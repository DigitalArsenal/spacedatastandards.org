 ...
 */
@Suppress("unused")
class GEOStatus_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : GEOStatus_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createGEOStatus_Abridged(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idOnOrbitOffset: Int, origObjectIdOffset: Int, ss: Double, sc: Double, relativeEnergy: Double, longitudeRate: Double, longitudeMin: Double, longitudeMax: Double, confidenceLevelOffset: Int, planeChangeStatusOffset: Int, troughTypeOffset: Int, lostFlag: Boolean, semiAnnualCorrFlag: Boolean, objectStatusOffset: Int, rawFileUriOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, satNo: Int, origNetworkOffset: Int) : Int {
            ...
            return endGEOStatus_Abridged(builder)
        }
        fun startGEOStatus_Abridged(builder: FlatBufferBuilder) = builder.startTable(24)
        ...
        fun endGEOStatus_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishGEOStatusAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "GEOS")
        fun finishSizePrefixedGEOStatus_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "GEOS")
    }
}
