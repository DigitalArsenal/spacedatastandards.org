 ...
 */
@Suppress("unused")
class AntennaDetails_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : AntennaDetails_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsAntennaDetails_Abridged(_bb: ByteBuffer): AntennaDetails_Abridged = getRootAsAntennaDetails_Abridged(_bb, AntennaDetails_Abridged())
        fun getRootAsAntennaDetails_Abridged(_bb: ByteBuffer, obj: AntennaDetails_Abridged): AntennaDetails_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun AntennaDetails_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "ANTE")
        fun createAntennaDetails_Abridged(builder: FlatBufferBuilder, idOffset: Int, idAntennaOffset: Int, classificationMarkingOffset: Int, typeOffset: Int, positionOffset: Int, mode: Byte, steerable: Boolean, beamForming: Boolean, manufacturerOrgIdOffset: Int, diameter: Double, sizeOffset: Int, startFrequency: Double, endFrequency: Double, beamwidth: Double, gain: Double, gainTolerance: Double, polarization: Double, descriptionOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endAntennaDetails_Abridged(builder)
        }
        fun startAntennaDetails_Abridged(builder: FlatBufferBuilder) = builder.startTable(24)
        ...
        fun endAntennaDetails_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishAntennaDetailsAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ANTE")
        fun finishSizePrefixedAntennaDetails_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ANTE")
    }
}
