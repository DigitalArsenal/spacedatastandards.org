 ...
 */
@Suppress("unused")
class TrackDetails_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : TrackDetails_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsTrackDetails_Ingest(_bb: ByteBuffer): TrackDetails_Ingest = getRootAsTrackDetails_Ingest(_bb, TrackDetails_Ingest())
        fun getRootAsTrackDetails_Ingest(_bb: ByteBuffer, obj: TrackDetails_Ingest): TrackDetails_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun TrackDetails_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "TRAC")
        fun startTrackDetails_Ingest(builder: FlatBufferBuilder) = builder.startTable(158)
        ...
        fun endTrackDetails_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishTrackDetailsIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "TRAC")
        fun finishSizePrefixedTrackDetails_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "TRAC")
    }
}
