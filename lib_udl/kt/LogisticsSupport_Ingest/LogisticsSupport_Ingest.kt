 ...
 */
@Suppress("unused")
class LogisticsSupport_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : LogisticsSupport_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createLogisticsSupport_Ingest(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, extSystemIdOffset: Int, tailNumberOffset: Int, aircraftMdsOffset: Int, currIcaoOffset: Int, suppIcaoOffset: Int, rptCreatedTimeOffset: Int, rptClosedTimeOffset: Int, meTimeOffset: Int, mcTimeOffset: Int, logisticActionOffset: Int, logisticsRecordIdOffset: Int, eticOffset: Int, etmcOffset: Int, maintStatusCodeOffset: Int, reopenFlag: Boolean, ownerOffset: Int, logisticsRemarksOffset: Int, logisticsDiscrepancyInfosOffset: Int, logisticsTransportationPlansOffset: Int, logisticsSupportItemsOffset: Int, origNetworkOffset: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte) : Int {
            ...
            return endLogisticsSupport_Ingest(builder)
        }
        fun startLogisticsSupport_Ingest(builder: FlatBufferBuilder) = builder.startTable(30)
        ...
        fun endLogisticsSupport_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishLogisticsSupportIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "LOGI")
        fun finishSizePrefixedLogisticsSupport_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "LOGI")
    }
}
