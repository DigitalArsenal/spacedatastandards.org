 ...
 */
@Suppress("unused")
class LogisticsParts_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : LogisticsParts_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsLogisticsParts_Full(_bb: ByteBuffer): LogisticsParts_Full = getRootAsLogisticsParts_Full(_bb, LogisticsParts_Full())
        fun getRootAsLogisticsParts_Full(_bb: ByteBuffer, obj: LogisticsParts_Full): LogisticsParts_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun LogisticsParts_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "LOGI")
        fun createLogisticsParts_Full(builder: FlatBufferBuilder, partNumberOffset: Int, nationalStockNumberOffset: Int, measurementUnitCodeOffset: Int, workUnitCodeOffset: Int, technicalOrderTextOffset: Int, figureNumberOffset: Int, indexNumberOffset: Int, requestVerifierOffset: Int, locationVerifierOffset: Int, supplyDocumentNumberOffset: Int, logisticsStocksOffset: Int) : Int {
            ...
            return endLogisticsParts_Full(builder)
        }
        fun startLogisticsParts_Full(builder: FlatBufferBuilder) = builder.startTable(11)
        ...
        fun endLogisticsParts_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishLogisticsPartsFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "LOGI")
        fun finishSizePrefixedLogisticsParts_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "LOGI")
    }
}
