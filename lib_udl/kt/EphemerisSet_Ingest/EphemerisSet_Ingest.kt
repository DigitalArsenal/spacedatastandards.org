 ...
 */
@Suppress("unused")
class EphemerisSet_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : EphemerisSet_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createEphemerisSet_Ingest(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idOnOrbitOffset: Int, origObjectIdOffset: Int, pointStartTimeOffset: Int, usableStartTimeOffset: Int, pointEndTimeOffset: Int, usableEndTimeOffset: Int, stepSize: Int, numPoints: Int, typeOffset: Int, pedigreeOffset: Int, categoryOffset: Int, idStateVectorOffset: Int, hasMnvr: Boolean, idManeuversOffset: Int, hasCov: Boolean, hasAccel: Boolean, centBodyOffset: Int, integratorOffset: Int, geopotentialModelOffset: Int, dragModelOffset: Int, lunarSolar: Boolean, solidEarthTides: Boolean, bDot: Double, edr: Double, interpolationOffset: Int, interpolationDegree: Int, filenameOffset: Int, commentsOffset: Int, descriptionOffset: Int, descriptorOffset: Int, referenceFrame: Byte, covReferenceFrame: Byte, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, satNo: Int, ephemerisListOffset: Int, tagsOffset: Int, transactionIdOffset: Int, origNetworkOffset: Int) : Int {
            ...
            return endEphemerisSet_Ingest(builder)
        }
        fun startEphemerisSet_Ingest(builder: FlatBufferBuilder) = builder.startTable(44)
        ...
        fun addSatNo(builder: FlatBufferBuilder, satNo: Int) = builder.addInt(39, satNo, 0)
        fun addEphemerisList(builder: FlatBufferBuilder, ephemerisList: Int) = builder.addOffset(40, ephemerisList, 0)
        ...
        fun endEphemerisSet_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishEphemerisSetIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "EPHE")
        fun finishSizePrefixedEphemerisSet_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "EPHE")
    }
}
