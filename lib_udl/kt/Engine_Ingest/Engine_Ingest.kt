 ...
 */
@Suppress("unused")
class Engine_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Engine_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsEngine_Ingest(_bb: ByteBuffer): Engine_Ingest = getRootAsEngine_Ingest(_bb, Engine_Ingest())
        fun getRootAsEngine_Ingest(_bb: ByteBuffer, obj: Engine_Ingest): Engine_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun Engine_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "ENGI")
        fun createEngine_Ingest(builder: FlatBufferBuilder, idOffset: Int, nameOffset: Int, classificationMarkingOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endEngine_Ingest(builder)
        }
        fun startEngine_Ingest(builder: FlatBufferBuilder) = builder.startTable(9)
        ...
        fun endEngine_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishEngineIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ENGI")
        fun finishSizePrefixedEngine_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ENGI")
    }
}
