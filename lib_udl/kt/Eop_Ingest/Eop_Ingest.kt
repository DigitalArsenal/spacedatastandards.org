 ...
 */
@Suppress("unused")
class Eop_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Eop_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createEop_Ingest(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, eopDateOffset: Int, polarMotionState: Byte, polarMotionX: Double, polarMotionXunc: Double, polarMotionY: Double, polarMotionYunc: Double, ut1Utcstate: Byte, ut1Utc: Double, ut1Utcunc: Double, lod: Double, lodUnc: Double, nutationState: Byte, dPsi: Double, dPsiunc: Double, dEpsilon: Double, dEpsilonUnc: Double, dX: Double, dXunc: Double, dY: Double, dYunc: Double, polarMotionXb: Double, polarMotionYb: Double, ut1Utcb: Double, dPsib: Double, dEpsilonB: Double, dXb: Double, dYb: Double, precessionNutationStdOffset: Int, rawFileUriOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, createdAtOffset: Int, createdByOffset: Int, origNetworkOffset: Int) : Int {
            ...
            return endEop_Ingest(builder)
        }
        fun startEop_Ingest(builder: FlatBufferBuilder) = builder.startTable(37)
        ...
        fun endEop_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishEopIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "EOPI")
        fun finishSizePrefixedEop_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "EOPI")
    }
}
