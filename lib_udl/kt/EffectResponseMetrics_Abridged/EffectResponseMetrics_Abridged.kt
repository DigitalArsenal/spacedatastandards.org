 ...
 */
@Suppress("unused")
class EffectResponseMetrics_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : EffectResponseMetrics_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsEffectResponseMetrics_Abridged(_bb: ByteBuffer): EffectResponseMetrics_Abridged = getRootAsEffectResponseMetrics_Abridged(_bb, EffectResponseMetrics_Abridged())
        fun getRootAsEffectResponseMetrics_Abridged(_bb: ByteBuffer, obj: EffectResponseMetrics_Abridged): EffectResponseMetrics_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun EffectResponseMetrics_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "EFFE")
        fun createEffectResponseMetrics_Abridged(builder: FlatBufferBuilder, metricTypeOffset: Int, domainValue: Double, relativeValue: Double, provenanceOffset: Int) : Int {
            ...
            return endEffectResponseMetrics_Abridged(builder)
        }
        fun startEffectResponseMetrics_Abridged(builder: FlatBufferBuilder) = builder.startTable(4)
        ...
        fun endEffectResponseMetrics_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishEffectResponseMetricsAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "EFFE")
        fun finishSizePrefixedEffectResponseMetrics_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "EFFE")
    }
}
