 ...
 */
@Suppress("unused")
class AnalyticImagery_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : AnalyticImagery_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createAnalyticImagery_Full(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, contentOffset: Int, msgTimeOffset: Int, imageTypeOffset: Int, filenameOffset: Int, filesize: Long, imgWidth: Int, imgHeight: Int, xUnitsOffset: Int, yUnitsOffset: Int, zUnitsOffset: Int, imageSetIdOffset: Int, imageSetLength: Int, sequenceId: Int, descriptionOffset: Int, dataStartOffset: Int, dataStopOffset: Int, annLimsOffset: Int, annTextOffset: Int, keywordsOffset: Int, areaOffset: Int, atextOffset: Int, agjsonOffset: Int, atypeOffset: Int, andims: Int, asrid: Int, satIdOffset: Int, satIdConfOffset: Int, srcTypsOffset: Int, srcIdsOffset: Int, tagsOffset: Int, checksumValueOffset: Int, transactionIdOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, sourceDlOffset: Int, dataMode: Byte) : Int {
            ...
            return endAnalyticImagery_Full(builder)
        }
        fun startAnalyticImagery_Full(builder: FlatBufferBuilder) = builder.startTable(41)
        ...
        fun endAnalyticImagery_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishAnalyticImageryFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ANAL")
        fun finishSizePrefixedAnalyticImagery_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ANAL")
    }
}
