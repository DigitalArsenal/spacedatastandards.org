 ...
 */
@Suppress("unused")
class LaunchSite_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : LaunchSite_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsLaunchSite_Ingest(_bb: ByteBuffer): LaunchSite_Ingest = getRootAsLaunchSite_Ingest(_bb, LaunchSite_Ingest())
        fun getRootAsLaunchSite_Ingest(_bb: ByteBuffer, obj: LaunchSite_Ingest): LaunchSite_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun LaunchSite_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "LAUN")
        fun createLaunchSite_Ingest(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, codeOffset: Int, shortCodeOffset: Int, altCodeOffset: Int, idSiteOffset: Int, nameOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endLaunchSite_Ingest(builder)
        }
        fun startLaunchSite_Ingest(builder: FlatBufferBuilder) = builder.startTable(13)
        ...
        fun endLaunchSite_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishLaunchSiteIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "LAUN")
        fun finishSizePrefixedLaunchSite_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "LAUN")
    }
}
