 ...
 */
@Suppress("unused")
class IonoObservationProfileDensityShiftedChebyshevEntry_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : IonoObservationProfileDensityShiftedChebyshevEntry_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsIonoObservationProfileDensityShiftedChebyshevEntry_Ingest(_bb: ByteBuffer): IonoObservationProfileDensityShiftedChebyshevEntry_Ingest = getRootAsIonoObservationProfileDensityShiftedChebyshevEntry_Ingest(_bb, IonoObservationProfileDensityShiftedChebyshevEntry_Ingest())
        fun getRootAsIonoObservationProfileDensityShiftedChebyshevEntry_Ingest(_bb: ByteBuffer, obj: IonoObservationProfileDensityShiftedChebyshevEntry_Ingest): IonoObservationProfileDensityShiftedChebyshevEntry_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun IonoObservationProfileDensityShiftedChebyshevEntry_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "IONO")
        fun createIonoObservationProfileDensityShiftedChebyshevEntry_Ingest(builder: FlatBufferBuilder, layerOffset: Int, fstart: Double, fstop: Double, peakheight: Double, zhalfNm: Double, n: Int, coeffsOffset: Int, error: Double) : Int {
            ...
            return endIonoObservationProfileDensityShiftedChebyshevEntry_Ingest(builder)
        }
        fun startIonoObservationProfileDensityShiftedChebyshevEntry_Ingest(builder: FlatBufferBuilder) = builder.startTable(8)
        ...
        fun endIonoObservationProfileDensityShiftedChebyshevEntry_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishIonoObservationProfileDensityShiftedChebyshevEntryIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "IONO")
        fun finishSizePrefixedIonoObservationProfileDensityShiftedChebyshevEntry_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "IONO")
    }
}
