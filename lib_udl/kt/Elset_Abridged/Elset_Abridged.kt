 ...
 */
@Suppress("unused")
class Elset_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Elset_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val algorithmAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(70, 1)
    fun algorithmInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 70, 1)
    /**
    ...
    val transactionIdAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(72, 1)
    fun transactionIdInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 72, 1)
    /**
    ...
    companion object {
        ...
        fun getRootAsElset_Abridged(_bb: ByteBuffer): Elset_Abridged = getRootAsElset_Abridged(_bb, Elset_Abridged())
        fun getRootAsElset_Abridged(_bb: ByteBuffer, obj: Elset_Abridged): Elset_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun Elset_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "ELSE")
        fun createElset_Abridged(builder: FlatBufferBuilder, idElsetOffset: Int, classificationMarkingOffset: Int, satNo: Int, epochOffset: Int, meanMotion: Double, idOnOrbitOffset: Int, uct: Boolean, eccentricity: Double, inclination: Double, raan: Double, argOfPerigee: Double, meanAnomaly: Double, revNo: Int, bStar: Double, agom: Double, ballisticCoeff: Double, meanMotionDot: Double, meanMotionDdot: Double, semiMajorAxis: Double, period: Double, apogee: Double, perigee: Double, origObjectIdOffset: Int, idOrbitDeterminationOffset: Int, line1Offset: Int, line2Offset: Int, descriptorOffset: Int, createdAtOffset: Int, createdByOffset: Int, originOffset: Int, sourceDlOffset: Int, sourceOffset: Int, dataMode: Byte, algorithmOffset: Int, transactionIdOffset: Int, ephemType: Int, origNetworkOffset: Int) : Int {
            ...
            addUct(builder, uct)
            return endElset_Abridged(builder)
        }
        fun startElset_Abridged(builder: FlatBufferBuilder) = builder.startTable(37)
        ...
        fun addAlgorithm(builder: FlatBufferBuilder, algorithm: Int) = builder.addOffset(33, algorithm, 0)
        fun addTransactionId(builder: FlatBufferBuilder, transactionId: Int) = builder.addOffset(34, transactionId, 0)
        fun addEphemType(builder: FlatBufferBuilder, ephemType: Int) = builder.addInt(35, ephemType, 0)
        fun addOrigNetwork(builder: FlatBufferBuilder, origNetwork: Int) = builder.addOffset(36, origNetwork, 0)
        fun endElset_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishElsetAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ELSE")
        fun finishSizePrefixedElset_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ELSE")
    }
}
