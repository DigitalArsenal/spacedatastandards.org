 ...
 */
@Suppress("unused")
class LogisticsSpecialties_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : LogisticsSpecialties_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsLogisticsSpecialties_Abridged(_bb: ByteBuffer): LogisticsSpecialties_Abridged = getRootAsLogisticsSpecialties_Abridged(_bb, LogisticsSpecialties_Abridged())
        fun getRootAsLogisticsSpecialties_Abridged(_bb: ByteBuffer, obj: LogisticsSpecialties_Abridged): LogisticsSpecialties_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun LogisticsSpecialties_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "LOGI")
        fun createLogisticsSpecialties_Abridged(builder: FlatBufferBuilder, specialtyOffset: Int, skillLevel: Int, firstNameOffset: Int, lastNameOffset: Int, rankCodeOffset: Int, last4SsnOffset: Int, roleTypeCodeOffset: Int) : Int {
            ...
            return endLogisticsSpecialties_Abridged(builder)
        }
        fun startLogisticsSpecialties_Abridged(builder: FlatBufferBuilder) = builder.startTable(7)
        ...
        fun endLogisticsSpecialties_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishLogisticsSpecialtiesAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "LOGI")
        fun finishSizePrefixedLogisticsSpecialties_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "LOGI")
    }
}
