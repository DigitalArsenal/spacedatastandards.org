 ...
 */
@Suppress("unused")
class NavigationalObstruction_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : NavigationalObstruction_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val updatedAtAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(148, 1)
    fun updatedAtInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 148, 1)
    /**
    ...
    val updatedByAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(150, 1)
    fun updatedByInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 150, 1)
    /**
    ...
    val sourceDlAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(152, 1)
    fun sourceDlInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 152, 1)
    /**
     * Source of the data.
    ...
    companion object {
        ...
        fun createNavigationalObstruction_Full(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, cycleDateOffset: Int, obstacleTypeOffset: Int, obstacleIdOffset: Int, externalIdOffset: Int, origIdOffset: Int, countryCodeOffset: Int, provinceCodeOffset: Int, pointLat: Double, pointLon: Double, lineNelon: Double, lineNelat: Double, lineSwlon: Double, lineSwlat: Double, segStartPoint: Int, segEndPoint: Int, segNum: Int, faccOffset: Int, featureCodeOffset: Int, featureTypeOffset: Int, featureNameOffset: Int, featureDescriptionOffset: Int, wacOffset: Int, wacInnrOffset: Int, multObsOffset: Int, numObs: Int, horizDatumCodeOffset: Int, heightAgl: Double, heightAglacc: Double, heightMsl: Double, heightMslacc: Double, elevation: Double, elevationAcc: Double, horizAcc: Double, qualityOffset: Int, lightingCodeOffset: Int, surfaceMatCodeOffset: Int, directivityCode: Int, validationCode: Int, transactionCodeOffset: Int, processCodeOffset: Int, actDelCodeOffset: Int, producerOffset: Int, derivingOrgOffset: Int, deletingOrgOffset: Int, sourceDateOffset: Int, revDateOffset: Int, initRecordDateOffset: Int, keysOffset: Int, valuesOffset: Int, obstacleRemarksOffset: Int, nextCycleDateOffset: Int, baselineCutoffDateOffset: Int, cutoffDateOffset: Int, airacCycle: Int, baseAiracCycle: Int, ownerCountryCodeOffset: Int, boundNelon: Double, boundNelat: Double, boundSwlon: Double, boundSwlat: Double, minHeightAgl: Double, numPoints: Int, numLines: Int, dataSetRemarksOffset: Int, pointsFilenameOffset: Int, linesFilenameOffset: Int, vectorsFilenameOffset: Int, rawFileUriOffset: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceDlOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endNavigationalObstruction_Full(builder)
        }
        fun startNavigationalObstruction_Full(builder: FlatBufferBuilder) = builder.startTable(79)
        ...
        fun addUpdatedAt(builder: FlatBufferBuilder, updatedAt: Int) = builder.addOffset(72, updatedAt, 0)
        fun addUpdatedBy(builder: FlatBufferBuilder, updatedBy: Int) = builder.addOffset(73, updatedBy, 0)
        fun addSourceDL(builder: FlatBufferBuilder, sourceDl: Int) = builder.addOffset(74, sourceDl, 0)
        ...
        fun endNavigationalObstruction_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishNavigationalObstructionFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "NAVI")
        fun finishSizePrefixedNavigationalObstruction_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "NAVI")
    }
}
