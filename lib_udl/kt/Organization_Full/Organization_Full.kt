 ...
 */
@Suppress("unused")
class Organization_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Organization_Full {
        __init(_i, _bb)
        return this
    }
    /**
     ...
     * Constraints: No constraints specified.
     */
    fun organizationDetails(j: Int) : String? {
        val o = __offset(38)
        return if (o != 0) {
    ...
    val organizationDetailsLength : Int
        get() {
    ...
    companion object {
        ...
        fun getRootAsOrganization_Full(_bb: ByteBuffer): Organization_Full = getRootAsOrganization_Full(_bb, Organization_Full())
        fun getRootAsOrganization_Full(_bb: ByteBuffer, obj: Organization_Full): Organization_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun Organization_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "ORGA")
        fun createOrganization_Full(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, nameOffset: Int, typeOffset: Int, categoryOffset: Int, externalIdOffset: Int, descriptionOffset: Int, countryCodeOffset: Int, nationalityOffset: Int, active: Boolean, sourceOffset: Int, originOffset: Int, dataMode: Byte, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, organizationDetailsOffset: Int, origNetworkOffset: Int) : Int {
            builder.startTable(19)
            addOrigNetwork(builder, origNetworkOffset)
            addOrganizationDetails(builder, organizationDetailsOffset)
            ...
            return endOrganization_Full(builder)
        }
        fun startOrganization_Full(builder: FlatBufferBuilder) = builder.startTable(19)
        ...
        fun addOrganizationDetails(builder: FlatBufferBuilder, organizationDetails: Int) = builder.addOffset(17, organizationDetails, 0)
        fun createOrganizationDetailsVector(builder: FlatBufferBuilder, data: IntArray) : Int {
        ...
        fun startOrganizationDetailsVector(builder: FlatBufferBuilder, numElems: Int) = builder.startVector(4, numElems, 4)
        fun addOrigNetwork(builder: FlatBufferBuilder, origNetwork: Int) = builder.addOffset(18, origNetwork, 0)
        fun endOrganization_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishOrganizationFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ORGA")
        fun finishSizePrefixedOrganization_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ORGA")
    }
}
