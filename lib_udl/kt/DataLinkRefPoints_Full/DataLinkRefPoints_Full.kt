 ...
 */
@Suppress("unused")
class DataLinkRefPoints_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : DataLinkRefPoints_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsDataLinkRefPoints_Full(_bb: ByteBuffer): DataLinkRefPoints_Full = getRootAsDataLinkRefPoints_Full(_bb, DataLinkRefPoints_Full())
        fun getRootAsDataLinkRefPoints_Full(_bb: ByteBuffer, obj: DataLinkRefPoints_Full): DataLinkRefPoints_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun DataLinkRefPoints_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "DATA")
        fun createDataLinkRefPoints_Full(builder: FlatBufferBuilder, refPointTypeOffset: Int, refDesOffset: Int, refLocNameOffset: Int, refLat: Double, refLon: Double, effEventTimeOffset: Int) : Int {
            ...
            return endDataLinkRefPoints_Full(builder)
        }
        fun startDataLinkRefPoints_Full(builder: FlatBufferBuilder) = builder.startTable(6)
        ...
        fun endDataLinkRefPoints_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishDataLinkRefPointsFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "DATA")
        fun finishSizePrefixedDataLinkRefPoints_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "DATA")
    }
}
