 ...
 */
@Suppress("unused")
class RoutePoints_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : RoutePoints_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsRoutePoints_Ingest(_bb: ByteBuffer): RoutePoints_Ingest = getRootAsRoutePoints_Ingest(_bb, RoutePoints_Ingest())
        fun getRootAsRoutePoints_Ingest(_bb: ByteBuffer, obj: RoutePoints_Ingest): RoutePoints_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun RoutePoints_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "ROUT")
        fun createRoutePoints_Ingest(builder: FlatBufferBuilder, ptSequenceId: Int, ptTypeCodeOffset: Int, ptTypeNameOffset: Int, waypointNameOffset: Int, dafifPt: Boolean, ptLat: Double, ptLon: Double, magDec: Double, navaidLength: Double, navaidOffset: Int, countryCodeOffset: Int, altCountryCodeOffset: Int, navaidTypeOffset: Int) : Int {
            ...
            return endRoutePoints_Ingest(builder)
        }
        fun startRoutePoints_Ingest(builder: FlatBufferBuilder) = builder.startTable(13)
        ...
        fun endRoutePoints_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishRoutePointsIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ROUT")
        fun finishSizePrefixedRoutePoints_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ROUT")
    }
}
