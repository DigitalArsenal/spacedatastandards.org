 ...
 */
@Suppress("unused")
class SofDataSourceRef_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : SofDataSourceRef_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsSofDataSourceRef_Full(_bb: ByteBuffer): SofDataSourceRef_Full = getRootAsSofDataSourceRef_Full(_bb, SofDataSourceRef_Full())
        fun getRootAsSofDataSourceRef_Full(_bb: ByteBuffer, obj: SofDataSourceRef_Full): SofDataSourceRef_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun SofDataSourceRef_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "SOFD")
        fun createSofDataSourceRef_Full(builder: FlatBufferBuilder, dataSourceIdOffset: Int, startPositionOffset: Int, endPositionOffset: Int, paragraphNumberOffset: Int, sentenceNumberOffset: Int) : Int {
            ...
            return endSofDataSourceRef_Full(builder)
        }
        fun startSofDataSourceRef_Full(builder: FlatBufferBuilder) = builder.startTable(5)
        ...
        fun endSofDataSourceRef_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishSofDataSourceRefFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "SOFD")
        fun finishSizePrefixedSofDataSourceRef_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "SOFD")
    }
}
