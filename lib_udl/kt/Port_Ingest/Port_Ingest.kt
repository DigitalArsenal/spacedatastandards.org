 ...
 */
@Suppress("unused")
class Port_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Port_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createPort_Ingest(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idSiteOffset: Int, externalIdOffset: Int, locodeOffset: Int, portNameOffset: Int, harborTypeOffset: Int, harborSize: Double, maxDraught: Double, avgDuration: Double, tideRange: Double, shelterOffset: Int, pilotReqd: Boolean, lat: Double, lon: Double, countryCodeOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, origNetworkOffset: Int) : Int {
            ...
            return endPort_Ingest(builder)
        }
        fun startPort_Ingest(builder: FlatBufferBuilder) = builder.startTable(22)
        ...
        fun endPort_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishPortIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "PORT")
        fun finishSizePrefixedPort_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "PORT")
    }
}
