 ...
 */
@Suppress("unused")
class PersonnelRecoveryEnemyData_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : PersonnelRecoveryEnemyData_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsPersonnelRecoveryEnemyData_Full(_bb: ByteBuffer): PersonnelRecoveryEnemyData_Full = getRootAsPersonnelRecoveryEnemyData_Full(_bb, PersonnelRecoveryEnemyData_Full())
        fun getRootAsPersonnelRecoveryEnemyData_Full(_bb: ByteBuffer, obj: PersonnelRecoveryEnemyData_Full): PersonnelRecoveryEnemyData_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun PersonnelRecoveryEnemyData_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "PERS")
        fun createPersonnelRecoveryEnemyData_Full(builder: FlatBufferBuilder, dirToEnemyOffset: Int, hostileFireTypeOffset: Int, friendliesRemarksOffset: Int, hlzRemarksOffset: Int) : Int {
            ...
            return endPersonnelRecoveryEnemyData_Full(builder)
        }
        fun startPersonnelRecoveryEnemyData_Full(builder: FlatBufferBuilder) = builder.startTable(4)
        ...
        fun endPersonnelRecoveryEnemyData_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishPersonnelRecoveryEnemyDataFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "PERS")
        fun finishSizePrefixedPersonnelRecoveryEnemyData_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "PERS")
    }
}
