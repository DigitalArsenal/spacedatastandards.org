 ...
 */
@Suppress("unused")
class EffectResponseMetrics_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : EffectResponseMetrics_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsEffectResponseMetrics_Full(_bb: ByteBuffer): EffectResponseMetrics_Full = getRootAsEffectResponseMetrics_Full(_bb, EffectResponseMetrics_Full())
        fun getRootAsEffectResponseMetrics_Full(_bb: ByteBuffer, obj: EffectResponseMetrics_Full): EffectResponseMetrics_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun EffectResponseMetrics_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "EFFE")
        fun createEffectResponseMetrics_Full(builder: FlatBufferBuilder, metricTypeOffset: Int, domainValue: Double, relativeValue: Double, provenanceOffset: Int) : Int {
            ...
            return endEffectResponseMetrics_Full(builder)
        }
        fun startEffectResponseMetrics_Full(builder: FlatBufferBuilder) = builder.startTable(4)
        ...
        fun endEffectResponseMetrics_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishEffectResponseMetricsFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "EFFE")
        fun finishSizePrefixedEffectResponseMetrics_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "EFFE")
    }
}
