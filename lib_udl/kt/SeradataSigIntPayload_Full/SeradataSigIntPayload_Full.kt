 ...
 */
@Suppress("unused")
class SeradataSigIntPayload_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : SeradataSigIntPayload_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsSeradataSigIntPayload_Full(_bb: ByteBuffer): SeradataSigIntPayload_Full = getRootAsSeradataSigIntPayload_Full(_bb, SeradataSigIntPayload_Full())
        fun getRootAsSeradataSigIntPayload_Full(_bb: ByteBuffer, obj: SeradataSigIntPayload_Full): SeradataSigIntPayload_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun SeradataSigIntPayload_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "SERA")
        fun createSeradataSigIntPayload_Full(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, spacecraftIdOffset: Int, idSensorOffset: Int, hostedForCompanyOrgIdOffset: Int, manufacturerOrgIdOffset: Int, typeOffset: Int, swathWidth: Double, groundStationsOffset: Int, groundStationLocationsOffset: Int, frequencyCoverageOffset: Int, positionalAccuracyOffset: Int, interceptParametersOffset: Int, nameOffset: Int, notesOffset: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endSeradataSigIntPayload_Full(builder)
        }
        fun startSeradataSigIntPayload_Full(builder: FlatBufferBuilder) = builder.startTable(23)
        ...
        fun endSeradataSigIntPayload_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishSeradataSigIntPayloadFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "SERA")
        fun finishSizePrefixedSeradataSigIntPayload_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "SERA")
    }
}
