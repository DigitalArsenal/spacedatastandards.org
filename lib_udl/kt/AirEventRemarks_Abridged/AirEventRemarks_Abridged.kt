 ...
 */
@Suppress("unused")
class AirEventRemarks_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : AirEventRemarks_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsAirEventRemarks_Abridged(_bb: ByteBuffer): AirEventRemarks_Abridged = getRootAsAirEventRemarks_Abridged(_bb, AirEventRemarks_Abridged())
        fun getRootAsAirEventRemarks_Abridged(_bb: ByteBuffer, obj: AirEventRemarks_Abridged): AirEventRemarks_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun AirEventRemarks_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "AIRE")
        fun createAirEventRemarks_Abridged(builder: FlatBufferBuilder, externalRemarkIdOffset: Int, textOffset: Int, dateOffset: Int, userOffset: Int) : Int {
            ...
            return endAirEventRemarks_Abridged(builder)
        }
        fun startAirEventRemarks_Abridged(builder: FlatBufferBuilder) = builder.startTable(4)
        ...
        fun endAirEventRemarks_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishAirEventRemarksAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "AIRE")
        fun finishSizePrefixedAirEventRemarks_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "AIRE")
    }
}
