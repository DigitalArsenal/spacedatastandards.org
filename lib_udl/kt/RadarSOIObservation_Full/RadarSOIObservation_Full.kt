 ...
 */
@Suppress("unused")
class RadarSOIObservation_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : RadarSOIObservation_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsRadarSOIObservation_Full(_bb: ByteBuffer): RadarSOIObservation_Full = getRootAsRadarSOIObservation_Full(_bb, RadarSOIObservation_Full())
        fun getRootAsRadarSOIObservation_Full(_bb: ByteBuffer, obj: RadarSOIObservation_Full): RadarSOIObservation_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun RadarSOIObservation_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "RADA")
        fun createRadarSOIObservation_Full(builder: FlatBufferBuilder, obStartTimeOffset: Int, tovsOffset: Int, rspacesOffset: Int, xspacesOffset: Int, doppler2XrsOffset: Int, deltaTimesOffset: Int, aspectAnglesOffset: Int, projAngVelsOffset: Int, idStateVectorOffset: Int, idAttitudeSetOffset: Int, rangesOffset: Int, azimuthsOffset: Int, elevationsOffset: Int, rangeRatesOffset: Int, azimuthRatesOffset: Int, elevationRatesOffset: Int, azimuthBiasesOffset: Int, elevationBiasesOffset: Int, rangeBiasesOffset: Int, integrationAnglesOffset: Int, crossRangeResOffset: Int, beta: Double, kappa: Double, peakAmplitudesOffset: Int, centerFrequency: Double, pulseBandwidth: Double, xposOffset: Int, yposOffset: Int, zposOffset: Int, xvelOffset: Int, yvelOffset: Int, zvelOffset: Int) : Int {
            ...
            return endRadarSOIObservation_Full(builder)
        }
        fun startRadarSOIObservation_Full(builder: FlatBufferBuilder) = builder.startTable(32)
        ...
        fun endRadarSOIObservation_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishRadarSOIObservationFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "RADA")
        fun finishSizePrefixedRadarSOIObservation_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "RADA")
    }
}
