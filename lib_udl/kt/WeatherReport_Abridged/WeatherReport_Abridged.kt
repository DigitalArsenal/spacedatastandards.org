 ...
 */
@Suppress("unused")
class WeatherReport_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : WeatherReport_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val atextAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(44, 1)
    fun atextInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 44, 1)
    /**
    ...
    val agjsonAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(46, 1)
    fun agjsonInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 46, 1)
    /**
    ...
    val atypeAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(48, 1)
    fun atypeInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 48, 1)
    /**
    ...
    val actWeatherAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(98, 1)
    fun actWeatherInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 98, 1)
    /**
    ...
    val weatherDescAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(100, 1)
    fun weatherDescInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 100, 1)
    /**
    ...
    val weatherIntAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(102, 1)
    fun weatherIntInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 102, 1)
    /**
    ...
    val rawMetarAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(104, 1)
    fun rawMetarInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 104, 1)
    /**
    ...
    val rawTafAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(106, 1)
    fun rawTafInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 106, 1)
    /**
    ...
    val surroundingWeatherAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(142, 1)
    fun surroundingWeatherInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 142, 1)
    /**
    ...
    val weatherAmpAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(144, 1)
    fun weatherAmpInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 144, 1)
    /**
    ...
    val enRouteWeatherAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(154, 1)
    fun enRouteWeatherInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 154, 1)
    /**
    ...
    val srcTypsLength : Int
        get() {
            val o = __offset(158); return if (o != 0) __vector_len(o) else 0
        }
    /**
    ...
    val createdAtAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(164, 1)
    fun createdAtInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 164, 1)
    /**
    ...
    val createdByAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(166, 1)
    fun createdByInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 166, 1)
    /**
     * Source of the data.
    ...
    val sourceAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(168, 1)
    fun sourceInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 168, 1)
    /**
    ...
    val originAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(170, 1)
    fun originInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 170, 1)
    /**
    ...
    companion object {
        ...
        fun createWeatherReport_Abridged(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idSensorOffset: Int, origSensorIdOffset: Int, weatherIdOffset: Int, idGroundImageryOffset: Int, idSiteOffset: Int, idAirfieldOffset: Int, icaoOffset: Int, externalIdOffset: Int, externalLocationIdOffset: Int, reportTypeOffset: Int, obTimeOffset: Int, forecastStartTimeOffset: Int, forecastEndTimeOffset: Int, lat: Double, lon: Double, alt: Double, geoPotentialAlt: Double, dataLevelOffset: Int, atextOffset: Int, agjsonOffset: Int, atypeOffset: Int, andims: Int, asrid: Int, windSpd: Double, windSpdAvg: Double, windGust: Double, windGust10: Double, vshear: Double, hshear: Double, radVel: Double, radVelBeam1: Double, radVelBeam2: Double, radVelBeam3: Double, radVelBeam4: Double, radVelBeam5: Double, windDir: Double, windDirAvg: Double, windDirPeak: Double, windDirPeak10: Double, windChill: Double, dirDev: Double, windVar: Boolean, windCovOffset: Int, cloudCoverOffset: Int, cloudHghtOffset: Int, actWeatherOffset: Int, weatherDescOffset: Int, weatherIntOffset: Int, rawMetarOffset: Int, rawTafOffset: Int, qnh: Double, visibility: Double, temperature: Double, soilTemp: Double, barPress: Double, precipRate: Double, rainHour: Double, solarRad: Double, difRad: Double, refRad: Double, senlat: Double, senlon: Double, senalt: Double, dewPoint: Double, relHumidity: Double, indexRefraction: Double, soilMoisture: Double, surroundingWeatherOffset: Int, weatherAmpOffset: Int, contrailHghtLower: Double, contrailHghtUpper: Double, icingUpperLimit: Double, icingLowerLimit: Double, enRouteWeatherOffset: Int, ccEvent: Boolean, srcTypsOffset: Int, srcIdsOffset: Int, origNetworkOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte) : Int {
            ...
            return endWeatherReport_Abridged(builder)
        }
        fun startWeatherReport_Abridged(builder: FlatBufferBuilder) = builder.startTable(85)
        ...
        fun addAtext(builder: FlatBufferBuilder, atext: Int) = builder.addOffset(20, atext, 0)
        fun addAgjson(builder: FlatBufferBuilder, agjson: Int) = builder.addOffset(21, agjson, 0)
        fun addAtype(builder: FlatBufferBuilder, atype: Int) = builder.addOffset(22, atype, 0)
        fun addAndims(builder: FlatBufferBuilder, andims: Int) = builder.addInt(23, andims, 0)
        fun addAsrid(builder: FlatBufferBuilder, asrid: Int) = builder.addInt(24, asrid, 0)
        fun addWindSpd(builder: FlatBufferBuilder, windSpd: Double) = builder.addDouble(25, windSpd, 0.0)
        fun addWindSpdAvg(builder: FlatBufferBuilder, windSpdAvg: Double) = builder.addDouble(26, windSpdAvg, 0.0)
        fun addWindGust(builder: FlatBufferBuilder, windGust: Double) = builder.addDouble(27, windGust, 0.0)
        fun addWindGust10(builder: FlatBufferBuilder, windGust10: Double) = builder.addDouble(28, windGust10, 0.0)
        fun addVshear(builder: FlatBufferBuilder, vshear: Double) = builder.addDouble(29, vshear, 0.0)
        fun addHshear(builder: FlatBufferBuilder, hshear: Double) = builder.addDouble(30, hshear, 0.0)
        fun addRadVel(builder: FlatBufferBuilder, radVel: Double) = builder.addDouble(31, radVel, 0.0)
        fun addRadVelBeam1(builder: FlatBufferBuilder, radVelBeam1: Double) = builder.addDouble(32, radVelBeam1, 0.0)
        fun addRadVelBeam2(builder: FlatBufferBuilder, radVelBeam2: Double) = builder.addDouble(33, radVelBeam2, 0.0)
        fun addRadVelBeam3(builder: FlatBufferBuilder, radVelBeam3: Double) = builder.addDouble(34, radVelBeam3, 0.0)
        fun addRadVelBeam4(builder: FlatBufferBuilder, radVelBeam4: Double) = builder.addDouble(35, radVelBeam4, 0.0)
        fun addRadVelBeam5(builder: FlatBufferBuilder, radVelBeam5: Double) = builder.addDouble(36, radVelBeam5, 0.0)
        fun addWindDir(builder: FlatBufferBuilder, windDir: Double) = builder.addDouble(37, windDir, 0.0)
        fun addWindDirAvg(builder: FlatBufferBuilder, windDirAvg: Double) = builder.addDouble(38, windDirAvg, 0.0)
        fun addWindDirPeak(builder: FlatBufferBuilder, windDirPeak: Double) = builder.addDouble(39, windDirPeak, 0.0)
        fun addWindDirPeak10(builder: FlatBufferBuilder, windDirPeak10: Double) = builder.addDouble(40, windDirPeak10, 0.0)
        fun addWindChill(builder: FlatBufferBuilder, windChill: Double) = builder.addDouble(41, windChill, 0.0)
        fun addDirDev(builder: FlatBufferBuilder, dirDev: Double) = builder.addDouble(42, dirDev, 0.0)
        fun addWindVar(builder: FlatBufferBuilder, windVar: Boolean) = builder.addBoolean(43, windVar, false)
        fun addWindCov(builder: FlatBufferBuilder, windCov: Int) = builder.addOffset(44, windCov, 0)
        ...
        fun addCloudCover(builder: FlatBufferBuilder, cloudCover: Int) = builder.addOffset(45, cloudCover, 0)
        ...
        fun addCloudHght(builder: FlatBufferBuilder, cloudHght: Int) = builder.addOffset(46, cloudHght, 0)
        ...
        fun addActWeather(builder: FlatBufferBuilder, actWeather: Int) = builder.addOffset(47, actWeather, 0)
        fun addWeatherDesc(builder: FlatBufferBuilder, weatherDesc: Int) = builder.addOffset(48, weatherDesc, 0)
        fun addWeatherInt(builder: FlatBufferBuilder, weatherInt: Int) = builder.addOffset(49, weatherInt, 0)
        fun addRawMETAR(builder: FlatBufferBuilder, rawMetar: Int) = builder.addOffset(50, rawMetar, 0)
        fun addRawTAF(builder: FlatBufferBuilder, rawTaf: Int) = builder.addOffset(51, rawTaf, 0)
        fun addQnh(builder: FlatBufferBuilder, qnh: Double) = builder.addDouble(52, qnh, 0.0)
        fun addVisibility(builder: FlatBufferBuilder, visibility: Double) = builder.addDouble(53, visibility, 0.0)
        fun addTemperature(builder: FlatBufferBuilder, temperature: Double) = builder.addDouble(54, temperature, 0.0)
        fun addSoilTemp(builder: FlatBufferBuilder, soilTemp: Double) = builder.addDouble(55, soilTemp, 0.0)
        fun addBarPress(builder: FlatBufferBuilder, barPress: Double) = builder.addDouble(56, barPress, 0.0)
        fun addPrecipRate(builder: FlatBufferBuilder, precipRate: Double) = builder.addDouble(57, precipRate, 0.0)
        fun addRainHour(builder: FlatBufferBuilder, rainHour: Double) = builder.addDouble(58, rainHour, 0.0)
        fun addSolarRad(builder: FlatBufferBuilder, solarRad: Double) = builder.addDouble(59, solarRad, 0.0)
        fun addDifRad(builder: FlatBufferBuilder, difRad: Double) = builder.addDouble(60, difRad, 0.0)
        fun addRefRad(builder: FlatBufferBuilder, refRad: Double) = builder.addDouble(61, refRad, 0.0)
        fun addSenlat(builder: FlatBufferBuilder, senlat: Double) = builder.addDouble(62, senlat, 0.0)
        fun addSenlon(builder: FlatBufferBuilder, senlon: Double) = builder.addDouble(63, senlon, 0.0)
        fun addSenalt(builder: FlatBufferBuilder, senalt: Double) = builder.addDouble(64, senalt, 0.0)
        fun addDewPoint(builder: FlatBufferBuilder, dewPoint: Double) = builder.addDouble(65, dewPoint, 0.0)
        fun addRelHumidity(builder: FlatBufferBuilder, relHumidity: Double) = builder.addDouble(66, relHumidity, 0.0)
        fun addIndexRefraction(builder: FlatBufferBuilder, indexRefraction: Double) = builder.addDouble(67, indexRefraction, 0.0)
        fun addSoilMoisture(builder: FlatBufferBuilder, soilMoisture: Double) = builder.addDouble(68, soilMoisture, 0.0)
        fun addSurroundingWeather(builder: FlatBufferBuilder, surroundingWeather: Int) = builder.addOffset(69, surroundingWeather, 0)
        fun addWeatherAmp(builder: FlatBufferBuilder, weatherAmp: Int) = builder.addOffset(70, weatherAmp, 0)
        fun addContrailHghtLower(builder: FlatBufferBuilder, contrailHghtLower: Double) = builder.addDouble(71, contrailHghtLower, 0.0)
        fun addContrailHghtUpper(builder: FlatBufferBuilder, contrailHghtUpper: Double) = builder.addDouble(72, contrailHghtUpper, 0.0)
        fun addIcingUpperLimit(builder: FlatBufferBuilder, icingUpperLimit: Double) = builder.addDouble(73, icingUpperLimit, 0.0)
        fun addIcingLowerLimit(builder: FlatBufferBuilder, icingLowerLimit: Double) = builder.addDouble(74, icingLowerLimit, 0.0)
        fun addEnRouteWeather(builder: FlatBufferBuilder, enRouteWeather: Int) = builder.addOffset(75, enRouteWeather, 0)
        fun addCcEvent(builder: FlatBufferBuilder, ccEvent: Boolean) = builder.addBoolean(76, ccEvent, false)
        fun addSrcTyps(builder: FlatBufferBuilder, srcTyps: Int) = builder.addOffset(77, srcTyps, 0)
        ...
        fun addSrcIds(builder: FlatBufferBuilder, srcIds: Int) = builder.addOffset(78, srcIds, 0)
        ...
        fun addCreatedAt(builder: FlatBufferBuilder, createdAt: Int) = builder.addOffset(80, createdAt, 0)
        fun addCreatedBy(builder: FlatBufferBuilder, createdBy: Int) = builder.addOffset(81, createdBy, 0)
        fun addSource(builder: FlatBufferBuilder, source: Int) = builder.addOffset(82, source, 0)
        fun addOrigin(builder: FlatBufferBuilder, origin: Int) = builder.addOffset(83, origin, 0)
        fun addDataMode(builder: FlatBufferBuilder, dataMode: Byte) = builder.addByte(84, dataMode, 0)
        fun endWeatherReport_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishWeatherReportAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "WEAT")
        fun finishSizePrefixedWeatherReport_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "WEAT")
    }
}
