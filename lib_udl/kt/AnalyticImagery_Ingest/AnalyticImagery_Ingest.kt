 ...
 */
@Suppress("unused")
class AnalyticImagery_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : AnalyticImagery_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val areaAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(46, 1)
    fun areaInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 46, 1)
    /**
    ...
    val atextAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(48, 1)
    fun atextInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 48, 1)
    /**
    ...
    val agjsonAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(50, 1)
    fun agjsonInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 50, 1)
    /**
    ...
    val atypeAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(52, 1)
    fun atypeInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 52, 1)
    /**
    ...
    val checksumValueAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(68, 1)
    fun checksumValueInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 68, 1)
    /**
    ...
    val transactionIdAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(70, 1)
    fun transactionIdInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 70, 1)
    /**
    ...
    companion object {
        ...
        fun createAnalyticImagery_Ingest(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, contentOffset: Int, msgTimeOffset: Int, imageTypeOffset: Int, filenameOffset: Int, filesize: Long, imgWidth: Int, imgHeight: Int, xUnitsOffset: Int, yUnitsOffset: Int, zUnitsOffset: Int, imageSetIdOffset: Int, imageSetLength: Int, sequenceId: Int, descriptionOffset: Int, dataStartOffset: Int, dataStopOffset: Int, annLimsOffset: Int, annTextOffset: Int, keywordsOffset: Int, areaOffset: Int, atextOffset: Int, agjsonOffset: Int, atypeOffset: Int, andims: Int, asrid: Int, satIdOffset: Int, satIdConfOffset: Int, srcTypsOffset: Int, srcIdsOffset: Int, tagsOffset: Int, checksumValueOffset: Int, transactionIdOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, sourceDlOffset: Int, dataMode: Byte) : Int {
            ...
            return endAnalyticImagery_Ingest(builder)
        }
        fun startAnalyticImagery_Ingest(builder: FlatBufferBuilder) = builder.startTable(41)
        ...
        fun addArea(builder: FlatBufferBuilder, area: Int) = builder.addOffset(21, area, 0)
        fun addAtext(builder: FlatBufferBuilder, atext: Int) = builder.addOffset(22, atext, 0)
        fun addAgjson(builder: FlatBufferBuilder, agjson: Int) = builder.addOffset(23, agjson, 0)
        fun addAtype(builder: FlatBufferBuilder, atype: Int) = builder.addOffset(24, atype, 0)
        fun addAndims(builder: FlatBufferBuilder, andims: Int) = builder.addInt(25, andims, 0)
        fun addAsrid(builder: FlatBufferBuilder, asrid: Int) = builder.addInt(26, asrid, 0)
        fun addSatId(builder: FlatBufferBuilder, satId: Int) = builder.addOffset(27, satId, 0)
        ...
        fun addSatIdConf(builder: FlatBufferBuilder, satIdConf: Int) = builder.addOffset(28, satIdConf, 0)
        ...
        fun addSrcTyps(builder: FlatBufferBuilder, srcTyps: Int) = builder.addOffset(29, srcTyps, 0)
        ...
        fun addSrcIds(builder: FlatBufferBuilder, srcIds: Int) = builder.addOffset(30, srcIds, 0)
        ...
        fun addChecksumValue(builder: FlatBufferBuilder, checksumValue: Int) = builder.addOffset(32, checksumValue, 0)
        fun addTransactionId(builder: FlatBufferBuilder, transactionId: Int) = builder.addOffset(33, transactionId, 0)
        ...
        fun endAnalyticImagery_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishAnalyticImageryIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ANAL")
        fun finishSizePrefixedAnalyticImagery_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ANAL")
    }
}
