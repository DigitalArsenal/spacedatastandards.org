 ...
 */
@Suppress("unused")
class AirspaceControlOrderReference_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : AirspaceControlOrderReference_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsAirspaceControlOrderReference_Abridged(_bb: ByteBuffer): AirspaceControlOrderReference_Abridged = getRootAsAirspaceControlOrderReference_Abridged(_bb, AirspaceControlOrderReference_Abridged())
        fun getRootAsAirspaceControlOrderReference_Abridged(_bb: ByteBuffer, obj: AirspaceControlOrderReference_Abridged): AirspaceControlOrderReference_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun AirspaceControlOrderReference_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "AIRS")
        fun createAirspaceControlOrderReference_Abridged(builder: FlatBufferBuilder, refSidOffset: Int, refTypeOffset: Int, refOriginatorOffset: Int, refTsOffset: Int, refSerialNumOffset: Int, refSpecialNotationOffset: Int, refSicsOffset: Int) : Int {
            ...
            return endAirspaceControlOrderReference_Abridged(builder)
        }
        fun startAirspaceControlOrderReference_Abridged(builder: FlatBufferBuilder) = builder.startTable(7)
        ...
        fun endAirspaceControlOrderReference_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishAirspaceControlOrderReferenceAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "AIRS")
        fun finishSizePrefixedAirspaceControlOrderReference_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "AIRS")
    }
}
