 ...
 */
@Suppress("unused")
class EvacEnemyData_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : EvacEnemyData_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsEvacEnemyData_Full(_bb: ByteBuffer): EvacEnemyData_Full = getRootAsEvacEnemyData_Full(_bb, EvacEnemyData_Full())
        fun getRootAsEvacEnemyData_Full(_bb: ByteBuffer, obj: EvacEnemyData_Full): EvacEnemyData_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun EvacEnemyData_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "EVAC")
        fun createEvacEnemyData_Full(builder: FlatBufferBuilder, dirToEnemyOffset: Int, hostileFireTypeOffset: Int, friendliesRemarksOffset: Int, hlzRemarksOffset: Int) : Int {
            ...
            return endEvacEnemyData_Full(builder)
        }
        fun startEvacEnemyData_Full(builder: FlatBufferBuilder) = builder.startTable(4)
        ...
        fun endEvacEnemyData_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishEvacEnemyDataFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "EVAC")
        fun finishSizePrefixedEvacEnemyData_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "EVAC")
    }
}
