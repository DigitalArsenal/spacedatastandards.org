 ...
 */
@Suppress("unused")
class AttitudeSet_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : AttitudeSet_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createAttitudeSet_Ingest(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idOnOrbitOffset: Int, satNo: Int, origObjectIdOffset: Int, typeOffset: Int, esIdOffset: Int, asRefOffset: Int, idSensorOffset: Int, origSensorIdOffset: Int, startTimeOffset: Int, endTimeOffset: Int, frame1Offset: Int, frame2Offset: Int, numPoints: Int, stepSize: Int, precAngleInit: Double, spinAngleInit: Double, eulerRotSeqOffset: Int, attitudeListOffset: Int, interpolatorOffset: Int, interpolatorDegree: Int, notesOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, origNetworkOffset: Int) : Int {
            ...
            return endAttitudeSet_Ingest(builder)
        }
        fun startAttitudeSet_Ingest(builder: FlatBufferBuilder) = builder.startTable(29)
        ...
        fun endAttitudeSet_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishAttitudeSetIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ATTI")
        fun finishSizePrefixedAttitudeSet_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ATTI")
    }
}
