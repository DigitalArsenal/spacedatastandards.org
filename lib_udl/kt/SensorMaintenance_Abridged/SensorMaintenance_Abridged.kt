 ...
 */
@Suppress("unused")
class SensorMaintenance_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : SensorMaintenance_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createSensorMaintenance_Abridged(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, siteCodeOffset: Int, idSensorOffset: Int, startTimeOffset: Int, endTimeOffset: Int, recallOffset: Int, durationOffset: Int, mwOpsCapOffset: Int, ssOpsCapOffset: Int, mdOpsCapOffset: Int, impactedFacesOffset: Int, equipStatusOffset: Int, activityOffset: Int, remarkOffset: Int, requestorOffset: Int, changerOffset: Int, approverOffset: Int, eowIdOffset: Int, revOffset: Int, priorityOffset: Int, relOffset: Int, lineNumberOffset: Int, resourceOffset: Int, inactiveDateOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, origNetworkOffset: Int) : Int {
            ...
            return endSensorMaintenance_Abridged(builder)
        }
        fun startSensorMaintenance_Abridged(builder: FlatBufferBuilder) = builder.startTable(31)
        ...
        fun endSensorMaintenance_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishSensorMaintenanceAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "SENS")
        fun finishSizePrefixedSensorMaintenance_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "SENS")
    }
}
