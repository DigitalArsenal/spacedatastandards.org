 ...
 */
@Suppress("unused")
class PointOfContact_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : PointOfContact_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsPointOfContact_Full(_bb: ByteBuffer): PointOfContact_Full = getRootAsPointOfContact_Full(_bb, PointOfContact_Full())
        fun getRootAsPointOfContact_Full(_bb: ByteBuffer, obj: PointOfContact_Full): PointOfContact_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun PointOfContact_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "POIN")
        fun createPointOfContact_Full(builder: FlatBufferBuilder, pocSequenceId: Int, pocTypeNameOffset: Int, pocNameOffset: Int, officeOffset: Int, usernameOffset: Int, rankOffset: Int, pocOrgOffset: Int, phoneOffset: Int, remarkOffset: Int) : Int {
            ...
            return endPointOfContact_Full(builder)
        }
        fun startPointOfContact_Full(builder: FlatBufferBuilder) = builder.startTable(9)
        ...
        fun endPointOfContact_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishPointOfContactFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "POIN")
        fun finishSizePrefixedPointOfContact_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "POIN")
    }
}
