 ...
 */
@Suppress("unused")
class SARObservation_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : SARObservation_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val createdAtAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(128, 1)
    fun createdAtInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 128, 1)
    /**
    ...
    val createdByAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(130, 1)
    fun createdByInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 130, 1)
    /**
     * Source of the data.
    ...
    val origNetworkAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(136, 1)
    fun origNetworkInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 136, 1)
    /**
    ...
    val sourceDlAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(138, 1)
    fun sourceDlInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 138, 1)
    /**
    ...
    companion object {
        ...
        fun createSARObservation_Ingest(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idOnOrbitOffset: Int, satNo: Int, origObjectIdOffset: Int, idSensorOffset: Int, origSensorIdOffset: Int, externalIdOffset: Int, collectionIdOffset: Int, detectionIdOffset: Int, collectionStartOffset: Int, collectionEndOffset: Int, centerTimeOffset: Int, detectionStartOffset: Int, detectionEndOffset: Int, dwellTime: Double, orbitStateOffset: Int, sarModeOffset: Int, operatingBandOffset: Int, operatingFreq: Double, snr: Double, txPolarizationOffset: Int, rxPolarizationOffset: Int, grazeAngle: Double, incidenceAngle: Double, squintAngle: Double, pulseBandwidth: Double, pulseDuration: Double, continuousSpotAngle: Double, slantRange: Double, nearRange: Double, farRange: Double, swathLength: Double, areaOffset: Int, atextOffset: Int, agjsonOffset: Int, atypeOffset: Int, andims: Int, asrid: Int, spacingRange: Double, spacingAzimuth: Double, looksAzimuth: Int, looksRange: Int, resolutionRange: Double, resolutionAzimuth: Double, obDirectionOffset: Int, coordSysOffset: Int, targetposx: Double, targetposy: Double, targetposz: Double, senalt: Double, senvelx: Double, senvely: Double, senvelz: Double, senlatStart: Double, senlonStart: Double, senlatEnd: Double, senlonEnd: Double, transactionIdOffset: Int, tagsOffset: Int, srcTypsOffset: Int, srcIdsOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, sourceDlOffset: Int, dataMode: Byte) : Int {
            ...
            return endSARObservation_Ingest(builder)
        }
        fun startSARObservation_Ingest(builder: FlatBufferBuilder) = builder.startTable(69)
        ...
        fun addCreatedAt(builder: FlatBufferBuilder, createdAt: Int) = builder.addOffset(62, createdAt, 0)
        fun addCreatedBy(builder: FlatBufferBuilder, createdBy: Int) = builder.addOffset(63, createdBy, 0)
        ...
        fun addOrigNetwork(builder: FlatBufferBuilder, origNetwork: Int) = builder.addOffset(66, origNetwork, 0)
        fun addSourceDL(builder: FlatBufferBuilder, sourceDl: Int) = builder.addOffset(67, sourceDl, 0)
        fun addDataMode(builder: FlatBufferBuilder, dataMode: Byte) = builder.addByte(68, dataMode, 0)
        fun endSARObservation_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishSARObservationIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "SARO")
        fun finishSizePrefixedSARObservation_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "SARO")
    }
}
