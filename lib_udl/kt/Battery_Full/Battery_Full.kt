 ...
 */
@Suppress("unused")
class Battery_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Battery_Full {
        __init(_i, _bb)
        return this
    }
    /**
     ...
     * Constraints: No constraints specified.
     */
    fun batteryDetails(j: Int) : String? {
        val o = __offset(24)
        return if (o != 0) {
    ...
    val batteryDetailsLength : Int
        get() {
            val o = __offset(24); return if (o != 0) __vector_len(o) else 0
        }
    companion object {
        fun validateVersion() = Constants.FLATBUFFERS_24_3_25()
        fun getRootAsBattery_Full(_bb: ByteBuffer): Battery_Full = getRootAsBattery_Full(_bb, Battery_Full())
        fun getRootAsBattery_Full(_bb: ByteBuffer, obj: Battery_Full): Battery_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun Battery_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "BATT")
        fun createBattery_Full(builder: FlatBufferBuilder, idOffset: Int, nameOffset: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte, batteryDetailsOffset: Int) : Int {
            builder.startTable(11)
            addBatteryDetails(builder, batteryDetailsOffset)
            ...
            return endBattery_Full(builder)
        }
        fun startBattery_Full(builder: FlatBufferBuilder) = builder.startTable(11)
        ...
        fun addBatteryDetails(builder: FlatBufferBuilder, batteryDetails: Int) = builder.addOffset(10, batteryDetails, 0)
        fun createBatteryDetailsVector(builder: FlatBufferBuilder, data: IntArray) : Int {
        ...
        fun startBatteryDetailsVector(builder: FlatBufferBuilder, numElems: Int) = builder.startVector(4, numElems, 4)
        fun endBattery_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishBatteryFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "BATT")
        fun finishSizePrefixedBattery_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "BATT")
    }
}
