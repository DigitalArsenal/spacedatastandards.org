 ...
 */
@Suppress("unused")
class SGI_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : SGI_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val rawFileUriAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(86, 1)
    fun rawFileUriInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 86, 1)
    /**
    ...
    val transactionIdAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(88, 1)
    fun transactionIdInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 88, 1)
    /**
     * Source of the data.
    ...
    val sourceAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(90, 1)
    fun sourceInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 90, 1)
    /**
    ...
    val originAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(92, 1)
    fun originInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 92, 1)
    /**
    ...
    companion object {
        ...
        fun getRootAsSGI_Abridged(_bb: ByteBuffer): SGI_Abridged = getRootAsSGI_Abridged(_bb, SGI_Abridged())
        fun getRootAsSGI_Abridged(_bb: ByteBuffer, obj: SGI_Abridged): SGI_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun SGI_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "SGIA")
        fun createSGI_Abridged(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, effectiveDateOffset: Int, sgiDateOffset: Int, typeOffset: Int, state: Byte, stationNameOffset: Int, idSensorOffset: Int, origSensorIdOffset: Int, mode: Int, precedence: Byte, coeffDegreeOffset: Int, coeffOrderOffset: Int, ctceOffset: Int, stceOffset: Int, ctciOffset: Int, stciOffset: Int, e10: Double, e54: Double, s10: Double, s54: Double, m10: Double, m54: Double, y10: Double, y54: Double, f10: Double, f54: Double, f81: Double, ap: Double, apDuration: Int, kIndex: Int, kp: Double, kpDuration: Int, gamma: Int, dst: Double, dtc: Double, rbRegionCode: Int, rbIndex: Double, normFactor: Double, rbDuration: Int, analyzerAttenuation: Double, rawFileUriOffset: Int, transactionIdOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte, createdAtOffset: Int, createdByOffset: Int) : Int {
            ...
            return endSGI_Abridged(builder)
        }
        fun startSGI_Abridged(builder: FlatBufferBuilder) = builder.startTable(49)
        ...
        fun addRawFileURI(builder: FlatBufferBuilder, rawFileUri: Int) = builder.addOffset(41, rawFileUri, 0)
        fun addTransactionId(builder: FlatBufferBuilder, transactionId: Int) = builder.addOffset(42, transactionId, 0)
        fun addSource(builder: FlatBufferBuilder, source: Int) = builder.addOffset(43, source, 0)
        fun addOrigin(builder: FlatBufferBuilder, origin: Int) = builder.addOffset(44, origin, 0)
        ...
        fun endSGI_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishSGIAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "SGIA")
        fun finishSizePrefixedSGI_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "SGIA")
    }
}
