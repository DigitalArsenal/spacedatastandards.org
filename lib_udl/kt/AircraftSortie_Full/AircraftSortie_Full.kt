 ...
 */
@Suppress("unused")
class AircraftSortie_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : AircraftSortie_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val updatedAtAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(154, 1)
    fun updatedAtInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 154, 1)
    /**
    ...
    val updatedByAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(156, 1)
    fun updatedByInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 156, 1)
    /**
    ...
    val sourceDlAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(158, 1)
    fun sourceDlInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 158, 1)
    /**
     * Source of the data.
    ...
    val crewAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(168, 1)
    fun crewInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 168, 1)
    /**
     * No description provided.
     * Example: /// Example: No example provided.
     * Constraints: No constraints specified.
     */
    fun sortiePpr(j: Int) : String? {
        val o = __offset(170)
        return if (o != 0) {
    ...
    companion object {
        ...
        fun createAircraftSortie_Full(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, origSortieIdOffset: Int, idAircraftOffset: Int, aircraftAltIdOffset: Int, tailNumberOffset: Int, aircraftMdsOffset: Int, aircraftAdsbOffset: Int, sortieDateOffset: Int, lineNumber: Int, idMissionOffset: Int, missionIdOffset: Int, amcMsnNumOffset: Int, amcMsnTypeOffset: Int, callSignOffset: Int, jcsPriorityOffset: Int, primarySclOffset: Int, secondarySclOffset: Int, reqConfigOffset: Int, cargoConfigOffset: Int, fuelReq: Double, oxyReqCrew: Double, oxyOnCrew: Double, oxyReqPax: Double, oxyOnPax: Double, alertStatusCodeOffset: Int, alertStatus: Int, currentStateOffset: Int, depItinerary: Int, depIcaoOffset: Int, depIataOffset: Int, depFaaOffset: Int, plannedDepTimeOffset: Int, estDepTimeOffset: Int, actualDepTimeOffset: Int, estBlockOutTimeOffset: Int, actualBlockOutTimeOffset: Int, depPurposeCodeOffset: Int, arrItinerary: Int, arrIcaoOffset: Int, arrIataOffset: Int, arrFaaOffset: Int, plannedArrTimeOffset: Int, estArrTimeOffset: Int, actualArrTimeOffset: Int, estBlockInTimeOffset: Int, actualBlockInTimeOffset: Int, arrPurposeCodeOffset: Int, dhdOffset: Int, dhdReasonOffset: Int, aircraftEventOffset: Int, soeOffset: Int, legNum: Int, flightTime: Double, gndTime: Double, rawFileUriOffset: Int, papersVersionOffset: Int, filenameOffset: Int, filesize: Int, paperStatus: Byte, pprStatus: Byte, missionUpdateOffset: Int, delayCodeOffset: Int, commanderNameOffset: Int, fmDeskNumOffset: Int, fmNameOffset: Int, rvnReq: Byte, passengers: Int, parkingLocOffset: Int, objectiveRemarksOffset: Int, aircraftRemarksOffset: Int, scheduleRemarksOffset: Int, resultRemarksOffset: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceDlOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, origNetworkOffset: Int, crewOffset: Int, sortiePprOffset: Int) : Int {
            ...
            addSortiePPR(builder, sortiePprOffset)
            addCrew(builder, crewOffset)
            ...
            return endAircraftSortie_Full(builder)
        }
        fun startAircraftSortie_Full(builder: FlatBufferBuilder) = builder.startTable(84)
        ...
        fun addUpdatedAt(builder: FlatBufferBuilder, updatedAt: Int) = builder.addOffset(75, updatedAt, 0)
        fun addUpdatedBy(builder: FlatBufferBuilder, updatedBy: Int) = builder.addOffset(76, updatedBy, 0)
        fun addSourceDL(builder: FlatBufferBuilder, sourceDl: Int) = builder.addOffset(77, sourceDl, 0)
        ...
        fun addCrew(builder: FlatBufferBuilder, crew: Int) = builder.addOffset(82, crew, 0)
        fun addSortiePPR(builder: FlatBufferBuilder, sortiePpr: Int) = builder.addOffset(83, sortiePpr, 0)
        fun createSortiePprVector(builder: FlatBufferBuilder, data: IntArray) : Int {
        ...
        fun startSortiePprVector(builder: FlatBufferBuilder, numElems: Int) = builder.startVector(4, numElems, 4)
        fun endAircraftSortie_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishAircraftSortieFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "AIRC")
        fun finishSizePrefixedAircraftSortie_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "AIRC")
    }
}
