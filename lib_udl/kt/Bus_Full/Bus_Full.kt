 ...
 */
@Suppress("unused")
class Bus_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Bus_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val updatedAtAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(116, 1)
    fun updatedAtInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 116, 1)
    /**
    ...
    val updatedByAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(118, 1)
    fun updatedByInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 118, 1)
    /**
    ...
    companion object {
        ...
        fun createBus_Full(builder: FlatBufferBuilder, idOffset: Int, nameOffset: Int, classificationMarkingOffset: Int, idEntityOffset: Int, typeOffset: Int, maxLaunchMassLower: Double, maxLaunchMassUpper: Double, maxBolstationMass: Double, avgPayloadMass: Double, maxPayloadMass: Double, minDryMass: Double, avgDryMass: Double, medianDryMass: Double, maxDryMass: Double, minWetMass: Double, avgWetMass: Double, medianWetMass: Double, maxWetMass: Double, maxBolpowerLower: Double, maxBolpowerUpper: Double, maxEolpowerLower: Double, maxEolpowerUpper: Double, avgSpacecraftPower: Double, maxSpacecraftPower: Double, oapSpacecraftPower: Double, avgPayloadPower: Double, maxPayloadPower: Double, oapPayloadPower: Double, bodyDimensionX: Double, bodyDimensionY: Double, bodyDimensionZ: Double, payloadDimensionX: Double, payloadDimensionY: Double, payloadDimensionZ: Double, payloadVolume: Double, launchEnvelopeDimensionX: Double, launchEnvelopeDimensionY: Double, launchEnvelopeDimensionZ: Double, numOrbitType: Int, orbitTypesOffset: Int, telemetryTrackingManufacturerOrgIdOffset: Int, mainComputerManufacturerOrgIdOffset: Int, manufacturerOrgIdOffset: Int, busKitDesignerOrgIdOffset: Int, countryCodeOffset: Int, massCategoryOffset: Int, powerCategoryOffset: Int, generic: Boolean, descriptionOffset: Int, aocsNotesOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, entityOffset: Int) : Int {
            ...
            return endBus_Full(builder)
        }
        fun startBus_Full(builder: FlatBufferBuilder) = builder.startTable(59)
        ...
        fun addUpdatedAt(builder: FlatBufferBuilder, updatedAt: Int) = builder.addOffset(56, updatedAt, 0)
        fun addUpdatedBy(builder: FlatBufferBuilder, updatedBy: Int) = builder.addOffset(57, updatedBy, 0)
        fun addEntity(builder: FlatBufferBuilder, entity: Int) = builder.addOffset(58, entity, 0)
        fun endBus_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishBusFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "BUSF")
        fun finishSizePrefixedBus_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "BUSF")
    }
}
