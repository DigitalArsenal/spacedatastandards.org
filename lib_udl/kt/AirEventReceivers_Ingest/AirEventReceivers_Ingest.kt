 ...
 */
@Suppress("unused")
class AirEventReceivers_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : AirEventReceivers_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsAirEventReceivers_Ingest(_bb: ByteBuffer): AirEventReceivers_Ingest = getRootAsAirEventReceivers_Ingest(_bb, AirEventReceivers_Ingest())
        fun getRootAsAirEventReceivers_Ingest(_bb: ByteBuffer, obj: AirEventReceivers_Ingest): AirEventReceivers_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun AirEventReceivers_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "AIRE")
        fun createAirEventReceivers_Ingest(builder: FlatBufferBuilder, idReceiverSortieOffset: Int, idReceiverMissionOffset: Int, idReceiverAirfieldOffset: Int, externalReceiverIdOffset: Int, receiverCoordOffset: Int, receiverMdsOffset: Int, amcReceiverMissionIdOffset: Int, altReceiverMissionIdOffset: Int, receiverCallSignOffset: Int, receiverOwnerOffset: Int, receiverPocOffset: Int, receiverLegNum: Int, receiverDeployedIcaoOffset: Int, receiverDeliveryMethodOffset: Int, fuelOn: Double, receiverCellPosition: Int, sequenceNumOffset: Int, recOrgOffset: Int, numRecAircraft: Int, receiverFuelTypeOffset: Int, receiverExerciseOffset: Int, packageIdOffset: Int) : Int {
            ...
            return endAirEventReceivers_Ingest(builder)
        }
        fun startAirEventReceivers_Ingest(builder: FlatBufferBuilder) = builder.startTable(22)
        ...
        fun endAirEventReceivers_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishAirEventReceiversIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "AIRE")
        fun finishSizePrefixedAirEventReceivers_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "AIRE")
    }
}
