 ...
 */
@Suppress("unused")
class OpticalSOIObservation_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : OpticalSOIObservation_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsOpticalSOIObservation_Ingest(_bb: ByteBuffer): OpticalSOIObservation_Ingest = getRootAsOpticalSOIObservation_Ingest(_bb, OpticalSOIObservation_Ingest())
        fun getRootAsOpticalSOIObservation_Ingest(_bb: ByteBuffer, obj: OpticalSOIObservation_Ingest): OpticalSOIObservation_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun OpticalSOIObservation_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "OPTI")
        fun createOpticalSOIObservation_Ingest(builder: FlatBufferBuilder, obStartTimeOffset: Int, intensityTimesOffset: Int, currentSpectralFilterNum: Int, expDuration: Double, intensitiesOffset: Int, extinctionCoeffsOffset: Int, extinctionCoeffsUncOffset: Int, skyBgsOffset: Int, localSkyBgsOffset: Int, localSkyBgsUncOffset: Int, numDetectedStarsOffset: Int, numCorrelatedStarsOffset: Int, zeroPointsOffset: Int, rasOffset: Int, declinationsOffset: Int, raRatesOffset: Int, percentSatsOffset: Int) : Int {
            ...
            return endOpticalSOIObservation_Ingest(builder)
        }
        fun startOpticalSOIObservation_Ingest(builder: FlatBufferBuilder) = builder.startTable(17)
        ...
        fun endOpticalSOIObservation_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishOpticalSOIObservationIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "OPTI")
        fun finishSizePrefixedOpticalSOIObservation_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "OPTI")
    }
}
