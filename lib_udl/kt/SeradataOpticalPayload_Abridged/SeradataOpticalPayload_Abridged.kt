 ...
 */
@Suppress("unused")
class SeradataOpticalPayload_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : SeradataOpticalPayload_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createSeradataOpticalPayload_Abridged(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, spacecraftIdOffset: Int, idSensorOffset: Int, hostedForCompanyOrgIdOffset: Int, manufacturerOrgIdOffset: Int, imagingPayloadCategoryOffset: Int, nameOffset: Int, spectralBandOffset: Int, spectralFrequencyLimitsOffset: Int, numberOfFilmReturnCanisters: Int, bestResolution: Double, swathWidth: Double, recorderSizeOffset: Int, fieldOfView: Double, fieldOfRegard: Double, pointingMethodOffset: Int, groundStationsOffset: Int, groundStationLocationsOffset: Int, notesOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endSeradataOpticalPayload_Abridged(builder)
        }
        fun startSeradataOpticalPayload_Abridged(builder: FlatBufferBuilder) = builder.startTable(26)
        ...
        fun endSeradataOpticalPayload_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishSeradataOpticalPayloadAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "SERA")
        fun finishSizePrefixedSeradataOpticalPayload_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "SERA")
    }
}
