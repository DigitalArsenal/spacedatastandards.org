 ...
 */
@Suppress("unused")
class IonoObservationDensityProfile_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : IonoObservationDensityProfile_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsIonoObservationDensityProfile_Ingest(_bb: ByteBuffer): IonoObservationDensityProfile_Ingest = getRootAsIonoObservationDensityProfile_Ingest(_bb, IonoObservationDensityProfile_Ingest())
        fun getRootAsIonoObservationDensityProfile_Ingest(_bb: ByteBuffer, obj: IonoObservationDensityProfile_Ingest): IonoObservationDensityProfile_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun IonoObservationDensityProfile_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "IONO")
        fun createIonoObservationDensityProfile_Ingest(builder: FlatBufferBuilder, parabolicOffset: Int, quasiParabolicOffset: Int, valleyModelDescriptionOffset: Int, valleyModelCoeffsOffset: Int, shiftedChebyshevOffset: Int, topsideExtensionChapmanConstOffset: Int, topsideExtensionVaryChapOffset: Int, iriOffset: Int) : Int {
            ...
            return endIonoObservationDensityProfile_Ingest(builder)
        }
        fun startIonoObservationDensityProfile_Ingest(builder: FlatBufferBuilder) = builder.startTable(8)
        ...
        fun endIonoObservationDensityProfile_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishIonoObservationDensityProfileIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "IONO")
        fun finishSizePrefixedIonoObservationDensityProfile_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "IONO")
    }
}
