 ...
 */
@Suppress("unused")
class Notification_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Notification_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsNotification_Abridged(_bb: ByteBuffer): Notification_Abridged = getRootAsNotification_Abridged(_bb, Notification_Abridged())
        fun getRootAsNotification_Abridged(_bb: ByteBuffer, obj: Notification_Abridged): Notification_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun Notification_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "NOTI")
        fun createNotification_Abridged(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, msgTypeOffset: Int, msgBodyOffset: Int, dataMode: Byte, sourceDlOffset: Int, sourceOffset: Int, originOffset: Int, tagsOffset: Int, createdAtOffset: Int, createdByOffset: Int, origNetworkOffset: Int) : Int {
            ...
            return endNotification_Abridged(builder)
        }
        fun startNotification_Abridged(builder: FlatBufferBuilder) = builder.startTable(12)
        ...
        fun endNotification_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishNotificationAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "NOTI")
        fun finishSizePrefixedNotification_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "NOTI")
    }
}
