 ...
 */
@Suppress("unused")
class ISRCollectionPOC_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : ISRCollectionPOC_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsISRCollectionPOC_Full(_bb: ByteBuffer): ISRCollectionPOC_Full = getRootAsISRCollectionPOC_Full(_bb, ISRCollectionPOC_Full())
        fun getRootAsISRCollectionPOC_Full(_bb: ByteBuffer, obj: ISRCollectionPOC_Full): ISRCollectionPOC_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun ISRCollectionPOC_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "ISRC")
        fun createISRCollectionPOC_Full(builder: FlatBufferBuilder, idOffset: Int, nameOffset: Int, callsignOffset: Int, unitOffset: Int, emailOffset: Int, phoneOffset: Int, radioFrequency: Double, chatSystemOffset: Int, chatNameOffset: Int, notesOffset: Int) : Int {
            ...
            return endISRCollectionPOC_Full(builder)
        }
        fun startISRCollectionPOC_Full(builder: FlatBufferBuilder) = builder.startTable(10)
        ...
        fun endISRCollectionPOC_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishISRCollectionPOCFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ISRC")
        fun finishSizePrefixedISRCollectionPOC_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ISRC")
    }
}
