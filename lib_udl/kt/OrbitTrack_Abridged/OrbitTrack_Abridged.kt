 ...
 */
@Suppress("unused")
class OrbitTrack_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : OrbitTrack_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val idElsetAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(14, 1)
    fun idElsetInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 14, 1)
    /**
    ...
    val identAmpAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(32, 1)
    fun identAmpInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 32, 1)
    /**
    ...
    val satStatusAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(34, 1)
    fun satStatusInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 34, 1)
    /**
    ...
    val charlieLineAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(42, 1)
    fun charlieLineInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 42, 1)
    /**
    ...
    val aouTypeAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(44, 1)
    fun aouTypeInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 44, 1)
    /**
    ...
    val xrefAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(54, 1)
    fun xrefInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 54, 1)
    /**
    ...
    val chXrefAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(56, 1)
    fun chXrefInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 56, 1)
    /**
    ...
    val amplificationAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(58, 1)
    fun amplificationInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 58, 1)
    /**
    ...
    val iffAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(60, 1)
    fun iffInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 60, 1)
    /**
    ...
    val vehTypeAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(76, 1)
    fun vehTypeInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 76, 1)
    /**
    ...
    val trkIdAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(78, 1)
    fun trkIdInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 78, 1)
    /**
    ...
    val createdAtAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(82, 1)
    fun createdAtInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 82, 1)
    /**
    ...
    val createdByAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(84, 1)
    fun createdByInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 84, 1)
    /**
     * Source of the data.
    ...
    companion object {
        ...
        fun createOrbitTrack_Abridged(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idOnOrbitOffset: Int, satNo: Int, origObjectIdOffset: Int, idElsetOffset: Int, tsOffset: Int, lat: Double, lon: Double, alt: Double, rdfRf: Double, callSignOffset: Int, rptNumOffset: Int, objIdent: Byte, identAmpOffset: Int, satStatusOffset: Int, objectType: Byte, countryCodeOffset: Int, decay: Double, charlieLineOffset: Int, aouTypeOffset: Int, aouDataOffset: Int, spd: Double, angElev: Double, cntnmnt: Double, xrefOffset: Int, chXrefOffset: Int, amplificationOffset: Int, iffOffset: Int, reinforced: Boolean, reduced: Boolean, hq: Boolean, dummy: Boolean, taskForce: Boolean, feint: Boolean, installation: Boolean, vehTypeOffset: Int, trkIdOffset: Int, trackSensorsOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, origNetworkOffset: Int) : Int {
            ...
            return endOrbitTrack_Abridged(builder)
        }
        fun startOrbitTrack_Abridged(builder: FlatBufferBuilder) = builder.startTable(45)
        ...
        fun addIdElset(builder: FlatBufferBuilder, idElset: Int) = builder.addOffset(5, idElset, 0)
        ...
        fun addObjIdent(builder: FlatBufferBuilder, objIdent: Byte) = builder.addByte(13, objIdent, 0)
        fun addIdentAmp(builder: FlatBufferBuilder, identAmp: Int) = builder.addOffset(14, identAmp, 0)
        fun addSatStatus(builder: FlatBufferBuilder, satStatus: Int) = builder.addOffset(15, satStatus, 0)
        fun addObjectType(builder: FlatBufferBuilder, objectType: Byte) = builder.addByte(16, objectType, 0)
        fun addCountryCode(builder: FlatBufferBuilder, countryCode: Int) = builder.addOffset(17, countryCode, 0)
        fun addDecay(builder: FlatBufferBuilder, decay: Double) = builder.addDouble(18, decay, 0.0)
        fun addCharlieLine(builder: FlatBufferBuilder, charlieLine: Int) = builder.addOffset(19, charlieLine, 0)
        fun addAouType(builder: FlatBufferBuilder, aouType: Int) = builder.addOffset(20, aouType, 0)
        fun addAouData(builder: FlatBufferBuilder, aouData: Int) = builder.addOffset(21, aouData, 0)
        ...
        fun addSpd(builder: FlatBufferBuilder, spd: Double) = builder.addDouble(22, spd, 0.0)
        fun addAngElev(builder: FlatBufferBuilder, angElev: Double) = builder.addDouble(23, angElev, 0.0)
        fun addCntnmnt(builder: FlatBufferBuilder, cntnmnt: Double) = builder.addDouble(24, cntnmnt, 0.0)
        fun addXref(builder: FlatBufferBuilder, xref: Int) = builder.addOffset(25, xref, 0)
        fun addChXRef(builder: FlatBufferBuilder, chXref: Int) = builder.addOffset(26, chXref, 0)
        fun addAmplification(builder: FlatBufferBuilder, amplification: Int) = builder.addOffset(27, amplification, 0)
        fun addIff(builder: FlatBufferBuilder, iff: Int) = builder.addOffset(28, iff, 0)
        ...
        fun addVehType(builder: FlatBufferBuilder, vehType: Int) = builder.addOffset(36, vehType, 0)
        fun addTrkId(builder: FlatBufferBuilder, trkId: Int) = builder.addOffset(37, trkId, 0)
        fun addTrackSensors(builder: FlatBufferBuilder, trackSensors: Int) = builder.addOffset(38, trackSensors, 0)
        ...
        fun addCreatedAt(builder: FlatBufferBuilder, createdAt: Int) = builder.addOffset(39, createdAt, 0)
        fun addCreatedBy(builder: FlatBufferBuilder, createdBy: Int) = builder.addOffset(40, createdBy, 0)
        ...
        fun endOrbitTrack_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishOrbitTrackAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ORBI")
        fun finishSizePrefixedOrbitTrack_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ORBI")
    }
}
