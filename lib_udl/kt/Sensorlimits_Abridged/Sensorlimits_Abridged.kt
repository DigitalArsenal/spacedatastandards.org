 ...
 */
@Suppress("unused")
class Sensorlimits_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Sensorlimits_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsSensorlimits_Abridged(_bb: ByteBuffer): Sensorlimits_Abridged = getRootAsSensorlimits_Abridged(_bb, Sensorlimits_Abridged())
        fun getRootAsSensorlimits_Abridged(_bb: ByteBuffer, obj: Sensorlimits_Abridged): Sensorlimits_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun Sensorlimits_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "SENS")
        fun createSensorlimits_Abridged(builder: FlatBufferBuilder, idSensorLimitsOffset: Int, classificationMarkingOffset: Int, origNetworkOffset: Int, upperLeftAzimuthLimit: Double, upperRightAzimuthLimit: Double, lowerRightAzimuthLimit: Double, lowerLeftAzimuthLimit: Double, lowerLeftElevationLimit: Double, upperLeftElevationLimit: Double, lowerRightElevationLimit: Double, upperRightElevationLimit: Double, sourceOffset: Int, dataMode: Byte, createdAtOffset: Int, createdByOffset: Int, idSensorOffset: Int) : Int {
            ...
            return endSensorlimits_Abridged(builder)
        }
        fun startSensorlimits_Abridged(builder: FlatBufferBuilder) = builder.startTable(16)
        ...
        fun endSensorlimits_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishSensorlimitsAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "SENS")
        fun finishSizePrefixedSensorlimits_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "SENS")
    }
}
