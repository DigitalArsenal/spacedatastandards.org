 ...
 */
@Suppress("unused")
class Notification_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Notification_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsNotification_Ingest(_bb: ByteBuffer): Notification_Ingest = getRootAsNotification_Ingest(_bb, Notification_Ingest())
        fun getRootAsNotification_Ingest(_bb: ByteBuffer, obj: Notification_Ingest): Notification_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun Notification_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "NOTI")
        fun createNotification_Ingest(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, msgTypeOffset: Int, msgBodyOffset: Int, dataMode: Byte, sourceDlOffset: Int, sourceOffset: Int, originOffset: Int, tagsOffset: Int, createdAtOffset: Int, createdByOffset: Int, origNetworkOffset: Int) : Int {
            ...
            return endNotification_Ingest(builder)
        }
        fun startNotification_Ingest(builder: FlatBufferBuilder) = builder.startTable(12)
        ...
        fun endNotification_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishNotificationIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "NOTI")
        fun finishSizePrefixedNotification_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "NOTI")
    }
}
