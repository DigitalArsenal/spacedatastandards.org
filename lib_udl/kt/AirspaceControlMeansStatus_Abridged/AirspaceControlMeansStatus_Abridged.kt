 ...
 */
@Suppress("unused")
class AirspaceControlMeansStatus_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : AirspaceControlMeansStatus_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsAirspaceControlMeansStatus_Abridged(_bb: ByteBuffer): AirspaceControlMeansStatus_Abridged = getRootAsAirspaceControlMeansStatus_Abridged(_bb, AirspaceControlMeansStatus_Abridged())
        fun getRootAsAirspaceControlMeansStatus_Abridged(_bb: ByteBuffer, obj: AirspaceControlMeansStatus_Abridged): AirspaceControlMeansStatus_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun AirspaceControlMeansStatus_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "AIRS")
        fun createAirspaceControlMeansStatus_Abridged(builder: FlatBufferBuilder, cmStatOffset: Int, cmStatIdOffset: Int, airspaceControlMeansOffset: Int) : Int {
            ...
            return endAirspaceControlMeansStatus_Abridged(builder)
        }
        fun startAirspaceControlMeansStatus_Abridged(builder: FlatBufferBuilder) = builder.startTable(3)
        ...
        fun endAirspaceControlMeansStatus_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishAirspaceControlMeansStatusAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "AIRS")
        fun finishSizePrefixedAirspaceControlMeansStatus_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "AIRS")
    }
}
