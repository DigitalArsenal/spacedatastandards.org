 ...
 */
@Suppress("unused")
class SWIR_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : SWIR_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createSWIR_Full(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idOnOrbitOffset: Int, onOrbitOffset: Int, tsOffset: Int, solarPhaseAngle: Double, lat: Double, lon: Double, locationNameOffset: Int, badWaveOffset: Int, wavelengthsOffset: Int, absFluxesOffset: Int, ratioWavelengthsOffset: Int, fluxRatiosOffset: Int, origObjectIdOffset: Int, sourceOffset: Int, originOffset: Int, satNo: Int, dataMode: Byte, createdAtOffset: Int, createdByOffset: Int, origNetworkOffset: Int) : Int {
            ...
            return endSWIR_Full(builder)
        }
        fun startSWIR_Full(builder: FlatBufferBuilder) = builder.startTable(22)
        ...
        fun addSatNo(builder: FlatBufferBuilder, satNo: Int) = builder.addInt(17, satNo, 0)
        ...
        fun endSWIR_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishSWIRFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "SWIR")
        fun finishSizePrefixedSWIR_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "SWIR")
    }
}
