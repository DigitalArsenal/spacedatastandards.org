 ...
 */
@Suppress("unused")
class SolarArrayDetails_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : SolarArrayDetails_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsSolarArrayDetails_Ingest(_bb: ByteBuffer): SolarArrayDetails_Ingest = getRootAsSolarArrayDetails_Ingest(_bb, SolarArrayDetails_Ingest())
        fun getRootAsSolarArrayDetails_Ingest(_bb: ByteBuffer, obj: SolarArrayDetails_Ingest): SolarArrayDetails_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun SolarArrayDetails_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "SOLA")
        fun createSolarArrayDetails_Ingest(builder: FlatBufferBuilder, idOffset: Int, idSolarArrayOffset: Int, classificationMarkingOffset: Int, typeOffset: Int, technologyOffset: Int, junctionTechnologyOffset: Int, manufacturerOrgIdOffset: Int, span: Double, area: Double, descriptionOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte, tagsOffset: Int) : Int {
            ...
            return endSolarArrayDetails_Ingest(builder)
        }
        fun startSolarArrayDetails_Ingest(builder: FlatBufferBuilder) = builder.startTable(17)
        ...
        fun addTags(builder: FlatBufferBuilder, tags: Int) = builder.addOffset(16, tags, 0)
        ...
        fun endSolarArrayDetails_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishSolarArrayDetailsIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "SOLA")
        fun finishSizePrefixedSolarArrayDetails_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "SOLA")
    }
}
