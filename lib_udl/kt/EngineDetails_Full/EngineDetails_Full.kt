 ...
 */
@Suppress("unused")
class EngineDetails_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : EngineDetails_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsEngineDetails_Full(_bb: ByteBuffer): EngineDetails_Full = getRootAsEngineDetails_Full(_bb, EngineDetails_Full())
        fun getRootAsEngineDetails_Full(_bb: ByteBuffer, obj: EngineDetails_Full): EngineDetails_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun EngineDetails_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "ENGI")
        fun createEngineDetails_Full(builder: FlatBufferBuilder, idOffset: Int, idEngineOffset: Int, classificationMarkingOffset: Int, familyOffset: Int, cycleTypeOffset: Int, characteristicTypeOffset: Int, manufacturerOrgIdOffset: Int, specificImpulse: Double, burnTime: Double, seaLevelThrust: Double, vacuumThrust: Double, chamberPressure: Double, nozzleExpansionRatio: Double, maxFirings: Int, propellantOffset: Int, oxidizerOffset: Int, notesOffset: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte, tagsOffset: Int) : Int {
            ...
            return endEngineDetails_Full(builder)
        }
        fun startEngineDetails_Full(builder: FlatBufferBuilder) = builder.startTable(26)
        ...
        fun addTags(builder: FlatBufferBuilder, tags: Int) = builder.addOffset(25, tags, 0)
        ...
        fun endEngineDetails_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishEngineDetailsFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ENGI")
        fun finishSizePrefixedEngineDetails_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ENGI")
    }
}
