...
class Battery : Table() {
    ...
    fun __assign(_i: Int, _bb: ByteBuffer) : Battery {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsBattery(_bb: ByteBuffer): Battery = getRootAsBattery(_bb, Battery())
        fun getRootAsBattery(_bb: ByteBuffer, obj: Battery): Battery {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun BatteryBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "BATT")
        fun createBattery(builder: FlatBufferBuilder, idOffset: Int, nameOffset: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte, batteryDetailsOffset: Int) : Int {
            ...
            return endBattery(builder)
        }
        fun startBattery(builder: FlatBufferBuilder) = builder.startTable(11)
        ...
        fun endBattery(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishBatteryBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "BATT")
        fun finishSizePrefixedBatteryBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "BATT")
    }
}
