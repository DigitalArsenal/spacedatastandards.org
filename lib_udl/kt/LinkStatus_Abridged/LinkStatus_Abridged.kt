 ...
 */
@Suppress("unused")
class LinkStatus_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : LinkStatus_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createLinkStatus_Abridged(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idOnOrbit1Offset: Int, idOnOrbit2Offset: Int, linkStartTimeOffset: Int, linkStopTimeOffset: Int, constellationOffset: Int, linkNameOffset: Int, linkTypeOffset: Int, bandOffset: Int, idBeam1Offset: Int, endPoint1NameOffset: Int, endPoint1Lat: Double, endPoint1Lon: Double, idBeam2Offset: Int, endPoint2NameOffset: Int, endPoint2Lat: Double, endPoint2Lon: Double, dataRate1To2: Double, dataRate2To1: Double, linkStateOffset: Int, sysCapOffset: Int, opsCapOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte, satNo1: Int, satNo2: Int) : Int {
            ...
            return endLinkStatus_Abridged(builder)
        }
        fun startLinkStatus_Abridged(builder: FlatBufferBuilder) = builder.startTable(31)
        ...
        fun endLinkStatus_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishLinkStatusAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "LINK")
        fun finishSizePrefixedLinkStatus_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "LINK")
    }
}
