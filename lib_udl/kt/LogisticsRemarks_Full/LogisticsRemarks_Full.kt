 ...
 */
@Suppress("unused")
class LogisticsRemarks_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : LogisticsRemarks_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsLogisticsRemarks_Full(_bb: ByteBuffer): LogisticsRemarks_Full = getRootAsLogisticsRemarks_Full(_bb, LogisticsRemarks_Full())
        fun getRootAsLogisticsRemarks_Full(_bb: ByteBuffer, obj: LogisticsRemarks_Full): LogisticsRemarks_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun LogisticsRemarks_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "LOGI")
        fun createLogisticsRemarks_Full(builder: FlatBufferBuilder, usernameOffset: Int, remarkOffset: Int, lastChangedOffset: Int) : Int {
            builder.startTable(3)
            addLastChanged(builder, lastChangedOffset)
            addRemark(builder, remarkOffset)
            addUsername(builder, usernameOffset)
            return endLogisticsRemarks_Full(builder)
        }
        fun startLogisticsRemarks_Full(builder: FlatBufferBuilder) = builder.startTable(3)
        ...
        fun endLogisticsRemarks_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishLogisticsRemarksFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "LOGI")
        fun finishSizePrefixedLogisticsRemarks_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "LOGI")
    }
}
