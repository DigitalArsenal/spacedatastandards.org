 ...
 */
@Suppress("unused")
class SensorStats_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : SensorStats_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsSensorStats_Ingest(_bb: ByteBuffer): SensorStats_Ingest = getRootAsSensorStats_Ingest(_bb, SensorStats_Ingest())
        fun getRootAsSensorStats_Ingest(_bb: ByteBuffer, obj: SensorStats_Ingest): SensorStats_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun SensorStats_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "SENS")
        fun createSensorStats_Ingest(builder: FlatBufferBuilder, idOffset: Int, idSensorOffset: Int, classificationMarkingOffset: Int, lastObTimeOffset: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceOffset: Int, dataMode: Byte) : Int {
            ...
            return endSensorStats_Ingest(builder)
        }
        fun startSensorStats_Ingest(builder: FlatBufferBuilder) = builder.startTable(10)
        ...
        fun endSensorStats_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishSensorStatsIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "SENS")
        fun finishSizePrefixedSensorStats_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "SENS")
    }
}
