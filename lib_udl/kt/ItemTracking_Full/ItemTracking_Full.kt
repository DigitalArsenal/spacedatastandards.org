 ...
 */
@Suppress("unused")
class ItemTracking_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : ItemTracking_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsItemTracking_Full(_bb: ByteBuffer): ItemTracking_Full = getRootAsItemTracking_Full(_bb, ItemTracking_Full())
        fun getRootAsItemTracking_Full(_bb: ByteBuffer, obj: ItemTracking_Full): ItemTracking_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun ItemTracking_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "ITEM")
        fun createItemTracking_Full(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, scanCodeOffset: Int, scGenToolOffset: Int, scannerIdOffset: Int, tsOffset: Int, idItemOffset: Int, typeOffset: Int, lat: Double, lon: Double, scanTypeOffset: Int, dvCodeOffset: Int, notesOffset: Int, keysOffset: Int, valuesOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceDlOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endItemTracking_Full(builder)
        }
        fun startItemTracking_Full(builder: FlatBufferBuilder) = builder.startTable(22)
        ...
        fun endItemTracking_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishItemTrackingFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ITEM")
        fun finishSizePrefixedItemTracking_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ITEM")
    }
}
