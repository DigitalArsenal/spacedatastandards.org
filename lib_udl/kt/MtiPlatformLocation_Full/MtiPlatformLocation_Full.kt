 ...
 */
@Suppress("unused")
class MtiPlatformLocation_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : MtiPlatformLocation_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsMtiPlatformLocation_Full(_bb: ByteBuffer): MtiPlatformLocation_Full = getRootAsMtiPlatformLocation_Full(_bb, MtiPlatformLocation_Full())
        fun getRootAsMtiPlatformLocation_Full(_bb: ByteBuffer, obj: MtiPlatformLocation_Full): MtiPlatformLocation_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun MtiPlatformLocation_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "MTIP")
        fun createMtiPlatformLocation_Full(builder: FlatBufferBuilder, l1: Long, l2: Double, l3: Double, l4: Int, l5: Double, l6: Int, l7: Int, platloctsOffset: Int) : Int {
            ...
            addL6(builder, l6)
            addL4(builder, l4)
            return endMtiPlatformLocation_Full(builder)
        }
        fun startMtiPlatformLocation_Full(builder: FlatBufferBuilder) = builder.startTable(8)
        ...
        fun endMtiPlatformLocation_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishMtiPlatformLocationFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "MTIP")
        fun finishSizePrefixedMtiPlatformLocation_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "MTIP")
    }
}
