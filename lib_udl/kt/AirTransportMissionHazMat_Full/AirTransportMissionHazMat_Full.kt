 ...
 */
@Suppress("unused")
class AirTransportMissionHazMat_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : AirTransportMissionHazMat_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsAirTransportMissionHazMat_Full(_bb: ByteBuffer): AirTransportMissionHazMat_Full = getRootAsAirTransportMissionHazMat_Full(_bb, AirTransportMissionHazMat_Full())
        fun getRootAsAirTransportMissionHazMat_Full(_bb: ByteBuffer, obj: AirTransportMissionHazMat_Full): AirTransportMissionHazMat_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun AirTransportMissionHazMat_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "AIRT")
        fun createAirTransportMissionHazMat_Full(builder: FlatBufferBuilder, extHazMatIdOffset: Int, itemNameOffset: Int, unNumOffset: Int, pieces: Int, weight: Double, netExpWt: Double, classDiv: Double, cgcOffset: Int, cgnOffset: Int, applicableNotesOffset: Int, onItin: Int, onIcaoOffset: Int, offItin: Int, offIcaoOffset: Int, plannedOffset: Int) : Int {
            ...
            return endAirTransportMissionHazMat_Full(builder)
        }
        fun startAirTransportMissionHazMat_Full(builder: FlatBufferBuilder) = builder.startTable(15)
        ...
        fun endAirTransportMissionHazMat_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishAirTransportMissionHazMatFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "AIRT")
        fun finishSizePrefixedAirTransportMissionHazMat_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "AIRT")
    }
}
