 ...
 */
@Suppress("unused")
class RoutePoints_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : RoutePoints_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsRoutePoints_Full(_bb: ByteBuffer): RoutePoints_Full = getRootAsRoutePoints_Full(_bb, RoutePoints_Full())
        fun getRootAsRoutePoints_Full(_bb: ByteBuffer, obj: RoutePoints_Full): RoutePoints_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun RoutePoints_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "ROUT")
        fun createRoutePoints_Full(builder: FlatBufferBuilder, ptSequenceId: Int, ptTypeCodeOffset: Int, ptTypeNameOffset: Int, waypointNameOffset: Int, dafifPt: Boolean, ptLat: Double, ptLon: Double, magDec: Double, navaidLength: Double, navaidOffset: Int, countryCodeOffset: Int, altCountryCodeOffset: Int, navaidTypeOffset: Int) : Int {
            ...
            return endRoutePoints_Full(builder)
        }
        fun startRoutePoints_Full(builder: FlatBufferBuilder) = builder.startTable(13)
        ...
        fun endRoutePoints_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishRoutePointsFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ROUT")
        fun finishSizePrefixedRoutePoints_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ROUT")
    }
}
