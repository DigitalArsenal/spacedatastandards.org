 ...
 */
@Suppress("unused")
class LogisticsDiscrepancyInfos_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : LogisticsDiscrepancyInfos_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsLogisticsDiscrepancyInfos_Full(_bb: ByteBuffer): LogisticsDiscrepancyInfos_Full = getRootAsLogisticsDiscrepancyInfos_Full(_bb, LogisticsDiscrepancyInfos_Full())
        fun getRootAsLogisticsDiscrepancyInfos_Full(_bb: ByteBuffer, obj: LogisticsDiscrepancyInfos_Full): LogisticsDiscrepancyInfos_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun LogisticsDiscrepancyInfos_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "LOGI")
        fun createLogisticsDiscrepancyInfos_Full(builder: FlatBufferBuilder, jcnOffset: Int, discrepancyInfoOffset: Int, jobStTimeOffset: Int, closureTimeOffset: Int) : Int {
            ...
            return endLogisticsDiscrepancyInfos_Full(builder)
        }
        fun startLogisticsDiscrepancyInfos_Full(builder: FlatBufferBuilder) = builder.startTable(4)
        ...
        fun endLogisticsDiscrepancyInfos_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishLogisticsDiscrepancyInfosFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "LOGI")
        fun finishSizePrefixedLogisticsDiscrepancyInfos_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "LOGI")
    }
}
