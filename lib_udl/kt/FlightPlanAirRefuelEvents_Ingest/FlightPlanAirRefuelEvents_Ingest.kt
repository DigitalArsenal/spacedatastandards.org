 ...
 */
@Suppress("unused")
class FlightPlanAirRefuelEvents_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : FlightPlanAirRefuelEvents_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsFlightPlanAirRefuelEvents_Ingest(_bb: ByteBuffer): FlightPlanAirRefuelEvents_Ingest = getRootAsFlightPlanAirRefuelEvents_Ingest(_bb, FlightPlanAirRefuelEvents_Ingest())
        fun getRootAsFlightPlanAirRefuelEvents_Ingest(_bb: ByteBuffer, obj: FlightPlanAirRefuelEvents_Ingest): FlightPlanAirRefuelEvents_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun FlightPlanAirRefuelEvents_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "FLIG")
        fun createFlightPlanAirRefuelEvents_Ingest(builder: FlatBufferBuilder, arDegrade: Double, arNum: Int, arExchangedFuel: Double, divertFuel: Double, exitFuel: Double) : Int {
            ...
            return endFlightPlanAirRefuelEvents_Ingest(builder)
        }
        fun startFlightPlanAirRefuelEvents_Ingest(builder: FlatBufferBuilder) = builder.startTable(5)
        ...
        fun endFlightPlanAirRefuelEvents_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishFlightPlanAirRefuelEventsIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "FLIG")
        fun finishSizePrefixedFlightPlanAirRefuelEvents_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "FLIG")
    }
}
