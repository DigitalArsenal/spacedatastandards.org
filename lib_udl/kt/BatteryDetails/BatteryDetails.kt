 ...
 */
@Suppress("unused")
class BatteryDetails : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : BatteryDetails {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsBatteryDetails(_bb: ByteBuffer): BatteryDetails = getRootAsBatteryDetails(_bb, BatteryDetails())
        fun getRootAsBatteryDetails(_bb: ByteBuffer, obj: BatteryDetails): BatteryDetails {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun BatteryDetailsBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "BATT")
        fun createBatteryDetails(builder: FlatBufferBuilder, idOffset: Int, idBatteryOffset: Int, classificationMarkingOffset: Int, technologyOffset: Int, capacity: Double, dischargeDepth: Double, modelOffset: Int, descriptionOffset: Int, manufacturerOrgIdOffset: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte, tagsOffset: Int, manufacturerOrgOffset: Int) : Int {
            ...
            return endBatteryDetails(builder)
        }
        fun startBatteryDetails(builder: FlatBufferBuilder) = builder.startTable(19)
        ...
        fun endBatteryDetails(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishBatteryDetailsBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "BATT")
        fun finishSizePrefixedBatteryDetailsBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "BATT")
    }
}
