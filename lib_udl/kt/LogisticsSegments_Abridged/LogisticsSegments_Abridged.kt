 ...
 */
@Suppress("unused")
class LogisticsSegments_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : LogisticsSegments_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsLogisticsSegments_Abridged(_bb: ByteBuffer): LogisticsSegments_Abridged = getRootAsLogisticsSegments_Abridged(_bb, LogisticsSegments_Abridged())
        fun getRootAsLogisticsSegments_Abridged(_bb: ByteBuffer, obj: LogisticsSegments_Abridged): LogisticsSegments_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun LogisticsSegments_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "LOGI")
        fun createLogisticsSegments_Abridged(builder: FlatBufferBuilder, segmentNumber: Int, modeCodeOffset: Int, missionTypeOffset: Int, idMissionOffset: Int, extMissionIdOffset: Int, missionNumberOffset: Int, itin: Int, segTailNumberOffset: Int, segAircraftMdsOffset: Int, departureIcaoOffset: Int, segActDepTimeOffset: Int, arrivalIcaoOffset: Int, segActArrTimeOffset: Int, segEstDepTimeOffset: Int, segEstArrTimeOffset: Int) : Int {
            ...
            return endLogisticsSegments_Abridged(builder)
        }
        fun startLogisticsSegments_Abridged(builder: FlatBufferBuilder) = builder.startTable(15)
        ...
        fun endLogisticsSegments_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishLogisticsSegmentsAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "LOGI")
        fun finishSizePrefixedLogisticsSegments_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "LOGI")
    }
}
