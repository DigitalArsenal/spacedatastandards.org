 ...
 */
@Suppress("unused")
class LaunchVehicle_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : LaunchVehicle_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsLaunchVehicle_Abridged(_bb: ByteBuffer): LaunchVehicle_Abridged = getRootAsLaunchVehicle_Abridged(_bb, LaunchVehicle_Abridged())
        fun getRootAsLaunchVehicle_Abridged(_bb: ByteBuffer, obj: LaunchVehicle_Abridged): LaunchVehicle_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun LaunchVehicle_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "LAUN")
        fun createLaunchVehicle_Abridged(builder: FlatBufferBuilder, idOffset: Int, nameOffset: Int, classificationMarkingOffset: Int, typeOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endLaunchVehicle_Abridged(builder)
        }
        fun startLaunchVehicle_Abridged(builder: FlatBufferBuilder) = builder.startTable(10)
        ...
        fun endLaunchVehicle_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishLaunchVehicleAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "LAUN")
        fun finishSizePrefixedLaunchVehicle_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "LAUN")
    }
}
