 ...
 */
@Suppress("unused")
class IonoObservationAzimuth_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : IonoObservationAzimuth_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsIonoObservationAzimuth_Full(_bb: ByteBuffer): IonoObservationAzimuth_Full = getRootAsIonoObservationAzimuth_Full(_bb, IonoObservationAzimuth_Full())
        fun getRootAsIonoObservationAzimuth_Full(_bb: ByteBuffer, obj: IonoObservationAzimuth_Full): IonoObservationAzimuth_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun IonoObservationAzimuth_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "IONO")
        fun createIonoObservationAzimuth_Full(builder: FlatBufferBuilder, notesOffset: Int, dimensionsOffset: Int, dimensionNameOffset: Int, dataOffset: Int) : Int {
            ...
            return endIonoObservationAzimuth_Full(builder)
        }
        fun startIonoObservationAzimuth_Full(builder: FlatBufferBuilder) = builder.startTable(4)
        ...
        fun endIonoObservationAzimuth_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishIonoObservationAzimuthFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "IONO")
        fun finishSizePrefixedIonoObservationAzimuth_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "IONO")
    }
}
