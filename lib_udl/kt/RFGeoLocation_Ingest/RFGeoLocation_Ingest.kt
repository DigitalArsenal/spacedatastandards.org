 ...
 */
@Suppress("unused")
class RFGeoLocation_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : RFGeoLocation_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createRFGeoLocation_Ingest(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, orderIdOffset: Int, createdTsOffset: Int, receivedTsOffset: Int, startTimeOffset: Int, endTimeOffset: Int, idOnOrbitOffset: Int, satNo: Int, origObjectIdOffset: Int, constellationOffset: Int, signalOfInterestOffset: Int, idRfemitterOffset: Int, origRfemitterIdOffset: Int, numBursts: Int, minFreq: Double, maxFreq: Double, centerFreq: Double, detectLat: Double, detectLon: Double, detectAlt: Double, confSemiMajor: Double, confSemiMinor: Double, confOrientation: Double, confArea: Double, atypeOffset: Int, agjsonOffset: Int, atextOffset: Int, areaOffset: Int, andims: Int, asrid: Int, passGroupIdOffset: Int, algVersionOffset: Int, externalIdOffset: Int, tagsOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, sourceDlOffset: Int, dataMode: Byte) : Int {
            ...
            return endRFGeoLocation_Ingest(builder)
        }
        fun startRFGeoLocation_Ingest(builder: FlatBufferBuilder) = builder.startTable(42)
        ...
        fun endRFGeoLocation_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishRFGeoLocationIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "RFGE")
        fun finishSizePrefixedRFGeoLocation_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "RFGE")
    }
}
