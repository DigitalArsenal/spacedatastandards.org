 ...
 */
@Suppress("unused")
class GNSSObservation_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : GNSSObservation_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsGNSSObservation_Full(_bb: ByteBuffer): GNSSObservation_Full = getRootAsGNSSObservation_Full(_bb, GNSSObservation_Full())
        fun getRootAsGNSSObservation_Full(_bb: ByteBuffer, obj: GNSSObservation_Full): GNSSObservation_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun GNSSObservation_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "GNSS")
        fun createGNSSObservation_Full(builder: FlatBufferBuilder, gnssSatIdOffset: Int, trackingStatus: Int, agcState: Int, obsCodeSetOffset: Int, obOffset: Int) : Int {
            ...
            return endGNSSObservation_Full(builder)
        }
        fun startGNSSObservation_Full(builder: FlatBufferBuilder) = builder.startTable(5)
        ...
        fun endGNSSObservation_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishGNSSObservationFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "GNSS")
        fun finishSizePrefixedGNSSObservation_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "GNSS")
    }
}
