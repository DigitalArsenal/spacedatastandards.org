 ...
 */
@Suppress("unused")
class SensorPlan_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : SensorPlan_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
     ...
     * Constraints: No constraints specified.
     */
    fun collectRequests(j: Int) : String? {
        val o = __offset(44)
        return if (o != 0) {
    ...
    companion object {
        ...
        fun getRootAsSensorPlan_Ingest(_bb: ByteBuffer): SensorPlan_Ingest = getRootAsSensorPlan_Ingest(_bb, SensorPlan_Ingest())
        fun getRootAsSensorPlan_Ingest(_bb: ByteBuffer, obj: SensorPlan_Ingest): SensorPlan_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun SensorPlan_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "SENS")
        fun createSensorPlan_Ingest(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, typeOffset: Int, recTypeOffset: Int, startTimeOffset: Int, endTimeOffset: Int, nameOffset: Int, idSensorOffset: Int, origSensorIdOffset: Int, purposeOffset: Int, senNetworkOffset: Int, reqTotal: Int, customerOffset: Int, statusOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, origNetworkOffset: Int, collectRequestsOffset: Int, tagsOffset: Int) : Int {
            builder.startTable(22)
            addTags(builder, tagsOffset)
            addCollectRequests(builder, collectRequestsOffset)
            ...
            return endSensorPlan_Ingest(builder)
        }
        fun startSensorPlan_Ingest(builder: FlatBufferBuilder) = builder.startTable(22)
        ...
        fun addCollectRequests(builder: FlatBufferBuilder, collectRequests: Int) = builder.addOffset(20, collectRequests, 0)
        fun createCollectRequestsVector(builder: FlatBufferBuilder, data: IntArray) : Int {
        ...
        fun startCollectRequestsVector(builder: FlatBufferBuilder, numElems: Int) = builder.startVector(4, numElems, 4)
        fun addTags(builder: FlatBufferBuilder, tags: Int) = builder.addOffset(21, tags, 0)
        ...
        fun endSensorPlan_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishSensorPlanIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "SENS")
        fun finishSizePrefixedSensorPlan_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "SENS")
    }
}
