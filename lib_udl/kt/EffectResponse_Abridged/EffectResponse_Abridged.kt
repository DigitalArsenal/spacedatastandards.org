 ...
 */
@Suppress("unused")
class EffectResponse_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : EffectResponse_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createEffectResponse_Abridged(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idEffectRequestOffset: Int, externalRequestIdOffset: Int, typeOffset: Int, actorSrcTypeOffset: Int, actorSrcIdOffset: Int, munitionTypeOffset: Int, munitionIdOffset: Int, shotsRequired: Int, probabilityOfKill: Double, collateralDamageEst: Double, actionsListOffset: Int, externalActionsOffset: Int, coaMetricsOffset: Int, redTimeToOverheadOffset: Int, decisionDeadlineOffset: Int, redTargetSrcTypeOffset: Int, redTargetSrcIdOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, origNetworkOffset: Int) : Int {
            ...
            return endEffectResponse_Abridged(builder)
        }
        fun startEffectResponse_Abridged(builder: FlatBufferBuilder) = builder.startTable(25)
        ...
        fun endEffectResponse_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishEffectResponseAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "EFFE")
        fun finishSizePrefixedEffectResponse_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "EFFE")
    }
}
