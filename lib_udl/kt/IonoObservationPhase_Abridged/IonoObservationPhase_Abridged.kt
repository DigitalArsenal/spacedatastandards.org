 ...
 */
@Suppress("unused")
class IonoObservationPhase_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : IonoObservationPhase_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsIonoObservationPhase_Abridged(_bb: ByteBuffer): IonoObservationPhase_Abridged = getRootAsIonoObservationPhase_Abridged(_bb, IonoObservationPhase_Abridged())
        fun getRootAsIonoObservationPhase_Abridged(_bb: ByteBuffer, obj: IonoObservationPhase_Abridged): IonoObservationPhase_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun IonoObservationPhase_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "IONO")
        fun createIonoObservationPhase_Abridged(builder: FlatBufferBuilder, notesOffset: Int, dimensionsOffset: Int, dimensionNameOffset: Int, dataOffset: Int) : Int {
            ...
            return endIonoObservationPhase_Abridged(builder)
        }
        fun startIonoObservationPhase_Abridged(builder: FlatBufferBuilder) = builder.startTable(4)
        ...
        fun endIonoObservationPhase_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishIonoObservationPhaseAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "IONO")
        fun finishSizePrefixedIonoObservationPhase_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "IONO")
    }
}
