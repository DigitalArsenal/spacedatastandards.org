 ...
 */
@Suppress("unused")
class TrackSensor_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : TrackSensor_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsTrackSensor_Full(_bb: ByteBuffer): TrackSensor_Full = getRootAsTrackSensor_Full(_bb, TrackSensor_Full())
        fun getRootAsTrackSensor_Full(_bb: ByteBuffer, obj: TrackSensor_Full): TrackSensor_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun TrackSensor_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "TRAC")
        fun createTrackSensor_Full(builder: FlatBufferBuilder, range: Double, az: Double, sensorNumber: Int, sensorNameOffset: Int, missionNumberOffset: Int, minRangeLimit: Double, sensorFovtype: Byte) : Int {
            ...
            return endTrackSensor_Full(builder)
        }
        fun startTrackSensor_Full(builder: FlatBufferBuilder) = builder.startTable(7)
        ...
        fun endTrackSensor_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishTrackSensorFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "TRAC")
        fun finishSizePrefixedTrackSensor_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "TRAC")
    }
}
