 ...
 */
@Suppress("unused")
class LaunchEvent_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : LaunchEvent_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsLaunchEvent_Ingest(_bb: ByteBuffer): LaunchEvent_Ingest = getRootAsLaunchEvent_Ingest(_bb, LaunchEvent_Ingest())
        fun getRootAsLaunchEvent_Ingest(_bb: ByteBuffer, obj: LaunchEvent_Ingest): LaunchEvent_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun LaunchEvent_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "LAUN")
        fun createLaunchEvent_Ingest(builder: FlatBufferBuilder, idOffset: Int, idOnOrbitOffset: Int, origObjectIdOffset: Int, classificationMarkingOffset: Int, derivedFromOffset: Int, declassificationDateOffset: Int, declassificationStringOffset: Int, msgCreateDateOffset: Int, launchFailureCodeOffset: Int, launchDateOffset: Int, beNumberOffset: Int, oSuffixOffset: Int, launchFacilityNameOffset: Int, createdAtOffset: Int, createdByOffset: Int, originOffset: Int, sourceOffset: Int, dataMode: Byte, origNetworkOffset: Int, satNo: Int) : Int {
            ...
            return endLaunchEvent_Ingest(builder)
        }
        fun startLaunchEvent_Ingest(builder: FlatBufferBuilder) = builder.startTable(20)
        ...
        fun endLaunchEvent_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishLaunchEventIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "LAUN")
        fun finishSizePrefixedLaunchEvent_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "LAUN")
    }
}
