 ...
 */
@Suppress("unused")
class NavalFlightOperations_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : NavalFlightOperations_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsNavalFlightOperations_Ingest(_bb: ByteBuffer): NavalFlightOperations_Ingest = getRootAsNavalFlightOperations_Ingest(_bb, NavalFlightOperations_Ingest())
        fun getRootAsNavalFlightOperations_Ingest(_bb: ByteBuffer, obj: NavalFlightOperations_Ingest): NavalFlightOperations_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun NavalFlightOperations_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "NAVA")
        fun createNavalFlightOperations_Ingest(builder: FlatBufferBuilder, shipNameOffset: Int, fltOpStartOffset: Int, fltOpStopOffset: Int, schdLaunchRcvyTimeOffset: Int) : Int {
            ...
            return endNavalFlightOperations_Ingest(builder)
        }
        fun startNavalFlightOperations_Ingest(builder: FlatBufferBuilder) = builder.startTable(4)
        ...
        fun endNavalFlightOperations_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishNavalFlightOperationsIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "NAVA")
        fun finishSizePrefixedNavalFlightOperations_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "NAVA")
    }
}
