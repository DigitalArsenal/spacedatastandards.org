 ...
 */
@Suppress("unused")
class FlightPlanPoints_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : FlightPlanPoints_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsFlightPlanPoints_Full(_bb: ByteBuffer): FlightPlanPoints_Full = getRootAsFlightPlanPoints_Full(_bb, FlightPlanPoints_Full())
        fun getRootAsFlightPlanPoints_Full(_bb: ByteBuffer, obj: FlightPlanPoints_Full): FlightPlanPoints_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun FlightPlanPoints_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "FLIG")
        fun createFlightPlanPoints_Full(builder: FlatBufferBuilder, pointNameOffset: Int, fppLat: Double, fppLon: Double, fppEtaOffset: Int, fppReqFuel: Double) : Int {
            ...
            return endFlightPlanPoints_Full(builder)
        }
        fun startFlightPlanPoints_Full(builder: FlatBufferBuilder) = builder.startTable(5)
        ...
        fun endFlightPlanPoints_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishFlightPlanPointsFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "FLIG")
        fun finishSizePrefixedFlightPlanPoints_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "FLIG")
    }
}
