 ...
 */
@Suppress("unused")
class SigAct_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : SigAct_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val atextAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(26, 1)
    fun atextInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 26, 1)
    /**
    ...
    val agjsonAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(28, 1)
    fun agjsonInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 28, 1)
    /**
    ...
    val atypeAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(30, 1)
    fun atypeInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 30, 1)
    /**
    ...
    val eventStartAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(36, 1)
    fun eventStartInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 36, 1)
    /**
    ...
    val eventEndAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(38, 1)
    fun eventEndInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 38, 1)
    /**
    ...
    val reportDateAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(40, 1)
    fun reportDateInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 40, 1)
    /**
    ...
    val targetAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(98, 1)
    fun targetInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 98, 1)
    /**
    ...
    val eventDescriptionAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(100, 1)
    fun eventDescriptionInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 100, 1)
    /**
    ...
    val eventTypeAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(102, 1)
    fun eventTypeInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 102, 1)
    /**
    ...
    val typeOfAttackAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(104, 1)
    fun typeOfAttackInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 104, 1)
    /**
    ...
    val idNumberAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(108, 1)
    fun idNumberInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 108, 1)
    /**
    ...
    val cameoCodeAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(116, 1)
    fun cameoCodeInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 116, 1)
    /**
    ...
    val cameoBaseCodeAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(118, 1)
    fun cameoBaseCodeInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 118, 1)
    /**
    ...
    val cameoRootCodeAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(120, 1)
    fun cameoRootCodeInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 120, 1)
    /**
    ...
    val documentSourceAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(124, 1)
    fun documentSourceInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 124, 1)
    /**
    ...
    val documentFilenameAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(126, 1)
    fun documentFilenameInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 126, 1)
    /**
    ...
    val checksumValueAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(132, 1)
    fun checksumValueInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 132, 1)
    /**
     * The reporting unit.
    ...
    val repUnitAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(134, 1)
    fun repUnitInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 134, 1)
    /**
    ...
    val repUnitTypeAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(136, 1)
    fun repUnitTypeInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 136, 1)
    /**
    ...
    val repUnitActivityAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(138, 1)
    fun repUnitActivityInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 138, 1)
    /**
    ...
    val sourceUrlAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(148, 1)
    fun sourceUrlInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 148, 1)
    /**
    ...
    val summaryAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(152, 1)
    fun summaryInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 152, 1)
    /**
    ...
    val notesAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(154, 1)
    fun notesInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 154, 1)
    /**
    ...
    val createdAtAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(156, 1)
    fun createdAtInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 156, 1)
    /**
    ...
    val createdByAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(158, 1)
    fun createdByInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 158, 1)
    /**
     * Source of the data.
    ...
    companion object {
        ...
        fun createSigAct_Abridged(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, sourceLanguageOffset: Int, countryCodeOffset: Int, cityOffset: Int, districtOffset: Int, provinceOffset: Int, lat: Double, lon: Double, milgridOffset: Int, theaterOffset: Int, atextOffset: Int, agjsonOffset: Int, atypeOffset: Int, andims: Int, asrid: Int, eventStartOffset: Int, eventEndOffset: Int, reportDateOffset: Int, actorsOffset: Int, civAbd: Int, civDet: Int, civKia: Int, civWound: Int, coalAbd: Int, coalDet: Int, coalKia: Int, coalWound: Int, enemyAbd: Int, enemyDet: Int, enemyKia: Int, friendlyAbd: Int, friendlyDet: Int, friendlyKia: Int, friendlyWound: Int, hostNatAbd: Int, hostNatDet: Int, hostNatKia: Int, hostNatWound: Int, sideAabd: Int, sideAdet: Int, sideAkia: Int, sideAwound: Int, sideBabd: Int, sideBdet: Int, sideBkia: Int, sideBwound: Int, targetOffset: Int, eventDescriptionOffset: Int, eventTypeOffset: Int, typeOfAttackOffset: Int, complexAttack: Boolean, idNumberOffset: Int, confidence: Int, accuracy: Int, clarity: Int, cameoCodeOffset: Int, cameoBaseCodeOffset: Int, cameoRootCodeOffset: Int, goldstein: Double, documentSourceOffset: Int, documentFilenameOffset: Int, hasAttachment: Boolean, filesize: Long, checksumValueOffset: Int, repUnitOffset: Int, repUnitTypeOffset: Int, repUnitActivityOffset: Int, numMentions: Int, numSources: Int, numArticles: Int, avgTone: Double, sourceUrlOffset: Int, relatedDocsOffset: Int, summaryOffset: Int, notesOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, origNetworkOffset: Int) : Int {
            ...
            return endSigAct_Abridged(builder)
        }
        fun startSigAct_Abridged(builder: FlatBufferBuilder) = builder.startTable(82)
        ...
        fun addAtext(builder: FlatBufferBuilder, atext: Int) = builder.addOffset(11, atext, 0)
        fun addAgjson(builder: FlatBufferBuilder, agjson: Int) = builder.addOffset(12, agjson, 0)
        fun addAtype(builder: FlatBufferBuilder, atype: Int) = builder.addOffset(13, atype, 0)
        fun addAndims(builder: FlatBufferBuilder, andims: Int) = builder.addInt(14, andims, 0)
        fun addAsrid(builder: FlatBufferBuilder, asrid: Int) = builder.addInt(15, asrid, 0)
        fun addEventStart(builder: FlatBufferBuilder, eventStart: Int) = builder.addOffset(16, eventStart, 0)
        fun addEventEnd(builder: FlatBufferBuilder, eventEnd: Int) = builder.addOffset(17, eventEnd, 0)
        fun addReportDate(builder: FlatBufferBuilder, reportDate: Int) = builder.addOffset(18, reportDate, 0)
        fun addActors(builder: FlatBufferBuilder, actors: Int) = builder.addOffset(19, actors, 0)
        ...
        fun addCivAbd(builder: FlatBufferBuilder, civAbd: Int) = builder.addInt(20, civAbd, 0)
        fun addCivDet(builder: FlatBufferBuilder, civDet: Int) = builder.addInt(21, civDet, 0)
        fun addCivKIA(builder: FlatBufferBuilder, civKia: Int) = builder.addInt(22, civKia, 0)
        fun addCivWound(builder: FlatBufferBuilder, civWound: Int) = builder.addInt(23, civWound, 0)
        fun addCoalAbd(builder: FlatBufferBuilder, coalAbd: Int) = builder.addInt(24, coalAbd, 0)
        fun addCoalDet(builder: FlatBufferBuilder, coalDet: Int) = builder.addInt(25, coalDet, 0)
        fun addCoalKIA(builder: FlatBufferBuilder, coalKia: Int) = builder.addInt(26, coalKia, 0)
        fun addCoalWound(builder: FlatBufferBuilder, coalWound: Int) = builder.addInt(27, coalWound, 0)
        fun addEnemyAbd(builder: FlatBufferBuilder, enemyAbd: Int) = builder.addInt(28, enemyAbd, 0)
        fun addEnemyDet(builder: FlatBufferBuilder, enemyDet: Int) = builder.addInt(29, enemyDet, 0)
        fun addEnemyKIA(builder: FlatBufferBuilder, enemyKia: Int) = builder.addInt(30, enemyKia, 0)
        fun addFriendlyAbd(builder: FlatBufferBuilder, friendlyAbd: Int) = builder.addInt(31, friendlyAbd, 0)
        fun addFriendlyDet(builder: FlatBufferBuilder, friendlyDet: Int) = builder.addInt(32, friendlyDet, 0)
        fun addFriendlyKIA(builder: FlatBufferBuilder, friendlyKia: Int) = builder.addInt(33, friendlyKia, 0)
        fun addFriendlyWound(builder: FlatBufferBuilder, friendlyWound: Int) = builder.addInt(34, friendlyWound, 0)
        fun addHostNatAbd(builder: FlatBufferBuilder, hostNatAbd: Int) = builder.addInt(35, hostNatAbd, 0)
        fun addHostNatDet(builder: FlatBufferBuilder, hostNatDet: Int) = builder.addInt(36, hostNatDet, 0)
        fun addHostNatKIA(builder: FlatBufferBuilder, hostNatKia: Int) = builder.addInt(37, hostNatKia, 0)
        fun addHostNatWound(builder: FlatBufferBuilder, hostNatWound: Int) = builder.addInt(38, hostNatWound, 0)
        fun addSideAAbd(builder: FlatBufferBuilder, sideAabd: Int) = builder.addInt(39, sideAabd, 0)
        fun addSideADet(builder: FlatBufferBuilder, sideAdet: Int) = builder.addInt(40, sideAdet, 0)
        fun addSideAKIA(builder: FlatBufferBuilder, sideAkia: Int) = builder.addInt(41, sideAkia, 0)
        fun addSideAWound(builder: FlatBufferBuilder, sideAwound: Int) = builder.addInt(42, sideAwound, 0)
        fun addSideBAbd(builder: FlatBufferBuilder, sideBabd: Int) = builder.addInt(43, sideBabd, 0)
        fun addSideBDet(builder: FlatBufferBuilder, sideBdet: Int) = builder.addInt(44, sideBdet, 0)
        fun addSideBKIA(builder: FlatBufferBuilder, sideBkia: Int) = builder.addInt(45, sideBkia, 0)
        fun addSideBWound(builder: FlatBufferBuilder, sideBwound: Int) = builder.addInt(46, sideBwound, 0)
        fun addTarget(builder: FlatBufferBuilder, target: Int) = builder.addOffset(47, target, 0)
        fun addEventDescription(builder: FlatBufferBuilder, eventDescription: Int) = builder.addOffset(48, eventDescription, 0)
        fun addEventType(builder: FlatBufferBuilder, eventType: Int) = builder.addOffset(49, eventType, 0)
        fun addTypeOfAttack(builder: FlatBufferBuilder, typeOfAttack: Int) = builder.addOffset(50, typeOfAttack, 0)
        fun addComplexAttack(builder: FlatBufferBuilder, complexAttack: Boolean) = builder.addBoolean(51, complexAttack, false)
        fun addIdNumber(builder: FlatBufferBuilder, idNumber: Int) = builder.addOffset(52, idNumber, 0)
        fun addConfidence(builder: FlatBufferBuilder, confidence: Int) = builder.addInt(53, confidence, 0)
        fun addAccuracy(builder: FlatBufferBuilder, accuracy: Int) = builder.addInt(54, accuracy, 0)
        fun addClarity(builder: FlatBufferBuilder, clarity: Int) = builder.addInt(55, clarity, 0)
        fun addCameoCode(builder: FlatBufferBuilder, cameoCode: Int) = builder.addOffset(56, cameoCode, 0)
        fun addCameoBaseCode(builder: FlatBufferBuilder, cameoBaseCode: Int) = builder.addOffset(57, cameoBaseCode, 0)
        fun addCameoRootCode(builder: FlatBufferBuilder, cameoRootCode: Int) = builder.addOffset(58, cameoRootCode, 0)
        fun addGoldstein(builder: FlatBufferBuilder, goldstein: Double) = builder.addDouble(59, goldstein, 0.0)
        fun addDocumentSource(builder: FlatBufferBuilder, documentSource: Int) = builder.addOffset(60, documentSource, 0)
        fun addDocumentFilename(builder: FlatBufferBuilder, documentFilename: Int) = builder.addOffset(61, documentFilename, 0)
        fun addHasAttachment(builder: FlatBufferBuilder, hasAttachment: Boolean) = builder.addBoolean(62, hasAttachment, false)
        fun addFilesize(builder: FlatBufferBuilder, filesize: Long) = builder.addLong(63, filesize, 0L)
        fun addChecksumValue(builder: FlatBufferBuilder, checksumValue: Int) = builder.addOffset(64, checksumValue, 0)
        fun addRepUnit(builder: FlatBufferBuilder, repUnit: Int) = builder.addOffset(65, repUnit, 0)
        fun addRepUnitType(builder: FlatBufferBuilder, repUnitType: Int) = builder.addOffset(66, repUnitType, 0)
        fun addRepUnitActivity(builder: FlatBufferBuilder, repUnitActivity: Int) = builder.addOffset(67, repUnitActivity, 0)
        fun addNumMentions(builder: FlatBufferBuilder, numMentions: Int) = builder.addInt(68, numMentions, 0)
        fun addNumSources(builder: FlatBufferBuilder, numSources: Int) = builder.addInt(69, numSources, 0)
        fun addNumArticles(builder: FlatBufferBuilder, numArticles: Int) = builder.addInt(70, numArticles, 0)
        fun addAvgTone(builder: FlatBufferBuilder, avgTone: Double) = builder.addDouble(71, avgTone, 0.0)
        fun addSourceUrl(builder: FlatBufferBuilder, sourceUrl: Int) = builder.addOffset(72, sourceUrl, 0)
        fun addRelatedDocs(builder: FlatBufferBuilder, relatedDocs: Int) = builder.addOffset(73, relatedDocs, 0)
        ...
        fun addSummary(builder: FlatBufferBuilder, summary: Int) = builder.addOffset(74, summary, 0)
        fun addNotes(builder: FlatBufferBuilder, notes: Int) = builder.addOffset(75, notes, 0)
        fun addCreatedAt(builder: FlatBufferBuilder, createdAt: Int) = builder.addOffset(76, createdAt, 0)
        fun addCreatedBy(builder: FlatBufferBuilder, createdBy: Int) = builder.addOffset(77, createdBy, 0)
        ...
        fun addOrigNetwork(builder: FlatBufferBuilder, origNetwork: Int) = builder.addOffset(81, origNetwork, 0)
        fun endSigAct_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishSigActAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "SIGA")
        fun finishSizePrefixedSigAct_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "SIGA")
    }
}
