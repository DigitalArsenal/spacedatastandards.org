 ...
 */
@Suppress("unused")
class OnorbitThruster_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : OnorbitThruster_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val updatedByAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(22, 1)
    fun updatedByInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 22, 1)
    /**
     * Source of the data.
    ...
    val engineAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(30, 1)
    fun engineInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 30, 1)
    /**
    ...
    companion object {
        ...
        fun getRootAsOnorbitThruster_Full(_bb: ByteBuffer): OnorbitThruster_Full = getRootAsOnorbitThruster_Full(_bb, OnorbitThruster_Full())
        fun getRootAsOnorbitThruster_Full(_bb: ByteBuffer, obj: OnorbitThruster_Full): OnorbitThruster_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun OnorbitThruster_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "ONOR")
        fun createOnorbitThruster_Full(builder: FlatBufferBuilder, idOffset: Int, idOnOrbitOffset: Int, idEngineOffset: Int, classificationMarkingOffset: Int, typeOffset: Int, quantity: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, engineOffset: Int, origNetworkOffset: Int) : Int {
            ...
            return endOnorbitThruster_Full(builder)
        }
        fun startOnorbitThruster_Full(builder: FlatBufferBuilder) = builder.startTable(15)
        ...
        fun addUpdatedBy(builder: FlatBufferBuilder, updatedBy: Int) = builder.addOffset(9, updatedBy, 0)
        ...
        fun addEngine(builder: FlatBufferBuilder, engine: Int) = builder.addOffset(13, engine, 0)
        fun addOrigNetwork(builder: FlatBufferBuilder, origNetwork: Int) = builder.addOffset(14, origNetwork, 0)
        fun endOnorbitThruster_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishOnorbitThrusterFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ONOR")
        fun finishSizePrefixedOnorbitThruster_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ONOR")
    }
}
