 ...
 */
@Suppress("unused")
class OnboardNavigation_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : OnboardNavigation_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val esIdAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(20, 1)
    fun esIdInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 20, 1)
    /**
    ...
    val starCatNameAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(22, 1)
    fun starCatNameInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 22, 1)
    /**
    ...
    val starCatLoadTimeAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(24, 1)
    fun starCatLoadTimeInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 24, 1)
    /**
    ...
    val idStateVectorAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(26, 1)
    fun idStateVectorInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 26, 1)
    /**
    ...
    companion object {
        ...
        fun getRootAsOnboardNavigation_Full(_bb: ByteBuffer): OnboardNavigation_Full = getRootAsOnboardNavigation_Full(_bb, OnboardNavigation_Full())
        fun getRootAsOnboardNavigation_Full(_bb: ByteBuffer, obj: OnboardNavigation_Full): OnboardNavigation_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun OnboardNavigation_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "ONBO")
        fun createOnboardNavigation_Full(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idOnOrbitOffset: Int, satNo: Int, onOrbitOffset: Int, origObjectIdOffset: Int, startTimeOffset: Int, endTimeOffset: Int, esIdOffset: Int, starCatNameOffset: Int, starCatLoadTimeOffset: Int, idStateVectorOffset: Int, tsOffset: Int, referenceFrame: Byte, sunSensorOffset: Int, magOffset: Int, starTrackerOffset: Int, deltaPosOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endOnboardNavigation_Full(builder)
        }
        fun startOnboardNavigation_Full(builder: FlatBufferBuilder) = builder.startTable(24)
        ...
        fun addEsId(builder: FlatBufferBuilder, esId: Int) = builder.addOffset(8, esId, 0)
        fun addStarCatName(builder: FlatBufferBuilder, starCatName: Int) = builder.addOffset(9, starCatName, 0)
        fun addStarCatLoadTime(builder: FlatBufferBuilder, starCatLoadTime: Int) = builder.addOffset(10, starCatLoadTime, 0)
        fun addIdStateVector(builder: FlatBufferBuilder, idStateVector: Int) = builder.addOffset(11, idStateVector, 0)
        fun addTs(builder: FlatBufferBuilder, ts: Int) = builder.addOffset(12, ts, 0)
        ...
        fun addReferenceFrame(builder: FlatBufferBuilder, referenceFrame: Byte) = builder.addByte(13, referenceFrame, 0)
        fun addSunSensor(builder: FlatBufferBuilder, sunSensor: Int) = builder.addOffset(14, sunSensor, 0)
        ...
        fun addMag(builder: FlatBufferBuilder, mag: Int) = builder.addOffset(15, mag, 0)
        ...
        fun addStarTracker(builder: FlatBufferBuilder, starTracker: Int) = builder.addOffset(16, starTracker, 0)
        ...
        fun addDeltaPos(builder: FlatBufferBuilder, deltaPos: Int) = builder.addOffset(17, deltaPos, 0)
        ...
        fun endOnboardNavigation_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishOnboardNavigationFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ONBO")
        fun finishSizePrefixedOnboardNavigation_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ONBO")
    }
}
