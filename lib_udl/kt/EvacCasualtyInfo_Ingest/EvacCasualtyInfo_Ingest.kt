 ...
 */
@Suppress("unused")
class EvacCasualtyInfo_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : EvacCasualtyInfo_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createEvacCasualtyInfo_Ingest(builder: FlatBufferBuilder, priorityOffset: Int, evacTypeOffset: Int, casualtyTypeOffset: Int, bodyPartOffset: Int, contamTypeOffset: Int, specMedEquipOffset: Int, casualtyKeyOffset: Int, patientStatusOffset: Int, patientIdentityOffset: Int, nationalityOffset: Int, payGradeOffset: Int, nameOffset: Int, age: Int, genderOffset: Int, last4SsnOffset: Int, bloodTypeOffset: Int, serviceOffset: Int, callSignOffset: Int, occSpecialityOffset: Int, burialLocationOffset: Int, collectionPointOffset: Int, careProviderUrnOffset: Int, dispositionTypeOffset: Int, dispositionOffset: Int, reportGenOffset: Int, reportTimeOffset: Int, commentsOffset: Int, etiologyOffset: Int, treatmentOffset: Int, vitalSignDataOffset: Int, healthStateOffset: Int, conditionOffset: Int, medicationOffset: Int, injuryOffset: Int, allergyOffset: Int) : Int {
            ...
            return endEvacCasualtyInfo_Ingest(builder)
        }
        fun startEvacCasualtyInfo_Ingest(builder: FlatBufferBuilder) = builder.startTable(35)
        ...
        fun endEvacCasualtyInfo_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishEvacCasualtyInfoIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "EVAC")
        fun finishSizePrefixedEvacCasualtyInfo_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "EVAC")
    }
}
