 ...
 */
@Suppress("unused")
class RFEmitter_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : RFEmitter_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val entityAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(30, 1)
    fun entityInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 30, 1)
    /**
     * Read-only details for this RFEmitter.
     * Example: /// Example: No example provided.
     * Constraints: No constraints specified.
     */
    fun rfEmitterDetails(j: Int) : String? {
        val o = __offset(32)
        return if (o != 0) {
    ...
    companion object {
        ...
        fun getRootAsRFEmitter_Full(_bb: ByteBuffer): RFEmitter_Full = getRootAsRFEmitter_Full(_bb, RFEmitter_Full())
        fun getRootAsRFEmitter_Full(_bb: ByteBuffer, obj: RFEmitter_Full): RFEmitter_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun RFEmitter_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "RFEM")
        fun createRFEmitter_Full(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idEntityOffset: Int, nameOffset: Int, typeOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, entityOffset: Int, rfEmitterDetailsOffset: Int) : Int {
            ...
            return endRFEmitter_Full(builder)
        }
        fun startRFEmitter_Full(builder: FlatBufferBuilder) = builder.startTable(15)
        ...
        fun addRfEmitterDetails(builder: FlatBufferBuilder, rfEmitterDetails: Int) = builder.addOffset(14, rfEmitterDetails, 0)
        ...
        fun endRFEmitter_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishRFEmitterFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "RFEM")
        fun finishSizePrefixedRFEmitter_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "RFEM")
    }
}
