 ...
 */
@Suppress("unused")
class Conjunction_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Conjunction_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val stateVector1AsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(126, 1)
    fun stateVector1InByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 126, 1)
    /**
     * No description provided.
     * Example: /// Example: No example provided.
     * Constraints: No constraints specified.
    ...
    val stateVector2AsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(128, 1)
    fun stateVector2InByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 128, 1)
    /**
    ...
    val origIdOnOrbit1AsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(134, 1)
    fun origIdOnOrbit1InByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 134, 1)
    /**
     * Optional place holder for an OnOrbit ID that does not exist in UDL.
    ...
    val origIdOnOrbit2AsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(136, 1)
    fun origIdOnOrbit2InByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 136, 1)
    /**
    ...
    companion object {
        ...
        fun createConjunction_Abridged(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idOnOrbit1Offset: Int, idOnOrbit2Offset: Int, typeOffset: Int, tcaOffset: Int, missDistance: Double, collisionProb: Double, collisionProbMethodOffset: Int, ephemName1Offset: Int, esId1Offset: Int, ephemName2Offset: Int, esId2Offset: Int, relPosR: Double, relPosT: Double, relPosN: Double, relVelMag: Double, relVelR: Double, relVelT: Double, relVelN: Double, screenEntryTimeOffset: Int, screenExitTimeOffset: Int, screenVolumeX: Double, screenVolumeY: Double, screenVolumeZ: Double, volShapeOffset: Int, volEntryTimeOffset: Int, volExitTimeOffset: Int, penetrationLevelSigma: Double, idStateVector1Offset: Int, lastObTime1Offset: Int, cdAoM1: Double, crAoM1: Double, thrustAccel1: Double, idStateVector2Offset: Int, lastObTime2Offset: Int, cdAoM2: Double, crAoM2: Double, thrustAccel2: Double, commentsOffset: Int, ccirOffset: Int, concernNotesOffset: Int, stateDeptNotified: Boolean, ownerContacted: Boolean, rawFileUriOffset: Int, messageForOffset: Int, messageIdOffset: Int, uvwWarn: Boolean, smallRelVelWarning: Boolean, largeRelPosWarning: Boolean, smallCovWarning: Boolean, largeCovWarning: Boolean, transactionIdOffset: Int, sourceOffset: Int, originOffset: Int, originatorOffset: Int, eventIdOffset: Int, descriptorOffset: Int, dataMode: Byte, createdAtOffset: Int, createdByOffset: Int, stateVector1Offset: Int, stateVector2Offset: Int, satNo1: Int, satNo2: Int, origIdOnOrbit1Offset: Int, origIdOnOrbit2Offset: Int, origNetworkOffset: Int) : Int {
            ...
            return endConjunction_Abridged(builder)
        }
        fun startConjunction_Abridged(builder: FlatBufferBuilder) = builder.startTable(68)
        ...
        fun addDataMode(builder: FlatBufferBuilder, dataMode: Byte) = builder.addByte(58, dataMode, 0)
        ...
        fun addStateVector1(builder: FlatBufferBuilder, stateVector1: Int) = builder.addOffset(61, stateVector1, 0)
        fun addStateVector2(builder: FlatBufferBuilder, stateVector2: Int) = builder.addOffset(62, stateVector2, 0)
        fun addSatNo1(builder: FlatBufferBuilder, satNo1: Int) = builder.addInt(63, satNo1, 0)
        fun addSatNo2(builder: FlatBufferBuilder, satNo2: Int) = builder.addInt(64, satNo2, 0)
        fun addOrigIdOnOrbit1(builder: FlatBufferBuilder, origIdOnOrbit1: Int) = builder.addOffset(65, origIdOnOrbit1, 0)
        fun addOrigIdOnOrbit2(builder: FlatBufferBuilder, origIdOnOrbit2: Int) = builder.addOffset(66, origIdOnOrbit2, 0)
        fun addOrigNetwork(builder: FlatBufferBuilder, origNetwork: Int) = builder.addOffset(67, origNetwork, 0)
        fun endConjunction_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishConjunctionAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "CONJ")
        fun finishSizePrefixedConjunction_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "CONJ")
    }
}
