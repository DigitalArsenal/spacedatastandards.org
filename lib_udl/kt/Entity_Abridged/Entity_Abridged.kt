 ...
 */
@Suppress("unused")
class Entity_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Entity_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val onOrbitAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(32, 1)
    fun onOrbitInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 32, 1)
    /**
    ...
    val idOnOrbitAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(34, 1)
    fun idOnOrbitInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 34, 1)
    /**
    ...
    val idOperatingUnitAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(36, 1)
    fun idOperatingUnitInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 36, 1)
    /**
    ...
    companion object {
        ...
        fun getRootAsEntity_Abridged(_bb: ByteBuffer): Entity_Abridged = getRootAsEntity_Abridged(_bb, Entity_Abridged())
        fun getRootAsEntity_Abridged(_bb: ByteBuffer, obj: Entity_Abridged): Entity_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun Entity_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "ENTI")
        fun createEntity_Abridged(builder: FlatBufferBuilder, idEntityOffset: Int, nameOffset: Int, classificationMarkingOffset: Int, type: Byte, idLocationOffset: Int, countryCodeOffset: Int, ownerType: Byte, taskable: Boolean, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, locationOffset: Int, onOrbitOffset: Int, idOnOrbitOffset: Int, idOperatingUnitOffset: Int, origNetworkOffset: Int) : Int {
            ...
            return endEntity_Abridged(builder)
        }
        fun startEntity_Abridged(builder: FlatBufferBuilder) = builder.startTable(18)
        ...
        fun addOnOrbit(builder: FlatBufferBuilder, onOrbit: Int) = builder.addOffset(14, onOrbit, 0)
        fun addIdOnOrbit(builder: FlatBufferBuilder, idOnOrbit: Int) = builder.addOffset(15, idOnOrbit, 0)
        fun addIdOperatingUnit(builder: FlatBufferBuilder, idOperatingUnit: Int) = builder.addOffset(16, idOperatingUnit, 0)
        fun addOrigNetwork(builder: FlatBufferBuilder, origNetwork: Int) = builder.addOffset(17, origNetwork, 0)
        fun endEntity_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishEntityAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ENTI")
        fun finishSizePrefixedEntity_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ENTI")
    }
}
