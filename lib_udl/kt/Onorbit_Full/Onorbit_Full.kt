 ...
 */
@Suppress("unused")
class Onorbit_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Onorbit_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createOnorbit_Full(builder: FlatBufferBuilder, idOnOrbitOffset: Int, classificationMarkingOffset: Int, satNo: Int, commonNameOffset: Int, constellationOffset: Int, intlDesOffset: Int, launchDateOffset: Int, decayDateOffset: Int, objectType: Byte, originOffset: Int, missionNumberOffset: Int, category: Byte, lifetimeYears: Int, altNameOffset: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceOffset: Int, dataMode: Byte, launchSiteIdOffset: Int, antennasOffset: Int, batteriesOffset: Int, solarArraysOffset: Int, thrustersOffset: Int, onorbitDetailsOffset: Int, countryCodeOffset: Int, origNetworkOffset: Int, entityCollectionOffset: Int) : Int {
            ...
            return endOnorbit_Full(builder)
        }
        fun startOnorbit_Full(builder: FlatBufferBuilder) = builder.startTable(29)
        ...
        fun addEntityCollection(builder: FlatBufferBuilder, entityCollection: Int) = builder.addOffset(28, entityCollection, 0)
        ...
        fun endOnorbit_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishOnorbitFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ONOR")
        fun finishSizePrefixedOnorbit_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ONOR")
    }
}
