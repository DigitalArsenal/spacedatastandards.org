 ...
 */
@Suppress("unused")
class OperatingUnitRemark_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : OperatingUnitRemark_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val idOperatingUnitAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(8, 1)
    fun idOperatingUnitInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 8, 1)
    /**
    ...
    val updatedByAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(26, 1)
    fun updatedByInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 26, 1)
    /**
     * Source of the data.
     * Example: /// Example: some.user
     * Constraints: Minimum length = 1, Maximum length = 64
    ...
    companion object {
        ...
        fun getRootAsOperatingUnitRemark_Full(_bb: ByteBuffer): OperatingUnitRemark_Full = getRootAsOperatingUnitRemark_Full(_bb, OperatingUnitRemark_Full())
        fun getRootAsOperatingUnitRemark_Full(_bb: ByteBuffer, obj: OperatingUnitRemark_Full): OperatingUnitRemark_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun OperatingUnitRemark_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "OPER")
        fun createOperatingUnitRemark_Full(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idOperatingUnitOffset: Int, altRmkIdOffset: Int, nameOffset: Int, typeOffset: Int, textOffset: Int, codeOffset: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte) : Int {
            ...
            return endOperatingUnitRemark_Full(builder)
        }
        fun startOperatingUnitRemark_Full(builder: FlatBufferBuilder) = builder.startTable(15)
        fun addId(builder: FlatBufferBuilder, id: Int) = builder.addOffset(0, id, 0)
        fun addClassificationMarking(builder: FlatBufferBuilder, classificationMarking: Int) = builder.addOffset(1, classificationMarking, 0)
        fun addIdOperatingUnit(builder: FlatBufferBuilder, idOperatingUnit: Int) = builder.addOffset(2, idOperatingUnit, 0)
        ...
        fun addUpdatedBy(builder: FlatBufferBuilder, updatedBy: Int) = builder.addOffset(11, updatedBy, 0)
        ...
        fun endOperatingUnitRemark_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishOperatingUnitRemarkFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "OPER")
        fun finishSizePrefixedOperatingUnitRemark_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "OPER")
    }
}
