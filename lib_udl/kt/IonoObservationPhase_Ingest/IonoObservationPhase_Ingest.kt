 ...
 */
@Suppress("unused")
class IonoObservationPhase_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : IonoObservationPhase_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsIonoObservationPhase_Ingest(_bb: ByteBuffer): IonoObservationPhase_Ingest = getRootAsIonoObservationPhase_Ingest(_bb, IonoObservationPhase_Ingest())
        fun getRootAsIonoObservationPhase_Ingest(_bb: ByteBuffer, obj: IonoObservationPhase_Ingest): IonoObservationPhase_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun IonoObservationPhase_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "IONO")
        fun createIonoObservationPhase_Ingest(builder: FlatBufferBuilder, notesOffset: Int, dimensionsOffset: Int, dimensionNameOffset: Int, dataOffset: Int) : Int {
            ...
            return endIonoObservationPhase_Ingest(builder)
        }
        fun startIonoObservationPhase_Ingest(builder: FlatBufferBuilder) = builder.startTable(4)
        ...
        fun endIonoObservationPhase_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishIonoObservationPhaseIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "IONO")
        fun finishSizePrefixedIonoObservationPhase_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "IONO")
    }
}
