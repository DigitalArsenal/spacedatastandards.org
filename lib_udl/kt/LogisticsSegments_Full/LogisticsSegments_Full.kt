 ...
 */
@Suppress("unused")
class LogisticsSegments_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : LogisticsSegments_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsLogisticsSegments_Full(_bb: ByteBuffer): LogisticsSegments_Full = getRootAsLogisticsSegments_Full(_bb, LogisticsSegments_Full())
        fun getRootAsLogisticsSegments_Full(_bb: ByteBuffer, obj: LogisticsSegments_Full): LogisticsSegments_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun LogisticsSegments_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "LOGI")
        fun createLogisticsSegments_Full(builder: FlatBufferBuilder, segmentNumber: Int, modeCodeOffset: Int, missionTypeOffset: Int, idMissionOffset: Int, extMissionIdOffset: Int, missionNumberOffset: Int, itin: Int, segTailNumberOffset: Int, segAircraftMdsOffset: Int, departureIcaoOffset: Int, segActDepTimeOffset: Int, arrivalIcaoOffset: Int, segActArrTimeOffset: Int, segEstDepTimeOffset: Int, segEstArrTimeOffset: Int) : Int {
            ...
            return endLogisticsSegments_Full(builder)
        }
        fun startLogisticsSegments_Full(builder: FlatBufferBuilder) = builder.startTable(15)
        ...
        fun endLogisticsSegments_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishLogisticsSegmentsFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "LOGI")
        fun finishSizePrefixedLogisticsSegments_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "LOGI")
    }
}
