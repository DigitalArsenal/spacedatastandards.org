 ...
 */
@Suppress("unused")
class OperatingUnitRemark_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : OperatingUnitRemark_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsOperatingUnitRemark_Abridged(_bb: ByteBuffer): OperatingUnitRemark_Abridged = getRootAsOperatingUnitRemark_Abridged(_bb, OperatingUnitRemark_Abridged())
        fun getRootAsOperatingUnitRemark_Abridged(_bb: ByteBuffer, obj: OperatingUnitRemark_Abridged): OperatingUnitRemark_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun OperatingUnitRemark_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "OPER")
        fun createOperatingUnitRemark_Abridged(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idOperatingUnitOffset: Int, altRmkIdOffset: Int, nameOffset: Int, typeOffset: Int, textOffset: Int, codeOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte) : Int {
            ...
            return endOperatingUnitRemark_Abridged(builder)
        }
        fun startOperatingUnitRemark_Abridged(builder: FlatBufferBuilder) = builder.startTable(13)
        ...
        fun endOperatingUnitRemark_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishOperatingUnitRemarkAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "OPER")
        fun finishSizePrefixedOperatingUnitRemark_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "OPER")
    }
}
