 ...
 */
@Suppress("unused")
class AircraftStatusRemark_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : AircraftStatusRemark_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsAircraftStatusRemark_Full(_bb: ByteBuffer): AircraftStatusRemark_Full = getRootAsAircraftStatusRemark_Full(_bb, AircraftStatusRemark_Full())
        fun getRootAsAircraftStatusRemark_Full(_bb: ByteBuffer, obj: AircraftStatusRemark_Full): AircraftStatusRemark_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun AircraftStatusRemark_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "AIRC")
        fun createAircraftStatusRemark_Full(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idAircraftStatusOffset: Int, altRmkIdOffset: Int, nameOffset: Int, textOffset: Int, timestampOffset: Int, lastUpdatedByOffset: Int, lastUpdatedAtOffset: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceDlOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endAircraftStatusRemark_Full(builder)
        }
        fun startAircraftStatusRemark_Full(builder: FlatBufferBuilder) = builder.startTable(18)
        ...
        fun endAircraftStatusRemark_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishAircraftStatusRemarkFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "AIRC")
        fun finishSizePrefixedAircraftStatusRemark_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "AIRC")
    }
}
