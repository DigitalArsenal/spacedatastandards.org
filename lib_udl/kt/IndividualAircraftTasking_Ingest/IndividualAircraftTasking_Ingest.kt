 ...
 */
@Suppress("unused")
class IndividualAircraftTasking_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : IndividualAircraftTasking_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsIndividualAircraftTasking_Ingest(_bb: ByteBuffer): IndividualAircraftTasking_Ingest = getRootAsIndividualAircraftTasking_Ingest(_bb, IndividualAircraftTasking_Ingest())
        fun getRootAsIndividualAircraftTasking_Ingest(_bb: ByteBuffer, obj: IndividualAircraftTasking_Ingest): IndividualAircraftTasking_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun IndividualAircraftTasking_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "INDI")
        fun createIndividualAircraftTasking_Ingest(builder: FlatBufferBuilder, numAcft: Int, acftTypeOffset: Int, callSignOffset: Int, priConfigCodeOffset: Int, secConfigCodeOffset: Int, link16CallSignOffset: Int, tacanChan: Int, juAddressOffset: Int, iffSifMode1CodeOffset: Int, iffSifMode2CodeOffset: Int, iffSifMode3CodeOffset: Int) : Int {
            ...
            return endIndividualAircraftTasking_Ingest(builder)
        }
        fun startIndividualAircraftTasking_Ingest(builder: FlatBufferBuilder) = builder.startTable(11)
        ...
        fun endIndividualAircraftTasking_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishIndividualAircraftTaskingIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "INDI")
        fun finishSizePrefixedIndividualAircraftTasking_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "INDI")
    }
}
