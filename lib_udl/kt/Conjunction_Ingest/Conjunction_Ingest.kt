 ...
 */
@Suppress("unused")
class Conjunction_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Conjunction_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val origIdOnOrbit1AsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(136, 1)
    fun origIdOnOrbit1InByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 136, 1)
    /**
     * Optional place holder for an OnOrbit ID that does not exist in UDL.
    ...
    val origIdOnOrbit2AsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(138, 1)
    fun origIdOnOrbit2InByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 138, 1)
    /**
    ...
    companion object {
        ...
        fun createConjunction_Ingest(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idOnOrbit1Offset: Int, idOnOrbit2Offset: Int, typeOffset: Int, tcaOffset: Int, missDistance: Double, collisionProb: Double, collisionProbMethodOffset: Int, ephemName1Offset: Int, esId1Offset: Int, ephemName2Offset: Int, esId2Offset: Int, relPosR: Double, relPosT: Double, relPosN: Double, relVelMag: Double, relVelR: Double, relVelT: Double, relVelN: Double, screenEntryTimeOffset: Int, screenExitTimeOffset: Int, screenVolumeX: Double, screenVolumeY: Double, screenVolumeZ: Double, volShapeOffset: Int, volEntryTimeOffset: Int, volExitTimeOffset: Int, penetrationLevelSigma: Double, idStateVector1Offset: Int, lastObTime1Offset: Int, cdAoM1: Double, crAoM1: Double, thrustAccel1: Double, idStateVector2Offset: Int, lastObTime2Offset: Int, cdAoM2: Double, crAoM2: Double, thrustAccel2: Double, commentsOffset: Int, ccirOffset: Int, concernNotesOffset: Int, stateDeptNotified: Boolean, ownerContacted: Boolean, rawFileUriOffset: Int, messageForOffset: Int, messageIdOffset: Int, uvwWarn: Boolean, smallRelVelWarning: Boolean, largeRelPosWarning: Boolean, smallCovWarning: Boolean, largeCovWarning: Boolean, transactionIdOffset: Int, sourceOffset: Int, originOffset: Int, originatorOffset: Int, eventIdOffset: Int, descriptorOffset: Int, tagsOffset: Int, dataMode: Byte, createdAtOffset: Int, createdByOffset: Int, stateVector1Offset: Int, stateVector2Offset: Int, satNo1: Int, satNo2: Int, origIdOnOrbit1Offset: Int, origIdOnOrbit2Offset: Int, origNetworkOffset: Int) : Int {
            ...
            return endConjunction_Ingest(builder)
        }
        fun startConjunction_Ingest(builder: FlatBufferBuilder) = builder.startTable(69)
        ...
        fun addOrigIdOnOrbit1(builder: FlatBufferBuilder, origIdOnOrbit1: Int) = builder.addOffset(66, origIdOnOrbit1, 0)
        fun addOrigIdOnOrbit2(builder: FlatBufferBuilder, origIdOnOrbit2: Int) = builder.addOffset(67, origIdOnOrbit2, 0)
        fun addOrigNetwork(builder: FlatBufferBuilder, origNetwork: Int) = builder.addOffset(68, origNetwork, 0)
        fun endConjunction_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishConjunctionIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "CONJ")
        fun finishSizePrefixedConjunction_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "CONJ")
    }
}
