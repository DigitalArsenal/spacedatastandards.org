...
class RFObservation_Abridged : Table() {
    ...
    companion object {
        ...
        fun RFObservation_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "RFOB")
        ...
        fun finishRFObservationAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "RFOB")
        fun finishSizePrefixedRFObservation_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "RFOB")
    }
}
