 ...
 */
@Suppress("unused")
class IonoObservationFrequency_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : IonoObservationFrequency_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsIonoObservationFrequency_Abridged(_bb: ByteBuffer): IonoObservationFrequency_Abridged = getRootAsIonoObservationFrequency_Abridged(_bb, IonoObservationFrequency_Abridged())
        fun getRootAsIonoObservationFrequency_Abridged(_bb: ByteBuffer, obj: IonoObservationFrequency_Abridged): IonoObservationFrequency_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun IonoObservationFrequency_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "IONO")
        fun createIonoObservationFrequency_Abridged(builder: FlatBufferBuilder, notesOffset: Int, dimensionsOffset: Int, dimensionNameOffset: Int, dataOffset: Int) : Int {
            ...
            return endIonoObservationFrequency_Abridged(builder)
        }
        fun startIonoObservationFrequency_Abridged(builder: FlatBufferBuilder) = builder.startTable(4)
        ...
        fun endIonoObservationFrequency_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishIonoObservationFrequencyAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "IONO")
        fun finishSizePrefixedIonoObservationFrequency_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "IONO")
    }
}
