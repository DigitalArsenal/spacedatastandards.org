 ...
 */
@Suppress("unused")
class DataLinkVoiceCoord_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : DataLinkVoiceCoord_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsDataLinkVoiceCoord_Ingest(_bb: ByteBuffer): DataLinkVoiceCoord_Ingest = getRootAsDataLinkVoiceCoord_Ingest(_bb, DataLinkVoiceCoord_Ingest())
        fun getRootAsDataLinkVoiceCoord_Ingest(_bb: ByteBuffer, obj: DataLinkVoiceCoord_Ingest): DataLinkVoiceCoord_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun DataLinkVoiceCoord_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "DATA")
        fun createDataLinkVoiceCoord_Ingest(builder: FlatBufferBuilder, voiceNetDesOffset: Int, freqDesOffset: Int, commPriOffset: Int, teleFreqNumsOffset: Int) : Int {
            ...
            return endDataLinkVoiceCoord_Ingest(builder)
        }
        fun startDataLinkVoiceCoord_Ingest(builder: FlatBufferBuilder) = builder.startTable(4)
        ...
        fun endDataLinkVoiceCoord_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishDataLinkVoiceCoordIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "DATA")
        fun finishSizePrefixedDataLinkVoiceCoord_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "DATA")
    }
}
