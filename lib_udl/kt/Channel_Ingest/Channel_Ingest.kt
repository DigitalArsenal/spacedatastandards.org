 ...
 */
@Suppress("unused")
class Channel_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Channel_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsChannel_Ingest(_bb: ByteBuffer): Channel_Ingest = getRootAsChannel_Ingest(_bb, Channel_Ingest())
        fun getRootAsChannel_Ingest(_bb: ByteBuffer, obj: Channel_Ingest): Channel_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun Channel_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "CHAN")
        fun createChannel_Ingest(builder: FlatBufferBuilder, idOffset: Int, idTransponderOffset: Int, nameOffset: Int, classificationMarkingOffset: Int, typeOffset: Int, idBeamOffset: Int, beamNameOffset: Int, idRfbandOffset: Int, encryptionOffset: Int, pkgOffset: Int, resOffset: Int, compressionOffset: Int, vpidOffset: Int, apidOffset: Int, sidOffset: Int, ownerOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte, createdAtOffset: Int, createdByOffset: Int) : Int {
            ...
            return endChannel_Ingest(builder)
        }
        fun startChannel_Ingest(builder: FlatBufferBuilder) = builder.startTable(22)
        ...
        fun endChannel_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishChannelIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "CHAN")
        fun finishSizePrefixedChannel_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "CHAN")
    }
}
