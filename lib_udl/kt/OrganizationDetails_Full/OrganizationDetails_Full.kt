 ...
 */
@Suppress("unused")
class OrganizationDetails_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : OrganizationDetails_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createOrganizationDetails_Full(builder: FlatBufferBuilder, idOffset: Int, idOrganizationOffset: Int, classificationMarkingOffset: Int, nameOffset: Int, emailOffset: Int, address1Offset: Int, address2Offset: Int, address3Offset: Int, geoAdminLevel1Offset: Int, geoAdminLevel2Offset: Int, geoAdminLevel3Offset: Int, postalCodeOffset: Int, descriptionOffset: Int, formerOrgIdOffset: Int, parentOrgIdOffset: Int, financialYearEndDateOffset: Int, revenue: Double, profit: Double, ebitda: Double, ftes: Int, brokerOffset: Int, ceoOffset: Int, cfoOffset: Int, ctoOffset: Int, riskManagerOffset: Int, massRanking: Int, revenueRanking: Int, financialNotesOffset: Int, servicesNotesOffset: Int, fleetPlanNotesOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, tagsOffset: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, origNetworkOffset: Int) : Int {
            ...
            return endOrganizationDetails_Full(builder)
        }
        fun startOrganizationDetails_Full(builder: FlatBufferBuilder) = builder.startTable(39)
        ...
        fun endOrganizationDetails_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishOrganizationDetailsFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ORGA")
        fun finishSizePrefixedOrganizationDetails_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ORGA")
    }
}
