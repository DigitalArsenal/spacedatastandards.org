 ...
 */
@Suppress("unused")
class MtiHRR_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : MtiHRR_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsMtiHRR_Ingest(_bb: ByteBuffer): MtiHRR_Ingest = getRootAsMtiHRR_Ingest(_bb, MtiHRR_Ingest())
        fun getRootAsMtiHRR_Ingest(_bb: ByteBuffer, obj: MtiHRR_Ingest): MtiHRR_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun MtiHRR_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "MTIH")
        fun createMtiHRR_Ingest(builder: FlatBufferBuilder, h2: Int, h3: Int, h4: Boolean, h5: Int, h6: Int, h7: Int, h8: Int, h9: Int, h10: Int, h11: Double, h12: Double, h13: Double, h14: Double, h15: Double, h16Offset: Int, h17Offset: Int, h18Offset: Int, h19: Double, h20: Int, h21: Int, h22: Int, h23Offset: Int, h24Offset: Int, h27: Int, h28: Long, h29: Int, h30: Int, h31: Int, h32Offset: Int) : Int {
            ...
            addH2(builder, h2)
            addH4(builder, h4)
            return endMtiHRR_Ingest(builder)
        }
        fun startMtiHRR_Ingest(builder: FlatBufferBuilder) = builder.startTable(29)
        ...
        fun endMtiHRR_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishMtiHRRIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "MTIH")
        fun finishSizePrefixedMtiHRR_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "MTIH")
    }
}
