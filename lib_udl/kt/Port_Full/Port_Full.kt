 ...
 */
@Suppress("unused")
class Port_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Port_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsPort_Full(_bb: ByteBuffer): Port_Full = getRootAsPort_Full(_bb, Port_Full())
        fun getRootAsPort_Full(_bb: ByteBuffer, obj: Port_Full): Port_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun Port_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "PORT")
        fun createPort_Full(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idSiteOffset: Int, externalIdOffset: Int, locodeOffset: Int, portNameOffset: Int, harborTypeOffset: Int, harborSize: Double, maxDraught: Double, avgDuration: Double, tideRange: Double, shelterOffset: Int, pilotReqd: Boolean, lat: Double, lon: Double, countryCodeOffset: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceOffset: Int, sourceDlOffset: Int, originOffset: Int, dataMode: Byte, origNetworkOffset: Int) : Int {
            ...
            return endPort_Full(builder)
        }
        fun startPort_Full(builder: FlatBufferBuilder) = builder.startTable(25)
        ...
        fun endPort_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishPortFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "PORT")
        fun finishSizePrefixedPort_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "PORT")
    }
}
