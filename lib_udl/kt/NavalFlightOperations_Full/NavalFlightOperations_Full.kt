 ...
 */
@Suppress("unused")
class NavalFlightOperations_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : NavalFlightOperations_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsNavalFlightOperations_Full(_bb: ByteBuffer): NavalFlightOperations_Full = getRootAsNavalFlightOperations_Full(_bb, NavalFlightOperations_Full())
        fun getRootAsNavalFlightOperations_Full(_bb: ByteBuffer, obj: NavalFlightOperations_Full): NavalFlightOperations_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun NavalFlightOperations_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "NAVA")
        fun createNavalFlightOperations_Full(builder: FlatBufferBuilder, shipNameOffset: Int, fltOpStartOffset: Int, fltOpStopOffset: Int, schdLaunchRcvyTimeOffset: Int) : Int {
            ...
            return endNavalFlightOperations_Full(builder)
        }
        fun startNavalFlightOperations_Full(builder: FlatBufferBuilder) = builder.startTable(4)
        ...
        fun endNavalFlightOperations_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishNavalFlightOperationsFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "NAVA")
        fun finishSizePrefixedNavalFlightOperations_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "NAVA")
    }
}
