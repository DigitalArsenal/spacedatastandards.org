 ...
 */
@Suppress("unused")
class MtiPlatformLocation_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : MtiPlatformLocation_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsMtiPlatformLocation_Abridged(_bb: ByteBuffer): MtiPlatformLocation_Abridged = getRootAsMtiPlatformLocation_Abridged(_bb, MtiPlatformLocation_Abridged())
        fun getRootAsMtiPlatformLocation_Abridged(_bb: ByteBuffer, obj: MtiPlatformLocation_Abridged): MtiPlatformLocation_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun MtiPlatformLocation_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "MTIP")
        fun createMtiPlatformLocation_Abridged(builder: FlatBufferBuilder, l1: Long, l2: Double, l3: Double, l4: Int, l5: Double, l6: Int, l7: Int, platloctsOffset: Int) : Int {
            ...
            addL6(builder, l6)
            addL4(builder, l4)
            return endMtiPlatformLocation_Abridged(builder)
        }
        fun startMtiPlatformLocation_Abridged(builder: FlatBufferBuilder) = builder.startTable(8)
        ...
        fun endMtiPlatformLocation_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishMtiPlatformLocationAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "MTIP")
        fun finishSizePrefixedMtiPlatformLocation_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "MTIP")
    }
}
