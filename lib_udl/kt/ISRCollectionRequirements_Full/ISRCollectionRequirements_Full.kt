 ...
 */
@Suppress("unused")
class ISRCollectionRequirements_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : ISRCollectionRequirements_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsISRCollectionRequirements_Full(_bb: ByteBuffer): ISRCollectionRequirements_Full = getRootAsISRCollectionRequirements_Full(_bb, ISRCollectionRequirements_Full())
        fun getRootAsISRCollectionRequirements_Full(_bb: ByteBuffer, obj: ISRCollectionRequirements_Full): ISRCollectionRequirements_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun ISRCollectionRequirements_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "ISRC")
        fun createISRCollectionRequirements_Full(builder: FlatBufferBuilder, idOffset: Int, hashOffset: Int, typeOffset: Int, cridNumbersOffset: Int, priority: Double, recordIdOffset: Int, reconSurveyOffset: Int, intelDisciplineOffset: Int, secondary: Boolean, emphasized: Boolean, isPrismCr: Boolean, startOffset: Int, stopOffset: Int, operationOffset: Int, supportedUnitOffset: Int, countryOffset: Int, regionOffset: Int, subregionOffset: Int, specialComGuidanceOffset: Int, criticalTimesOffset: Int, exploitationRequirementOffset: Int, targetListOffset: Int) : Int {
            ...
            return endISRCollectionRequirements_Full(builder)
        }
        fun startISRCollectionRequirements_Full(builder: FlatBufferBuilder) = builder.startTable(22)
        ...
        fun endISRCollectionRequirements_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishISRCollectionRequirementsFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ISRC")
        fun finishSizePrefixedISRCollectionRequirements_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ISRC")
    }
}
