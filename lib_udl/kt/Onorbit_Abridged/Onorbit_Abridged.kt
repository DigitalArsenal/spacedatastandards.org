 ...
 */
@Suppress("unused")
class Onorbit_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Onorbit_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val launchSiteIdAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(40, 1)
    fun launchSiteIdInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 40, 1)
    /**
    ...
    val countryCodeAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(42, 1)
    fun countryCodeInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 42, 1)
    /**
    ...
    companion object {
        ...
        fun getRootAsOnorbit_Abridged(_bb: ByteBuffer): Onorbit_Abridged = getRootAsOnorbit_Abridged(_bb, Onorbit_Abridged())
        fun getRootAsOnorbit_Abridged(_bb: ByteBuffer, obj: Onorbit_Abridged): Onorbit_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun Onorbit_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "ONOR")
        fun createOnorbit_Abridged(builder: FlatBufferBuilder, idOnOrbitOffset: Int, classificationMarkingOffset: Int, satNo: Int, commonNameOffset: Int, constellationOffset: Int, intlDesOffset: Int, launchDateOffset: Int, decayDateOffset: Int, objectType: Byte, originOffset: Int, missionNumberOffset: Int, category: Byte, lifetimeYears: Int, altNameOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, dataMode: Byte, launchSiteIdOffset: Int, countryCodeOffset: Int, origNetworkOffset: Int) : Int {
            ...
            return endOnorbit_Abridged(builder)
        }
        fun startOnorbit_Abridged(builder: FlatBufferBuilder) = builder.startTable(21)
        ...
        fun addLaunchSiteId(builder: FlatBufferBuilder, launchSiteId: Int) = builder.addOffset(18, launchSiteId, 0)
        fun addCountryCode(builder: FlatBufferBuilder, countryCode: Int) = builder.addOffset(19, countryCode, 0)
        fun addOrigNetwork(builder: FlatBufferBuilder, origNetwork: Int) = builder.addOffset(20, origNetwork, 0)
        fun endOnorbit_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishOnorbitAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ONOR")
        fun finishSizePrefixedOnorbit_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ONOR")
    }
}
