 ...
 */
@Suppress("unused")
class RFObservationDetails_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : RFObservationDetails_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val urlAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(166, 1)
    fun urlInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 166, 1)
    /**
    ...
    companion object {
        ...
        fun createRFObservationDetails_Ingest(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, obTimeOffset: Int, idOnOrbitOffset: Int, idSensorOffset: Int, typeOffset: Int, satNo: Int, taskIdOffset: Int, transactionIdOffset: Int, trackIdOffset: Int, origObjectIdOffset: Int, origSensorIdOffset: Int, uct: Boolean, transponderOffset: Int, azimuth: Double, azimuthUnc: Double, azimuthRate: Double, elevation: Double, elevationUnc: Double, elevationRate: Double, range: Double, rangeUnc: Double, rangeRate: Double, rangeRateUnc: Double, trackRange: Double, senlat: Double, senlon: Double, senalt: Double, elnotOffset: Int, frequency: Double, nominalFrequency: Double, startFrequency: Double, endFrequency: Double, relativeCarrierPower: Double, spectrumAnalyzerPower: Double, relativeNoiseFloor: Double, referenceLevel: Double, pgri: Double, confidence: Double, incoming: Boolean, switchPoint: Int, baudRate: Double, snr: Double, nominalSnr: Double, polarity: Double, polarityType: Byte, channel: Int, powerOverNoise: Double, nominalPowerOverNoise: Double, bandwidth: Double, nominalBandwidth: Double, resolutionBandwidth: Double, videoBandwidth: Double, eirp: Double, nominalEirp: Double, minPsd: Double, maxPsd: Double, frequencyShift: Double, peak: Boolean, antennaNameOffset: Int, detectionStatusOffset: Int, collectionModeOffset: Int, rawFileUriOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, tagsOffset: Int, createdAtOffset: Int, createdByOffset: Int, noisePwrDensity: Double, carrierStandardOffset: Int, modulationOffset: Int, innerCodingRate: Int, outerCodingRate: Int, transmitFilterTypeOffset: Int, transmitFilterRollOff: Double, symbolToNoiseRatio: Double, bitErrorRate: Double, origNetworkOffset: Int, sourceDlOffset: Int, descriptorOffset: Int, urlOffset: Int, frequenciesOffset: Int, powersOffset: Int, snrsOffset: Int, confidencesOffset: Int, detectionStatusesOffset: Int, chipRatesOffset: Int, codeTapsOffset: Int, codeFillsOffset: Int, codeLengthsOffset: Int, pnOrdersOffset: Int, signalIdsOffset: Int, baudRatesOffset: Int, telemetryIdsOffset: Int, constellationXpointsOffset: Int, constellationYpointsOffset: Int) : Int {
            ...
            addUct(builder, uct)
            return endRFObservationDetails_Ingest(builder)
        }
        fun startRFObservationDetails_Ingest(builder: FlatBufferBuilder) = builder.startTable(97)
        ...
        fun addUrl(builder: FlatBufferBuilder, url: Int) = builder.addOffset(81, url, 0)
        fun addFrequencies(builder: FlatBufferBuilder, frequencies: Int) = builder.addOffset(82, frequencies, 0)
        ...
        fun addPowers(builder: FlatBufferBuilder, powers: Int) = builder.addOffset(83, powers, 0)
        ...
        fun addSnrs(builder: FlatBufferBuilder, snrs: Int) = builder.addOffset(84, snrs, 0)
        ...
        fun addConfidences(builder: FlatBufferBuilder, confidences: Int) = builder.addOffset(85, confidences, 0)
        ...
        fun addDetectionStatuses(builder: FlatBufferBuilder, detectionStatuses: Int) = builder.addOffset(86, detectionStatuses, 0)
        ...
        fun addChipRates(builder: FlatBufferBuilder, chipRates: Int) = builder.addOffset(87, chipRates, 0)
        ...
        fun addCodeTaps(builder: FlatBufferBuilder, codeTaps: Int) = builder.addOffset(88, codeTaps, 0)
        ...
        fun addCodeFills(builder: FlatBufferBuilder, codeFills: Int) = builder.addOffset(89, codeFills, 0)
        ...
        fun addCodeLengths(builder: FlatBufferBuilder, codeLengths: Int) = builder.addOffset(90, codeLengths, 0)
        ...
        fun addPnOrders(builder: FlatBufferBuilder, pnOrders: Int) = builder.addOffset(91, pnOrders, 0)
        ...
        fun addSignalIds(builder: FlatBufferBuilder, signalIds: Int) = builder.addOffset(92, signalIds, 0)
        ...
        fun addBaudRates(builder: FlatBufferBuilder, baudRates: Int) = builder.addOffset(93, baudRates, 0)
        ...
        fun addTelemetryIds(builder: FlatBufferBuilder, telemetryIds: Int) = builder.addOffset(94, telemetryIds, 0)
        ...
        fun addConstellationXPoints(builder: FlatBufferBuilder, constellationXpoints: Int) = builder.addOffset(95, constellationXpoints, 0)
        ...
        fun addConstellationYPoints(builder: FlatBufferBuilder, constellationYpoints: Int) = builder.addOffset(96, constellationYpoints, 0)
        ...
        fun endRFObservationDetails_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishRFObservationDetailsIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "RFOB")
        fun finishSizePrefixedRFObservationDetails_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "RFOB")
    }
}
