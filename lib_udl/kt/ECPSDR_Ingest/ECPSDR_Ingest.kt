 ...
 */
@Suppress("unused")
class ECPSDR_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : ECPSDR_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createECPSDR_Ingest(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idOnOrbitOffset: Int, satNo: Int, origObjectIdOffset: Int, idSensorOffset: Int, origSensorIdOffset: Int, typeOffset: Int, msgTimeOffset: Int, obTimeOffset: Int, retransmit: Boolean, senModeOffset: Int, dosBias: Int, asl5VcurrMon: Int, dsl5VcurrMon: Int, psTempMon: Int, cdsPlateVmon: Int, cdsRefVmon: Int, mpTemp: Int, vRef: Int, pd1SigLev: Int, pd2SigLev: Int, esdTrigCountL: Int, esdTrigCountH: Int, lowLetL: Int, lowLetM: Int, medLet1L: Int, medLet1M: Int, medLet2L: Int, medLet2M: Int, medLet3L: Int, medLet3M: Int, medLet4L: Int, medLet4M: Int, hiLetL: Int, hiLetM: Int, surfDosL: Int, surfDosM: Int, surfDosH: Int, surfDosChargeL: Int, surfDosChargeH: Int, surfDosStat: Int, cdsThrottle: Int, cdsThreshold: Int, checksum: Int, transientDataOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endECPSDR_Ingest(builder)
        }
        fun startECPSDR_Ingest(builder: FlatBufferBuilder) = builder.startTable(52)
        ...
        fun endECPSDR_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishECPSDRIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ECPS")
        fun finishSizePrefixedECPSDR_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ECPS")
    }
}
