 ...
 */
@Suppress("unused")
class AirfieldSlotConsumption_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : AirfieldSlotConsumption_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createAirfieldSlotConsumption_Ingest(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idAirfieldSlotOffset: Int, status: Byte, occupied: Boolean, consumerOffset: Int, occAircraftMdsOffset: Int, occTailNumberOffset: Int, callSignsOffset: Int, missionIdOffset: Int, numAircraft: Int, occStartTimeOffset: Int, resAircraftMdsOffset: Int, resTailNumberOffset: Int, resTypeOffset: Int, resReasonOffset: Int, resMissionIdOffset: Int, startTimeOffset: Int, endTimeOffset: Int, targetTimeOffset: Int, idArrSortieOffset: Int, idDepSortieOffset: Int, altArrSortieIdOffset: Int, altDepSortieIdOffset: Int, reqCommentOffset: Int, appCommentOffset: Int, reqOrgOffset: Int, reqInitialsOffset: Int, appOrgOffset: Int, appInitialsOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceDlOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endAirfieldSlotConsumption_Ingest(builder)
        }
        fun startAirfieldSlotConsumption_Ingest(builder: FlatBufferBuilder) = builder.startTable(37)
        ...
        fun endAirfieldSlotConsumption_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishAirfieldSlotConsumptionIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "AIRF")
        fun finishSizePrefixedAirfieldSlotConsumption_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "AIRF")
    }
}
