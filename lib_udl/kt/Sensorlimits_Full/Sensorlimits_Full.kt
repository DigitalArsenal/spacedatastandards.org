 ...
 */
@Suppress("unused")
class Sensorlimits_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Sensorlimits_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val idSensorAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(38, 1)
    fun idSensorInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 38, 1)
    companion object {
        fun validateVersion() = Constants.FLATBUFFERS_24_3_25()
        fun getRootAsSensorlimits_Full(_bb: ByteBuffer): Sensorlimits_Full = getRootAsSensorlimits_Full(_bb, Sensorlimits_Full())
        fun getRootAsSensorlimits_Full(_bb: ByteBuffer, obj: Sensorlimits_Full): Sensorlimits_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun Sensorlimits_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "SENS")
        fun createSensorlimits_Full(builder: FlatBufferBuilder, idSensorLimitsOffset: Int, classificationMarkingOffset: Int, origNetworkOffset: Int, upperLeftAzimuthLimit: Double, upperRightAzimuthLimit: Double, lowerRightAzimuthLimit: Double, lowerLeftAzimuthLimit: Double, lowerLeftElevationLimit: Double, upperLeftElevationLimit: Double, lowerRightElevationLimit: Double, upperRightElevationLimit: Double, sourceOffset: Int, dataMode: Byte, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, idSensorOffset: Int) : Int {
            ...
            return endSensorlimits_Full(builder)
        }
        fun startSensorlimits_Full(builder: FlatBufferBuilder) = builder.startTable(18)
        ...
        fun addIdSensor(builder: FlatBufferBuilder, idSensor: Int) = builder.addOffset(17, idSensor, 0)
        fun endSensorlimits_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishSensorlimitsFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "SENS")
        fun finishSizePrefixedSensorlimits_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "SENS")
    }
}
