 ...
 */
@Suppress("unused")
class DiplomaticClearanceDetails_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : DiplomaticClearanceDetails_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsDiplomaticClearanceDetails_Abridged(_bb: ByteBuffer): DiplomaticClearanceDetails_Abridged = getRootAsDiplomaticClearanceDetails_Abridged(_bb, DiplomaticClearanceDetails_Abridged())
        fun getRootAsDiplomaticClearanceDetails_Abridged(_bb: ByteBuffer, obj: DiplomaticClearanceDetails_Abridged): DiplomaticClearanceDetails_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun DiplomaticClearanceDetails_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "DIPL")
        fun createDiplomaticClearanceDetails_Abridged(builder: FlatBufferBuilder, idSortieOffset: Int, legNum: Int, routeStringOffset: Int, validStartTimeOffset: Int, validEndTimeOffset: Int, clearanceIdOffset: Int, externalClearanceIdOffset: Int, clearedCallSignOffset: Int, sequenceNum: Int, countryCodeOffset: Int, altCountryCodeOffset: Int, countryNameOffset: Int, validDescOffset: Int, windowRemarkOffset: Int, entryPointOffset: Int, entryNetOffset: Int, exitPointOffset: Int, exitNltOffset: Int, reqIcao: Boolean, actionOffset: Int, statusOffset: Int, profileOffset: Int, reqPoint: Boolean, clearanceRemarkOffset: Int) : Int {
            ...
            return endDiplomaticClearanceDetails_Abridged(builder)
        }
        fun startDiplomaticClearanceDetails_Abridged(builder: FlatBufferBuilder) = builder.startTable(24)
        ...
        fun endDiplomaticClearanceDetails_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishDiplomaticClearanceDetailsAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "DIPL")
        fun finishSizePrefixedDiplomaticClearanceDetails_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "DIPL")
    }
}
