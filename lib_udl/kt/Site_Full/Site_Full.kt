 ...
 */
@Suppress("unused")
class Site_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Site_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val entityAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(6, 1)
    fun entityInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 6, 1)
    /**
    ...
    val idParentSiteAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(10, 1)
    fun idParentSiteInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 10, 1)
    /**
    ...
    val classificationMarkingAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(12, 1)
    fun classificationMarkingInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 12, 1)
    /**
    ...
    val origSiteIdAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(14, 1)
    fun origSiteIdInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 14, 1)
    /**
    ...
    val origLzIdAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(16, 1)
    fun origLzIdInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 16, 1)
    /**
    ...
    val pinAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(18, 1)
    fun pinInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 18, 1)
    /**
    ...
    val usageAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(22, 1)
    fun usageInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 22, 1)
    /**
    ...
    val lzUsageAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(24, 1)
    fun lzUsageInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 24, 1)
    /**
    ...
    val coordDatumAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(28, 1)
    fun coordDatumInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 28, 1)
    /**
    ...
    val coordAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(30, 1)
    fun coordInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 30, 1)
    /**
    ...
    val osuffixAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(34, 1)
    fun osuffixInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 34, 1)
    /**
    ...
    val iataAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(36, 1)
    fun iataInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 36, 1)
    /**
    ...
    val icaoAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(38, 1)
    fun icaoInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 38, 1)
    /**
    ...
    val faaAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(40, 1)
    fun faaInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 40, 1)
    /**
    ...
    val airDefAreaAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(42, 1)
    fun airDefAreaInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 42, 1)
    /**
    ...
    val utmAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(44, 1)
    fun utmInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 44, 1)
    /**
    ...
    val milGridSysAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(46, 1)
    fun milGridSysInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 46, 1)
    /**
    ...
    val milGridAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(48, 1)
    fun milGridInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 48, 1)
    /**
    ...
    val catCodeAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(50, 1)
    fun catCodeInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 50, 1)
    /**
    ...
    val catTextAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(52, 1)
    fun catTextInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 52, 1)
    /**
    ...
    val wacAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(54, 1)
    fun wacInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 54, 1)
    /**
    ...
    val polSubdivAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(56, 1)
    fun polSubdivInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 56, 1)
    /**
    ...
    val geoAreaAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(58, 1)
    fun geoAreaInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 58, 1)
    /**
    ...
    val allegianceAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(62, 1)
    fun allegianceInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 62, 1)
    /**
    ...
    val altAllegianceAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(64, 1)
    fun altAllegianceInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 64, 1)
    /**
    ...
    val classRatingAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(66, 1)
    fun classRatingInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 66, 1)
    /**
    ...
    val fpaAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(68, 1)
    fun fpaInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 68, 1)
    /**
    ...
    val beNumberAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(70, 1)
    fun beNumberInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 70, 1)
    /**
    ...
    val conditionAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(76, 1)
    fun conditionInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 76, 1)
    /**
    ...
    val conditionAvailAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(78, 1)
    fun conditionAvailInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 78, 1)
    /**
    ...
    val operStatusAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(80, 1)
    fun operStatusInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 80, 1)
    /**
    ...
    val activityAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(84, 1)
    fun activityInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 84, 1)
    /**
    ...
    val functPrimaryAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(86, 1)
    fun functPrimaryInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 86, 1)
    /**
    ...
    val msnPrimaryAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(88, 1)
    fun msnPrimaryInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 88, 1)
    /**
    ...
    val msnPrimarySpecAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(90, 1)
    fun msnPrimarySpecInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 90, 1)
    /**
    ...
    val nucCapAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(92, 1)
    fun nucCapInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 92, 1)
    /**
    ...
    val identAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(94, 1)
    fun identInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 94, 1)
    /**
    ...
    val vegTypeAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(104, 1)
    fun vegTypeInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 104, 1)
    /**
    ...
    val notesAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(110, 1)
    fun notesInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 110, 1)
    /**
    ...
    val resProdAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(112, 1)
    fun resProdInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 112, 1)
    /**
    ...
    val reviewDateAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(116, 1)
    fun reviewDateInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 116, 1)
    /**
    ...
    val recStatusAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(118, 1)
    fun recStatusInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 118, 1)
    /**
    ...
    val symCodeAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(120, 1)
    fun symCodeInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 120, 1)
    /**
    ...
    val referenceDocAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(122, 1)
    fun referenceDocInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 122, 1)
    /**
    ...
    val createdAtAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(126, 1)
    fun createdAtInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 126, 1)
    /**
    ...
    val createdByAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(128, 1)
    fun createdByInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 128, 1)
    /**
    ...
    val updatedAtAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(130, 1)
    fun updatedAtInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 130, 1)
    /**
    ...
    val updatedByAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(132, 1)
    fun updatedByInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 132, 1)
    /**
     * Source of the data.
    ...
    companion object {
        ...
        fun getRootAsSite_Full(_bb: ByteBuffer): Site_Full = getRootAsSite_Full(_bb, Site_Full())
        fun getRootAsSite_Full(_bb: ByteBuffer, obj: Site_Full): Site_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun Site_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "SITE")
        fun createSite_Full(builder: FlatBufferBuilder, idOffset: Int, entityOffset: Int, idEntityOffset: Int, idParentSiteOffset: Int, classificationMarkingOffset: Int, origSiteIdOffset: Int, origLzIdOffset: Int, pinOffset: Int, typeOffset: Int, usageOffset: Int, lzUsageOffset: Int, nameOffset: Int, coordDatumOffset: Int, coordOffset: Int, coordDerivAcc: Double, osuffixOffset: Int, iataOffset: Int, icaoOffset: Int, faaOffset: Int, airDefAreaOffset: Int, utmOffset: Int, milGridSysOffset: Int, milGridOffset: Int, catCodeOffset: Int, catTextOffset: Int, wacOffset: Int, polSubdivOffset: Int, geoAreaOffset: Int, geoidalMslSep: Double, allegianceOffset: Int, altAllegianceOffset: Int, classRatingOffset: Int, fpaOffset: Int, beNumberOffset: Int, runways: Int, maxRunwayLength: Int, conditionOffset: Int, conditionAvailOffset: Int, operStatusOffset: Int, grade: Int, activityOffset: Int, functPrimaryOffset: Int, msnPrimaryOffset: Int, msnPrimarySpecOffset: Int, nucCapOffset: Int, identOffset: Int, elevMsl: Double, elevMslConfLvl: Int, elevMslDerivAcc: Double, vegHt: Double, vegTypeOffset: Int, popArea: Boolean, popAreaProx: Double, notesOffset: Int, resProdOffset: Int, eval: Int, reviewDateOffset: Int, recStatusOffset: Int, symCodeOffset: Int, referenceDocOffset: Int, siteRemarksOffset: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            addSiteRemarks(builder, siteRemarksOffset)
            ...
            return endSite_Full(builder)
        }
        fun startSite_Full(builder: FlatBufferBuilder) = builder.startTable(69)
        fun addId(builder: FlatBufferBuilder, id: Int) = builder.addOffset(0, id, 0)
        fun addEntity(builder: FlatBufferBuilder, entity: Int) = builder.addOffset(1, entity, 0)
        fun addIdEntity(builder: FlatBufferBuilder, idEntity: Int) = builder.addOffset(2, idEntity, 0)
        fun addIdParentSite(builder: FlatBufferBuilder, idParentSite: Int) = builder.addOffset(3, idParentSite, 0)
        fun addClassificationMarking(builder: FlatBufferBuilder, classificationMarking: Int) = builder.addOffset(4, classificationMarking, 0)
        fun addOrigSiteID(builder: FlatBufferBuilder, origSiteId: Int) = builder.addOffset(5, origSiteId, 0)
        fun addOrigLzId(builder: FlatBufferBuilder, origLzId: Int) = builder.addOffset(6, origLzId, 0)
        fun addPin(builder: FlatBufferBuilder, pin: Int) = builder.addOffset(7, pin, 0)
        fun addType(builder: FlatBufferBuilder, type: Int) = builder.addOffset(8, type, 0)
        fun addUsage(builder: FlatBufferBuilder, usage: Int) = builder.addOffset(9, usage, 0)
        fun addLzUsage(builder: FlatBufferBuilder, lzUsage: Int) = builder.addOffset(10, lzUsage, 0)
        fun addName(builder: FlatBufferBuilder, name: Int) = builder.addOffset(11, name, 0)
        fun addCoordDatum(builder: FlatBufferBuilder, coordDatum: Int) = builder.addOffset(12, coordDatum, 0)
        fun addCoord(builder: FlatBufferBuilder, coord: Int) = builder.addOffset(13, coord, 0)
        fun addCoordDerivAcc(builder: FlatBufferBuilder, coordDerivAcc: Double) = builder.addDouble(14, coordDerivAcc, 0.0)
        fun addOsuffix(builder: FlatBufferBuilder, osuffix: Int) = builder.addOffset(15, osuffix, 0)
        fun addIata(builder: FlatBufferBuilder, iata: Int) = builder.addOffset(16, iata, 0)
        fun addIcao(builder: FlatBufferBuilder, icao: Int) = builder.addOffset(17, icao, 0)
        fun addFaa(builder: FlatBufferBuilder, faa: Int) = builder.addOffset(18, faa, 0)
        fun addAirDefArea(builder: FlatBufferBuilder, airDefArea: Int) = builder.addOffset(19, airDefArea, 0)
        fun addUtm(builder: FlatBufferBuilder, utm: Int) = builder.addOffset(20, utm, 0)
        fun addMilGridSys(builder: FlatBufferBuilder, milGridSys: Int) = builder.addOffset(21, milGridSys, 0)
        fun addMilGrid(builder: FlatBufferBuilder, milGrid: Int) = builder.addOffset(22, milGrid, 0)
        fun addCatCode(builder: FlatBufferBuilder, catCode: Int) = builder.addOffset(23, catCode, 0)
        fun addCatText(builder: FlatBufferBuilder, catText: Int) = builder.addOffset(24, catText, 0)
        fun addWac(builder: FlatBufferBuilder, wac: Int) = builder.addOffset(25, wac, 0)
        fun addPolSubdiv(builder: FlatBufferBuilder, polSubdiv: Int) = builder.addOffset(26, polSubdiv, 0)
        fun addGeoArea(builder: FlatBufferBuilder, geoArea: Int) = builder.addOffset(27, geoArea, 0)
        fun addGeoidalMslSep(builder: FlatBufferBuilder, geoidalMslSep: Double) = builder.addDouble(28, geoidalMslSep, 0.0)
        fun addAllegiance(builder: FlatBufferBuilder, allegiance: Int) = builder.addOffset(29, allegiance, 0)
        fun addAltAllegiance(builder: FlatBufferBuilder, altAllegiance: Int) = builder.addOffset(30, altAllegiance, 0)
        fun addClassRating(builder: FlatBufferBuilder, classRating: Int) = builder.addOffset(31, classRating, 0)
        fun addFpa(builder: FlatBufferBuilder, fpa: Int) = builder.addOffset(32, fpa, 0)
        fun addBeNumber(builder: FlatBufferBuilder, beNumber: Int) = builder.addOffset(33, beNumber, 0)
        fun addRunways(builder: FlatBufferBuilder, runways: Int) = builder.addInt(34, runways, 0)
        fun addMaxRunwayLength(builder: FlatBufferBuilder, maxRunwayLength: Int) = builder.addInt(35, maxRunwayLength, 0)
        fun addCondition(builder: FlatBufferBuilder, condition: Int) = builder.addOffset(36, condition, 0)
        fun addConditionAvail(builder: FlatBufferBuilder, conditionAvail: Int) = builder.addOffset(37, conditionAvail, 0)
        fun addOperStatus(builder: FlatBufferBuilder, operStatus: Int) = builder.addOffset(38, operStatus, 0)
        fun addGrade(builder: FlatBufferBuilder, grade: Int) = builder.addInt(39, grade, 0)
        fun addActivity(builder: FlatBufferBuilder, activity: Int) = builder.addOffset(40, activity, 0)
        fun addFunctPrimary(builder: FlatBufferBuilder, functPrimary: Int) = builder.addOffset(41, functPrimary, 0)
        fun addMsnPrimary(builder: FlatBufferBuilder, msnPrimary: Int) = builder.addOffset(42, msnPrimary, 0)
        fun addMsnPrimarySpec(builder: FlatBufferBuilder, msnPrimarySpec: Int) = builder.addOffset(43, msnPrimarySpec, 0)
        fun addNucCap(builder: FlatBufferBuilder, nucCap: Int) = builder.addOffset(44, nucCap, 0)
        fun addIdent(builder: FlatBufferBuilder, ident: Int) = builder.addOffset(45, ident, 0)
        fun addElevMsl(builder: FlatBufferBuilder, elevMsl: Double) = builder.addDouble(46, elevMsl, 0.0)
        fun addElevMslConfLvl(builder: FlatBufferBuilder, elevMslConfLvl: Int) = builder.addInt(47, elevMslConfLvl, 0)
        fun addElevMslDerivAcc(builder: FlatBufferBuilder, elevMslDerivAcc: Double) = builder.addDouble(48, elevMslDerivAcc, 0.0)
        fun addVegHt(builder: FlatBufferBuilder, vegHt: Double) = builder.addDouble(49, vegHt, 0.0)
        fun addVegType(builder: FlatBufferBuilder, vegType: Int) = builder.addOffset(50, vegType, 0)
        fun addPopArea(builder: FlatBufferBuilder, popArea: Boolean) = builder.addBoolean(51, popArea, false)
        fun addPopAreaProx(builder: FlatBufferBuilder, popAreaProx: Double) = builder.addDouble(52, popAreaProx, 0.0)
        fun addNotes(builder: FlatBufferBuilder, notes: Int) = builder.addOffset(53, notes, 0)
        fun addResProd(builder: FlatBufferBuilder, resProd: Int) = builder.addOffset(54, resProd, 0)
        fun addEval(builder: FlatBufferBuilder, eval: Int) = builder.addInt(55, eval, 0)
        fun addReviewDate(builder: FlatBufferBuilder, reviewDate: Int) = builder.addOffset(56, reviewDate, 0)
        fun addRecStatus(builder: FlatBufferBuilder, recStatus: Int) = builder.addOffset(57, recStatus, 0)
        fun addSymCode(builder: FlatBufferBuilder, symCode: Int) = builder.addOffset(58, symCode, 0)
        fun addReferenceDoc(builder: FlatBufferBuilder, referenceDoc: Int) = builder.addOffset(59, referenceDoc, 0)
        fun addSiteRemarks(builder: FlatBufferBuilder, siteRemarks: Int) = builder.addOffset(60, siteRemarks, 0)
        fun createSiteRemarksVector(builder: FlatBufferBuilder, data: IntArray) : Int {
        ...
        fun startSiteRemarksVector(builder: FlatBufferBuilder, numElems: Int) = builder.startVector(4, numElems, 4)
        fun addCreatedAt(builder: FlatBufferBuilder, createdAt: Int) = builder.addOffset(61, createdAt, 0)
        fun addCreatedBy(builder: FlatBufferBuilder, createdBy: Int) = builder.addOffset(62, createdBy, 0)
        fun addUpdatedAt(builder: FlatBufferBuilder, updatedAt: Int) = builder.addOffset(63, updatedAt, 0)
        fun addUpdatedBy(builder: FlatBufferBuilder, updatedBy: Int) = builder.addOffset(64, updatedBy, 0)
        ...
        fun addDataMode(builder: FlatBufferBuilder, dataMode: Byte) = builder.addByte(68, dataMode, 0)
        fun endSite_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishSiteFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "SITE")
        fun finishSizePrefixedSite_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "SITE")
    }
}
