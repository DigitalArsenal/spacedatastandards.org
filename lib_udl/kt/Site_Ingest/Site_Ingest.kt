 ...
 */
@Suppress("unused")
class Site_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Site_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val sourceAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(128, 1)
    fun sourceInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 128, 1)
    /**
    ...
    val originAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(130, 1)
    fun originInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 130, 1)
    /**
    ...
    val origNetworkAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(132, 1)
    fun origNetworkInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 132, 1)
    /**
    ...
    companion object {
        ...
        fun createSite_Ingest(builder: FlatBufferBuilder, idOffset: Int, entityOffset: Int, idEntityOffset: Int, idParentSiteOffset: Int, classificationMarkingOffset: Int, origSiteIdOffset: Int, origLzIdOffset: Int, pinOffset: Int, typeOffset: Int, usageOffset: Int, lzUsageOffset: Int, nameOffset: Int, coordDatumOffset: Int, coordOffset: Int, coordDerivAcc: Double, osuffixOffset: Int, iataOffset: Int, icaoOffset: Int, faaOffset: Int, airDefAreaOffset: Int, utmOffset: Int, milGridSysOffset: Int, milGridOffset: Int, catCodeOffset: Int, catTextOffset: Int, wacOffset: Int, polSubdivOffset: Int, geoAreaOffset: Int, geoidalMslSep: Double, allegianceOffset: Int, altAllegianceOffset: Int, classRatingOffset: Int, fpaOffset: Int, beNumberOffset: Int, runways: Int, maxRunwayLength: Int, conditionOffset: Int, conditionAvailOffset: Int, operStatusOffset: Int, grade: Int, activityOffset: Int, functPrimaryOffset: Int, msnPrimaryOffset: Int, msnPrimarySpecOffset: Int, nucCapOffset: Int, identOffset: Int, elevMsl: Double, elevMslConfLvl: Int, elevMslDerivAcc: Double, vegHt: Double, vegTypeOffset: Int, popArea: Boolean, popAreaProx: Double, notesOffset: Int, resProdOffset: Int, eval: Int, reviewDateOffset: Int, recStatusOffset: Int, symCodeOffset: Int, referenceDocOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endSite_Ingest(builder)
        }
        fun startSite_Ingest(builder: FlatBufferBuilder) = builder.startTable(66)
        ...
        fun addSource(builder: FlatBufferBuilder, source: Int) = builder.addOffset(62, source, 0)
        fun addOrigin(builder: FlatBufferBuilder, origin: Int) = builder.addOffset(63, origin, 0)
        fun addOrigNetwork(builder: FlatBufferBuilder, origNetwork: Int) = builder.addOffset(64, origNetwork, 0)
        fun addDataMode(builder: FlatBufferBuilder, dataMode: Byte) = builder.addByte(65, dataMode, 0)
        fun endSite_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishSiteIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "SITE")
        fun finishSizePrefixedSite_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "SITE")
    }
}
