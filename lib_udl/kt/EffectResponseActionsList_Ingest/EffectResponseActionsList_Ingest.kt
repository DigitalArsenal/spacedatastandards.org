 ...
 */
@Suppress("unused")
class EffectResponseActionsList_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : EffectResponseActionsList_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsEffectResponseActionsList_Ingest(_bb: ByteBuffer): EffectResponseActionsList_Ingest = getRootAsEffectResponseActionsList_Ingest(_bb, EffectResponseActionsList_Ingest())
        fun getRootAsEffectResponseActionsList_Ingest(_bb: ByteBuffer, obj: EffectResponseActionsList_Ingest): EffectResponseActionsList_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun EffectResponseActionsList_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "EFFE")
        fun createEffectResponseActionsList_Ingest(builder: FlatBufferBuilder, summaryOffset: Int, actionIdOffset: Int, actionStartTimeOffset: Int, actionEndTimeOffset: Int, totStartTimeOffset: Int, totEndTimeOffset: Int, actionActorSrcTypeOffset: Int, actionActorSrcIdOffset: Int, effectorOffset: Int, targetSrcTypeOffset: Int, targetSrcIdOffset: Int, actorInterceptLat: Double, actorInterceptLon: Double, actorInterceptAlt: Double, weaponInterceptLat: Double, weaponInterceptLon: Double, weaponInterceptAlt: Double, actionMetricsOffset: Int) : Int {
            ...
            return endEffectResponseActionsList_Ingest(builder)
        }
        fun startEffectResponseActionsList_Ingest(builder: FlatBufferBuilder) = builder.startTable(18)
        ...
        fun endEffectResponseActionsList_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishEffectResponseActionsListIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "EFFE")
        fun finishSizePrefixedEffectResponseActionsList_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "EFFE")
    }
}
