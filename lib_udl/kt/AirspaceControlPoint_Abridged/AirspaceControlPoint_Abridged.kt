 ...
 */
@Suppress("unused")
class AirspaceControlPoint_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : AirspaceControlPoint_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsAirspaceControlPoint_Abridged(_bb: ByteBuffer): AirspaceControlPoint_Abridged = getRootAsAirspaceControlPoint_Abridged(_bb, AirspaceControlPoint_Abridged())
        fun getRootAsAirspaceControlPoint_Abridged(_bb: ByteBuffer, obj: AirspaceControlPoint_Abridged): AirspaceControlPoint_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun AirspaceControlPoint_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "AIRS")
        fun createAirspaceControlPoint_Abridged(builder: FlatBufferBuilder, ctrlPtTypeOffset: Int, ctrlPtNameOffset: Int, ctrlPtLocationOffset: Int, ctrlPtAltitudeOffset: Int) : Int {
            ...
            return endAirspaceControlPoint_Abridged(builder)
        }
        fun startAirspaceControlPoint_Abridged(builder: FlatBufferBuilder) = builder.startTable(4)
        ...
        fun endAirspaceControlPoint_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishAirspaceControlPointAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "AIRS")
        fun finishSizePrefixedAirspaceControlPoint_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "AIRS")
    }
}
