 ...
 */
@Suppress("unused")
class IonoObservationAmplitude_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : IonoObservationAmplitude_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsIonoObservationAmplitude_Abridged(_bb: ByteBuffer): IonoObservationAmplitude_Abridged = getRootAsIonoObservationAmplitude_Abridged(_bb, IonoObservationAmplitude_Abridged())
        fun getRootAsIonoObservationAmplitude_Abridged(_bb: ByteBuffer, obj: IonoObservationAmplitude_Abridged): IonoObservationAmplitude_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun IonoObservationAmplitude_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "IONO")
        fun createIonoObservationAmplitude_Abridged(builder: FlatBufferBuilder, notesOffset: Int, dimensionsOffset: Int, dimensionNameOffset: Int, dataOffset: Int) : Int {
            ...
            return endIonoObservationAmplitude_Abridged(builder)
        }
        fun startIonoObservationAmplitude_Abridged(builder: FlatBufferBuilder) = builder.startTable(4)
        ...
        fun endIonoObservationAmplitude_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishIonoObservationAmplitudeAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "IONO")
        fun finishSizePrefixedIonoObservationAmplitude_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "IONO")
    }
}
