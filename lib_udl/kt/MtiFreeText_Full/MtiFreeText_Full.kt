 ...
 */
@Suppress("unused")
class MtiFreeText_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : MtiFreeText_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsMtiFreeText_Full(_bb: ByteBuffer): MtiFreeText_Full = getRootAsMtiFreeText_Full(_bb, MtiFreeText_Full())
        fun getRootAsMtiFreeText_Full(_bb: ByteBuffer, obj: MtiFreeText_Full): MtiFreeText_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun MtiFreeText_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "MTIF")
        fun createMtiFreeText_Full(builder: FlatBufferBuilder, f1Offset: Int, f2Offset: Int, f3Offset: Int) : Int {
            builder.startTable(3)
            addF3(builder, f3Offset)
            addF2(builder, f2Offset)
            addF1(builder, f1Offset)
            return endMtiFreeText_Full(builder)
        }
        fun startMtiFreeText_Full(builder: FlatBufferBuilder) = builder.startTable(3)
        ...
        fun endMtiFreeText_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishMtiFreeTextFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "MTIF")
        fun finishSizePrefixedMtiFreeText_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "MTIF")
    }
}
