 ...
 */
@Suppress("unused")
class BeamContour_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : BeamContour_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsBeamContour_Full(_bb: ByteBuffer): BeamContour_Full = getRootAsBeamContour_Full(_bb, BeamContour_Full())
        fun getRootAsBeamContour_Full(_bb: ByteBuffer, obj: BeamContour_Full): BeamContour_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun BeamContour_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "BEAM")
        fun createBeamContour_Full(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idBeamOffset: Int, type: Byte, contourIdx: Int, gain: Double, regionNameOffset: Int, geographyOffset: Int, geographyTextOffset: Int, geographyJsonOffset: Int, geographyTypeOffset: Int, geographyNdims: Int, geographySrid: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endBeamContour_Full(builder)
        }
        fun startBeamContour_Full(builder: FlatBufferBuilder) = builder.startTable(21)
        ...
        fun endBeamContour_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishBeamContourFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "BEAM")
        fun finishSizePrefixedBeamContour_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "BEAM")
    }
}
