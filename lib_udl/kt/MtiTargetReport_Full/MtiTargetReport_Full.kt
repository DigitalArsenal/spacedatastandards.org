 ...
 */
@Suppress("unused")
class MtiTargetReport_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : MtiTargetReport_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsMtiTargetReport_Full(_bb: ByteBuffer): MtiTargetReport_Full = getRootAsMtiTargetReport_Full(_bb, MtiTargetReport_Full())
        fun getRootAsMtiTargetReport_Full(_bb: ByteBuffer, obj: MtiTargetReport_Full): MtiTargetReport_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun MtiTargetReport_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "MTIT")
        fun createMtiTargetReport_Full(builder: FlatBufferBuilder, d321: Int, d322: Double, d323: Double, d324: Int, d325: Int, d326: Int, d327: Int, d328: Int, d329: Int, d3210Offset: Int, d3211: Int, d3212: Int, d3213: Int, d3214: Int, d3215: Int, d3216: Int, d3217: Long, d3218: Int) : Int {
            ...
            return endMtiTargetReport_Full(builder)
        }
        fun startMtiTargetReport_Full(builder: FlatBufferBuilder) = builder.startTable(18)
        ...
        fun endMtiTargetReport_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishMtiTargetReportFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "MTIT")
        fun finishSizePrefixedMtiTargetReport_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "MTIT")
    }
}
