 ...
 */
@Suppress("unused")
class MtiJobDefinition_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : MtiJobDefinition_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsMtiJobDefinition_Full(_bb: ByteBuffer): MtiJobDefinition_Full = getRootAsMtiJobDefinition_Full(_bb, MtiJobDefinition_Full())
        fun getRootAsMtiJobDefinition_Full(_bb: ByteBuffer, obj: MtiJobDefinition_Full): MtiJobDefinition_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun MtiJobDefinition_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "MTIJ")
        fun createMtiJobDefinition_Full(builder: FlatBufferBuilder, j1: Long, j2Offset: Int, j3Offset: Int, j4: Int, j5: Int, j6: Double, j7: Double, j8: Double, j9: Double, j10: Double, j11: Double, j12: Double, j13: Double, j14Offset: Int, j15: Int, j16: Int, j17: Int, j18: Int, j19: Int, j20: Int, j21: Int, j22: Double, j23: Int, j24: Int, j25: Int, j26: Int, j27Offset: Int, j28Offset: Int) : Int {
            ...
            return endMtiJobDefinition_Full(builder)
        }
        fun startMtiJobDefinition_Full(builder: FlatBufferBuilder) = builder.startTable(28)
        ...
        fun endMtiJobDefinition_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishMtiJobDefinitionFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "MTIJ")
        fun finishSizePrefixedMtiJobDefinition_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "MTIJ")
    }
}
