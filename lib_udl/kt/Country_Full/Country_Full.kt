 ...
 */
@Suppress("unused")
class Country_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Country_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsCountry_Full(_bb: ByteBuffer): Country_Full = getRootAsCountry_Full(_bb, Country_Full())
        fun getRootAsCountry_Full(_bb: ByteBuffer, obj: Country_Full): Country_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun Country_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "COUN")
        fun createCountry_Full(builder: FlatBufferBuilder, codeOffset: Int, nameOffset: Int, fipsCodeOffset: Int, iso3CodeOffset: Int, codeAltOffset: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endCountry_Full(builder)
        }
        fun startCountry_Full(builder: FlatBufferBuilder) = builder.startTable(12)
        ...
        fun endCountry_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishCountryFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "COUN")
        fun finishSizePrefixedCountry_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "COUN")
    }
}
