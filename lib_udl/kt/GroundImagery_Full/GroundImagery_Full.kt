 ...
 */
@Suppress("unused")
class GroundImagery_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : GroundImagery_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val regionAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(14, 1)
    fun regionInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 14, 1)
    /**
    ...
    val regionTextAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(16, 1)
    fun regionTextInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 16, 1)
    /**
    ...
    val regionGeoJsonAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(18, 1)
    fun regionGeoJsonInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 18, 1)
    /**
    ...
    val regionTypeAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(20, 1)
    fun regionTypeInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 20, 1)
    /**
    ...
    val updatedByAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(48, 1)
    fun updatedByInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 48, 1)
    /**
    ...
    val transactionIdAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(50, 1)
    fun transactionIdInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 50, 1)
    /**
    ...
    val notesAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(56, 1)
    fun notesInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 56, 1)
    /**
    ...
    val formatAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(58, 1)
    fun formatInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 58, 1)
    /**
    ...
    val checksumValueAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(62, 1)
    fun checksumValueInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 62, 1)
    companion object {
        fun validateVersion() = Constants.FLATBUFFERS_24_3_25()
        fun getRootAsGroundImagery_Full(_bb: ByteBuffer): GroundImagery_Full = getRootAsGroundImagery_Full(_bb, GroundImagery_Full())
        fun getRootAsGroundImagery_Full(_bb: ByteBuffer, obj: GroundImagery_Full): GroundImagery_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun GroundImagery_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "GROU")
        fun createGroundImagery_Full(builder: FlatBufferBuilder, idOffset: Int, idSensorOffset: Int, classificationMarkingOffset: Int, imageTimeOffset: Int, filenameOffset: Int, regionOffset: Int, regionTextOffset: Int, regionGeoJsonOffset: Int, regionTypeOffset: Int, regionNdims: Int, regionSrid: Int, origSensorIdOffset: Int, subjectIdOffset: Int, nameOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, sourceDlOffset: Int, dataMode: Byte, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, transactionIdOffset: Int, tagsOffset: Int, keywordsOffset: Int, notesOffset: Int, formatOffset: Int, filesize: Long, checksumValueOffset: Int) : Int {
            ...
            return endGroundImagery_Full(builder)
        }
        fun startGroundImagery_Full(builder: FlatBufferBuilder) = builder.startTable(30)
        ...
        fun addRegion(builder: FlatBufferBuilder, region: Int) = builder.addOffset(5, region, 0)
        fun addRegionText(builder: FlatBufferBuilder, regionText: Int) = builder.addOffset(6, regionText, 0)
        fun addRegionGeoJSON(builder: FlatBufferBuilder, regionGeoJson: Int) = builder.addOffset(7, regionGeoJson, 0)
        fun addRegionType(builder: FlatBufferBuilder, regionType: Int) = builder.addOffset(8, regionType, 0)
        fun addRegionNDims(builder: FlatBufferBuilder, regionNdims: Int) = builder.addInt(9, regionNdims, 0)
        fun addRegionSRid(builder: FlatBufferBuilder, regionSrid: Int) = builder.addInt(10, regionSrid, 0)
        ...
        fun addUpdatedBy(builder: FlatBufferBuilder, updatedBy: Int) = builder.addOffset(22, updatedBy, 0)
        fun addTransactionId(builder: FlatBufferBuilder, transactionId: Int) = builder.addOffset(23, transactionId, 0)
        ...
        fun addKeywords(builder: FlatBufferBuilder, keywords: Int) = builder.addOffset(25, keywords, 0)
        ...
        fun addNotes(builder: FlatBufferBuilder, notes: Int) = builder.addOffset(26, notes, 0)
        fun addFormat(builder: FlatBufferBuilder, format: Int) = builder.addOffset(27, format, 0)
        fun addFilesize(builder: FlatBufferBuilder, filesize: Long) = builder.addLong(28, filesize, 0L)
        fun addChecksumValue(builder: FlatBufferBuilder, checksumValue: Int) = builder.addOffset(29, checksumValue, 0)
        fun endGroundImagery_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishGroundImageryFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "GROU")
        fun finishSizePrefixedGroundImagery_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "GROU")
    }
}
