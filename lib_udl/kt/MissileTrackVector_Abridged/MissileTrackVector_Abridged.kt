 ...
 */
@Suppress("unused")
class MissileTrackVector_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : MissileTrackVector_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsMissileTrackVector_Abridged(_bb: ByteBuffer): MissileTrackVector_Abridged = getRootAsMissileTrackVector_Abridged(_bb, MissileTrackVector_Abridged())
        fun getRootAsMissileTrackVector_Abridged(_bb: ByteBuffer, obj: MissileTrackVector_Abridged): MissileTrackVector_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun MissileTrackVector_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "MISS")
        fun createMissileTrackVector_Abridged(builder: FlatBufferBuilder, typeOffset: Int, object_Offset: Int, epochOffset: Int, idSensorOffset: Int, origSensorIdOffset: Int, posOffset: Int, velOffset: Int, accelOffset: Int, course: Double, spd: Double, referenceFrameOffset: Int, covOffset: Int, covReferenceFrameOffset: Int, vectorLat: Double, vectorLon: Double, vectorAlt: Double, confidence: Int, statusOffset: Int, timeSourceOffset: Int, quatOffset: Int, flightAz: Double) : Int {
            ...
            return endMissileTrackVector_Abridged(builder)
        }
        fun startMissileTrackVector_Abridged(builder: FlatBufferBuilder) = builder.startTable(21)
        ...
        fun endMissileTrackVector_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishMissileTrackVectorAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "MISS")
        fun finishSizePrefixedMissileTrackVector_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "MISS")
    }
}
