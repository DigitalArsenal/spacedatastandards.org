 ...
 */
@Suppress("unused")
class RadarObservation_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : RadarObservation_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val descriptorAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(114, 1)
    fun descriptorInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 114, 1)
    /**
    ...
    val origNetworkAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(116, 1)
    fun origNetworkInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 116, 1)
    /**
    ...
    val sourceDlAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(118, 1)
    fun sourceDlInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 118, 1)
    /**
    ...
    companion object {
        ...
        fun createRadarObservation_Abridged(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, obTimeOffset: Int, idOnOrbitOffset: Int, idSensorOffset: Int, satNo: Int, taskIdOffset: Int, transactionIdOffset: Int, trackIdOffset: Int, obPositionOffset: Int, origObjectIdOffset: Int, origSensorIdOffset: Int, uct: Boolean, azimuth: Double, azimuthUnc: Double, azimuthBias: Double, azimuthRate: Double, elevation: Double, elevationUnc: Double, elevationBias: Double, elevationRate: Double, range: Double, rangeAccel: Double, rangeAccelUnc: Double, rangeUnc: Double, rangeBias: Double, rangeRate: Double, rangeRateUnc: Double, doppler: Double, dopplerUnc: Double, ra: Double, declination: Double, x: Double, y: Double, z: Double, xvel: Double, yvel: Double, zvel: Double, senx: Double, seny: Double, senz: Double, rcs: Double, rcsUnc: Double, orthogonalRcs: Double, orthogonalRcsUnc: Double, snr: Double, beam: Double, timingBias: Double, rawFileUriOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, createdAtOffset: Int, createdByOffset: Int, senReferenceFrame: Byte, descriptorOffset: Int, origNetworkOffset: Int, sourceDlOffset: Int, typeOffset: Int) : Int {
            ...
            addUct(builder, uct)
            return endRadarObservation_Abridged(builder)
        }
        fun startRadarObservation_Abridged(builder: FlatBufferBuilder) = builder.startTable(59)
        ...
        fun addSenReferenceFrame(builder: FlatBufferBuilder, senReferenceFrame: Byte) = builder.addByte(54, senReferenceFrame, 0)
        fun addDescriptor(builder: FlatBufferBuilder, descriptor: Int) = builder.addOffset(55, descriptor, 0)
        fun addOrigNetwork(builder: FlatBufferBuilder, origNetwork: Int) = builder.addOffset(56, origNetwork, 0)
        fun addSourceDL(builder: FlatBufferBuilder, sourceDl: Int) = builder.addOffset(57, sourceDl, 0)
        fun addType(builder: FlatBufferBuilder, type: Int) = builder.addOffset(58, type, 0)
        fun endRadarObservation_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishRadarObservationAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "RADA")
        fun finishSizePrefixedRadarObservation_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "RADA")
    }
}
