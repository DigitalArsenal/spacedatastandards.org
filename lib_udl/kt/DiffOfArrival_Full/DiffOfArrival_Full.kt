 ...
 */
@Suppress("unused")
class DiffOfArrival_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : DiffOfArrival_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val onOrbitAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(82, 1)
    fun onOrbitInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 82, 1)
    /**
    ...
    val descriptorAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(84, 1)
    fun descriptorInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 84, 1)
    /**
    ...
    val transactionIdAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(86, 1)
    fun transactionIdInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 86, 1)
    /**
    ...
    val sourceDlAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(90, 1)
    fun sourceDlInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 90, 1)
    companion object {
        fun validateVersion() = Constants.FLATBUFFERS_24_3_25()
        fun getRootAsDiffOfArrival_Full(_bb: ByteBuffer): DiffOfArrival_Full = getRootAsDiffOfArrival_Full(_bb, DiffOfArrival_Full())
        fun getRootAsDiffOfArrival_Full(_bb: ByteBuffer, obj: DiffOfArrival_Full): DiffOfArrival_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun DiffOfArrival_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "DIFF")
        fun createDiffOfArrival_Full(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, obTimeOffset: Int, idOnOrbitOffset: Int, idSensor1Offset: Int, idSensor2Offset: Int, satNo: Int, taskIdOffset: Int, origObjectIdOffset: Int, origSensorId1Offset: Int, origSensorId2Offset: Int, uct: Boolean, sensor1Delay: Double, sensor2Delay: Double, senlat: Double, senlon: Double, senalt: Double, sen2lat: Double, sen2lon: Double, sen2alt: Double, frequency: Double, bandwidth: Double, deltaRange: Double, deltaRangeUnc: Double, deltaRangeRate: Double, deltaRangeRateUnc: Double, snr: Double, tdoa: Double, tdoaUnc: Double, fdoa: Double, fdoaUnc: Double, collectionModeOffset: Int, rawFileUriOffset: Int, sourceOffset: Int, dataMode: Byte, tagsOffset: Int, originOffset: Int, createdAtOffset: Int, createdByOffset: Int, onOrbitOffset: Int, descriptorOffset: Int, transactionIdOffset: Int, origNetworkOffset: Int, sourceDlOffset: Int) : Int {
            ...
            addUct(builder, uct)
            return endDiffOfArrival_Full(builder)
        }
        fun startDiffOfArrival_Full(builder: FlatBufferBuilder) = builder.startTable(44)
        ...
        fun addOnOrbit(builder: FlatBufferBuilder, onOrbit: Int) = builder.addOffset(39, onOrbit, 0)
        fun addDescriptor(builder: FlatBufferBuilder, descriptor: Int) = builder.addOffset(40, descriptor, 0)
        fun addTransactionId(builder: FlatBufferBuilder, transactionId: Int) = builder.addOffset(41, transactionId, 0)
        fun addOrigNetwork(builder: FlatBufferBuilder, origNetwork: Int) = builder.addOffset(42, origNetwork, 0)
        fun addSourceDL(builder: FlatBufferBuilder, sourceDl: Int) = builder.addOffset(43, sourceDl, 0)
        fun endDiffOfArrival_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishDiffOfArrivalFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "DIFF")
        fun finishSizePrefixedDiffOfArrival_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "DIFF")
    }
}
