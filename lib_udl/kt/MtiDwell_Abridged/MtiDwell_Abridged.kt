 ...
 */
@Suppress("unused")
class MtiDwell_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : MtiDwell_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsMtiDwell_Abridged(_bb: ByteBuffer): MtiDwell_Abridged = getRootAsMtiDwell_Abridged(_bb, MtiDwell_Abridged())
        fun getRootAsMtiDwell_Abridged(_bb: ByteBuffer, obj: MtiDwell_Abridged): MtiDwell_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun MtiDwell_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "MTID")
        fun createMtiDwell_Abridged(builder: FlatBufferBuilder, d2: Int, d3: Int, d4: Boolean, d5: Int, d6: Long, d7: Double, d8: Double, d9: Int, d10: Double, d11: Double, d12: Int, d13: Int, d14: Int, d15: Double, d16: Int, d17: Int, d18: Int, d19: Int, d20: Int, d21: Double, d22: Double, d23: Double, d24: Double, d25: Double, d26: Double, d27: Double, d28: Double, d29: Double, d30: Double, d31: Int, d32Offset: Int, dwelltsOffset: Int) : Int {
            ...
            addD2(builder, d2)
            addD4(builder, d4)
            return endMtiDwell_Abridged(builder)
        }
        fun startMtiDwell_Abridged(builder: FlatBufferBuilder) = builder.startTable(32)
        ...
        fun endMtiDwell_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishMtiDwellAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "MTID")
        fun finishSizePrefixedMtiDwell_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "MTID")
    }
}
