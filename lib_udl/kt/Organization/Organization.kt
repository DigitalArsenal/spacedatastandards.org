...
class Organization : Table() {
    ...
    companion object {
        ...
        fun OrganizationBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "ORGA")
        ...
        fun startOrganization(builder: FlatBufferBuilder) = builder.startTable(19)
        ...
        fun finishOrganizationBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ORGA")
        fun finishSizePrefixedOrganizationBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ORGA")
    }
}
