 ...
 */
@Suppress("unused")
class BeamContour_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : BeamContour_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val geographyTextAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(18, 1)
    fun geographyTextInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 18, 1)
    /**
    ...
    val geographyJsonAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(20, 1)
    fun geographyJsonInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 20, 1)
    /**
    ...
    val geographyTypeAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(22, 1)
    fun geographyTypeInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 22, 1)
    /**
    ...
    companion object {
        ...
        fun getRootAsBeamContour_Abridged(_bb: ByteBuffer): BeamContour_Abridged = getRootAsBeamContour_Abridged(_bb, BeamContour_Abridged())
        fun getRootAsBeamContour_Abridged(_bb: ByteBuffer, obj: BeamContour_Abridged): BeamContour_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun BeamContour_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "BEAM")
        fun createBeamContour_Abridged(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idBeamOffset: Int, type: Byte, contourIdx: Int, gain: Double, regionNameOffset: Int, geographyTextOffset: Int, geographyJsonOffset: Int, geographyTypeOffset: Int, geographyNdims: Int, geographySrid: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endBeamContour_Abridged(builder)
        }
        fun startBeamContour_Abridged(builder: FlatBufferBuilder) = builder.startTable(18)
        ...
        fun addGeographyText(builder: FlatBufferBuilder, geographyText: Int) = builder.addOffset(7, geographyText, 0)
        fun addGeographyJson(builder: FlatBufferBuilder, geographyJson: Int) = builder.addOffset(8, geographyJson, 0)
        fun addGeographyType(builder: FlatBufferBuilder, geographyType: Int) = builder.addOffset(9, geographyType, 0)
        fun addGeographyNdims(builder: FlatBufferBuilder, geographyNdims: Int) = builder.addInt(10, geographyNdims, 0)
        fun addGeographySrid(builder: FlatBufferBuilder, geographySrid: Int) = builder.addInt(11, geographySrid, 0)
        ...
        fun endBeamContour_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishBeamContourAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "BEAM")
        fun finishSizePrefixedBeamContour_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "BEAM")
    }
}
