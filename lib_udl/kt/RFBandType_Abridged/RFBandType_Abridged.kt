 ...
 */
@Suppress("unused")
class RFBandType_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : RFBandType_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsRFBandType_Abridged(_bb: ByteBuffer): RFBandType_Abridged = getRootAsRFBandType_Abridged(_bb, RFBandType_Abridged())
        fun getRootAsRFBandType_Abridged(_bb: ByteBuffer, obj: RFBandType_Abridged): RFBandType_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun RFBandType_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "RFBA")
        fun createRFBandType_Abridged(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, descriptionOffset: Int, startFreq: Double, endFreq: Double, sourceOffset: Int, originOffset: Int, dataMode: Byte, createdAtOffset: Int, createdByOffset: Int) : Int {
            ...
            return endRFBandType_Abridged(builder)
        }
        fun startRFBandType_Abridged(builder: FlatBufferBuilder) = builder.startTable(10)
        ...
        fun endRFBandType_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishRFBandTypeAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "RFBA")
        fun finishSizePrefixedRFBandType_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "RFBA")
    }
}
