 ...
 */
@Suppress("unused")
class Sensor_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Sensor_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val updatedAtAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(32, 1)
    fun updatedAtInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 32, 1)
    /**
    ...
    val updatedByAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(34, 1)
    fun updatedByInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 34, 1)
    /**
    ...
    val entityAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(44, 1)
    fun entityInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 44, 1)
    /**
    ...
    val idEntityAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(46, 1)
    fun idEntityInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 46, 1)
    /**
     * No description provided.
     * Example: /// Example: No example provided.
     * Constraints: No constraints specified.
    ...
    val sensorObservationTypeAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(48, 1)
    fun sensorObservationTypeInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 48, 1)
    /**
     * No description provided.
     * Example: /// Example: No example provided.
     * Constraints: No constraints specified.
    ...
    val sensorTypeAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(50, 1)
    fun sensorTypeInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 50, 1)
    companion object {
        fun validateVersion() = Constants.FLATBUFFERS_24_3_25()
        fun getRootAsSensor_Full(_bb: ByteBuffer): Sensor_Full = getRootAsSensor_Full(_bb, Sensor_Full())
        fun getRootAsSensor_Full(_bb: ByteBuffer, obj: Sensor_Full): Sensor_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun Sensor_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "SENS")
        fun createSensor_Full(builder: FlatBufferBuilder, idSensorOffset: Int, sensorNameOffset: Int, classificationMarkingOffset: Int, sensorNumber: Int, shortNameOffset: Int, dataControlOffset: Int, afIdOffset: Int, asrTypeOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, active: Boolean, sensorcharacteristicsOffset: Int, sensorStatsOffset: Int, sensorlimitsCollectionOffset: Int, entityOffset: Int, idEntityOffset: Int, sensorObservationTypeOffset: Int, sensorTypeOffset: Int) : Int {
            ...
            return endSensor_Full(builder)
        }
        fun startSensor_Full(builder: FlatBufferBuilder) = builder.startTable(24)
        ...
        fun addUpdatedAt(builder: FlatBufferBuilder, updatedAt: Int) = builder.addOffset(14, updatedAt, 0)
        fun addUpdatedBy(builder: FlatBufferBuilder, updatedBy: Int) = builder.addOffset(15, updatedBy, 0)
        fun addActive(builder: FlatBufferBuilder, active: Boolean) = builder.addBoolean(16, active, false)
        fun addSensorcharacteristics(builder: FlatBufferBuilder, sensorcharacteristics: Int) = builder.addOffset(17, sensorcharacteristics, 0)
        ...
        fun addSensorStats(builder: FlatBufferBuilder, sensorStats: Int) = builder.addOffset(18, sensorStats, 0)
        ...
        fun addSensorlimitsCollection(builder: FlatBufferBuilder, sensorlimitsCollection: Int) = builder.addOffset(19, sensorlimitsCollection, 0)
        ...
        fun addEntity(builder: FlatBufferBuilder, entity: Int) = builder.addOffset(20, entity, 0)
        fun addIdEntity(builder: FlatBufferBuilder, idEntity: Int) = builder.addOffset(21, idEntity, 0)
        fun addSensorObservationType(builder: FlatBufferBuilder, sensorObservationType: Int) = builder.addOffset(22, sensorObservationType, 0)
        fun addSensorType(builder: FlatBufferBuilder, sensorType: Int) = builder.addOffset(23, sensorType, 0)
        fun endSensor_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishSensorFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "SENS")
        fun finishSizePrefixedSensor_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "SENS")
    }
}
