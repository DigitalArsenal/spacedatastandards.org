 ...
 */
@Suppress("unused")
class FlightPlanMessages_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : FlightPlanMessages_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsFlightPlanMessages_Ingest(_bb: ByteBuffer): FlightPlanMessages_Ingest = getRootAsFlightPlanMessages_Ingest(_bb, FlightPlanMessages_Ingest())
        fun getRootAsFlightPlanMessages_Ingest(_bb: ByteBuffer, obj: FlightPlanMessages_Ingest): FlightPlanMessages_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun FlightPlanMessages_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "FLIG")
        fun createFlightPlanMessages_Ingest(builder: FlatBufferBuilder, severityOffset: Int, wpNumOffset: Int, routePathOffset: Int, msgTextOffset: Int) : Int {
            ...
            return endFlightPlanMessages_Ingest(builder)
        }
        fun startFlightPlanMessages_Ingest(builder: FlatBufferBuilder) = builder.startTable(4)
        ...
        fun endFlightPlanMessages_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishFlightPlanMessagesIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "FLIG")
        fun finishSizePrefixedFlightPlanMessages_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "FLIG")
    }
}
