 ...
 */
@Suppress("unused")
class FlightPlanPoints_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : FlightPlanPoints_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsFlightPlanPoints_Ingest(_bb: ByteBuffer): FlightPlanPoints_Ingest = getRootAsFlightPlanPoints_Ingest(_bb, FlightPlanPoints_Ingest())
        fun getRootAsFlightPlanPoints_Ingest(_bb: ByteBuffer, obj: FlightPlanPoints_Ingest): FlightPlanPoints_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun FlightPlanPoints_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "FLIG")
        fun createFlightPlanPoints_Ingest(builder: FlatBufferBuilder, pointNameOffset: Int, fppLat: Double, fppLon: Double, fppEtaOffset: Int, fppReqFuel: Double) : Int {
            ...
            return endFlightPlanPoints_Ingest(builder)
        }
        fun startFlightPlanPoints_Ingest(builder: FlatBufferBuilder) = builder.startTable(5)
        ...
        fun endFlightPlanPoints_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishFlightPlanPointsIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "FLIG")
        fun finishSizePrefixedFlightPlanPoints_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "FLIG")
    }
}
