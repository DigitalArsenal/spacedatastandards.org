 ...
 */
@Suppress("unused")
class Navigation_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Navigation_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val entityAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(26, 1)
    fun entityInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 26, 1)
    companion object {
        fun validateVersion() = Constants.FLATBUFFERS_24_3_25()
        fun getRootAsNavigation_Ingest(_bb: ByteBuffer): Navigation_Ingest = getRootAsNavigation_Ingest(_bb, Navigation_Ingest())
        fun getRootAsNavigation_Ingest(_bb: ByteBuffer, obj: Navigation_Ingest): Navigation_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun Navigation_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "NAVI")
        fun createNavigation_Ingest(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idEntityOffset: Int, nameOffset: Int, descriptionOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte, entityOffset: Int) : Int {
            ...
            return endNavigation_Ingest(builder)
        }
        fun startNavigation_Ingest(builder: FlatBufferBuilder) = builder.startTable(12)
        ...
        fun addEntity(builder: FlatBufferBuilder, entity: Int) = builder.addOffset(11, entity, 0)
        fun endNavigation_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishNavigationIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "NAVI")
        fun finishSizePrefixedNavigation_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "NAVI")
    }
}
