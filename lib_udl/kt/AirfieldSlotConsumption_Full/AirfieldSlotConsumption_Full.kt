 ...
 */
@Suppress("unused")
class AirfieldSlotConsumption_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : AirfieldSlotConsumption_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val updatedAtAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(68, 1)
    fun updatedAtInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 68, 1)
    /**
    ...
    val updatedByAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(70, 1)
    fun updatedByInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 70, 1)
    /**
    ...
    companion object {
        ...
        fun getRootAsAirfieldSlotConsumption_Full(_bb: ByteBuffer): AirfieldSlotConsumption_Full = getRootAsAirfieldSlotConsumption_Full(_bb, AirfieldSlotConsumption_Full())
        fun getRootAsAirfieldSlotConsumption_Full(_bb: ByteBuffer, obj: AirfieldSlotConsumption_Full): AirfieldSlotConsumption_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun AirfieldSlotConsumption_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "AIRF")
        fun createAirfieldSlotConsumption_Full(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idAirfieldSlotOffset: Int, status: Byte, occupied: Boolean, consumerOffset: Int, occAircraftMdsOffset: Int, occTailNumberOffset: Int, callSignsOffset: Int, missionIdOffset: Int, numAircraft: Int, occStartTimeOffset: Int, resAircraftMdsOffset: Int, resTailNumberOffset: Int, resTypeOffset: Int, resReasonOffset: Int, resMissionIdOffset: Int, startTimeOffset: Int, endTimeOffset: Int, targetTimeOffset: Int, idArrSortieOffset: Int, idDepSortieOffset: Int, altArrSortieIdOffset: Int, altDepSortieIdOffset: Int, reqCommentOffset: Int, appCommentOffset: Int, reqOrgOffset: Int, reqInitialsOffset: Int, appOrgOffset: Int, appInitialsOffset: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceDlOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endAirfieldSlotConsumption_Full(builder)
        }
        fun startAirfieldSlotConsumption_Full(builder: FlatBufferBuilder) = builder.startTable(39)
        ...
        fun addUpdatedAt(builder: FlatBufferBuilder, updatedAt: Int) = builder.addOffset(32, updatedAt, 0)
        fun addUpdatedBy(builder: FlatBufferBuilder, updatedBy: Int) = builder.addOffset(33, updatedBy, 0)
        ...
        fun endAirfieldSlotConsumption_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishAirfieldSlotConsumptionFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "AIRF")
        fun finishSizePrefixedAirfieldSlotConsumption_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "AIRF")
    }
}
