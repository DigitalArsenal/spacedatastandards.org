 ...
 */
@Suppress("unused")
class LogisticsDiscrepancyInfos_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : LogisticsDiscrepancyInfos_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsLogisticsDiscrepancyInfos_Abridged(_bb: ByteBuffer): LogisticsDiscrepancyInfos_Abridged = getRootAsLogisticsDiscrepancyInfos_Abridged(_bb, LogisticsDiscrepancyInfos_Abridged())
        fun getRootAsLogisticsDiscrepancyInfos_Abridged(_bb: ByteBuffer, obj: LogisticsDiscrepancyInfos_Abridged): LogisticsDiscrepancyInfos_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun LogisticsDiscrepancyInfos_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "LOGI")
        fun createLogisticsDiscrepancyInfos_Abridged(builder: FlatBufferBuilder, jcnOffset: Int, discrepancyInfoOffset: Int, jobStTimeOffset: Int, closureTimeOffset: Int) : Int {
            ...
            return endLogisticsDiscrepancyInfos_Abridged(builder)
        }
        fun startLogisticsDiscrepancyInfos_Abridged(builder: FlatBufferBuilder) = builder.startTable(4)
        ...
        fun endLogisticsDiscrepancyInfos_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishLogisticsDiscrepancyInfosAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "LOGI")
        fun finishSizePrefixedLogisticsDiscrepancyInfos_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "LOGI")
    }
}
