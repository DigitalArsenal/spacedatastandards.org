 ...
 */
@Suppress("unused")
class IonoObservationPower_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : IonoObservationPower_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsIonoObservationPower_Ingest(_bb: ByteBuffer): IonoObservationPower_Ingest = getRootAsIonoObservationPower_Ingest(_bb, IonoObservationPower_Ingest())
        fun getRootAsIonoObservationPower_Ingest(_bb: ByteBuffer, obj: IonoObservationPower_Ingest): IonoObservationPower_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun IonoObservationPower_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "IONO")
        fun createIonoObservationPower_Ingest(builder: FlatBufferBuilder, notesOffset: Int, dimensionsOffset: Int, dimensionNameOffset: Int, dataOffset: Int) : Int {
            ...
            return endIonoObservationPower_Ingest(builder)
        }
        fun startIonoObservationPower_Ingest(builder: FlatBufferBuilder) = builder.startTable(4)
        ...
        fun endIonoObservationPower_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishIonoObservationPowerIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "IONO")
        fun finishSizePrefixedIonoObservationPower_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "IONO")
    }
}
