 ...
 */
@Suppress("unused")
class IonoObservationDensityProfile_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : IonoObservationDensityProfile_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsIonoObservationDensityProfile_Abridged(_bb: ByteBuffer): IonoObservationDensityProfile_Abridged = getRootAsIonoObservationDensityProfile_Abridged(_bb, IonoObservationDensityProfile_Abridged())
        fun getRootAsIonoObservationDensityProfile_Abridged(_bb: ByteBuffer, obj: IonoObservationDensityProfile_Abridged): IonoObservationDensityProfile_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun IonoObservationDensityProfile_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "IONO")
        fun createIonoObservationDensityProfile_Abridged(builder: FlatBufferBuilder, parabolicOffset: Int, quasiParabolicOffset: Int, valleyModelDescriptionOffset: Int, valleyModelCoeffsOffset: Int, shiftedChebyshevOffset: Int, topsideExtensionChapmanConstOffset: Int, topsideExtensionVaryChapOffset: Int, iriOffset: Int) : Int {
            ...
            return endIonoObservationDensityProfile_Abridged(builder)
        }
        fun startIonoObservationDensityProfile_Abridged(builder: FlatBufferBuilder) = builder.startTable(8)
        ...
        fun endIonoObservationDensityProfile_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishIonoObservationDensityProfileAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "IONO")
        fun finishSizePrefixedIonoObservationDensityProfile_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "IONO")
    }
}
