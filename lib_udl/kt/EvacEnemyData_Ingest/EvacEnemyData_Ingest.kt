 ...
 */
@Suppress("unused")
class EvacEnemyData_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : EvacEnemyData_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsEvacEnemyData_Ingest(_bb: ByteBuffer): EvacEnemyData_Ingest = getRootAsEvacEnemyData_Ingest(_bb, EvacEnemyData_Ingest())
        fun getRootAsEvacEnemyData_Ingest(_bb: ByteBuffer, obj: EvacEnemyData_Ingest): EvacEnemyData_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun EvacEnemyData_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "EVAC")
        fun createEvacEnemyData_Ingest(builder: FlatBufferBuilder, dirToEnemyOffset: Int, hostileFireTypeOffset: Int, friendliesRemarksOffset: Int, hlzRemarksOffset: Int) : Int {
            ...
            return endEvacEnemyData_Ingest(builder)
        }
        fun startEvacEnemyData_Ingest(builder: FlatBufferBuilder) = builder.startTable(4)
        ...
        fun endEvacEnemyData_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishEvacEnemyDataIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "EVAC")
        fun finishSizePrefixedEvacEnemyData_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "EVAC")
    }
}
