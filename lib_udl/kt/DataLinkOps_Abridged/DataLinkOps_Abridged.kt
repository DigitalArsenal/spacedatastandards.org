 ...
 */
@Suppress("unused")
class DataLinkOps_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : DataLinkOps_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsDataLinkOps_Abridged(_bb: ByteBuffer): DataLinkOps_Abridged = getRootAsDataLinkOps_Abridged(_bb, DataLinkOps_Abridged())
        fun getRootAsDataLinkOps_Abridged(_bb: ByteBuffer, obj: DataLinkOps_Abridged): DataLinkOps_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun DataLinkOps_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "DATA")
        fun createDataLinkOps_Abridged(builder: FlatBufferBuilder, linkNameOffset: Int, linkStartTimeOffset: Int, linkStopTimeOffset: Int, linkStopTimeModOffset: Int, linkDetailsOffset: Int) : Int {
            ...
            return endDataLinkOps_Abridged(builder)
        }
        fun startDataLinkOps_Abridged(builder: FlatBufferBuilder) = builder.startTable(5)
        ...
        fun endDataLinkOps_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishDataLinkOpsAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "DATA")
        fun finishSizePrefixedDataLinkOps_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "DATA")
    }
}
