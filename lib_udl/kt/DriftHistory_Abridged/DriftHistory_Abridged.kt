 ...
 */
@Suppress("unused")
class DriftHistory_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : DriftHistory_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsDriftHistory_Abridged(_bb: ByteBuffer): DriftHistory_Abridged = getRootAsDriftHistory_Abridged(_bb, DriftHistory_Abridged())
        fun getRootAsDriftHistory_Abridged(_bb: ByteBuffer, obj: DriftHistory_Abridged): DriftHistory_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun DriftHistory_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "DRIF")
        fun createDriftHistory_Abridged(builder: FlatBufferBuilder, idOffset: Int, idOnOrbitOffset: Int, classificationMarkingOffset: Int, effectiveUntilOffset: Int, driftRate: Double, createdByOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte) : Int {
            ...
            return endDriftHistory_Abridged(builder)
        }
        fun startDriftHistory_Abridged(builder: FlatBufferBuilder) = builder.startTable(9)
        ...
        fun endDriftHistory_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishDriftHistoryAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "DRIF")
        fun finishSizePrefixedDriftHistory_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "DRIF")
    }
}
