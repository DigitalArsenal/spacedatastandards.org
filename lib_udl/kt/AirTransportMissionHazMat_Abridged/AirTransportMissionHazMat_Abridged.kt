 ...
 */
@Suppress("unused")
class AirTransportMissionHazMat_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : AirTransportMissionHazMat_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsAirTransportMissionHazMat_Abridged(_bb: ByteBuffer): AirTransportMissionHazMat_Abridged = getRootAsAirTransportMissionHazMat_Abridged(_bb, AirTransportMissionHazMat_Abridged())
        fun getRootAsAirTransportMissionHazMat_Abridged(_bb: ByteBuffer, obj: AirTransportMissionHazMat_Abridged): AirTransportMissionHazMat_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun AirTransportMissionHazMat_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "AIRT")
        fun createAirTransportMissionHazMat_Abridged(builder: FlatBufferBuilder, extHazMatIdOffset: Int, itemNameOffset: Int, unNumOffset: Int, pieces: Int, weight: Double, netExpWt: Double, classDiv: Double, cgcOffset: Int, cgnOffset: Int, applicableNotesOffset: Int, onItin: Int, onIcaoOffset: Int, offItin: Int, offIcaoOffset: Int, plannedOffset: Int) : Int {
            ...
            return endAirTransportMissionHazMat_Abridged(builder)
        }
        fun startAirTransportMissionHazMat_Abridged(builder: FlatBufferBuilder) = builder.startTable(15)
        ...
        fun endAirTransportMissionHazMat_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishAirTransportMissionHazMatAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "AIRT")
        fun finishSizePrefixedAirTransportMissionHazMat_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "AIRT")
    }
}
