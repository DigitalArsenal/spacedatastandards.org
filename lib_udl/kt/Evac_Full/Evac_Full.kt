 ...
 */
@Suppress("unused")
class Evac_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Evac_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val sourceAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(80, 1)
    fun sourceInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 80, 1)
    /**
    ...
    val originAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(82, 1)
    fun originInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 82, 1)
    /**
    ...
    companion object {
        ...
        fun createEvac_Full(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, medevacIdOffset: Int, type: Byte, missionTypeOffset: Int, idWeatherReportOffset: Int, numKia: Int, numWia: Int, numLitter: Int, numAmbulatory: Int, medicReq: Boolean, reqNumOffset: Int, reqTimeOffset: Int, reqCallSignOffset: Int, pickupTimeOffset: Int, pickupLat: Double, pickupLon: Double, pickupAlt: Double, ce: Double, le: Double, terrainOffset: Int, obstaclesRemarksOffset: Int, terrainRemarksOffset: Int, zoneNameOffset: Int, zoneMarkingOffset: Int, zoneSecurityOffset: Int, zoneMarkingColorOffset: Int, zoneHot: Boolean, cntctFreq: Double, zoneContrCallSignOffset: Int, numCasualties: Int, commentsOffset: Int, casualtyInfoOffset: Int, enemyDataOffset: Int, relatedDocsOffset: Int, origNetworkOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte) : Int {
            ...
            return endEvac_Full(builder)
        }
        fun startEvac_Full(builder: FlatBufferBuilder) = builder.startTable(41)
        ...
        fun addRelatedDocs(builder: FlatBufferBuilder, relatedDocs: Int) = builder.addOffset(34, relatedDocs, 0)
        ...
        fun addSource(builder: FlatBufferBuilder, source: Int) = builder.addOffset(38, source, 0)
        fun addOrigin(builder: FlatBufferBuilder, origin: Int) = builder.addOffset(39, origin, 0)
        fun addDataMode(builder: FlatBufferBuilder, dataMode: Byte) = builder.addByte(40, dataMode, 0)
        fun endEvac_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishEvacFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "EVAC")
        fun finishSizePrefixedEvac_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "EVAC")
    }
}
