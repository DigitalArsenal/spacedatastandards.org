 ...
 */
@Suppress("unused")
class Onorbit_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Onorbit_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createOnorbit_Ingest(builder: FlatBufferBuilder, idOnOrbitOffset: Int, classificationMarkingOffset: Int, satNo: Int, commonNameOffset: Int, constellationOffset: Int, intlDesOffset: Int, launchDateOffset: Int, decayDateOffset: Int, objectType: Byte, originOffset: Int, missionNumberOffset: Int, category: Byte, lifetimeYears: Int, altNameOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, dataMode: Byte, launchSiteIdOffset: Int, countryCodeOffset: Int, origNetworkOffset: Int) : Int {
            ...
            return endOnorbit_Ingest(builder)
        }
        fun startOnorbit_Ingest(builder: FlatBufferBuilder) = builder.startTable(21)
        ...
        fun endOnorbit_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishOnorbitIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ONOR")
        fun finishSizePrefixedOnorbit_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ONOR")
    }
}
