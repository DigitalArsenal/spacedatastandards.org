 ...
 */
@Suppress("unused")
class IonoObservationScalerInfo_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : IonoObservationScalerInfo_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsIonoObservationScalerInfo_Full(_bb: ByteBuffer): IonoObservationScalerInfo_Full = getRootAsIonoObservationScalerInfo_Full(_bb, IonoObservationScalerInfo_Full())
        fun getRootAsIonoObservationScalerInfo_Full(_bb: ByteBuffer, obj: IonoObservationScalerInfo_Full): IonoObservationScalerInfo_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun IonoObservationScalerInfo_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "IONO")
        fun createIonoObservationScalerInfo_Full(builder: FlatBufferBuilder, typeOffset: Int, nameOffset: Int, organizationOffset: Int, version: Double, confidenceScore: Int, confidenceLevel: Int) : Int {
            ...
            return endIonoObservationScalerInfo_Full(builder)
        }
        fun startIonoObservationScalerInfo_Full(builder: FlatBufferBuilder) = builder.startTable(6)
        ...
        fun endIonoObservationScalerInfo_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishIonoObservationScalerInfoFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "IONO")
        fun finishSizePrefixedIonoObservationScalerInfo_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "IONO")
    }
}
