 ...
 */
@Suppress("unused")
class ISRCollectionPOC_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : ISRCollectionPOC_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsISRCollectionPOC_Abridged(_bb: ByteBuffer): ISRCollectionPOC_Abridged = getRootAsISRCollectionPOC_Abridged(_bb, ISRCollectionPOC_Abridged())
        fun getRootAsISRCollectionPOC_Abridged(_bb: ByteBuffer, obj: ISRCollectionPOC_Abridged): ISRCollectionPOC_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun ISRCollectionPOC_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "ISRC")
        fun createISRCollectionPOC_Abridged(builder: FlatBufferBuilder, idOffset: Int, nameOffset: Int, callsignOffset: Int, unitOffset: Int, emailOffset: Int, phoneOffset: Int, radioFrequency: Double, chatSystemOffset: Int, chatNameOffset: Int, notesOffset: Int) : Int {
            ...
            return endISRCollectionPOC_Abridged(builder)
        }
        fun startISRCollectionPOC_Abridged(builder: FlatBufferBuilder) = builder.startTable(10)
        ...
        fun endISRCollectionPOC_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishISRCollectionPOCAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ISRC")
        fun finishSizePrefixedISRCollectionPOC_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ISRC")
    }
}
