 ...
 */
@Suppress("unused")
class AirEventTankers_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : AirEventTankers_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createAirEventTankers_Abridged(builder: FlatBufferBuilder, idTankerSortieOffset: Int, idTankerMissionOffset: Int, idTankerAirfieldOffset: Int, externalTankerIdOffset: Int, tankerCoordOffset: Int, tankerMdsOffset: Int, amcTankerMissionIdOffset: Int, altTankerMissionIdOffset: Int, tankerCallSignOffset: Int, tankerOwnerOffset: Int, tankerPocOffset: Int, tankerLegNum: Int, tankerDeployedIcaoOffset: Int, tankerDeliveryMethodOffset: Int, fuelOff: Double, tankerCellPosition: Int, tankerFuelTypeOffset: Int, dualRole: Boolean) : Int {
            ...
            return endAirEventTankers_Abridged(builder)
        }
        fun startAirEventTankers_Abridged(builder: FlatBufferBuilder) = builder.startTable(18)
        ...
        fun endAirEventTankers_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishAirEventTankersAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "AIRE")
        fun finishSizePrefixedAirEventTankers_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "AIRE")
    }
}
