 ...
 */
@Suppress("unused")
class OnorbitList_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : OnorbitList_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsOnorbitList_Ingest(_bb: ByteBuffer): OnorbitList_Ingest = getRootAsOnorbitList_Ingest(_bb, OnorbitList_Ingest())
        fun getRootAsOnorbitList_Ingest(_bb: ByteBuffer, obj: OnorbitList_Ingest): OnorbitList_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun OnorbitList_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "ONOR")
        fun createOnorbitList_Ingest(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, nameOffset: Int, descriptionOffset: Int, onorbitsOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, createdAtOffset: Int, createdByOffset: Int) : Int {
            ...
            return endOnorbitList_Ingest(builder)
        }
        fun startOnorbitList_Ingest(builder: FlatBufferBuilder) = builder.startTable(10)
        ...
        fun endOnorbitList_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishOnorbitListIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ONOR")
        fun finishSizePrefixedOnorbitList_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ONOR")
    }
}
