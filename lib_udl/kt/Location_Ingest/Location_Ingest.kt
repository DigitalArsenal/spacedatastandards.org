 ...
 */
@Suppress("unused")
class Location_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Location_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsLocation_Ingest(_bb: ByteBuffer): Location_Ingest = getRootAsLocation_Ingest(_bb, Location_Ingest())
        fun getRootAsLocation_Ingest(_bb: ByteBuffer, obj: Location_Ingest): Location_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun Location_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "LOCA")
        fun createLocation_Ingest(builder: FlatBufferBuilder, idLocationOffset: Int, classificationMarkingOffset: Int, nameOffset: Int, countryCodeOffset: Int, lat: Double, lon: Double, altitude: Double, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, origNetworkOffset: Int) : Int {
            ...
            return endLocation_Ingest(builder)
        }
        fun startLocation_Ingest(builder: FlatBufferBuilder) = builder.startTable(13)
        ...
        fun endLocation_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishLocationIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "LOCA")
        fun finishSizePrefixedLocation_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "LOCA")
    }
}
