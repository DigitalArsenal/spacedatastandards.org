 ...
 */
@Suppress("unused")
class EngineDetails : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : EngineDetails {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createEngineDetails(builder: FlatBufferBuilder, idOffset: Int, idEngineOffset: Int, classificationMarkingOffset: Int, familyOffset: Int, cycleTypeOffset: Int, characteristicTypeOffset: Int, manufacturerOrgIdOffset: Int, specificImpulse: Double, burnTime: Double, seaLevelThrust: Double, vacuumThrust: Double, chamberPressure: Double, nozzleExpansionRatio: Double, maxFirings: Int, propellantOffset: Int, oxidizerOffset: Int, notesOffset: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte, tagsOffset: Int) : Int {
            ...
            return endEngineDetails(builder)
        }
        fun startEngineDetails(builder: FlatBufferBuilder) = builder.startTable(26)
        ...
        fun endEngineDetails(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishEngineDetailsBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ENGI")
        fun finishSizePrefixedEngineDetailsBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ENGI")
    }
}
