 ...
 */
@Suppress("unused")
class Stage_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Stage_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val engineAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(88, 1)
    fun engineInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 88, 1)
    companion object {
        fun validateVersion() = Constants.FLATBUFFERS_24_3_25()
        fun getRootAsStage_Full(_bb: ByteBuffer): Stage_Full = getRootAsStage_Full(_bb, Stage_Full())
        fun getRootAsStage_Full(_bb: ByteBuffer, obj: Stage_Full): Stage_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun Stage_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "STAG")
        fun createStage_Full(builder: FlatBufferBuilder, idOffset: Int, idLaunchVehicleOffset: Int, idEngineOffset: Int, classificationMarkingOffset: Int, stageNumber: Int, typeOffset: Int, manufacturerOrgIdOffset: Int, numEngines: Int, length: Double, diameter: Double, mass: Double, vernierOffset: Int, numVernier: Int, mainEngineThrustSeaLevel: Double, mainEngineThrustVacuum: Double, thrustSeaLevel: Double, thrustVacuum: Double, burnTime: Double, numBurns: Int, vernierBurnTime: Double, vernierNumBurns: Int, vernierThrustSeaLevel: Double, vernierThrustVacuum: Double, numStageElements: Int, reusable: Boolean, restartable: Boolean, controlThruster1Offset: Int, numControlThruster1: Int, controlThruster2Offset: Int, numControlThruster2: Int, photoUrlsOffset: Int, notesOffset: Int, avionicsNotesOffset: Int, tagsOffset: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte, engineOffset: Int) : Int {
            ...
            return endStage_Full(builder)
        }
        fun startStage_Full(builder: FlatBufferBuilder) = builder.startTable(43)
        ...
        fun addEngine(builder: FlatBufferBuilder, engine: Int) = builder.addOffset(42, engine, 0)
        fun endStage_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishStageFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "STAG")
        fun finishSizePrefixedStage_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "STAG")
    }
}
