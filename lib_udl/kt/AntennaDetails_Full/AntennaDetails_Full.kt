 ...
 */
@Suppress("unused")
class AntennaDetails_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : AntennaDetails_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createAntennaDetails_Full(builder: FlatBufferBuilder, idOffset: Int, idAntennaOffset: Int, classificationMarkingOffset: Int, typeOffset: Int, positionOffset: Int, mode: Byte, steerable: Boolean, beamForming: Boolean, manufacturerOrgIdOffset: Int, diameter: Double, sizeOffset: Int, startFrequency: Double, endFrequency: Double, beamwidth: Double, gain: Double, gainTolerance: Double, polarization: Double, descriptionOffset: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte, tagsOffset: Int, manufacturerOrgOffset: Int) : Int {
            ...
            return endAntennaDetails_Full(builder)
        }
        fun startAntennaDetails_Full(builder: FlatBufferBuilder) = builder.startTable(28)
        ...
        fun endAntennaDetails_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishAntennaDetailsFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ANTE")
        fun finishSizePrefixedAntennaDetails_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ANTE")
    }
}
