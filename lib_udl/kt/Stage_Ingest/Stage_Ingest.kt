 ...
 */
@Suppress("unused")
class Stage_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Stage_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createStage_Ingest(builder: FlatBufferBuilder, idOffset: Int, idLaunchVehicleOffset: Int, idEngineOffset: Int, classificationMarkingOffset: Int, stageNumber: Int, typeOffset: Int, manufacturerOrgIdOffset: Int, numEngines: Int, length: Double, diameter: Double, mass: Double, vernierOffset: Int, numVernier: Int, mainEngineThrustSeaLevel: Double, mainEngineThrustVacuum: Double, thrustSeaLevel: Double, thrustVacuum: Double, burnTime: Double, numBurns: Int, vernierBurnTime: Double, vernierNumBurns: Int, vernierThrustSeaLevel: Double, vernierThrustVacuum: Double, numStageElements: Int, reusable: Boolean, restartable: Boolean, controlThruster1Offset: Int, numControlThruster1: Int, controlThruster2Offset: Int, numControlThruster2: Int, photoUrlsOffset: Int, notesOffset: Int, avionicsNotesOffset: Int, tagsOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endStage_Ingest(builder)
        }
        fun startStage_Ingest(builder: FlatBufferBuilder) = builder.startTable(40)
        ...
        fun endStage_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishStageIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "STAG")
        fun finishSizePrefixedStage_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "STAG")
    }
}
