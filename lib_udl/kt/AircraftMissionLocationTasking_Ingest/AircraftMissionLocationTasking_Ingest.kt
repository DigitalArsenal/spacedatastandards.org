 ...
 */
@Suppress("unused")
class AircraftMissionLocationTasking_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : AircraftMissionLocationTasking_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsAircraftMissionLocationTasking_Ingest(_bb: ByteBuffer): AircraftMissionLocationTasking_Ingest = getRootAsAircraftMissionLocationTasking_Ingest(_bb, AircraftMissionLocationTasking_Ingest())
        fun getRootAsAircraftMissionLocationTasking_Ingest(_bb: ByteBuffer, obj: AircraftMissionLocationTasking_Ingest): AircraftMissionLocationTasking_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun AircraftMissionLocationTasking_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "AIRC")
        fun createAircraftMissionLocationTasking_Ingest(builder: FlatBufferBuilder, startTimeOffset: Int, endTimeOffset: Int, msnLocNameOffset: Int, alt: Int, airMsnPriOffset: Int, areaGeoRad: Int, msnLocPtNameOffset: Int, msnLocPtLat: Double, msnLocPtLon: Double, msnLocPtBarTOffset: Int) : Int {
            ...
            return endAircraftMissionLocationTasking_Ingest(builder)
        }
        fun startAircraftMissionLocationTasking_Ingest(builder: FlatBufferBuilder) = builder.startTable(10)
        ...
        fun endAircraftMissionLocationTasking_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishAircraftMissionLocationTaskingIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "AIRC")
        fun finishSizePrefixedAircraftMissionLocationTasking_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "AIRC")
    }
}
