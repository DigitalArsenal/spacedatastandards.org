 ...
 */
@Suppress("unused")
class SeradataRadarPayload_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : SeradataRadarPayload_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsSeradataRadarPayload_Full(_bb: ByteBuffer): SeradataRadarPayload_Full = getRootAsSeradataRadarPayload_Full(_bb, SeradataRadarPayload_Full())
        fun getRootAsSeradataRadarPayload_Full(_bb: ByteBuffer, obj: SeradataRadarPayload_Full): SeradataRadarPayload_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun SeradataRadarPayload_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "SERA")
        fun createSeradataRadarPayload_Full(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, spacecraftIdOffset: Int, idSensorOffset: Int, hostedForCompanyOrgIdOffset: Int, manufacturerOrgIdOffset: Int, categoryOffset: Int, nameOffset: Int, frequencyBandOffset: Int, frequency: Double, waveLength: Double, bestResolution: Double, swathWidth: Double, recorderSizeOffset: Int, fieldOfView: Double, fieldOfRegard: Double, pointingMethodOffset: Int, groundStationsOffset: Int, groundStationLocationsOffset: Int, transmitPolarizationOffset: Int, receivePolarizationOffset: Int, dutyCycleOffset: Int, partnerSpacecraftOffset: Int, constellationInterferometricCapabilityOffset: Int, notesOffset: Int, bandwidth: Double, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endSeradataRadarPayload_Full(builder)
        }
        fun startSeradataRadarPayload_Full(builder: FlatBufferBuilder) = builder.startTable(34)
        ...
        fun endSeradataRadarPayload_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishSeradataRadarPayloadFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "SERA")
        fun finishSizePrefixedSeradataRadarPayload_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "SERA")
    }
}
