 ...
 */
@Suppress("unused")
class FlightPlanPointGroups_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : FlightPlanPointGroups_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsFlightPlanPointGroups_Ingest(_bb: ByteBuffer): FlightPlanPointGroups_Ingest = getRootAsFlightPlanPointGroups_Ingest(_bb, FlightPlanPointGroups_Ingest())
        fun getRootAsFlightPlanPointGroups_Ingest(_bb: ByteBuffer, obj: FlightPlanPointGroups_Ingest): FlightPlanPointGroups_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun FlightPlanPointGroups_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "FLIG")
        fun createFlightPlanPointGroups_Ingest(builder: FlatBufferBuilder, pointGroupNameOffset: Int, worstFuelCaseOffset: Int, lsafNameOffset: Int, lsafDistance: Double, fsafDistance: Double, etopsDistance: Double, lsafTimeOffset: Int, fsafTimeOffset: Int, etopsTimeOffset: Int, lsafAvgWindFactor: Double, fsafAvgWindFactor: Double, etopsAvgWindFactor: Double, lsafTempDev: Double, fsafTempDev: Double, etopsTempDev: Double, lsafReqFuel: Double, fsafReqFuel: Double, etopsReqFuel: Double, fromTakeoffTimeOffset: Int, plannedFuel: Double, fuelCalcAlt: Double, fuelCalcSpd: Double, avgFuelFlow: Double, flightPlanPointsOffset: Int) : Int {
            ...
            return endFlightPlanPointGroups_Ingest(builder)
        }
        fun startFlightPlanPointGroups_Ingest(builder: FlatBufferBuilder) = builder.startTable(24)
        ...
        fun endFlightPlanPointGroups_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishFlightPlanPointGroupsIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "FLIG")
        fun finishSizePrefixedFlightPlanPointGroups_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "FLIG")
    }
}
