 ...
 */
@Suppress("unused")
class EffectResponse_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : EffectResponse_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createEffectResponse_Full(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idEffectRequestOffset: Int, externalRequestIdOffset: Int, typeOffset: Int, actorSrcTypeOffset: Int, actorSrcIdOffset: Int, munitionTypeOffset: Int, munitionIdOffset: Int, shotsRequired: Int, probabilityOfKill: Double, collateralDamageEst: Double, actionsListOffset: Int, externalActionsOffset: Int, coaMetricsOffset: Int, redTimeToOverheadOffset: Int, decisionDeadlineOffset: Int, redTargetSrcTypeOffset: Int, redTargetSrcIdOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, origNetworkOffset: Int) : Int {
            ...
            return endEffectResponse_Full(builder)
        }
        fun startEffectResponse_Full(builder: FlatBufferBuilder) = builder.startTable(25)
        ...
        fun endEffectResponse_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishEffectResponseFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "EFFE")
        fun finishSizePrefixedEffectResponse_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "EFFE")
    }
}
