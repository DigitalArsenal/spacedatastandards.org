 ...
 */
@Suppress("unused")
class LaunchDetection_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : LaunchDetection_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createLaunchDetection_Full(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, launchTimeOffset: Int, messageTypeOffset: Int, launchLatitude: Double, launchLongitude: Double, launchAzimuth: Double, raan: Double, inclination: Double, observationTimeOffset: Int, observationLatitude: Double, observationLongitude: Double, observationAltitude: Double, stereoFlag: Boolean, highZenithAzimuth: Boolean, sequenceNumber: Int, eventIdOffset: Int, sourceOffset: Int, originOffset: Int, descriptorOffset: Int, tagsOffset: Int, origNetworkOffset: Int, dataMode: Byte, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int) : Int {
            ...
            return endLaunchDetection_Full(builder)
        }
        fun startLaunchDetection_Full(builder: FlatBufferBuilder) = builder.startTable(27)
        ...
        fun endLaunchDetection_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishLaunchDetectionFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "LAUN")
        fun finishSizePrefixedLaunchDetection_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "LAUN")
    }
}
