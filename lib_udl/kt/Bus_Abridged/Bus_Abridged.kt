...
class Bus_Abridged : Table() {
    ...
    companion object {
        ...
        fun Bus_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "BUSA")
        ...
        fun finishBusAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "BUSA")
        fun finishSizePrefixedBus_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "BUSA")
    }
}
