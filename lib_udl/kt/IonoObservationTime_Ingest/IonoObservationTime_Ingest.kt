 ...
 */
@Suppress("unused")
class IonoObservationTime_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : IonoObservationTime_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsIonoObservationTime_Ingest(_bb: ByteBuffer): IonoObservationTime_Ingest = getRootAsIonoObservationTime_Ingest(_bb, IonoObservationTime_Ingest())
        fun getRootAsIonoObservationTime_Ingest(_bb: ByteBuffer, obj: IonoObservationTime_Ingest): IonoObservationTime_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun IonoObservationTime_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "IONO")
        fun createIonoObservationTime_Ingest(builder: FlatBufferBuilder, dimensionsOffset: Int, dimensionNameOffset: Int, notesOffset: Int, dataOffset: Int) : Int {
            ...
            return endIonoObservationTime_Ingest(builder)
        }
        fun startIonoObservationTime_Ingest(builder: FlatBufferBuilder) = builder.startTable(4)
        ...
        fun endIonoObservationTime_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishIonoObservationTimeIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "IONO")
        fun finishSizePrefixedIonoObservationTime_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "IONO")
    }
}
