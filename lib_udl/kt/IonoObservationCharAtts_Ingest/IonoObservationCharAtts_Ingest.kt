 ...
 */
@Suppress("unused")
class IonoObservationCharAtts_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : IonoObservationCharAtts_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsIonoObservationCharAtts_Ingest(_bb: ByteBuffer): IonoObservationCharAtts_Ingest = getRootAsIonoObservationCharAtts_Ingest(_bb, IonoObservationCharAtts_Ingest())
        fun getRootAsIonoObservationCharAtts_Ingest(_bb: ByteBuffer, obj: IonoObservationCharAtts_Ingest): IonoObservationCharAtts_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun IonoObservationCharAtts_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "IONO")
        fun createIonoObservationCharAtts_Ingest(builder: FlatBufferBuilder, ursiIdOffset: Int, charNameOffset: Int, lowerBound: Double, upperBound: Double, qOffset: Int, dOffset: Int, climateModelNameOffset: Int, climateModelOptionsOffset: Int, climateModelInputParamsOffset: Int, uncertaintyBoundTypeOffset: Int) : Int {
            ...
            return endIonoObservationCharAtts_Ingest(builder)
        }
        fun startIonoObservationCharAtts_Ingest(builder: FlatBufferBuilder) = builder.startTable(10)
        ...
        fun endIonoObservationCharAtts_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishIonoObservationCharAttsIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "IONO")
        fun finishSizePrefixedIonoObservationCharAtts_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "IONO")
    }
}
