 ...
 */
@Suppress("unused")
class Mti_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Mti_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createMti_Ingest(builder: FlatBufferBuilder, classificationMarkingOffset: Int, sourceOffset: Int, originOffset: Int, idOffset: Int, dataMode: Byte, createdByOffset: Int, createdAtOffset: Int, p3Offset: Int, p6Offset: Int, p7Offset: Int, p8Offset: Int, p9: Int, p10: Int, missionsOffset: Int, dwellsOffset: Int, hrrsOffset: Int, jobDefsOffset: Int, freeTextsOffset: Int, platformLocsOffset: Int, jobRequestsOffset: Int, origNetworkOffset: Int) : Int {
            ...
            return endMti_Ingest(builder)
        }
        fun startMti_Ingest(builder: FlatBufferBuilder) = builder.startTable(21)
        ...
        fun endMti_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishMtiIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "MTII")
        fun finishSizePrefixedMti_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "MTII")
    }
}
