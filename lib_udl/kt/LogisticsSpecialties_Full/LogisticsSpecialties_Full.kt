 ...
 */
@Suppress("unused")
class LogisticsSpecialties_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : LogisticsSpecialties_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsLogisticsSpecialties_Full(_bb: ByteBuffer): LogisticsSpecialties_Full = getRootAsLogisticsSpecialties_Full(_bb, LogisticsSpecialties_Full())
        fun getRootAsLogisticsSpecialties_Full(_bb: ByteBuffer, obj: LogisticsSpecialties_Full): LogisticsSpecialties_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun LogisticsSpecialties_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "LOGI")
        fun createLogisticsSpecialties_Full(builder: FlatBufferBuilder, specialtyOffset: Int, skillLevel: Int, firstNameOffset: Int, lastNameOffset: Int, rankCodeOffset: Int, last4SsnOffset: Int, roleTypeCodeOffset: Int) : Int {
            ...
            return endLogisticsSpecialties_Full(builder)
        }
        fun startLogisticsSpecialties_Full(builder: FlatBufferBuilder) = builder.startTable(7)
        ...
        fun endLogisticsSpecialties_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishLogisticsSpecialtiesFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "LOGI")
        fun finishSizePrefixedLogisticsSpecialties_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "LOGI")
    }
}
