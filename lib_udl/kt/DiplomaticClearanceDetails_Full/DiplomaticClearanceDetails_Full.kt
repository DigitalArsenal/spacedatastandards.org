 ...
 */
@Suppress("unused")
class DiplomaticClearanceDetails_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : DiplomaticClearanceDetails_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createDiplomaticClearanceDetails_Full(builder: FlatBufferBuilder, idSortieOffset: Int, legNum: Int, routeStringOffset: Int, validStartTimeOffset: Int, validEndTimeOffset: Int, clearanceIdOffset: Int, externalClearanceIdOffset: Int, clearedCallSignOffset: Int, sequenceNum: Int, countryCodeOffset: Int, altCountryCodeOffset: Int, countryNameOffset: Int, validDescOffset: Int, windowRemarkOffset: Int, entryPointOffset: Int, entryNetOffset: Int, exitPointOffset: Int, exitNltOffset: Int, reqIcao: Boolean, actionOffset: Int, statusOffset: Int, profileOffset: Int, reqPoint: Boolean, clearanceRemarkOffset: Int) : Int {
            ...
            return endDiplomaticClearanceDetails_Full(builder)
        }
        fun startDiplomaticClearanceDetails_Full(builder: FlatBufferBuilder) = builder.startTable(24)
        ...
        fun endDiplomaticClearanceDetails_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishDiplomaticClearanceDetailsFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "DIPL")
        fun finishSizePrefixedDiplomaticClearanceDetails_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "DIPL")
    }
}
