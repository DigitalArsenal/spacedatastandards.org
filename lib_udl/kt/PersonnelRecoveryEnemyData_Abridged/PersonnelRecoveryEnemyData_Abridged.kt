...
class PersonnelRecoveryEnemyData_Abridged : Table() {
    ...
    companion object {
        ...
        fun PersonnelRecoveryEnemyData_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "PERS")
        ...
        fun finishPersonnelRecoveryEnemyDataAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "PERS")
        fun finishSizePrefixedPersonnelRecoveryEnemyData_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "PERS")
    }
}
