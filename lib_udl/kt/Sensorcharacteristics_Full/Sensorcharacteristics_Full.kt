 ...
 */
@Suppress("unused")
class Sensorcharacteristics_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Sensorcharacteristics_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val updatedAtAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(112, 1)
    fun updatedAtInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 112, 1)
    /**
    ...
    companion object {
        ...
        fun createSensorcharacteristics_Full(builder: FlatBufferBuilder, idOffset: Int, idSensorOffset: Int, classificationMarkingOffset: Int, origNetworkOffset: Int, azimuthRate: Double, elevationRateGeolm: Double, minRangeLimit: Double, maxRangeLimit: Double, leftClockAngle: Double, rightClockAngle: Double, boresight: Double, boresightOffAngle: Double, negativeRangeRateLimit: Double, positiveRangeRateLimit: Double, magnitudeLimit: Double, trackAngle: Double, minSignalNoiseRatio: Double, fanBeamWidth: Double, taskableRange: Double, maxObservableRange: Double, radioFrequency: Double, radarFrequency: Double, transmitPower: Double, hFov: Double, vFov: Double, hResPixels: Int, vResPixels: Int, bandOffset: Int, maxDeviationAngle: Double, aperture: Double, leftGeoBeltLimit: Double, rightGeoBeltLimit: Double, asrScanRate: Double, k: Double, focalPoint: Double, towerHeight: Double, trueNorthCorrector: Int, magDec: Double, z1MinRange: Double, z2MinRange: Double, z1MaxRange: Double, z2MaxRange: Double, radarMur: Double, probFalseAlarm: Double, prf: Double, radarPulseWidth: Double, numIntegratedPulses: Int, trueTilt: Double, radarMessageFormatOffset: Int, systemNoiseTemperature: Double, sourceOffset: Int, dataMode: Byte, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int) : Int {
            ...
            return endSensorcharacteristics_Full(builder)
        }
        fun startSensorcharacteristics_Full(builder: FlatBufferBuilder) = builder.startTable(56)
        ...
        fun addUpdatedAt(builder: FlatBufferBuilder, updatedAt: Int) = builder.addOffset(54, updatedAt, 0)
        fun addUpdatedBy(builder: FlatBufferBuilder, updatedBy: Int) = builder.addOffset(55, updatedBy, 0)
        fun endSensorcharacteristics_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishSensorcharacteristicsFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "SENS")
        fun finishSizePrefixedSensorcharacteristics_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "SENS")
    }
}
