 ...
 */
@Suppress("unused")
class MtiMission_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : MtiMission_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsMtiMission_Abridged(_bb: ByteBuffer): MtiMission_Abridged = getRootAsMtiMission_Abridged(_bb, MtiMission_Abridged())
        fun getRootAsMtiMission_Abridged(_bb: ByteBuffer, obj: MtiMission_Abridged): MtiMission_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun MtiMission_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "MTIM")
        fun createMtiMission_Abridged(builder: FlatBufferBuilder, m1Offset: Int, m2Offset: Int, m3Offset: Int, m4Offset: Int, msnRefTsOffset: Int) : Int {
            ...
            return endMtiMission_Abridged(builder)
        }
        fun startMtiMission_Abridged(builder: FlatBufferBuilder) = builder.startTable(5)
        ...
        fun endMtiMission_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishMtiMissionAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "MTIM")
        fun finishSizePrefixedMtiMission_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "MTIM")
    }
}
