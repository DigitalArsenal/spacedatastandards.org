 ...
 */
@Suppress("unused")
class SeradataEarlyWarning_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : SeradataEarlyWarning_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createSeradataEarlyWarning_Abridged(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idIrOffset: Int, spacecraftIdOffset: Int, hostedForCompanyOrgIdOffset: Int, manufacturerOrgIdOffset: Int, nameOffset: Int, spectralBandsOffset: Int, frequencyLimitsOffset: Int, bestResolution: Double, groundStationsOffset: Int, groundStationLocationsOffset: Int, missileLaunchPhaseDetectionAbilityOffset: Int, earthPointing: Boolean, partnerSpacecraftIdOffset: Int, payloadNotesOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endSeradataEarlyWarning_Abridged(builder)
        }
        fun startSeradataEarlyWarning_Abridged(builder: FlatBufferBuilder) = builder.startTable(22)
        ...
        fun endSeradataEarlyWarning_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishSeradataEarlyWarningAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "SERA")
        fun finishSizePrefixedSeradataEarlyWarning_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "SERA")
    }
}
