 ...
 */
@Suppress("unused")
class LogisticsSupportItems_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : LogisticsSupportItems_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsLogisticsSupportItems_Ingest(_bb: ByteBuffer): LogisticsSupportItems_Ingest = getRootAsLogisticsSupportItems_Ingest(_bb, LogisticsSupportItems_Ingest())
        fun getRootAsLogisticsSupportItems_Ingest(_bb: ByteBuffer, obj: LogisticsSupportItems_Ingest): LogisticsSupportItems_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun LogisticsSupportItems_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "LOGI")
        fun createLogisticsSupportItems_Ingest(builder: FlatBufferBuilder, recoveryRequestTypeCodeOffset: Int, requestNumberOffset: Int, quantity: Int, descriptionOffset: Int, shipmentUnitIdOffset: Int, redeployShipmentUnitIdOffset: Int, jobControlNumberOffset: Int, sourceIcaoOffset: Int, deployPlanNumberOffset: Int, redeployPlanNumberOffset: Int, cannibalized: Boolean, siPocOffset: Int, readyTimeOffset: Int, receivedTimeOffset: Int, resupportFlag: Boolean, itemLastChangedDateOffset: Int, logisticsPartsOffset: Int, logisticsSpecialtiesOffset: Int, logisticsRemarksOffset: Int) : Int {
            ...
            return endLogisticsSupportItems_Ingest(builder)
        }
        fun startLogisticsSupportItems_Ingest(builder: FlatBufferBuilder) = builder.startTable(19)
        ...
        fun endLogisticsSupportItems_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishLogisticsSupportItemsIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "LOGI")
        fun finishSizePrefixedLogisticsSupportItems_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "LOGI")
    }
}
