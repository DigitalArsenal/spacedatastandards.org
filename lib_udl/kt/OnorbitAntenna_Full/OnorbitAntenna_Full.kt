 ...
 */
@Suppress("unused")
class OnorbitAntenna_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : OnorbitAntenna_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsOnorbitAntenna_Full(_bb: ByteBuffer): OnorbitAntenna_Full = getRootAsOnorbitAntenna_Full(_bb, OnorbitAntenna_Full())
        fun getRootAsOnorbitAntenna_Full(_bb: ByteBuffer, obj: OnorbitAntenna_Full): OnorbitAntenna_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun OnorbitAntenna_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "ONOR")
        fun createOnorbitAntenna_Full(builder: FlatBufferBuilder, idOffset: Int, idOnOrbitOffset: Int, idAntennaOffset: Int, classificationMarkingOffset: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, antennaOffset: Int, origNetworkOffset: Int) : Int {
            ...
            return endOnorbitAntenna_Full(builder)
        }
        fun startOnorbitAntenna_Full(builder: FlatBufferBuilder) = builder.startTable(13)
        ...
        fun endOnorbitAntenna_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishOnorbitAntennaFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ONOR")
        fun finishSizePrefixedOnorbitAntenna_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ONOR")
    }
}
