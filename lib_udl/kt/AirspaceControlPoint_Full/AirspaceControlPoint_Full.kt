 ...
 */
@Suppress("unused")
class AirspaceControlPoint_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : AirspaceControlPoint_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsAirspaceControlPoint_Full(_bb: ByteBuffer): AirspaceControlPoint_Full = getRootAsAirspaceControlPoint_Full(_bb, AirspaceControlPoint_Full())
        fun getRootAsAirspaceControlPoint_Full(_bb: ByteBuffer, obj: AirspaceControlPoint_Full): AirspaceControlPoint_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun AirspaceControlPoint_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "AIRS")
        fun createAirspaceControlPoint_Full(builder: FlatBufferBuilder, ctrlPtTypeOffset: Int, ctrlPtNameOffset: Int, ctrlPtLocationOffset: Int, ctrlPtAltitudeOffset: Int) : Int {
            ...
            return endAirspaceControlPoint_Full(builder)
        }
        fun startAirspaceControlPoint_Full(builder: FlatBufferBuilder) = builder.startTable(4)
        ...
        fun endAirspaceControlPoint_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishAirspaceControlPointFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "AIRS")
        fun finishSizePrefixedAirspaceControlPoint_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "AIRS")
    }
}
