 ...
 */
@Suppress("unused")
class AttitudeSet_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : AttitudeSet_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val startTimeAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(22, 1)
    fun startTimeInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 22, 1)
    /**
    ...
    val endTimeAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(24, 1)
    fun endTimeInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 24, 1)
    /**
    ...
    val frame1AsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(26, 1)
    fun frame1InByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 26, 1)
    /**
    ...
    val frame2AsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(28, 1)
    fun frame2InByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 28, 1)
    /**
    ...
    val interpolatorAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(40, 1)
    fun interpolatorInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 40, 1)
    /**
    ...
    companion object {
        ...
        fun getRootAsAttitudeSet_Abridged(_bb: ByteBuffer): AttitudeSet_Abridged = getRootAsAttitudeSet_Abridged(_bb, AttitudeSet_Abridged())
        fun getRootAsAttitudeSet_Abridged(_bb: ByteBuffer, obj: AttitudeSet_Abridged): AttitudeSet_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun AttitudeSet_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "ATTI")
        fun createAttitudeSet_Abridged(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idOnOrbitOffset: Int, satNo: Int, origObjectIdOffset: Int, typeOffset: Int, esIdOffset: Int, idSensorOffset: Int, origSensorIdOffset: Int, startTimeOffset: Int, endTimeOffset: Int, frame1Offset: Int, frame2Offset: Int, numPoints: Int, stepSize: Int, precAngleInit: Double, spinAngleInit: Double, eulerRotSeqOffset: Int, interpolatorOffset: Int, interpolatorDegree: Int, notesOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, origNetworkOffset: Int) : Int {
            ...
            return endAttitudeSet_Abridged(builder)
        }
        fun startAttitudeSet_Abridged(builder: FlatBufferBuilder) = builder.startTable(27)
        ...
        fun addStartTime(builder: FlatBufferBuilder, startTime: Int) = builder.addOffset(9, startTime, 0)
        fun addEndTime(builder: FlatBufferBuilder, endTime: Int) = builder.addOffset(10, endTime, 0)
        fun addFrame1(builder: FlatBufferBuilder, frame1: Int) = builder.addOffset(11, frame1, 0)
        fun addFrame2(builder: FlatBufferBuilder, frame2: Int) = builder.addOffset(12, frame2, 0)
        fun addNumPoints(builder: FlatBufferBuilder, numPoints: Int) = builder.addInt(13, numPoints, 0)
        fun addStepSize(builder: FlatBufferBuilder, stepSize: Int) = builder.addInt(14, stepSize, 0)
        fun addPrecAngleInit(builder: FlatBufferBuilder, precAngleInit: Double) = builder.addDouble(15, precAngleInit, 0.0)
        fun addSpinAngleInit(builder: FlatBufferBuilder, spinAngleInit: Double) = builder.addDouble(16, spinAngleInit, 0.0)
        fun addEulerRotSeq(builder: FlatBufferBuilder, eulerRotSeq: Int) = builder.addOffset(17, eulerRotSeq, 0)
        fun addInterpolator(builder: FlatBufferBuilder, interpolator: Int) = builder.addOffset(18, interpolator, 0)
        fun addInterpolatorDegree(builder: FlatBufferBuilder, interpolatorDegree: Int) = builder.addInt(19, interpolatorDegree, 0)
        ...
        fun endAttitudeSet_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishAttitudeSetAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ATTI")
        fun finishSizePrefixedAttitudeSet_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ATTI")
    }
}
