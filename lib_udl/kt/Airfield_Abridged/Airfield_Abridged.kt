 ...
 */
@Suppress("unused")
class Airfield_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Airfield_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createAirfield_Abridged(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idSiteOffset: Int, altAirfieldIdOffset: Int, wacInnrOffset: Int, zarIdOffset: Int, icaoOffset: Int, iataOffset: Int, faaOffset: Int, hostNatCodeOffset: Int, nameOffset: Int, typeOffset: Int, lat: Double, lon: Double, elevFt: Double, elevM: Double, magDec: Double, regionNameOffset: Int, countryCodeOffset: Int, cityOffset: Int, stateOffset: Int, geolocOffset: Int, gmtOffsetOffset: Int, suitabilityCodesOffset: Int, miscCodesOffset: Int, runways: Int, maxRunwayLength: Int, infoUrlOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceDlOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endAirfield_Abridged(builder)
        }
        fun startAirfield_Abridged(builder: FlatBufferBuilder) = builder.startTable(35)
        ...
        fun endAirfield_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishAirfieldAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "AIRF")
        fun finishSizePrefixedAirfield_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "AIRF")
    }
}
