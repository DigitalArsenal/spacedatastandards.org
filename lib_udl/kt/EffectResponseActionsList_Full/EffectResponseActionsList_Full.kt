 ...
 */
@Suppress("unused")
class EffectResponseActionsList_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : EffectResponseActionsList_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsEffectResponseActionsList_Full(_bb: ByteBuffer): EffectResponseActionsList_Full = getRootAsEffectResponseActionsList_Full(_bb, EffectResponseActionsList_Full())
        fun getRootAsEffectResponseActionsList_Full(_bb: ByteBuffer, obj: EffectResponseActionsList_Full): EffectResponseActionsList_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun EffectResponseActionsList_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "EFFE")
        fun createEffectResponseActionsList_Full(builder: FlatBufferBuilder, summaryOffset: Int, actionIdOffset: Int, actionStartTimeOffset: Int, actionEndTimeOffset: Int, totStartTimeOffset: Int, totEndTimeOffset: Int, actionActorSrcTypeOffset: Int, actionActorSrcIdOffset: Int, effectorOffset: Int, targetSrcTypeOffset: Int, targetSrcIdOffset: Int, actorInterceptLat: Double, actorInterceptLon: Double, actorInterceptAlt: Double, weaponInterceptLat: Double, weaponInterceptLon: Double, weaponInterceptAlt: Double, actionMetricsOffset: Int) : Int {
            ...
            return endEffectResponseActionsList_Full(builder)
        }
        fun startEffectResponseActionsList_Full(builder: FlatBufferBuilder) = builder.startTable(18)
        ...
        fun endEffectResponseActionsList_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishEffectResponseActionsListFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "EFFE")
        fun finishSizePrefixedEffectResponseActionsList_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "EFFE")
    }
}
