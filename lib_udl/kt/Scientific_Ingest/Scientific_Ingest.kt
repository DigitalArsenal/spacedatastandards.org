 ...
 */
@Suppress("unused")
class Scientific_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Scientific_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val entityAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(36, 1)
    fun entityInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 36, 1)
    companion object {
        fun validateVersion() = Constants.FLATBUFFERS_24_3_25()
        fun getRootAsScientific_Ingest(_bb: ByteBuffer): Scientific_Ingest = getRootAsScientific_Ingest(_bb, Scientific_Ingest())
        fun getRootAsScientific_Ingest(_bb: ByteBuffer, obj: Scientific_Ingest): Scientific_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun Scientific_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "SCIE")
        fun createScientific_Ingest(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, spacecraftIdOffset: Int, hostedForCompanyOrgIdOffset: Int, manufacturerOrgIdOffset: Int, payloadCategoryOffset: Int, nameOffset: Int, frequencyBandOffset: Int, notesOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte, idEntityOffset: Int, entityOffset: Int) : Int {
            ...
            return endScientific_Ingest(builder)
        }
        fun startScientific_Ingest(builder: FlatBufferBuilder) = builder.startTable(17)
        ...
        fun addEntity(builder: FlatBufferBuilder, entity: Int) = builder.addOffset(16, entity, 0)
        fun endScientific_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishScientificIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "SCIE")
        fun finishSizePrefixedScientific_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "SCIE")
    }
}
