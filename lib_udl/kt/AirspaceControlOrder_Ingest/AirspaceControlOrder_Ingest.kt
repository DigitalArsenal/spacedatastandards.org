 ...
 */
@Suppress("unused")
class AirspaceControlOrder_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : AirspaceControlOrder_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createAirspaceControlOrder_Ingest(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, rawFileUriOffset: Int, opExNameOffset: Int, originatorOffset: Int, startTimeOffset: Int, stopTimeOffset: Int, stopQualifierOffset: Int, opExInfoOffset: Int, opExInfoAltOffset: Int, planOrigNumOffset: Int, serialNumOffset: Int, monthOffset: Int, qualifierOffset: Int, qualSn: Int, areaOfValidityOffset: Int, acoSerialNumOffset: Int, geoDatumOffset: Int, acoCommentsOffset: Int, airspaceControlOrderReferencesOffset: Int, airspaceControlMeansStatusOffset: Int, undLnkTrkOffset: Int, classSourceOffset: Int, classReasonOffset: Int, downgradeInsDateOffset: Int, declassExemptionCodeOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceDlOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endAirspaceControlOrder_Ingest(builder)
        }
        fun startAirspaceControlOrder_Ingest(builder: FlatBufferBuilder) = builder.startTable(33)
        ...
        fun endAirspaceControlOrder_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishAirspaceControlOrderIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "AIRS")
        fun finishSizePrefixedAirspaceControlOrder_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "AIRS")
    }
}
