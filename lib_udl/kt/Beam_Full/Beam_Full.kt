 ...
 */
@Suppress("unused")
class Beam_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Beam_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val beamNameAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(8, 1)
    fun beamNameInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 8, 1)
    /**
    ...
    val notesAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(10, 1)
    fun notesInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 10, 1)
    /**
    ...
    companion object {
        ...
        fun getRootAsBeam_Full(_bb: ByteBuffer): Beam_Full = getRootAsBeam_Full(_bb, Beam_Full())
        fun getRootAsBeam_Full(_bb: ByteBuffer, obj: Beam_Full): Beam_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun Beam_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "BEAM")
        fun createBeam_Full(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, beamNameOffset: Int, notesOffset: Int, beamContoursOffset: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endBeam_Full(builder)
        }
        fun startBeam_Full(builder: FlatBufferBuilder) = builder.startTable(13)
        fun addId(builder: FlatBufferBuilder, id: Int) = builder.addOffset(0, id, 0)
        fun addClassificationMarking(builder: FlatBufferBuilder, classificationMarking: Int) = builder.addOffset(1, classificationMarking, 0)
        fun addBeamName(builder: FlatBufferBuilder, beamName: Int) = builder.addOffset(2, beamName, 0)
        fun addNotes(builder: FlatBufferBuilder, notes: Int) = builder.addOffset(3, notes, 0)
        fun addBeamContours(builder: FlatBufferBuilder, beamContours: Int) = builder.addOffset(4, beamContours, 0)
        ...
        fun endBeam_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishBeamFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "BEAM")
        fun finishSizePrefixedBeam_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "BEAM")
    }
}
