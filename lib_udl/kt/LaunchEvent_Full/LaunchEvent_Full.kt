 ...
 */
@Suppress("unused")
class LaunchEvent_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : LaunchEvent_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val onOrbitAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(42, 1)
    fun onOrbitInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 42, 1)
    /**
    ...
    companion object {
        ...
        fun getRootAsLaunchEvent_Full(_bb: ByteBuffer): LaunchEvent_Full = getRootAsLaunchEvent_Full(_bb, LaunchEvent_Full())
        fun getRootAsLaunchEvent_Full(_bb: ByteBuffer, obj: LaunchEvent_Full): LaunchEvent_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun LaunchEvent_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "LAUN")
        fun createLaunchEvent_Full(builder: FlatBufferBuilder, idOffset: Int, idOnOrbitOffset: Int, origObjectIdOffset: Int, classificationMarkingOffset: Int, derivedFromOffset: Int, declassificationDateOffset: Int, declassificationStringOffset: Int, msgCreateDateOffset: Int, launchFailureCodeOffset: Int, launchDateOffset: Int, beNumberOffset: Int, oSuffixOffset: Int, launchFacilityNameOffset: Int, createdAtOffset: Int, createdByOffset: Int, originOffset: Int, sourceOffset: Int, dataMode: Byte, origNetworkOffset: Int, onOrbitOffset: Int, satNo: Int) : Int {
            ...
            return endLaunchEvent_Full(builder)
        }
        fun startLaunchEvent_Full(builder: FlatBufferBuilder) = builder.startTable(21)
        ...
        fun addOnOrbit(builder: FlatBufferBuilder, onOrbit: Int) = builder.addOffset(19, onOrbit, 0)
        fun addSatNo(builder: FlatBufferBuilder, satNo: Int) = builder.addInt(20, satNo, 0)
        fun endLaunchEvent_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishLaunchEventFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "LAUN")
        fun finishSizePrefixedLaunchEvent_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "LAUN")
    }
}
