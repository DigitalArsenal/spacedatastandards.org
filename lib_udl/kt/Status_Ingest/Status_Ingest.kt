 ...
 */
@Suppress("unused")
class Status_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Status_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsStatus_Ingest(_bb: ByteBuffer): Status_Ingest = getRootAsStatus_Ingest(_bb, Status_Ingest())
        fun getRootAsStatus_Ingest(_bb: ByteBuffer, obj: Status_Ingest): Status_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun Status_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "STAT")
        fun createStatus_Ingest(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, derivedFromOffset: Int, declassificationDateOffset: Int, declassificationStringOffset: Int, idEntityOffset: Int, state: Byte, sysCap: Byte, opsCap: Byte, sourceOffset: Int, subStatusCollectionOffset: Int, dataMode: Byte, notesOffset: Int, createdAtOffset: Int, createdByOffset: Int, originOffset: Int, origNetworkOffset: Int) : Int {
            ...
            return endStatus_Ingest(builder)
        }
        fun startStatus_Ingest(builder: FlatBufferBuilder) = builder.startTable(17)
        ...
        fun endStatus_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishStatusIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "STAT")
        fun finishSizePrefixedStatus_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "STAT")
    }
}
