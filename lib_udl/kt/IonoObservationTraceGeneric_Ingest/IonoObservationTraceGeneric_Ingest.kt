 ...
 */
@Suppress("unused")
class IonoObservationTraceGeneric_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : IonoObservationTraceGeneric_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsIonoObservationTraceGeneric_Ingest(_bb: ByteBuffer): IonoObservationTraceGeneric_Ingest = getRootAsIonoObservationTraceGeneric_Ingest(_bb, IonoObservationTraceGeneric_Ingest())
        fun getRootAsIonoObservationTraceGeneric_Ingest(_bb: ByteBuffer, obj: IonoObservationTraceGeneric_Ingest): IonoObservationTraceGeneric_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun IonoObservationTraceGeneric_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "IONO")
        fun createIonoObservationTraceGeneric_Ingest(builder: FlatBufferBuilder, dataOffset: Int, dimensionNameOffset: Int, notesOffset: Int) : Int {
            builder.startTable(3)
            addNotes(builder, notesOffset)
            addDimensionName(builder, dimensionNameOffset)
            addData(builder, dataOffset)
            return endIonoObservationTraceGeneric_Ingest(builder)
        }
        fun startIonoObservationTraceGeneric_Ingest(builder: FlatBufferBuilder) = builder.startTable(3)
        ...
        fun endIonoObservationTraceGeneric_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishIonoObservationTraceGenericIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "IONO")
        fun finishSizePrefixedIonoObservationTraceGeneric_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "IONO")
    }
}
