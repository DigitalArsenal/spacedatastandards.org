 ...
 */
@Suppress("unused")
class AirspaceTimePeriod_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : AirspaceTimePeriod_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsAirspaceTimePeriod_Abridged(_bb: ByteBuffer): AirspaceTimePeriod_Abridged = getRootAsAirspaceTimePeriod_Abridged(_bb, AirspaceTimePeriod_Abridged())
        fun getRootAsAirspaceTimePeriod_Abridged(_bb: ByteBuffer, obj: AirspaceTimePeriod_Abridged): AirspaceTimePeriod_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun AirspaceTimePeriod_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "AIRS")
        fun createAirspaceTimePeriod_Abridged(builder: FlatBufferBuilder, timeModeOffset: Int, timeStartOffset: Int, timeEndOffset: Int, intFreqOffset: Int, intDurOffset: Int) : Int {
            ...
            return endAirspaceTimePeriod_Abridged(builder)
        }
        fun startAirspaceTimePeriod_Abridged(builder: FlatBufferBuilder) = builder.startTable(5)
        ...
        fun endAirspaceTimePeriod_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishAirspaceTimePeriodAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "AIRS")
        fun finishSizePrefixedAirspaceTimePeriod_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "AIRS")
    }
}
