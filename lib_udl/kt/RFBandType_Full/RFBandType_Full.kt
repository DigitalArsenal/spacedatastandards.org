 ...
 */
@Suppress("unused")
class RFBandType_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : RFBandType_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsRFBandType_Full(_bb: ByteBuffer): RFBandType_Full = getRootAsRFBandType_Full(_bb, RFBandType_Full())
        fun getRootAsRFBandType_Full(_bb: ByteBuffer, obj: RFBandType_Full): RFBandType_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun RFBandType_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "RFBA")
        fun createRFBandType_Full(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, descriptionOffset: Int, startFreq: Double, endFreq: Double, sourceOffset: Int, originOffset: Int, dataMode: Byte, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int) : Int {
            ...
            return endRFBandType_Full(builder)
        }
        fun startRFBandType_Full(builder: FlatBufferBuilder) = builder.startTable(12)
        ...
        fun endRFBandType_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishRFBandTypeFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "RFBA")
        fun finishSizePrefixedRFBandType_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "RFBA")
    }
}
