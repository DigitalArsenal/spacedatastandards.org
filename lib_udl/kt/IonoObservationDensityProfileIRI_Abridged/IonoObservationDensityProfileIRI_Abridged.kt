 ...
 */
@Suppress("unused")
class IonoObservationDensityProfileIRI_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : IonoObservationDensityProfileIRI_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsIonoObservationDensityProfileIRI_Abridged(_bb: ByteBuffer): IonoObservationDensityProfileIRI_Abridged = getRootAsIonoObservationDensityProfileIRI_Abridged(_bb, IonoObservationDensityProfileIRI_Abridged())
        fun getRootAsIonoObservationDensityProfileIRI_Abridged(_bb: ByteBuffer, obj: IonoObservationDensityProfileIRI_Abridged): IonoObservationDensityProfileIRI_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun IonoObservationDensityProfileIRI_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "IONO")
        fun createIonoObservationDensityProfileIRI_Abridged(builder: FlatBufferBuilder, descriptionOffset: Int, nmF2: Double, hmF2: Double, b0: Double, b1: Double, nmF1: Double, hmF1: Double, d1: Double, hz: Double, hValTop: Double, nValB: Double, nmE: Double, hmE: Double, hdx: Double, nmD: Double, hmD: Double, ha: Double, fp1: Double, fp2: Double, fp30: Double, fp3U: Double, chi: Double) : Int {
            ...
            return endIonoObservationDensityProfileIRI_Abridged(builder)
        }
        fun startIonoObservationDensityProfileIRI_Abridged(builder: FlatBufferBuilder) = builder.startTable(22)
        ...
        fun endIonoObservationDensityProfileIRI_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishIonoObservationDensityProfileIRIAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "IONO")
        fun finishSizePrefixedIonoObservationDensityProfileIRI_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "IONO")
    }
}
