 ...
 */
@Suppress("unused")
class OperatingUnitRemark_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : OperatingUnitRemark_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsOperatingUnitRemark_Ingest(_bb: ByteBuffer): OperatingUnitRemark_Ingest = getRootAsOperatingUnitRemark_Ingest(_bb, OperatingUnitRemark_Ingest())
        fun getRootAsOperatingUnitRemark_Ingest(_bb: ByteBuffer, obj: OperatingUnitRemark_Ingest): OperatingUnitRemark_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun OperatingUnitRemark_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "OPER")
        fun createOperatingUnitRemark_Ingest(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idOperatingUnitOffset: Int, altRmkIdOffset: Int, nameOffset: Int, typeOffset: Int, textOffset: Int, codeOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte) : Int {
            ...
            return endOperatingUnitRemark_Ingest(builder)
        }
        fun startOperatingUnitRemark_Ingest(builder: FlatBufferBuilder) = builder.startTable(13)
        ...
        fun endOperatingUnitRemark_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishOperatingUnitRemarkIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "OPER")
        fun finishSizePrefixedOperatingUnitRemark_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "OPER")
    }
}
