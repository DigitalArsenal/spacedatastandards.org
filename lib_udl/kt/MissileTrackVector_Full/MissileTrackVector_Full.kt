 ...
 */
@Suppress("unused")
class MissileTrackVector_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : MissileTrackVector_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsMissileTrackVector_Full(_bb: ByteBuffer): MissileTrackVector_Full = getRootAsMissileTrackVector_Full(_bb, MissileTrackVector_Full())
        fun getRootAsMissileTrackVector_Full(_bb: ByteBuffer, obj: MissileTrackVector_Full): MissileTrackVector_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun MissileTrackVector_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "MISS")
        fun createMissileTrackVector_Full(builder: FlatBufferBuilder, typeOffset: Int, object_Offset: Int, epochOffset: Int, idSensorOffset: Int, origSensorIdOffset: Int, posOffset: Int, velOffset: Int, accelOffset: Int, course: Double, spd: Double, referenceFrameOffset: Int, covOffset: Int, covReferenceFrameOffset: Int, vectorLat: Double, vectorLon: Double, vectorAlt: Double, confidence: Int, statusOffset: Int, timeSourceOffset: Int, quatOffset: Int, flightAz: Double) : Int {
            ...
            return endMissileTrackVector_Full(builder)
        }
        fun startMissileTrackVector_Full(builder: FlatBufferBuilder) = builder.startTable(21)
        ...
        fun endMissileTrackVector_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishMissileTrackVectorFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "MISS")
        fun finishSizePrefixedMissileTrackVector_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "MISS")
    }
}
