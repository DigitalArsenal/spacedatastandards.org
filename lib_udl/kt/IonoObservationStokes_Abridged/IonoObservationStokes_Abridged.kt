 ...
 */
@Suppress("unused")
class IonoObservationStokes_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : IonoObservationStokes_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsIonoObservationStokes_Abridged(_bb: ByteBuffer): IonoObservationStokes_Abridged = getRootAsIonoObservationStokes_Abridged(_bb, IonoObservationStokes_Abridged())
        fun getRootAsIonoObservationStokes_Abridged(_bb: ByteBuffer, obj: IonoObservationStokes_Abridged): IonoObservationStokes_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun IonoObservationStokes_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "IONO")
        fun createIonoObservationStokes_Abridged(builder: FlatBufferBuilder, notesOffset: Int, dimensionsOffset: Int, dimensionNameOffset: Int, dataOffset: Int, sOffset: Int) : Int {
            ...
            return endIonoObservationStokes_Abridged(builder)
        }
        fun startIonoObservationStokes_Abridged(builder: FlatBufferBuilder) = builder.startTable(5)
        ...
        fun endIonoObservationStokes_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishIonoObservationStokesAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "IONO")
        fun finishSizePrefixedIonoObservationStokes_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "IONO")
    }
}
