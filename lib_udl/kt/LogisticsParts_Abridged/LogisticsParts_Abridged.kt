 ...
 */
@Suppress("unused")
class LogisticsParts_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : LogisticsParts_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsLogisticsParts_Abridged(_bb: ByteBuffer): LogisticsParts_Abridged = getRootAsLogisticsParts_Abridged(_bb, LogisticsParts_Abridged())
        fun getRootAsLogisticsParts_Abridged(_bb: ByteBuffer, obj: LogisticsParts_Abridged): LogisticsParts_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun LogisticsParts_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "LOGI")
        fun createLogisticsParts_Abridged(builder: FlatBufferBuilder, partNumberOffset: Int, nationalStockNumberOffset: Int, measurementUnitCodeOffset: Int, workUnitCodeOffset: Int, technicalOrderTextOffset: Int, figureNumberOffset: Int, indexNumberOffset: Int, requestVerifierOffset: Int, locationVerifierOffset: Int, supplyDocumentNumberOffset: Int, logisticsStocksOffset: Int) : Int {
            ...
            return endLogisticsParts_Abridged(builder)
        }
        fun startLogisticsParts_Abridged(builder: FlatBufferBuilder) = builder.startTable(11)
        ...
        fun endLogisticsParts_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishLogisticsPartsAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "LOGI")
        fun finishSizePrefixedLogisticsParts_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "LOGI")
    }
}
