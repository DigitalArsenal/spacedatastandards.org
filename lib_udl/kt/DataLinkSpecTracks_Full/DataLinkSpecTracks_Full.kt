 ...
 */
@Suppress("unused")
class DataLinkSpecTracks_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : DataLinkSpecTracks_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsDataLinkSpecTracks_Full(_bb: ByteBuffer): DataLinkSpecTracks_Full = getRootAsDataLinkSpecTracks_Full(_bb, DataLinkSpecTracks_Full())
        fun getRootAsDataLinkSpecTracks_Full(_bb: ByteBuffer, obj: DataLinkSpecTracks_Full): DataLinkSpecTracks_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun DataLinkSpecTracks_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "DATA")
        fun createDataLinkSpecTracks_Full(builder: FlatBufferBuilder, specTrackNumOffset: Int, specTrackNumDescOffset: Int) : Int {
            builder.startTable(2)
            addSpecTrackNumDesc(builder, specTrackNumDescOffset)
            addSpecTrackNum(builder, specTrackNumOffset)
            return endDataLinkSpecTracks_Full(builder)
        }
        fun startDataLinkSpecTracks_Full(builder: FlatBufferBuilder) = builder.startTable(2)
        ...
        fun endDataLinkSpecTracks_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishDataLinkSpecTracksFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "DATA")
        fun finishSizePrefixedDataLinkSpecTracks_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "DATA")
    }
}
