 ...
 */
@Suppress("unused")
class Ephemeris_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Ephemeris_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsEphemeris_Abridged(_bb: ByteBuffer): Ephemeris_Abridged = getRootAsEphemeris_Abridged(_bb, Ephemeris_Abridged())
        fun getRootAsEphemeris_Abridged(_bb: ByteBuffer, obj: Ephemeris_Abridged): Ephemeris_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun Ephemeris_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "EPHE")
        fun createEphemeris_Abridged(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, esIdOffset: Int, tsOffset: Int, xpos: Double, ypos: Double, zpos: Double, xvel: Double, yvel: Double, zvel: Double, xaccel: Double, yaccel: Double, zaccel: Double, covOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, dataMode: Byte, idOnOrbitOffset: Int, origObjectIdOffset: Int, originOffset: Int) : Int {
            ...
            return endEphemeris_Abridged(builder)
        }
        fun startEphemeris_Abridged(builder: FlatBufferBuilder) = builder.startTable(21)
        ...
        fun endEphemeris_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishEphemerisAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "EPHE")
        fun finishSizePrefixedEphemeris_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "EPHE")
    }
}
