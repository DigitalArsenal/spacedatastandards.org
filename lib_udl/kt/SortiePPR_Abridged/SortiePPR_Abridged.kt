 ...
 */
@Suppress("unused")
class SortiePPR_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : SortiePPR_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsSortiePPR_Abridged(_bb: ByteBuffer): SortiePPR_Abridged = getRootAsSortiePPR_Abridged(_bb, SortiePPR_Abridged())
        fun getRootAsSortiePPR_Abridged(_bb: ByteBuffer, obj: SortiePPR_Abridged): SortiePPR_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun SortiePPR_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "SORT")
        fun createSortiePPR_Abridged(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idSortieOffset: Int, externalIdOffset: Int, numberOffset: Int, startTimeOffset: Int, endTimeOffset: Int, requestorOffset: Int, grantorOffset: Int, type: Byte, remarksOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceDlOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endSortiePPR_Abridged(builder)
        }
        fun startSortiePPR_Abridged(builder: FlatBufferBuilder) = builder.startTable(18)
        ...
        fun endSortiePPR_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishSortiePPRAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "SORT")
        fun finishSizePrefixedSortiePPR_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "SORT")
    }
}
