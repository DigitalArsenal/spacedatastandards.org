 ...
 */
@Suppress("unused")
class RFEmitterDetails_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : RFEmitterDetails_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val updatedAtAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(74, 1)
    fun updatedAtInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 74, 1)
    /**
    ...
    val updatedByAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(76, 1)
    fun updatedByInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 76, 1)
    /**
     * No description provided.
     * Example: /// Example: No example provided.
     * Constraints: No constraints specified.
     */
    val productionFacilityLocation : String?
        get() {
            val o = __offset(78)
            return if (o != 0) {
                __string(o + bb_pos)
    ...
    val productionFacilityLocationAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(78, 1)
    fun productionFacilityLocationInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 78, 1)
    /**
     * No description provided.
     * Example: /// Example: No example provided.
     * Constraints: No constraints specified.
    ...
    val manufacturerOrgAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(80, 1)
    fun manufacturerOrgInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 80, 1)
    companion object {
        fun validateVersion() = Constants.FLATBUFFERS_24_3_25()
        fun getRootAsRFEmitterDetails_Full(_bb: ByteBuffer): RFEmitterDetails_Full = getRootAsRFEmitterDetails_Full(_bb, RFEmitterDetails_Full())
        fun getRootAsRFEmitterDetails_Full(_bb: ByteBuffer, obj: RFEmitterDetails_Full): RFEmitterDetails_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun RFEmitterDetails_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "RFEM")
        fun createRFEmitterDetails_Full(builder: FlatBufferBuilder, idOffset: Int, idRfemitterOffset: Int, classificationMarkingOffset: Int, designatorOffset: Int, altNameOffset: Int, familyOffset: Int, productionFacilityNameOffset: Int, alternateFacilityNameOffset: Int, manufacturerOrgIdOffset: Int, productionFacilityLocationIdOffset: Int, systemSensitivityStart: Double, systemSensitivityEnd: Double, receiverTypeOffset: Int, receiverSensitivity: Double, receiverBandwidth: Double, transmitterFrequency: Double, transmitterBandwidth: Double, transmitPower: Double, barrageNoiseBandwidth: Double, dopplerNoise: Double, drfmInstantaneousBandwidth: Double, numChannels: Int, numBits: Int, antennaSizeOffset: Int, antennaDiameter: Double, notesOffset: Int, secondaryNotesOffset: Int, descriptionOffset: Int, urlsOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, productionFacilityLocationOffset: Int, manufacturerOrgOffset: Int) : Int {
            ...
            addProductionFacilityLocation(builder, productionFacilityLocationOffset)
            ...
            return endRFEmitterDetails_Full(builder)
        }
        fun startRFEmitterDetails_Full(builder: FlatBufferBuilder) = builder.startTable(39)
        ...
        fun addUpdatedAt(builder: FlatBufferBuilder, updatedAt: Int) = builder.addOffset(35, updatedAt, 0)
        fun addUpdatedBy(builder: FlatBufferBuilder, updatedBy: Int) = builder.addOffset(36, updatedBy, 0)
        fun addProductionFacilityLocation(builder: FlatBufferBuilder, productionFacilityLocation: Int) = builder.addOffset(37, productionFacilityLocation, 0)
        fun addManufacturerOrg(builder: FlatBufferBuilder, manufacturerOrg: Int) = builder.addOffset(38, manufacturerOrg, 0)
        fun endRFEmitterDetails_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishRFEmitterDetailsFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "RFEM")
        fun finishSizePrefixedRFEmitterDetails_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "RFEM")
    }
}
