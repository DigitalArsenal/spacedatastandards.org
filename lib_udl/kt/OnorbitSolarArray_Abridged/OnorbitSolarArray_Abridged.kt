 ...
 */
@Suppress("unused")
class OnorbitSolarArray_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : OnorbitSolarArray_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val solarArrayAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(24, 1)
    fun solarArrayInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 24, 1)
    /**
    ...
    companion object {
        ...
        fun getRootAsOnorbitSolarArray_Abridged(_bb: ByteBuffer): OnorbitSolarArray_Abridged = getRootAsOnorbitSolarArray_Abridged(_bb, OnorbitSolarArray_Abridged())
        fun getRootAsOnorbitSolarArray_Abridged(_bb: ByteBuffer, obj: OnorbitSolarArray_Abridged): OnorbitSolarArray_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun OnorbitSolarArray_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "ONOR")
        fun createOnorbitSolarArray_Abridged(builder: FlatBufferBuilder, idOffset: Int, idOnOrbitOffset: Int, idSolarArrayOffset: Int, classificationMarkingOffset: Int, quantity: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, solarArrayOffset: Int, origNetworkOffset: Int) : Int {
            ...
            return endOnorbitSolarArray_Abridged(builder)
        }
        fun startOnorbitSolarArray_Abridged(builder: FlatBufferBuilder) = builder.startTable(12)
        ...
        fun addSolarArray(builder: FlatBufferBuilder, solarArray: Int) = builder.addOffset(10, solarArray, 0)
        fun addOrigNetwork(builder: FlatBufferBuilder, origNetwork: Int) = builder.addOffset(11, origNetwork, 0)
        fun endOnorbitSolarArray_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishOnorbitSolarArrayAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "ONOR")
        fun finishSizePrefixedOnorbitSolarArray_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "ONOR")
    }
}
