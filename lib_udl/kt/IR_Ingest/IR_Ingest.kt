 ...
 */
@Suppress("unused")
class IR_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : IR_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsIR_Ingest(_bb: ByteBuffer): IR_Ingest = getRootAsIR_Ingest(_bb, IR_Ingest())
        fun getRootAsIR_Ingest(_bb: ByteBuffer, obj: IR_Ingest): IR_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun IR_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "IRIN")
        fun createIR_Ingest(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idEntityOffset: Int, nameOffset: Int, descriptionOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte, entityOffset: Int) : Int {
            ...
            return endIR_Ingest(builder)
        }
        fun startIR_Ingest(builder: FlatBufferBuilder) = builder.startTable(12)
        ...
        fun endIR_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishIRIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "IRIN")
        fun finishSizePrefixedIR_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "IRIN")
    }
}
