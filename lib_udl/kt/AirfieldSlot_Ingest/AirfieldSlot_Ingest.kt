 ...
 */
@Suppress("unused")
class AirfieldSlot_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : AirfieldSlot_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsAirfieldSlot_Ingest(_bb: ByteBuffer): AirfieldSlot_Ingest = getRootAsAirfieldSlot_Ingest(_bb, AirfieldSlot_Ingest())
        fun getRootAsAirfieldSlot_Ingest(_bb: ByteBuffer, obj: AirfieldSlot_Ingest): AirfieldSlot_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun AirfieldSlot_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "AIRF")
        fun createAirfieldSlot_Ingest(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, airfieldNameOffset: Int, icaoOffset: Int, idAirfieldOffset: Int, altAirfieldIdOffset: Int, nameOffset: Int, type: Byte, acSlotCat: Byte, capacity: Int, startTimeOffset: Int, endTimeOffset: Int, minSeparation: Int, notesOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceDlOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endAirfieldSlot_Ingest(builder)
        }
        fun startAirfieldSlot_Ingest(builder: FlatBufferBuilder) = builder.startTable(21)
        ...
        fun endAirfieldSlot_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishAirfieldSlotIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "AIRF")
        fun finishSizePrefixedAirfieldSlot_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "AIRF")
    }
}
