 ...
 */
@Suppress("unused")
class SOIObservationSet_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : SOIObservationSet_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val createdAtAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(132, 1)
    fun createdAtInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 132, 1)
    /**
    ...
    val createdByAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(134, 1)
    fun createdByInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 134, 1)
    /**
     * Source of the data.
    ...
    val sourceAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(136, 1)
    fun sourceInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 136, 1)
    /**
    ...
    val originAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(138, 1)
    fun originInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 138, 1)
    /**
    ...
    val origNetworkAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(140, 1)
    fun origNetworkInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 140, 1)
    /**
    ...
    companion object {
        ...
        fun createSOIObservationSet_Abridged(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, msgCreateDateOffset: Int, idSensorOffset: Int, origSensorIdOffset: Int, sensorAsIdOffset: Int, idOnOrbitOffset: Int, satNo: Int, origObjectIdOffset: Int, senlat: Double, senlon: Double, senalt: Double, senx: Double, seny: Double, senz: Double, senvelx: Double, senvely: Double, senvelz: Double, idElsetOffset: Int, startTimeOffset: Int, endTimeOffset: Int, numObs: Int, type: Byte, polarAngleStart: Double, polarAngleEnd: Double, referenceFrame: Byte, senReferenceFrame: Byte, losDeclinationStart: Double, losDeclinationEnd: Double, pointingAngleAzStart: Double, pointingAngleAzEnd: Double, pointingAngleElStart: Double, pointingAngleElEnd: Double, pixelArrayWidth: Int, pixelArrayHeight: Int, numSpectralFilters: Int, spectralFiltersOffset: Int, collectionModeOffset: Int, gain: Double, binningHoriz: Int, binningVert: Int, solarMag: Double, pixelMin: Int, pixelMax: Int, softwareVersionOffset: Int, satelliteNameOffset: Int, starCatNameOffset: Int, corrQuality: Double, uct: Boolean, validCalibrationsOffset: Int, calibrationTypeOffset: Int, percentSatThreshold: Double, changeDetected: Boolean, periodicityChangeDetected: Boolean, brightnessVarianceChangeDetected: Boolean, solarPhaseAngleBrightnessChangeDetected: Boolean, changeConfOffset: Int, collectionDensityConfOffset: Int, periodicitySamplingConfOffset: Int, periodicityDetectionConfOffset: Int, collectionIdOffset: Int, calibrationsOffset: Int, tagsOffset: Int, transactionIdOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, sourceDlOffset: Int, dataMode: Byte) : Int {
            ...
            return endSOIObservationSet_Abridged(builder)
        }
        fun startSOIObservationSet_Abridged(builder: FlatBufferBuilder) = builder.startTable(71)
        ...
        fun addCreatedAt(builder: FlatBufferBuilder, createdAt: Int) = builder.addOffset(64, createdAt, 0)
        fun addCreatedBy(builder: FlatBufferBuilder, createdBy: Int) = builder.addOffset(65, createdBy, 0)
        fun addSource(builder: FlatBufferBuilder, source: Int) = builder.addOffset(66, source, 0)
        fun addOrigin(builder: FlatBufferBuilder, origin: Int) = builder.addOffset(67, origin, 0)
        fun addOrigNetwork(builder: FlatBufferBuilder, origNetwork: Int) = builder.addOffset(68, origNetwork, 0)
        fun addSourceDL(builder: FlatBufferBuilder, sourceDl: Int) = builder.addOffset(69, sourceDl, 0)
        fun addDataMode(builder: FlatBufferBuilder, dataMode: Byte) = builder.addByte(70, dataMode, 0)
        fun endSOIObservationSet_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishSOIObservationSetAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "SOIO")
        fun finishSizePrefixedSOIObservationSet_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "SOIO")
    }
}
