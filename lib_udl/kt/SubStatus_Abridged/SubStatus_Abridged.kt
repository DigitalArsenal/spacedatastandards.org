 ...
 */
@Suppress("unused")
class SubStatus_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : SubStatus_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsSubStatus_Abridged(_bb: ByteBuffer): SubStatus_Abridged = getRootAsSubStatus_Abridged(_bb, SubStatus_Abridged())
        fun getRootAsSubStatus_Abridged(_bb: ByteBuffer, obj: SubStatus_Abridged): SubStatus_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun SubStatus_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "SUBS")
        fun createSubStatus_Abridged(builder: FlatBufferBuilder, idOffset: Int, type: Byte, classificationMarkingOffset: Int, statusIdOffset: Int, status: Byte, notesOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte, createdAtOffset: Int, createdByOffset: Int) : Int {
            ...
            return endSubStatus_Abridged(builder)
        }
        fun startSubStatus_Abridged(builder: FlatBufferBuilder) = builder.startTable(12)
        ...
        fun endSubStatus_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishSubStatusAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "SUBS")
        fun finishSizePrefixedSubStatus_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "SUBS")
    }
}
