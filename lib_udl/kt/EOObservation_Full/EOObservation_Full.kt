 ...
 */
@Suppress("unused")
class EOObservation_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : EOObservation_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val tagsLength : Int
        get() {
            val o = __offset(166); return if (o != 0) __vector_len(o) else 0
        }
    /**
    ...
    val createdAtAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(168, 1)
    fun createdAtInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 168, 1)
    /**
    ...
    val createdByAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(170, 1)
    fun createdByInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 170, 1)
    /**
     ...
     * Constraints: No constraints specified.
     */
    val eoobservationDetails : String?
        get() {
            val o = __offset(174)
            return if (o != 0) {
                __string(o + bb_pos)
    ...
    val eoobservationDetailsAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(174, 1)
    fun eoobservationDetailsInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 174, 1)
    /**
     * No description provided.
     * Example: /// Example: No example provided.
     * Constraints: No constraints specified.
    ...
    val onOrbitAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(176, 1)
    fun onOrbitInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 176, 1)
    /**
    ...
    val sourceDlAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(188, 1)
    fun sourceDlInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 188, 1)
    /**
    ...
    companion object {
        ...
        fun createEOObservation_Full(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, obTimeOffset: Int, corrQuality: Double, idOnOrbitOffset: Int, idSensorOffset: Int, idSkyImageryOffset: Int, collectMethodOffset: Int, satNo: Int, taskIdOffset: Int, transactionIdOffset: Int, trackIdOffset: Int, obPositionOffset: Int, origObjectIdOffset: Int, origSensorIdOffset: Int, uct: Boolean, azimuth: Double, azimuthUnc: Double, azimuthBias: Double, azimuthRate: Double, elevation: Double, elevationUnc: Double, elevationBias: Double, elevationRate: Double, range: Double, rangeUnc: Double, rangeBias: Double, rangeRate: Double, rangeRateUnc: Double, ra: Double, raRate: Double, raUnc: Double, raBias: Double, declination: Double, declinationRate: Double, declinationUnc: Double, declinationBias: Double, losx: Double, losy: Double, losz: Double, losUnc: Double, losxvel: Double, losyvel: Double, loszvel: Double, senlat: Double, senlon: Double, senalt: Double, senx: Double, seny: Double, senz: Double, senvelx: Double, senvely: Double, senvelz: Double, senQuatOffset: Int, fovCount: Int, expDuration: Double, zeroptd: Double, netObjSig: Double, netObjSigUnc: Double, mag: Double, magUnc: Double, magNormRange: Double, geolat: Double, geolon: Double, geoalt: Double, georange: Double, skyBkgrnd: Double, primaryExtinction: Double, primaryExtinctionUnc: Double, solarPhaseAngle: Double, solarEqPhaseAngle: Double, solarDecAngle: Double, shutterDelay: Double, timingBias: Double, rawFileUriOffset: Int, intensity: Double, bgIntensity: Double, descriptorOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, tagsOffset: Int, createdAtOffset: Int, createdByOffset: Int, zeroPtdUnc: Double, eoobservationDetailsOffset: Int, onOrbitOffset: Int, referenceFrame: Byte, senReferenceFrame: Byte, umbra: Boolean, penumbra: Boolean, origNetworkOffset: Int, sourceDlOffset: Int, typeOffset: Int) : Int {
            ...
            addEoobservationDetails(builder, eoobservationDetailsOffset)
            ...
            addUct(builder, uct)
            return endEOObservation_Full(builder)
        }
        fun startEOObservation_Full(builder: FlatBufferBuilder) = builder.startTable(94)
        ...
        fun addTags(builder: FlatBufferBuilder, tags: Int) = builder.addOffset(81, tags, 0)
        ...
        fun addCreatedAt(builder: FlatBufferBuilder, createdAt: Int) = builder.addOffset(82, createdAt, 0)
        fun addCreatedBy(builder: FlatBufferBuilder, createdBy: Int) = builder.addOffset(83, createdBy, 0)
        fun addZeroPtdUnc(builder: FlatBufferBuilder, zeroPtdUnc: Double) = builder.addDouble(84, zeroPtdUnc, 0.0)
        fun addEoobservationDetails(builder: FlatBufferBuilder, eoobservationDetails: Int) = builder.addOffset(85, eoobservationDetails, 0)
        fun addOnOrbit(builder: FlatBufferBuilder, onOrbit: Int) = builder.addOffset(86, onOrbit, 0)
        fun addReferenceFrame(builder: FlatBufferBuilder, referenceFrame: Byte) = builder.addByte(87, referenceFrame, 0)
        fun addSenReferenceFrame(builder: FlatBufferBuilder, senReferenceFrame: Byte) = builder.addByte(88, senReferenceFrame, 0)
        fun addUmbra(builder: FlatBufferBuilder, umbra: Boolean) = builder.addBoolean(89, umbra, false)
        fun addPenumbra(builder: FlatBufferBuilder, penumbra: Boolean) = builder.addBoolean(90, penumbra, false)
        fun addOrigNetwork(builder: FlatBufferBuilder, origNetwork: Int) = builder.addOffset(91, origNetwork, 0)
        fun addSourceDL(builder: FlatBufferBuilder, sourceDl: Int) = builder.addOffset(92, sourceDl, 0)
        fun addType(builder: FlatBufferBuilder, type: Int) = builder.addOffset(93, type, 0)
        fun endEOObservation_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishEOObservationFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "EOOB")
        fun finishSizePrefixedEOObservation_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "EOOB")
    }
}
