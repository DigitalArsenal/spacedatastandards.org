 ...
 */
@Suppress("unused")
class AircraftStatusRemark_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : AircraftStatusRemark_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsAircraftStatusRemark_Abridged(_bb: ByteBuffer): AircraftStatusRemark_Abridged = getRootAsAircraftStatusRemark_Abridged(_bb, AircraftStatusRemark_Abridged())
        fun getRootAsAircraftStatusRemark_Abridged(_bb: ByteBuffer, obj: AircraftStatusRemark_Abridged): AircraftStatusRemark_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun AircraftStatusRemark_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "AIRC")
        fun createAircraftStatusRemark_Abridged(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idAircraftStatusOffset: Int, altRmkIdOffset: Int, nameOffset: Int, textOffset: Int, timestampOffset: Int, lastUpdatedByOffset: Int, lastUpdatedAtOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceDlOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endAircraftStatusRemark_Abridged(builder)
        }
        fun startAircraftStatusRemark_Abridged(builder: FlatBufferBuilder) = builder.startTable(16)
        ...
        fun endAircraftStatusRemark_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishAircraftStatusRemarkAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "AIRC")
        fun finishSizePrefixedAircraftStatusRemark_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "AIRC")
    }
}
