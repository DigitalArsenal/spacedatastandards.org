 ...
 */
@Suppress("unused")
class PersonnelRecoveryVehicle_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : PersonnelRecoveryVehicle_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsPersonnelRecoveryVehicle_Abridged(_bb: ByteBuffer): PersonnelRecoveryVehicle_Abridged = getRootAsPersonnelRecoveryVehicle_Abridged(_bb, PersonnelRecoveryVehicle_Abridged())
        fun getRootAsPersonnelRecoveryVehicle_Abridged(_bb: ByteBuffer, obj: PersonnelRecoveryVehicle_Abridged): PersonnelRecoveryVehicle_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun PersonnelRecoveryVehicle_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "PERS")
        fun createPersonnelRecoveryVehicle_Abridged(builder: FlatBufferBuilder, callSignOffset: Int, typeOffset: Int, primaryFreq: Double, strength: Int) : Int {
            builder.startTable(4)
            addPrimaryFreq(builder, primaryFreq)
            addStrength(builder, strength)
            addType(builder, typeOffset)
            addCallSign(builder, callSignOffset)
            return endPersonnelRecoveryVehicle_Abridged(builder)
        }
        fun startPersonnelRecoveryVehicle_Abridged(builder: FlatBufferBuilder) = builder.startTable(4)
        ...
        fun endPersonnelRecoveryVehicle_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishPersonnelRecoveryVehicleAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "PERS")
        fun finishSizePrefixedPersonnelRecoveryVehicle_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "PERS")
    }
}
