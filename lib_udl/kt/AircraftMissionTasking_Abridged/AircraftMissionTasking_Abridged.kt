 ...
 */
@Suppress("unused")
class AircraftMissionTasking_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : AircraftMissionTasking_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun createAircraftMissionTasking_Abridged(builder: FlatBufferBuilder, countryCodeOffset: Int, taskedServiceOffset: Int, unitDesignatorOffset: Int, unitLocNameOffset: Int, resMsnIndOffset: Int, amcMsnNumOffset: Int, pkgIdOffset: Int, msnCommanderOffset: Int, msnNumOffset: Int, priMsnTypeOffset: Int, secMsnTypeOffset: Int, alertStatus: Int, depLocNameOffset: Int, depLocUtmOffset: Int, depLocLat: Double, depLocLon: Double, depTimeOffset: Int, rcvyLocNameOffset: Int, rcvyLocUtmOffset: Int, rcvyLocLatOffset: Int, rcvyLocLonOffset: Int, rcvyTimeOffset: Int, indActaskingOffset: Int, acMsnLocSegOffset: Int) : Int {
            ...
            return endAircraftMissionTasking_Abridged(builder)
        }
        fun startAircraftMissionTasking_Abridged(builder: FlatBufferBuilder) = builder.startTable(24)
        ...
        fun endAircraftMissionTasking_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishAircraftMissionTaskingAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "AIRC")
        fun finishSizePrefixedAircraftMissionTasking_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "AIRC")
    }
}
