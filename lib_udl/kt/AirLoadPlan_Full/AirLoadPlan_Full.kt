 ...
 */
@Suppress("unused")
class AirLoadPlan_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : AirLoadPlan_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val updatedAtAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(92, 1)
    fun updatedAtInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 92, 1)
    /**
    ...
    val updatedByAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(94, 1)
    fun updatedByInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 94, 1)
    /**
    ...
    val sourceDlAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(96, 1)
    fun sourceDlInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 96, 1)
    /**
     * Source of the data.
    ...
    companion object {
        ...
        fun getRootAsAirLoadPlan_Full(_bb: ByteBuffer): AirLoadPlan_Full = getRootAsAirLoadPlan_Full(_bb, AirLoadPlan_Full())
        fun getRootAsAirLoadPlan_Full(_bb: ByteBuffer, obj: AirLoadPlan_Full): AirLoadPlan_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun AirLoadPlan_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "AIRL")
        fun createAirLoadPlan_Full(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, externalIdOffset: Int, idMissionOffset: Int, missionNumberOffset: Int, idSortieOffset: Int, legNum: Int, callSignOffset: Int, tailNumberOffset: Int, aircraftMdsOffset: Int, depIcaoOffset: Int, depAirfieldOffset: Int, estDepTimeOffset: Int, arrIcaoOffset: Int, arrAirfieldOffset: Int, estArrTimeOffset: Int, crewSize: Int, cargoConfigOffset: Int, equipConfigOffset: Int, tankConfigOffset: Int, basicWeight: Double, basicMoment: Double, fuelWeight: Double, fuelMoment: Double, estLandingFuelWeight: Double, estLandingFuelMoment: Double, operatingWeight: Double, operatingMoment: Double, cargoWeight: Double, cargoMoment: Double, zeroFuelWeight: Double, zeroFuelMoment: Double, zeroFuelCg: Double, grossWeight: Double, grossMoment: Double, grossCg: Double, landingWeight: Double, landingMoment: Double, landingCg: Double, cargoBayFsmin: Int, cargoBayFsmax: Int, cargoBayWidth: Double, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceDlOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte) : Int {
            ...
            return endAirLoadPlan_Full(builder)
        }
        fun startAirLoadPlan_Full(builder: FlatBufferBuilder) = builder.startTable(51)
        ...
        fun addUpdatedAt(builder: FlatBufferBuilder, updatedAt: Int) = builder.addOffset(44, updatedAt, 0)
        fun addUpdatedBy(builder: FlatBufferBuilder, updatedBy: Int) = builder.addOffset(45, updatedBy, 0)
        fun addSourceDL(builder: FlatBufferBuilder, sourceDl: Int) = builder.addOffset(46, sourceDl, 0)
        ...
        fun endAirLoadPlan_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishAirLoadPlanFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "AIRL")
        fun finishSizePrefixedAirLoadPlan_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "AIRL")
    }
}
