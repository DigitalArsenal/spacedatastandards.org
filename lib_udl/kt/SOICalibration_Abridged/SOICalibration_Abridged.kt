 ...
 */
@Suppress("unused")
class SOICalibration_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : SOICalibration_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsSOICalibration_Abridged(_bb: ByteBuffer): SOICalibration_Abridged = getRootAsSOICalibration_Abridged(_bb, SOICalibration_Abridged())
        fun getRootAsSOICalibration_Abridged(_bb: ByteBuffer, obj: SOICalibration_Abridged): SOICalibration_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun SOICalibration_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "SOIC")
        fun createSOICalibration_Abridged(builder: FlatBufferBuilder, calExtinctionCoeff: Double, calSkyBg: Double, calBgIntensity: Double, calSpectralFilterSolarMag: Double, calZeroPoint: Double, calNumDetectedStars: Int, calNumCorrelatedStars: Int, calExtinctionCoeffUnc: Double, calExtinctionCoeffMaxUnc: Double, calTimeOffset: Int, calTypeOffset: Int) : Int {
            ...
            return endSOICalibration_Abridged(builder)
        }
        fun startSOICalibration_Abridged(builder: FlatBufferBuilder) = builder.startTable(11)
        ...
        fun endSOICalibration_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishSOICalibrationAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "SOIC")
        fun finishSizePrefixedSOICalibration_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "SOIC")
    }
}
