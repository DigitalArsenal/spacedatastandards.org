 ...
 */
@Suppress("unused")
class SARObservation_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : SARObservation_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val agjsonAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(72, 1)
    fun agjsonInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 72, 1)
    /**
    ...
    val atypeAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(74, 1)
    fun atypeInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 74, 1)
    /**
    ...
    val obDirectionAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(92, 1)
    fun obDirectionInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 92, 1)
    /**
    ...
    val coordSysAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(94, 1)
    fun coordSysInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 94, 1)
    /**
    ...
    val sourceDlAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(134, 1)
    fun sourceDlInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 134, 1)
    /**
    ...
    companion object {
        ...
        fun createSARObservation_Abridged(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idOnOrbitOffset: Int, satNo: Int, origObjectIdOffset: Int, idSensorOffset: Int, origSensorIdOffset: Int, externalIdOffset: Int, collectionIdOffset: Int, detectionIdOffset: Int, collectionStartOffset: Int, collectionEndOffset: Int, centerTimeOffset: Int, detectionStartOffset: Int, detectionEndOffset: Int, dwellTime: Double, orbitStateOffset: Int, sarModeOffset: Int, operatingBandOffset: Int, operatingFreq: Double, snr: Double, txPolarizationOffset: Int, rxPolarizationOffset: Int, grazeAngle: Double, incidenceAngle: Double, squintAngle: Double, pulseBandwidth: Double, pulseDuration: Double, continuousSpotAngle: Double, slantRange: Double, nearRange: Double, farRange: Double, swathLength: Double, atextOffset: Int, agjsonOffset: Int, atypeOffset: Int, andims: Int, asrid: Int, spacingRange: Double, spacingAzimuth: Double, looksAzimuth: Int, looksRange: Int, resolutionRange: Double, resolutionAzimuth: Double, obDirectionOffset: Int, coordSysOffset: Int, targetposx: Double, targetposy: Double, targetposz: Double, senalt: Double, senvelx: Double, senvely: Double, senvelz: Double, senlatStart: Double, senlonStart: Double, senlatEnd: Double, senlonEnd: Double, transactionIdOffset: Int, srcTypsOffset: Int, srcIdsOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, sourceDlOffset: Int, dataMode: Byte) : Int {
            ...
            return endSARObservation_Abridged(builder)
        }
        fun startSARObservation_Abridged(builder: FlatBufferBuilder) = builder.startTable(67)
        ...
        fun addAgjson(builder: FlatBufferBuilder, agjson: Int) = builder.addOffset(34, agjson, 0)
        fun addAtype(builder: FlatBufferBuilder, atype: Int) = builder.addOffset(35, atype, 0)
        fun addAndims(builder: FlatBufferBuilder, andims: Int) = builder.addInt(36, andims, 0)
        fun addAsrid(builder: FlatBufferBuilder, asrid: Int) = builder.addInt(37, asrid, 0)
        fun addSpacingRange(builder: FlatBufferBuilder, spacingRange: Double) = builder.addDouble(38, spacingRange, 0.0)
        fun addSpacingAzimuth(builder: FlatBufferBuilder, spacingAzimuth: Double) = builder.addDouble(39, spacingAzimuth, 0.0)
        fun addLooksAzimuth(builder: FlatBufferBuilder, looksAzimuth: Int) = builder.addInt(40, looksAzimuth, 0)
        fun addLooksRange(builder: FlatBufferBuilder, looksRange: Int) = builder.addInt(41, looksRange, 0)
        fun addResolutionRange(builder: FlatBufferBuilder, resolutionRange: Double) = builder.addDouble(42, resolutionRange, 0.0)
        fun addResolutionAzimuth(builder: FlatBufferBuilder, resolutionAzimuth: Double) = builder.addDouble(43, resolutionAzimuth, 0.0)
        fun addObDirection(builder: FlatBufferBuilder, obDirection: Int) = builder.addOffset(44, obDirection, 0)
        fun addCoordSys(builder: FlatBufferBuilder, coordSys: Int) = builder.addOffset(45, coordSys, 0)
        fun addTargetposx(builder: FlatBufferBuilder, targetposx: Double) = builder.addDouble(46, targetposx, 0.0)
        fun addTargetposy(builder: FlatBufferBuilder, targetposy: Double) = builder.addDouble(47, targetposy, 0.0)
        fun addTargetposz(builder: FlatBufferBuilder, targetposz: Double) = builder.addDouble(48, targetposz, 0.0)
        fun addSenalt(builder: FlatBufferBuilder, senalt: Double) = builder.addDouble(49, senalt, 0.0)
        ...
        fun addSenlatStart(builder: FlatBufferBuilder, senlatStart: Double) = builder.addDouble(53, senlatStart, 0.0)
        fun addSenlonStart(builder: FlatBufferBuilder, senlonStart: Double) = builder.addDouble(54, senlonStart, 0.0)
        fun addSenlatEnd(builder: FlatBufferBuilder, senlatEnd: Double) = builder.addDouble(55, senlatEnd, 0.0)
        fun addSenlonEnd(builder: FlatBufferBuilder, senlonEnd: Double) = builder.addDouble(56, senlonEnd, 0.0)
        fun addTransactionId(builder: FlatBufferBuilder, transactionId: Int) = builder.addOffset(57, transactionId, 0)
        fun addSrcTyps(builder: FlatBufferBuilder, srcTyps: Int) = builder.addOffset(58, srcTyps, 0)
        ...
        fun addSrcIds(builder: FlatBufferBuilder, srcIds: Int) = builder.addOffset(59, srcIds, 0)
        ...
        fun addSourceDL(builder: FlatBufferBuilder, sourceDl: Int) = builder.addOffset(65, sourceDl, 0)
        fun addDataMode(builder: FlatBufferBuilder, dataMode: Byte) = builder.addByte(66, dataMode, 0)
        fun endSARObservation_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishSARObservationAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "SARO")
        fun finishSizePrefixedSARObservation_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "SARO")
    }
}
