 ...
 */
@Suppress("unused")
class SolarArray_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : SolarArray_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsSolarArray_Full(_bb: ByteBuffer): SolarArray_Full = getRootAsSolarArray_Full(_bb, SolarArray_Full())
        fun getRootAsSolarArray_Full(_bb: ByteBuffer, obj: SolarArray_Full): SolarArray_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun SolarArray_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "SOLA")
        fun createSolarArray_Full(builder: FlatBufferBuilder, idOffset: Int, nameOffset: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte, solarArrayDetailsOffset: Int) : Int {
            ...
            return endSolarArray_Full(builder)
        }
        fun startSolarArray_Full(builder: FlatBufferBuilder) = builder.startTable(11)
        ...
        fun endSolarArray_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishSolarArrayFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "SOLA")
        fun finishSizePrefixedSolarArray_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "SOLA")
    }
}
