 ...
 */
@Suppress("unused")
class AircraftStatus_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : AircraftStatus_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val updatedAtAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(98, 1)
    fun updatedAtInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 98, 1)
    /**
    ...
    val updatedByAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(100, 1)
    fun updatedByInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 100, 1)
    /**
    ...
    val sourceDlAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(102, 1)
    fun sourceDlInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 102, 1)
    /**
     * Source of the data.
    ...
    companion object {
        ...
        fun createAircraftStatus_Full(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idAircraftOffset: Int, altAircraftIdOffset: Int, currentStateOffset: Int, idAirfieldOffset: Int, geoLocOffset: Int, previousIcaoOffset: Int, currentIcaoOffset: Int, nextIcaoOffset: Int, flightPhaseOffset: Int, taStartTimeOffset: Int, earliestTaendTimeOffset: Int, missionReadinessOffset: Int, fuel: Int, fuelFunctionOffset: Int, gunCapable: Boolean, gunRdsTypeOffset: Int, gunRdsMin: Int, gunRdsMax: Int, airToAirStatus: Byte, airToGroundStatus: Byte, inventoryOffset: Int, inventoryMinOffset: Int, inventoryMaxOffset: Int, unavailableSysOffset: Int, additionalSysOffset: Int, notesOffset: Int, mxRemarkOffset: Int, maintStatusOffset: Int, maintStatusDriverOffset: Int, maintPriorityOffset: Int, alphaStatusCodeOffset: Int, maintStatusUpdateOffset: Int, lastInspectionDateOffset: Int, maintPocOffset: Int, groundStatusOffset: Int, contaminationStatusOffset: Int, fuelStatusOffset: Int, lastUpdatedByOffset: Int, troubleshootEticOffset: Int, eticOffset: Int, parkLocationOffset: Int, parkLocationSystemOffset: Int, idPoiOffset: Int, createdAtOffset: Int, createdByOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, sourceDlOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, origNetworkOffset: Int) : Int {
            ...
            return endAircraftStatus_Full(builder)
        }
        fun startAircraftStatus_Full(builder: FlatBufferBuilder) = builder.startTable(54)
        ...
        fun addUpdatedAt(builder: FlatBufferBuilder, updatedAt: Int) = builder.addOffset(47, updatedAt, 0)
        fun addUpdatedBy(builder: FlatBufferBuilder, updatedBy: Int) = builder.addOffset(48, updatedBy, 0)
        fun addSourceDL(builder: FlatBufferBuilder, sourceDl: Int) = builder.addOffset(49, sourceDl, 0)
        ...
        fun endAircraftStatus_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishAircraftStatusFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "AIRC")
        fun finishSizePrefixedAircraftStatus_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "AIRC")
    }
}
