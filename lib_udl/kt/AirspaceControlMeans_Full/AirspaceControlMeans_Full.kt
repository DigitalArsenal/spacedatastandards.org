 ...
 */
@Suppress("unused")
class AirspaceControlMeans_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : AirspaceControlMeans_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsAirspaceControlMeans_Full(_bb: ByteBuffer): AirspaceControlMeans_Full = getRootAsAirspaceControlMeans_Full(_bb, AirspaceControlMeans_Full())
        fun getRootAsAirspaceControlMeans_Full(_bb: ByteBuffer, obj: AirspaceControlMeans_Full): AirspaceControlMeans_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun AirspaceControlMeans_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "AIRS")
        fun createAirspaceControlMeans_Full(builder: FlatBufferBuilder, cmTypeOffset: Int, cmIdOffset: Int, cmShape: Byte, usageOffset: Int, link16IdOffset: Int, transAltitudeOffset: Int, geoDatumAltOffset: Int, coord0Offset: Int, coord1Offset: Int, bearing0: Double, bearing1: Double, radMag0: Double, radMag1: Double, radMagUnitOffset: Int, polyCoordOffset: Int, trackLeg: Int, widthLeft: Double, widthRight: Double, width: Double, widthUnitOffset: Int, corrWayPointsOffset: Int, orbitAlignmentOffset: Int, effVdimOffset: Int, airspaceTimePeriodOffset: Int, airspaceControlPointOffset: Int, ctrlAuthOffset: Int, ctrlAuthFreqsOffset: Int, genTextIndOffset: Int, freeTextOffset: Int) : Int {
            ...
            return endAirspaceControlMeans_Full(builder)
        }
        fun startAirspaceControlMeans_Full(builder: FlatBufferBuilder) = builder.startTable(29)
        ...
        fun endAirspaceControlMeans_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishAirspaceControlMeansFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "AIRS")
        fun finishSizePrefixedAirspaceControlMeans_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "AIRS")
    }
}
