 ...
 */
@Suppress("unused")
class CollectRequest_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : CollectRequest_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    val updatedAtAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(162, 1)
    fun updatedAtInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 162, 1)
    /**
    ...
    val updatedByAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(164, 1)
    fun updatedByInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 164, 1)
    /**
    ...
    val stateVectorAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(178, 1)
    fun stateVectorInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 178, 1)
    /**
     * No description provided.
     * Example: /// Example: No example provided.
     * Constraints: No constraints specified.
    ...
    val elsetAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(180, 1)
    fun elsetInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 180, 1)
    /**
     * No description provided.
     * Example: /// Example: No example provided.
     * Constraints: No constraints specified.
    ...
    val onOrbitAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(182, 1)
    fun onOrbitInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 182, 1)
    /**
     ...
     * Constraints: No constraints specified.
     */
    fun collectResponse(j: Int) : String? {
        val o = __offset(186)
        return if (o != 0) {
            __string(__vector(o) + j * 4)
        } else {
    ...
    companion object {
        ...
        fun createCollectRequest_Full(builder: FlatBufferBuilder, idOffset: Int, classificationMarkingOffset: Int, idParentReqOffset: Int, msgTypeOffset: Int, msgCreateDateOffset: Int, typeOffset: Int, idPlanOffset: Int, planIndex: Int, taskIdOffset: Int, dwellIdOffset: Int, externalIdOffset: Int, idSensorOffset: Int, origSensorIdOffset: Int, obTypeOffset: Int, priorityOffset: Int, taskCategory: Int, suffixOffset: Int, uctFollowUp: Boolean, startTimeOffset: Int, endTimeOffset: Int, idOnOrbitOffset: Int, satNo: Int, origObjectIdOffset: Int, taskGroupOffset: Int, iron: Int, orbitRegimeOffset: Int, targetSize: Double, rcsMin: Double, rcs: Double, rcsMax: Double, freqMin: Double, freq: Double, freqMax: Double, polarizationOffset: Int, visMagMin: Double, visMag: Double, visMagMax: Double, spectralModelOffset: Int, reflectance: Double, irradiance: Double, numFrames: Int, frameRate: Double, integrationTime: Double, numTracks: Int, numObs: Int, duration: Int, srchPatternOffset: Int, scenarioOffset: Int, idElsetOffset: Int, idManifoldOffset: Int, idStateVectorOffset: Int, esIdOffset: Int, epochOffset: Int, semiMajorAxis: Double, eccentricity: Double, inclination: Double, raan: Double, argOfPerigee: Double, trueAnomoly: Double, ra: Double, dec: Double, az: Double, el: Double, range: Double, extentAz: Double, extentEl: Double, extentRange: Double, lat: Double, lon: Double, alt: Double, stopLat: Double, stopLon: Double, stopAlt: Double, srchInc: Double, xAngle: Double, yAngle: Double, orientAngle: Double, customerOffset: Int, notesOffset: Int, updatedAtOffset: Int, updatedByOffset: Int, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, origNetworkOffset: Int, dataMode: Byte, stateVectorOffset: Int, elsetOffset: Int, onOrbitOffset: Int, tagsOffset: Int, collectResponseOffset: Int) : Int {
            ...
            addCollectResponse(builder, collectResponseOffset)
            ...
            return endCollectRequest_Full(builder)
        }
        fun startCollectRequest_Full(builder: FlatBufferBuilder) = builder.startTable(92)
        ...
        fun addUpdatedAt(builder: FlatBufferBuilder, updatedAt: Int) = builder.addOffset(79, updatedAt, 0)
        fun addUpdatedBy(builder: FlatBufferBuilder, updatedBy: Int) = builder.addOffset(80, updatedBy, 0)
        ...
        fun addDataMode(builder: FlatBufferBuilder, dataMode: Byte) = builder.addByte(86, dataMode, 0)
        fun addStateVector(builder: FlatBufferBuilder, stateVector: Int) = builder.addOffset(87, stateVector, 0)
        fun addElset(builder: FlatBufferBuilder, elset: Int) = builder.addOffset(88, elset, 0)
        fun addOnOrbit(builder: FlatBufferBuilder, onOrbit: Int) = builder.addOffset(89, onOrbit, 0)
        fun addTags(builder: FlatBufferBuilder, tags: Int) = builder.addOffset(90, tags, 0)
        ...
        fun addCollectResponse(builder: FlatBufferBuilder, collectResponse: Int) = builder.addOffset(91, collectResponse, 0)
        fun createCollectResponseVector(builder: FlatBufferBuilder, data: IntArray) : Int {
            builder.startVector(4, data.size, 4)
            for (i in data.size - 1 downTo 0) {
                builder.addOffset(data[i])
            }
        ...
        fun startCollectResponseVector(builder: FlatBufferBuilder, numElems: Int) = builder.startVector(4, numElems, 4)
        fun endCollectRequest_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishCollectRequestFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "COLL")
        fun finishSizePrefixedCollectRequest_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "COLL")
    }
}
