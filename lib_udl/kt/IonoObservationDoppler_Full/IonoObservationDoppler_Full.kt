 ...
 */
@Suppress("unused")
class IonoObservationDoppler_Full : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : IonoObservationDoppler_Full {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsIonoObservationDoppler_Full(_bb: ByteBuffer): IonoObservationDoppler_Full = getRootAsIonoObservationDoppler_Full(_bb, IonoObservationDoppler_Full())
        fun getRootAsIonoObservationDoppler_Full(_bb: ByteBuffer, obj: IonoObservationDoppler_Full): IonoObservationDoppler_Full {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun IonoObservationDoppler_FullBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "IONO")
        fun createIonoObservationDoppler_Full(builder: FlatBufferBuilder, notesOffset: Int, dimensionsOffset: Int, dimensionNameOffset: Int, dataOffset: Int) : Int {
            ...
            return endIonoObservationDoppler_Full(builder)
        }
        fun startIonoObservationDoppler_Full(builder: FlatBufferBuilder) = builder.startTable(4)
        ...
        fun endIonoObservationDoppler_Full(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishIonoObservationDopplerFullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "IONO")
        fun finishSizePrefixedIonoObservationDoppler_FullBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "IONO")
    }
}
