 ...
 */
@Suppress("unused")
class Manifold_Abridged : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : Manifold_Abridged {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsManifold_Abridged(_bb: ByteBuffer): Manifold_Abridged = getRootAsManifold_Abridged(_bb, Manifold_Abridged())
        fun getRootAsManifold_Abridged(_bb: ByteBuffer, obj: Manifold_Abridged): Manifold_Abridged {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun Manifold_AbridgedBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "MANI")
        fun createManifold_Abridged(builder: FlatBufferBuilder, idOffset: Int, idObjectOfInterestOffset: Int, classificationMarkingOffset: Int, statusOffset: Int, weight: Double, deltaV: Double, deltaT: Double, createdAtOffset: Int, createdByOffset: Int, sourceOffset: Int, originOffset: Int, dataMode: Byte, origNetworkOffset: Int) : Int {
            ...
            return endManifold_Abridged(builder)
        }
        fun startManifold_Abridged(builder: FlatBufferBuilder) = builder.startTable(13)
        ...
        fun endManifold_Abridged(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishManifoldAbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "MANI")
        fun finishSizePrefixedManifold_AbridgedBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "MANI")
    }
}
