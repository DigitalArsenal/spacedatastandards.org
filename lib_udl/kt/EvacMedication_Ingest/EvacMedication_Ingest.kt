 ...
 */
@Suppress("unused")
class EvacMedication_Ingest : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : EvacMedication_Ingest {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsEvacMedication_Ingest(_bb: ByteBuffer): EvacMedication_Ingest = getRootAsEvacMedication_Ingest(_bb, EvacMedication_Ingest())
        fun getRootAsEvacMedication_Ingest(_bb: ByteBuffer, obj: EvacMedication_Ingest): EvacMedication_Ingest {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun EvacMedication_IngestBufferHasIdentifier(_bb: ByteBuffer) : Boolean = __has_identifier(_bb, "EVAC")
        fun createEvacMedication_Ingest(builder: FlatBufferBuilder, typeOffset: Int, bodyPartOffset: Int, doseOffset: Int, adminRouteOffset: Int, timeOffset: Int, commentsOffset: Int) : Int {
            ...
            return endEvacMedication_Ingest(builder)
        }
        fun startEvacMedication_Ingest(builder: FlatBufferBuilder) = builder.startTable(6)
        ...
        fun endEvacMedication_Ingest(builder: FlatBufferBuilder) : Int {
            val o = builder.endTable()
            return o
        }
        fun finishEvacMedicationIngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finish(offset, "EVAC")
        fun finishSizePrefixedEvacMedication_IngestBuffer(builder: FlatBufferBuilder, offset: Int) = builder.finishSizePrefixed(offset, "EVAC")
    }
}
