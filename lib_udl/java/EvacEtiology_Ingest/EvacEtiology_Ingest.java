...
public final class EvacEtiology_Ingest extends Table {
  ...
  public static EvacEtiology_Ingest getRootAsEvacEtiology_Ingest(ByteBuffer _bb, EvacEtiology_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean EvacEtiology_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "EVAC"); }
  ...
  public static int createEvacEtiology_Ingest(FlatBufferBuilder builder,
      int typeOffset,
      int bodyPartOffset,
      int timeOffset,
      int commentsOffset) {
  ...
  public static int endEvacEtiology_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishEvacEtiology_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "EVAC"); }
  public static void finishSizePrefixedEvacEtiology_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "EVAC"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public EvacEtiology_Ingest get(int j) { return get(new EvacEtiology_Ingest(), j); }
    public EvacEtiology_Ingest get(EvacEtiology_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
