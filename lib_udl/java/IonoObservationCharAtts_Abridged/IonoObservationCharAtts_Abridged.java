...
public final class IonoObservationCharAtts_Abridged extends Table {
  ...
  public static IonoObservationCharAtts_Abridged getRootAsIonoObservationCharAtts_Abridged(ByteBuffer _bb, IonoObservationCharAtts_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean IonoObservationCharAtts_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "IONO"); }
  ...
  public static int createIonoObservationCharAtts_Abridged(FlatBufferBuilder builder,
      int ursiIdOffset,
      int charNameOffset,
      double lowerBound,
      double upperBound,
  ...
  public static int endIonoObservationCharAtts_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishIonoObservationCharAtts_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "IONO"); }
  public static void finishSizePrefixedIonoObservationCharAtts_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "IONO"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public IonoObservationCharAtts_Abridged get(int j) { return get(new IonoObservationCharAtts_Abridged(), j); }
    public IonoObservationCharAtts_Abridged get(IonoObservationCharAtts_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
