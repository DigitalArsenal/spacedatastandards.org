...
public final class PersonnelRecoveryObjectiveAreaInfo_Ingest extends Table {
  ...
  public static PersonnelRecoveryObjectiveAreaInfo_Ingest getRootAsPersonnelRecoveryObjectiveAreaInfo_Ingest(ByteBuffer _bb, PersonnelRecoveryObjectiveAreaInfo_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean PersonnelRecoveryObjectiveAreaInfo_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "PERS"); }
  ...
  public static int createPersonnelRecoveryObjectiveAreaInfo_Ingest(FlatBufferBuilder builder,
  ...
  public static int endPersonnelRecoveryObjectiveAreaInfo_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishPersonnelRecoveryObjectiveAreaInfo_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "PERS"); }
  public static void finishSizePrefixedPersonnelRecoveryObjectiveAreaInfo_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "PERS"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public PersonnelRecoveryObjectiveAreaInfo_Ingest get(int j) { return get(new PersonnelRecoveryObjectiveAreaInfo_Ingest(), j); }
    public PersonnelRecoveryObjectiveAreaInfo_Ingest get(PersonnelRecoveryObjectiveAreaInfo_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
