...
public final class EvacTreatment_Ingest extends Table {
  ...
  public static EvacTreatment_Ingest getRootAsEvacTreatment_Ingest(ByteBuffer _bb, EvacTreatment_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean EvacTreatment_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "EVAC"); }
  ...
  public static int createEvacTreatment_Ingest(FlatBufferBuilder builder,
      int typeOffset,
      int bodyPartOffset,
      int timeOffset,
      int commentsOffset) {
  ...
  public static int endEvacTreatment_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishEvacTreatment_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "EVAC"); }
  public static void finishSizePrefixedEvacTreatment_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "EVAC"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public EvacTreatment_Ingest get(int j) { return get(new EvacTreatment_Ingest(), j); }
    public EvacTreatment_Ingest get(EvacTreatment_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
