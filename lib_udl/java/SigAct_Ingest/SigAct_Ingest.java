...
public final class SigAct_Ingest extends Table {
  ...
  public static SigAct_Ingest getRootAsSigAct_Ingest(ByteBuffer _bb, SigAct_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean SigAct_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "SIGA"); }
  ...
  public static int createSigAct_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endSigAct_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishSigAct_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "SIGA"); }
  public static void finishSizePrefixedSigAct_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "SIGA"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public SigAct_Ingest get(int j) { return get(new SigAct_Ingest(), j); }
    public SigAct_Ingest get(SigAct_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
