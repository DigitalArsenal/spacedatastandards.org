...
public final class LaunchVehicleDetails_Ingest extends Table {
  ...
  public static LaunchVehicleDetails_Ingest getRootAsLaunchVehicleDetails_Ingest(ByteBuffer _bb, LaunchVehicleDetails_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean LaunchVehicleDetails_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "LAUN"); }
   ...
   * Constraints: No constraints specified.
   */
  public String tags(int j) { int o = __offset(112); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int tagsLength() { int o = __offset(112); return o != 0 ? __vector_len(o) : 0; }
  public StringVector tagsVector() { return tagsVector(new StringVector()); }
  public StringVector tagsVector(StringVector obj) { int o = __offset(112); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }

  public static int createLaunchVehicleDetails_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static void addTags(FlatBufferBuilder builder, int tagsOffset) { builder.addOffset(54, tagsOffset, 0); }
  ...
  public static int endLaunchVehicleDetails_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishLaunchVehicleDetails_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "LAUN"); }
  public static void finishSizePrefixedLaunchVehicleDetails_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "LAUN"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public LaunchVehicleDetails_Ingest get(int j) { return get(new LaunchVehicleDetails_Ingest(), j); }
    public LaunchVehicleDetails_Ingest get(LaunchVehicleDetails_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
