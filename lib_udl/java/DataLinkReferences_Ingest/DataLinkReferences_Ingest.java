...
public final class DataLinkReferences_Ingest extends Table {
  ...
  public static DataLinkReferences_Ingest getRootAsDataLinkReferences_Ingest(ByteBuffer _bb, DataLinkReferences_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean DataLinkReferences_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "DATA"); }
  ...
  public static int createDataLinkReferences_Ingest(FlatBufferBuilder builder,
  ...
  public static int endDataLinkReferences_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishDataLinkReferences_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "DATA"); }
  public static void finishSizePrefixedDataLinkReferences_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "DATA"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public DataLinkReferences_Ingest get(int j) { return get(new DataLinkReferences_Ingest(), j); }
    public DataLinkReferences_Ingest get(DataLinkReferences_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
