...
public final class AirfieldStatus_Full extends Table {
  ...
  public static AirfieldStatus_Full getRootAsAirfieldStatus_Full(ByteBuffer _bb, AirfieldStatus_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean AirfieldStatus_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "AIRF"); }
  ...
  public static int createAirfieldStatus_Full(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endAirfieldStatus_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAirfieldStatus_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "AIRF"); }
  public static void finishSizePrefixedAirfieldStatus_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "AIRF"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public AirfieldStatus_Full get(int j) { return get(new AirfieldStatus_Full(), j); }
    public AirfieldStatus_Full get(AirfieldStatus_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
