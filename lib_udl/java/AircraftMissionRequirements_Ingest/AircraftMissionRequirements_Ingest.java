...
public final class AircraftMissionRequirements_Ingest extends Table {
  ...
  public static AircraftMissionRequirements_Ingest getRootAsAircraftMissionRequirements_Ingest(ByteBuffer _bb, AircraftMissionRequirements_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean AircraftMissionRequirements_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "AIRC"); }
  ...
  public static int createAircraftMissionRequirements_Ingest(FlatBufferBuilder builder,
      int gdssReqIdOffset,
      int onloadId,
  ...
  public static int endAircraftMissionRequirements_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAircraftMissionRequirements_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "AIRC"); }
  public static void finishSizePrefixedAircraftMissionRequirements_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "AIRC"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public AircraftMissionRequirements_Ingest get(int j) { return get(new AircraftMissionRequirements_Ingest(), j); }
    public AircraftMissionRequirements_Ingest get(AircraftMissionRequirements_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
