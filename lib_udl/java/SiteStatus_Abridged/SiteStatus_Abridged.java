...
public final class SiteStatus_Abridged extends Table {
  ...
  public static SiteStatus_Abridged getRootAsSiteStatus_Abridged(ByteBuffer _bb, SiteStatus_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean SiteStatus_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "SITE"); }
  ...
  public static int createSiteStatus_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endSiteStatus_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishSiteStatus_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "SITE"); }
  public static void finishSizePrefixedSiteStatus_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "SITE"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public SiteStatus_Abridged get(int j) { return get(new SiteStatus_Abridged(), j); }
    public SiteStatus_Abridged get(SiteStatus_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
