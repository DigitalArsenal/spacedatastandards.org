...
public final class Channel_Abridged extends Table {
  ...
  public static Channel_Abridged getRootAsChannel_Abridged(ByteBuffer _bb, Channel_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Channel_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "CHAN"); }
  ...
  public static int createChannel_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endChannel_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishChannel_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "CHAN"); }
  public static void finishSizePrefixedChannel_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "CHAN"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Channel_Abridged get(int j) { return get(new Channel_Abridged(), j); }
    public Channel_Abridged get(Channel_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
