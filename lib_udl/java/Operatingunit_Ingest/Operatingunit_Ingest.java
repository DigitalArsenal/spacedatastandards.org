...
public final class Operatingunit_Ingest extends Table {
  ...
  public static Operatingunit_Ingest getRootAsOperatingunit_Ingest(ByteBuffer _bb, Operatingunit_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Operatingunit_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "OPER"); }
  ...
  public static int createOperatingunit_Ingest(FlatBufferBuilder builder,
  ...
  public static int endOperatingunit_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishOperatingunit_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "OPER"); }
  public static void finishSizePrefixedOperatingunit_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "OPER"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Operatingunit_Ingest get(int j) { return get(new Operatingunit_Ingest(), j); }
    public Operatingunit_Ingest get(Operatingunit_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
