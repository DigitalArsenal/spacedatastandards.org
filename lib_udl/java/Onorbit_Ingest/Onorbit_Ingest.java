...
public final class Onorbit_Ingest extends Table {
  ...
  public static Onorbit_Ingest getRootAsOnorbit_Ingest(ByteBuffer _bb, Onorbit_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Onorbit_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "ONOR"); }
  ...
  public static int createOnorbit_Ingest(FlatBufferBuilder builder,
      int idOnOrbitOffset,
  ...
  public static int endOnorbit_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishOnorbit_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "ONOR"); }
  public static void finishSizePrefixedOnorbit_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "ONOR"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Onorbit_Ingest get(int j) { return get(new Onorbit_Ingest(), j); }
    public Onorbit_Ingest get(Onorbit_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
