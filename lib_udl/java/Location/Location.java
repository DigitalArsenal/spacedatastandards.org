...
public final class Location extends Table {
  ...
  public static boolean LocationBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "LOCA"); }
  ...
  public static void finishLocationBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "LOCA"); }
  public static void finishSizePrefixedLocationBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "LOCA"); }
