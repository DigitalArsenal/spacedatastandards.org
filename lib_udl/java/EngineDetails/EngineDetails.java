...
public final class EngineDetails extends Table {
  ...
  public static EngineDetails getRootAsEngineDetails(ByteBuffer _bb, EngineDetails obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean EngineDetailsBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "ENGI"); }
  ...
  public static int createEngineDetails(FlatBufferBuilder builder,
      int idOffset,
      int idEngineOffset,
  ...
  public static int endEngineDetails(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishEngineDetailsBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "ENGI"); }
  public static void finishSizePrefixedEngineDetailsBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "ENGI"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public EngineDetails get(int j) { return get(new EngineDetails(), j); }
    public EngineDetails get(EngineDetails obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
