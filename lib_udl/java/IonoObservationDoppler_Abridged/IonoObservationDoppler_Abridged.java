...
public final class IonoObservationDoppler_Abridged extends Table {
  ...
  public static IonoObservationDoppler_Abridged getRootAsIonoObservationDoppler_Abridged(ByteBuffer _bb, IonoObservationDoppler_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean IonoObservationDoppler_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "IONO"); }
  ...
  public static int createIonoObservationDoppler_Abridged(FlatBufferBuilder builder,
      int notesOffset,
  ...
  public static int endIonoObservationDoppler_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishIonoObservationDoppler_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "IONO"); }
  public static void finishSizePrefixedIonoObservationDoppler_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "IONO"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public IonoObservationDoppler_Abridged get(int j) { return get(new IonoObservationDoppler_Abridged(), j); }
    public IonoObservationDoppler_Abridged get(IonoObservationDoppler_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
