...
public final class MtiFreeText_Abridged extends Table {
  ...
  public static MtiFreeText_Abridged getRootAsMtiFreeText_Abridged(ByteBuffer _bb, MtiFreeText_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean MtiFreeText_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "MTIF"); }
  ...
  public static int createMtiFreeText_Abridged(FlatBufferBuilder builder,
      int f1Offset,
      int f2Offset,
      int f3Offset) {
  ...
  public static int endMtiFreeText_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishMtiFreeText_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "MTIF"); }
  public static void finishSizePrefixedMtiFreeText_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "MTIF"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public MtiFreeText_Abridged get(int j) { return get(new MtiFreeText_Abridged(), j); }
    public MtiFreeText_Abridged get(MtiFreeText_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
