...
public final class DriftHistory_Abridged extends Table {
  ...
  public static DriftHistory_Abridged getRootAsDriftHistory_Abridged(ByteBuffer _bb, DriftHistory_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean DriftHistory_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "DRIF"); }
  ...
  public static int createDriftHistory_Abridged(FlatBufferBuilder builder,
      int idOffset,
      int idOnOrbitOffset,
  ...
  public static int endDriftHistory_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishDriftHistory_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "DRIF"); }
  public static void finishSizePrefixedDriftHistory_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "DRIF"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public DriftHistory_Abridged get(int j) { return get(new DriftHistory_Abridged(), j); }
    public DriftHistory_Abridged get(DriftHistory_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
