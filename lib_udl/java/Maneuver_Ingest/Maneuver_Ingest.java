...
public final class Maneuver_Ingest extends Table {
  ...
  public static Maneuver_Ingest getRootAsManeuver_Ingest(ByteBuffer _bb, Maneuver_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Maneuver_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "MANE"); }
   ...
   * Constraints: No constraints specified.
   */
  public String tags(int j) { int o = __offset(188); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int tagsLength() { int o = __offset(188); return o != 0 ? __vector_len(o) : 0; }
  public StringVector tagsVector() { return tagsVector(new StringVector()); }
  public StringVector tagsVector(StringVector obj) { int o = __offset(188); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   * Optional algorithm used to produce this record.
   * Example: /// Example: Example algorithm
   * Constraints: Minimum length = 0, Maximum length = 64
   */
  public String algorithm() { int o = __offset(190); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer algorithmAsByteBuffer() { return __vector_as_bytebuffer(190, 1); }
  public ByteBuffer algorithmInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 190, 1); }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public String sourcedData(int j) { int o = __offset(192); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int sourcedDataLength() { int o = __offset(192); return o != 0 ? __vector_len(o) : 0; }
  public StringVector sourcedDataVector() { return sourcedDataVector(new StringVector()); }
  public StringVector sourcedDataVector(StringVector obj) { int o = __offset(192); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public byte sourcedDataTypes() { int o = __offset(194); return o != 0 ? bb.get(o + bb_pos) : 0; }
  /**
   * Optional identifier to track a commercial or marketplace transaction executed to produce this data.
   * Example: /// Example: TRANSACTION-ID
   * Constraints: Minimum length = 0, Maximum length = 64
   */
  public String transactionId() { int o = __offset(196); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer transactionIdAsByteBuffer() { return __vector_as_bytebuffer(196, 1); }
  public ByteBuffer transactionIdInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 196, 1); }
  /**
   * The originating source network on which this record was created, auto-populated by the system.
   * Example: /// Example: ORIG
   * Constraints: Minimum length = 1, Maximum length = 32
   */
  public String origNetwork() { int o = __offset(198); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer origNetworkAsByteBuffer() { return __vector_as_bytebuffer(198, 1); }
  public ByteBuffer origNetworkInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 198, 1); }

  public static int createManeuver_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static void addTags(FlatBufferBuilder builder, int tagsOffset) { builder.addOffset(92, tagsOffset, 0); }
  ...
  public static void addAlgorithm(FlatBufferBuilder builder, int algorithmOffset) { builder.addOffset(93, algorithmOffset, 0); }
  public static void addSourcedData(FlatBufferBuilder builder, int sourcedDataOffset) { builder.addOffset(94, sourcedDataOffset, 0); }
  ...
  public static void addSourcedDataTypes(FlatBufferBuilder builder, byte sourcedDataTypes) { builder.addByte(95, sourcedDataTypes, 0); }
  public static void addTransactionId(FlatBufferBuilder builder, int transactionIdOffset) { builder.addOffset(96, transactionIdOffset, 0); }
  public static void addOrigNetwork(FlatBufferBuilder builder, int origNetworkOffset) { builder.addOffset(97, origNetworkOffset, 0); }
  public static int endManeuver_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishManeuver_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "MANE"); }
  public static void finishSizePrefixedManeuver_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "MANE"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Maneuver_Ingest get(int j) { return get(new Maneuver_Ingest(), j); }
    public Maneuver_Ingest get(Maneuver_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
