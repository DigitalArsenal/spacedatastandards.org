...
public final class StateVector_Full extends Table {
  ...
  public static StateVector_Full getRootAsStateVector_Full(ByteBuffer _bb, StateVector_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean StateVector_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "STAT"); }
   ...
   * Constraints: No constraints specified.
   */
  public String effectiveFrom() { int o = __offset(168); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer effectiveFromAsByteBuffer() { return __vector_as_bytebuffer(168, 1); }
  public ByteBuffer effectiveFromInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 168, 1); }
  /**
   * End time at which this state vector was no longer the 'current' state vector for its satellite.
   * Example: /// Example: 2018-01-01T16:00:00.123Z
   * Constraints: No constraints specified.
   */
  public String effectiveUntil() { int o = __offset(170); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer effectiveUntilAsByteBuffer() { return __vector_as_bytebuffer(170, 1); }
  public ByteBuffer effectiveUntilInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 170, 1); }
  /**
   * Optional URI location in the document repository of the raw file parsed by the system to produce this record. To download the raw file, prepend https://udl-hostname/scs/download?id= to this value.
   * Example: /// Example: rawFileURI
   * Constraints: Minimum length = 0, Maximum length = 256
   */
  public String rawFileUri() { int o = __offset(172); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer rawFileUriAsByteBuffer() { return __vector_as_bytebuffer(172, 1); }
  public ByteBuffer rawFileUriInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 172, 1); }
  /**
   * Source of the data.
   * Example: /// Example: Bluestaq
   * Constraints: Minimum length = 1, Maximum length = 64
   */
  public String source() { int o = __offset(174); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer sourceAsByteBuffer() { return __vector_as_bytebuffer(174, 1); }
  public ByteBuffer sourceInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 174, 1); }
  /**
   * Originating system or organization which produced the data, if different from the source. The origin may be different than the source if the source was a mediating system which forwarded the data on behalf of the origin system. If null, the source may be assumed to be the origin.
   * Example: /// Example: THIRD_PARTY_DATASOURCE
   * Constraints: Minimum length = 0, Maximum length = 64
   */
  public String origin() { int o = __offset(176); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer originAsByteBuffer() { return __vector_as_bytebuffer(176, 1); }
  public ByteBuffer originInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 176, 1); }
  /**
   ...
   */
  public byte dataMode() { int o = __offset(178); return o != 0 ? bb.get(o + bb_pos) : 0; }
  /**
   * Optional array of provider/source specific tags for this data, where each element is no longer than 32 characters, used for implementing data owner conditional access controls to restrict access to the data. Should be left null by data providers unless conditional access controls are coordinated with the UDL team.
   * Example: /// Example: ['TAG1', 'TAG2']
   * Constraints: No constraints specified.
   */
  public String tags(int j) { int o = __offset(180); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int tagsLength() { int o = __offset(180); return o != 0 ? __vector_len(o) : 0; }
  public StringVector tagsVector() { return tagsVector(new StringVector()); }
  public StringVector tagsVector(StringVector obj) { int o = __offset(180); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   * Optional algorithm used to produce this record.
   * Example: /// Example: SAMPLE_ALGORITHM
   * Constraints: Minimum length = 0, Maximum length = 64
   */
  public String algorithm() { int o = __offset(182); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer algorithmAsByteBuffer() { return __vector_as_bytebuffer(182, 1); }
  public ByteBuffer algorithmInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 182, 1); }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public String sourcedData(int j) { int o = __offset(184); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int sourcedDataLength() { int o = __offset(184); return o != 0 ? __vector_len(o) : 0; }
  public StringVector sourcedDataVector() { return sourcedDataVector(new StringVector()); }
  public StringVector sourcedDataVector(StringVector obj) { int o = __offset(184); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public byte sourcedDataTypes() { int o = __offset(186); return o != 0 ? bb.get(o + bb_pos) : 0; }
  /**
   * Time the row was created in the database, auto-populated by the system.
   * Example: /// Example: 2018-01-01T16:00:00.123Z
   * Constraints: No constraints specified.
   */
  public String createdAt() { int o = __offset(188); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer createdAtAsByteBuffer() { return __vector_as_bytebuffer(188, 1); }
  public ByteBuffer createdAtInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 188, 1); }
  /**
   * Application user who created the row in the database, auto-populated by the system.
   * Example: /// Example: some.user
   * Constraints: Minimum length = 1, Maximum length = 64
   */
  public String createdBy() { int o = __offset(190); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer createdByAsByteBuffer() { return __vector_as_bytebuffer(190, 1); }
  public ByteBuffer createdByInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 190, 1); }
  /**
   * No description provided.
   * Example: /// Example: No example provided.
   * Constraints: No constraints specified.
   */
  public String onOrbit() { int o = __offset(192); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer onOrbitAsByteBuffer() { return __vector_as_bytebuffer(192, 1); }
  public ByteBuffer onOrbitInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 192, 1); }
  /**
   * Optional source-provided and searchable metadata or descriptor of the data.
   * Example: /// Example: descriptor
   * Constraints: Minimum length = 0, Maximum length = 64
   */
  public String descriptor() { int o = __offset(194); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer descriptorAsByteBuffer() { return __vector_as_bytebuffer(194, 1); }
  public ByteBuffer descriptorInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 194, 1); }
  /**
   ...
   * Constraints: Minimum length = 0, Maximum length = 64
   */
  public String sourceDl() { int o = __offset(200); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer sourceDlAsByteBuffer() { return __vector_as_bytebuffer(200, 1); }
  public ByteBuffer sourceDlInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 200, 1); }

  public static int createStateVector_Full(FlatBufferBuilder builder,
  ...
  public static void addEffectiveFrom(FlatBufferBuilder builder, int effectiveFromOffset) { builder.addOffset(82, effectiveFromOffset, 0); }
  public static void addEffectiveUntil(FlatBufferBuilder builder, int effectiveUntilOffset) { builder.addOffset(83, effectiveUntilOffset, 0); }
  public static void addRawFileUri(FlatBufferBuilder builder, int rawFileUriOffset) { builder.addOffset(84, rawFileUriOffset, 0); }
  public static void addSource(FlatBufferBuilder builder, int sourceOffset) { builder.addOffset(85, sourceOffset, 0); }
  public static void addOrigin(FlatBufferBuilder builder, int originOffset) { builder.addOffset(86, originOffset, 0); }
  public static void addDataMode(FlatBufferBuilder builder, byte dataMode) { builder.addByte(87, dataMode, 0); }
  public static void addTags(FlatBufferBuilder builder, int tagsOffset) { builder.addOffset(88, tagsOffset, 0); }
  ...
  public static void addAlgorithm(FlatBufferBuilder builder, int algorithmOffset) { builder.addOffset(89, algorithmOffset, 0); }
  public static void addSourcedData(FlatBufferBuilder builder, int sourcedDataOffset) { builder.addOffset(90, sourcedDataOffset, 0); }
  ...
  public static void addSourcedDataTypes(FlatBufferBuilder builder, byte sourcedDataTypes) { builder.addByte(91, sourcedDataTypes, 0); }
  public static void addCreatedAt(FlatBufferBuilder builder, int createdAtOffset) { builder.addOffset(92, createdAtOffset, 0); }
  public static void addCreatedBy(FlatBufferBuilder builder, int createdByOffset) { builder.addOffset(93, createdByOffset, 0); }
  public static void addOnOrbit(FlatBufferBuilder builder, int onOrbitOffset) { builder.addOffset(94, onOrbitOffset, 0); }
  public static void addDescriptor(FlatBufferBuilder builder, int descriptorOffset) { builder.addOffset(95, descriptorOffset, 0); }
  ...
  public static void addSourceDl(FlatBufferBuilder builder, int sourceDlOffset) { builder.addOffset(98, sourceDlOffset, 0); }
  public static int endStateVector_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishStateVector_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "STAT"); }
  public static void finishSizePrefixedStateVector_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "STAT"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public StateVector_Full get(int j) { return get(new StateVector_Full(), j); }
    public StateVector_Full get(StateVector_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
