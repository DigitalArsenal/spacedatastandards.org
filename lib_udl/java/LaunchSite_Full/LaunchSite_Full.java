...
public final class LaunchSite_Full extends Table {
  ...
  public static boolean LaunchSite_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "LAUN"); }
  ...
  public StringVector launchSiteDetailsVector() { return launchSiteDetailsVector(new StringVector()); }
  public StringVector launchSiteDetailsVector(StringVector obj) { int o = __offset(34); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  ...
  public static void finishLaunchSite_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "LAUN"); }
  public static void finishSizePrefixedLaunchSite_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "LAUN"); }
