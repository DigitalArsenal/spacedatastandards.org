...
public final class OrbitTrack_Full extends Table {
  ...
  public static OrbitTrack_Full getRootAsOrbitTrack_Full(ByteBuffer _bb, OrbitTrack_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean OrbitTrack_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "ORBI"); }
   ...
   * Constraints: Minimum length = 0, Maximum length = 36
   */
  public String idElset() { int o = __offset(16); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer idElsetAsByteBuffer() { return __vector_as_bytebuffer(16, 1); }
  public ByteBuffer idElsetInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 16, 1); }
  /**
   * Track timestamp in ISO8601 UTC format, with microsecond precision.
   * Example: /// Example: 2021-02-25T12:00:00.123456Z
   * Constraints: No constraints specified.
   */
  public String ts() { int o = __offset(18); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer tsAsByteBuffer() { return __vector_as_bytebuffer(18, 1); }
  public ByteBuffer tsInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 18, 1); }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public double alt() { int o = __offset(24); return o != 0 ? bb.getDouble(o + bb_pos) : 0.0; }
  /**
   * Radio frequency of the track, measured in megahertz (MHz).
   * Example: /// Example: 1.5273
   * Constraints: No constraints specified.
   */
  public double rdfRf() { int o = __offset(26); return o != 0 ? bb.getDouble(o + bb_pos) : 0.0; }
  /**
   ...
   */
  public String rptNum() { int o = __offset(30); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer rptNumAsByteBuffer() { return __vector_as_bytebuffer(30, 1); }
  public ByteBuffer rptNumInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 30, 1); }
  /**
   ...
   * Constraints: Minimum length = 0, Maximum length = 32
   */
  public byte objIdent() { int o = __offset(32); return o != 0 ? bb.get(o + bb_pos) : 0; }
  /**
   ...
   * Constraints: Minimum length = 0, Maximum length = 32
   */
  public String identAmp() { int o = __offset(34); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer identAmpAsByteBuffer() { return __vector_as_bytebuffer(34, 1); }
  public ByteBuffer identAmpInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 34, 1); }
  /**
   * Status of the satellite.
   * Example: /// Example: INACTIVE
   * Constraints: Minimum length = 0, Maximum length = 64
   */
  public String satStatus() { int o = __offset(36); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer satStatusAsByteBuffer() { return __vector_as_bytebuffer(36, 1); }
  public ByteBuffer satStatusInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 36, 1); }
  /**
   * The on-orbit category assigned to this track object (DEBRIS, MANNED, PAYLOAD, PLATFORM, ROCKET BODY, UNKNOWN).
   * Example: /// Example: PAYLOAD
   * Constraints: Minimum length = 0, Maximum length = 32
   */
  public byte objectType() { int o = __offset(38); return o != 0 ? bb.get(o + bb_pos) : 0; }
  /**
   ...
   */
  public String charlieLine() { int o = __offset(44); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer charlieLineAsByteBuffer() { return __vector_as_bytebuffer(44, 1); }
  public ByteBuffer charlieLineInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 44, 1); }
  /**
   ...
   */
  public String aouType() { int o = __offset(46); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer aouTypeAsByteBuffer() { return __vector_as_bytebuffer(46, 1); }
  public ByteBuffer aouTypeInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 46, 1); }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public String aouData(int j) { int o = __offset(48); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int aouDataLength() { int o = __offset(48); return o != 0 ? __vector_len(o) : 0; }
  public StringVector aouDataVector() { return aouDataVector(new StringVector()); }
  public StringVector aouDataVector(StringVector obj) { int o = __offset(48); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   * Track object speed, in km/sec.
   * Example: /// Example: 15.03443
   * Constraints: No constraints specified.
   */
  public double spd() { int o = __offset(50); return o != 0 ? bb.getDouble(o + bb_pos) : 0.0; }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public double angElev() { int o = __offset(52); return o != 0 ? bb.getDouble(o + bb_pos) : 0.0; }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public double cntnmnt() { int o = __offset(54); return o != 0 ? bb.getDouble(o + bb_pos) : 0.0; }
  /**
   * Source cross-reference code for the command that originated the track report.
   * Example: /// Example: XE
   * Constraints: Minimum length = 0, Maximum length = 8
   */
  public String xref() { int o = __offset(56); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer xrefAsByteBuffer() { return __vector_as_bytebuffer(56, 1); }
  public ByteBuffer xrefInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 56, 1); }
  /**
   ...
   * Constraints: Minimum length = 0, Maximum length = 32
   */
  public String chXref() { int o = __offset(58); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer chXrefAsByteBuffer() { return __vector_as_bytebuffer(58, 1); }
  public ByteBuffer chXrefInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 58, 1); }
  /**
   * Free-form remarks entered for the satellite.
   * Example: /// Example: A note regarding this spacecraft
   * Constraints: Minimum length = 0, Maximum length = 256
   */
  public String amplification() { int o = __offset(60); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer amplificationAsByteBuffer() { return __vector_as_bytebuffer(60, 1); }
  public ByteBuffer amplificationInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 60, 1); }
  /**
   * A text aplifier displaying IFF/SIF/AIS Identification modes and codes.
   * Example: /// Example: ID Mode
   * Constraints: Minimum length = 0, Maximum length = 64
   */
  public String iff() { int o = __offset(62); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer iffAsByteBuffer() { return __vector_as_bytebuffer(62, 1); }
  public ByteBuffer iffInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 62, 1); }
  /**
   * Flag indicating that this track represents a reinforced object or group.  Based on MIL-STD-2525 symbology definitions.
   * Example: /// Example: False
   * Constraints: No constraints specified.
   */
  public boolean reinforced() { int o = __offset(64); return o != 0 ? 0!=bb.get(o + bb_pos) : false; }
  /**
   * Flag indicating that this track represents a reduced object or group.  Based on MIL-STD-2525 symbology definitions.
   * Example: /// Example: False
   * Constraints: No constraints specified.
   */
  public boolean reduced() { int o = __offset(66); return o != 0 ? 0!=bb.get(o + bb_pos) : false; }
  /**
   * Flag indicating that this track represents a headquarters object.  Based on MIL-STD-2525 symbology definitions.
   * Example: /// Example: False
   * Constraints: No constraints specified.
   */
  public boolean hq() { int o = __offset(68); return o != 0 ? 0!=bb.get(o + bb_pos) : false; }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public boolean dummy() { int o = __offset(70); return o != 0 ? 0!=bb.get(o + bb_pos) : false; }
  /**
   * Flag indicating that this track represents a task force.  Based on MIL-STD-2525 symbology definitions.
   * Example: /// Example: False
   * Constraints: No constraints specified.
   */
  public boolean taskForce() { int o = __offset(72); return o != 0 ? 0!=bb.get(o + bb_pos) : false; }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public boolean feint() { int o = __offset(74); return o != 0 ? 0!=bb.get(o + bb_pos) : false; }
  /**
   * Flag indicating that this track represents an installation.  Based on MIL-STD-2525 symbology definitions.
   * Example: /// Example: False
   * Constraints: No constraints specified.
   */
  public boolean installation() { int o = __offset(76); return o != 0 ? 0!=bb.get(o + bb_pos) : false; }
  /**
   ...
   */
  public String vehType() { int o = __offset(78); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer vehTypeAsByteBuffer() { return __vector_as_bytebuffer(78, 1); }
  public ByteBuffer vehTypeInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 78, 1); }
  /**
   ...
   * Constraints: Minimum length = 0, Maximum length = 36
   */
  public String trkId() { int o = __offset(80); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer trkIdAsByteBuffer() { return __vector_as_bytebuffer(80, 1); }
  public ByteBuffer trkIdInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 80, 1); }
  /**
   * TrackSensor Collection.
   * Example: /// Example: No example provided.
   * Constraints: No constraints specified.
   */
  public String trackSensors(int j) { int o = __offset(82); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int trackSensorsLength() { int o = __offset(82); return o != 0 ? __vector_len(o) : 0; }
  public StringVector trackSensorsVector() { return trackSensorsVector(new StringVector()); }
  public StringVector trackSensorsVector(StringVector obj) { int o = __offset(82); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
  ...
  public static int createOrbitTrack_Full(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static void addIdElset(FlatBufferBuilder builder, int idElsetOffset) { builder.addOffset(6, idElsetOffset, 0); }
  public static void addTs(FlatBufferBuilder builder, int tsOffset) { builder.addOffset(7, tsOffset, 0); }
  ...
  public static void addRptNum(FlatBufferBuilder builder, int rptNumOffset) { builder.addOffset(13, rptNumOffset, 0); }
  public static void addObjIdent(FlatBufferBuilder builder, byte objIdent) { builder.addByte(14, objIdent, 0); }
  public static void addIdentAmp(FlatBufferBuilder builder, int identAmpOffset) { builder.addOffset(15, identAmpOffset, 0); }
  public static void addSatStatus(FlatBufferBuilder builder, int satStatusOffset) { builder.addOffset(16, satStatusOffset, 0); }
  public static void addObjectType(FlatBufferBuilder builder, byte objectType) { builder.addByte(17, objectType, 0); }
  ...
  public static void addCharlieLine(FlatBufferBuilder builder, int charlieLineOffset) { builder.addOffset(20, charlieLineOffset, 0); }
  public static void addAouType(FlatBufferBuilder builder, int aouTypeOffset) { builder.addOffset(21, aouTypeOffset, 0); }
  public static void addAouData(FlatBufferBuilder builder, int aouDataOffset) { builder.addOffset(22, aouDataOffset, 0); }
  ...
  public static void addXref(FlatBufferBuilder builder, int xrefOffset) { builder.addOffset(26, xrefOffset, 0); }
  public static void addChXref(FlatBufferBuilder builder, int chXrefOffset) { builder.addOffset(27, chXrefOffset, 0); }
  public static void addAmplification(FlatBufferBuilder builder, int amplificationOffset) { builder.addOffset(28, amplificationOffset, 0); }
  public static void addIff(FlatBufferBuilder builder, int iffOffset) { builder.addOffset(29, iffOffset, 0); }
  public static void addReinforced(FlatBufferBuilder builder, boolean reinforced) { builder.addBoolean(30, reinforced, false); }
  public static void addReduced(FlatBufferBuilder builder, boolean reduced) { builder.addBoolean(31, reduced, false); }
  public static void addHq(FlatBufferBuilder builder, boolean hq) { builder.addBoolean(32, hq, false); }
  public static void addDummy(FlatBufferBuilder builder, boolean dummy) { builder.addBoolean(33, dummy, false); }
  public static void addTaskForce(FlatBufferBuilder builder, boolean taskForce) { builder.addBoolean(34, taskForce, false); }
  public static void addFeint(FlatBufferBuilder builder, boolean feint) { builder.addBoolean(35, feint, false); }
  public static void addInstallation(FlatBufferBuilder builder, boolean installation) { builder.addBoolean(36, installation, false); }
  public static void addVehType(FlatBufferBuilder builder, int vehTypeOffset) { builder.addOffset(37, vehTypeOffset, 0); }
  public static void addTrkId(FlatBufferBuilder builder, int trkIdOffset) { builder.addOffset(38, trkIdOffset, 0); }
  public static void addTrackSensors(FlatBufferBuilder builder, int trackSensorsOffset) { builder.addOffset(39, trackSensorsOffset, 0); }
  ...
  public static int endOrbitTrack_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishOrbitTrack_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "ORBI"); }
  public static void finishSizePrefixedOrbitTrack_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "ORBI"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public OrbitTrack_Full get(int j) { return get(new OrbitTrack_Full(), j); }
    public OrbitTrack_Full get(OrbitTrack_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
