...
public final class MtiMission_Ingest extends Table {
  ...
  public static MtiMission_Ingest getRootAsMtiMission_Ingest(ByteBuffer _bb, MtiMission_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean MtiMission_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "MTIM"); }
  ...
  public static int createMtiMission_Ingest(FlatBufferBuilder builder,
      int m1Offset,
      int m2Offset,
      int m3Offset,
      int m4Offset,
  ...
  public static int endMtiMission_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishMtiMission_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "MTIM"); }
  public static void finishSizePrefixedMtiMission_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "MTIM"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public MtiMission_Ingest get(int j) { return get(new MtiMission_Ingest(), j); }
    public MtiMission_Ingest get(MtiMission_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
