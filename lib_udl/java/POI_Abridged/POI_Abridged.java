...
public final class POI_Abridged extends Table {
  ...
  public static POI_Abridged getRootAsPOI_Abridged(ByteBuffer _bb, POI_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean POI_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "POIA"); }
   ...
   * Constraints: No constraints specified.
   */
  public String atext() { int o = __offset(66); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer atextAsByteBuffer() { return __vector_as_bytebuffer(66, 1); }
  public ByteBuffer atextInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 66, 1); }
  /**
   ...
   * Constraints: Minimum length = 0, Maximum length = 128
   */
  public String atype() { int o = __offset(70); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer atypeAsByteBuffer() { return __vector_as_bytebuffer(70, 1); }
  public ByteBuffer atypeInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 70, 1); }
  /**
   * Number of dimensions of the geometry depicted by region.
   * Example: /// Example: 3
   * Constraints: No constraints specified.
   */
  public int andims() { int o = __offset(72); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  /**
   * Geographical spatial_ref_sys for region.
   * Example: /// Example: 3
   * Constraints: No constraints specified.
   */
  public int asrid() { int o = __offset(74); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  /**
   * Time the row was created in the database.
   * Example: /// Example: 2018-01-01T16:00:00.123Z
   * Constraints: No constraints specified.
   */
  public String createdAt() { int o = __offset(76); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer createdAtAsByteBuffer() { return __vector_as_bytebuffer(76, 1); }
  public ByteBuffer createdAtInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 76, 1); }
  /**
   * Application user who created the row in the database.
   * Example: /// Example: some.user
   * Constraints: Minimum length = 1, Maximum length = 64
   */
  public String createdBy() { int o = __offset(78); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer createdByAsByteBuffer() { return __vector_as_bytebuffer(78, 1); }
  public ByteBuffer createdByInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 78, 1); }
  /**
   ...
   * Constraints: Minimum length = 1, Maximum length = 36
   */
  public String source() { int o = __offset(82); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer sourceAsByteBuffer() { return __vector_as_bytebuffer(82, 1); }
  public ByteBuffer sourceInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 82, 1); }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public String groups(int j) { int o = __offset(88); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int groupsLength() { int o = __offset(88); return o != 0 ? __vector_len(o) : 0; }
  public StringVector groupsVector() { return groupsVector(new StringVector()); }
  public StringVector groupsVector(StringVector obj) { int o = __offset(88); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   * ID/name of the platform or entity providing the POI data.
   * Example: /// Example: PLATFORM_NAME
   * Constraints: Minimum length = 0, Maximum length = 64
   */
  public String asset() { int o = __offset(90); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer assetAsByteBuffer() { return __vector_as_bytebuffer(90, 1); }
  public ByteBuffer assetInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 90, 1); }
  /**
   * The Basic Encyclopedia Number associated with the POI, if applicable.
   * Example: /// Example: 0427RT1030
   * Constraints: Minimum length = 0, Maximum length = 64
   */
  public String beNumber() { int o = __offset(92); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer beNumberAsByteBuffer() { return __vector_as_bytebuffer(92, 1); }
  public ByteBuffer beNumberInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 92, 1); }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public double orientation() { int o = __offset(94); return o != 0 ? bb.getDouble(o + bb_pos) : 0.0; }
  /**
   ...
   * Constraints: Minimum length = 0, Maximum length = 64
   */
  public String transactionId() { int o = __offset(98); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer transactionIdAsByteBuffer() { return __vector_as_bytebuffer(98, 1); }
  public ByteBuffer transactionIdInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 98, 1); }

  public static int createPOI_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static void addAtext(FlatBufferBuilder builder, int atextOffset) { builder.addOffset(31, atextOffset, 0); }
  public static void addAgjson(FlatBufferBuilder builder, int agjsonOffset) { builder.addOffset(32, agjsonOffset, 0); }
  public static void addAtype(FlatBufferBuilder builder, int atypeOffset) { builder.addOffset(33, atypeOffset, 0); }
  ...
  public static void addCreatedAt(FlatBufferBuilder builder, int createdAtOffset) { builder.addOffset(36, createdAtOffset, 0); }
  public static void addCreatedBy(FlatBufferBuilder builder, int createdByOffset) { builder.addOffset(37, createdByOffset, 0); }
  public static void addSourceDl(FlatBufferBuilder builder, int sourceDlOffset) { builder.addOffset(38, sourceDlOffset, 0); }
  public static void addSource(FlatBufferBuilder builder, int sourceOffset) { builder.addOffset(39, sourceOffset, 0); }
  ...
  public static void addGroups(FlatBufferBuilder builder, int groupsOffset) { builder.addOffset(42, groupsOffset, 0); }
  ...
  public static void addAsset(FlatBufferBuilder builder, int assetOffset) { builder.addOffset(43, assetOffset, 0); }
  public static void addBeNumber(FlatBufferBuilder builder, int beNumberOffset) { builder.addOffset(44, beNumberOffset, 0); }
  ...
  public static void addTransactionId(FlatBufferBuilder builder, int transactionIdOffset) { builder.addOffset(47, transactionIdOffset, 0); }
  public static int endPOI_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishPOI_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "POIA"); }
  public static void finishSizePrefixedPOI_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "POIA"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public POI_Abridged get(int j) { return get(new POI_Abridged(), j); }
    public POI_Abridged get(POI_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
