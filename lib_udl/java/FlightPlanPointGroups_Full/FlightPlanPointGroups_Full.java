...
public final class FlightPlanPointGroups_Full extends Table {
  ...
  public static FlightPlanPointGroups_Full getRootAsFlightPlanPointGroups_Full(ByteBuffer _bb, FlightPlanPointGroups_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean FlightPlanPointGroups_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "FLIG"); }
  ...
  public static int createFlightPlanPointGroups_Full(FlatBufferBuilder builder,
  ...
  public static int endFlightPlanPointGroups_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishFlightPlanPointGroups_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "FLIG"); }
  public static void finishSizePrefixedFlightPlanPointGroups_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "FLIG"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public FlightPlanPointGroups_Full get(int j) { return get(new FlightPlanPointGroups_Full(), j); }
    public FlightPlanPointGroups_Full get(FlightPlanPointGroups_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
