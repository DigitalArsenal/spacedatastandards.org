...
public final class MtiPlatformLocation_Abridged extends Table {
  ...
  public static MtiPlatformLocation_Abridged getRootAsMtiPlatformLocation_Abridged(ByteBuffer _bb, MtiPlatformLocation_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean MtiPlatformLocation_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "MTIP"); }
  ...
  public static int createMtiPlatformLocation_Abridged(FlatBufferBuilder builder,
      long l1,
      double l2,
      double l3,
      int l4,
  ...
  public static int endMtiPlatformLocation_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishMtiPlatformLocation_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "MTIP"); }
  public static void finishSizePrefixedMtiPlatformLocation_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "MTIP"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public MtiPlatformLocation_Abridged get(int j) { return get(new MtiPlatformLocation_Abridged(), j); }
    public MtiPlatformLocation_Abridged get(MtiPlatformLocation_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
