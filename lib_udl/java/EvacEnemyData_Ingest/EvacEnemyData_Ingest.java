...
public final class EvacEnemyData_Ingest extends Table {
  ...
  public static EvacEnemyData_Ingest getRootAsEvacEnemyData_Ingest(ByteBuffer _bb, EvacEnemyData_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean EvacEnemyData_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "EVAC"); }
  ...
  public static int createEvacEnemyData_Ingest(FlatBufferBuilder builder,
  ...
  public static int endEvacEnemyData_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishEvacEnemyData_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "EVAC"); }
  public static void finishSizePrefixedEvacEnemyData_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "EVAC"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public EvacEnemyData_Ingest get(int j) { return get(new EvacEnemyData_Ingest(), j); }
    public EvacEnemyData_Ingest get(EvacEnemyData_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
