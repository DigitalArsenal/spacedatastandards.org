...
public final class EquipmentRemark_Abridged extends Table {
  ...
  public static EquipmentRemark_Abridged getRootAsEquipmentRemark_Abridged(ByteBuffer _bb, EquipmentRemark_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean EquipmentRemark_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "EQUI"); }
  ...
  public static int createEquipmentRemark_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endEquipmentRemark_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishEquipmentRemark_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "EQUI"); }
  public static void finishSizePrefixedEquipmentRemark_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "EQUI"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public EquipmentRemark_Abridged get(int j) { return get(new EquipmentRemark_Abridged(), j); }
    public EquipmentRemark_Abridged get(EquipmentRemark_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
