...
public final class IonoObservationAzimuth_Ingest extends Table {
  ...
  public static IonoObservationAzimuth_Ingest getRootAsIonoObservationAzimuth_Ingest(ByteBuffer _bb, IonoObservationAzimuth_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean IonoObservationAzimuth_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "IONO"); }
  ...
  public static int createIonoObservationAzimuth_Ingest(FlatBufferBuilder builder,
      int notesOffset,
  ...
  public static int endIonoObservationAzimuth_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishIonoObservationAzimuth_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "IONO"); }
  public static void finishSizePrefixedIonoObservationAzimuth_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "IONO"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public IonoObservationAzimuth_Ingest get(int j) { return get(new IonoObservationAzimuth_Ingest(), j); }
    public IonoObservationAzimuth_Ingest get(IonoObservationAzimuth_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
