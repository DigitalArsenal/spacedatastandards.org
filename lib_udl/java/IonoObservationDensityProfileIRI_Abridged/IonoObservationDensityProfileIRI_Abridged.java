...
public final class IonoObservationDensityProfileIRI_Abridged extends Table {
  ...
  public static IonoObservationDensityProfileIRI_Abridged getRootAsIonoObservationDensityProfileIRI_Abridged(ByteBuffer _bb, IonoObservationDensityProfileIRI_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean IonoObservationDensityProfileIRI_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "IONO"); }
  ...
  public static int createIonoObservationDensityProfileIRI_Abridged(FlatBufferBuilder builder,
  ...
  public static int endIonoObservationDensityProfileIRI_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishIonoObservationDensityProfileIRI_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "IONO"); }
  public static void finishSizePrefixedIonoObservationDensityProfileIRI_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "IONO"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public IonoObservationDensityProfileIRI_Abridged get(int j) { return get(new IonoObservationDensityProfileIRI_Abridged(), j); }
    public IonoObservationDensityProfileIRI_Abridged get(IonoObservationDensityProfileIRI_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
