...
public final class SWIR_Ingest extends Table {
  ...
  public static SWIR_Ingest getRootAsSWIR_Ingest(ByteBuffer _bb, SWIR_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean SWIR_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "SWIR"); }
   ...
   * Constraints: No constraints specified.
   */
  public String wavelengths(int j) { int o = __offset(22); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int wavelengthsLength() { int o = __offset(22); return o != 0 ? __vector_len(o) : 0; }
  public StringVector wavelengthsVector() { return wavelengthsVector(new StringVector()); }
  public StringVector wavelengthsVector(StringVector obj) { int o = __offset(22); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public String absFluxes(int j) { int o = __offset(24); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int absFluxesLength() { int o = __offset(24); return o != 0 ? __vector_len(o) : 0; }
  public StringVector absFluxesVector() { return absFluxesVector(new StringVector()); }
  public StringVector absFluxesVector(StringVector obj) { int o = __offset(24); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   * Array of ratio wavelength data. This array should correspond with the same-sized array of fluxRatios.
   * Example: /// Example: [1.23, 4.56]
   * Constraints: No constraints specified.
   */
  public String ratioWavelengths(int j) { int o = __offset(26); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int ratioWavelengthsLength() { int o = __offset(26); return o != 0 ? __vector_len(o) : 0; }
  public StringVector ratioWavelengthsVector() { return ratioWavelengthsVector(new StringVector()); }
  public StringVector ratioWavelengthsVector(StringVector obj) { int o = __offset(26); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   * Array of flux ratio data. This array should correspond with the same-sized array of ratioWavelengths.
   * Example: /// Example: [1.23, 4.56]
   * Constraints: No constraints specified.
   */
  public String fluxRatios(int j) { int o = __offset(28); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int fluxRatiosLength() { int o = __offset(28); return o != 0 ? __vector_len(o) : 0; }
  public StringVector fluxRatiosVector() { return fluxRatiosVector(new StringVector()); }
  public StringVector fluxRatiosVector(StringVector obj) { int o = __offset(28); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public int satNo() { int o = __offset(36); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  /**
  ...
  public static int createSWIR_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static void addWavelengths(FlatBufferBuilder builder, int wavelengthsOffset) { builder.addOffset(9, wavelengthsOffset, 0); }
  ...
  public static void addAbsFluxes(FlatBufferBuilder builder, int absFluxesOffset) { builder.addOffset(10, absFluxesOffset, 0); }
  ...
  public static void addRatioWavelengths(FlatBufferBuilder builder, int ratioWavelengthsOffset) { builder.addOffset(11, ratioWavelengthsOffset, 0); }
  ...
  public static void addFluxRatios(FlatBufferBuilder builder, int fluxRatiosOffset) { builder.addOffset(12, fluxRatiosOffset, 0); }
  ...
  public static int endSWIR_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishSWIR_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "SWIR"); }
  public static void finishSizePrefixedSWIR_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "SWIR"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public SWIR_Ingest get(int j) { return get(new SWIR_Ingest(), j); }
    public SWIR_Ingest get(SWIR_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
