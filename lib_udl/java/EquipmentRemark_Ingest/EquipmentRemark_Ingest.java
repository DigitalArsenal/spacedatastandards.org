...
public final class EquipmentRemark_Ingest extends Table {
  ...
  public static EquipmentRemark_Ingest getRootAsEquipmentRemark_Ingest(ByteBuffer _bb, EquipmentRemark_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean EquipmentRemark_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "EQUI"); }
  ...
  public static int createEquipmentRemark_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endEquipmentRemark_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishEquipmentRemark_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "EQUI"); }
  public static void finishSizePrefixedEquipmentRemark_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "EQUI"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public EquipmentRemark_Ingest get(int j) { return get(new EquipmentRemark_Ingest(), j); }
    public EquipmentRemark_Ingest get(EquipmentRemark_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
