...
public final class SortiePPR_Ingest extends Table {
  ...
  public static SortiePPR_Ingest getRootAsSortiePPR_Ingest(ByteBuffer _bb, SortiePPR_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean SortiePPR_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "SORT"); }
  ...
  public static int createSortiePPR_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endSortiePPR_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishSortiePPR_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "SORT"); }
  public static void finishSizePrefixedSortiePPR_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "SORT"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public SortiePPR_Ingest get(int j) { return get(new SortiePPR_Ingest(), j); }
    public SortiePPR_Ingest get(SortiePPR_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
