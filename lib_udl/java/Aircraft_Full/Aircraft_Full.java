...
public final class Aircraft_Full extends Table {
  ...
  public static Aircraft_Full getRootAsAircraft_Full(ByteBuffer _bb, Aircraft_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Aircraft_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "AIRC"); }
   ...
   */
  public String origNetwork() { int o = __offset(54); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer origNetworkAsByteBuffer() { return __vector_as_bytebuffer(54, 1); }
  public ByteBuffer origNetworkInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 54, 1); }

  public static int createAircraft_Full(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static void addOrigNetwork(FlatBufferBuilder builder, int origNetworkOffset) { builder.addOffset(25, origNetworkOffset, 0); }
  public static int endAircraft_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAircraft_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "AIRC"); }
  public static void finishSizePrefixedAircraft_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "AIRC"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Aircraft_Full get(int j) { return get(new Aircraft_Full(), j); }
    public Aircraft_Full get(Aircraft_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
