...
public final class Bus_Ingest extends Table {
  public static void ValidateVersion() { Constants.FLATBUFFERS_24_3_25(); }
  public static Bus_Ingest getRootAsBus_Ingest(ByteBuffer _bb) { return getRootAsBus_Ingest(_bb, new Bus_Ingest()); }
  public static Bus_Ingest getRootAsBus_Ingest(ByteBuffer _bb, Bus_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Bus_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "BUSI"); }
   ...
   * Constraints: No constraints specified.
   */
  public String entity() { int o = __offset(116); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer entityAsByteBuffer() { return __vector_as_bytebuffer(116, 1); }
  public ByteBuffer entityInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 116, 1); }

  public static int createBus_Ingest(FlatBufferBuilder builder,
      int idOffset,
      int nameOffset,
  ...
  public static void addEntity(FlatBufferBuilder builder, int entityOffset) { builder.addOffset(56, entityOffset, 0); }
  public static int endBus_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishBus_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "BUSI"); }
  public static void finishSizePrefixedBus_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "BUSI"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Bus_Ingest get(int j) { return get(new Bus_Ingest(), j); }
    public Bus_Ingest get(Bus_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
