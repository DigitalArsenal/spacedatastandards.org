...
public final class RelatedDocument_Full extends Table {
  ...
  public static RelatedDocument_Full getRootAsRelatedDocument_Full(ByteBuffer _bb, RelatedDocument_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean RelatedDocument_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "RELA"); }
  ...
  public static int createRelatedDocument_Full(FlatBufferBuilder builder,
  ...
  public static int endRelatedDocument_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishRelatedDocument_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "RELA"); }
  public static void finishSizePrefixedRelatedDocument_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "RELA"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public RelatedDocument_Full get(int j) { return get(new RelatedDocument_Full(), j); }
    public RelatedDocument_Full get(RelatedDocument_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
