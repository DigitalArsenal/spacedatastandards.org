...
public final class RadarObservation_Full extends Table {
  ...
  public static RadarObservation_Full getRootAsRadarObservation_Full(ByteBuffer _bb, RadarObservation_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean RadarObservation_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "RADA"); }
   ...
   */
  public byte senReferenceFrame() { int o = __offset(116); return o != 0 ? bb.get(o + bb_pos) : 0; }
  /**
   ...
   * Constraints: Minimum length = 1, Maximum length = 32
   */
  public String origNetwork() { int o = __offset(120); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer origNetworkAsByteBuffer() { return __vector_as_bytebuffer(120, 1); }
  public ByteBuffer origNetworkInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 120, 1); }
  /**
   * The source data library from which this record was received. This could be a remote or tactical UDL or another data library. If null, the record should be assumed to have originated from the primary Enterprise UDL.
   * Example: /// Example: AXE
   * Constraints: Minimum length = 0, Maximum length = 64
   */
  public String sourceDl() { int o = __offset(122); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer sourceDlAsByteBuffer() { return __vector_as_bytebuffer(122, 1); }
  public ByteBuffer sourceDlInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 122, 1); }
  /**
   * Read only enumeration specifying the type of observation (e.g. OPTICAL, RADAR, RF, etc).
   * Example: /// Example: RADAR
   * Constraints: No constraints specified.
   */
  public String type() { int o = __offset(124); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer typeAsByteBuffer() { return __vector_as_bytebuffer(124, 1); }
  public ByteBuffer typeInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 124, 1); }

  public static int createRadarObservation_Full(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static void addSenReferenceFrame(FlatBufferBuilder builder, byte senReferenceFrame) { builder.addByte(56, senReferenceFrame, 0); }
  public static void addDescriptor(FlatBufferBuilder builder, int descriptorOffset) { builder.addOffset(57, descriptorOffset, 0); }
  public static void addOrigNetwork(FlatBufferBuilder builder, int origNetworkOffset) { builder.addOffset(58, origNetworkOffset, 0); }
  public static void addSourceDl(FlatBufferBuilder builder, int sourceDlOffset) { builder.addOffset(59, sourceDlOffset, 0); }
  public static void addType(FlatBufferBuilder builder, int typeOffset) { builder.addOffset(60, typeOffset, 0); }
  public static int endRadarObservation_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishRadarObservation_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "RADA"); }
  public static void finishSizePrefixedRadarObservation_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "RADA"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public RadarObservation_Full get(int j) { return get(new RadarObservation_Full(), j); }
    public RadarObservation_Full get(RadarObservation_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
