...
public final class RFEmitter_Abridged extends Table {
  ...
  public static RFEmitter_Abridged getRootAsRFEmitter_Abridged(ByteBuffer _bb, RFEmitter_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean RFEmitter_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "RFEM"); }
  ...
  public static int createRFEmitter_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endRFEmitter_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishRFEmitter_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "RFEM"); }
  public static void finishSizePrefixedRFEmitter_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "RFEM"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public RFEmitter_Abridged get(int j) { return get(new RFEmitter_Abridged(), j); }
    public RFEmitter_Abridged get(RFEmitter_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
