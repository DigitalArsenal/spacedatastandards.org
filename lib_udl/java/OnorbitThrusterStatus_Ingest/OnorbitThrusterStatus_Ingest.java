...
public final class OnorbitThrusterStatus_Ingest extends Table {
  ...
  public static OnorbitThrusterStatus_Ingest getRootAsOnorbitThrusterStatus_Ingest(ByteBuffer _bb, OnorbitThrusterStatus_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean OnorbitThrusterStatus_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "ONOR"); }
  ...
  public static int createOnorbitThrusterStatus_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endOnorbitThrusterStatus_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishOnorbitThrusterStatus_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "ONOR"); }
  public static void finishSizePrefixedOnorbitThrusterStatus_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "ONOR"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public OnorbitThrusterStatus_Ingest get(int j) { return get(new OnorbitThrusterStatus_Ingest(), j); }
    public OnorbitThrusterStatus_Ingest get(OnorbitThrusterStatus_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
