...
public final class IonoObservationDensityProfileQuasiParabolic_Ingest extends Table {
  ...
  public static IonoObservationDensityProfileQuasiParabolic_Ingest getRootAsIonoObservationDensityProfileQuasiParabolic_Ingest(ByteBuffer _bb, IonoObservationDensityProfileQuasiParabolic_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean IonoObservationDensityProfileQuasiParabolic_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "IONO"); }
  ...
  public static int createIonoObservationDensityProfileQuasiParabolic_Ingest(FlatBufferBuilder builder,
  ...
  public static int endIonoObservationDensityProfileQuasiParabolic_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishIonoObservationDensityProfileQuasiParabolic_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "IONO"); }
  public static void finishSizePrefixedIonoObservationDensityProfileQuasiParabolic_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "IONO"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public IonoObservationDensityProfileQuasiParabolic_Ingest get(int j) { return get(new IonoObservationDensityProfileQuasiParabolic_Ingest(), j); }
    public IonoObservationDensityProfileQuasiParabolic_Ingest get(IonoObservationDensityProfileQuasiParabolic_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
