...
public final class GNSSObservation_Ingest extends Table {
  ...
  public static GNSSObservation_Ingest getRootAsGNSSObservation_Ingest(ByteBuffer _bb, GNSSObservation_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean GNSSObservation_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "GNSS"); }
  ...
  public static int createGNSSObservation_Ingest(FlatBufferBuilder builder,
      int gnssSatIdOffset,
      int trackingStatus,
      int agcState,
  ...
  public static int endGNSSObservation_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishGNSSObservation_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "GNSS"); }
  public static void finishSizePrefixedGNSSObservation_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "GNSS"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public GNSSObservation_Ingest get(int j) { return get(new GNSSObservation_Ingest(), j); }
    public GNSSObservation_Ingest get(GNSSObservation_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
