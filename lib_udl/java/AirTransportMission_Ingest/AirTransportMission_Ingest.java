...
public final class AirTransportMission_Ingest extends Table {
  ...
  public static AirTransportMission_Ingest getRootAsAirTransportMission_Ingest(ByteBuffer _bb, AirTransportMission_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean AirTransportMission_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "AIRT"); }
  ...
  public static int createAirTransportMission_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endAirTransportMission_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAirTransportMission_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "AIRT"); }
  public static void finishSizePrefixedAirTransportMission_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "AIRT"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public AirTransportMission_Ingest get(int j) { return get(new AirTransportMission_Ingest(), j); }
    public AirTransportMission_Ingest get(AirTransportMission_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
