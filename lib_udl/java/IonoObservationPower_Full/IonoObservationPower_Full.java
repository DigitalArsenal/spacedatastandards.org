...
public final class IonoObservationPower_Full extends Table {
  ...
  public static IonoObservationPower_Full getRootAsIonoObservationPower_Full(ByteBuffer _bb, IonoObservationPower_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean IonoObservationPower_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "IONO"); }
  ...
  public static int createIonoObservationPower_Full(FlatBufferBuilder builder,
      int notesOffset,
  ...
  public static int endIonoObservationPower_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishIonoObservationPower_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "IONO"); }
  public static void finishSizePrefixedIonoObservationPower_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "IONO"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public IonoObservationPower_Full get(int j) { return get(new IonoObservationPower_Full(), j); }
    public IonoObservationPower_Full get(IonoObservationPower_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
