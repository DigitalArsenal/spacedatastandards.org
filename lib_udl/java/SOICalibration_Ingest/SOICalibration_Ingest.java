...
public final class SOICalibration_Ingest extends Table {
  ...
  public static SOICalibration_Ingest getRootAsSOICalibration_Ingest(ByteBuffer _bb, SOICalibration_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean SOICalibration_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "SOIC"); }
  ...
  public static int createSOICalibration_Ingest(FlatBufferBuilder builder,
  ...
  public static int endSOICalibration_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishSOICalibration_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "SOIC"); }
  public static void finishSizePrefixedSOICalibration_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "SOIC"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public SOICalibration_Ingest get(int j) { return get(new SOICalibration_Ingest(), j); }
    public SOICalibration_Ingest get(SOICalibration_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
