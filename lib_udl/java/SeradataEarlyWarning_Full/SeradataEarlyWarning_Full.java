...
public final class SeradataEarlyWarning_Full extends Table {
  ...
  public static SeradataEarlyWarning_Full getRootAsSeradataEarlyWarning_Full(ByteBuffer _bb, SeradataEarlyWarning_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean SeradataEarlyWarning_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "SERA"); }
  ...
  public static int createSeradataEarlyWarning_Full(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endSeradataEarlyWarning_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishSeradataEarlyWarning_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "SERA"); }
  public static void finishSizePrefixedSeradataEarlyWarning_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "SERA"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public SeradataEarlyWarning_Full get(int j) { return get(new SeradataEarlyWarning_Full(), j); }
    public SeradataEarlyWarning_Full get(SeradataEarlyWarning_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
