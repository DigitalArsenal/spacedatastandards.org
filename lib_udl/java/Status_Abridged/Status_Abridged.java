...
public final class Status_Abridged extends Table {
  ...
  public static Status_Abridged getRootAsStatus_Abridged(ByteBuffer _bb, Status_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Status_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "STAT"); }
  ...
  public static int createStatus_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endStatus_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishStatus_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "STAT"); }
  public static void finishSizePrefixedStatus_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "STAT"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Status_Abridged get(int j) { return get(new Status_Abridged(), j); }
    public Status_Abridged get(Status_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
