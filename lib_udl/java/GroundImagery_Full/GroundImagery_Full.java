...
public final class GroundImagery_Full extends Table {
  ...
  public static GroundImagery_Full getRootAsGroundImagery_Full(ByteBuffer _bb, GroundImagery_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean GroundImagery_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "GROU"); }
   ...
   * Constraints: No constraints specified.
   */
  public String updatedAt() { int o = __offset(46); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer updatedAtAsByteBuffer() { return __vector_as_bytebuffer(46, 1); }
  public ByteBuffer updatedAtInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 46, 1); }
  /**
   ...
   * Constraints: Minimum length = 1, Maximum length = 64
   */
  public String updatedBy() { int o = __offset(48); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer updatedByAsByteBuffer() { return __vector_as_bytebuffer(48, 1); }
  public ByteBuffer updatedByInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 48, 1); }
  /**
   * Optional identifier to track a commercial or marketplace transaction executed to produce this data.
   * Example: /// Example: 37bdef1f-5a4f-4776-bee4-7a1e0ec7d35a
   * Constraints: Minimum length = 0, Maximum length = 64
   */
  public String transactionId() { int o = __offset(50); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer transactionIdAsByteBuffer() { return __vector_as_bytebuffer(50, 1); }
  public ByteBuffer transactionIdInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 50, 1); }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public String keywords(int j) { int o = __offset(54); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int keywordsLength() { int o = __offset(54); return o != 0 ? __vector_len(o) : 0; }
  public StringVector keywordsVector() { return keywordsVector(new StringVector()); }
  public StringVector keywordsVector(StringVector obj) { int o = __offset(54); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   * Description and notes of the image.
   * Example: /// Example: Example notes
   * Constraints: Minimum length = 0, Maximum length = 1024
   */
  public String notes() { int o = __offset(56); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer notesAsByteBuffer() { return __vector_as_bytebuffer(56, 1); }
  public ByteBuffer notesInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 56, 1); }
  /**
   * Optional, field indicating type of image, NITF, PNG, etc.
   * Example: /// Example: PNG
   * Constraints: Minimum length = 1, Maximum length = 16
   */
  public String format() { int o = __offset(58); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer formatAsByteBuffer() { return __vector_as_bytebuffer(58, 1); }
  public ByteBuffer formatInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 58, 1); }
  /**
   * Size of the image file. Units in bytes. If filesize is provided without an associated file, it defaults to 0.
   * Example: /// Example: 0
   * Constraints: No constraints specified.
   */
  public long filesize() { int o = __offset(60); return o != 0 ? bb.getLong(o + bb_pos) : 0L; }
  /**
   ...
   */
  public String checksumValue() { int o = __offset(62); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer checksumValueAsByteBuffer() { return __vector_as_bytebuffer(62, 1); }
  public ByteBuffer checksumValueInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 62, 1); }

  public static int createGroundImagery_Full(FlatBufferBuilder builder,
      int idOffset,
      int idSensorOffset,
  ...
  public static void addUpdatedAt(FlatBufferBuilder builder, int updatedAtOffset) { builder.addOffset(21, updatedAtOffset, 0); }
  public static void addUpdatedBy(FlatBufferBuilder builder, int updatedByOffset) { builder.addOffset(22, updatedByOffset, 0); }
  public static void addTransactionId(FlatBufferBuilder builder, int transactionIdOffset) { builder.addOffset(23, transactionIdOffset, 0); }
  ...
  public static void addKeywords(FlatBufferBuilder builder, int keywordsOffset) { builder.addOffset(25, keywordsOffset, 0); }
  ...
  public static void addNotes(FlatBufferBuilder builder, int notesOffset) { builder.addOffset(26, notesOffset, 0); }
  public static void addFormat(FlatBufferBuilder builder, int formatOffset) { builder.addOffset(27, formatOffset, 0); }
  public static void addFilesize(FlatBufferBuilder builder, long filesize) { builder.addLong(28, filesize, 0L); }
  public static void addChecksumValue(FlatBufferBuilder builder, int checksumValueOffset) { builder.addOffset(29, checksumValueOffset, 0); }
  public static int endGroundImagery_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishGroundImagery_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "GROU"); }
  public static void finishSizePrefixedGroundImagery_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "GROU"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public GroundImagery_Full get(int j) { return get(new GroundImagery_Full(), j); }
    public GroundImagery_Full get(GroundImagery_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
