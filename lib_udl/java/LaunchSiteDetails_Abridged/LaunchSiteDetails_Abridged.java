...
public final class LaunchSiteDetails_Abridged extends Table {
  ...
  public static LaunchSiteDetails_Abridged getRootAsLaunchSiteDetails_Abridged(ByteBuffer _bb, LaunchSiteDetails_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean LaunchSiteDetails_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "LAUN"); }
  ...
  public static int createLaunchSiteDetails_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endLaunchSiteDetails_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishLaunchSiteDetails_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "LAUN"); }
  public static void finishSizePrefixedLaunchSiteDetails_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "LAUN"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public LaunchSiteDetails_Abridged get(int j) { return get(new LaunchSiteDetails_Abridged(), j); }
    public LaunchSiteDetails_Abridged get(LaunchSiteDetails_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
