...
public final class AirspaceTimePeriod_Full extends Table {
  ...
  public static AirspaceTimePeriod_Full getRootAsAirspaceTimePeriod_Full(ByteBuffer _bb, AirspaceTimePeriod_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean AirspaceTimePeriod_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "AIRS"); }
  ...
  public static int createAirspaceTimePeriod_Full(FlatBufferBuilder builder,
      int timeModeOffset,
      int timeStartOffset,
      int timeEndOffset,
      int intFreqOffset,
  ...
  public static int endAirspaceTimePeriod_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAirspaceTimePeriod_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "AIRS"); }
  public static void finishSizePrefixedAirspaceTimePeriod_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "AIRS"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public AirspaceTimePeriod_Full get(int j) { return get(new AirspaceTimePeriod_Full(), j); }
    public AirspaceTimePeriod_Full get(AirspaceTimePeriod_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
