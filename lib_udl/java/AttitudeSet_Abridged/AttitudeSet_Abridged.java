...
public final class AttitudeSet_Abridged extends Table {
  ...
  public static AttitudeSet_Abridged getRootAsAttitudeSet_Abridged(ByteBuffer _bb, AttitudeSet_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean AttitudeSet_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "ATTI"); }
   ...
   * Constraints: No constraints specified.
   */
  public String startTime() { int o = __offset(22); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer startTimeAsByteBuffer() { return __vector_as_bytebuffer(22, 1); }
  public ByteBuffer startTimeInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 22, 1); }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public String endTime() { int o = __offset(24); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer endTimeAsByteBuffer() { return __vector_as_bytebuffer(24, 1); }
  public ByteBuffer endTimeInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 24, 1); }
  /**
   ...
   * Constraints: Minimum length = 1, Maximum length = 36
   */
  public String frame1() { int o = __offset(26); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer frame1AsByteBuffer() { return __vector_as_bytebuffer(26, 1); }
  public ByteBuffer frame1InByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 26, 1); }
  /**
   * Reference frame 2 of the quaternion or Euler angle transformation utilized in this attitude parameter or attitude ephemeris.  The UDL convention is that transformations occur FROM frame1 TO frame2.  A specific spacecraft frame or instrument name may be provided with the assumption the consumer understands the location of these frames (ex. SC BODY, J2000, LVLH, ICRF, INSTRUMENTx, THRUSTERx, etc.).
   * Example: /// Example: J2000
   * Constraints: Minimum length = 1, Maximum length = 36
   */
  public String frame2() { int o = __offset(28); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer frame2AsByteBuffer() { return __vector_as_bytebuffer(28, 1); }
  public ByteBuffer frame2InByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 28, 1); }
  /**
   * Number of attitude records contained in this set.
   * Example: /// Example: 120
   * Constraints: No constraints specified.
   */
  public int numPoints() { int o = __offset(30); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  /**
   * Attitude ephemeris step size, in seconds. This applies to Attitude Ephemeris Messages (AEM) that employ a fixed step size.
   * Example: /// Example: 60
   * Constraints: No constraints specified.
   */
  public int stepSize() { int o = __offset(32); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  /**
   * Initial precession angle (ECI J2000 frame) in degrees.
   * Example: /// Example: 30.5
   * Constraints: No constraints specified.
   */
  public double precAngleInit() { int o = __offset(34); return o != 0 ? bb.getDouble(o + bb_pos) : 0.0; }
  /**
   * Initial spin angle (ECI J2000 frame) in degrees.
   * Example: /// Example: 25.5
   * Constraints: No constraints specified.
   */
  public double spinAngleInit() { int o = __offset(36); return o != 0 ? bb.getDouble(o + bb_pos) : 0.0; }
  /**
   ...
   */
  public String eulerRotSeq() { int o = __offset(38); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer eulerRotSeqAsByteBuffer() { return __vector_as_bytebuffer(38, 1); }
  public ByteBuffer eulerRotSeqInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 38, 1); }
  /**
   * Recommended interpolation method for estimating attitude ephemeris data.
   * Example: /// Example: LINEAR
   * Constraints: Minimum length = 0, Maximum length = 16
   */
  public String interpolator() { int o = __offset(40); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer interpolatorAsByteBuffer() { return __vector_as_bytebuffer(40, 1); }
  public ByteBuffer interpolatorInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 40, 1); }
  /**
   * Recommended polynomial interpolation degree.
   * Example: /// Example: 2
   * Constraints: No constraints specified.
   */
  public int interpolatorDegree() { int o = __offset(42); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  /**
  ...
  public static int createAttitudeSet_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static void addStartTime(FlatBufferBuilder builder, int startTimeOffset) { builder.addOffset(9, startTimeOffset, 0); }
  public static void addEndTime(FlatBufferBuilder builder, int endTimeOffset) { builder.addOffset(10, endTimeOffset, 0); }
  public static void addFrame1(FlatBufferBuilder builder, int frame1Offset) { builder.addOffset(11, frame1Offset, 0); }
  public static void addFrame2(FlatBufferBuilder builder, int frame2Offset) { builder.addOffset(12, frame2Offset, 0); }
  ...
  public static void addEulerRotSeq(FlatBufferBuilder builder, int eulerRotSeqOffset) { builder.addOffset(17, eulerRotSeqOffset, 0); }
  public static void addInterpolator(FlatBufferBuilder builder, int interpolatorOffset) { builder.addOffset(18, interpolatorOffset, 0); }
  ...
  public static int endAttitudeSet_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAttitudeSet_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "ATTI"); }
  public static void finishSizePrefixedAttitudeSet_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "ATTI"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public AttitudeSet_Abridged get(int j) { return get(new AttitudeSet_Abridged(), j); }
    public AttitudeSet_Abridged get(AttitudeSet_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
