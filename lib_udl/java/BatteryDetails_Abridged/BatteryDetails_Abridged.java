...
public final class BatteryDetails_Abridged extends Table {
  ...
  public static BatteryDetails_Abridged getRootAsBatteryDetails_Abridged(ByteBuffer _bb, BatteryDetails_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean BatteryDetails_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "BATT"); }
  ...
  public static int createBatteryDetails_Abridged(FlatBufferBuilder builder,
      int idOffset,
      int idBatteryOffset,
  ...
  public static int endBatteryDetails_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishBatteryDetails_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "BATT"); }
  public static void finishSizePrefixedBatteryDetails_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "BATT"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public BatteryDetails_Abridged get(int j) { return get(new BatteryDetails_Abridged(), j); }
    public BatteryDetails_Abridged get(BatteryDetails_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
