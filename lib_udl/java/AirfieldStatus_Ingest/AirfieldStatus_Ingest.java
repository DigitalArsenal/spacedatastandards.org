...
public final class AirfieldStatus_Ingest extends Table {
  ...
  public static AirfieldStatus_Ingest getRootAsAirfieldStatus_Ingest(ByteBuffer _bb, AirfieldStatus_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean AirfieldStatus_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "AIRF"); }
  ...
  public static int createAirfieldStatus_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endAirfieldStatus_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAirfieldStatus_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "AIRF"); }
  public static void finishSizePrefixedAirfieldStatus_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "AIRF"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public AirfieldStatus_Ingest get(int j) { return get(new AirfieldStatus_Ingest(), j); }
    public AirfieldStatus_Ingest get(AirfieldStatus_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
