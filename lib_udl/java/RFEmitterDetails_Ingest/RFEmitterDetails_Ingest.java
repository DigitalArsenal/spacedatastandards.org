...
public final class RFEmitterDetails_Ingest extends Table {
  ...
  public static RFEmitterDetails_Ingest getRootAsRFEmitterDetails_Ingest(ByteBuffer _bb, RFEmitterDetails_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean RFEmitterDetails_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "RFEM"); }
  ...
  public static int createRFEmitterDetails_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endRFEmitterDetails_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishRFEmitterDetails_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "RFEM"); }
  public static void finishSizePrefixedRFEmitterDetails_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "RFEM"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public RFEmitterDetails_Ingest get(int j) { return get(new RFEmitterDetails_Ingest(), j); }
    public RFEmitterDetails_Ingest get(RFEmitterDetails_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
