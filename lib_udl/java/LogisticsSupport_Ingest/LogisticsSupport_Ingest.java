...
public final class LogisticsSupport_Ingest extends Table {
  ...
  public static LogisticsSupport_Ingest getRootAsLogisticsSupport_Ingest(ByteBuffer _bb, LogisticsSupport_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean LogisticsSupport_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "LOGI"); }
  ...
  public static int createLogisticsSupport_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endLogisticsSupport_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishLogisticsSupport_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "LOGI"); }
  public static void finishSizePrefixedLogisticsSupport_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "LOGI"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public LogisticsSupport_Ingest get(int j) { return get(new LogisticsSupport_Ingest(), j); }
    public LogisticsSupport_Ingest get(LogisticsSupport_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
