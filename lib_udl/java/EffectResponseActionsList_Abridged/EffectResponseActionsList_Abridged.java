...
public final class EffectResponseActionsList_Abridged extends Table {
  ...
  public static EffectResponseActionsList_Abridged getRootAsEffectResponseActionsList_Abridged(ByteBuffer _bb, EffectResponseActionsList_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean EffectResponseActionsList_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "EFFE"); }
  ...
  public static int createEffectResponseActionsList_Abridged(FlatBufferBuilder builder,
      int summaryOffset,
      int actionIdOffset,
  ...
  public static int endEffectResponseActionsList_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishEffectResponseActionsList_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "EFFE"); }
  public static void finishSizePrefixedEffectResponseActionsList_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "EFFE"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public EffectResponseActionsList_Abridged get(int j) { return get(new EffectResponseActionsList_Abridged(), j); }
    public EffectResponseActionsList_Abridged get(EffectResponseActionsList_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
