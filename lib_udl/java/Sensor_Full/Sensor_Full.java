...
public final class Sensor_Full extends Table {
  ...
  public static Sensor_Full getRootAsSensor_Full(ByteBuffer _bb, Sensor_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Sensor_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "SENS"); }
   ...
   * Constraints: No constraints specified.
   */
  public String updatedAt() { int o = __offset(32); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer updatedAtAsByteBuffer() { return __vector_as_bytebuffer(32, 1); }
  public ByteBuffer updatedAtInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 32, 1); }
  /**
   * Application user who updated the row in the database, auto-populated by the system.
   * Example: /// Example: some.user
   * Constraints: Minimum length = 0, Maximum length = 64
   */
  public String updatedBy() { int o = __offset(34); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer updatedByAsByteBuffer() { return __vector_as_bytebuffer(34, 1); }
  public ByteBuffer updatedByInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 34, 1); }
  /**
   * Optional flag indicating if the sensor is active.
   * Example: /// Example: True
   * Constraints: No constraints specified.
   */
  public boolean active() { int o = __offset(36); return o != 0 ? 0!=bb.get(o + bb_pos) : false; }
  /**
   * Collection of Sensorcharacteristics which define characteristics and capabilities of a sensor.
   * Example: /// Example: No example provided.
   * Constraints: No constraints specified.
   */
  public String sensorcharacteristics(int j) { int o = __offset(38); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int sensorcharacteristicsLength() { int o = __offset(38); return o != 0 ? __vector_len(o) : 0; }
  public StringVector sensorcharacteristicsVector() { return sensorcharacteristicsVector(new StringVector()); }
  public StringVector sensorcharacteristicsVector(StringVector obj) { int o = __offset(38); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   * Collection of SensorStats which contain statistics of a sensor.
   * Example: /// Example: No example provided.
   * Constraints: No constraints specified.
   */
  public String sensorStats(int j) { int o = __offset(40); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int sensorStatsLength() { int o = __offset(40); return o != 0 ? __vector_len(o) : 0; }
  public StringVector sensorStatsVector() { return sensorStatsVector(new StringVector()); }
  public StringVector sensorStatsVector(StringVector obj) { int o = __offset(40); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   * Sensorlimits define 0 to many limits of a particular sensor in terms of observation coverage of on-orbit objects.
   * Example: /// Example: No example provided.
   * Constraints: No constraints specified.
   */
  public String sensorlimitsCollection(int j) { int o = __offset(42); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int sensorlimitsCollectionLength() { int o = __offset(42); return o != 0 ? __vector_len(o) : 0; }
  public StringVector sensorlimitsCollectionVector() { return sensorlimitsCollectionVector(new StringVector()); }
  public StringVector sensorlimitsCollectionVector(StringVector obj) { int o = __offset(42); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   * No description provided.
   * Example: /// Example: No example provided.
   * Constraints: No constraints specified.
   */
  public String entity() { int o = __offset(44); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer entityAsByteBuffer() { return __vector_as_bytebuffer(44, 1); }
  public ByteBuffer entityInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 44, 1); }
  /**
   * Unique identifier of the parent entity. idEntity is required for Put.
   * Example: /// Example: ENTITY-ID
   * Constraints: Minimum length = 0, Maximum length = 36
   */
  public String idEntity() { int o = __offset(46); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer idEntityAsByteBuffer() { return __vector_as_bytebuffer(46, 1); }
  public ByteBuffer idEntityInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 46, 1); }
  /**
   * No description provided.
   * Example: /// Example: No example provided.
   * Constraints: No constraints specified.
   */
  public String sensorObservationType() { int o = __offset(48); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer sensorObservationTypeAsByteBuffer() { return __vector_as_bytebuffer(48, 1); }
  public ByteBuffer sensorObservationTypeInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 48, 1); }
  /**
   * No description provided.
   * Example: /// Example: No example provided.
   * Constraints: No constraints specified.
   */
  public String sensorType() { int o = __offset(50); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer sensorTypeAsByteBuffer() { return __vector_as_bytebuffer(50, 1); }
  public ByteBuffer sensorTypeInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 50, 1); }

  public static int createSensor_Full(FlatBufferBuilder builder,
      int idSensorOffset,
  ...
  public static void addUpdatedAt(FlatBufferBuilder builder, int updatedAtOffset) { builder.addOffset(14, updatedAtOffset, 0); }
  public static void addUpdatedBy(FlatBufferBuilder builder, int updatedByOffset) { builder.addOffset(15, updatedByOffset, 0); }
  public static void addActive(FlatBufferBuilder builder, boolean active) { builder.addBoolean(16, active, false); }
  public static void addSensorcharacteristics(FlatBufferBuilder builder, int sensorcharacteristicsOffset) { builder.addOffset(17, sensorcharacteristicsOffset, 0); }
  ...
  public static void addSensorStats(FlatBufferBuilder builder, int sensorStatsOffset) { builder.addOffset(18, sensorStatsOffset, 0); }
  ...
  public static void addSensorlimitsCollection(FlatBufferBuilder builder, int sensorlimitsCollectionOffset) { builder.addOffset(19, sensorlimitsCollectionOffset, 0); }
  ...
  public static void addEntity(FlatBufferBuilder builder, int entityOffset) { builder.addOffset(20, entityOffset, 0); }
  public static void addIdEntity(FlatBufferBuilder builder, int idEntityOffset) { builder.addOffset(21, idEntityOffset, 0); }
  public static void addSensorObservationType(FlatBufferBuilder builder, int sensorObservationTypeOffset) { builder.addOffset(22, sensorObservationTypeOffset, 0); }
  public static void addSensorType(FlatBufferBuilder builder, int sensorTypeOffset) { builder.addOffset(23, sensorTypeOffset, 0); }
  public static int endSensor_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishSensor_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "SENS"); }
  public static void finishSizePrefixedSensor_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "SENS"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Sensor_Full get(int j) { return get(new Sensor_Full(), j); }
    public Sensor_Full get(Sensor_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
