...
public final class StateVector_Ingest extends Table {
  ...
  public static StateVector_Ingest getRootAsStateVector_Ingest(ByteBuffer _bb, StateVector_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean StateVector_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "STAT"); }
   ...
   */
  public String rawFileUri() { int o = __offset(168); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer rawFileUriAsByteBuffer() { return __vector_as_bytebuffer(168, 1); }
  public ByteBuffer rawFileUriInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 168, 1); }
  /**
   * Source of the data.
   ...
   * Constraints: No constraints specified.
   */
  public String tags(int j) { int o = __offset(176); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int tagsLength() { int o = __offset(176); return o != 0 ? __vector_len(o) : 0; }
  public StringVector tagsVector() { return tagsVector(new StringVector()); }
  public StringVector tagsVector(StringVector obj) { int o = __offset(176); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   * Optional algorithm used to produce this record.
   * Example: /// Example: SAMPLE_ALGORITHM
   * Constraints: Minimum length = 0, Maximum length = 64
   */
  public String algorithm() { int o = __offset(178); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer algorithmAsByteBuffer() { return __vector_as_bytebuffer(178, 1); }
  public ByteBuffer algorithmInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 178, 1); }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public String sourcedData(int j) { int o = __offset(180); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int sourcedDataLength() { int o = __offset(180); return o != 0 ? __vector_len(o) : 0; }
  public StringVector sourcedDataVector() { return sourcedDataVector(new StringVector()); }
  public StringVector sourcedDataVector(StringVector obj) { int o = __offset(180); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public byte sourcedDataTypes() { int o = __offset(182); return o != 0 ? bb.get(o + bb_pos) : 0; }
  /**
   ...
   * Constraints: Minimum length = 0, Maximum length = 64
   */
  public String descriptor() { int o = __offset(188); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer descriptorAsByteBuffer() { return __vector_as_bytebuffer(188, 1); }
  public ByteBuffer descriptorInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 188, 1); }
  /**
   ...
   * Constraints: Minimum length = 0, Maximum length = 64
   */
  public String sourceDl() { int o = __offset(194); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer sourceDlAsByteBuffer() { return __vector_as_bytebuffer(194, 1); }
  public ByteBuffer sourceDlInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 194, 1); }

  public static int createStateVector_Ingest(FlatBufferBuilder builder,
  ...
  public static void addRawFileUri(FlatBufferBuilder builder, int rawFileUriOffset) { builder.addOffset(82, rawFileUriOffset, 0); }
  ...
  public static void addTags(FlatBufferBuilder builder, int tagsOffset) { builder.addOffset(86, tagsOffset, 0); }
  ...
  public static void addAlgorithm(FlatBufferBuilder builder, int algorithmOffset) { builder.addOffset(87, algorithmOffset, 0); }
  public static void addSourcedData(FlatBufferBuilder builder, int sourcedDataOffset) { builder.addOffset(88, sourcedDataOffset, 0); }
  ...
  public static void addSourcedDataTypes(FlatBufferBuilder builder, byte sourcedDataTypes) { builder.addByte(89, sourcedDataTypes, 0); }
  ...
  public static void addDescriptor(FlatBufferBuilder builder, int descriptorOffset) { builder.addOffset(92, descriptorOffset, 0); }
  ...
  public static void addSourceDl(FlatBufferBuilder builder, int sourceDlOffset) { builder.addOffset(95, sourceDlOffset, 0); }
  public static int endStateVector_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishStateVector_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "STAT"); }
  public static void finishSizePrefixedStateVector_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "STAT"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public StateVector_Ingest get(int j) { return get(new StateVector_Ingest(), j); }
    public StateVector_Ingest get(StateVector_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
