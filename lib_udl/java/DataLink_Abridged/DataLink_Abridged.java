...
public final class DataLink_Abridged extends Table {
  ...
  public static DataLink_Abridged getRootAsDataLink_Abridged(ByteBuffer _bb, DataLink_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean DataLink_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "DATA"); }
  ...
  public static int createDataLink_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endDataLink_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishDataLink_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "DATA"); }
  public static void finishSizePrefixedDataLink_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "DATA"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public DataLink_Abridged get(int j) { return get(new DataLink_Abridged(), j); }
    public DataLink_Abridged get(DataLink_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
