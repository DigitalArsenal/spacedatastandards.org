...
public final class StarCatalog_Full extends Table {
  ...
  public static StarCatalog_Full getRootAsStarCatalog_Full(ByteBuffer _bb, StarCatalog_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean StarCatalog_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "STAR"); }
  ...
  public static int createStarCatalog_Full(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endStarCatalog_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishStarCatalog_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "STAR"); }
  public static void finishSizePrefixedStarCatalog_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "STAR"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public StarCatalog_Full get(int j) { return get(new StarCatalog_Full(), j); }
    public StarCatalog_Full get(StarCatalog_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
