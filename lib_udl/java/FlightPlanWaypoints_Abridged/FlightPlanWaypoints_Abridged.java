...
public final class FlightPlanWaypoints_Abridged extends Table {
  ...
  public static FlightPlanWaypoints_Abridged getRootAsFlightPlanWaypoints_Abridged(ByteBuffer _bb, FlightPlanWaypoints_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean FlightPlanWaypoints_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "FLIG"); }
  ...
  public static int createFlightPlanWaypoints_Abridged(FlatBufferBuilder builder,
      int typeOffset,
  ...
  public static int endFlightPlanWaypoints_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishFlightPlanWaypoints_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "FLIG"); }
  public static void finishSizePrefixedFlightPlanWaypoints_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "FLIG"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public FlightPlanWaypoints_Abridged get(int j) { return get(new FlightPlanWaypoints_Abridged(), j); }
    public FlightPlanWaypoints_Abridged get(FlightPlanWaypoints_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
