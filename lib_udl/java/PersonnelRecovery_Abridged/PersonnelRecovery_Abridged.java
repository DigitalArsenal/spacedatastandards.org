...
public final class PersonnelRecovery_Abridged extends Table {
  ...
  public static PersonnelRecovery_Abridged getRootAsPersonnelRecovery_Abridged(ByteBuffer _bb, PersonnelRecovery_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean PersonnelRecovery_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "PERS"); }
  ...
  public static int createPersonnelRecovery_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endPersonnelRecovery_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishPersonnelRecovery_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "PERS"); }
  public static void finishSizePrefixedPersonnelRecovery_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "PERS"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public PersonnelRecovery_Abridged get(int j) { return get(new PersonnelRecovery_Abridged(), j); }
    public PersonnelRecovery_Abridged get(PersonnelRecovery_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
