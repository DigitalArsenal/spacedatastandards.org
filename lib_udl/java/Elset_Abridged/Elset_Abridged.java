...
public final class Elset_Abridged extends Table {
  ...
  public static Elset_Abridged getRootAsElset_Abridged(ByteBuffer _bb, Elset_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Elset_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "ELSE"); }
   ...
   * Constraints: Minimum length = 0, Maximum length = 64
   */
  public String algorithm() { int o = __offset(70); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer algorithmAsByteBuffer() { return __vector_as_bytebuffer(70, 1); }
  public ByteBuffer algorithmInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 70, 1); }
  /**
   * Optional identifier to track a commercial or marketplace transaction executed to produce this data.
   * Example: /// Example: TRANSACTION-ID
   * Constraints: Minimum length = 0, Maximum length = 64
   */
  public String transactionId() { int o = __offset(72); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer transactionIdAsByteBuffer() { return __vector_as_bytebuffer(72, 1); }
  public ByteBuffer transactionIdInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 72, 1); }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public int ephemType() { int o = __offset(74); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  /**
  ...
  public static int createElset_Abridged(FlatBufferBuilder builder,
      int idElsetOffset,
  ...
  public static void addAlgorithm(FlatBufferBuilder builder, int algorithmOffset) { builder.addOffset(33, algorithmOffset, 0); }
  public static void addTransactionId(FlatBufferBuilder builder, int transactionIdOffset) { builder.addOffset(34, transactionIdOffset, 0); }
  ...
  public static int endElset_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishElset_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "ELSE"); }
  public static void finishSizePrefixedElset_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "ELSE"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Elset_Abridged get(int j) { return get(new Elset_Abridged(), j); }
    public Elset_Abridged get(Elset_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
