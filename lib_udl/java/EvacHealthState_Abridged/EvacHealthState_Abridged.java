...
public final class EvacHealthState_Abridged extends Table {
  ...
  public static EvacHealthState_Abridged getRootAsEvacHealthState_Abridged(ByteBuffer _bb, EvacHealthState_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean EvacHealthState_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "EVAC"); }
  ...
  public static int createEvacHealthState_Abridged(FlatBufferBuilder builder,
      int typeOffset,
  ...
  public static int endEvacHealthState_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishEvacHealthState_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "EVAC"); }
  public static void finishSizePrefixedEvacHealthState_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "EVAC"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public EvacHealthState_Abridged get(int j) { return get(new EvacHealthState_Abridged(), j); }
    public EvacHealthState_Abridged get(EvacHealthState_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
