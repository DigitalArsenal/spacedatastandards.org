...
public final class BeamContour_Full extends Table {
  ...
  public static BeamContour_Full getRootAsBeamContour_Full(ByteBuffer _bb, BeamContour_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean BeamContour_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "BEAM"); }
  ...
  public static int createBeamContour_Full(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endBeamContour_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishBeamContour_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "BEAM"); }
  public static void finishSizePrefixedBeamContour_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "BEAM"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public BeamContour_Full get(int j) { return get(new BeamContour_Full(), j); }
    public BeamContour_Full get(BeamContour_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
