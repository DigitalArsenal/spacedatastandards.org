...
public final class IonoObservationAzimuth_Abridged extends Table {
  ...
  public static IonoObservationAzimuth_Abridged getRootAsIonoObservationAzimuth_Abridged(ByteBuffer _bb, IonoObservationAzimuth_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean IonoObservationAzimuth_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "IONO"); }
  ...
  public static int createIonoObservationAzimuth_Abridged(FlatBufferBuilder builder,
      int notesOffset,
  ...
  public static int endIonoObservationAzimuth_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishIonoObservationAzimuth_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "IONO"); }
  public static void finishSizePrefixedIonoObservationAzimuth_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "IONO"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public IonoObservationAzimuth_Abridged get(int j) { return get(new IonoObservationAzimuth_Abridged(), j); }
    public IonoObservationAzimuth_Abridged get(IonoObservationAzimuth_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
