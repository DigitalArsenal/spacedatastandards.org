...
public final class Crew_Full extends Table {
  public static void ValidateVersion() { Constants.FLATBUFFERS_24_3_25(); }
  public static Crew_Full getRootAsCrew_Full(ByteBuffer _bb) { return getRootAsCrew_Full(_bb, new Crew_Full()); }
  public static Crew_Full getRootAsCrew_Full(ByteBuffer _bb, Crew_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Crew_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "CREW"); }
  ...
  public static int createCrew_Full(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endCrew_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishCrew_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "CREW"); }
  public static void finishSizePrefixedCrew_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "CREW"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Crew_Full get(int j) { return get(new Crew_Full(), j); }
    public Crew_Full get(Crew_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
