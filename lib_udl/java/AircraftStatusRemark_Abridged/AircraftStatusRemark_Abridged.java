...
public final class AircraftStatusRemark_Abridged extends Table {
  ...
  public static AircraftStatusRemark_Abridged getRootAsAircraftStatusRemark_Abridged(ByteBuffer _bb, AircraftStatusRemark_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean AircraftStatusRemark_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "AIRC"); }
  ...
  public static int createAircraftStatusRemark_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endAircraftStatusRemark_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAircraftStatusRemark_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "AIRC"); }
  public static void finishSizePrefixedAircraftStatusRemark_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "AIRC"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public AircraftStatusRemark_Abridged get(int j) { return get(new AircraftStatusRemark_Abridged(), j); }
    public AircraftStatusRemark_Abridged get(AircraftStatusRemark_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
