...
public final class EvacInjury_Ingest extends Table {
  ...
  public static EvacInjury_Ingest getRootAsEvacInjury_Ingest(ByteBuffer _bb, EvacInjury_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean EvacInjury_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "EVAC"); }
  ...
  public static int createEvacInjury_Ingest(FlatBufferBuilder builder,
      int typeOffset,
      int bodyPartOffset,
      int timeOffset,
      int commentsOffset) {
  ...
  public static int endEvacInjury_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishEvacInjury_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "EVAC"); }
  public static void finishSizePrefixedEvacInjury_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "EVAC"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public EvacInjury_Ingest get(int j) { return get(new EvacInjury_Ingest(), j); }
    public EvacInjury_Ingest get(EvacInjury_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
