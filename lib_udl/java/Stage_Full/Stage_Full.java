...
public final class Stage_Full extends Table {
  public static void ValidateVersion() { Constants.FLATBUFFERS_24_3_25(); }
  public static Stage_Full getRootAsStage_Full(ByteBuffer _bb) { return getRootAsStage_Full(_bb, new Stage_Full()); }
  public static Stage_Full getRootAsStage_Full(ByteBuffer _bb, Stage_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Stage_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "STAG"); }
   ...
   * Constraints: No constraints specified.
   */
  public String engine() { int o = __offset(88); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer engineAsByteBuffer() { return __vector_as_bytebuffer(88, 1); }
  public ByteBuffer engineInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 88, 1); }

  public static int createStage_Full(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static void addEngine(FlatBufferBuilder builder, int engineOffset) { builder.addOffset(42, engineOffset, 0); }
  public static int endStage_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishStage_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "STAG"); }
  public static void finishSizePrefixedStage_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "STAG"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Stage_Full get(int j) { return get(new Stage_Full(), j); }
    public Stage_Full get(Stage_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
