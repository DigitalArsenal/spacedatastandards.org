...
public final class POI_Ingest extends Table {
  public static void ValidateVersion() { Constants.FLATBUFFERS_24_3_25(); }
  public static POI_Ingest getRootAsPOI_Ingest(ByteBuffer _bb) { return getRootAsPOI_Ingest(_bb, new POI_Ingest()); }
  public static POI_Ingest getRootAsPOI_Ingest(ByteBuffer _bb, POI_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean POI_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "POII"); }
  ...
  public static int createPOI_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endPOI_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishPOI_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "POII"); }
  public static void finishSizePrefixedPOI_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "POII"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public POI_Ingest get(int j) { return get(new POI_Ingest(), j); }
    public POI_Ingest get(POI_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
