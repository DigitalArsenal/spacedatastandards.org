...
public final class IonoObservationDensityProfileShiftedChebyshev_Full extends Table {
  ...
  public static IonoObservationDensityProfileShiftedChebyshev_Full getRootAsIonoObservationDensityProfileShiftedChebyshev_Full(ByteBuffer _bb, IonoObservationDensityProfileShiftedChebyshev_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean IonoObservationDensityProfileShiftedChebyshev_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "IONO"); }
  ...
  public static int createIonoObservationDensityProfileShiftedChebyshev_Full(FlatBufferBuilder builder,
  ...
  public static int endIonoObservationDensityProfileShiftedChebyshev_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishIonoObservationDensityProfileShiftedChebyshev_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "IONO"); }
  public static void finishSizePrefixedIonoObservationDensityProfileShiftedChebyshev_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "IONO"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public IonoObservationDensityProfileShiftedChebyshev_Full get(int j) { return get(new IonoObservationDensityProfileShiftedChebyshev_Full(), j); }
    public IonoObservationDensityProfileShiftedChebyshev_Full get(IonoObservationDensityProfileShiftedChebyshev_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
