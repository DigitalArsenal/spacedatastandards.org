...
public final class AirspaceControlOrderReference_Ingest extends Table {
  ...
  public static AirspaceControlOrderReference_Ingest getRootAsAirspaceControlOrderReference_Ingest(ByteBuffer _bb, AirspaceControlOrderReference_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean AirspaceControlOrderReference_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "AIRS"); }
  ...
  public static int createAirspaceControlOrderReference_Ingest(FlatBufferBuilder builder,
      int refSidOffset,
      int refTypeOffset,
  ...
  public static int endAirspaceControlOrderReference_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAirspaceControlOrderReference_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "AIRS"); }
  public static void finishSizePrefixedAirspaceControlOrderReference_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "AIRS"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public AirspaceControlOrderReference_Ingest get(int j) { return get(new AirspaceControlOrderReference_Ingest(), j); }
    public AirspaceControlOrderReference_Ingest get(AirspaceControlOrderReference_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
