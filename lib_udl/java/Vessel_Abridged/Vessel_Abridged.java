...
public final class Vessel_Abridged extends Table {
  ...
  public static Vessel_Abridged getRootAsVessel_Abridged(ByteBuffer _bb, Vessel_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Vessel_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "VESS"); }
   ...
   * Constraints: Minimum length = 0, Maximum length = 36
   */
  public String altVesselId() { int o = __offset(10); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer altVesselIdAsByteBuffer() { return __vector_as_bytebuffer(10, 1); }
  public ByteBuffer altVesselIdInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 10, 1); }
  /**
   * The UDL ID of the organization that owns the vessel.
   * Example: /// Example: 0147f777-w09a-835f-85aa-0a07a730fgg0
   * Constraints: Minimum length = 0, Maximum length = 36
   */
  public String idOrganization() { int o = __offset(12); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer idOrganizationAsByteBuffer() { return __vector_as_bytebuffer(12, 1); }
  public ByteBuffer idOrganizationInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 12, 1); }
  /**
   ...
   */
  public String vesselName() { int o = __offset(14); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer vesselNameAsByteBuffer() { return __vector_as_bytebuffer(14, 1); }
  public ByteBuffer vesselNameInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 14, 1); }
  /**
   * The reported ship type (e.g. Passenger, Tanker, Cargo, Other, etc.).
   * Example: /// Example: Passenger
   * Constraints: Minimum length = 0, Maximum length = 48
   */
  public String vesselType() { int o = __offset(16); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer vesselTypeAsByteBuffer() { return __vector_as_bytebuffer(16, 1); }
  public ByteBuffer vesselTypeInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 16, 1); }
  /**
   ...
   */
  public String vesselClass() { int o = __offset(18); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer vesselClassAsByteBuffer() { return __vector_as_bytebuffer(18, 1); }
  public ByteBuffer vesselClassInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 18, 1); }
  /**
   * Further description or explanation of the vessel or type.
   * Example: /// Example: Search and Rescue Vessel
   * Constraints: Minimum length = 0, Maximum length = 100
   */
  public String vesselDescription() { int o = __offset(20); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer vesselDescriptionAsByteBuffer() { return __vector_as_bytebuffer(20, 1); }
  public ByteBuffer vesselDescriptionInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 20, 1); }
  /**
   ...
   * Constraints: Minimum length = 0, Maximum length = 36
   */
  public String sconum() { int o = __offset(22); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer sconumAsByteBuffer() { return __vector_as_bytebuffer(22, 1); }
  public ByteBuffer sconumInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 22, 1); }
  /**
   ...
   */
  public int imon() { int o = __offset(24); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  /**
   ...
   */
  public String mmsi() { int o = __offset(26); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer mmsiAsByteBuffer() { return __vector_as_bytebuffer(26, 1); }
  public ByteBuffer mmsiInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 26, 1); }
  /**
   ...
   */
  public String yearBuilt() { int o = __offset(32); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer yearBuiltAsByteBuffer() { return __vector_as_bytebuffer(32, 1); }
  public ByteBuffer yearBuiltInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 32, 1); }
  /**
   * The shipbuilder who built this vessel.
   * Example: /// Example: Samsung Heavy Inds - Geoje
   * Constraints: Minimum length = 0, Maximum length = 64
   */
  public String vesselBuilder() { int o = __offset(34); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer vesselBuilderAsByteBuffer() { return __vector_as_bytebuffer(34, 1); }
  public ByteBuffer vesselBuilderInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 34, 1); }
  /**
   * The status of this vessel.
   * Example: /// Example: In Service/Commission
   * Constraints: Minimum length = 0, Maximum length = 64
   */
  public String status() { int o = __offset(36); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer statusAsByteBuffer() { return __vector_as_bytebuffer(36, 1); }
  public ByteBuffer statusInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 36, 1); }
  /**
   * The date this vessel was first seen.
   * Example: /// Example: 2018-01-01T16:00:00.123Z
   * Constraints: No constraints specified.
   */
  public String firstSeen() { int o = __offset(38); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer firstSeenAsByteBuffer() { return __vector_as_bytebuffer(38, 1); }
  public ByteBuffer firstSeenInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 38, 1); }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public double length() { int o = __offset(40); return o != 0 ? bb.getDouble(o + bb_pos) : 0.0; }
  /**
   * The breadth of the vessel, in meters. A value of 63 indicates a vessel breadth of 63 meters or greater.
   * Example: /// Example: 24.1
   * Constraints: No constraints specified.
   */
  public double width() { int o = __offset(42); return o != 0 ? bb.getDouble(o + bb_pos) : 0.0; }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public double maxDraught() { int o = __offset(44); return o != 0 ? bb.getDouble(o + bb_pos) : 0.0; }
  /**
   * The weight in tons, of this vessel.
   * Example: /// Example: 3423.76
   * Constraints: No constraints specified.
   */
  public double vslWt() { int o = __offset(46); return o != 0 ? bb.getDouble(o + bb_pos) : 0.0; }
  /**
   * The maximum possible speed of this vessel in meters per second.
   * Example: /// Example: 32.5
   * Constraints: No constraints specified.
   */
  public double maxSpeed() { int o = __offset(48); return o != 0 ? bb.getDouble(o + bb_pos) : 0.0; }
  /**
   * The stern type code (Counter, Cruiser) associated with this vessel.
   * Example: /// Example: Cruiser
   * Constraints: Minimum length = 0, Maximum length = 16
   */
  public String sternType() { int o = __offset(50); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer sternTypeAsByteBuffer() { return __vector_as_bytebuffer(50, 1); }
  public ByteBuffer sternTypeInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 50, 1); }
  /**
   * The number of blades per shaft for this vessel.
   * Example: /// Example: 4
   * Constraints: No constraints specified.
   */
  public int numBlades() { int o = __offset(52); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  /**
   * The number of shafts on this vessel.
   * Example: /// Example: 3
   * Constraints: No constraints specified.
   */
  public int numShafts() { int o = __offset(54); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  /**
   * The type of propulsion employed by this vessel.
   * Example: /// Example: Diesel
   * Constraints: Minimum length = 0, Maximum length = 6
   */
  public String propType() { int o = __offset(56); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer propTypeAsByteBuffer() { return __vector_as_bytebuffer(56, 1); }
  public ByteBuffer propTypeInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 56, 1); }
  /**
   ...
   */
  public String hullNum() { int o = __offset(58); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer hullNumAsByteBuffer() { return __vector_as_bytebuffer(58, 1); }
  public ByteBuffer hullNumInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 58, 1); }
  /**
  ...
  public static int createVessel_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static void addAltVesselId(FlatBufferBuilder builder, int altVesselIdOffset) { builder.addOffset(3, altVesselIdOffset, 0); }
  public static void addIdOrganization(FlatBufferBuilder builder, int idOrganizationOffset) { builder.addOffset(4, idOrganizationOffset, 0); }
  public static void addVesselName(FlatBufferBuilder builder, int vesselNameOffset) { builder.addOffset(5, vesselNameOffset, 0); }
  public static void addVesselType(FlatBufferBuilder builder, int vesselTypeOffset) { builder.addOffset(6, vesselTypeOffset, 0); }
  public static void addVesselClass(FlatBufferBuilder builder, int vesselClassOffset) { builder.addOffset(7, vesselClassOffset, 0); }
  public static void addVesselDescription(FlatBufferBuilder builder, int vesselDescriptionOffset) { builder.addOffset(8, vesselDescriptionOffset, 0); }
  public static void addSconum(FlatBufferBuilder builder, int sconumOffset) { builder.addOffset(9, sconumOffset, 0); }
  public static void addImon(FlatBufferBuilder builder, int imon) { builder.addInt(10, imon, 0); }
  public static void addMmsi(FlatBufferBuilder builder, int mmsiOffset) { builder.addOffset(11, mmsiOffset, 0); }
  ...
  public static void addYearBuilt(FlatBufferBuilder builder, int yearBuiltOffset) { builder.addOffset(14, yearBuiltOffset, 0); }
  public static void addVesselBuilder(FlatBufferBuilder builder, int vesselBuilderOffset) { builder.addOffset(15, vesselBuilderOffset, 0); }
  public static void addStatus(FlatBufferBuilder builder, int statusOffset) { builder.addOffset(16, statusOffset, 0); }
  public static void addFirstSeen(FlatBufferBuilder builder, int firstSeenOffset) { builder.addOffset(17, firstSeenOffset, 0); }
  ...
  public static void addSternType(FlatBufferBuilder builder, int sternTypeOffset) { builder.addOffset(23, sternTypeOffset, 0); }
  ...
  public static void addPropType(FlatBufferBuilder builder, int propTypeOffset) { builder.addOffset(26, propTypeOffset, 0); }
  public static void addHullNum(FlatBufferBuilder builder, int hullNumOffset) { builder.addOffset(27, hullNumOffset, 0); }
  ...
  public static int endVessel_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishVessel_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "VESS"); }
  public static void finishSizePrefixedVessel_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "VESS"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Vessel_Abridged get(int j) { return get(new Vessel_Abridged(), j); }
    public Vessel_Abridged get(Vessel_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
