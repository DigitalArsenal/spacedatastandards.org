...
public final class FlightPlanPointGroups_Abridged extends Table {
  ...
  public static FlightPlanPointGroups_Abridged getRootAsFlightPlanPointGroups_Abridged(ByteBuffer _bb, FlightPlanPointGroups_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean FlightPlanPointGroups_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "FLIG"); }
  ...
  public static int createFlightPlanPointGroups_Abridged(FlatBufferBuilder builder,
  ...
  public static int endFlightPlanPointGroups_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishFlightPlanPointGroups_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "FLIG"); }
  public static void finishSizePrefixedFlightPlanPointGroups_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "FLIG"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public FlightPlanPointGroups_Abridged get(int j) { return get(new FlightPlanPointGroups_Abridged(), j); }
    public FlightPlanPointGroups_Abridged get(FlightPlanPointGroups_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
