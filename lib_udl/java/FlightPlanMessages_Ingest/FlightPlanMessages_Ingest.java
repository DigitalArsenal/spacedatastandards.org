...
public final class FlightPlanMessages_Ingest extends Table {
  ...
  public static FlightPlanMessages_Ingest getRootAsFlightPlanMessages_Ingest(ByteBuffer _bb, FlightPlanMessages_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean FlightPlanMessages_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "FLIG"); }
  ...
  public static int createFlightPlanMessages_Ingest(FlatBufferBuilder builder,
      int severityOffset,
      int wpNumOffset,
      int routePathOffset,
      int msgTextOffset) {
  ...
  public static int endFlightPlanMessages_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishFlightPlanMessages_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "FLIG"); }
  public static void finishSizePrefixedFlightPlanMessages_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "FLIG"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public FlightPlanMessages_Ingest get(int j) { return get(new FlightPlanMessages_Ingest(), j); }
    public FlightPlanMessages_Ingest get(FlightPlanMessages_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
