...
public final class Evac_Ingest extends Table {
  ...
  public static Evac_Ingest getRootAsEvac_Ingest(ByteBuffer _bb, Evac_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Evac_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "EVAC"); }
  ...
  public static int createEvac_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endEvac_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishEvac_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "EVAC"); }
  public static void finishSizePrefixedEvac_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "EVAC"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Evac_Ingest get(int j) { return get(new Evac_Ingest(), j); }
    public Evac_Ingest get(Evac_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
