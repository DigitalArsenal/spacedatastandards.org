...
public final class AirTaskingOrder_Abridged extends Table {
  ...
  public static AirTaskingOrder_Abridged getRootAsAirTaskingOrder_Abridged(ByteBuffer _bb, AirTaskingOrder_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean AirTaskingOrder_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "AIRT"); }
  ...
  public static int createAirTaskingOrder_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endAirTaskingOrder_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAirTaskingOrder_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "AIRT"); }
  public static void finishSizePrefixedAirTaskingOrder_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "AIRT"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public AirTaskingOrder_Abridged get(int j) { return get(new AirTaskingOrder_Abridged(), j); }
    public AirTaskingOrder_Abridged get(AirTaskingOrder_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
