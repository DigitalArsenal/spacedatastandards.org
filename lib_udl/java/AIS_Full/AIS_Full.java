...
public final class AIS_Full extends Table {
  public static void ValidateVersion() { Constants.FLATBUFFERS_24_3_25(); }
  public static AIS_Full getRootAsAIS_Full(ByteBuffer _bb) { return getRootAsAIS_Full(_bb, new AIS_Full()); }
  public static AIS_Full getRootAsAIS_Full(ByteBuffer _bb, AIS_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean AIS_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "AISF"); }
  ...
  public static int createAIS_Full(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endAIS_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAIS_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "AISF"); }
  public static void finishSizePrefixedAIS_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "AISF"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public AIS_Full get(int j) { return get(new AIS_Full(), j); }
    public AIS_Full get(AIS_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
