...
public final class NavigationalObstruction_Ingest extends Table {
  ...
  public static NavigationalObstruction_Ingest getRootAsNavigationalObstruction_Ingest(ByteBuffer _bb, NavigationalObstruction_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean NavigationalObstruction_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "NAVI"); }
  ...
  public static int createNavigationalObstruction_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endNavigationalObstruction_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishNavigationalObstruction_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "NAVI"); }
  public static void finishSizePrefixedNavigationalObstruction_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "NAVI"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public NavigationalObstruction_Ingest get(int j) { return get(new NavigationalObstruction_Ingest(), j); }
    public NavigationalObstruction_Ingest get(NavigationalObstruction_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
