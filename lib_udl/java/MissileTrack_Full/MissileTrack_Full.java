...
public final class MissileTrack_Full extends Table {
  ...
  public static MissileTrack_Full getRootAsMissileTrack_Full(ByteBuffer _bb, MissileTrack_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean MissileTrack_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "MISS"); }
  ...
  public static int createMissileTrack_Full(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endMissileTrack_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishMissileTrack_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "MISS"); }
  public static void finishSizePrefixedMissileTrack_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "MISS"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public MissileTrack_Full get(int j) { return get(new MissileTrack_Full(), j); }
    public MissileTrack_Full get(MissileTrack_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
