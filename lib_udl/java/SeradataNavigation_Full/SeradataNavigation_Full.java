...
public final class SeradataNavigation_Full extends Table {
  ...
  public static SeradataNavigation_Full getRootAsSeradataNavigation_Full(ByteBuffer _bb, SeradataNavigation_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean SeradataNavigation_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "SERA"); }
  ...
  public static int createSeradataNavigation_Full(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endSeradataNavigation_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishSeradataNavigation_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "SERA"); }
  public static void finishSizePrefixedSeradataNavigation_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "SERA"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public SeradataNavigation_Full get(int j) { return get(new SeradataNavigation_Full(), j); }
    public SeradataNavigation_Full get(SeradataNavigation_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
