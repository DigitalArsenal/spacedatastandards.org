...
public final class IndividualAircraftTasking_Ingest extends Table {
  ...
  public static IndividualAircraftTasking_Ingest getRootAsIndividualAircraftTasking_Ingest(ByteBuffer _bb, IndividualAircraftTasking_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean IndividualAircraftTasking_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "INDI"); }
  ...
  public static int createIndividualAircraftTasking_Ingest(FlatBufferBuilder builder,
      int numAcft,
      int acftTypeOffset,
      int callSignOffset,
  ...
  public static int endIndividualAircraftTasking_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishIndividualAircraftTasking_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "INDI"); }
  public static void finishSizePrefixedIndividualAircraftTasking_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "INDI"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public IndividualAircraftTasking_Ingest get(int j) { return get(new IndividualAircraftTasking_Ingest(), j); }
    public IndividualAircraftTasking_Ingest get(IndividualAircraftTasking_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
