...
public final class DataLinkOps_Ingest extends Table {
  ...
  public static DataLinkOps_Ingest getRootAsDataLinkOps_Ingest(ByteBuffer _bb, DataLinkOps_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean DataLinkOps_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "DATA"); }
  ...
  public static int createDataLinkOps_Ingest(FlatBufferBuilder builder,
      int linkNameOffset,
  ...
  public static int endDataLinkOps_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishDataLinkOps_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "DATA"); }
  public static void finishSizePrefixedDataLinkOps_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "DATA"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public DataLinkOps_Ingest get(int j) { return get(new DataLinkOps_Ingest(), j); }
    public DataLinkOps_Ingest get(DataLinkOps_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
