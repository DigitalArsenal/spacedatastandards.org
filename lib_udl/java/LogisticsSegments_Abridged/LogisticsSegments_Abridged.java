...
public final class LogisticsSegments_Abridged extends Table {
  ...
  public static LogisticsSegments_Abridged getRootAsLogisticsSegments_Abridged(ByteBuffer _bb, LogisticsSegments_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean LogisticsSegments_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "LOGI"); }
  ...
  public static int createLogisticsSegments_Abridged(FlatBufferBuilder builder,
      int segmentNumber,
      int modeCodeOffset,
  ...
  public static int endLogisticsSegments_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishLogisticsSegments_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "LOGI"); }
  public static void finishSizePrefixedLogisticsSegments_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "LOGI"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public LogisticsSegments_Abridged get(int j) { return get(new LogisticsSegments_Abridged(), j); }
    public LogisticsSegments_Abridged get(LogisticsSegments_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
