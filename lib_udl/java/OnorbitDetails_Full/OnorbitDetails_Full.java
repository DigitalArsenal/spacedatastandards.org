...
public final class OnorbitDetails_Full extends Table {
  ...
  public static OnorbitDetails_Full getRootAsOnorbitDetails_Full(ByteBuffer _bb, OnorbitDetails_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean OnorbitDetails_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "ONOR"); }
  ...
  public static int createOnorbitDetails_Full(FlatBufferBuilder builder,
      int idOffset,
      int idOnOrbitOffset,
  ...
  public static int endOnorbitDetails_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishOnorbitDetails_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "ONOR"); }
  public static void finishSizePrefixedOnorbitDetails_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "ONOR"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public OnorbitDetails_Full get(int j) { return get(new OnorbitDetails_Full(), j); }
    public OnorbitDetails_Full get(OnorbitDetails_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
