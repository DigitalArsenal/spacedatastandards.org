...
public final class MtiJobRequest_Abridged extends Table {
  ...
  public static MtiJobRequest_Abridged getRootAsMtiJobRequest_Abridged(ByteBuffer _bb, MtiJobRequest_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean MtiJobRequest_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "MTIJ"); }
  ...
  public static int createMtiJobRequest_Abridged(FlatBufferBuilder builder,
      int r1Offset,
      int r2Offset,
      int r3,
      double r4,
  ...
  public static int endMtiJobRequest_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishMtiJobRequest_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "MTIJ"); }
  public static void finishSizePrefixedMtiJobRequest_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "MTIJ"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public MtiJobRequest_Abridged get(int j) { return get(new MtiJobRequest_Abridged(), j); }
    public MtiJobRequest_Abridged get(MtiJobRequest_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
