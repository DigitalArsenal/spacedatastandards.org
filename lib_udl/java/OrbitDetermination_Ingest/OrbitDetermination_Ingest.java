...
public final class OrbitDetermination_Ingest extends Table {
  ...
  public static OrbitDetermination_Ingest getRootAsOrbitDetermination_Ingest(ByteBuffer _bb, OrbitDetermination_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean OrbitDetermination_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "ORBI"); }
  ...
  public static int createOrbitDetermination_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endOrbitDetermination_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishOrbitDetermination_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "ORBI"); }
  public static void finishSizePrefixedOrbitDetermination_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "ORBI"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public OrbitDetermination_Ingest get(int j) { return get(new OrbitDetermination_Ingest(), j); }
    public OrbitDetermination_Ingest get(OrbitDetermination_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
