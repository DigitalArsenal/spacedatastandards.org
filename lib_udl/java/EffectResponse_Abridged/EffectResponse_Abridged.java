...
public final class EffectResponse_Abridged extends Table {
  ...
  public static EffectResponse_Abridged getRootAsEffectResponse_Abridged(ByteBuffer _bb, EffectResponse_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean EffectResponse_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "EFFE"); }
  ...
  public static int createEffectResponse_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endEffectResponse_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishEffectResponse_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "EFFE"); }
  public static void finishSizePrefixedEffectResponse_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "EFFE"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public EffectResponse_Abridged get(int j) { return get(new EffectResponse_Abridged(), j); }
    public EffectResponse_Abridged get(EffectResponse_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
