...
public final class AntennaDetails_Ingest extends Table {
  ...
  public static AntennaDetails_Ingest getRootAsAntennaDetails_Ingest(ByteBuffer _bb, AntennaDetails_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean AntennaDetails_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "ANTE"); }
  ...
  public static int createAntennaDetails_Ingest(FlatBufferBuilder builder,
      int idOffset,
      int idAntennaOffset,
  ...
  public static int endAntennaDetails_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAntennaDetails_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "ANTE"); }
  public static void finishSizePrefixedAntennaDetails_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "ANTE"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public AntennaDetails_Ingest get(int j) { return get(new AntennaDetails_Ingest(), j); }
    public AntennaDetails_Ingest get(AntennaDetails_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
