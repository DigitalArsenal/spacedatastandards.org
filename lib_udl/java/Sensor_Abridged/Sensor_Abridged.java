...
public final class Sensor_Abridged extends Table {
  ...
  public static Sensor_Abridged getRootAsSensor_Abridged(ByteBuffer _bb, Sensor_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Sensor_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "SENS"); }
  ...
  public static int createSensor_Abridged(FlatBufferBuilder builder,
      int idSensorOffset,
  ...
  public static int endSensor_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishSensor_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "SENS"); }
  public static void finishSizePrefixedSensor_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "SENS"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Sensor_Abridged get(int j) { return get(new Sensor_Abridged(), j); }
    public Sensor_Abridged get(Sensor_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
