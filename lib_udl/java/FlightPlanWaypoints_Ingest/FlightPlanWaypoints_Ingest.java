...
public final class FlightPlanWaypoints_Ingest extends Table {
  ...
  public static FlightPlanWaypoints_Ingest getRootAsFlightPlanWaypoints_Ingest(ByteBuffer _bb, FlightPlanWaypoints_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean FlightPlanWaypoints_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "FLIG"); }
  ...
  public static int createFlightPlanWaypoints_Ingest(FlatBufferBuilder builder,
      int typeOffset,
  ...
  public static int endFlightPlanWaypoints_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishFlightPlanWaypoints_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "FLIG"); }
  public static void finishSizePrefixedFlightPlanWaypoints_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "FLIG"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public FlightPlanWaypoints_Ingest get(int j) { return get(new FlightPlanWaypoints_Ingest(), j); }
    public FlightPlanWaypoints_Ingest get(FlightPlanWaypoints_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
