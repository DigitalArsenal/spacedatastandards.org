...
public final class AircraftMissionLocationTasking_Ingest extends Table {
  ...
  public static AircraftMissionLocationTasking_Ingest getRootAsAircraftMissionLocationTasking_Ingest(ByteBuffer _bb, AircraftMissionLocationTasking_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean AircraftMissionLocationTasking_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "AIRC"); }
  ...
  public static int createAircraftMissionLocationTasking_Ingest(FlatBufferBuilder builder,
      int startTimeOffset,
      int endTimeOffset,
  ...
  public static int endAircraftMissionLocationTasking_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAircraftMissionLocationTasking_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "AIRC"); }
  public static void finishSizePrefixedAircraftMissionLocationTasking_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "AIRC"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public AircraftMissionLocationTasking_Ingest get(int j) { return get(new AircraftMissionLocationTasking_Ingest(), j); }
    public AircraftMissionLocationTasking_Ingest get(AircraftMissionLocationTasking_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
