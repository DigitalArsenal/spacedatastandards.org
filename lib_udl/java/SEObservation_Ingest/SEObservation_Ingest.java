...
public final class SEObservation_Ingest extends Table {
  ...
  public static SEObservation_Ingest getRootAsSEObservation_Ingest(ByteBuffer _bb, SEObservation_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean SEObservation_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "SEOB"); }
  ...
  public static int createSEObservation_Ingest(FlatBufferBuilder builder,
      int obTypeOffset,
      int obUoMOffset,
      double obValue,
      int obStringOffset,
  ...
  public static int endSEObservation_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishSEObservation_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "SEOB"); }
  public static void finishSizePrefixedSEObservation_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "SEOB"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public SEObservation_Ingest get(int j) { return get(new SEObservation_Ingest(), j); }
    public SEObservation_Ingest get(SEObservation_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
