...
public final class SeradataNavigation_Abridged extends Table {
  ...
  public static SeradataNavigation_Abridged getRootAsSeradataNavigation_Abridged(ByteBuffer _bb, SeradataNavigation_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean SeradataNavigation_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "SERA"); }
  ...
  public static int createSeradataNavigation_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endSeradataNavigation_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishSeradataNavigation_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "SERA"); }
  public static void finishSizePrefixedSeradataNavigation_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "SERA"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public SeradataNavigation_Abridged get(int j) { return get(new SeradataNavigation_Abridged(), j); }
    public SeradataNavigation_Abridged get(SeradataNavigation_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
