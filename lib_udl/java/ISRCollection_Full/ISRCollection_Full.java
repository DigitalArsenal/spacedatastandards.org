...
public final class ISRCollection_Full extends Table {
  ...
  public static ISRCollection_Full getRootAsISRCollection_Full(ByteBuffer _bb, ISRCollection_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean ISRCollection_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "ISRC"); }
  ...
  public static int createISRCollection_Full(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endISRCollection_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishISRCollection_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "ISRC"); }
  public static void finishSizePrefixedISRCollection_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "ISRC"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public ISRCollection_Full get(int j) { return get(new ISRCollection_Full(), j); }
    public ISRCollection_Full get(ISRCollection_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
