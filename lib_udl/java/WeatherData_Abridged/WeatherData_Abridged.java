...
public final class WeatherData_Abridged extends Table {
  ...
  public static WeatherData_Abridged getRootAsWeatherData_Abridged(ByteBuffer _bb, WeatherData_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean WeatherData_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "WEAT"); }
  ...
  public static int createWeatherData_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endWeatherData_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishWeatherData_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "WEAT"); }
  public static void finishSizePrefixedWeatherData_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "WEAT"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public WeatherData_Abridged get(int j) { return get(new WeatherData_Abridged(), j); }
    public WeatherData_Abridged get(WeatherData_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
