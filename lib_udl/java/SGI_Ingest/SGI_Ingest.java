...
public final class SGI_Ingest extends Table {
  public static void ValidateVersion() { Constants.FLATBUFFERS_24_3_25(); }
  public static SGI_Ingest getRootAsSGI_Ingest(ByteBuffer _bb) { return getRootAsSGI_Ingest(_bb, new SGI_Ingest()); }
  public static SGI_Ingest getRootAsSGI_Ingest(ByteBuffer _bb, SGI_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean SGI_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "SGII"); }
  ...
  public static int createSGI_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endSGI_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishSGI_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "SGII"); }
  public static void finishSizePrefixedSGI_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "SGII"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public SGI_Ingest get(int j) { return get(new SGI_Ingest(), j); }
    public SGI_Ingest get(SGI_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
