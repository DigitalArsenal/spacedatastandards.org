...
public final class LogisticsTransportationPlans_Abridged extends Table {
  ...
  public static LogisticsTransportationPlans_Abridged getRootAsLogisticsTransportationPlans_Abridged(ByteBuffer _bb, LogisticsTransportationPlans_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean LogisticsTransportationPlans_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "LOGI"); }
  ...
  public static int createLogisticsTransportationPlans_Abridged(FlatBufferBuilder builder,
  ...
  public static int endLogisticsTransportationPlans_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishLogisticsTransportationPlans_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "LOGI"); }
  public static void finishSizePrefixedLogisticsTransportationPlans_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "LOGI"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public LogisticsTransportationPlans_Abridged get(int j) { return get(new LogisticsTransportationPlans_Abridged(), j); }
    public LogisticsTransportationPlans_Abridged get(LogisticsTransportationPlans_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
