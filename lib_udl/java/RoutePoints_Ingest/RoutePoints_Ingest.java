...
public final class RoutePoints_Ingest extends Table {
  ...
  public static RoutePoints_Ingest getRootAsRoutePoints_Ingest(ByteBuffer _bb, RoutePoints_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean RoutePoints_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "ROUT"); }
  ...
  public static int createRoutePoints_Ingest(FlatBufferBuilder builder,
      int ptSequenceId,
  ...
  public static int endRoutePoints_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishRoutePoints_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "ROUT"); }
  public static void finishSizePrefixedRoutePoints_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "ROUT"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public RoutePoints_Ingest get(int j) { return get(new RoutePoints_Ingest(), j); }
    public RoutePoints_Ingest get(RoutePoints_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
