...
public final class MtiHRR_Full extends Table {
  ...
  public static MtiHRR_Full getRootAsMtiHRR_Full(ByteBuffer _bb, MtiHRR_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean MtiHRR_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "MTIH"); }
  ...
  public static int createMtiHRR_Full(FlatBufferBuilder builder,
      int h2,
      int h3,
      boolean h4,
      int h5,
  ...
  public static int endMtiHRR_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishMtiHRR_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "MTIH"); }
  public static void finishSizePrefixedMtiHRR_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "MTIH"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public MtiHRR_Full get(int j) { return get(new MtiHRR_Full(), j); }
    public MtiHRR_Full get(MtiHRR_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
