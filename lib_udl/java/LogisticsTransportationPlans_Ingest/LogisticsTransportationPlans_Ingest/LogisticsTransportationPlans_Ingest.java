...
public final class LogisticsTransportationPlans_Ingest extends Table {
  ...
  public StringVector logisticsSegments_vector() { return logisticsSegments_vector(new StringVector()); }
  public StringVector logisticsSegments_vector(StringVector obj) { int o = __offset(52); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
  ...
  public StringVector logisticsTransportationPlansRemarks_vector() { return logisticsTransportationPlansRemarks_vector(new StringVector()); }
  public StringVector logisticsTransportationPlansRemarks_vector(StringVector obj) { int o = __offset(54); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
