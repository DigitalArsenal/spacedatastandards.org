...
public final class AircraftMissionTasking_Full extends Table {
  ...
  public static AircraftMissionTasking_Full getRootAsAircraftMissionTasking_Full(ByteBuffer _bb, AircraftMissionTasking_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean AircraftMissionTasking_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "AIRC"); }
  ...
  public static int createAircraftMissionTasking_Full(FlatBufferBuilder builder,
  ...
  public static int endAircraftMissionTasking_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAircraftMissionTasking_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "AIRC"); }
  public static void finishSizePrefixedAircraftMissionTasking_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "AIRC"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public AircraftMissionTasking_Full get(int j) { return get(new AircraftMissionTasking_Full(), j); }
    public AircraftMissionTasking_Full get(AircraftMissionTasking_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
