...
public final class FlightPlan_Full extends Table {
  ...
  public static FlightPlan_Full getRootAsFlightPlan_Full(ByteBuffer _bb, FlightPlan_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean FlightPlan_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "FLIG"); }
  ...
  public static int createFlightPlan_Full(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endFlightPlan_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishFlightPlan_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "FLIG"); }
  public static void finishSizePrefixedFlightPlan_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "FLIG"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public FlightPlan_Full get(int j) { return get(new FlightPlan_Full(), j); }
    public FlightPlan_Full get(FlightPlan_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
