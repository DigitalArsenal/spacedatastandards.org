...
public final class PersonnelRecoveryExecutionInfo_Abridged extends Table {
  ...
  public static PersonnelRecoveryExecutionInfo_Abridged getRootAsPersonnelRecoveryExecutionInfo_Abridged(ByteBuffer _bb, PersonnelRecoveryExecutionInfo_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean PersonnelRecoveryExecutionInfo_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "PERS"); }
  ...
  public static int createPersonnelRecoveryExecutionInfo_Abridged(FlatBufferBuilder builder,
  ...
  public static int endPersonnelRecoveryExecutionInfo_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishPersonnelRecoveryExecutionInfo_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "PERS"); }
  public static void finishSizePrefixedPersonnelRecoveryExecutionInfo_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "PERS"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public PersonnelRecoveryExecutionInfo_Abridged get(int j) { return get(new PersonnelRecoveryExecutionInfo_Abridged(), j); }
    public PersonnelRecoveryExecutionInfo_Abridged get(PersonnelRecoveryExecutionInfo_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
