...
public final class AirLoadPlan_Ingest extends Table {
  ...
  public static AirLoadPlan_Ingest getRootAsAirLoadPlan_Ingest(ByteBuffer _bb, AirLoadPlan_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean AirLoadPlan_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "AIRL"); }
   ...
   * Constraints: Minimum length = 1, Maximum length = 64
   */
  public String source() { int o = __offset(94); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer sourceAsByteBuffer() { return __vector_as_bytebuffer(94, 1); }
  public ByteBuffer sourceInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 94, 1); }
  /**
   * Originating system or organization which produced the data, if different from the source. The origin may be different than the source if the source was a mediating system which forwarded the data on behalf of the origin system. If null, the source may be assumed to be the origin.
   * Example: /// Example: THIRD_PARTY_DATASOURCE
   * Constraints: Minimum length = 0, Maximum length = 64
   */
  public String origin() { int o = __offset(96); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer originAsByteBuffer() { return __vector_as_bytebuffer(96, 1); }
  public ByteBuffer originInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 96, 1); }
  /**
   * The originating source network on which this record was created, auto-populated by the system.
   * Example: /// Example: ORIG
   * Constraints: Minimum length = 0, Maximum length = 32
   */
  public String origNetwork() { int o = __offset(98); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer origNetworkAsByteBuffer() { return __vector_as_bytebuffer(98, 1); }
  public ByteBuffer origNetworkInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 98, 1); }
  /**
   ...
   */
  public byte dataMode() { int o = __offset(100); return o != 0 ? bb.get(o + bb_pos) : 0; }

  public static int createAirLoadPlan_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static void addSource(FlatBufferBuilder builder, int sourceOffset) { builder.addOffset(45, sourceOffset, 0); }
  public static void addOrigin(FlatBufferBuilder builder, int originOffset) { builder.addOffset(46, originOffset, 0); }
  public static void addOrigNetwork(FlatBufferBuilder builder, int origNetworkOffset) { builder.addOffset(47, origNetworkOffset, 0); }
  public static void addDataMode(FlatBufferBuilder builder, byte dataMode) { builder.addByte(48, dataMode, 0); }
  public static int endAirLoadPlan_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAirLoadPlan_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "AIRL"); }
  public static void finishSizePrefixedAirLoadPlan_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "AIRL"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public AirLoadPlan_Ingest get(int j) { return get(new AirLoadPlan_Ingest(), j); }
    public AirLoadPlan_Ingest get(AirLoadPlan_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
