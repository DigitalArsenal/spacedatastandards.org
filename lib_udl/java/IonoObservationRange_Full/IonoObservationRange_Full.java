...
public final class IonoObservationRange_Full extends Table {
  ...
  public static IonoObservationRange_Full getRootAsIonoObservationRange_Full(ByteBuffer _bb, IonoObservationRange_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean IonoObservationRange_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "IONO"); }
  ...
  public static int createIonoObservationRange_Full(FlatBufferBuilder builder,
      int notesOffset,
  ...
  public static int endIonoObservationRange_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishIonoObservationRange_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "IONO"); }
  public static void finishSizePrefixedIonoObservationRange_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "IONO"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public IonoObservationRange_Full get(int j) { return get(new IonoObservationRange_Full(), j); }
    public IonoObservationRange_Full get(IonoObservationRange_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
