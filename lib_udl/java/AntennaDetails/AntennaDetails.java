...
public final class AntennaDetails extends Table {
  ...
  public static AntennaDetails getRootAsAntennaDetails(ByteBuffer _bb, AntennaDetails obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean AntennaDetailsBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "ANTE"); }
  ...
  public static int createAntennaDetails(FlatBufferBuilder builder,
      int idOffset,
      int idAntennaOffset,
  ...
  public static int endAntennaDetails(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAntennaDetailsBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "ANTE"); }
  public static void finishSizePrefixedAntennaDetailsBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "ANTE"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public AntennaDetails get(int j) { return get(new AntennaDetails(), j); }
    public AntennaDetails get(AntennaDetails obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
