...
public final class LinkStatus_Ingest extends Table {
  ...
  public static LinkStatus_Ingest getRootAsLinkStatus_Ingest(ByteBuffer _bb, LinkStatus_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean LinkStatus_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "LINK"); }
  ...
  public static int createLinkStatus_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endLinkStatus_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishLinkStatus_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "LINK"); }
  public static void finishSizePrefixedLinkStatus_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "LINK"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public LinkStatus_Ingest get(int j) { return get(new LinkStatus_Ingest(), j); }
    public LinkStatus_Ingest get(LinkStatus_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
