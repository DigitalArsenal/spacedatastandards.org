...
public final class Mti_Full extends Table {
  public static void ValidateVersion() { Constants.FLATBUFFERS_24_3_25(); }
  public static Mti_Full getRootAsMti_Full(ByteBuffer _bb) { return getRootAsMti_Full(_bb, new Mti_Full()); }
  public static Mti_Full getRootAsMti_Full(ByteBuffer _bb, Mti_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Mti_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "MTIF"); }
  ...
  public static int createMti_Full(FlatBufferBuilder builder,
  ...
  public static int endMti_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishMti_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "MTIF"); }
  public static void finishSizePrefixedMti_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "MTIF"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Mti_Full get(int j) { return get(new Mti_Full(), j); }
    public Mti_Full get(Mti_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
