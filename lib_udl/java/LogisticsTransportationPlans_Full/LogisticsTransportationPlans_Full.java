...
public final class LogisticsTransportationPlans_Full extends Table {
  ...
  public static LogisticsTransportationPlans_Full getRootAsLogisticsTransportationPlans_Full(ByteBuffer _bb, LogisticsTransportationPlans_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean LogisticsTransportationPlans_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "LOGI"); }
  ...
  public static int createLogisticsTransportationPlans_Full(FlatBufferBuilder builder,
  ...
  public static int endLogisticsTransportationPlans_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishLogisticsTransportationPlans_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "LOGI"); }
  public static void finishSizePrefixedLogisticsTransportationPlans_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "LOGI"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public LogisticsTransportationPlans_Full get(int j) { return get(new LogisticsTransportationPlans_Full(), j); }
    public LogisticsTransportationPlans_Full get(LogisticsTransportationPlans_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
