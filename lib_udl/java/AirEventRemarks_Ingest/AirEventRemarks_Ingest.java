...
public final class AirEventRemarks_Ingest extends Table {
  ...
  public static AirEventRemarks_Ingest getRootAsAirEventRemarks_Ingest(ByteBuffer _bb, AirEventRemarks_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean AirEventRemarks_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "AIRE"); }
  ...
  public static int createAirEventRemarks_Ingest(FlatBufferBuilder builder,
  ...
  public static int endAirEventRemarks_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAirEventRemarks_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "AIRE"); }
  public static void finishSizePrefixedAirEventRemarks_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "AIRE"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public AirEventRemarks_Ingest get(int j) { return get(new AirEventRemarks_Ingest(), j); }
    public AirEventRemarks_Ingest get(AirEventRemarks_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
