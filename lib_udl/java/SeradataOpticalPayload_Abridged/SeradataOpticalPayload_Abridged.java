...
public final class SeradataOpticalPayload_Abridged extends Table {
  ...
  public static SeradataOpticalPayload_Abridged getRootAsSeradataOpticalPayload_Abridged(ByteBuffer _bb, SeradataOpticalPayload_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean SeradataOpticalPayload_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "SERA"); }
   ...
   * Constraints: Minimum length = 1, Maximum length = 64
   */
  public String source() { int o = __offset(48); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer sourceAsByteBuffer() { return __vector_as_bytebuffer(48, 1); }
  public ByteBuffer sourceInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 48, 1); }
  /**
   * Originating system or organization which produced the data, if different from the source. The origin may be different than the source if the source was a mediating system which forwarded the data on behalf of the origin system. If null, the source may be assumed to be the origin.
   * Example: /// Example: THIRD_PARTY_DATASOURCE
   * Constraints: Minimum length = 0, Maximum length = 64
   */
  public String origin() { int o = __offset(50); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer originAsByteBuffer() { return __vector_as_bytebuffer(50, 1); }
  public ByteBuffer originInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 50, 1); }
  /**
  ...
  public static int createSeradataOpticalPayload_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static void addSource(FlatBufferBuilder builder, int sourceOffset) { builder.addOffset(22, sourceOffset, 0); }
  public static void addOrigin(FlatBufferBuilder builder, int originOffset) { builder.addOffset(23, originOffset, 0); }
  ...
  public static int endSeradataOpticalPayload_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishSeradataOpticalPayload_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "SERA"); }
  public static void finishSizePrefixedSeradataOpticalPayload_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "SERA"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public SeradataOpticalPayload_Abridged get(int j) { return get(new SeradataOpticalPayload_Abridged(), j); }
    public SeradataOpticalPayload_Abridged get(SeradataOpticalPayload_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
