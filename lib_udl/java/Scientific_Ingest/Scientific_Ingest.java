...
public final class Scientific_Ingest extends Table {
  ...
  public static Scientific_Ingest getRootAsScientific_Ingest(ByteBuffer _bb, Scientific_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Scientific_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "SCIE"); }
   ...
   * Constraints: No constraints specified.
   */
  public String entity() { int o = __offset(36); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer entityAsByteBuffer() { return __vector_as_bytebuffer(36, 1); }
  public ByteBuffer entityInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 36, 1); }

  public static int createScientific_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static void addEntity(FlatBufferBuilder builder, int entityOffset) { builder.addOffset(16, entityOffset, 0); }
  public static int endScientific_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishScientific_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "SCIE"); }
  public static void finishSizePrefixedScientific_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "SCIE"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Scientific_Ingest get(int j) { return get(new Scientific_Ingest(), j); }
    public Scientific_Ingest get(Scientific_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
