...
public final class SeradataSpacecraftDetails_Ingest extends Table {
  ...
  public static SeradataSpacecraftDetails_Ingest getRootAsSeradataSpacecraftDetails_Ingest(ByteBuffer _bb, SeradataSpacecraftDetails_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean SeradataSpacecraftDetails_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "SERA"); }
  ...
  public static int createSeradataSpacecraftDetails_Ingest(FlatBufferBuilder builder,
      int idOffset,
      int idOnOrbitOffset,
  ...
  public static int endSeradataSpacecraftDetails_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishSeradataSpacecraftDetails_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "SERA"); }
  public static void finishSizePrefixedSeradataSpacecraftDetails_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "SERA"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public SeradataSpacecraftDetails_Ingest get(int j) { return get(new SeradataSpacecraftDetails_Ingest(), j); }
    public SeradataSpacecraftDetails_Ingest get(SeradataSpacecraftDetails_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
