...
public final class NavalFlightOperations_Full extends Table {
  ...
  public static NavalFlightOperations_Full getRootAsNavalFlightOperations_Full(ByteBuffer _bb, NavalFlightOperations_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean NavalFlightOperations_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "NAVA"); }
  ...
  public static int createNavalFlightOperations_Full(FlatBufferBuilder builder,
      int shipNameOffset,
  ...
  public static int endNavalFlightOperations_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishNavalFlightOperations_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "NAVA"); }
  public static void finishSizePrefixedNavalFlightOperations_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "NAVA"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public NavalFlightOperations_Full get(int j) { return get(new NavalFlightOperations_Full(), j); }
    public NavalFlightOperations_Full get(NavalFlightOperations_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
