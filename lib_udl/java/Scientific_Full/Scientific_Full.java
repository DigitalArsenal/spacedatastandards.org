...
public final class Scientific_Full extends Table {
  ...
  public static Scientific_Full getRootAsScientific_Full(ByteBuffer _bb, Scientific_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Scientific_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "SCIE"); }
   ...
   * Constraints: Minimum length = 0, Maximum length = 36
   */
  public String idEntity() { int o = __offset(38); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer idEntityAsByteBuffer() { return __vector_as_bytebuffer(38, 1); }
  public ByteBuffer idEntityInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 38, 1); }
  /**
  ...
  public static int createScientific_Full(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static void addIdEntity(FlatBufferBuilder builder, int idEntityOffset) { builder.addOffset(17, idEntityOffset, 0); }
  public static void addEntity(FlatBufferBuilder builder, int entityOffset) { builder.addOffset(18, entityOffset, 0); }
  public static int endScientific_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishScientific_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "SCIE"); }
  public static void finishSizePrefixedScientific_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "SCIE"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Scientific_Full get(int j) { return get(new Scientific_Full(), j); }
    public Scientific_Full get(Scientific_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
