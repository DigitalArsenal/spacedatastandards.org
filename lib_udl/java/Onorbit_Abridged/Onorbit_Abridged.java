...
public final class Onorbit_Abridged extends Table {
  ...
  public static Onorbit_Abridged getRootAsOnorbit_Abridged(ByteBuffer _bb, Onorbit_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Onorbit_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "ONOR"); }
   ...
   */
  public String launchSiteId() { int o = __offset(40); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer launchSiteIdAsByteBuffer() { return __vector_as_bytebuffer(40, 1); }
  public ByteBuffer launchSiteIdInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 40, 1); }
  /**
   * The country code. This value is typically the ISO 3166 Alpha-2 two-character country code, however it can also represent various consortiums that do not appear in the ISO document. The code must correspond to an existing country in the UDL’s country API. Call udl/country/{code} to get any associated FIPS code, ISO Alpha-3 code, or alternate code values that exist for the specified country code.
   * Example: /// Example: US
   * Constraints: No constraints specified.
   */
  public String countryCode() { int o = __offset(42); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer countryCodeAsByteBuffer() { return __vector_as_bytebuffer(42, 1); }
  public ByteBuffer countryCodeInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 42, 1); }
  /**
  ...
  public static int createOnorbit_Abridged(FlatBufferBuilder builder,
      int idOnOrbitOffset,
  ...
  public static void addLaunchSiteId(FlatBufferBuilder builder, int launchSiteIdOffset) { builder.addOffset(18, launchSiteIdOffset, 0); }
  public static void addCountryCode(FlatBufferBuilder builder, int countryCodeOffset) { builder.addOffset(19, countryCodeOffset, 0); }
  ...
  public static int endOnorbit_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishOnorbit_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "ONOR"); }
  public static void finishSizePrefixedOnorbit_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "ONOR"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Onorbit_Abridged get(int j) { return get(new Onorbit_Abridged(), j); }
    public Onorbit_Abridged get(Onorbit_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
