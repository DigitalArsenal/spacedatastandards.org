...
public final class Sensorcharacteristics_Ingest extends Table {
  ...
  public static Sensorcharacteristics_Ingest getRootAsSensorcharacteristics_Ingest(ByteBuffer _bb, Sensorcharacteristics_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Sensorcharacteristics_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "SENS"); }
  ...
  public static int createSensorcharacteristics_Ingest(FlatBufferBuilder builder,
      int idOffset,
      int idSensorOffset,
  ...
  public static int endSensorcharacteristics_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishSensorcharacteristics_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "SENS"); }
  public static void finishSizePrefixedSensorcharacteristics_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "SENS"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Sensorcharacteristics_Ingest get(int j) { return get(new Sensorcharacteristics_Ingest(), j); }
    public Sensorcharacteristics_Ingest get(Sensorcharacteristics_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
