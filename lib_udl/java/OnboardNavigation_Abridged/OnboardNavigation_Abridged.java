...
public final class OnboardNavigation_Abridged extends Table {
  ...
  public static OnboardNavigation_Abridged getRootAsOnboardNavigation_Abridged(ByteBuffer _bb, OnboardNavigation_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean OnboardNavigation_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "ONBO"); }
   ...
   * Constraints: Minimum length = 0, Maximum length = 36
   */
  public String esId() { int o = __offset(18); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer esIdAsByteBuffer() { return __vector_as_bytebuffer(18, 1); }
  public ByteBuffer esIdInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 18, 1); }
  /**
   * The name or identifier the star catalog in use.
   * Example: /// Example: STAR-CAT-NAME
   * Constraints: Minimum length = 0, Maximum length = 24
   */
  public String starCatName() { int o = __offset(20); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer starCatNameAsByteBuffer() { return __vector_as_bytebuffer(20, 1); }
  public ByteBuffer starCatNameInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 20, 1); }
  /**
   * The last load time of the current star catalog onboard this spacecraft.
   * Example: /// Example: 2021-07-21T01:02:03.123Z
   * Constraints: No constraints specified.
   */
  public String starCatLoadTime() { int o = __offset(22); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer starCatLoadTimeAsByteBuffer() { return __vector_as_bytebuffer(22, 1); }
  public ByteBuffer starCatLoadTimeInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 22, 1); }
  /**
   * Unique identifier of the last onboard state vector.
   * Example: /// Example: STATE-VECTOR-ID
   * Constraints: Minimum length = 0, Maximum length = 36
   */
  public String idStateVector() { int o = __offset(24); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer idStateVectorAsByteBuffer() { return __vector_as_bytebuffer(24, 1); }
  public ByteBuffer idStateVectorInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 24, 1); }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public String ts(int j) { int o = __offset(26); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int tsLength() { int o = __offset(26); return o != 0 ? __vector_len(o) : 0; }
  public StringVector tsVector() { return tsVector(new StringVector()); }
  public StringVector tsVector(StringVector obj) { int o = __offset(26); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   ...
   * Constraints: Minimum length = 0, Maximum length = 24
   */
  public byte referenceFrame() { int o = __offset(28); return o != 0 ? bb.get(o + bb_pos) : 0; }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public String sunSensor(int j) { int o = __offset(30); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int sunSensorLength() { int o = __offset(30); return o != 0 ? __vector_len(o) : 0; }
  public StringVector sunSensorVector() { return sunSensorVector(new StringVector()); }
  public StringVector sunSensorVector(StringVector obj) { int o = __offset(30); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public String mag(int j) { int o = __offset(32); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int magLength() { int o = __offset(32); return o != 0 ? __vector_len(o) : 0; }
  public StringVector magVector() { return magVector(new StringVector()); }
  public StringVector magVector(StringVector obj) { int o = __offset(32); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public String starTracker(int j) { int o = __offset(34); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int starTrackerLength() { int o = __offset(34); return o != 0 ? __vector_len(o) : 0; }
  public StringVector starTrackerVector() { return starTrackerVector(new StringVector()); }
  public StringVector starTrackerVector(StringVector obj) { int o = __offset(34); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public String deltaPos(int j) { int o = __offset(36); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int deltaPosLength() { int o = __offset(36); return o != 0 ? __vector_len(o) : 0; }
  public StringVector deltaPosVector() { return deltaPosVector(new StringVector()); }
  public StringVector deltaPosVector(StringVector obj) { int o = __offset(36); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
  ...
  public static int createOnboardNavigation_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static void addEsId(FlatBufferBuilder builder, int esIdOffset) { builder.addOffset(7, esIdOffset, 0); }
  public static void addStarCatName(FlatBufferBuilder builder, int starCatNameOffset) { builder.addOffset(8, starCatNameOffset, 0); }
  public static void addStarCatLoadTime(FlatBufferBuilder builder, int starCatLoadTimeOffset) { builder.addOffset(9, starCatLoadTimeOffset, 0); }
  public static void addIdStateVector(FlatBufferBuilder builder, int idStateVectorOffset) { builder.addOffset(10, idStateVectorOffset, 0); }
  public static void addTs(FlatBufferBuilder builder, int tsOffset) { builder.addOffset(11, tsOffset, 0); }
  ...
  public static void addReferenceFrame(FlatBufferBuilder builder, byte referenceFrame) { builder.addByte(12, referenceFrame, 0); }
  public static void addSunSensor(FlatBufferBuilder builder, int sunSensorOffset) { builder.addOffset(13, sunSensorOffset, 0); }
  ...
  public static void addMag(FlatBufferBuilder builder, int magOffset) { builder.addOffset(14, magOffset, 0); }
  ...
  public static void addStarTracker(FlatBufferBuilder builder, int starTrackerOffset) { builder.addOffset(15, starTrackerOffset, 0); }
  ...
  public static void addDeltaPos(FlatBufferBuilder builder, int deltaPosOffset) { builder.addOffset(16, deltaPosOffset, 0); }
  ...
  public static int endOnboardNavigation_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishOnboardNavigation_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "ONBO"); }
  public static void finishSizePrefixedOnboardNavigation_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "ONBO"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public OnboardNavigation_Abridged get(int j) { return get(new OnboardNavigation_Abridged(), j); }
    public OnboardNavigation_Abridged get(OnboardNavigation_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
