...
public final class AirLoadPlan_Abridged extends Table {
  ...
  public static AirLoadPlan_Abridged getRootAsAirLoadPlan_Abridged(ByteBuffer _bb, AirLoadPlan_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean AirLoadPlan_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "AIRL"); }
  ...
  public static int createAirLoadPlan_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endAirLoadPlan_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAirLoadPlan_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "AIRL"); }
  public static void finishSizePrefixedAirLoadPlan_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "AIRL"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public AirLoadPlan_Abridged get(int j) { return get(new AirLoadPlan_Abridged(), j); }
    public AirLoadPlan_Abridged get(AirLoadPlan_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
