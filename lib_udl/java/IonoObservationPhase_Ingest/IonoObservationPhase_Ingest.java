...
public final class IonoObservationPhase_Ingest extends Table {
  ...
  public static IonoObservationPhase_Ingest getRootAsIonoObservationPhase_Ingest(ByteBuffer _bb, IonoObservationPhase_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean IonoObservationPhase_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "IONO"); }
  ...
  public static int createIonoObservationPhase_Ingest(FlatBufferBuilder builder,
      int notesOffset,
  ...
  public static int endIonoObservationPhase_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishIonoObservationPhase_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "IONO"); }
  public static void finishSizePrefixedIonoObservationPhase_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "IONO"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public IonoObservationPhase_Ingest get(int j) { return get(new IonoObservationPhase_Ingest(), j); }
    public IonoObservationPhase_Ingest get(IonoObservationPhase_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
