...
public final class PersonnelRecoveryExecutionInfo_Full extends Table {
  ...
  public static PersonnelRecoveryExecutionInfo_Full getRootAsPersonnelRecoveryExecutionInfo_Full(ByteBuffer _bb, PersonnelRecoveryExecutionInfo_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean PersonnelRecoveryExecutionInfo_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "PERS"); }
  ...
  public static int createPersonnelRecoveryExecutionInfo_Full(FlatBufferBuilder builder,
  ...
  public static int endPersonnelRecoveryExecutionInfo_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishPersonnelRecoveryExecutionInfo_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "PERS"); }
  public static void finishSizePrefixedPersonnelRecoveryExecutionInfo_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "PERS"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public PersonnelRecoveryExecutionInfo_Full get(int j) { return get(new PersonnelRecoveryExecutionInfo_Full(), j); }
    public PersonnelRecoveryExecutionInfo_Full get(PersonnelRecoveryExecutionInfo_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
