...
public final class IonoObservationDensityProfileTopsideExtensionChapmanConst_Full extends Table {
  ...
  public static IonoObservationDensityProfileTopsideExtensionChapmanConst_Full getRootAsIonoObservationDensityProfileTopsideExtensionChapmanConst_Full(ByteBuffer _bb, IonoObservationDensityProfileTopsideExtensionChapmanConst_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean IonoObservationDensityProfileTopsideExtensionChapmanConst_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "IONO"); }
  ...
  public static int createIonoObservationDensityProfileTopsideExtensionChapmanConst_Full(FlatBufferBuilder builder,
  ...
  public static int endIonoObservationDensityProfileTopsideExtensionChapmanConst_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishIonoObservationDensityProfileTopsideExtensionChapmanConst_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "IONO"); }
  public static void finishSizePrefixedIonoObservationDensityProfileTopsideExtensionChapmanConst_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "IONO"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public IonoObservationDensityProfileTopsideExtensionChapmanConst_Full get(int j) { return get(new IonoObservationDensityProfileTopsideExtensionChapmanConst_Full(), j); }
    public IonoObservationDensityProfileTopsideExtensionChapmanConst_Full get(IonoObservationDensityProfileTopsideExtensionChapmanConst_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
