...
public final class SensorStats_Abridged extends Table {
  ...
  public static SensorStats_Abridged getRootAsSensorStats_Abridged(ByteBuffer _bb, SensorStats_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean SensorStats_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "SENS"); }
  ...
  public static int createSensorStats_Abridged(FlatBufferBuilder builder,
      int idOffset,
      int idSensorOffset,
  ...
  public static int endSensorStats_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishSensorStats_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "SENS"); }
  public static void finishSizePrefixedSensorStats_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "SENS"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public SensorStats_Abridged get(int j) { return get(new SensorStats_Abridged(), j); }
    public SensorStats_Abridged get(SensorStats_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
