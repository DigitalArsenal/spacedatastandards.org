...
public final class SpaceEnvObservation_Abridged extends Table {
  ...
  public static SpaceEnvObservation_Abridged getRootAsSpaceEnvObservation_Abridged(ByteBuffer _bb, SpaceEnvObservation_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean SpaceEnvObservation_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "SPAC"); }
  ...
  public static int createSpaceEnvObservation_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endSpaceEnvObservation_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishSpaceEnvObservation_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "SPAC"); }
  public static void finishSizePrefixedSpaceEnvObservation_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "SPAC"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public SpaceEnvObservation_Abridged get(int j) { return get(new SpaceEnvObservation_Abridged(), j); }
    public SpaceEnvObservation_Abridged get(SpaceEnvObservation_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
