...
public final class ISRCollectionTaskings_Ingest extends Table {
  ...
  public static ISRCollectionTaskings_Ingest getRootAsISRCollectionTaskings_Ingest(ByteBuffer _bb, ISRCollectionTaskings_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean ISRCollectionTaskings_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "ISRC"); }
  ...
  public static int createISRCollectionTaskings_Ingest(FlatBufferBuilder builder,
      int idOffset,
      byte type,
      byte collectionType,
  ...
  public static int endISRCollectionTaskings_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishISRCollectionTaskings_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "ISRC"); }
  public static void finishSizePrefixedISRCollectionTaskings_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "ISRC"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public ISRCollectionTaskings_Ingest get(int j) { return get(new ISRCollectionTaskings_Ingest(), j); }
    public ISRCollectionTaskings_Ingest get(ISRCollectionTaskings_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
