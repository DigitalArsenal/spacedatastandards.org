...
public final class ManifoldElset_Full extends Table {
  ...
  public static ManifoldElset_Full getRootAsManifoldElset_Full(ByteBuffer _bb, ManifoldElset_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean ManifoldElset_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "MANI"); }
   ...
   * Constraints: No constraints specified.
   */
  public String updatedAt() { int o = __offset(50); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer updatedAtAsByteBuffer() { return __vector_as_bytebuffer(50, 1); }
  public ByteBuffer updatedAtInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 50, 1); }
  /**
   ...
   */
  public String updatedBy() { int o = __offset(52); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer updatedByAsByteBuffer() { return __vector_as_bytebuffer(52, 1); }
  public ByteBuffer updatedByInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 52, 1); }
  /**
   * Source of the data.
  ...
  public static int createManifoldElset_Full(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static void addUpdatedAt(FlatBufferBuilder builder, int updatedAtOffset) { builder.addOffset(23, updatedAtOffset, 0); }
  public static void addUpdatedBy(FlatBufferBuilder builder, int updatedByOffset) { builder.addOffset(24, updatedByOffset, 0); }
  ...
  public static int endManifoldElset_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishManifoldElset_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "MANI"); }
  public static void finishSizePrefixedManifoldElset_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "MANI"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public ManifoldElset_Full get(int j) { return get(new ManifoldElset_Full(), j); }
    public ManifoldElset_Full get(ManifoldElset_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
