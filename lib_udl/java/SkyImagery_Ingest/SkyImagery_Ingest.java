...
public final class SkyImagery_Ingest extends Table {
  ...
  public static SkyImagery_Ingest getRootAsSkyImagery_Ingest(ByteBuffer _bb, SkyImagery_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean SkyImagery_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "SKYI"); }
   ...
   * Constraints: No constraints specified.
   */
  public String eoObservations(int j) { int o = __offset(102); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int eoObservationsLength() { int o = __offset(102); return o != 0 ? __vector_len(o) : 0; }
  public StringVector eoObservationsVector() { return eoObservationsVector(new StringVector()); }
  public StringVector eoObservationsVector(StringVector obj) { int o = __offset(102); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }

  public static int createSkyImagery_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static void addEoObservations(FlatBufferBuilder builder, int eoObservationsOffset) { builder.addOffset(49, eoObservationsOffset, 0); }
  ...
  public static int endSkyImagery_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishSkyImagery_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "SKYI"); }
  public static void finishSizePrefixedSkyImagery_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "SKYI"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public SkyImagery_Ingest get(int j) { return get(new SkyImagery_Ingest(), j); }
    public SkyImagery_Ingest get(SkyImagery_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
