...
public final class AnalyticImagery_Abridged extends Table {
  ...
  public static AnalyticImagery_Abridged getRootAsAnalyticImagery_Abridged(ByteBuffer _bb, AnalyticImagery_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean AnalyticImagery_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "ANAL"); }
   ...
   * Constraints: No constraints specified.
   */
  public String satId(int j) { int o = __offset(56); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int satIdLength() { int o = __offset(56); return o != 0 ? __vector_len(o) : 0; }
  public StringVector satIdVector() { return satIdVector(new StringVector()); }
  public StringVector satIdVector(StringVector obj) { int o = __offset(56); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public String satIdConf(int j) { int o = __offset(58); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int satIdConfLength() { int o = __offset(58); return o != 0 ? __vector_len(o) : 0; }
  public StringVector satIdConfVector() { return satIdConfVector(new StringVector()); }
  public StringVector satIdConfVector(StringVector obj) { int o = __offset(58); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public String srcTyps(int j) { int o = __offset(60); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int srcTypsLength() { int o = __offset(60); return o != 0 ? __vector_len(o) : 0; }
  public StringVector srcTypsVector() { return srcTypsVector(new StringVector()); }
  public StringVector srcTypsVector(StringVector obj) { int o = __offset(60); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public String srcIds(int j) { int o = __offset(62); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int srcIdsLength() { int o = __offset(62); return o != 0 ? __vector_len(o) : 0; }
  public StringVector srcIdsVector() { return srcIdsVector(new StringVector()); }
  public StringVector srcIdsVector(StringVector obj) { int o = __offset(62); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   * Optional array of provider/source specific tags for this data, where each element is no longer than 32 characters, used for implementing data owner conditional access controls to restrict access to the data. Should be left null by data providers unless conditional access controls are coordinated with the UDL team.
   * Example: /// Example: ['TAG1', 'TAG2']
   * Constraints: No constraints specified.
   */
  public String tags(int j) { int o = __offset(64); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int tagsLength() { int o = __offset(64); return o != 0 ? __vector_len(o) : 0; }
  public StringVector tagsVector() { return tagsVector(new StringVector()); }
  public StringVector tagsVector(StringVector obj) { int o = __offset(64); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   * MD5 checksum value of the file. The ingest/create operation will automatically generate the value.
   * Example: /// Example: 123
   * Constraints: Minimum length = 0, Maximum length = 256
   */
  public String checksumValue() { int o = __offset(66); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer checksumValueAsByteBuffer() { return __vector_as_bytebuffer(66, 1); }
  public ByteBuffer checksumValueInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 66, 1); }
  /**
   * Optional identifier to track a commercial or marketplace transaction executed to produce this data.
   * Example: /// Example: a7bdef1f-5a4f-4716-bee4-7a1e0ec7d35a
   * Constraints: Minimum length = 0, Maximum length = 64
   */
  public String transactionId() { int o = __offset(68); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer transactionIdAsByteBuffer() { return __vector_as_bytebuffer(68, 1); }
  public ByteBuffer transactionIdInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 68, 1); }
  /**
   ...
   * Constraints: Minimum length = 0, Maximum length = 64
   */
  public String sourceDl() { int o = __offset(80); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer sourceDlAsByteBuffer() { return __vector_as_bytebuffer(80, 1); }
  public ByteBuffer sourceDlInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 80, 1); }
  /**
  ...
  public static int createAnalyticImagery_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static void addSatId(FlatBufferBuilder builder, int satIdOffset) { builder.addOffset(26, satIdOffset, 0); }
  ...
  public static void addSatIdConf(FlatBufferBuilder builder, int satIdConfOffset) { builder.addOffset(27, satIdConfOffset, 0); }
  ...
  public static void addSrcTyps(FlatBufferBuilder builder, int srcTypsOffset) { builder.addOffset(28, srcTypsOffset, 0); }
  ...
  public static void addSrcIds(FlatBufferBuilder builder, int srcIdsOffset) { builder.addOffset(29, srcIdsOffset, 0); }
  ...
  public static void addTags(FlatBufferBuilder builder, int tagsOffset) { builder.addOffset(30, tagsOffset, 0); }
  ...
  public static void addChecksumValue(FlatBufferBuilder builder, int checksumValueOffset) { builder.addOffset(31, checksumValueOffset, 0); }
  public static void addTransactionId(FlatBufferBuilder builder, int transactionIdOffset) { builder.addOffset(32, transactionIdOffset, 0); }
  ...
  public static void addSourceDl(FlatBufferBuilder builder, int sourceDlOffset) { builder.addOffset(38, sourceDlOffset, 0); }
  public static void addDataMode(FlatBufferBuilder builder, byte dataMode) { builder.addByte(39, dataMode, 0); }
  public static int endAnalyticImagery_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAnalyticImagery_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "ANAL"); }
  public static void finishSizePrefixedAnalyticImagery_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "ANAL"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public AnalyticImagery_Abridged get(int j) { return get(new AnalyticImagery_Abridged(), j); }
    public AnalyticImagery_Abridged get(AnalyticImagery_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
