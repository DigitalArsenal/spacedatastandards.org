...
public final class MtiTargetReport_Ingest extends Table {
  ...
  public static MtiTargetReport_Ingest getRootAsMtiTargetReport_Ingest(ByteBuffer _bb, MtiTargetReport_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean MtiTargetReport_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "MTIT"); }
  ...
  public static int createMtiTargetReport_Ingest(FlatBufferBuilder builder,
      int d321,
      double d322,
      double d323,
      int d324,
  ...
  public static int endMtiTargetReport_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishMtiTargetReport_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "MTIT"); }
  public static void finishSizePrefixedMtiTargetReport_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "MTIT"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public MtiTargetReport_Ingest get(int j) { return get(new MtiTargetReport_Ingest(), j); }
    public MtiTargetReport_Ingest get(MtiTargetReport_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
