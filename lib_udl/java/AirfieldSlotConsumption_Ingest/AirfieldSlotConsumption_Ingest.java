...
public final class AirfieldSlotConsumption_Ingest extends Table {
  ...
  public static AirfieldSlotConsumption_Ingest getRootAsAirfieldSlotConsumption_Ingest(ByteBuffer _bb, AirfieldSlotConsumption_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean AirfieldSlotConsumption_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "AIRF"); }
  ...
  public static int createAirfieldSlotConsumption_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endAirfieldSlotConsumption_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAirfieldSlotConsumption_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "AIRF"); }
  public static void finishSizePrefixedAirfieldSlotConsumption_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "AIRF"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public AirfieldSlotConsumption_Ingest get(int j) { return get(new AirfieldSlotConsumption_Ingest(), j); }
    public AirfieldSlotConsumption_Ingest get(AirfieldSlotConsumption_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
