...
public final class LogisticsParts_Full extends Table {
  ...
  public static LogisticsParts_Full getRootAsLogisticsParts_Full(ByteBuffer _bb, LogisticsParts_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean LogisticsParts_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "LOGI"); }
  ...
  public static int createLogisticsParts_Full(FlatBufferBuilder builder,
  ...
  public static int endLogisticsParts_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishLogisticsParts_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "LOGI"); }
  public static void finishSizePrefixedLogisticsParts_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "LOGI"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public LogisticsParts_Full get(int j) { return get(new LogisticsParts_Full(), j); }
    public LogisticsParts_Full get(LogisticsParts_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
