...
public final class Site_Full extends Table {
  public static void ValidateVersion() { Constants.FLATBUFFERS_24_3_25(); }
  public static Site_Full getRootAsSite_Full(ByteBuffer _bb) { return getRootAsSite_Full(_bb, new Site_Full()); }
  public static Site_Full getRootAsSite_Full(ByteBuffer _bb, Site_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Site_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "SITE"); }
   ...
   * Constraints: No constraints specified.
   */
  public String siteRemarks(int j) { int o = __offset(124); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int siteRemarksLength() { int o = __offset(124); return o != 0 ? __vector_len(o) : 0; }
  public StringVector siteRemarksVector() { return siteRemarksVector(new StringVector()); }
  public StringVector siteRemarksVector(StringVector obj) { int o = __offset(124); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   * Time the row was created in the database, auto-populated by the system.
   * Example: /// Example: 2018-01-01T16:00:00.123Z
   * Constraints: No constraints specified.
   */
  public String createdAt() { int o = __offset(126); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer createdAtAsByteBuffer() { return __vector_as_bytebuffer(126, 1); }
  public ByteBuffer createdAtInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 126, 1); }
  /**
   * Application user who created the row in the database, auto-populated by the system.
   * Example: /// Example: some.user
   * Constraints: Minimum length = 1, Maximum length = 64
   */
  public String createdBy() { int o = __offset(128); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer createdByAsByteBuffer() { return __vector_as_bytebuffer(128, 1); }
  public ByteBuffer createdByInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 128, 1); }
  /**
   * Time the row was updated in the database, auto-populated by the system.
   * Example: /// Example: 2018-01-01T16:00:00.123Z
   * Constraints: No constraints specified.
   */
  public String updatedAt() { int o = __offset(130); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer updatedAtAsByteBuffer() { return __vector_as_bytebuffer(130, 1); }
  public ByteBuffer updatedAtInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 130, 1); }
  /**
   * Application user who updated the row in the database, auto-populated by the system.
   * Example: /// Example: some.user
   * Constraints: Minimum length = 1, Maximum length = 64
   */
  public String updatedBy() { int o = __offset(132); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer updatedByAsByteBuffer() { return __vector_as_bytebuffer(132, 1); }
  public ByteBuffer updatedByInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 132, 1); }
  /**
   * Source of the data.
  ...
  public static int createSite_Full(FlatBufferBuilder builder,
      int idOffset,
      int entityOffset,
      int idEntityOffset,
  ...
  public static void addSiteRemarks(FlatBufferBuilder builder, int siteRemarksOffset) { builder.addOffset(60, siteRemarksOffset, 0); }
  public static int createSiteRemarksVector(FlatBufferBuilder builder, int[] data) { builder.startVector(4, data.length, 4); for (int i = data.length - 1; i >= 0; i--) builder.addOffset(data[i]); return builder.endVector(); }
  public static void startSiteRemarksVector(FlatBufferBuilder builder, int numElems) { builder.startVector(4, numElems, 4); }
  public static void addCreatedAt(FlatBufferBuilder builder, int createdAtOffset) { builder.addOffset(61, createdAtOffset, 0); }
  public static void addCreatedBy(FlatBufferBuilder builder, int createdByOffset) { builder.addOffset(62, createdByOffset, 0); }
  public static void addUpdatedAt(FlatBufferBuilder builder, int updatedAtOffset) { builder.addOffset(63, updatedAtOffset, 0); }
  public static void addUpdatedBy(FlatBufferBuilder builder, int updatedByOffset) { builder.addOffset(64, updatedByOffset, 0); }
  ...
  public static int endSite_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishSite_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "SITE"); }
  public static void finishSizePrefixedSite_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "SITE"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Site_Full get(int j) { return get(new Site_Full(), j); }
    public Site_Full get(Site_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
