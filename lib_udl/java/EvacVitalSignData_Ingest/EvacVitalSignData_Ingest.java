...
public final class EvacVitalSignData_Ingest extends Table {
  ...
  public static EvacVitalSignData_Ingest getRootAsEvacVitalSignData_Ingest(ByteBuffer _bb, EvacVitalSignData_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean EvacVitalSignData_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "EVAC"); }
  ...
  public static int createEvacVitalSignData_Ingest(FlatBufferBuilder builder,
      int vitalSignOffset,
      double vitalSign1,
      double vitalSign2,
      int medConfFactor,
  ...
  public static int endEvacVitalSignData_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishEvacVitalSignData_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "EVAC"); }
  public static void finishSizePrefixedEvacVitalSignData_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "EVAC"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public EvacVitalSignData_Ingest get(int j) { return get(new EvacVitalSignData_Ingest(), j); }
    public EvacVitalSignData_Ingest get(EvacVitalSignData_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
