...
public final class AirspaceControlPoint_Ingest extends Table {
  ...
  public static AirspaceControlPoint_Ingest getRootAsAirspaceControlPoint_Ingest(ByteBuffer _bb, AirspaceControlPoint_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean AirspaceControlPoint_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "AIRS"); }
  ...
  public static int createAirspaceControlPoint_Ingest(FlatBufferBuilder builder,
  ...
  public static int endAirspaceControlPoint_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAirspaceControlPoint_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "AIRS"); }
  public static void finishSizePrefixedAirspaceControlPoint_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "AIRS"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public AirspaceControlPoint_Ingest get(int j) { return get(new AirspaceControlPoint_Ingest(), j); }
    public AirspaceControlPoint_Ingest get(AirspaceControlPoint_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
