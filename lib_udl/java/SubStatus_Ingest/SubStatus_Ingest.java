...
public final class SubStatus_Ingest extends Table {
  ...
  public static SubStatus_Ingest getRootAsSubStatus_Ingest(ByteBuffer _bb, SubStatus_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean SubStatus_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "SUBS"); }
  ...
  public static int createSubStatus_Ingest(FlatBufferBuilder builder,
      int idOffset,
      byte type,
  ...
  public static int endSubStatus_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishSubStatus_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "SUBS"); }
  public static void finishSizePrefixedSubStatus_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "SUBS"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public SubStatus_Ingest get(int j) { return get(new SubStatus_Ingest(), j); }
    public SubStatus_Ingest get(SubStatus_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
