...
public final class AIS_Abridged extends Table {
  ...
  public static AIS_Abridged getRootAsAIS_Abridged(ByteBuffer _bb, AIS_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean AIS_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "AISA"); }
  ...
  public static int createAIS_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endAIS_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAIS_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "AISA"); }
  public static void finishSizePrefixedAIS_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "AISA"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public AIS_Abridged get(int j) { return get(new AIS_Abridged(), j); }
    public AIS_Abridged get(AIS_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
