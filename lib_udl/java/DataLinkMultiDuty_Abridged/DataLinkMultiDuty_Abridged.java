...
public final class DataLinkMultiDuty_Abridged extends Table {
  ...
  public static DataLinkMultiDuty_Abridged getRootAsDataLinkMultiDuty_Abridged(ByteBuffer _bb, DataLinkMultiDuty_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean DataLinkMultiDuty_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "DATA"); }
  ...
  public static int createDataLinkMultiDuty_Abridged(FlatBufferBuilder builder,
      int unitDesOffset,
      int nameOffset,
      int rankOffset,
      int dutyOffset,
  ...
  public static int endDataLinkMultiDuty_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishDataLinkMultiDuty_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "DATA"); }
  public static void finishSizePrefixedDataLinkMultiDuty_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "DATA"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public DataLinkMultiDuty_Abridged get(int j) { return get(new DataLinkMultiDuty_Abridged(), j); }
    public DataLinkMultiDuty_Abridged get(DataLinkMultiDuty_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
