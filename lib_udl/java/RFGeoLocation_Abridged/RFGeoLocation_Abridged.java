...
public final class RFGeoLocation_Abridged extends Table {
  ...
  public static RFGeoLocation_Abridged getRootAsRFGeoLocation_Abridged(ByteBuffer _bb, RFGeoLocation_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean RFGeoLocation_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "RFGE"); }
   ...
   * Constraints: No constraints specified.
   */
  public int andims() { int o = __offset(60); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  /**
   * Geographical spatial_ref_sys for region.
   * Example: /// Example: 3
   * Constraints: No constraints specified.
   */
  public int asrid() { int o = __offset(62); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  /**
   ...
   * Constraints: Minimum length = 0, Maximum length = 36
   */
  public String passGroupId() { int o = __offset(64); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer passGroupIdAsByteBuffer() { return __vector_as_bytebuffer(64, 1); }
  public ByteBuffer passGroupIdInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 64, 1); }
  /**
   * The RFGeo algorithm type and version used in geolocation calculations.
   * Example: /// Example: v1.0-3-gps_nb_3ball
   * Constraints: Minimum length = 0, Maximum length = 36
   */
  public String algVersion() { int o = __offset(66); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer algVersionAsByteBuffer() { return __vector_as_bytebuffer(66, 1); }
  public ByteBuffer algVersionInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 66, 1); }
  /**
   * Optional ID from external systems. This field has no meaning within UDL and is provided as a convenience for systems that require tracking of an internal system generated ID.
   * Example: /// Example: 780180925
   * Constraints: Minimum length = 0, Maximum length = 36
   */
  public String externalId() { int o = __offset(68); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer externalIdAsByteBuffer() { return __vector_as_bytebuffer(68, 1); }
  public ByteBuffer externalIdInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 68, 1); }
  /**
  ...
  public static int createRFGeoLocation_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static void addPassGroupId(FlatBufferBuilder builder, int passGroupIdOffset) { builder.addOffset(30, passGroupIdOffset, 0); }
  public static void addAlgVersion(FlatBufferBuilder builder, int algVersionOffset) { builder.addOffset(31, algVersionOffset, 0); }
  public static void addExternalId(FlatBufferBuilder builder, int externalIdOffset) { builder.addOffset(32, externalIdOffset, 0); }
  ...
  public static int endRFGeoLocation_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishRFGeoLocation_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "RFGE"); }
  public static void finishSizePrefixedRFGeoLocation_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "RFGE"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public RFGeoLocation_Abridged get(int j) { return get(new RFGeoLocation_Abridged(), j); }
    public RFGeoLocation_Abridged get(RFGeoLocation_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
