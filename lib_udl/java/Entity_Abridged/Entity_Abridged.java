...
public final class Entity_Abridged extends Table {
  ...
  public static boolean Entity_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "ENTI"); }
  ...
  public static void finishEntity_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "ENTI"); }
  public static void finishSizePrefixedEntity_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "ENTI"); }
