...
public final class Notification_Abridged extends Table {
  ...
  public static Notification_Abridged getRootAsNotification_Abridged(ByteBuffer _bb, Notification_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Notification_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "NOTI"); }
  ...
  public static int createNotification_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endNotification_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishNotification_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "NOTI"); }
  public static void finishSizePrefixedNotification_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "NOTI"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Notification_Abridged get(int j) { return get(new Notification_Abridged(), j); }
    public Notification_Abridged get(Notification_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
