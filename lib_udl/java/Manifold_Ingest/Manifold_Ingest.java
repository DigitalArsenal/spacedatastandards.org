...
public final class Manifold_Ingest extends Table {
  ...
  public static Manifold_Ingest getRootAsManifold_Ingest(ByteBuffer _bb, Manifold_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Manifold_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "MANI"); }
  ...
  public static int createManifold_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endManifold_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishManifold_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "MANI"); }
  public static void finishSizePrefixedManifold_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "MANI"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Manifold_Ingest get(int j) { return get(new Manifold_Ingest(), j); }
    public Manifold_Ingest get(Manifold_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
