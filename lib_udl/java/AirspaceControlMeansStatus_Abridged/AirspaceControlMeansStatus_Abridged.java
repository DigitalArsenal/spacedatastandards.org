...
public final class AirspaceControlMeansStatus_Abridged extends Table {
  ...
  public static AirspaceControlMeansStatus_Abridged getRootAsAirspaceControlMeansStatus_Abridged(ByteBuffer _bb, AirspaceControlMeansStatus_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean AirspaceControlMeansStatus_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "AIRS"); }
  ...
  public static int createAirspaceControlMeansStatus_Abridged(FlatBufferBuilder builder,
      int cmStatOffset,
      int cmStatIdOffset,
  ...
  public static int endAirspaceControlMeansStatus_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAirspaceControlMeansStatus_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "AIRS"); }
  public static void finishSizePrefixedAirspaceControlMeansStatus_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "AIRS"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public AirspaceControlMeansStatus_Abridged get(int j) { return get(new AirspaceControlMeansStatus_Abridged(), j); }
    public AirspaceControlMeansStatus_Abridged get(AirspaceControlMeansStatus_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
