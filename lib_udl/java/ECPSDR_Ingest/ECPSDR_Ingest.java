...
public final class ECPSDR_Ingest extends Table {
  ...
  public static ECPSDR_Ingest getRootAsECPSDR_Ingest(ByteBuffer _bb, ECPSDR_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean ECPSDR_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "ECPS"); }
  ...
  public static int createECPSDR_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endECPSDR_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishECPSDR_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "ECPS"); }
  public static void finishSizePrefixedECPSDR_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "ECPS"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public ECPSDR_Ingest get(int j) { return get(new ECPSDR_Ingest(), j); }
    public ECPSDR_Ingest get(ECPSDR_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
