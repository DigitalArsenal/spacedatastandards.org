...
public final class RFBand extends Table {
  public static void ValidateVersion() { Constants.FLATBUFFERS_24_3_25(); }
  public static RFBand getRootAsRFBand(ByteBuffer _bb) { return getRootAsRFBand(_bb, new RFBand()); }
  public static RFBand getRootAsRFBand(ByteBuffer _bb, RFBand obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean RFBandBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "RFBA"); }
  ...
  public static int createRFBand(FlatBufferBuilder builder,
      int idOffset,
      int idEntityOffset,
  ...
  public static int endRFBand(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishRFBandBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "RFBA"); }
  public static void finishSizePrefixedRFBandBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "RFBA"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public RFBand get(int j) { return get(new RFBand(), j); }
    public RFBand get(RFBand obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
