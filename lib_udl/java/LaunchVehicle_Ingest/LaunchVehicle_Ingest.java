...
public final class LaunchVehicle_Ingest extends Table {
  ...
  public static LaunchVehicle_Ingest getRootAsLaunchVehicle_Ingest(ByteBuffer _bb, LaunchVehicle_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean LaunchVehicle_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "LAUN"); }
  ...
  public static int createLaunchVehicle_Ingest(FlatBufferBuilder builder,
      int idOffset,
      int nameOffset,
  ...
  public static int endLaunchVehicle_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishLaunchVehicle_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "LAUN"); }
  public static void finishSizePrefixedLaunchVehicle_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "LAUN"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public LaunchVehicle_Ingest get(int j) { return get(new LaunchVehicle_Ingest(), j); }
    public LaunchVehicle_Ingest get(LaunchVehicle_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
