...
public final class DiffOfArrival_Ingest extends Table {
  ...
  public static DiffOfArrival_Ingest getRootAsDiffOfArrival_Ingest(ByteBuffer _bb, DiffOfArrival_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean DiffOfArrival_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "DIFF"); }
   ...
   * Constraints: Minimum length = 0, Maximum length = 32
   */
  public String origNetwork() { int o = __offset(86); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer origNetworkAsByteBuffer() { return __vector_as_bytebuffer(86, 1); }
  public ByteBuffer origNetworkInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 86, 1); }
  /**
   * The source data library from which this record was received. This could be a remote or tactical UDL or another data library. If null, the record should be assumed to have originated from the primary Enterprise UDL.
   * Example: /// Example: AXE
   * Constraints: Minimum length = 0, Maximum length = 64
   */
  public String sourceDl() { int o = __offset(88); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer sourceDlAsByteBuffer() { return __vector_as_bytebuffer(88, 1); }
  public ByteBuffer sourceDlInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 88, 1); }

  public static int createDiffOfArrival_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static void addOrigNetwork(FlatBufferBuilder builder, int origNetworkOffset) { builder.addOffset(41, origNetworkOffset, 0); }
  public static void addSourceDl(FlatBufferBuilder builder, int sourceDlOffset) { builder.addOffset(42, sourceDlOffset, 0); }
  public static int endDiffOfArrival_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishDiffOfArrival_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "DIFF"); }
  public static void finishSizePrefixedDiffOfArrival_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "DIFF"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public DiffOfArrival_Ingest get(int j) { return get(new DiffOfArrival_Ingest(), j); }
    public DiffOfArrival_Ingest get(DiffOfArrival_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
