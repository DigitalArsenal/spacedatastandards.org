...
public final class EvacHealthState_Ingest extends Table {
  ...
  public static EvacHealthState_Ingest getRootAsEvacHealthState_Ingest(ByteBuffer _bb, EvacHealthState_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean EvacHealthState_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "EVAC"); }
  ...
  public static int createEvacHealthState_Ingest(FlatBufferBuilder builder,
      int typeOffset,
  ...
  public static int endEvacHealthState_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishEvacHealthState_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "EVAC"); }
  public static void finishSizePrefixedEvacHealthState_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "EVAC"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public EvacHealthState_Ingest get(int j) { return get(new EvacHealthState_Ingest(), j); }
    public EvacHealthState_Ingest get(EvacHealthState_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
