...
public final class DiplomaticClearanceRemarks_Abridged extends Table {
  ...
  public static DiplomaticClearanceRemarks_Abridged getRootAsDiplomaticClearanceRemarks_Abridged(ByteBuffer _bb, DiplomaticClearanceRemarks_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean DiplomaticClearanceRemarks_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "DIPL"); }
  ...
  public static int createDiplomaticClearanceRemarks_Abridged(FlatBufferBuilder builder,
  ...
  public static int endDiplomaticClearanceRemarks_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishDiplomaticClearanceRemarks_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "DIPL"); }
  public static void finishSizePrefixedDiplomaticClearanceRemarks_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "DIPL"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public DiplomaticClearanceRemarks_Abridged get(int j) { return get(new DiplomaticClearanceRemarks_Abridged(), j); }
    public DiplomaticClearanceRemarks_Abridged get(DiplomaticClearanceRemarks_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
