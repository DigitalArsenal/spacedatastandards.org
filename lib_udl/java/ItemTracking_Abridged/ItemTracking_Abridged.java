...
public final class ItemTracking_Abridged extends Table {
  ...
  public static ItemTracking_Abridged getRootAsItemTracking_Abridged(ByteBuffer _bb, ItemTracking_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean ItemTracking_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "ITEM"); }
  ...
  public static int createItemTracking_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endItemTracking_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishItemTracking_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "ITEM"); }
  public static void finishSizePrefixedItemTracking_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "ITEM"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public ItemTracking_Abridged get(int j) { return get(new ItemTracking_Abridged(), j); }
    public ItemTracking_Abridged get(ItemTracking_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
