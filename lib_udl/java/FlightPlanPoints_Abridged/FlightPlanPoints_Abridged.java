...
public final class FlightPlanPoints_Abridged extends Table {
  ...
  public static FlightPlanPoints_Abridged getRootAsFlightPlanPoints_Abridged(ByteBuffer _bb, FlightPlanPoints_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean FlightPlanPoints_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "FLIG"); }
  ...
  public static int createFlightPlanPoints_Abridged(FlatBufferBuilder builder,
      int pointNameOffset,
      double fppLat,
      double fppLon,
      int fppEtaOffset,
  ...
  public static int endFlightPlanPoints_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishFlightPlanPoints_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "FLIG"); }
  public static void finishSizePrefixedFlightPlanPoints_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "FLIG"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public FlightPlanPoints_Abridged get(int j) { return get(new FlightPlanPoints_Abridged(), j); }
    public FlightPlanPoints_Abridged get(FlightPlanPoints_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
