...
public final class Mti_Ingest extends Table {
  public static void ValidateVersion() { Constants.FLATBUFFERS_24_3_25(); }
  public static Mti_Ingest getRootAsMti_Ingest(ByteBuffer _bb) { return getRootAsMti_Ingest(_bb, new Mti_Ingest()); }
  public static Mti_Ingest getRootAsMti_Ingest(ByteBuffer _bb, Mti_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Mti_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "MTII"); }
  ...
  public static int createMti_Ingest(FlatBufferBuilder builder,
  ...
  public static int endMti_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishMti_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "MTII"); }
  public static void finishSizePrefixedMti_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "MTII"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Mti_Ingest get(int j) { return get(new Mti_Ingest(), j); }
    public Mti_Ingest get(Mti_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
