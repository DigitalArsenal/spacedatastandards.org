...
public final class SeradataEarlyWarning_Abridged extends Table {
  ...
  public static SeradataEarlyWarning_Abridged getRootAsSeradataEarlyWarning_Abridged(ByteBuffer _bb, SeradataEarlyWarning_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean SeradataEarlyWarning_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "SERA"); }
  ...
  public static int createSeradataEarlyWarning_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endSeradataEarlyWarning_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishSeradataEarlyWarning_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "SERA"); }
  public static void finishSizePrefixedSeradataEarlyWarning_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "SERA"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public SeradataEarlyWarning_Abridged get(int j) { return get(new SeradataEarlyWarning_Abridged(), j); }
    public SeradataEarlyWarning_Abridged get(SeradataEarlyWarning_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
