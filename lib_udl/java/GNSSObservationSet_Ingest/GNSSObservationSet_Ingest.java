...
public final class GNSSObservationSet_Ingest extends Table {
  ...
  public static GNSSObservationSet_Ingest getRootAsGNSSObservationSet_Ingest(ByteBuffer _bb, GNSSObservationSet_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean GNSSObservationSet_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "GNSS"); }
  ...
  public static int createGNSSObservationSet_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endGNSSObservationSet_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishGNSSObservationSet_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "GNSS"); }
  public static void finishSizePrefixedGNSSObservationSet_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "GNSS"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public GNSSObservationSet_Ingest get(int j) { return get(new GNSSObservationSet_Ingest(), j); }
    public GNSSObservationSet_Ingest get(GNSSObservationSet_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
