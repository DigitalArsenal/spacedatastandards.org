...
public final class AircraftSortie_Ingest extends Table {
  ...
  public static AircraftSortie_Ingest getRootAsAircraftSortie_Ingest(ByteBuffer _bb, AircraftSortie_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean AircraftSortie_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "AIRC"); }
   ...
   * Constraints: Minimum length = 0, Maximum length = 64
   */
  public String sourceDl() { int o = __offset(154); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer sourceDlAsByteBuffer() { return __vector_as_bytebuffer(154, 1); }
  public ByteBuffer sourceDlInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 154, 1); }
  /**
   * Source of the data.
  ...
  public static int createAircraftSortie_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static void addSourceDl(FlatBufferBuilder builder, int sourceDlOffset) { builder.addOffset(75, sourceDlOffset, 0); }
  ...
  public static int endAircraftSortie_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAircraftSortie_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "AIRC"); }
  public static void finishSizePrefixedAircraftSortie_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "AIRC"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public AircraftSortie_Ingest get(int j) { return get(new AircraftSortie_Ingest(), j); }
    public AircraftSortie_Ingest get(AircraftSortie_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
