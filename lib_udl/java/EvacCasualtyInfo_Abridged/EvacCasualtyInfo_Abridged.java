...
public final class EvacCasualtyInfo_Abridged extends Table {
  ...
  public static EvacCasualtyInfo_Abridged getRootAsEvacCasualtyInfo_Abridged(ByteBuffer _bb, EvacCasualtyInfo_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean EvacCasualtyInfo_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "EVAC"); }
  ...
  public static int createEvacCasualtyInfo_Abridged(FlatBufferBuilder builder,
      int priorityOffset,
      int evacTypeOffset,
  ...
  public static int endEvacCasualtyInfo_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishEvacCasualtyInfo_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "EVAC"); }
  public static void finishSizePrefixedEvacCasualtyInfo_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "EVAC"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public EvacCasualtyInfo_Abridged get(int j) { return get(new EvacCasualtyInfo_Abridged(), j); }
    public EvacCasualtyInfo_Abridged get(EvacCasualtyInfo_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
