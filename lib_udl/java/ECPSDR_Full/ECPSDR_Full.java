...
public final class ECPSDR_Full extends Table {
  ...
  public static ECPSDR_Full getRootAsECPSDR_Full(ByteBuffer _bb, ECPSDR_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean ECPSDR_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "ECPS"); }
   ...
   * Constraints: No constraints specified.
   */
  public String updatedAt() { int o = __offset(100); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer updatedAtAsByteBuffer() { return __vector_as_bytebuffer(100, 1); }
  public ByteBuffer updatedAtInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 100, 1); }
  /**
   * Application user who updated the row in the database, auto-populated by the system.
   * Example: /// Example: some.user
   * Constraints: Minimum length = 0, Maximum length = 64
   */
  public String updatedBy() { int o = __offset(102); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer updatedByAsByteBuffer() { return __vector_as_bytebuffer(102, 1); }
  public ByteBuffer updatedByInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 102, 1); }
  /**
   * Source of the data.
   ...
   * Constraints: No constraints specified.
   */
  public String onOrbit() { int o = __offset(112); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer onOrbitAsByteBuffer() { return __vector_as_bytebuffer(112, 1); }
  public ByteBuffer onOrbitInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 112, 1); }

  public static int createECPSDR_Full(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static void addUpdatedAt(FlatBufferBuilder builder, int updatedAtOffset) { builder.addOffset(48, updatedAtOffset, 0); }
  public static void addUpdatedBy(FlatBufferBuilder builder, int updatedByOffset) { builder.addOffset(49, updatedByOffset, 0); }
  ...
  public static void addOnOrbit(FlatBufferBuilder builder, int onOrbitOffset) { builder.addOffset(54, onOrbitOffset, 0); }
  public static int endECPSDR_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishECPSDR_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "ECPS"); }
  public static void finishSizePrefixedECPSDR_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "ECPS"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public ECPSDR_Full get(int j) { return get(new ECPSDR_Full(), j); }
    public ECPSDR_Full get(ECPSDR_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
