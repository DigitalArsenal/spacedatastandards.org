...
public final class EOObservationDetails_Ingest extends Table {
  ...
  public static EOObservationDetails_Ingest getRootAsEOObservationDetails_Ingest(ByteBuffer _bb, EOObservationDetails_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean EOObservationDetails_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "EOOB"); }
  ...
  public static int createEOObservationDetails_Ingest(FlatBufferBuilder builder,
  ...
  public static int endEOObservationDetails_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishEOObservationDetails_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "EOOB"); }
  public static void finishSizePrefixedEOObservationDetails_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "EOOB"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public EOObservationDetails_Ingest get(int j) { return get(new EOObservationDetails_Ingest(), j); }
    public EOObservationDetails_Ingest get(EOObservationDetails_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
