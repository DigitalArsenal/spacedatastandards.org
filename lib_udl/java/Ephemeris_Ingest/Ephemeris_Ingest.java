...
public final class Ephemeris_Ingest extends Table {
  ...
  public static Ephemeris_Ingest getRootAsEphemeris_Ingest(ByteBuffer _bb, Ephemeris_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Ephemeris_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "EPHE"); }
  ...
  public static int createEphemeris_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endEphemeris_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishEphemeris_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "EPHE"); }
  public static void finishSizePrefixedEphemeris_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "EPHE"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Ephemeris_Ingest get(int j) { return get(new Ephemeris_Ingest(), j); }
    public Ephemeris_Ingest get(Ephemeris_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
