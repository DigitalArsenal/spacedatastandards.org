...
public final class GNSSRawIF_Full extends Table {
  ...
  public static GNSSRawIF_Full getRootAsGNSSRawIF_Full(ByteBuffer _bb, GNSSRawIF_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean GNSSRawIF_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "GNSS"); }
  ...
  public static int createGNSSRawIF_Full(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endGNSSRawIF_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishGNSSRawIF_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "GNSS"); }
  public static void finishSizePrefixedGNSSRawIF_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "GNSS"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public GNSSRawIF_Full get(int j) { return get(new GNSSRawIF_Full(), j); }
    public GNSSRawIF_Full get(GNSSRawIF_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
