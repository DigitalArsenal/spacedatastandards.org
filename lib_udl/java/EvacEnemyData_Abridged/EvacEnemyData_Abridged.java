...
public final class EvacEnemyData_Abridged extends Table {
  ...
  public static EvacEnemyData_Abridged getRootAsEvacEnemyData_Abridged(ByteBuffer _bb, EvacEnemyData_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean EvacEnemyData_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "EVAC"); }
  ...
  public static int createEvacEnemyData_Abridged(FlatBufferBuilder builder,
  ...
  public static int endEvacEnemyData_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishEvacEnemyData_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "EVAC"); }
  public static void finishSizePrefixedEvacEnemyData_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "EVAC"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public EvacEnemyData_Abridged get(int j) { return get(new EvacEnemyData_Abridged(), j); }
    public EvacEnemyData_Abridged get(EvacEnemyData_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
