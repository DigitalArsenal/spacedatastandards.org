...
public final class Elset_Full extends Table {
  public static void ValidateVersion() { Constants.FLATBUFFERS_24_3_25(); }
  public static Elset_Full getRootAsElset_Full(ByteBuffer _bb) { return getRootAsElset_Full(_bb, new Elset_Full()); }
  public static Elset_Full getRootAsElset_Full(ByteBuffer _bb, Elset_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Elset_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "ELSE"); }
   ...
   * Constraints: No constraints specified.
   */
  public String effectiveFrom() { int o = __offset(52); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer effectiveFromAsByteBuffer() { return __vector_as_bytebuffer(52, 1); }
  public ByteBuffer effectiveFromInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 52, 1); }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public String effectiveUntil() { int o = __offset(54); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer effectiveUntilAsByteBuffer() { return __vector_as_bytebuffer(54, 1); }
  public ByteBuffer effectiveUntilInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 54, 1); }
  /**
   ...
   */
  public String line1() { int o = __offset(56); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer line1AsByteBuffer() { return __vector_as_bytebuffer(56, 1); }
  public ByteBuffer line1InByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 56, 1); }
  /**
   ...
   * Constraints: Minimum length = 0, Maximum length = 69
   */
  public String line2() { int o = __offset(58); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer line2AsByteBuffer() { return __vector_as_bytebuffer(58, 1); }
  public ByteBuffer line2InByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 58, 1); }
  /**
   * Optional source-provided and searchable metadata or descriptor of the data.
   * Example: /// Example: Example description
   * Constraints: Minimum length = 0, Maximum length = 64
   */
  public String descriptor() { int o = __offset(60); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer descriptorAsByteBuffer() { return __vector_as_bytebuffer(60, 1); }
  public ByteBuffer descriptorInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 60, 1); }
  /**
   ...
   */
  public String rawFileUri() { int o = __offset(66); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer rawFileUriAsByteBuffer() { return __vector_as_bytebuffer(66, 1); }
  public ByteBuffer rawFileUriInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 66, 1); }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public String tags(int j) { int o = __offset(76); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int tagsLength() { int o = __offset(76); return o != 0 ? __vector_len(o) : 0; }
  public StringVector tagsVector() { return tagsVector(new StringVector()); }
  public StringVector tagsVector(StringVector obj) { int o = __offset(76); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   * Optional algorithm used to produce this record.
   * Example: /// Example: Example algorithm
   * Constraints: Minimum length = 0, Maximum length = 64
   */
  public String algorithm() { int o = __offset(78); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer algorithmAsByteBuffer() { return __vector_as_bytebuffer(78, 1); }
  public ByteBuffer algorithmInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 78, 1); }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public String sourcedData(int j) { int o = __offset(80); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int sourcedDataLength() { int o = __offset(80); return o != 0 ? __vector_len(o) : 0; }
  public StringVector sourcedDataVector() { return sourcedDataVector(new StringVector()); }
  public StringVector sourcedDataVector(StringVector obj) { int o = __offset(80); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public byte sourcedDataTypes() { int o = __offset(82); return o != 0 ? bb.get(o + bb_pos) : 0; }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public int ephemType() { int o = __offset(86); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public String onOrbit() { int o = __offset(90); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer onOrbitAsByteBuffer() { return __vector_as_bytebuffer(90, 1); }
  public ByteBuffer onOrbitInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 90, 1); }

  public static int createElset_Full(FlatBufferBuilder builder,
      int idElsetOffset,
  ...
  public static void addEffectiveFrom(FlatBufferBuilder builder, int effectiveFromOffset) { builder.addOffset(24, effectiveFromOffset, 0); }
  public static void addEffectiveUntil(FlatBufferBuilder builder, int effectiveUntilOffset) { builder.addOffset(25, effectiveUntilOffset, 0); }
  public static void addLine1(FlatBufferBuilder builder, int line1Offset) { builder.addOffset(26, line1Offset, 0); }
  public static void addLine2(FlatBufferBuilder builder, int line2Offset) { builder.addOffset(27, line2Offset, 0); }
  public static void addDescriptor(FlatBufferBuilder builder, int descriptorOffset) { builder.addOffset(28, descriptorOffset, 0); }
  ...
  public static void addRawFileUri(FlatBufferBuilder builder, int rawFileUriOffset) { builder.addOffset(31, rawFileUriOffset, 0); }
  ...
  public static void addTags(FlatBufferBuilder builder, int tagsOffset) { builder.addOffset(36, tagsOffset, 0); }
  ...
  public static void addAlgorithm(FlatBufferBuilder builder, int algorithmOffset) { builder.addOffset(37, algorithmOffset, 0); }
  public static void addSourcedData(FlatBufferBuilder builder, int sourcedDataOffset) { builder.addOffset(38, sourcedDataOffset, 0); }
  ...
  public static void addSourcedDataTypes(FlatBufferBuilder builder, byte sourcedDataTypes) { builder.addByte(39, sourcedDataTypes, 0); }
  ...
  public static void addOnOrbit(FlatBufferBuilder builder, int onOrbitOffset) { builder.addOffset(43, onOrbitOffset, 0); }
  public static int endElset_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishElset_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "ELSE"); }
  public static void finishSizePrefixedElset_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "ELSE"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Elset_Full get(int j) { return get(new Elset_Full(), j); }
    public Elset_Full get(Elset_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
