...
public final class LaunchSiteDetails_Full extends Table {
  ...
  public static LaunchSiteDetails_Full getRootAsLaunchSiteDetails_Full(ByteBuffer _bb, LaunchSiteDetails_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean LaunchSiteDetails_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "LAUN"); }
  ...
  public static int createLaunchSiteDetails_Full(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endLaunchSiteDetails_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishLaunchSiteDetails_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "LAUN"); }
  public static void finishSizePrefixedLaunchSiteDetails_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "LAUN"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public LaunchSiteDetails_Full get(int j) { return get(new LaunchSiteDetails_Full(), j); }
    public LaunchSiteDetails_Full get(LaunchSiteDetails_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
