...
public final class Surface_Full extends Table {
  ...
  public static Surface_Full getRootAsSurface_Full(ByteBuffer _bb, Surface_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Surface_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "SURF"); }
  ...
  public static int createSurface_Full(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endSurface_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishSurface_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "SURF"); }
  public static void finishSizePrefixedSurface_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "SURF"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Surface_Full get(int j) { return get(new Surface_Full(), j); }
    public Surface_Full get(Surface_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
