...
public final class ItemTracking_Full extends Table {
  ...
  public static ItemTracking_Full getRootAsItemTracking_Full(ByteBuffer _bb, ItemTracking_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean ItemTracking_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "ITEM"); }
  ...
  public static int createItemTracking_Full(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endItemTracking_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishItemTracking_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "ITEM"); }
  public static void finishSizePrefixedItemTracking_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "ITEM"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public ItemTracking_Full get(int j) { return get(new ItemTracking_Full(), j); }
    public ItemTracking_Full get(ItemTracking_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
