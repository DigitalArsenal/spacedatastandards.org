...
public final class StarCatalog_Ingest extends Table {
  ...
  public static StarCatalog_Ingest getRootAsStarCatalog_Ingest(ByteBuffer _bb, StarCatalog_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean StarCatalog_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "STAR"); }
  ...
  public static int createStarCatalog_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endStarCatalog_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishStarCatalog_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "STAR"); }
  public static void finishSizePrefixedStarCatalog_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "STAR"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public StarCatalog_Ingest get(int j) { return get(new StarCatalog_Ingest(), j); }
    public StarCatalog_Ingest get(StarCatalog_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
