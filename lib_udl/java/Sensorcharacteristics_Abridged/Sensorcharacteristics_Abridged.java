...
public final class Sensorcharacteristics_Abridged extends Table {
  ...
  public static Sensorcharacteristics_Abridged getRootAsSensorcharacteristics_Abridged(ByteBuffer _bb, Sensorcharacteristics_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Sensorcharacteristics_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "SENS"); }
  ...
  public static int createSensorcharacteristics_Abridged(FlatBufferBuilder builder,
      int idOffset,
      int idSensorOffset,
  ...
  public static int endSensorcharacteristics_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishSensorcharacteristics_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "SENS"); }
  public static void finishSizePrefixedSensorcharacteristics_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "SENS"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Sensorcharacteristics_Abridged get(int j) { return get(new Sensorcharacteristics_Abridged(), j); }
    public Sensorcharacteristics_Abridged get(Sensorcharacteristics_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
