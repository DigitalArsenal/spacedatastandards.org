...
public final class VideoStreams_Abridged extends Table {
  ...
  public static VideoStreams_Abridged getRootAsVideoStreams_Abridged(ByteBuffer _bb, VideoStreams_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean VideoStreams_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "VIDE"); }
  ...
  public static int createVideoStreams_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endVideoStreams_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishVideoStreams_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "VIDE"); }
  public static void finishSizePrefixedVideoStreams_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "VIDE"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public VideoStreams_Abridged get(int j) { return get(new VideoStreams_Abridged(), j); }
    public VideoStreams_Abridged get(VideoStreams_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
