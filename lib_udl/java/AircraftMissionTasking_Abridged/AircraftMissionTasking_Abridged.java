...
public final class AircraftMissionTasking_Abridged extends Table {
  ...
  public static AircraftMissionTasking_Abridged getRootAsAircraftMissionTasking_Abridged(ByteBuffer _bb, AircraftMissionTasking_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean AircraftMissionTasking_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "AIRC"); }
  ...
  public static int createAircraftMissionTasking_Abridged(FlatBufferBuilder builder,
  ...
  public static int endAircraftMissionTasking_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAircraftMissionTasking_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "AIRC"); }
  public static void finishSizePrefixedAircraftMissionTasking_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "AIRC"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public AircraftMissionTasking_Abridged get(int j) { return get(new AircraftMissionTasking_Abridged(), j); }
    public AircraftMissionTasking_Abridged get(AircraftMissionTasking_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
