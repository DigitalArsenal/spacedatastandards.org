...
public final class Location_Abridged extends Table {
  ...
  public static boolean Location_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "LOCA"); }
  ...
  public static void finishLocation_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "LOCA"); }
  public static void finishSizePrefixedLocation_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "LOCA"); }
