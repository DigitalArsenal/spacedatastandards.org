...
public final class IonoObservationCharAtts_Ingest extends Table {
  ...
  public static IonoObservationCharAtts_Ingest getRootAsIonoObservationCharAtts_Ingest(ByteBuffer _bb, IonoObservationCharAtts_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean IonoObservationCharAtts_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "IONO"); }
  ...
  public static int createIonoObservationCharAtts_Ingest(FlatBufferBuilder builder,
      int ursiIdOffset,
      int charNameOffset,
      double lowerBound,
      double upperBound,
  ...
  public static int endIonoObservationCharAtts_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishIonoObservationCharAtts_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "IONO"); }
  public static void finishSizePrefixedIonoObservationCharAtts_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "IONO"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public IonoObservationCharAtts_Ingest get(int j) { return get(new IonoObservationCharAtts_Ingest(), j); }
    public IonoObservationCharAtts_Ingest get(IonoObservationCharAtts_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
