...
public final class Equipment_Abridged extends Table {
  ...
  public static Equipment_Abridged getRootAsEquipment_Abridged(ByteBuffer _bb, Equipment_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Equipment_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "EQUI"); }
  ...
  public static int createEquipment_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endEquipment_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishEquipment_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "EQUI"); }
  public static void finishSizePrefixedEquipment_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "EQUI"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Equipment_Abridged get(int j) { return get(new Equipment_Abridged(), j); }
    public Equipment_Abridged get(Equipment_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
