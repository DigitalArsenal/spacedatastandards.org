...
public final class LinkStatus_Full extends Table {
  ...
  public static LinkStatus_Full getRootAsLinkStatus_Full(ByteBuffer _bb, LinkStatus_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean LinkStatus_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "LINK"); }
  ...
  public static int createLinkStatus_Full(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endLinkStatus_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishLinkStatus_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "LINK"); }
  public static void finishSizePrefixedLinkStatus_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "LINK"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public LinkStatus_Full get(int j) { return get(new LinkStatus_Full(), j); }
    public LinkStatus_Full get(LinkStatus_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
