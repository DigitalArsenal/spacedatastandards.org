...
public final class Port_Abridged extends Table {
  ...
  public static Port_Abridged getRootAsPort_Abridged(ByteBuffer _bb, Port_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Port_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "PORT"); }
  ...
  public static int createPort_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endPort_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishPort_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "PORT"); }
  public static void finishSizePrefixedPort_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "PORT"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Port_Abridged get(int j) { return get(new Port_Abridged(), j); }
    public Port_Abridged get(Port_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
