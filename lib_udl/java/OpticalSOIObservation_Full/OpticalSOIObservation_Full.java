...
public final class OpticalSOIObservation_Full extends Table {
  ...
  public static OpticalSOIObservation_Full getRootAsOpticalSOIObservation_Full(ByteBuffer _bb, OpticalSOIObservation_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean OpticalSOIObservation_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "OPTI"); }
  ...
  public static int createOpticalSOIObservation_Full(FlatBufferBuilder builder,
  ...
  public static int endOpticalSOIObservation_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishOpticalSOIObservation_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "OPTI"); }
  public static void finishSizePrefixedOpticalSOIObservation_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "OPTI"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public OpticalSOIObservation_Full get(int j) { return get(new OpticalSOIObservation_Full(), j); }
    public OpticalSOIObservation_Full get(OpticalSOIObservation_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
