...
public final class EffectRequest_Abridged extends Table {
  ...
  public static EffectRequest_Abridged getRootAsEffectRequest_Abridged(ByteBuffer _bb, EffectRequest_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean EffectRequest_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "EFFE"); }
  ...
  public static int createEffectRequest_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endEffectRequest_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishEffectRequest_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "EFFE"); }
  public static void finishSizePrefixedEffectRequest_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "EFFE"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public EffectRequest_Abridged get(int j) { return get(new EffectRequest_Abridged(), j); }
    public EffectRequest_Abridged get(EffectRequest_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
