...
public final class AirTransportMissionHazMat_Ingest extends Table {
  ...
  public static AirTransportMissionHazMat_Ingest getRootAsAirTransportMissionHazMat_Ingest(ByteBuffer _bb, AirTransportMissionHazMat_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean AirTransportMissionHazMat_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "AIRT"); }
  ...
  public static int createAirTransportMissionHazMat_Ingest(FlatBufferBuilder builder,
  ...
  public static int endAirTransportMissionHazMat_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAirTransportMissionHazMat_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "AIRT"); }
  public static void finishSizePrefixedAirTransportMissionHazMat_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "AIRT"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public AirTransportMissionHazMat_Ingest get(int j) { return get(new AirTransportMissionHazMat_Ingest(), j); }
    public AirTransportMissionHazMat_Ingest get(AirTransportMissionHazMat_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
