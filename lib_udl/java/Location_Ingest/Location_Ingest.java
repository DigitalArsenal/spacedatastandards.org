...
public final class Location_Ingest extends Table {
  ...
  public static Location_Ingest getRootAsLocation_Ingest(ByteBuffer _bb, Location_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Location_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "LOCA"); }
  ...
  public static int createLocation_Ingest(FlatBufferBuilder builder,
  ...
  public static int endLocation_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishLocation_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "LOCA"); }
  public static void finishSizePrefixedLocation_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "LOCA"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Location_Ingest get(int j) { return get(new Location_Ingest(), j); }
    public Location_Ingest get(Location_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
