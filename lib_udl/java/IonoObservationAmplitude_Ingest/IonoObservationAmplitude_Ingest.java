...
public final class IonoObservationAmplitude_Ingest extends Table {
  ...
  public static IonoObservationAmplitude_Ingest getRootAsIonoObservationAmplitude_Ingest(ByteBuffer _bb, IonoObservationAmplitude_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean IonoObservationAmplitude_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "IONO"); }
  ...
  public static int createIonoObservationAmplitude_Ingest(FlatBufferBuilder builder,
      int notesOffset,
  ...
  public static int endIonoObservationAmplitude_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishIonoObservationAmplitude_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "IONO"); }
  public static void finishSizePrefixedIonoObservationAmplitude_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "IONO"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public IonoObservationAmplitude_Ingest get(int j) { return get(new IonoObservationAmplitude_Ingest(), j); }
    public IonoObservationAmplitude_Ingest get(IonoObservationAmplitude_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
