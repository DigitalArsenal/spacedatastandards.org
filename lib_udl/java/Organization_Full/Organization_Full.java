...
public final class Organization_Full extends Table {
  ...
  public static Organization_Full getRootAsOrganization_Full(ByteBuffer _bb, Organization_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Organization_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "ORGA"); }
  ...
  public static int createOrganization_Full(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endOrganization_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishOrganization_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "ORGA"); }
  public static void finishSizePrefixedOrganization_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "ORGA"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Organization_Full get(int j) { return get(new Organization_Full(), j); }
    public Organization_Full get(Organization_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
