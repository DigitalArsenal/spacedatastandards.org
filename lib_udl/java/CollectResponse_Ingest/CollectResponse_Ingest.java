...
public final class CollectResponse_Ingest extends Table {
  public static void ValidateVersion() { Constants.FLATBUFFERS_24_3_25(); }
  public static CollectResponse_Ingest getRootAsCollectResponse_Ingest(ByteBuffer _bb) { return getRootAsCollectResponse_Ingest(_bb, new CollectResponse_Ingest()); }
  public static CollectResponse_Ingest getRootAsCollectResponse_Ingest(ByteBuffer _bb, CollectResponse_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean CollectResponse_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "COLL"); }
  public void __init(int _i, ByteBuffer _bb) { __reset(_i, _bb); }
  public CollectResponse_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
   ...
   * Constraints: No constraints specified.
   */
  public String tags(int j) { int o = __offset(56); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int tagsLength() { int o = __offset(56); return o != 0 ? __vector_len(o) : 0; }
  public StringVector tagsVector() { return tagsVector(new StringVector()); }
  public StringVector tagsVector(StringVector obj) { int o = __offset(56); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }

  public static int createCollectResponse_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static void startCollectResponse_Ingest(FlatBufferBuilder builder) { builder.startTable(27); }
  ...
  public static void addTags(FlatBufferBuilder builder, int tagsOffset) { builder.addOffset(26, tagsOffset, 0); }
  ...
  public static int endCollectResponse_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishCollectResponse_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "COLL"); }
  public static void finishSizePrefixedCollectResponse_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "COLL"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public CollectResponse_Ingest get(int j) { return get(new CollectResponse_Ingest(), j); }
    public CollectResponse_Ingest get(CollectResponse_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
