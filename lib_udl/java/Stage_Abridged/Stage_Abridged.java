...
public final class Stage_Abridged extends Table {
  ...
  public static Stage_Abridged getRootAsStage_Abridged(ByteBuffer _bb, Stage_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Stage_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "STAG"); }
  ...
  public static int createStage_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endStage_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishStage_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "STAG"); }
  public static void finishSizePrefixedStage_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "STAG"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Stage_Abridged get(int j) { return get(new Stage_Abridged(), j); }
    public Stage_Abridged get(Stage_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
