...
public final class SensorMaintenance_Ingest extends Table {
  ...
  public static SensorMaintenance_Ingest getRootAsSensorMaintenance_Ingest(ByteBuffer _bb, SensorMaintenance_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean SensorMaintenance_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "SENS"); }
  ...
  public static int createSensorMaintenance_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endSensorMaintenance_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishSensorMaintenance_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "SENS"); }
  public static void finishSizePrefixedSensorMaintenance_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "SENS"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public SensorMaintenance_Ingest get(int j) { return get(new SensorMaintenance_Ingest(), j); }
    public SensorMaintenance_Ingest get(SensorMaintenance_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
