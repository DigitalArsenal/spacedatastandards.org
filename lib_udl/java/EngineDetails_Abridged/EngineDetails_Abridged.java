...
public final class EngineDetails_Abridged extends Table {
  ...
  public static EngineDetails_Abridged getRootAsEngineDetails_Abridged(ByteBuffer _bb, EngineDetails_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean EngineDetails_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "ENGI"); }
  ...
  public static int createEngineDetails_Abridged(FlatBufferBuilder builder,
      int idOffset,
      int idEngineOffset,
  ...
  public static int endEngineDetails_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishEngineDetails_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "ENGI"); }
  public static void finishSizePrefixedEngineDetails_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "ENGI"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public EngineDetails_Abridged get(int j) { return get(new EngineDetails_Abridged(), j); }
    public EngineDetails_Abridged get(EngineDetails_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
