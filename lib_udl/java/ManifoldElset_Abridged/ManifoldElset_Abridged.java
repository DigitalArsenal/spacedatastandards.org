...
public final class ManifoldElset_Abridged extends Table {
  ...
  public static ManifoldElset_Abridged getRootAsManifoldElset_Abridged(ByteBuffer _bb, ManifoldElset_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean ManifoldElset_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "MANI"); }
  ...
  public static int createManifoldElset_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endManifoldElset_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishManifoldElset_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "MANI"); }
  public static void finishSizePrefixedManifoldElset_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "MANI"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public ManifoldElset_Abridged get(int j) { return get(new ManifoldElset_Abridged(), j); }
    public ManifoldElset_Abridged get(ManifoldElset_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
