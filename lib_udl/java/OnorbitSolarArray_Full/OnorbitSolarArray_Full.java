...
public final class OnorbitSolarArray_Full extends Table {
  ...
  public static OnorbitSolarArray_Full getRootAsOnorbitSolarArray_Full(ByteBuffer _bb, OnorbitSolarArray_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean OnorbitSolarArray_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "ONOR"); }
   ...
   * Constraints: No constraints specified.
   */
  public String solarArray() { int o = __offset(28); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer solarArrayAsByteBuffer() { return __vector_as_bytebuffer(28, 1); }
  public ByteBuffer solarArrayInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 28, 1); }
  /**
  ...
  public static int createOnorbitSolarArray_Full(FlatBufferBuilder builder,
      int idOffset,
      int idOnOrbitOffset,
  ...
  public static void addSolarArray(FlatBufferBuilder builder, int solarArrayOffset) { builder.addOffset(12, solarArrayOffset, 0); }
  ...
  public static int endOnorbitSolarArray_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishOnorbitSolarArray_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "ONOR"); }
  public static void finishSizePrefixedOnorbitSolarArray_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "ONOR"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public OnorbitSolarArray_Full get(int j) { return get(new OnorbitSolarArray_Full(), j); }
    public OnorbitSolarArray_Full get(OnorbitSolarArray_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
