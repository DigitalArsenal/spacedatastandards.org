...
public final class LogisticsDiscrepancyInfos_Full extends Table {
  ...
  public static LogisticsDiscrepancyInfos_Full getRootAsLogisticsDiscrepancyInfos_Full(ByteBuffer _bb, LogisticsDiscrepancyInfos_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean LogisticsDiscrepancyInfos_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "LOGI"); }
  ...
  public static int createLogisticsDiscrepancyInfos_Full(FlatBufferBuilder builder,
      int jcnOffset,
  ...
  public static int endLogisticsDiscrepancyInfos_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishLogisticsDiscrepancyInfos_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "LOGI"); }
  public static void finishSizePrefixedLogisticsDiscrepancyInfos_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "LOGI"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public LogisticsDiscrepancyInfos_Full get(int j) { return get(new LogisticsDiscrepancyInfos_Full(), j); }
    public LogisticsDiscrepancyInfos_Full get(LogisticsDiscrepancyInfos_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
