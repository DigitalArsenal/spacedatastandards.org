...
public final class Eop_Full extends Table {
  public static void ValidateVersion() { Constants.FLATBUFFERS_24_3_25(); }
  public static Eop_Full getRootAsEop_Full(ByteBuffer _bb) { return getRootAsEop_Full(_bb, new Eop_Full()); }
  public static Eop_Full getRootAsEop_Full(ByteBuffer _bb, Eop_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Eop_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "EOPF"); }
  ...
  public static int createEop_Full(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endEop_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishEop_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "EOPF"); }
  public static void finishSizePrefixedEop_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "EOPF"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Eop_Full get(int j) { return get(new Eop_Full(), j); }
    public Eop_Full get(Eop_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
