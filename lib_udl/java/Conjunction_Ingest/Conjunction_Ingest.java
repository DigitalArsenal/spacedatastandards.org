...
public final class Conjunction_Ingest extends Table {
  ...
  public static Conjunction_Ingest getRootAsConjunction_Ingest(ByteBuffer _bb, Conjunction_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Conjunction_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "CONJ"); }
   ...
   * Constraints: Minimum length = 0, Maximum length = 36
   */
  public String origIdOnOrbit1() { int o = __offset(136); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer origIdOnOrbit1AsByteBuffer() { return __vector_as_bytebuffer(136, 1); }
  public ByteBuffer origIdOnOrbit1InByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 136, 1); }
  /**
   * Optional place holder for an OnOrbit ID that does not exist in UDL.
   * Example: /// Example: ORIGONORBIT2-ID
   * Constraints: Minimum length = 0, Maximum length = 36
   */
  public String origIdOnOrbit2() { int o = __offset(138); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer origIdOnOrbit2AsByteBuffer() { return __vector_as_bytebuffer(138, 1); }
  public ByteBuffer origIdOnOrbit2InByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 138, 1); }
  /**
   * The originating source network on which this record was created, auto-populated by the system.
   * Example: /// Example: ORIG
   * Constraints: Minimum length = 0, Maximum length = 32
   */
  public String origNetwork() { int o = __offset(140); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer origNetworkAsByteBuffer() { return __vector_as_bytebuffer(140, 1); }
  public ByteBuffer origNetworkInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 140, 1); }

  public static int createConjunction_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static void addOrigIdOnOrbit1(FlatBufferBuilder builder, int origIdOnOrbit1Offset) { builder.addOffset(66, origIdOnOrbit1Offset, 0); }
  public static void addOrigIdOnOrbit2(FlatBufferBuilder builder, int origIdOnOrbit2Offset) { builder.addOffset(67, origIdOnOrbit2Offset, 0); }
  public static void addOrigNetwork(FlatBufferBuilder builder, int origNetworkOffset) { builder.addOffset(68, origNetworkOffset, 0); }
  public static int endConjunction_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishConjunction_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "CONJ"); }
  public static void finishSizePrefixedConjunction_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "CONJ"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Conjunction_Ingest get(int j) { return get(new Conjunction_Ingest(), j); }
    public Conjunction_Ingest get(Conjunction_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
