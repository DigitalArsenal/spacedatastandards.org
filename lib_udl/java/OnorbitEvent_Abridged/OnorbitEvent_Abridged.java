...
public final class OnorbitEvent_Abridged extends Table {
  ...
  public static OnorbitEvent_Abridged getRootAsOnorbitEvent_Abridged(ByteBuffer _bb, OnorbitEvent_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean OnorbitEvent_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "ONOR"); }
  ...
  public static int createOnorbitEvent_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endOnorbitEvent_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishOnorbitEvent_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "ONOR"); }
  public static void finishSizePrefixedOnorbitEvent_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "ONOR"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public OnorbitEvent_Abridged get(int j) { return get(new OnorbitEvent_Abridged(), j); }
    public OnorbitEvent_Abridged get(OnorbitEvent_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
