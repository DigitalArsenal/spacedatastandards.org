...
public final class RFBand_Ingest extends Table {
  ...
  public static RFBand_Ingest getRootAsRFBand_Ingest(ByteBuffer _bb, RFBand_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean RFBand_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "RFBA"); }
  ...
  public static int createRFBand_Ingest(FlatBufferBuilder builder,
      int idOffset,
      int idEntityOffset,
  ...
  public static int endRFBand_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishRFBand_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "RFBA"); }
  public static void finishSizePrefixedRFBand_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "RFBA"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public RFBand_Ingest get(int j) { return get(new RFBand_Ingest(), j); }
    public RFBand_Ingest get(RFBand_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
