...
public final class BeamContour_Abridged extends Table {
  ...
  public static BeamContour_Abridged getRootAsBeamContour_Abridged(ByteBuffer _bb, BeamContour_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean BeamContour_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "BEAM"); }
   ...
   * Constraints: No constraints specified.
   */
  public String geographyText() { int o = __offset(18); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer geographyTextAsByteBuffer() { return __vector_as_bytebuffer(18, 1); }
  public ByteBuffer geographyTextInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 18, 1); }
  /**
   * Geographical region or polygon (lat/lon pairs), as depicted by the GeoJSON representation of the geometry/geography, of the image as projected on the ground. GeoJSON Reference: https://geojson.org/. Ignored if included with a POST or PUT request that also specifies a valid 'area' or 'atext' field.
   * Example: /// Example: {"type":"Polygon","coordinates":[[[67.3291113966927,26.156175339112],[67.2580009640721,26.091022064271],[67.1795862381682,26.6637992964562],[67.2501237475598,26.730115808233],[67.3291113966927,26.156175339112]]]}
   * Constraints: No constraints specified.
   */
  public String geographyJson() { int o = __offset(20); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer geographyJsonAsByteBuffer() { return __vector_as_bytebuffer(20, 1); }
  public ByteBuffer geographyJsonInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 20, 1); }
  /**
   * Type of region as projected.
   * Example: /// Example: ST_Polygon
   * Constraints: Minimum length = 0, Maximum length = 128
   */
  public String geographyType() { int o = __offset(22); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer geographyTypeAsByteBuffer() { return __vector_as_bytebuffer(22, 1); }
  public ByteBuffer geographyTypeInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 22, 1); }
  /**
   * Number of dimensions of the geometry depicted by region.
   * Example: /// Example: No example provided.
   * Constraints: No constraints specified.
   */
  public int geographyNdims() { int o = __offset(24); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  /**
   * Geographical spatial_ref_sys for region.
   * Example: /// Example: 4326
   * Constraints: No constraints specified.
   */
  public int geographySrid() { int o = __offset(26); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  /**
  ...
  public static int createBeamContour_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static void addGeographyText(FlatBufferBuilder builder, int geographyTextOffset) { builder.addOffset(7, geographyTextOffset, 0); }
  public static void addGeographyJson(FlatBufferBuilder builder, int geographyJsonOffset) { builder.addOffset(8, geographyJsonOffset, 0); }
  public static void addGeographyType(FlatBufferBuilder builder, int geographyTypeOffset) { builder.addOffset(9, geographyTypeOffset, 0); }
  ...
  public static int endBeamContour_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishBeamContour_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "BEAM"); }
  public static void finishSizePrefixedBeamContour_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "BEAM"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public BeamContour_Abridged get(int j) { return get(new BeamContour_Abridged(), j); }
    public BeamContour_Abridged get(BeamContour_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
