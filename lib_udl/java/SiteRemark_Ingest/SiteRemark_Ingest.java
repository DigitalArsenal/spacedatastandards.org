...
public final class SiteRemark_Ingest extends Table {
  ...
  public static SiteRemark_Ingest getRootAsSiteRemark_Ingest(ByteBuffer _bb, SiteRemark_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean SiteRemark_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "SITE"); }
  ...
  public static int createSiteRemark_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endSiteRemark_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishSiteRemark_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "SITE"); }
  public static void finishSizePrefixedSiteRemark_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "SITE"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public SiteRemark_Ingest get(int j) { return get(new SiteRemark_Ingest(), j); }
    public SiteRemark_Ingest get(SiteRemark_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
