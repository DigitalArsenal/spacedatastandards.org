...
public final class IonoObservationAmplitude_Full extends Table {
  ...
  public static IonoObservationAmplitude_Full getRootAsIonoObservationAmplitude_Full(ByteBuffer _bb, IonoObservationAmplitude_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean IonoObservationAmplitude_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "IONO"); }
  ...
  public static int createIonoObservationAmplitude_Full(FlatBufferBuilder builder,
      int notesOffset,
  ...
  public static int endIonoObservationAmplitude_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishIonoObservationAmplitude_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "IONO"); }
  public static void finishSizePrefixedIonoObservationAmplitude_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "IONO"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public IonoObservationAmplitude_Full get(int j) { return get(new IonoObservationAmplitude_Full(), j); }
    public IonoObservationAmplitude_Full get(IonoObservationAmplitude_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
