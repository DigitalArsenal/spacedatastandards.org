...
public final class Onorbit_Full extends Table {
  ...
  public static Onorbit_Full getRootAsOnorbit_Full(ByteBuffer _bb, Onorbit_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Onorbit_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "ONOR"); }
   ...
   * Constraints: No constraints specified.
   */
  public String entityCollection(int j) { int o = __offset(60); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int entityCollectionLength() { int o = __offset(60); return o != 0 ? __vector_len(o) : 0; }
  public StringVector entityCollectionVector() { return entityCollectionVector(new StringVector()); }
  public StringVector entityCollectionVector(StringVector obj) { int o = __offset(60); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }

  public static int createOnorbit_Full(FlatBufferBuilder builder,
      int idOnOrbitOffset,
  ...
  public static void addEntityCollection(FlatBufferBuilder builder, int entityCollectionOffset) { builder.addOffset(28, entityCollectionOffset, 0); }
  ...
  public static int endOnorbit_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishOnorbit_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "ONOR"); }
  public static void finishSizePrefixedOnorbit_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "ONOR"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Onorbit_Full get(int j) { return get(new Onorbit_Full(), j); }
    public Onorbit_Full get(Onorbit_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
