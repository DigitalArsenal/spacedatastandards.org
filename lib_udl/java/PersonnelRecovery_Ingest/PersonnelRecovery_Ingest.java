...
public final class PersonnelRecovery_Ingest extends Table {
  ...
  public static PersonnelRecovery_Ingest getRootAsPersonnelRecovery_Ingest(ByteBuffer _bb, PersonnelRecovery_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean PersonnelRecovery_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "PERS"); }
  ...
  public static int createPersonnelRecovery_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endPersonnelRecovery_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishPersonnelRecovery_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "PERS"); }
  public static void finishSizePrefixedPersonnelRecovery_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "PERS"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public PersonnelRecovery_Ingest get(int j) { return get(new PersonnelRecovery_Ingest(), j); }
    public PersonnelRecovery_Ingest get(PersonnelRecovery_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
