...
public final class AircraftMissionRequirements_Abridged extends Table {
  ...
  public static AircraftMissionRequirements_Abridged getRootAsAircraftMissionRequirements_Abridged(ByteBuffer _bb, AircraftMissionRequirements_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean AircraftMissionRequirements_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "AIRC"); }
  ...
  public static int createAircraftMissionRequirements_Abridged(FlatBufferBuilder builder,
      int gdssReqIdOffset,
      int onloadId,
  ...
  public static int endAircraftMissionRequirements_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAircraftMissionRequirements_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "AIRC"); }
  public static void finishSizePrefixedAircraftMissionRequirements_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "AIRC"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public AircraftMissionRequirements_Abridged get(int j) { return get(new AircraftMissionRequirements_Abridged(), j); }
    public AircraftMissionRequirements_Abridged get(AircraftMissionRequirements_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
