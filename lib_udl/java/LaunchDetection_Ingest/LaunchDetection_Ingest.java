...
public final class LaunchDetection_Ingest extends Table {
  ...
  public static LaunchDetection_Ingest getRootAsLaunchDetection_Ingest(ByteBuffer _bb, LaunchDetection_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean LaunchDetection_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "LAUN"); }
  ...
  public static int createLaunchDetection_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endLaunchDetection_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishLaunchDetection_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "LAUN"); }
  public static void finishSizePrefixedLaunchDetection_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "LAUN"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public LaunchDetection_Ingest get(int j) { return get(new LaunchDetection_Ingest(), j); }
    public LaunchDetection_Ingest get(LaunchDetection_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
