...
public final class AirspaceControlPoint_Abridged extends Table {
  ...
  public static AirspaceControlPoint_Abridged getRootAsAirspaceControlPoint_Abridged(ByteBuffer _bb, AirspaceControlPoint_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean AirspaceControlPoint_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "AIRS"); }
  ...
  public static int createAirspaceControlPoint_Abridged(FlatBufferBuilder builder,
  ...
  public static int endAirspaceControlPoint_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAirspaceControlPoint_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "AIRS"); }
  public static void finishSizePrefixedAirspaceControlPoint_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "AIRS"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public AirspaceControlPoint_Abridged get(int j) { return get(new AirspaceControlPoint_Abridged(), j); }
    public AirspaceControlPoint_Abridged get(AirspaceControlPoint_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
