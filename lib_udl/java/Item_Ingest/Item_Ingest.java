...
public final class Item_Ingest extends Table {
  ...
  public static Item_Ingest getRootAsItem_Ingest(ByteBuffer _bb, Item_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Item_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "ITEM"); }
  ...
  public static int createItem_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endItem_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishItem_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "ITEM"); }
  public static void finishSizePrefixedItem_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "ITEM"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Item_Ingest get(int j) { return get(new Item_Ingest(), j); }
    public Item_Ingest get(Item_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
