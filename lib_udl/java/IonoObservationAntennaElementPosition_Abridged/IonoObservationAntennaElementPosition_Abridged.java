...
public final class IonoObservationAntennaElementPosition_Abridged extends Table {
  ...
  public static IonoObservationAntennaElementPosition_Abridged getRootAsIonoObservationAntennaElementPosition_Abridged(ByteBuffer _bb, IonoObservationAntennaElementPosition_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean IonoObservationAntennaElementPosition_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "IONO"); }
  ...
  public static int createIonoObservationAntennaElementPosition_Abridged(FlatBufferBuilder builder,
  ...
  public static int endIonoObservationAntennaElementPosition_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishIonoObservationAntennaElementPosition_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "IONO"); }
  public static void finishSizePrefixedIonoObservationAntennaElementPosition_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "IONO"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public IonoObservationAntennaElementPosition_Abridged get(int j) { return get(new IonoObservationAntennaElementPosition_Abridged(), j); }
    public IonoObservationAntennaElementPosition_Abridged get(IonoObservationAntennaElementPosition_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
