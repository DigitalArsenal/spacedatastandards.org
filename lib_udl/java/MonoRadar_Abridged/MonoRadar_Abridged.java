...
public final class MonoRadar_Abridged extends Table {
  ...
  public static MonoRadar_Abridged getRootAsMonoRadar_Abridged(ByteBuffer _bb, MonoRadar_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean MonoRadar_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "MONO"); }
  ...
  public static int createMonoRadar_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endMonoRadar_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishMonoRadar_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "MONO"); }
  public static void finishSizePrefixedMonoRadar_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "MONO"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public MonoRadar_Abridged get(int j) { return get(new MonoRadar_Abridged(), j); }
    public MonoRadar_Abridged get(MonoRadar_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
