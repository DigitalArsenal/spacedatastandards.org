...
public final class AirTransportMissionHazMat_Abridged extends Table {
  ...
  public static AirTransportMissionHazMat_Abridged getRootAsAirTransportMissionHazMat_Abridged(ByteBuffer _bb, AirTransportMissionHazMat_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean AirTransportMissionHazMat_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "AIRT"); }
  ...
  public static int createAirTransportMissionHazMat_Abridged(FlatBufferBuilder builder,
  ...
  public static int endAirTransportMissionHazMat_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAirTransportMissionHazMat_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "AIRT"); }
  public static void finishSizePrefixedAirTransportMissionHazMat_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "AIRT"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public AirTransportMissionHazMat_Abridged get(int j) { return get(new AirTransportMissionHazMat_Abridged(), j); }
    public AirTransportMissionHazMat_Abridged get(AirTransportMissionHazMat_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
