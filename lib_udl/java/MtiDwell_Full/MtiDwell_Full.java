...
public final class MtiDwell_Full extends Table {
  ...
  public static MtiDwell_Full getRootAsMtiDwell_Full(ByteBuffer _bb, MtiDwell_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean MtiDwell_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "MTID"); }
  ...
  public static int createMtiDwell_Full(FlatBufferBuilder builder,
      int d2,
      int d3,
      boolean d4,
      int d5,
  ...
  public static int endMtiDwell_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishMtiDwell_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "MTID"); }
  public static void finishSizePrefixedMtiDwell_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "MTID"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public MtiDwell_Full get(int j) { return get(new MtiDwell_Full(), j); }
    public MtiDwell_Full get(MtiDwell_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
