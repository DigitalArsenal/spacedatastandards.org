...
public final class SeradataCommDetails_Full extends Table {
  ...
  public static SeradataCommDetails_Full getRootAsSeradataCommDetails_Full(ByteBuffer _bb, SeradataCommDetails_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean SeradataCommDetails_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "SERA"); }
  ...
  public static int createSeradataCommDetails_Full(FlatBufferBuilder builder,
      int idOffset,
      int idCommOffset,
  ...
  public static int endSeradataCommDetails_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishSeradataCommDetails_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "SERA"); }
  public static void finishSizePrefixedSeradataCommDetails_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "SERA"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public SeradataCommDetails_Full get(int j) { return get(new SeradataCommDetails_Full(), j); }
    public SeradataCommDetails_Full get(SeradataCommDetails_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
