...
public final class IonoObservationPower_Ingest extends Table {
  ...
  public static IonoObservationPower_Ingest getRootAsIonoObservationPower_Ingest(ByteBuffer _bb, IonoObservationPower_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean IonoObservationPower_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "IONO"); }
  ...
  public static int createIonoObservationPower_Ingest(FlatBufferBuilder builder,
      int notesOffset,
  ...
  public static int endIonoObservationPower_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishIonoObservationPower_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "IONO"); }
  public static void finishSizePrefixedIonoObservationPower_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "IONO"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public IonoObservationPower_Ingest get(int j) { return get(new IonoObservationPower_Ingest(), j); }
    public IonoObservationPower_Ingest get(IonoObservationPower_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
