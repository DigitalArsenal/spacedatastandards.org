...
public final class Evac_Full extends Table {
  public static void ValidateVersion() { Constants.FLATBUFFERS_24_3_25(); }
  public static Evac_Full getRootAsEvac_Full(ByteBuffer _bb) { return getRootAsEvac_Full(_bb, new Evac_Full()); }
  public static Evac_Full getRootAsEvac_Full(ByteBuffer _bb, Evac_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Evac_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "EVAC"); }
   ...
   * Constraints: No constraints specified.
   */
  public String relatedDocs(int j) { int o = __offset(72); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int relatedDocsLength() { int o = __offset(72); return o != 0 ? __vector_len(o) : 0; }
  public StringVector relatedDocsVector() { return relatedDocsVector(new StringVector()); }
  public StringVector relatedDocsVector(StringVector obj) { int o = __offset(72); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   ...
   */
  public String source() { int o = __offset(80); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer sourceAsByteBuffer() { return __vector_as_bytebuffer(80, 1); }
  public ByteBuffer sourceInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 80, 1); }
  /**
   * Originating system or organization which produced the data, if different from the source. The origin may be different than the source if the source was a mediating system which forwarded the data on behalf of the origin system. If null, the source may be assumed to be the origin.
   * Example: /// Example: THIRD_PARTY_DATASOURCE
   * Constraints: Minimum length = 0, Maximum length = 64
   */
  public String origin() { int o = __offset(82); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer originAsByteBuffer() { return __vector_as_bytebuffer(82, 1); }
  public ByteBuffer originInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 82, 1); }
  /**
  ...
  public static int createEvac_Full(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static void addRelatedDocs(FlatBufferBuilder builder, int relatedDocsOffset) { builder.addOffset(34, relatedDocsOffset, 0); }
  ...
  public static void addSource(FlatBufferBuilder builder, int sourceOffset) { builder.addOffset(38, sourceOffset, 0); }
  public static void addOrigin(FlatBufferBuilder builder, int originOffset) { builder.addOffset(39, originOffset, 0); }
  public static void addDataMode(FlatBufferBuilder builder, byte dataMode) { builder.addByte(40, dataMode, 0); }
  public static int endEvac_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishEvac_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "EVAC"); }
  public static void finishSizePrefixedEvac_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "EVAC"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Evac_Full get(int j) { return get(new Evac_Full(), j); }
    public Evac_Full get(Evac_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
