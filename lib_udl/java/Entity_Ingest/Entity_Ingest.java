...
public final class Entity_Ingest extends Table {
  ...
  public static Entity_Ingest getRootAsEntity_Ingest(ByteBuffer _bb, Entity_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Entity_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "ENTI"); }
   ...
   * Constraints: No constraints specified.
   */
  public String onOrbit() { int o = __offset(34); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer onOrbitAsByteBuffer() { return __vector_as_bytebuffer(34, 1); }
  public ByteBuffer onOrbitInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 34, 1); }
  /**
   ...
   * Constraints: Minimum length = 0, Maximum length = 36
   */
  public String idOnOrbit() { int o = __offset(36); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer idOnOrbitAsByteBuffer() { return __vector_as_bytebuffer(36, 1); }
  public ByteBuffer idOnOrbitInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 36, 1); }
  /**
   * Unique identifier of the associated operating unit object.
   * Example: /// Example: OPERATINGUNIT-ID
   * Constraints: Minimum length = 0, Maximum length = 36
   */
  public String idOperatingUnit() { int o = __offset(38); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer idOperatingUnitAsByteBuffer() { return __vector_as_bytebuffer(38, 1); }
  public ByteBuffer idOperatingUnitInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 38, 1); }
  /**
  ...
  public static int createEntity_Ingest(FlatBufferBuilder builder,
      int idEntityOffset,
      int nameOffset,
  ...
  public static void addOnOrbit(FlatBufferBuilder builder, int onOrbitOffset) { builder.addOffset(15, onOrbitOffset, 0); }
  public static void addIdOnOrbit(FlatBufferBuilder builder, int idOnOrbitOffset) { builder.addOffset(16, idOnOrbitOffset, 0); }
  public static void addIdOperatingUnit(FlatBufferBuilder builder, int idOperatingUnitOffset) { builder.addOffset(17, idOperatingUnitOffset, 0); }
  ...
  public static int endEntity_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishEntity_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "ENTI"); }
  public static void finishSizePrefixedEntity_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "ENTI"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Entity_Ingest get(int j) { return get(new Entity_Ingest(), j); }
    public Entity_Ingest get(Entity_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
