...
public final class IonoObservationTime_Ingest extends Table {
  ...
  public static IonoObservationTime_Ingest getRootAsIonoObservationTime_Ingest(ByteBuffer _bb, IonoObservationTime_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean IonoObservationTime_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "IONO"); }
  ...
  public static int createIonoObservationTime_Ingest(FlatBufferBuilder builder,
  ...
  public static int endIonoObservationTime_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishIonoObservationTime_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "IONO"); }
  public static void finishSizePrefixedIonoObservationTime_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "IONO"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public IonoObservationTime_Ingest get(int j) { return get(new IonoObservationTime_Ingest(), j); }
    public IonoObservationTime_Ingest get(IonoObservationTime_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
