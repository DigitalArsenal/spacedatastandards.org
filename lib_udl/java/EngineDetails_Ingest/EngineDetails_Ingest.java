...
public final class EngineDetails_Ingest extends Table {
  ...
  public static EngineDetails_Ingest getRootAsEngineDetails_Ingest(ByteBuffer _bb, EngineDetails_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean EngineDetails_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "ENGI"); }
  ...
  public static int createEngineDetails_Ingest(FlatBufferBuilder builder,
      int idOffset,
      int idEngineOffset,
  ...
  public static int endEngineDetails_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishEngineDetails_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "ENGI"); }
  public static void finishSizePrefixedEngineDetails_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "ENGI"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public EngineDetails_Ingest get(int j) { return get(new EngineDetails_Ingest(), j); }
    public EngineDetails_Ingest get(EngineDetails_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
