...
public final class EvacEtiology_Full extends Table {
  ...
  public static EvacEtiology_Full getRootAsEvacEtiology_Full(ByteBuffer _bb, EvacEtiology_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean EvacEtiology_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "EVAC"); }
  ...
  public static int createEvacEtiology_Full(FlatBufferBuilder builder,
      int typeOffset,
      int bodyPartOffset,
      int timeOffset,
      int commentsOffset) {
  ...
  public static int endEvacEtiology_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishEvacEtiology_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "EVAC"); }
  public static void finishSizePrefixedEvacEtiology_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "EVAC"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public EvacEtiology_Full get(int j) { return get(new EvacEtiology_Full(), j); }
    public EvacEtiology_Full get(EvacEtiology_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
