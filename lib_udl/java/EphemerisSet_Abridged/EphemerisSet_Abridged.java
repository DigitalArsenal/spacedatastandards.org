...
public final class EphemerisSet_Abridged extends Table {
  ...
  public static EphemerisSet_Abridged getRootAsEphemerisSet_Abridged(ByteBuffer _bb, EphemerisSet_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean EphemerisSet_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "EPHE"); }
  ...
  public static int createEphemerisSet_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endEphemerisSet_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishEphemerisSet_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "EPHE"); }
  public static void finishSizePrefixedEphemerisSet_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "EPHE"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public EphemerisSet_Abridged get(int j) { return get(new EphemerisSet_Abridged(), j); }
    public EphemerisSet_Abridged get(EphemerisSet_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
