...
public final class MonoRadar_Ingest extends Table {
  ...
  public static MonoRadar_Ingest getRootAsMonoRadar_Ingest(ByteBuffer _bb, MonoRadar_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean MonoRadar_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "MONO"); }
  ...
  public static int createMonoRadar_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endMonoRadar_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishMonoRadar_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "MONO"); }
  public static void finishSizePrefixedMonoRadar_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "MONO"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public MonoRadar_Ingest get(int j) { return get(new MonoRadar_Ingest(), j); }
    public MonoRadar_Ingest get(MonoRadar_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
