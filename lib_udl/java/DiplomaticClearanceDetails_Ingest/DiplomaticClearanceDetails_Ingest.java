...
public final class DiplomaticClearanceDetails_Ingest extends Table {
  ...
  public static DiplomaticClearanceDetails_Ingest getRootAsDiplomaticClearanceDetails_Ingest(ByteBuffer _bb, DiplomaticClearanceDetails_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean DiplomaticClearanceDetails_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "DIPL"); }
  ...
  public static int createDiplomaticClearanceDetails_Ingest(FlatBufferBuilder builder,
      int idSortieOffset,
      int legNum,
  ...
  public static int endDiplomaticClearanceDetails_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishDiplomaticClearanceDetails_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "DIPL"); }
  public static void finishSizePrefixedDiplomaticClearanceDetails_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "DIPL"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public DiplomaticClearanceDetails_Ingest get(int j) { return get(new DiplomaticClearanceDetails_Ingest(), j); }
    public DiplomaticClearanceDetails_Ingest get(DiplomaticClearanceDetails_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
