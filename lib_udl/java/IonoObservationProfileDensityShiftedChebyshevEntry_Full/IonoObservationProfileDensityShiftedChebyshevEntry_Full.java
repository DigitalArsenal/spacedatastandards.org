...
public final class IonoObservationProfileDensityShiftedChebyshevEntry_Full extends Table {
  ...
  public static IonoObservationProfileDensityShiftedChebyshevEntry_Full getRootAsIonoObservationProfileDensityShiftedChebyshevEntry_Full(ByteBuffer _bb, IonoObservationProfileDensityShiftedChebyshevEntry_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean IonoObservationProfileDensityShiftedChebyshevEntry_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "IONO"); }
  ...
  public static int createIonoObservationProfileDensityShiftedChebyshevEntry_Full(FlatBufferBuilder builder,
      int layerOffset,
      double fstart,
      double fstop,
      double peakheight,
  ...
  public static int endIonoObservationProfileDensityShiftedChebyshevEntry_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishIonoObservationProfileDensityShiftedChebyshevEntry_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "IONO"); }
  public static void finishSizePrefixedIonoObservationProfileDensityShiftedChebyshevEntry_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "IONO"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public IonoObservationProfileDensityShiftedChebyshevEntry_Full get(int j) { return get(new IonoObservationProfileDensityShiftedChebyshevEntry_Full(), j); }
    public IonoObservationProfileDensityShiftedChebyshevEntry_Full get(IonoObservationProfileDensityShiftedChebyshevEntry_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
