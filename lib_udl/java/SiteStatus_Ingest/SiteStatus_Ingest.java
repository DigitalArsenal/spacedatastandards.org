...
public final class SiteStatus_Ingest extends Table {
  ...
  public static SiteStatus_Ingest getRootAsSiteStatus_Ingest(ByteBuffer _bb, SiteStatus_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean SiteStatus_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "SITE"); }
  ...
  public static int createSiteStatus_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endSiteStatus_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishSiteStatus_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "SITE"); }
  public static void finishSizePrefixedSiteStatus_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "SITE"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public SiteStatus_Ingest get(int j) { return get(new SiteStatus_Ingest(), j); }
    public SiteStatus_Ingest get(SiteStatus_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
