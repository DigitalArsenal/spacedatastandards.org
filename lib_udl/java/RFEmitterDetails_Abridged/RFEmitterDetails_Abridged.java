...
public final class RFEmitterDetails_Abridged extends Table {
  ...
  public static RFEmitterDetails_Abridged getRootAsRFEmitterDetails_Abridged(ByteBuffer _bb, RFEmitterDetails_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean RFEmitterDetails_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "RFEM"); }
  ...
  public static int createRFEmitterDetails_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endRFEmitterDetails_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishRFEmitterDetails_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "RFEM"); }
  public static void finishSizePrefixedRFEmitterDetails_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "RFEM"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public RFEmitterDetails_Abridged get(int j) { return get(new RFEmitterDetails_Abridged(), j); }
    public RFEmitterDetails_Abridged get(RFEmitterDetails_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
