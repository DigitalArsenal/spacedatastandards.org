...
public final class SeradataRadarPayload_Abridged extends Table {
  ...
  public static SeradataRadarPayload_Abridged getRootAsSeradataRadarPayload_Abridged(ByteBuffer _bb, SeradataRadarPayload_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean SeradataRadarPayload_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "SERA"); }
  ...
  public static int createSeradataRadarPayload_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endSeradataRadarPayload_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishSeradataRadarPayload_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "SERA"); }
  public static void finishSizePrefixedSeradataRadarPayload_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "SERA"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public SeradataRadarPayload_Abridged get(int j) { return get(new SeradataRadarPayload_Abridged(), j); }
    public SeradataRadarPayload_Abridged get(SeradataRadarPayload_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
