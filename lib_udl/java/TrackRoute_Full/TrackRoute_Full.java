...
public final class TrackRoute_Full extends Table {
  ...
  public static TrackRoute_Full getRootAsTrackRoute_Full(ByteBuffer _bb, TrackRoute_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean TrackRoute_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "TRAC"); }
  ...
  public static int createTrackRoute_Full(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endTrackRoute_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishTrackRoute_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "TRAC"); }
  public static void finishSizePrefixedTrackRoute_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "TRAC"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public TrackRoute_Full get(int j) { return get(new TrackRoute_Full(), j); }
    public TrackRoute_Full get(TrackRoute_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
