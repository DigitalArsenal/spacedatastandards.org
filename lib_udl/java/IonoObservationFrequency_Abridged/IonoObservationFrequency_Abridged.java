...
public final class IonoObservationFrequency_Abridged extends Table {
  ...
  public static IonoObservationFrequency_Abridged getRootAsIonoObservationFrequency_Abridged(ByteBuffer _bb, IonoObservationFrequency_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean IonoObservationFrequency_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "IONO"); }
  ...
  public static int createIonoObservationFrequency_Abridged(FlatBufferBuilder builder,
      int notesOffset,
  ...
  public static int endIonoObservationFrequency_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishIonoObservationFrequency_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "IONO"); }
  public static void finishSizePrefixedIonoObservationFrequency_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "IONO"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public IonoObservationFrequency_Abridged get(int j) { return get(new IonoObservationFrequency_Abridged(), j); }
    public IonoObservationFrequency_Abridged get(IonoObservationFrequency_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
