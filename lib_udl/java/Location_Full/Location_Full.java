...
public final class Location_Full extends Table {
  ...
  public static Location_Full getRootAsLocation_Full(ByteBuffer _bb, Location_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Location_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "LOCA"); }
  ...
  public static int createLocation_Full(FlatBufferBuilder builder,
  ...
  public static int endLocation_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishLocation_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "LOCA"); }
  public static void finishSizePrefixedLocation_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "LOCA"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Location_Full get(int j) { return get(new Location_Full(), j); }
    public Location_Full get(Location_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
