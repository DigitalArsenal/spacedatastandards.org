...
public final class SeradataSigIntPayload_Abridged extends Table {
  ...
  public static SeradataSigIntPayload_Abridged getRootAsSeradataSigIntPayload_Abridged(ByteBuffer _bb, SeradataSigIntPayload_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean SeradataSigIntPayload_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "SERA"); }
  ...
  public static int createSeradataSigIntPayload_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endSeradataSigIntPayload_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishSeradataSigIntPayload_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "SERA"); }
  public static void finishSizePrefixedSeradataSigIntPayload_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "SERA"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public SeradataSigIntPayload_Abridged get(int j) { return get(new SeradataSigIntPayload_Abridged(), j); }
    public SeradataSigIntPayload_Abridged get(SeradataSigIntPayload_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
