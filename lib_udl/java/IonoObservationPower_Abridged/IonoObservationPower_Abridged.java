...
public final class IonoObservationPower_Abridged extends Table {
  ...
  public static IonoObservationPower_Abridged getRootAsIonoObservationPower_Abridged(ByteBuffer _bb, IonoObservationPower_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean IonoObservationPower_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "IONO"); }
  ...
  public static int createIonoObservationPower_Abridged(FlatBufferBuilder builder,
      int notesOffset,
  ...
  public static int endIonoObservationPower_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishIonoObservationPower_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "IONO"); }
  public static void finishSizePrefixedIonoObservationPower_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "IONO"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public IonoObservationPower_Abridged get(int j) { return get(new IonoObservationPower_Abridged(), j); }
    public IonoObservationPower_Abridged get(IonoObservationPower_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
