...
public final class Track_Full extends Table {
  public static void ValidateVersion() { Constants.FLATBUFFERS_24_3_25(); }
  public static Track_Full getRootAsTrack_Full(ByteBuffer _bb) { return getRootAsTrack_Full(_bb, new Track_Full()); }
  public static Track_Full getRootAsTrack_Full(ByteBuffer _bb, Track_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Track_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "TRAC"); }
  ...
  public static int createTrack_Full(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endTrack_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishTrack_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "TRAC"); }
  public static void finishSizePrefixedTrack_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "TRAC"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Track_Full get(int j) { return get(new Track_Full(), j); }
    public Track_Full get(Track_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
