...
public final class LaunchSite_Ingest extends Table {
  ...
  public static LaunchSite_Ingest getRootAsLaunchSite_Ingest(ByteBuffer _bb, LaunchSite_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean LaunchSite_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "LAUN"); }
  ...
  public static int createLaunchSite_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endLaunchSite_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishLaunchSite_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "LAUN"); }
  public static void finishSizePrefixedLaunchSite_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "LAUN"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public LaunchSite_Ingest get(int j) { return get(new LaunchSite_Ingest(), j); }
    public LaunchSite_Ingest get(LaunchSite_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
