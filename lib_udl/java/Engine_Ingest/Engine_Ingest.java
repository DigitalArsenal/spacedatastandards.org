...
public final class Engine_Ingest extends Table {
  ...
  public static Engine_Ingest getRootAsEngine_Ingest(ByteBuffer _bb, Engine_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Engine_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "ENGI"); }
  ...
  public static int createEngine_Ingest(FlatBufferBuilder builder,
      int idOffset,
      int nameOffset,
  ...
  public static int endEngine_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishEngine_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "ENGI"); }
  public static void finishSizePrefixedEngine_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "ENGI"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Engine_Ingest get(int j) { return get(new Engine_Ingest(), j); }
    public Engine_Ingest get(Engine_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
