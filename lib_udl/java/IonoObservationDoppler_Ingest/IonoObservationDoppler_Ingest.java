...
public final class IonoObservationDoppler_Ingest extends Table {
  ...
  public static IonoObservationDoppler_Ingest getRootAsIonoObservationDoppler_Ingest(ByteBuffer _bb, IonoObservationDoppler_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean IonoObservationDoppler_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "IONO"); }
  ...
  public static int createIonoObservationDoppler_Ingest(FlatBufferBuilder builder,
      int notesOffset,
  ...
  public static int endIonoObservationDoppler_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishIonoObservationDoppler_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "IONO"); }
  public static void finishSizePrefixedIonoObservationDoppler_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "IONO"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public IonoObservationDoppler_Ingest get(int j) { return get(new IonoObservationDoppler_Ingest(), j); }
    public IonoObservationDoppler_Ingest get(IonoObservationDoppler_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
