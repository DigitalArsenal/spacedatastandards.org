...
public final class IonoObservationRange_Abridged extends Table {
  ...
  public static IonoObservationRange_Abridged getRootAsIonoObservationRange_Abridged(ByteBuffer _bb, IonoObservationRange_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean IonoObservationRange_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "IONO"); }
  ...
  public static int createIonoObservationRange_Abridged(FlatBufferBuilder builder,
      int notesOffset,
  ...
  public static int endIonoObservationRange_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishIonoObservationRange_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "IONO"); }
  public static void finishSizePrefixedIonoObservationRange_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "IONO"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public IonoObservationRange_Abridged get(int j) { return get(new IonoObservationRange_Abridged(), j); }
    public IonoObservationRange_Abridged get(IonoObservationRange_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
