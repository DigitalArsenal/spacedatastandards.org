...
public final class SensorStats_Full extends Table {
  ...
  public static SensorStats_Full getRootAsSensorStats_Full(ByteBuffer _bb, SensorStats_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean SensorStats_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "SENS"); }
  ...
  public static int createSensorStats_Full(FlatBufferBuilder builder,
      int idOffset,
      int idSensorOffset,
  ...
  public static int endSensorStats_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishSensorStats_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "SENS"); }
  public static void finishSizePrefixedSensorStats_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "SENS"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public SensorStats_Full get(int j) { return get(new SensorStats_Full(), j); }
    public SensorStats_Full get(SensorStats_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
