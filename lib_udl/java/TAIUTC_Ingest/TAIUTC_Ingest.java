...
public final class TAIUTC_Ingest extends Table {
  ...
  public static TAIUTC_Ingest getRootAsTAIUTC_Ingest(ByteBuffer _bb, TAIUTC_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean TAIUTC_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "TAIU"); }
  ...
  public static int createTAIUTC_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endTAIUTC_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishTAIUTC_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "TAIU"); }
  public static void finishSizePrefixedTAIUTC_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "TAIU"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public TAIUTC_Ingest get(int j) { return get(new TAIUTC_Ingest(), j); }
    public TAIUTC_Ingest get(TAIUTC_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
