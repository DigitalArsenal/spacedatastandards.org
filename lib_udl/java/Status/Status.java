...
public final class Status extends Table {
  ...
  public static boolean StatusBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "STAT"); }
  ...
  public static void finishStatusBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "STAT"); }
  public static void finishSizePrefixedStatusBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "STAT"); }
