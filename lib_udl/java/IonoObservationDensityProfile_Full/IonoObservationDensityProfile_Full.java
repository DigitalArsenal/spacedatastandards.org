...
public final class IonoObservationDensityProfile_Full extends Table {
  ...
  public static IonoObservationDensityProfile_Full getRootAsIonoObservationDensityProfile_Full(ByteBuffer _bb, IonoObservationDensityProfile_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean IonoObservationDensityProfile_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "IONO"); }
  ...
  public static int createIonoObservationDensityProfile_Full(FlatBufferBuilder builder,
      int parabolicOffset,
  ...
  public static int endIonoObservationDensityProfile_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishIonoObservationDensityProfile_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "IONO"); }
  public static void finishSizePrefixedIonoObservationDensityProfile_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "IONO"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public IonoObservationDensityProfile_Full get(int j) { return get(new IonoObservationDensityProfile_Full(), j); }
    public IonoObservationDensityProfile_Full get(IonoObservationDensityProfile_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
