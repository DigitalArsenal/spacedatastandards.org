...
public final class OnorbitThruster_Abridged extends Table {
  ...
  public static OnorbitThruster_Abridged getRootAsOnorbitThruster_Abridged(ByteBuffer _bb, OnorbitThruster_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean OnorbitThruster_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "ONOR"); }
  ...
  public static int createOnorbitThruster_Abridged(FlatBufferBuilder builder,
      int idOffset,
      int idOnOrbitOffset,
      int idEngineOffset,
  ...
  public static int endOnorbitThruster_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishOnorbitThruster_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "ONOR"); }
  public static void finishSizePrefixedOnorbitThruster_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "ONOR"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public OnorbitThruster_Abridged get(int j) { return get(new OnorbitThruster_Abridged(), j); }
    public OnorbitThruster_Abridged get(OnorbitThruster_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
