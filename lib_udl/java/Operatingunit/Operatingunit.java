...
public final class Operatingunit extends Table {
  ...
  public static Operatingunit getRootAsOperatingunit(ByteBuffer _bb, Operatingunit obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean OperatingunitBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "OPER"); }
  ...
  public static int createOperatingunit(FlatBufferBuilder builder,
  ...
  public static int endOperatingunit(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishOperatingunitBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "OPER"); }
  public static void finishSizePrefixedOperatingunitBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "OPER"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Operatingunit get(int j) { return get(new Operatingunit(), j); }
    public Operatingunit get(Operatingunit obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
