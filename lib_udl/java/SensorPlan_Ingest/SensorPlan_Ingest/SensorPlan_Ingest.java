...
public final class SensorPlan_Ingest extends Table {
  ...
  public StringVector collectRequests_vector() { return collectRequests_vector(new StringVector()); }
  public StringVector collectRequests_vector(StringVector obj) { int o = __offset(44); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
  ...
  public StringVector tags_vector() { return tags_vector(new StringVector()); }
  public StringVector tags_vector(StringVector obj) { int o = __offset(46); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
