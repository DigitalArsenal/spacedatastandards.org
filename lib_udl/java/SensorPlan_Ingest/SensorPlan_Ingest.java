...
public final class SensorPlan_Ingest extends Table {
  ...
  public static SensorPlan_Ingest getRootAsSensorPlan_Ingest(ByteBuffer _bb, SensorPlan_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean SensorPlan_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "SENS"); }
   ...
   * Constraints: No constraints specified.
   */
  public String collectRequests(int j) { int o = __offset(44); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int collectRequestsLength() { int o = __offset(44); return o != 0 ? __vector_len(o) : 0; }
  public StringVector collectRequestsVector() { return collectRequestsVector(new StringVector()); }
  public StringVector collectRequestsVector(StringVector obj) { int o = __offset(44); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   * Optional array of provider/source specific tags for this data, where each element is no longer than 32 characters, used for implementing data owner conditional access controls to restrict access to the data. Should be left null by data providers unless conditional access controls are coordinated with the UDL team.
   * Example: /// Example: ['PROVIDER_TAG1', 'PROVIDER_TAG2']
   * Constraints: No constraints specified.
   */
  public String tags(int j) { int o = __offset(46); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int tagsLength() { int o = __offset(46); return o != 0 ? __vector_len(o) : 0; }
  public StringVector tagsVector() { return tagsVector(new StringVector()); }
  public StringVector tagsVector(StringVector obj) { int o = __offset(46); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }

  public static int createSensorPlan_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static void addCollectRequests(FlatBufferBuilder builder, int collectRequestsOffset) { builder.addOffset(20, collectRequestsOffset, 0); }
  ...
  public static void addTags(FlatBufferBuilder builder, int tagsOffset) { builder.addOffset(21, tagsOffset, 0); }
  ...
  public static int endSensorPlan_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishSensorPlan_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "SENS"); }
  public static void finishSizePrefixedSensorPlan_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "SENS"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public SensorPlan_Ingest get(int j) { return get(new SensorPlan_Ingest(), j); }
    public SensorPlan_Ingest get(SensorPlan_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
