...
public final class AirfieldSlot_Abridged extends Table {
  ...
  public static AirfieldSlot_Abridged getRootAsAirfieldSlot_Abridged(ByteBuffer _bb, AirfieldSlot_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean AirfieldSlot_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "AIRF"); }
  ...
  public static int createAirfieldSlot_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endAirfieldSlot_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAirfieldSlot_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "AIRF"); }
  public static void finishSizePrefixedAirfieldSlot_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "AIRF"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public AirfieldSlot_Abridged get(int j) { return get(new AirfieldSlot_Abridged(), j); }
    public AirfieldSlot_Abridged get(AirfieldSlot_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
