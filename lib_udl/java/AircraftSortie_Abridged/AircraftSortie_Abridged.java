...
public final class AircraftSortie_Abridged extends Table {
  ...
  public static AircraftSortie_Abridged getRootAsAircraftSortie_Abridged(ByteBuffer _bb, AircraftSortie_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean AircraftSortie_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "AIRC"); }
  ...
  public static int createAircraftSortie_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endAircraftSortie_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAircraftSortie_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "AIRC"); }
  public static void finishSizePrefixedAircraftSortie_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "AIRC"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public AircraftSortie_Abridged get(int j) { return get(new AircraftSortie_Abridged(), j); }
    public AircraftSortie_Abridged get(AircraftSortie_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
