...
public final class RadarObservation_Abridged extends Table {
  ...
  public static RadarObservation_Abridged getRootAsRadarObservation_Abridged(ByteBuffer _bb, RadarObservation_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean RadarObservation_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "RADA"); }
   ...
   */
  public byte senReferenceFrame() { int o = __offset(112); return o != 0 ? bb.get(o + bb_pos) : 0; }
  /**
   * Optional source-provided and searchable metadata or descriptor of the data.
   * Example: /// Example: descriptor
   * Constraints: Minimum length = 0, Maximum length = 64
   */
  public String descriptor() { int o = __offset(114); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer descriptorAsByteBuffer() { return __vector_as_bytebuffer(114, 1); }
  public ByteBuffer descriptorInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 114, 1); }
  /**
   ...
   * Constraints: Minimum length = 0, Maximum length = 64
   */
  public String sourceDl() { int o = __offset(118); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer sourceDlAsByteBuffer() { return __vector_as_bytebuffer(118, 1); }
  public ByteBuffer sourceDlInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 118, 1); }
  /**
   * Read only enumeration specifying the type of observation (e.g. OPTICAL, RADAR, RF, etc).
   * Example: /// Example: RADAR
   * Constraints: No constraints specified.
   */
  public String type() { int o = __offset(120); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer typeAsByteBuffer() { return __vector_as_bytebuffer(120, 1); }
  public ByteBuffer typeInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 120, 1); }

  public static int createRadarObservation_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static void addSenReferenceFrame(FlatBufferBuilder builder, byte senReferenceFrame) { builder.addByte(54, senReferenceFrame, 0); }
  public static void addDescriptor(FlatBufferBuilder builder, int descriptorOffset) { builder.addOffset(55, descriptorOffset, 0); }
  ...
  public static void addSourceDl(FlatBufferBuilder builder, int sourceDlOffset) { builder.addOffset(57, sourceDlOffset, 0); }
  public static void addType(FlatBufferBuilder builder, int typeOffset) { builder.addOffset(58, typeOffset, 0); }
  public static int endRadarObservation_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishRadarObservation_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "RADA"); }
  public static void finishSizePrefixedRadarObservation_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "RADA"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public RadarObservation_Abridged get(int j) { return get(new RadarObservation_Abridged(), j); }
    public RadarObservation_Abridged get(RadarObservation_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
