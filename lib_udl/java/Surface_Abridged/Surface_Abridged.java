...
public final class Surface_Abridged extends Table {
  ...
  public static Surface_Abridged getRootAsSurface_Abridged(ByteBuffer _bb, Surface_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Surface_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "SURF"); }
  ...
  public static int createSurface_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endSurface_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishSurface_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "SURF"); }
  public static void finishSizePrefixedSurface_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "SURF"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Surface_Abridged get(int j) { return get(new Surface_Abridged(), j); }
    public Surface_Abridged get(Surface_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
