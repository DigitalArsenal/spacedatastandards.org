...
public final class EvacMedication_Full extends Table {
  ...
  public static EvacMedication_Full getRootAsEvacMedication_Full(ByteBuffer _bb, EvacMedication_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean EvacMedication_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "EVAC"); }
  ...
  public static int createEvacMedication_Full(FlatBufferBuilder builder,
      int typeOffset,
      int bodyPartOffset,
      int doseOffset,
  ...
  public static int endEvacMedication_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishEvacMedication_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "EVAC"); }
  public static void finishSizePrefixedEvacMedication_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "EVAC"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public EvacMedication_Full get(int j) { return get(new EvacMedication_Full(), j); }
    public EvacMedication_Full get(EvacMedication_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
