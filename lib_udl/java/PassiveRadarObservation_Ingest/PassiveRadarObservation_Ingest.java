...
public final class PassiveRadarObservation_Ingest extends Table {
  ...
  public static PassiveRadarObservation_Ingest getRootAsPassiveRadarObservation_Ingest(ByteBuffer _bb, PassiveRadarObservation_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean PassiveRadarObservation_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "PASS"); }
   ...
   * Constraints: No constraints specified.
   */
  public String type() { int o = __offset(136); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer typeAsByteBuffer() { return __vector_as_bytebuffer(136, 1); }
  public ByteBuffer typeInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 136, 1); }

  public static int createPassiveRadarObservation_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static void addType(FlatBufferBuilder builder, int typeOffset) { builder.addOffset(66, typeOffset, 0); }
  public static int endPassiveRadarObservation_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishPassiveRadarObservation_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "PASS"); }
  public static void finishSizePrefixedPassiveRadarObservation_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "PASS"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public PassiveRadarObservation_Ingest get(int j) { return get(new PassiveRadarObservation_Ingest(), j); }
    public PassiveRadarObservation_Ingest get(PassiveRadarObservation_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
