...
public final class CollectRequest_Full extends Table {
  ...
  public static CollectRequest_Full getRootAsCollectRequest_Full(ByteBuffer _bb, CollectRequest_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean CollectRequest_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "COLL"); }
   ...
   * Constraints: No constraints specified.
   */
  public String updatedAt() { int o = __offset(162); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer updatedAtAsByteBuffer() { return __vector_as_bytebuffer(162, 1); }
  public ByteBuffer updatedAtInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 162, 1); }
  /**
   * Application user who updated the row in the database, auto-populated by the system.
   * Example: /// Example: some.user
   * Constraints: Minimum length = 0, Maximum length = 64
   */
  public String updatedBy() { int o = __offset(164); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer updatedByAsByteBuffer() { return __vector_as_bytebuffer(164, 1); }
  public ByteBuffer updatedByInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 164, 1); }
  /**
   ...
   */
  public String origNetwork() { int o = __offset(174); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer origNetworkAsByteBuffer() { return __vector_as_bytebuffer(174, 1); }
  public ByteBuffer origNetworkInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 174, 1); }
  /**
   ...
   * Constraints: Minimum length = 1, Maximum length = 32
   */
  public byte dataMode() { int o = __offset(176); return o != 0 ? bb.get(o + bb_pos) : 0; }
  /**
   * No description provided.
   * Example: /// Example: No example provided.
   * Constraints: No constraints specified.
   */
  public String stateVector() { int o = __offset(178); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer stateVectorAsByteBuffer() { return __vector_as_bytebuffer(178, 1); }
  public ByteBuffer stateVectorInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 178, 1); }
  /**
   * No description provided.
   * Example: /// Example: No example provided.
   * Constraints: No constraints specified.
   */
  public String elset() { int o = __offset(180); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer elsetAsByteBuffer() { return __vector_as_bytebuffer(180, 1); }
  public ByteBuffer elsetInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 180, 1); }
  /**
   * No description provided.
   * Example: /// Example: No example provided.
   * Constraints: No constraints specified.
   */
  public String onOrbit() { int o = __offset(182); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer onOrbitAsByteBuffer() { return __vector_as_bytebuffer(182, 1); }
  public ByteBuffer onOrbitInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 182, 1); }
  /**
   * Optional array of provider/source specific tags for this data, where each element is no longer than 32 characters, used for implementing data owner conditional access controls to restrict access to the data. Should be left null by data providers unless conditional access controls are coordinated with the UDL team.
   * Example: /// Example: ['PROVIDER_TAG1', 'PROVIDER_TAG2']
   * Constraints: No constraints specified.
   */
  public String tags(int j) { int o = __offset(184); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int tagsLength() { int o = __offset(184); return o != 0 ? __vector_len(o) : 0; }
  public StringVector tagsVector() { return tagsVector(new StringVector()); }
  public StringVector tagsVector(StringVector obj) { int o = __offset(184); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public String collectResponse(int j) { int o = __offset(186); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int collectResponseLength() { int o = __offset(186); return o != 0 ? __vector_len(o) : 0; }
  public StringVector collectResponseVector() { return collectResponseVector(new StringVector()); }
  public StringVector collectResponseVector(StringVector obj) { int o = __offset(186); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }

  public static int createCollectRequest_Full(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static void addUpdatedAt(FlatBufferBuilder builder, int updatedAtOffset) { builder.addOffset(79, updatedAtOffset, 0); }
  public static void addUpdatedBy(FlatBufferBuilder builder, int updatedByOffset) { builder.addOffset(80, updatedByOffset, 0); }
  ...
  public static void addOrigNetwork(FlatBufferBuilder builder, int origNetworkOffset) { builder.addOffset(85, origNetworkOffset, 0); }
  public static void addDataMode(FlatBufferBuilder builder, byte dataMode) { builder.addByte(86, dataMode, 0); }
  public static void addStateVector(FlatBufferBuilder builder, int stateVectorOffset) { builder.addOffset(87, stateVectorOffset, 0); }
  public static void addElset(FlatBufferBuilder builder, int elsetOffset) { builder.addOffset(88, elsetOffset, 0); }
  public static void addOnOrbit(FlatBufferBuilder builder, int onOrbitOffset) { builder.addOffset(89, onOrbitOffset, 0); }
  public static void addTags(FlatBufferBuilder builder, int tagsOffset) { builder.addOffset(90, tagsOffset, 0); }
  ...
  public static void addCollectResponse(FlatBufferBuilder builder, int collectResponseOffset) { builder.addOffset(91, collectResponseOffset, 0); }
  public static int createCollectResponseVector(FlatBufferBuilder builder, int[] data) { builder.startVector(4, data.length, 4); for (int i = data.length - 1; i >= 0; i--) builder.addOffset(data[i]); return builder.endVector(); }
  public static void startCollectResponseVector(FlatBufferBuilder builder, int numElems) { builder.startVector(4, numElems, 4); }
  public static int endCollectRequest_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishCollectRequest_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "COLL"); }
  public static void finishSizePrefixedCollectRequest_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "COLL"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public CollectRequest_Full get(int j) { return get(new CollectRequest_Full(), j); }
    public CollectRequest_Full get(CollectRequest_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
