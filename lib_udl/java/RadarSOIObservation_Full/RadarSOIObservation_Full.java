...
public final class RadarSOIObservation_Full extends Table {
  ...
  public static RadarSOIObservation_Full getRootAsRadarSOIObservation_Full(ByteBuffer _bb, RadarSOIObservation_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean RadarSOIObservation_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "RADA"); }
  ...
  public static int createRadarSOIObservation_Full(FlatBufferBuilder builder,
  ...
  public static int endRadarSOIObservation_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishRadarSOIObservation_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "RADA"); }
  public static void finishSizePrefixedRadarSOIObservation_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "RADA"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public RadarSOIObservation_Full get(int j) { return get(new RadarSOIObservation_Full(), j); }
    public RadarSOIObservation_Full get(RadarSOIObservation_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
