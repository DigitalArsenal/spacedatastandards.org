...
public final class IonoObservationAzimuth_Full extends Table {
  ...
  public static IonoObservationAzimuth_Full getRootAsIonoObservationAzimuth_Full(ByteBuffer _bb, IonoObservationAzimuth_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean IonoObservationAzimuth_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "IONO"); }
  ...
  public static int createIonoObservationAzimuth_Full(FlatBufferBuilder builder,
      int notesOffset,
  ...
  public static int endIonoObservationAzimuth_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishIonoObservationAzimuth_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "IONO"); }
  public static void finishSizePrefixedIonoObservationAzimuth_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "IONO"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public IonoObservationAzimuth_Full get(int j) { return get(new IonoObservationAzimuth_Full(), j); }
    public IonoObservationAzimuth_Full get(IonoObservationAzimuth_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
