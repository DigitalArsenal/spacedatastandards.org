...
public final class MissileTrack_Abridged extends Table {
  ...
  public static MissileTrack_Abridged getRootAsMissileTrack_Abridged(ByteBuffer _bb, MissileTrack_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean MissileTrack_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "MISS"); }
  ...
  public static int createMissileTrack_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endMissileTrack_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishMissileTrack_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "MISS"); }
  public static void finishSizePrefixedMissileTrack_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "MISS"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public MissileTrack_Abridged get(int j) { return get(new MissileTrack_Abridged(), j); }
    public MissileTrack_Abridged get(MissileTrack_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
