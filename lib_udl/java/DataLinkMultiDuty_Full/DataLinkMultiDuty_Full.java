...
public final class DataLinkMultiDuty_Full extends Table {
  ...
  public static DataLinkMultiDuty_Full getRootAsDataLinkMultiDuty_Full(ByteBuffer _bb, DataLinkMultiDuty_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean DataLinkMultiDuty_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "DATA"); }
  ...
  public static int createDataLinkMultiDuty_Full(FlatBufferBuilder builder,
      int unitDesOffset,
      int nameOffset,
      int rankOffset,
      int dutyOffset,
  ...
  public static int endDataLinkMultiDuty_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishDataLinkMultiDuty_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "DATA"); }
  public static void finishSizePrefixedDataLinkMultiDuty_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "DATA"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public DataLinkMultiDuty_Full get(int j) { return get(new DataLinkMultiDuty_Full(), j); }
    public DataLinkMultiDuty_Full get(DataLinkMultiDuty_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
