...
public final class SigAct_Abridged extends Table {
  ...
  public static SigAct_Abridged getRootAsSigAct_Abridged(ByteBuffer _bb, SigAct_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean SigAct_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "SIGA"); }
   ...
   */
  public String atext() { int o = __offset(26); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer atextAsByteBuffer() { return __vector_as_bytebuffer(26, 1); }
  public ByteBuffer atextInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 26, 1); }
  /**
   * Geographical region or polygon (lat/lon pairs), as depicted by the GeoJSON representation of the geometry/geography, of the image as projected on the ground. GeoJSON Reference: https://geojson.org/. Ignored if included with a POST or PUT request that also specifies a valid 'area' or 'atext' field.
   * Example: /// Example: {"type":"Polygon","coordinates":[[[67.3291113966927,26.156175339112],[67.2580009640721,26.091022064271],[67.1795862381682,26.6637992964562],[67.2501237475598,26.730115808233],[67.3291113966927,26.156175339112]]]}
   * Constraints: Minimum length = 0, Maximum length = 512
   */
  public String agjson() { int o = __offset(28); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer agjsonAsByteBuffer() { return __vector_as_bytebuffer(28, 1); }
  public ByteBuffer agjsonInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 28, 1); }
  /**
   * Type of region as projected on the ground.
   * Example: /// Example: Type1
   * Constraints: Minimum length = 0, Maximum length = 128
   */
  public String atype() { int o = __offset(30); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer atypeAsByteBuffer() { return __vector_as_bytebuffer(30, 1); }
  public ByteBuffer atypeInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 30, 1); }
  /**
   * Number of dimensions of the geometry depicted by region.
   * Example: /// Example: 3
   * Constraints: No constraints specified.
   */
  public int andims() { int o = __offset(32); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  /**
   * Geographical spatial_ref_sys for region.
   * Example: /// Example: 3
   * Constraints: No constraints specified.
   */
  public int asrid() { int o = __offset(34); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  /**
   * The approximate start time of the event, in ISO 8601 UTC format.
   * Example: /// Example: 2021-01-01T01:02:03.123Z
   * Constraints: No constraints specified.
   */
  public String eventStart() { int o = __offset(36); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer eventStartAsByteBuffer() { return __vector_as_bytebuffer(36, 1); }
  public ByteBuffer eventStartInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 36, 1); }
  /**
   * The approximate end time of the event, in ISO 8601 UTC format.
   * Example: /// Example: 2021-01-01T01:02:03.123Z
   * Constraints: No constraints specified.
   */
  public String eventEnd() { int o = __offset(38); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer eventEndAsByteBuffer() { return __vector_as_bytebuffer(38, 1); }
  public ByteBuffer eventEndInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 38, 1); }
  /**
   * Date of the report or filing.
   * Example: /// Example: 2018-01-01T16:00:00.123Z
   * Constraints: No constraints specified.
   */
  public String reportDate() { int o = __offset(40); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer reportDateAsByteBuffer() { return __vector_as_bytebuffer(40, 1); }
  public ByteBuffer reportDateInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 40, 1); }
  /**
   * A list of one or more actors involved in the event.
   * Example: /// Example: ['US', 'CAN']
   * Constraints: No constraints specified.
   */
  public String actors(int j) { int o = __offset(42); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int actorsLength() { int o = __offset(42); return o != 0 ? __vector_len(o) : 0; }
  public StringVector actorsVector() { return actorsVector(new StringVector()); }
  public StringVector actorsVector(StringVector obj) { int o = __offset(42); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   * Number of civilians abducted in the activity.
   * Example: /// Example: 423
   * Constraints: No constraints specified.
   */
  public int civAbd() { int o = __offset(44); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  /**
   * Number of civilians detained in the activity.
   * Example: /// Example: 234
   * Constraints: No constraints specified.
   */
  public int civDet() { int o = __offset(46); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  /**
   * Number of civilians killed in the activity.
   * Example: /// Example: 2
   * Constraints: No constraints specified.
   */
  public int civKia() { int o = __offset(48); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  /**
   * Number of civilians wounded in the activity.
   * Example: /// Example: 123
   * Constraints: No constraints specified.
   */
  public int civWound() { int o = __offset(50); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  /**
   * Number of coalition members abducted in the activity.
   * Example: /// Example: 123
   * Constraints: No constraints specified.
   */
  public int coalAbd() { int o = __offset(52); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  /**
   * Number of coalition members detained in the activity.
   * Example: /// Example: 123
   * Constraints: No constraints specified.
   */
  public int coalDet() { int o = __offset(54); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  /**
   * Number of coalition members killed in the activity.
   * Example: /// Example: 123
   * Constraints: No constraints specified.
   */
  public int coalKia() { int o = __offset(56); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  /**
   * Number of coalition members wounded in the activity.
   * Example: /// Example: 123
   * Constraints: No constraints specified.
   */
  public int coalWound() { int o = __offset(58); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  /**
   * Number of enemy combatants abducted in the activity.
   * Example: /// Example: 123
   * Constraints: No constraints specified.
   */
  public int enemyAbd() { int o = __offset(60); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  /**
   * Number of enemy combatants detained in the activity.
   * Example: /// Example: 123
   * Constraints: No constraints specified.
   */
  public int enemyDet() { int o = __offset(62); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  /**
   * Number of enemy combatants killed in the activity.
   * Example: /// Example: 123
   * Constraints: No constraints specified.
   */
  public int enemyKia() { int o = __offset(64); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  /**
   * Number of friendlies abducted in the activity.
   * Example: /// Example: 123
   * Constraints: No constraints specified.
   */
  public int friendlyAbd() { int o = __offset(66); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  /**
   * Number of friendlies in the activity.
   * Example: /// Example: 123
   * Constraints: No constraints specified.
   */
  public int friendlyDet() { int o = __offset(68); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  /**
   * Number of friendlies killed in the activity.
   * Example: /// Example: 123
   * Constraints: No constraints specified.
   */
  public int friendlyKia() { int o = __offset(70); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  /**
   * Number of friendlies wounded in the activity.
   * Example: /// Example: 123
   * Constraints: No constraints specified.
   */
  public int friendlyWound() { int o = __offset(72); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  /**
   * Number of Host Nation members abducted in the activity.
   * Example: /// Example: 123
   * Constraints: No constraints specified.
   */
  public int hostNatAbd() { int o = __offset(74); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  /**
   * Number of Host Nation members detained in the activity.
   * Example: /// Example: 123
   * Constraints: No constraints specified.
   */
  public int hostNatDet() { int o = __offset(76); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  /**
   * Number of Host Nation members killed in the activity.
   * Example: /// Example: 123
   * Constraints: No constraints specified.
   */
  public int hostNatKia() { int o = __offset(78); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  /**
   * Number of Host Nation members wounded in the activity.
   * Example: /// Example: 123
   * Constraints: No constraints specified.
   */
  public int hostNatWound() { int o = __offset(80); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  /**
   * Number of side A members abducted in the activity.
   * Example: /// Example: 123
   * Constraints: No constraints specified.
   */
  public int sideAabd() { int o = __offset(82); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  /**
   * Number of side A members detained in the activity.
   * Example: /// Example: 123
   * Constraints: No constraints specified.
   */
  public int sideAdet() { int o = __offset(84); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  /**
   * Number of side A members killed in the activity.
   * Example: /// Example: 123
   * Constraints: No constraints specified.
   */
  public int sideAkia() { int o = __offset(86); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  /**
   * Number of side A members wounded in the activity.
   * Example: /// Example: 123
   * Constraints: No constraints specified.
   */
  public int sideAwound() { int o = __offset(88); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  /**
   * Number of side B members abducted in the activity.
   * Example: /// Example: 123
   * Constraints: No constraints specified.
   */
  public int sideBabd() { int o = __offset(90); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  /**
   * Number of side B members detained in the activity.
   * Example: /// Example: 123
   * Constraints: No constraints specified.
   */
  public int sideBdet() { int o = __offset(92); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  /**
   * Number of side B members killed in the activity.
   * Example: /// Example: 123
   * Constraints: No constraints specified.
   */
  public int sideBkia() { int o = __offset(94); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  /**
   * Number of side B members wounded in the activity.
   * Example: /// Example: 123
   * Constraints: No constraints specified.
   */
  public int sideBwound() { int o = __offset(96); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  /**
   * The name of the target.  The target may be an individual, an entity, or a country/region.
   * Example: /// Example: US
   * Constraints: Minimum length = 0, Maximum length = 64
   */
  public String target() { int o = __offset(98); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer targetAsByteBuffer() { return __vector_as_bytebuffer(98, 1); }
  public ByteBuffer targetInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 98, 1); }
  /**
   * A description of the event.
   * Example: /// Example: Example_Description
   * Constraints: Minimum length = 0, Maximum length = 4096
   */
  public String eventDescription() { int o = __offset(100); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer eventDescriptionAsByteBuffer() { return __vector_as_bytebuffer(100, 1); }
  public ByteBuffer eventDescriptionInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 100, 1); }
  /**
   * The type of event (e.g.  Military, Natural, Political, Social, etc.).
   * Example: /// Example: Military
   * Constraints: Minimum length = 0, Maximum length = 32
   */
  public String eventType() { int o = __offset(102); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer eventTypeAsByteBuffer() { return __vector_as_bytebuffer(102, 1); }
  public ByteBuffer eventTypeInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 102, 1); }
  /**
   * The mode of this attack or event (e.g. Direct Fire, IED Explosion, etc.).
   * Example: /// Example: IED Explosion
   * Constraints: Minimum length = 0, Maximum length = 32
   */
  public String typeOfAttack() { int o = __offset(104); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer typeOfAttackAsByteBuffer() { return __vector_as_bytebuffer(104, 1); }
  public ByteBuffer typeOfAttackInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 104, 1); }
  /**
   * Flag indicating that this attack was of a complex or coordinated nature.
   * Example: /// Example: False
   * Constraints: No constraints specified.
   */
  public boolean complexAttack() { int o = __offset(106); return o != 0 ? 0!=bb.get(o + bb_pos) : false; }
  /**
   ...
   * Constraints: Minimum length = 0, Maximum length = 64
   */
  public String idNumber() { int o = __offset(108); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer idNumberAsByteBuffer() { return __vector_as_bytebuffer(108, 1); }
  public ByteBuffer idNumberInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 108, 1); }
  /**
   * Estimate of the confidence that this event occurred.
   * Example: /// Example: 13
   * Constraints: No constraints specified.
   */
  public int confidence() { int o = __offset(110); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  /**
   * Estimate of the accuracy that this event occurred as described/reported.
   * Example: /// Example: 13
   * Constraints: No constraints specified.
   */
  public int accuracy() { int o = __offset(112); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public int clarity() { int o = __offset(114); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  /**
   ...
   * Constraints: Minimum length = 0, Maximum length = 32
   */
  public String cameoCode() { int o = __offset(116); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer cameoCodeAsByteBuffer() { return __vector_as_bytebuffer(116, 1); }
  public ByteBuffer cameoCodeInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 116, 1); }
  /**
   ...
   * Constraints: Minimum length = 0, Maximum length = 32
   */
  public String cameoBaseCode() { int o = __offset(118); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer cameoBaseCodeAsByteBuffer() { return __vector_as_bytebuffer(118, 1); }
  public ByteBuffer cameoBaseCodeInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 118, 1); }
  /**
   ...
   * Constraints: Minimum length = 0, Maximum length = 32
   */
  public String cameoRootCode() { int o = __offset(120); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer cameoRootCodeAsByteBuffer() { return __vector_as_bytebuffer(120, 1); }
  public ByteBuffer cameoRootCodeInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 120, 1); }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public double goldstein() { int o = __offset(122); return o != 0 ? bb.getDouble(o + bb_pos) : 0.0; }
  /**
   * The source of the document or report.
   * Example: /// Example: Example_documentSource
   * Constraints: Minimum length = 0, Maximum length = 128
   */
  public String documentSource() { int o = __offset(124); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer documentSourceAsByteBuffer() { return __vector_as_bytebuffer(124, 1); }
  public ByteBuffer documentSourceInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 124, 1); }
  /**
   * The filename of the document or report.
   * Example: /// Example: Example_documentFilename
   * Constraints: Minimum length = 0, Maximum length = 128
   */
  public String documentFilename() { int o = __offset(126); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer documentFilenameAsByteBuffer() { return __vector_as_bytebuffer(126, 1); }
  public ByteBuffer documentFilenameInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 126, 1); }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public boolean hasAttachment() { int o = __offset(128); return o != 0 ? 0!=bb.get(o + bb_pos) : false; }
  /**
   * Size of the associated text file. Units in bytes. If filesize is provided without an associated file, it defaults to 0.
   * Example: /// Example: 0
   * Constraints: No constraints specified.
   */
  public long filesize() { int o = __offset(130); return o != 0 ? bb.getLong(o + bb_pos) : 0L; }
  /**
   ...
   */
  public String checksumValue() { int o = __offset(132); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer checksumValueAsByteBuffer() { return __vector_as_bytebuffer(132, 1); }
  public ByteBuffer checksumValueInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 132, 1); }
  /**
   * The reporting unit.
   * Example: /// Example: Unit_1
   * Constraints: Minimum length = 0, Maximum length = 128
   */
  public String repUnit() { int o = __offset(134); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer repUnitAsByteBuffer() { return __vector_as_bytebuffer(134, 1); }
  public ByteBuffer repUnitInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 134, 1); }
  /**
   * The reporting unit type.
   * Example: /// Example: Example_repUnitType
   * Constraints: Minimum length = 0, Maximum length = 128
   */
  public String repUnitType() { int o = __offset(136); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer repUnitTypeAsByteBuffer() { return __vector_as_bytebuffer(136, 1); }
  public ByteBuffer repUnitTypeInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 136, 1); }
  /**
   * The activity the unit was engaged in.
   * Example: /// Example: Example_Activity
   * Constraints: Minimum length = 0, Maximum length = 128
   */
  public String repUnitActivity() { int o = __offset(138); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer repUnitActivityAsByteBuffer() { return __vector_as_bytebuffer(138, 1); }
  public ByteBuffer repUnitActivityInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 138, 1); }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public int numMentions() { int o = __offset(140); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public int numSources() { int o = __offset(142); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public int numArticles() { int o = __offset(144); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public double avgTone() { int o = __offset(146); return o != 0 ? bb.getDouble(o + bb_pos) : 0.0; }
  /**
   ...
   * Constraints: Minimum length = 0, Maximum length = 256
   */
  public String sourceUrl() { int o = __offset(148); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer sourceUrlAsByteBuffer() { return __vector_as_bytebuffer(148, 1); }
  public ByteBuffer sourceUrlInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 148, 1); }
  /**
   * Related document ids.
   * Example: /// Example: No example provided.
   * Constraints: No constraints specified.
   */
  public String relatedDocs(int j) { int o = __offset(150); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int relatedDocsLength() { int o = __offset(150); return o != 0 ? __vector_len(o) : 0; }
  public StringVector relatedDocsVector() { return relatedDocsVector(new StringVector()); }
  public StringVector relatedDocsVector(StringVector obj) { int o = __offset(150); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   * A summary of the event.
   * Example: /// Example: Example_Summary
   * Constraints: Minimum length = 0, Maximum length = 4096
   */
  public String summary() { int o = __offset(152); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer summaryAsByteBuffer() { return __vector_as_bytebuffer(152, 1); }
  public ByteBuffer summaryInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 152, 1); }
  /**
   * Notes related to the documents or event.
   * Example: /// Example: Example_Notes
   * Constraints: Minimum length = 0, Maximum length = 4096
   */
  public String notes() { int o = __offset(154); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer notesAsByteBuffer() { return __vector_as_bytebuffer(154, 1); }
  public ByteBuffer notesInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 154, 1); }
  /**
   * Time the row was created in the database, auto-populated by the system, example = 2018-01-01T16:00:00.123Z.
   * Example: /// Example: 2018-01-01T16:00:00.123Z
   * Constraints: No constraints specified.
   */
  public String createdAt() { int o = __offset(156); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer createdAtAsByteBuffer() { return __vector_as_bytebuffer(156, 1); }
  public ByteBuffer createdAtInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 156, 1); }
  /**
   * Application user who created the row in the database, auto-populated by the system.
   * Example: /// Example: some.user
   * Constraints: No constraints specified.
   */
  public String createdBy() { int o = __offset(158); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer createdByAsByteBuffer() { return __vector_as_bytebuffer(158, 1); }
  public ByteBuffer createdByInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 158, 1); }
  /**
   * Source of the data.
  ...
  public static int createSigAct_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static void addAtext(FlatBufferBuilder builder, int atextOffset) { builder.addOffset(11, atextOffset, 0); }
  public static void addAgjson(FlatBufferBuilder builder, int agjsonOffset) { builder.addOffset(12, agjsonOffset, 0); }
  public static void addAtype(FlatBufferBuilder builder, int atypeOffset) { builder.addOffset(13, atypeOffset, 0); }
  ...
  public static void addEventStart(FlatBufferBuilder builder, int eventStartOffset) { builder.addOffset(16, eventStartOffset, 0); }
  public static void addEventEnd(FlatBufferBuilder builder, int eventEndOffset) { builder.addOffset(17, eventEndOffset, 0); }
  public static void addReportDate(FlatBufferBuilder builder, int reportDateOffset) { builder.addOffset(18, reportDateOffset, 0); }
  public static void addActors(FlatBufferBuilder builder, int actorsOffset) { builder.addOffset(19, actorsOffset, 0); }
  ...
  public static void addTarget(FlatBufferBuilder builder, int targetOffset) { builder.addOffset(47, targetOffset, 0); }
  public static void addEventDescription(FlatBufferBuilder builder, int eventDescriptionOffset) { builder.addOffset(48, eventDescriptionOffset, 0); }
  public static void addEventType(FlatBufferBuilder builder, int eventTypeOffset) { builder.addOffset(49, eventTypeOffset, 0); }
  public static void addTypeOfAttack(FlatBufferBuilder builder, int typeOfAttackOffset) { builder.addOffset(50, typeOfAttackOffset, 0); }
  public static void addComplexAttack(FlatBufferBuilder builder, boolean complexAttack) { builder.addBoolean(51, complexAttack, false); }
  public static void addIdNumber(FlatBufferBuilder builder, int idNumberOffset) { builder.addOffset(52, idNumberOffset, 0); }
  ...
  public static void addCameoCode(FlatBufferBuilder builder, int cameoCodeOffset) { builder.addOffset(56, cameoCodeOffset, 0); }
  public static void addCameoBaseCode(FlatBufferBuilder builder, int cameoBaseCodeOffset) { builder.addOffset(57, cameoBaseCodeOffset, 0); }
  public static void addCameoRootCode(FlatBufferBuilder builder, int cameoRootCodeOffset) { builder.addOffset(58, cameoRootCodeOffset, 0); }
  public static void addGoldstein(FlatBufferBuilder builder, double goldstein) { builder.addDouble(59, goldstein, 0.0); }
  public static void addDocumentSource(FlatBufferBuilder builder, int documentSourceOffset) { builder.addOffset(60, documentSourceOffset, 0); }
  public static void addDocumentFilename(FlatBufferBuilder builder, int documentFilenameOffset) { builder.addOffset(61, documentFilenameOffset, 0); }
  public static void addHasAttachment(FlatBufferBuilder builder, boolean hasAttachment) { builder.addBoolean(62, hasAttachment, false); }
  public static void addFilesize(FlatBufferBuilder builder, long filesize) { builder.addLong(63, filesize, 0L); }
  public static void addChecksumValue(FlatBufferBuilder builder, int checksumValueOffset) { builder.addOffset(64, checksumValueOffset, 0); }
  public static void addRepUnit(FlatBufferBuilder builder, int repUnitOffset) { builder.addOffset(65, repUnitOffset, 0); }
  public static void addRepUnitType(FlatBufferBuilder builder, int repUnitTypeOffset) { builder.addOffset(66, repUnitTypeOffset, 0); }
  public static void addRepUnitActivity(FlatBufferBuilder builder, int repUnitActivityOffset) { builder.addOffset(67, repUnitActivityOffset, 0); }
  ...
  public static void addSourceUrl(FlatBufferBuilder builder, int sourceUrlOffset) { builder.addOffset(72, sourceUrlOffset, 0); }
  public static void addRelatedDocs(FlatBufferBuilder builder, int relatedDocsOffset) { builder.addOffset(73, relatedDocsOffset, 0); }
  ...
  public static void addSummary(FlatBufferBuilder builder, int summaryOffset) { builder.addOffset(74, summaryOffset, 0); }
  public static void addNotes(FlatBufferBuilder builder, int notesOffset) { builder.addOffset(75, notesOffset, 0); }
  public static void addCreatedAt(FlatBufferBuilder builder, int createdAtOffset) { builder.addOffset(76, createdAtOffset, 0); }
  public static void addCreatedBy(FlatBufferBuilder builder, int createdByOffset) { builder.addOffset(77, createdByOffset, 0); }
  ...
  public static int endSigAct_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishSigAct_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "SIGA"); }
  public static void finishSizePrefixedSigAct_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "SIGA"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public SigAct_Abridged get(int j) { return get(new SigAct_Abridged(), j); }
    public SigAct_Abridged get(SigAct_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
