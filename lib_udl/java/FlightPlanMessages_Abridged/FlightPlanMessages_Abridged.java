...
public final class FlightPlanMessages_Abridged extends Table {
  ...
  public static FlightPlanMessages_Abridged getRootAsFlightPlanMessages_Abridged(ByteBuffer _bb, FlightPlanMessages_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean FlightPlanMessages_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "FLIG"); }
  ...
  public static int createFlightPlanMessages_Abridged(FlatBufferBuilder builder,
      int severityOffset,
      int wpNumOffset,
      int routePathOffset,
      int msgTextOffset) {
  ...
  public static int endFlightPlanMessages_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishFlightPlanMessages_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "FLIG"); }
  public static void finishSizePrefixedFlightPlanMessages_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "FLIG"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public FlightPlanMessages_Abridged get(int j) { return get(new FlightPlanMessages_Abridged(), j); }
    public FlightPlanMessages_Abridged get(FlightPlanMessages_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
