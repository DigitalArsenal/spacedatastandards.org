...
public final class EOObservation_Abridged extends Table {
  ...
  public static EOObservation_Abridged getRootAsEOObservation_Abridged(ByteBuffer _bb, EOObservation_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean EOObservation_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "EOOB"); }
   ...
   * Constraints: Minimum length = 0, Maximum length = 24
   */
  public byte referenceFrame() { int o = __offset(170); return o != 0 ? bb.get(o + bb_pos) : 0; }
  /**
   * The reference frame of the observing sensor state. If the senReferenceFrame is null it is assumed to be J2000.
   * Example: /// Example: J2000
   * Constraints: Minimum length = 0, Maximum length = 24
   */
  public byte senReferenceFrame() { int o = __offset(172); return o != 0 ? bb.get(o + bb_pos) : 0; }
  /**
   * Boolean indicating that the target object was in umbral eclipse at the time of this observation.
   * Example: /// Example: False
   * Constraints: No constraints specified.
   */
  public boolean umbra() { int o = __offset(174); return o != 0 ? 0!=bb.get(o + bb_pos) : false; }
  /**
   * Boolean indicating that the target object was in a penumbral eclipse at the time of this observation.
   * Example: /// Example: False
   * Constraints: No constraints specified.
   */
  public boolean penumbra() { int o = __offset(176); return o != 0 ? 0!=bb.get(o + bb_pos) : false; }
  /**
   * The originating source network on which this record was created, auto-populated by the system.
   * Example: /// Example: ORIG
   * Constraints: Minimum length = 1, Maximum length = 32
   */
  public String origNetwork() { int o = __offset(178); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer origNetworkAsByteBuffer() { return __vector_as_bytebuffer(178, 1); }
  public ByteBuffer origNetworkInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 178, 1); }
  /**
   * The source data library from which this record was received. This could be a remote or tactical UDL or another data library. If null, the record should be assumed to have originated from the primary Enterprise UDL.
   * Example: /// Example: AXE
   * Constraints: Minimum length = 0, Maximum length = 64
   */
  public String sourceDl() { int o = __offset(180); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer sourceDlAsByteBuffer() { return __vector_as_bytebuffer(180, 1); }
  public ByteBuffer sourceDlInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 180, 1); }
  /**
   * Read only enumeration specifying the type of observation (e.g. OPTICAL, RADAR, RF, etc).
   * Example: /// Example: OPTICAL
   * Constraints: No constraints specified.
   */
  public String type() { int o = __offset(182); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer typeAsByteBuffer() { return __vector_as_bytebuffer(182, 1); }
  public ByteBuffer typeInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 182, 1); }

  public static int createEOObservation_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static void addReferenceFrame(FlatBufferBuilder builder, byte referenceFrame) { builder.addByte(83, referenceFrame, 0); }
  public static void addSenReferenceFrame(FlatBufferBuilder builder, byte senReferenceFrame) { builder.addByte(84, senReferenceFrame, 0); }
  public static void addUmbra(FlatBufferBuilder builder, boolean umbra) { builder.addBoolean(85, umbra, false); }
  public static void addPenumbra(FlatBufferBuilder builder, boolean penumbra) { builder.addBoolean(86, penumbra, false); }
  public static void addOrigNetwork(FlatBufferBuilder builder, int origNetworkOffset) { builder.addOffset(87, origNetworkOffset, 0); }
  public static void addSourceDl(FlatBufferBuilder builder, int sourceDlOffset) { builder.addOffset(88, sourceDlOffset, 0); }
  public static void addType(FlatBufferBuilder builder, int typeOffset) { builder.addOffset(89, typeOffset, 0); }
  public static int endEOObservation_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishEOObservation_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "EOOB"); }
  public static void finishSizePrefixedEOObservation_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "EOOB"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public EOObservation_Abridged get(int j) { return get(new EOObservation_Abridged(), j); }
    public EOObservation_Abridged get(EOObservation_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
