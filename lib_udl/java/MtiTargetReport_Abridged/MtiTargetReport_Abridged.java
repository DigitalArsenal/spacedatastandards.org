...
public final class MtiTargetReport_Abridged extends Table {
  ...
  public static MtiTargetReport_Abridged getRootAsMtiTargetReport_Abridged(ByteBuffer _bb, MtiTargetReport_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean MtiTargetReport_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "MTIT"); }
  ...
  public static int createMtiTargetReport_Abridged(FlatBufferBuilder builder,
      int d321,
      double d322,
      double d323,
      int d324,
  ...
  public static int endMtiTargetReport_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishMtiTargetReport_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "MTIT"); }
  public static void finishSizePrefixedMtiTargetReport_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "MTIT"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public MtiTargetReport_Abridged get(int j) { return get(new MtiTargetReport_Abridged(), j); }
    public MtiTargetReport_Abridged get(MtiTargetReport_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
