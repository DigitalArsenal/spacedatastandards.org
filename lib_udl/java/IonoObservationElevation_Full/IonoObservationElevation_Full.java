...
public final class IonoObservationElevation_Full extends Table {
  ...
  public static IonoObservationElevation_Full getRootAsIonoObservationElevation_Full(ByteBuffer _bb, IonoObservationElevation_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean IonoObservationElevation_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "IONO"); }
  ...
  public static int createIonoObservationElevation_Full(FlatBufferBuilder builder,
      int notesOffset,
  ...
  public static int endIonoObservationElevation_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishIonoObservationElevation_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "IONO"); }
  public static void finishSizePrefixedIonoObservationElevation_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "IONO"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public IonoObservationElevation_Full get(int j) { return get(new IonoObservationElevation_Full(), j); }
    public IonoObservationElevation_Full get(IonoObservationElevation_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
