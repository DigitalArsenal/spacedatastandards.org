...
public final class AirspaceControlMeans_Ingest extends Table {
  ...
  public static AirspaceControlMeans_Ingest getRootAsAirspaceControlMeans_Ingest(ByteBuffer _bb, AirspaceControlMeans_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean AirspaceControlMeans_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "AIRS"); }
  ...
  public static int createAirspaceControlMeans_Ingest(FlatBufferBuilder builder,
      int cmTypeOffset,
      int cmIdOffset,
      byte cmShape,
      int usageOffset,
  ...
  public static int endAirspaceControlMeans_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAirspaceControlMeans_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "AIRS"); }
  public static void finishSizePrefixedAirspaceControlMeans_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "AIRS"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public AirspaceControlMeans_Ingest get(int j) { return get(new AirspaceControlMeans_Ingest(), j); }
    public AirspaceControlMeans_Ingest get(AirspaceControlMeans_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
