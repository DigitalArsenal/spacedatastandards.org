...
public final class MtiDwell_Ingest extends Table {
  ...
  public static MtiDwell_Ingest getRootAsMtiDwell_Ingest(ByteBuffer _bb, MtiDwell_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean MtiDwell_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "MTID"); }
  ...
  public static int createMtiDwell_Ingest(FlatBufferBuilder builder,
      int d2,
      int d3,
      boolean d4,
      int d5,
  ...
  public static int endMtiDwell_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishMtiDwell_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "MTID"); }
  public static void finishSizePrefixedMtiDwell_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "MTID"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public MtiDwell_Ingest get(int j) { return get(new MtiDwell_Ingest(), j); }
    public MtiDwell_Ingest get(MtiDwell_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
