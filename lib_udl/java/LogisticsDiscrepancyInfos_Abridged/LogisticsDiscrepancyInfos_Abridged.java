...
public final class LogisticsDiscrepancyInfos_Abridged extends Table {
  ...
  public static LogisticsDiscrepancyInfos_Abridged getRootAsLogisticsDiscrepancyInfos_Abridged(ByteBuffer _bb, LogisticsDiscrepancyInfos_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean LogisticsDiscrepancyInfos_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "LOGI"); }
  ...
  public static int createLogisticsDiscrepancyInfos_Abridged(FlatBufferBuilder builder,
      int jcnOffset,
  ...
  public static int endLogisticsDiscrepancyInfos_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishLogisticsDiscrepancyInfos_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "LOGI"); }
  public static void finishSizePrefixedLogisticsDiscrepancyInfos_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "LOGI"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public LogisticsDiscrepancyInfos_Abridged get(int j) { return get(new LogisticsDiscrepancyInfos_Abridged(), j); }
    public LogisticsDiscrepancyInfos_Abridged get(LogisticsDiscrepancyInfos_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
