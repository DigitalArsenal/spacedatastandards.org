...
public final class LogisticsParts_Abridged extends Table {
  ...
  public static LogisticsParts_Abridged getRootAsLogisticsParts_Abridged(ByteBuffer _bb, LogisticsParts_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean LogisticsParts_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "LOGI"); }
  ...
  public static int createLogisticsParts_Abridged(FlatBufferBuilder builder,
  ...
  public static int endLogisticsParts_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishLogisticsParts_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "LOGI"); }
  public static void finishSizePrefixedLogisticsParts_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "LOGI"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public LogisticsParts_Abridged get(int j) { return get(new LogisticsParts_Abridged(), j); }
    public LogisticsParts_Abridged get(LogisticsParts_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
