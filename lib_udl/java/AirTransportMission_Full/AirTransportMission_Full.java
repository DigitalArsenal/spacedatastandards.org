...
public final class AirTransportMission_Full extends Table {
  ...
  public static AirTransportMission_Full getRootAsAirTransportMission_Full(ByteBuffer _bb, AirTransportMission_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean AirTransportMission_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "AIRT"); }
   ...
   * Constraints: No constraints specified.
   */
  public String aircraftSorties(int j) { int o = __offset(80); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int aircraftSortiesLength() { int o = __offset(80); return o != 0 ? __vector_len(o) : 0; }
  public StringVector aircraftSortiesVector() { return aircraftSortiesVector(new StringVector()); }
  public StringVector aircraftSortiesVector(StringVector obj) { int o = __offset(80); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }

  public static int createAirTransportMission_Full(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static void addAircraftSorties(FlatBufferBuilder builder, int aircraftSortiesOffset) { builder.addOffset(38, aircraftSortiesOffset, 0); }
  public static int createAircraftSortiesVector(FlatBufferBuilder builder, int[] data) { builder.startVector(4, data.length, 4); for (int i = data.length - 1; i >= 0; i--) builder.addOffset(data[i]); return builder.endVector(); }
  public static void startAircraftSortiesVector(FlatBufferBuilder builder, int numElems) { builder.startVector(4, numElems, 4); }
  public static int endAirTransportMission_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAirTransportMission_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "AIRT"); }
  public static void finishSizePrefixedAirTransportMission_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "AIRT"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public AirTransportMission_Full get(int j) { return get(new AirTransportMission_Full(), j); }
    public AirTransportMission_Full get(AirTransportMission_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
