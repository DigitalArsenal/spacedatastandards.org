...
public final class Ephemeris_Abridged extends Table {
  ...
  public static Ephemeris_Abridged getRootAsEphemeris_Abridged(ByteBuffer _bb, Ephemeris_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Ephemeris_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "EPHE"); }
  ...
  public static int createEphemeris_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endEphemeris_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishEphemeris_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "EPHE"); }
  public static void finishSizePrefixedEphemeris_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "EPHE"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Ephemeris_Abridged get(int j) { return get(new Ephemeris_Abridged(), j); }
    public Ephemeris_Abridged get(Ephemeris_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
