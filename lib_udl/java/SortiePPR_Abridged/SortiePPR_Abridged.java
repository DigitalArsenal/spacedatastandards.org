...
public final class SortiePPR_Abridged extends Table {
  ...
  public static SortiePPR_Abridged getRootAsSortiePPR_Abridged(ByteBuffer _bb, SortiePPR_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean SortiePPR_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "SORT"); }
  ...
  public static int createSortiePPR_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endSortiePPR_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishSortiePPR_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "SORT"); }
  public static void finishSizePrefixedSortiePPR_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "SORT"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public SortiePPR_Abridged get(int j) { return get(new SortiePPR_Abridged(), j); }
    public SortiePPR_Abridged get(SortiePPR_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
