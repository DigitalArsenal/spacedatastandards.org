...
public final class AirspaceControlOrder_Full extends Table {
  ...
  public static AirspaceControlOrder_Full getRootAsAirspaceControlOrder_Full(ByteBuffer _bb, AirspaceControlOrder_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean AirspaceControlOrder_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "AIRS"); }
  ...
  public static int createAirspaceControlOrder_Full(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endAirspaceControlOrder_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAirspaceControlOrder_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "AIRS"); }
  public static void finishSizePrefixedAirspaceControlOrder_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "AIRS"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public AirspaceControlOrder_Full get(int j) { return get(new AirspaceControlOrder_Full(), j); }
    public AirspaceControlOrder_Full get(AirspaceControlOrder_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
