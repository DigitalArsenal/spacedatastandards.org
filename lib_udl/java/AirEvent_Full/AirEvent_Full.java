...
public final class AirEvent_Full extends Table {
  ...
  public static AirEvent_Full getRootAsAirEvent_Full(ByteBuffer _bb, AirEvent_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean AirEvent_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "AIRE"); }
  ...
  public static int createAirEvent_Full(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endAirEvent_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAirEvent_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "AIRE"); }
  public static void finishSizePrefixedAirEvent_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "AIRE"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public AirEvent_Full get(int j) { return get(new AirEvent_Full(), j); }
    public AirEvent_Full get(AirEvent_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
