...
public final class IonoObservationPolarization_Abridged extends Table {
  ...
  public static IonoObservationPolarization_Abridged getRootAsIonoObservationPolarization_Abridged(ByteBuffer _bb, IonoObservationPolarization_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean IonoObservationPolarization_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "IONO"); }
  ...
  public static int createIonoObservationPolarization_Abridged(FlatBufferBuilder builder,
      int notesOffset,
  ...
  public static int endIonoObservationPolarization_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishIonoObservationPolarization_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "IONO"); }
  public static void finishSizePrefixedIonoObservationPolarization_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "IONO"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public IonoObservationPolarization_Abridged get(int j) { return get(new IonoObservationPolarization_Abridged(), j); }
    public IonoObservationPolarization_Abridged get(IonoObservationPolarization_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
