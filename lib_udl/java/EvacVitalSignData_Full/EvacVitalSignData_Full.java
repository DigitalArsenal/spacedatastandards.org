...
public final class EvacVitalSignData_Full extends Table {
  ...
  public static EvacVitalSignData_Full getRootAsEvacVitalSignData_Full(ByteBuffer _bb, EvacVitalSignData_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean EvacVitalSignData_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "EVAC"); }
  ...
  public static int createEvacVitalSignData_Full(FlatBufferBuilder builder,
      int vitalSignOffset,
      double vitalSign1,
      double vitalSign2,
      int medConfFactor,
  ...
  public static int endEvacVitalSignData_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishEvacVitalSignData_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "EVAC"); }
  public static void finishSizePrefixedEvacVitalSignData_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "EVAC"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public EvacVitalSignData_Full get(int j) { return get(new EvacVitalSignData_Full(), j); }
    public EvacVitalSignData_Full get(EvacVitalSignData_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
