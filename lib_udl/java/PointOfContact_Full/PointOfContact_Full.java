...
public final class PointOfContact_Full extends Table {
  ...
  public static PointOfContact_Full getRootAsPointOfContact_Full(ByteBuffer _bb, PointOfContact_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean PointOfContact_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "POIN"); }
  ...
  public static int createPointOfContact_Full(FlatBufferBuilder builder,
      int pocSequenceId,
  ...
  public static int endPointOfContact_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishPointOfContact_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "POIN"); }
  public static void finishSizePrefixedPointOfContact_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "POIN"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public PointOfContact_Full get(int j) { return get(new PointOfContact_Full(), j); }
    public PointOfContact_Full get(PointOfContact_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
