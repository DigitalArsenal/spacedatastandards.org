...
public final class GNSSRawIF_Abridged extends Table {
  ...
  public static GNSSRawIF_Abridged getRootAsGNSSRawIF_Abridged(ByteBuffer _bb, GNSSRawIF_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean GNSSRawIF_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "GNSS"); }
  ...
  public static int createGNSSRawIF_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endGNSSRawIF_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishGNSSRawIF_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "GNSS"); }
  public static void finishSizePrefixedGNSSRawIF_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "GNSS"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public GNSSRawIF_Abridged get(int j) { return get(new GNSSRawIF_Abridged(), j); }
    public GNSSRawIF_Abridged get(GNSSRawIF_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
