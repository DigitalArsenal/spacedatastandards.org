...
public final class OnboardNavigation_Ingest extends Table {
  ...
  public static OnboardNavigation_Ingest getRootAsOnboardNavigation_Ingest(ByteBuffer _bb, OnboardNavigation_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean OnboardNavigation_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "ONBO"); }
  ...
  public static int createOnboardNavigation_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endOnboardNavigation_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishOnboardNavigation_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "ONBO"); }
  public static void finishSizePrefixedOnboardNavigation_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "ONBO"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public OnboardNavigation_Ingest get(int j) { return get(new OnboardNavigation_Ingest(), j); }
    public OnboardNavigation_Ingest get(OnboardNavigation_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
