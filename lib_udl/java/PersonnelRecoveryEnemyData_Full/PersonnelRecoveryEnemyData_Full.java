...
public final class PersonnelRecoveryEnemyData_Full extends Table {
  ...
  public static PersonnelRecoveryEnemyData_Full getRootAsPersonnelRecoveryEnemyData_Full(ByteBuffer _bb, PersonnelRecoveryEnemyData_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean PersonnelRecoveryEnemyData_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "PERS"); }
  ...
  public static int createPersonnelRecoveryEnemyData_Full(FlatBufferBuilder builder,
  ...
  public static int endPersonnelRecoveryEnemyData_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishPersonnelRecoveryEnemyData_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "PERS"); }
  public static void finishSizePrefixedPersonnelRecoveryEnemyData_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "PERS"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public PersonnelRecoveryEnemyData_Full get(int j) { return get(new PersonnelRecoveryEnemyData_Full(), j); }
    public PersonnelRecoveryEnemyData_Full get(PersonnelRecoveryEnemyData_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
