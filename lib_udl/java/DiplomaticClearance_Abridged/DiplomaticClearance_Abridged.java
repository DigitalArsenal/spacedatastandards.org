...
public final class DiplomaticClearance_Abridged extends Table {
  ...
  public static DiplomaticClearance_Abridged getRootAsDiplomaticClearance_Abridged(ByteBuffer _bb, DiplomaticClearance_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean DiplomaticClearance_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "DIPL"); }
  ...
  public static int createDiplomaticClearance_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endDiplomaticClearance_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishDiplomaticClearance_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "DIPL"); }
  public static void finishSizePrefixedDiplomaticClearance_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "DIPL"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public DiplomaticClearance_Abridged get(int j) { return get(new DiplomaticClearance_Abridged(), j); }
    public DiplomaticClearance_Abridged get(DiplomaticClearance_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
