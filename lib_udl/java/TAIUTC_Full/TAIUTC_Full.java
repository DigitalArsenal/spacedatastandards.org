...
public final class TAIUTC_Full extends Table {
  ...
  public static TAIUTC_Full getRootAsTAIUTC_Full(ByteBuffer _bb, TAIUTC_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean TAIUTC_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "TAIU"); }
  ...
  public static int createTAIUTC_Full(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endTAIUTC_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishTAIUTC_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "TAIU"); }
  public static void finishSizePrefixedTAIUTC_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "TAIU"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public TAIUTC_Full get(int j) { return get(new TAIUTC_Full(), j); }
    public TAIUTC_Full get(TAIUTC_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
