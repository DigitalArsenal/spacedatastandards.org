...
public final class EvacMedication_Ingest extends Table {
  public static void ValidateVersion() { Constants.FLATBUFFERS_24_3_25(); }
  public static EvacMedication_Ingest getRootAsEvacMedication_Ingest(ByteBuffer _bb) { return getRootAsEvacMedication_Ingest(_bb, new EvacMedication_Ingest()); }
  public static EvacMedication_Ingest getRootAsEvacMedication_Ingest(ByteBuffer _bb, EvacMedication_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean EvacMedication_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "EVAC"); }
  public void __init(int _i, ByteBuffer _bb) { __reset(_i, _bb); }
  public EvacMedication_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static int createEvacMedication_Ingest(FlatBufferBuilder builder,
      int typeOffset,
      int bodyPartOffset,
      int doseOffset,
  ...
  public static void startEvacMedication_Ingest(FlatBufferBuilder builder) { builder.startTable(6); }
  ...
  public static int endEvacMedication_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishEvacMedication_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "EVAC"); }
  public static void finishSizePrefixedEvacMedication_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "EVAC"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public EvacMedication_Ingest get(int j) { return get(new EvacMedication_Ingest(), j); }
    public EvacMedication_Ingest get(EvacMedication_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
