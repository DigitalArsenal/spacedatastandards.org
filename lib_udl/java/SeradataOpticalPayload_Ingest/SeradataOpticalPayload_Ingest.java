...
public final class SeradataOpticalPayload_Ingest extends Table {
  ...
  public static SeradataOpticalPayload_Ingest getRootAsSeradataOpticalPayload_Ingest(ByteBuffer _bb, SeradataOpticalPayload_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean SeradataOpticalPayload_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "SERA"); }
  ...
  public static int createSeradataOpticalPayload_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endSeradataOpticalPayload_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishSeradataOpticalPayload_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "SERA"); }
  public static void finishSizePrefixedSeradataOpticalPayload_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "SERA"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public SeradataOpticalPayload_Ingest get(int j) { return get(new SeradataOpticalPayload_Ingest(), j); }
    public SeradataOpticalPayload_Ingest get(SeradataOpticalPayload_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
