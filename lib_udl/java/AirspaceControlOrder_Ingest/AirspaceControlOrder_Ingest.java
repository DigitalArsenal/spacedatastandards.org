...
public final class AirspaceControlOrder_Ingest extends Table {
  ...
  public static AirspaceControlOrder_Ingest getRootAsAirspaceControlOrder_Ingest(ByteBuffer _bb, AirspaceControlOrder_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean AirspaceControlOrder_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "AIRS"); }
  ...
  public static int createAirspaceControlOrder_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endAirspaceControlOrder_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAirspaceControlOrder_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "AIRS"); }
  public static void finishSizePrefixedAirspaceControlOrder_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "AIRS"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public AirspaceControlOrder_Ingest get(int j) { return get(new AirspaceControlOrder_Ingest(), j); }
    public AirspaceControlOrder_Ingest get(AirspaceControlOrder_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
