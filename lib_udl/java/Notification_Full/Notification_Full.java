...
public final class Notification_Full extends Table {
  ...
  public static Notification_Full getRootAsNotification_Full(ByteBuffer _bb, Notification_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Notification_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "NOTI"); }
  ...
  public static int createNotification_Full(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endNotification_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishNotification_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "NOTI"); }
  public static void finishSizePrefixedNotification_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "NOTI"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Notification_Full get(int j) { return get(new Notification_Full(), j); }
    public Notification_Full get(Notification_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
