...
public final class Port_Ingest extends Table {
  ...
  public static Port_Ingest getRootAsPort_Ingest(ByteBuffer _bb, Port_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Port_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "PORT"); }
  ...
  public static int createPort_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endPort_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishPort_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "PORT"); }
  public static void finishSizePrefixedPort_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "PORT"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Port_Ingest get(int j) { return get(new Port_Ingest(), j); }
    public Port_Ingest get(Port_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
