...
public final class SubStatus extends Table {
  public static void ValidateVersion() { Constants.FLATBUFFERS_24_3_25(); }
  public static SubStatus getRootAsSubStatus(ByteBuffer _bb) { return getRootAsSubStatus(_bb, new SubStatus()); }
  public static SubStatus getRootAsSubStatus(ByteBuffer _bb, SubStatus obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean SubStatusBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "SUBS"); }
  ...
  public static int createSubStatus(FlatBufferBuilder builder,
      int idOffset,
      byte type,
  ...
  public static int endSubStatus(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishSubStatusBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "SUBS"); }
  public static void finishSizePrefixedSubStatusBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "SUBS"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public SubStatus get(int j) { return get(new SubStatus(), j); }
    public SubStatus get(SubStatus obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
