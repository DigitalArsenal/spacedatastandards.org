...
public final class AircraftMissionRemarks_Full extends Table {
  ...
  public static AircraftMissionRemarks_Full getRootAsAircraftMissionRemarks_Full(ByteBuffer _bb, AircraftMissionRemarks_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean AircraftMissionRemarks_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "AIRC"); }
  ...
  public static int createAircraftMissionRemarks_Full(FlatBufferBuilder builder,
  ...
  public static int endAircraftMissionRemarks_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAircraftMissionRemarks_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "AIRC"); }
  public static void finishSizePrefixedAircraftMissionRemarks_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "AIRC"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public AircraftMissionRemarks_Full get(int j) { return get(new AircraftMissionRemarks_Full(), j); }
    public AircraftMissionRemarks_Full get(AircraftMissionRemarks_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
