...
public final class LogisticsStocks_Ingest extends Table {
  ...
  public static LogisticsStocks_Ingest getRootAsLogisticsStocks_Ingest(ByteBuffer _bb, LogisticsStocks_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean LogisticsStocks_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "LOGI"); }
  ...
  public static int createLogisticsStocks_Ingest(FlatBufferBuilder builder,
  ...
  public static int endLogisticsStocks_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishLogisticsStocks_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "LOGI"); }
  public static void finishSizePrefixedLogisticsStocks_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "LOGI"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public LogisticsStocks_Ingest get(int j) { return get(new LogisticsStocks_Ingest(), j); }
    public LogisticsStocks_Ingest get(LogisticsStocks_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
