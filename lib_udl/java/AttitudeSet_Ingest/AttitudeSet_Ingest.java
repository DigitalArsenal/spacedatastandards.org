...
public final class AttitudeSet_Ingest extends Table {
  ...
  public static AttitudeSet_Ingest getRootAsAttitudeSet_Ingest(ByteBuffer _bb, AttitudeSet_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean AttitudeSet_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "ATTI"); }
  ...
  public static int createAttitudeSet_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endAttitudeSet_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAttitudeSet_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "ATTI"); }
  public static void finishSizePrefixedAttitudeSet_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "ATTI"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public AttitudeSet_Ingest get(int j) { return get(new AttitudeSet_Ingest(), j); }
    public AttitudeSet_Ingest get(AttitudeSet_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
