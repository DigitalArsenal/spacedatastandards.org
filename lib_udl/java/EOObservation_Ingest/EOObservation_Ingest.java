...
public final class EOObservation_Ingest extends Table {
  ...
  public static EOObservation_Ingest getRootAsEOObservation_Ingest(ByteBuffer _bb, EOObservation_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean EOObservation_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "EOOB"); }
   ...
   * Constraints: Minimum length = 0, Maximum length = 24
   */
  public byte referenceFrame() { int o = __offset(176); return o != 0 ? bb.get(o + bb_pos) : 0; }
  /**
   * The reference frame of the observing sensor state. If the senReferenceFrame is null it is assumed to be J2000.
   * Example: /// Example: J2000
   * Constraints: Minimum length = 0, Maximum length = 24
   */
  public byte senReferenceFrame() { int o = __offset(178); return o != 0 ? bb.get(o + bb_pos) : 0; }
  /**
   * Boolean indicating that the target object was in umbral eclipse at the time of this observation.
   * Example: /// Example: False
   * Constraints: No constraints specified.
   */
  public boolean umbra() { int o = __offset(180); return o != 0 ? 0!=bb.get(o + bb_pos) : false; }
  /**
   * Boolean indicating that the target object was in a penumbral eclipse at the time of this observation.
   * Example: /// Example: False
   * Constraints: No constraints specified.
   */
  public boolean penumbra() { int o = __offset(182); return o != 0 ? 0!=bb.get(o + bb_pos) : false; }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public String type() { int o = __offset(188); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer typeAsByteBuffer() { return __vector_as_bytebuffer(188, 1); }
  public ByteBuffer typeInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 188, 1); }

  public static int createEOObservation_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static void addReferenceFrame(FlatBufferBuilder builder, byte referenceFrame) { builder.addByte(86, referenceFrame, 0); }
  public static void addSenReferenceFrame(FlatBufferBuilder builder, byte senReferenceFrame) { builder.addByte(87, senReferenceFrame, 0); }
  public static void addUmbra(FlatBufferBuilder builder, boolean umbra) { builder.addBoolean(88, umbra, false); }
  public static void addPenumbra(FlatBufferBuilder builder, boolean penumbra) { builder.addBoolean(89, penumbra, false); }
  ...
  public static void addType(FlatBufferBuilder builder, int typeOffset) { builder.addOffset(92, typeOffset, 0); }
  public static int endEOObservation_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishEOObservation_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "EOOB"); }
  public static void finishSizePrefixedEOObservation_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "EOOB"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public EOObservation_Ingest get(int j) { return get(new EOObservation_Ingest(), j); }
    public EOObservation_Ingest get(EOObservation_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
