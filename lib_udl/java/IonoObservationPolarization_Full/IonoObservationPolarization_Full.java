...
public final class IonoObservationPolarization_Full extends Table {
  ...
  public static IonoObservationPolarization_Full getRootAsIonoObservationPolarization_Full(ByteBuffer _bb, IonoObservationPolarization_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean IonoObservationPolarization_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "IONO"); }
  ...
  public static int createIonoObservationPolarization_Full(FlatBufferBuilder builder,
      int notesOffset,
  ...
  public static int endIonoObservationPolarization_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishIonoObservationPolarization_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "IONO"); }
  public static void finishSizePrefixedIonoObservationPolarization_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "IONO"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public IonoObservationPolarization_Full get(int j) { return get(new IonoObservationPolarization_Full(), j); }
    public IonoObservationPolarization_Full get(IonoObservationPolarization_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
