...
public final class AircraftMissionLocationTasking_Full extends Table {
  ...
  public static AircraftMissionLocationTasking_Full getRootAsAircraftMissionLocationTasking_Full(ByteBuffer _bb, AircraftMissionLocationTasking_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean AircraftMissionLocationTasking_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "AIRC"); }
  ...
  public static int createAircraftMissionLocationTasking_Full(FlatBufferBuilder builder,
      int startTimeOffset,
      int endTimeOffset,
  ...
  public static int endAircraftMissionLocationTasking_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAircraftMissionLocationTasking_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "AIRC"); }
  public static void finishSizePrefixedAircraftMissionLocationTasking_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "AIRC"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public AircraftMissionLocationTasking_Full get(int j) { return get(new AircraftMissionLocationTasking_Full(), j); }
    public AircraftMissionLocationTasking_Full get(AircraftMissionLocationTasking_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
