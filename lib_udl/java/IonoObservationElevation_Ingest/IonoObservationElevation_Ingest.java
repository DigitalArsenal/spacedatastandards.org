...
public final class IonoObservationElevation_Ingest extends Table {
  ...
  public static IonoObservationElevation_Ingest getRootAsIonoObservationElevation_Ingest(ByteBuffer _bb, IonoObservationElevation_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean IonoObservationElevation_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "IONO"); }
  ...
  public static int createIonoObservationElevation_Ingest(FlatBufferBuilder builder,
      int notesOffset,
  ...
  public static int endIonoObservationElevation_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishIonoObservationElevation_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "IONO"); }
  public static void finishSizePrefixedIonoObservationElevation_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "IONO"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public IonoObservationElevation_Ingest get(int j) { return get(new IonoObservationElevation_Ingest(), j); }
    public IonoObservationElevation_Ingest get(IonoObservationElevation_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
