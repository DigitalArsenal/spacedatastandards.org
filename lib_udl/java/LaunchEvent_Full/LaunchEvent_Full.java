...
public final class LaunchEvent_Full extends Table {
  ...
  public static LaunchEvent_Full getRootAsLaunchEvent_Full(ByteBuffer _bb, LaunchEvent_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean LaunchEvent_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "LAUN"); }
   ...
   * Constraints: No constraints specified.
   */
  public String onOrbit() { int o = __offset(42); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer onOrbitAsByteBuffer() { return __vector_as_bytebuffer(42, 1); }
  public ByteBuffer onOrbitInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 42, 1); }
  /**
   * Satellite/catalog number of the target on-orbit object.
   * Example: /// Example: 12
   * Constraints: No constraints specified.
   */
  public int satNo() { int o = __offset(44); return o != 0 ? bb.getInt(o + bb_pos) : 0; }

  public static int createLaunchEvent_Full(FlatBufferBuilder builder,
      int idOffset,
      int idOnOrbitOffset,
  ...
  public static void addOnOrbit(FlatBufferBuilder builder, int onOrbitOffset) { builder.addOffset(19, onOrbitOffset, 0); }
  public static void addSatNo(FlatBufferBuilder builder, int satNo) { builder.addInt(20, satNo, 0); }
  public static int endLaunchEvent_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishLaunchEvent_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "LAUN"); }
  public static void finishSizePrefixedLaunchEvent_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "LAUN"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public LaunchEvent_Full get(int j) { return get(new LaunchEvent_Full(), j); }
    public LaunchEvent_Full get(LaunchEvent_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
