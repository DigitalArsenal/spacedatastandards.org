...
public final class SolarArrayDetails_Abridged extends Table {
  ...
  public static SolarArrayDetails_Abridged getRootAsSolarArrayDetails_Abridged(ByteBuffer _bb, SolarArrayDetails_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean SolarArrayDetails_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "SOLA"); }
  ...
  public static int createSolarArrayDetails_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endSolarArrayDetails_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishSolarArrayDetails_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "SOLA"); }
  public static void finishSizePrefixedSolarArrayDetails_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "SOLA"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public SolarArrayDetails_Abridged get(int j) { return get(new SolarArrayDetails_Abridged(), j); }
    public SolarArrayDetails_Abridged get(SolarArrayDetails_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
