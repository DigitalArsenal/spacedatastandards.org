...
public final class DiplomaticClearanceDetails_Full extends Table {
  ...
  public static DiplomaticClearanceDetails_Full getRootAsDiplomaticClearanceDetails_Full(ByteBuffer _bb, DiplomaticClearanceDetails_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean DiplomaticClearanceDetails_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "DIPL"); }
  ...
  public static int createDiplomaticClearanceDetails_Full(FlatBufferBuilder builder,
      int idSortieOffset,
      int legNum,
  ...
  public static int endDiplomaticClearanceDetails_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishDiplomaticClearanceDetails_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "DIPL"); }
  public static void finishSizePrefixedDiplomaticClearanceDetails_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "DIPL"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public DiplomaticClearanceDetails_Full get(int j) { return get(new DiplomaticClearanceDetails_Full(), j); }
    public DiplomaticClearanceDetails_Full get(DiplomaticClearanceDetails_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
