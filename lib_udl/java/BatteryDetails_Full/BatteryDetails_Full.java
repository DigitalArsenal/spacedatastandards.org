...
public final class BatteryDetails_Full extends Table {
  ...
  public static BatteryDetails_Full getRootAsBatteryDetails_Full(ByteBuffer _bb, BatteryDetails_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean BatteryDetails_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "BATT"); }
  ...
  public static int createBatteryDetails_Full(FlatBufferBuilder builder,
      int idOffset,
      int idBatteryOffset,
  ...
  public static int endBatteryDetails_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishBatteryDetails_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "BATT"); }
  public static void finishSizePrefixedBatteryDetails_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "BATT"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public BatteryDetails_Full get(int j) { return get(new BatteryDetails_Full(), j); }
    public BatteryDetails_Full get(BatteryDetails_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
