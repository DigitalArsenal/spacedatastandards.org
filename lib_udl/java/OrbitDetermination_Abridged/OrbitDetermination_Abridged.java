...
public final class OrbitDetermination_Abridged extends Table {
  ...
  public static OrbitDetermination_Abridged getRootAsOrbitDetermination_Abridged(ByteBuffer _bb, OrbitDetermination_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean OrbitDetermination_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "ORBI"); }
  ...
  public static int createOrbitDetermination_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endOrbitDetermination_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishOrbitDetermination_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "ORBI"); }
  public static void finishSizePrefixedOrbitDetermination_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "ORBI"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public OrbitDetermination_Abridged get(int j) { return get(new OrbitDetermination_Abridged(), j); }
    public OrbitDetermination_Abridged get(OrbitDetermination_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
