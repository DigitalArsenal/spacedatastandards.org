...
public final class RoutePoints_Abridged extends Table {
  ...
  public static RoutePoints_Abridged getRootAsRoutePoints_Abridged(ByteBuffer _bb, RoutePoints_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean RoutePoints_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "ROUT"); }
  ...
  public static int createRoutePoints_Abridged(FlatBufferBuilder builder,
      int ptSequenceId,
  ...
  public static int endRoutePoints_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishRoutePoints_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "ROUT"); }
  public static void finishSizePrefixedRoutePoints_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "ROUT"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public RoutePoints_Abridged get(int j) { return get(new RoutePoints_Abridged(), j); }
    public RoutePoints_Abridged get(RoutePoints_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
