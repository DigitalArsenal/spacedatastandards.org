...
public final class EffectRequest_Full extends Table {
  ...
  public static EffectRequest_Full getRootAsEffectRequest_Full(ByteBuffer _bb, EffectRequest_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean EffectRequest_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "EFFE"); }
  ...
  public static int createEffectRequest_Full(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endEffectRequest_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishEffectRequest_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "EFFE"); }
  public static void finishSizePrefixedEffectRequest_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "EFFE"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public EffectRequest_Full get(int j) { return get(new EffectRequest_Full(), j); }
    public EffectRequest_Full get(EffectRequest_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
