...
public final class OrbitTrack_Ingest extends Table {
  ...
  public static OrbitTrack_Ingest getRootAsOrbitTrack_Ingest(ByteBuffer _bb, OrbitTrack_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean OrbitTrack_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "ORBI"); }
  ...
  public static int createOrbitTrack_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endOrbitTrack_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishOrbitTrack_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "ORBI"); }
  public static void finishSizePrefixedOrbitTrack_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "ORBI"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public OrbitTrack_Ingest get(int j) { return get(new OrbitTrack_Ingest(), j); }
    public OrbitTrack_Ingest get(OrbitTrack_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
