...
public final class EffectResponse_Ingest extends Table {
  ...
  public static EffectResponse_Ingest getRootAsEffectResponse_Ingest(ByteBuffer _bb, EffectResponse_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean EffectResponse_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "EFFE"); }
  ...
  public static int createEffectResponse_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endEffectResponse_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishEffectResponse_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "EFFE"); }
  public static void finishSizePrefixedEffectResponse_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "EFFE"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public EffectResponse_Ingest get(int j) { return get(new EffectResponse_Ingest(), j); }
    public EffectResponse_Ingest get(EffectResponse_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
