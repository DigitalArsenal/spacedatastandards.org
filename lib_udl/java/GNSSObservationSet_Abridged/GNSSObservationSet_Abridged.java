...
public final class GNSSObservationSet_Abridged extends Table {
  ...
  public static GNSSObservationSet_Abridged getRootAsGNSSObservationSet_Abridged(ByteBuffer _bb, GNSSObservationSet_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean GNSSObservationSet_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "GNSS"); }
  ...
  public static int createGNSSObservationSet_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endGNSSObservationSet_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishGNSSObservationSet_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "GNSS"); }
  public static void finishSizePrefixedGNSSObservationSet_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "GNSS"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public GNSSObservationSet_Abridged get(int j) { return get(new GNSSObservationSet_Abridged(), j); }
    public GNSSObservationSet_Abridged get(GNSSObservationSet_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
