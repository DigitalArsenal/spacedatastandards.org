...
public final class Hazard_Full extends Table {
  ...
  public static Hazard_Full getRootAsHazard_Full(ByteBuffer _bb, Hazard_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Hazard_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "HAZA"); }
  ...
  public static int createHazard_Full(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endHazard_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishHazard_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "HAZA"); }
  public static void finishSizePrefixedHazard_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "HAZA"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Hazard_Full get(int j) { return get(new Hazard_Full(), j); }
    public Hazard_Full get(Hazard_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
