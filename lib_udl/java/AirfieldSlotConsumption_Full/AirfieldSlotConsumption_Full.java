...
public final class AirfieldSlotConsumption_Full extends Table {
  ...
  public static AirfieldSlotConsumption_Full getRootAsAirfieldSlotConsumption_Full(ByteBuffer _bb, AirfieldSlotConsumption_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean AirfieldSlotConsumption_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "AIRF"); }
   ...
   * Constraints: No constraints specified.
   */
  public String updatedAt() { int o = __offset(68); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer updatedAtAsByteBuffer() { return __vector_as_bytebuffer(68, 1); }
  public ByteBuffer updatedAtInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 68, 1); }
  /**
   * Application user who updated the row in the database, auto-populated by the system.
   * Example: /// Example: some.user
   * Constraints: Minimum length = 0, Maximum length = 64
   */
  public String updatedBy() { int o = __offset(70); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer updatedByAsByteBuffer() { return __vector_as_bytebuffer(70, 1); }
  public ByteBuffer updatedByInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 70, 1); }
  /**
  ...
  public static int createAirfieldSlotConsumption_Full(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static void addUpdatedAt(FlatBufferBuilder builder, int updatedAtOffset) { builder.addOffset(32, updatedAtOffset, 0); }
  public static void addUpdatedBy(FlatBufferBuilder builder, int updatedByOffset) { builder.addOffset(33, updatedByOffset, 0); }
  ...
  public static int endAirfieldSlotConsumption_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAirfieldSlotConsumption_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "AIRF"); }
  public static void finishSizePrefixedAirfieldSlotConsumption_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "AIRF"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public AirfieldSlotConsumption_Full get(int j) { return get(new AirfieldSlotConsumption_Full(), j); }
    public AirfieldSlotConsumption_Full get(AirfieldSlotConsumption_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
