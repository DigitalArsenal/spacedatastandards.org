...
public final class Organization_Ingest extends Table {
  ...
  public static Organization_Ingest getRootAsOrganization_Ingest(ByteBuffer _bb, Organization_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Organization_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "ORGA"); }
  ...
  public static int createOrganization_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endOrganization_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishOrganization_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "ORGA"); }
  public static void finishSizePrefixedOrganization_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "ORGA"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Organization_Ingest get(int j) { return get(new Organization_Ingest(), j); }
    public Organization_Ingest get(Organization_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
