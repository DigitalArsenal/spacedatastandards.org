...
public final class RFObservationDetails_Ingest extends Table {
  public static void ValidateVersion() { Constants.FLATBUFFERS_24_3_25(); }
  public static RFObservationDetails_Ingest getRootAsRFObservationDetails_Ingest(ByteBuffer _bb) { return getRootAsRFObservationDetails_Ingest(_bb, new RFObservationDetails_Ingest()); }
  public static RFObservationDetails_Ingest getRootAsRFObservationDetails_Ingest(ByteBuffer _bb, RFObservationDetails_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean RFObservationDetails_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "RFOB"); }
  public void __init(int _i, ByteBuffer _bb) { __reset(_i, _bb); }
  public RFObservationDetails_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
   ...
   * Constraints: No constraints specified.
   */
  public String tags(int j) { int o = __offset(136); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int tagsLength() { int o = __offset(136); return o != 0 ? __vector_len(o) : 0; }
  public StringVector tagsVector() { return tagsVector(new StringVector()); }
  public StringVector tagsVector(StringVector obj) { int o = __offset(136); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   * Time the row was created in the database, auto-populated by the system.
   * Example: /// Example: 2018-01-01T16:00:00.123Z
   * Constraints: No constraints specified.
   */
  public String createdAt() { int o = __offset(138); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer createdAtAsByteBuffer() { return __vector_as_bytebuffer(138, 1); }
  public ByteBuffer createdAtInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 138, 1); }
  /**
   * Application user who created the row in the database, auto-populated by the system.
   * Example: /// Example: some.user
   * Constraints: Minimum length = 1, Maximum length = 64
   */
  public String createdBy() { int o = __offset(140); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer createdByAsByteBuffer() { return __vector_as_bytebuffer(140, 1); }
  public ByteBuffer createdByInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 140, 1); }
  /**
   * Noise power density, in dBW-Hz.
   * Example: /// Example: 10.1
   * Constraints: No constraints specified.
   */
  public double noisePwrDensity() { int o = __offset(142); return o != 0 ? bb.getDouble(o + bb_pos) : 0.0; }
  /**
   * Carrier standard (e.g. DVB-S2, 802.11g, etc.).
   * Example: /// Example: DVB-S2
   * Constraints: Minimum length = 0, Maximum length = 10
   */
  public String carrierStandard() { int o = __offset(144); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer carrierStandardAsByteBuffer() { return __vector_as_bytebuffer(144, 1); }
  public ByteBuffer carrierStandardInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 144, 1); }
  /**
   * Transponder modulation (e.g. Auto, QPSK, 8PSK, etc).
   * Example: /// Example: Auto
   * Constraints: Minimum length = 0, Maximum length = 10
   */
  public String modulation() { int o = __offset(146); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer modulationAsByteBuffer() { return __vector_as_bytebuffer(146, 1); }
  public ByteBuffer modulationInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 146, 1); }
  /**
   * Inner forward error correction rate:  0 = Auto, 1 = 1/2, 2 = 2/3, 3 = 3/4, 4 = 5/6, 5 = 7/8, 6 = 8/9, 7 = 3/5, 8 = 4/5, 9 = 9/10, 15 = None.
   * Example: /// Example: 7
   * Constraints: No constraints specified.
   */
  public int innerCodingRate() { int o = __offset(148); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  /**
   * Outer forward error correction rate:  0 = Auto, 1 = 1/2, 2 = 2/3, 3 = 3/4, 4 = 5/6, 5 = 7/8, 6 = 8/9, 7 = 3/5, 8 = 4/5, 9 = 9/10, 15 = None.
   * Example: /// Example: 4
   * Constraints: No constraints specified.
   */
  public int outerCodingRate() { int o = __offset(150); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  /**
   * Transmit pulse shaping filter typ (e.g. RRC).
   * Example: /// Example: RRC
   * Constraints: Minimum length = 0, Maximum length = 10
   */
  public String transmitFilterType() { int o = __offset(152); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer transmitFilterTypeAsByteBuffer() { return __vector_as_bytebuffer(152, 1); }
  public ByteBuffer transmitFilterTypeInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 152, 1); }
  /**
   * Transmit pulse shaping filter roll-off value.
   * Example: /// Example: 10.1
   * Constraints: No constraints specified.
   */
  public double transmitFilterRollOff() { int o = __offset(154); return o != 0 ? bb.getDouble(o + bb_pos) : 0.0; }
  /**
   * Symbol to noise ratio, in dB.
   * Example: /// Example: 10.1
   * Constraints: No constraints specified.
   */
  public double symbolToNoiseRatio() { int o = __offset(156); return o != 0 ? bb.getDouble(o + bb_pos) : 0.0; }
  /**
   * The ratio of bit errors per number of received bits.
   * Example: /// Example: 10.1
   * Constraints: No constraints specified.
   */
  public double bitErrorRate() { int o = __offset(158); return o != 0 ? bb.getDouble(o + bb_pos) : 0.0; }
  /**
   * The originating source network on which this record was created, auto-populated by the system.
   * Example: /// Example: ORIG
   * Constraints: Minimum length = 1, Maximum length = 32
   */
  public String origNetwork() { int o = __offset(160); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer origNetworkAsByteBuffer() { return __vector_as_bytebuffer(160, 1); }
  public ByteBuffer origNetworkInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 160, 1); }
  /**
   * The source data library from which this record was received. This could be a remote or tactical UDL or another data library. If null, the record should be assumed to have originated from the primary Enterprise UDL.
   * Example: /// Example: AXE
   * Constraints: Minimum length = 0, Maximum length = 64
   */
  public String sourceDl() { int o = __offset(162); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer sourceDlAsByteBuffer() { return __vector_as_bytebuffer(162, 1); }
  public ByteBuffer sourceDlInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 162, 1); }
  /**
   ...
   */
  public String url() { int o = __offset(166); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer urlAsByteBuffer() { return __vector_as_bytebuffer(166, 1); }
  public ByteBuffer urlInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 166, 1); }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public String frequencies(int j) { int o = __offset(168); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int frequenciesLength() { int o = __offset(168); return o != 0 ? __vector_len(o) : 0; }
  public StringVector frequenciesVector() { return frequenciesVector(new StringVector()); }
  public StringVector frequenciesVector(StringVector obj) { int o = __offset(168); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public String powers(int j) { int o = __offset(170); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int powersLength() { int o = __offset(170); return o != 0 ? __vector_len(o) : 0; }
  public StringVector powersVector() { return powersVector(new StringVector()); }
  public StringVector powersVector(StringVector obj) { int o = __offset(170); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   * Array of signal to noise ratios of the signals, in dB.
   * Example: /// Example: [1.1, 2.2]
   * Constraints: No constraints specified.
   */
  public String snrs(int j) { int o = __offset(172); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int snrsLength() { int o = __offset(172); return o != 0 ? __vector_len(o) : 0; }
  public StringVector snrsVector() { return snrsVector(new StringVector()); }
  public StringVector snrsVector(StringVector obj) { int o = __offset(172); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   * Array of measurement confidences.
   * Example: /// Example: [1.1, 2.2]
   * Constraints: No constraints specified.
   */
  public String confidences(int j) { int o = __offset(174); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int confidencesLength() { int o = __offset(174); return o != 0 ? __vector_len(o) : 0; }
  public StringVector confidencesVector() { return confidencesVector(new StringVector()); }
  public StringVector confidencesVector(StringVector obj) { int o = __offset(174); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   * Array of detection statuses (e.g. DETECTED, CARRIER_DETECTED, NOT_DETECTED) for each measured signal.
   * Example: /// Example: ['DETECTED']
   * Constraints: No constraints specified.
   */
  public String detectionStatuses(int j) { int o = __offset(176); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int detectionStatusesLength() { int o = __offset(176); return o != 0 ? __vector_len(o) : 0; }
  public StringVector detectionStatusesVector() { return detectionStatusesVector(new StringVector()); }
  public StringVector detectionStatusesVector(StringVector obj) { int o = __offset(176); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   * Array of chipRates.
   * Example: /// Example: [1.1, 2.2]
   * Constraints: No constraints specified.
   */
  public String chipRates(int j) { int o = __offset(178); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int chipRatesLength() { int o = __offset(178); return o != 0 ? __vector_len(o) : 0; }
  public StringVector chipRatesVector() { return chipRatesVector(new StringVector()); }
  public StringVector chipRatesVector(StringVector obj) { int o = __offset(178); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   * Array of code taps.
   * Example: /// Example: ['TAG1', 'TAG2']
   * Constraints: No constraints specified.
   */
  public String codeTaps(int j) { int o = __offset(180); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int codeTapsLength() { int o = __offset(180); return o != 0 ? __vector_len(o) : 0; }
  public StringVector codeTapsVector() { return codeTapsVector(new StringVector()); }
  public StringVector codeTapsVector(StringVector obj) { int o = __offset(180); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   * Array of code fills.
   * Example: /// Example: ['TAG1', 'TAG2']
   * Constraints: No constraints specified.
   */
  public String codeFills(int j) { int o = __offset(182); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int codeFillsLength() { int o = __offset(182); return o != 0 ? __vector_len(o) : 0; }
  public StringVector codeFillsVector() { return codeFillsVector(new StringVector()); }
  public StringVector codeFillsVector(StringVector obj) { int o = __offset(182); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   * Array of code lengths.
   * Example: /// Example: [1.1, 2.2]
   * Constraints: No constraints specified.
   */
  public String codeLengths(int j) { int o = __offset(184); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int codeLengthsLength() { int o = __offset(184); return o != 0 ? __vector_len(o) : 0; }
  public StringVector codeLengthsVector() { return codeLengthsVector(new StringVector()); }
  public StringVector codeLengthsVector(StringVector obj) { int o = __offset(184); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   * Array of pnOrder.
   * Example: /// Example: [1, 2]
   * Constraints: No constraints specified.
   */
  public String pnOrders(int j) { int o = __offset(186); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int pnOrdersLength() { int o = __offset(186); return o != 0 ? __vector_len(o) : 0; }
  public StringVector pnOrdersVector() { return pnOrdersVector(new StringVector()); }
  public StringVector pnOrdersVector(StringVector obj) { int o = __offset(186); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   * Array of optional source provided identifiers of the measurements/signals.
   * Example: /// Example: ['ID1', 'ID2']
   * Constraints: No constraints specified.
   */
  public String signalIds(int j) { int o = __offset(188); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int signalIdsLength() { int o = __offset(188); return o != 0 ? __vector_len(o) : 0; }
  public StringVector signalIdsVector() { return signalIdsVector(new StringVector()); }
  public StringVector signalIdsVector(StringVector obj) { int o = __offset(188); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   * Array of measured signal baud rates.
   * Example: /// Example: [1.1, 2.2]
   * Constraints: No constraints specified.
   */
  public String baudRates(int j) { int o = __offset(190); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int baudRatesLength() { int o = __offset(190); return o != 0 ? __vector_len(o) : 0; }
  public StringVector baudRatesVector() { return baudRatesVector(new StringVector()); }
  public StringVector baudRatesVector(StringVector obj) { int o = __offset(190); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   * Array of optional source provided telemetry identifiers of the measurements/signals.
   * Example: /// Example: ['ID1', 'ID2']
   * Constraints: No constraints specified.
   */
  public String telemetryIds(int j) { int o = __offset(192); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int telemetryIdsLength() { int o = __offset(192); return o != 0 ? __vector_len(o) : 0; }
  public StringVector telemetryIdsVector() { return telemetryIdsVector(new StringVector()); }
  public StringVector telemetryIdsVector(StringVector obj) { int o = __offset(192); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public String constellationXpoints(int j) { int o = __offset(194); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int constellationXpointsLength() { int o = __offset(194); return o != 0 ? __vector_len(o) : 0; }
  public StringVector constellationXpointsVector() { return constellationXpointsVector(new StringVector()); }
  public StringVector constellationXpointsVector(StringVector obj) { int o = __offset(194); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public String constellationYpoints(int j) { int o = __offset(196); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int constellationYpointsLength() { int o = __offset(196); return o != 0 ? __vector_len(o) : 0; }
  public StringVector constellationYpointsVector() { return constellationYpointsVector(new StringVector()); }
  public StringVector constellationYpointsVector(StringVector obj) { int o = __offset(196); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }

  public static int createRFObservationDetails_Ingest(FlatBufferBuilder builder,
      int idOffset,
      ...
      int powersOffset,
      int snrsOffset,
      int confidencesOffset,
      int detectionStatusesOffset,
      int chipRatesOffset,
      int codeTapsOffset,
      int codeFillsOffset,
      int codeLengthsOffset,
      int pnOrdersOffset,
      int signalIdsOffset,
      int baudRatesOffset,
      int telemetryIdsOffset,
      int constellationXpointsOffset,
      int constellationYpointsOffset) {
  ...
  public static void startRFObservationDetails_Ingest(FlatBufferBuilder builder) { builder.startTable(97); }
  ...
  public static void addTags(FlatBufferBuilder builder, int tagsOffset) { builder.addOffset(66, tagsOffset, 0); }
  ...
  public static void addCreatedAt(FlatBufferBuilder builder, int createdAtOffset) { builder.addOffset(67, createdAtOffset, 0); }
  public static void addCreatedBy(FlatBufferBuilder builder, int createdByOffset) { builder.addOffset(68, createdByOffset, 0); }
  ...
  public static void addCarrierStandard(FlatBufferBuilder builder, int carrierStandardOffset) { builder.addOffset(70, carrierStandardOffset, 0); }
  public static void addModulation(FlatBufferBuilder builder, int modulationOffset) { builder.addOffset(71, modulationOffset, 0); }
  ...
  public static void addTransmitFilterType(FlatBufferBuilder builder, int transmitFilterTypeOffset) { builder.addOffset(74, transmitFilterTypeOffset, 0); }
  ...
  public static void addOrigNetwork(FlatBufferBuilder builder, int origNetworkOffset) { builder.addOffset(78, origNetworkOffset, 0); }
  public static void addSourceDl(FlatBufferBuilder builder, int sourceDlOffset) { builder.addOffset(79, sourceDlOffset, 0); }
  public static void addDescriptor(FlatBufferBuilder builder, int descriptorOffset) { builder.addOffset(80, descriptorOffset, 0); }
  public static void addUrl(FlatBufferBuilder builder, int urlOffset) { builder.addOffset(81, urlOffset, 0); }
  public static void addFrequencies(FlatBufferBuilder builder, int frequenciesOffset) { builder.addOffset(82, frequenciesOffset, 0); }
  public static int createFrequenciesVector(FlatBufferBuilder builder, int[] data) { builder.startVector(4, data.length, 4); for (int i = data.length - 1; i >= 0; i--) builder.addOffset(data[i]); return builder.endVector(); }
  public static void startFrequenciesVector(FlatBufferBuilder builder, int numElems) { builder.startVector(4, numElems, 4); }
  public static void addPowers(FlatBufferBuilder builder, int powersOffset) { builder.addOffset(83, powersOffset, 0); }
  public static int createPowersVector(FlatBufferBuilder builder, int[] data) { builder.startVector(4, data.length, 4); for (int i = data.length - 1; i >= 0; i--) builder.addOffset(data[i]); return builder.endVector(); }
  public static void startPowersVector(FlatBufferBuilder builder, int numElems) { builder.startVector(4, numElems, 4); }
  public static void addSnrs(FlatBufferBuilder builder, int snrsOffset) { builder.addOffset(84, snrsOffset, 0); }
  ...
  public static void addConfidences(FlatBufferBuilder builder, int confidencesOffset) { builder.addOffset(85, confidencesOffset, 0); }
  public static int createConfidencesVector(FlatBufferBuilder builder, int[] data) { builder.startVector(4, data.length, 4); for (int i = data.length - 1; i >= 0; i--) builder.addOffset(data[i]); return builder.endVector(); }
  public static void startConfidencesVector(FlatBufferBuilder builder, int numElems) { builder.startVector(4, numElems, 4); }
  public static void addDetectionStatuses(FlatBufferBuilder builder, int detectionStatusesOffset) { builder.addOffset(86, detectionStatusesOffset, 0); }
  public static int createDetectionStatusesVector(FlatBufferBuilder builder, int[] data) { builder.startVector(4, data.length, 4); for (int i = data.length - 1; i >= 0; i--) builder.addOffset(data[i]); return builder.endVector(); }
  public static void startDetectionStatusesVector(FlatBufferBuilder builder, int numElems) { builder.startVector(4, numElems, 4); }
  public static void addChipRates(FlatBufferBuilder builder, int chipRatesOffset) { builder.addOffset(87, chipRatesOffset, 0); }
  public static int createChipRatesVector(FlatBufferBuilder builder, int[] data) { builder.startVector(4, data.length, 4); for (int i = data.length - 1; i >= 0; i--) builder.addOffset(data[i]); return builder.endVector(); }
  public static void startChipRatesVector(FlatBufferBuilder builder, int numElems) { builder.startVector(4, numElems, 4); }
  public static void addCodeTaps(FlatBufferBuilder builder, int codeTapsOffset) { builder.addOffset(88, codeTapsOffset, 0); }
  public static int createCodeTapsVector(FlatBufferBuilder builder, int[] data) { builder.startVector(4, data.length, 4); for (int i = data.length - 1; i >= 0; i--) builder.addOffset(data[i]); return builder.endVector(); }
  public static void startCodeTapsVector(FlatBufferBuilder builder, int numElems) { builder.startVector(4, numElems, 4); }
  public static void addCodeFills(FlatBufferBuilder builder, int codeFillsOffset) { builder.addOffset(89, codeFillsOffset, 0); }
  public static int createCodeFillsVector(FlatBufferBuilder builder, int[] data) { builder.startVector(4, data.length, 4); for (int i = data.length - 1; i >= 0; i--) builder.addOffset(data[i]); return builder.endVector(); }
  public static void startCodeFillsVector(FlatBufferBuilder builder, int numElems) { builder.startVector(4, numElems, 4); }
  public static void addCodeLengths(FlatBufferBuilder builder, int codeLengthsOffset) { builder.addOffset(90, codeLengthsOffset, 0); }
  public static int createCodeLengthsVector(FlatBufferBuilder builder, int[] data) { builder.startVector(4, data.length, 4); for (int i = data.length - 1; i >= 0; i--) builder.addOffset(data[i]); return builder.endVector(); }
  public static void startCodeLengthsVector(FlatBufferBuilder builder, int numElems) { builder.startVector(4, numElems, 4); }
  public static void addPnOrders(FlatBufferBuilder builder, int pnOrdersOffset) { builder.addOffset(91, pnOrdersOffset, 0); }
  public static int createPnOrdersVector(FlatBufferBuilder builder, int[] data) { builder.startVector(4, data.length, 4); for (int i = data.length - 1; i >= 0; i--) builder.addOffset(data[i]); return builder.endVector(); }
  public static void startPnOrdersVector(FlatBufferBuilder builder, int numElems) { builder.startVector(4, numElems, 4); }
  public static void addSignalIds(FlatBufferBuilder builder, int signalIdsOffset) { builder.addOffset(92, signalIdsOffset, 0); }
  public static int createSignalIdsVector(FlatBufferBuilder builder, int[] data) { builder.startVector(4, data.length, 4); for (int i = data.length - 1; i >= 0; i--) builder.addOffset(data[i]); return builder.endVector(); }
  public static void startSignalIdsVector(FlatBufferBuilder builder, int numElems) { builder.startVector(4, numElems, 4); }
  public static void addBaudRates(FlatBufferBuilder builder, int baudRatesOffset) { builder.addOffset(93, baudRatesOffset, 0); }
  public static int createBaudRatesVector(FlatBufferBuilder builder, int[] data) { builder.startVector(4, data.length, 4); for (int i = data.length - 1; i >= 0; i--) builder.addOffset(data[i]); return builder.endVector(); }
  public static void startBaudRatesVector(FlatBufferBuilder builder, int numElems) { builder.startVector(4, numElems, 4); }
  public static void addTelemetryIds(FlatBufferBuilder builder, int telemetryIdsOffset) { builder.addOffset(94, telemetryIdsOffset, 0); }
  public static int createTelemetryIdsVector(FlatBufferBuilder builder, int[] data) { builder.startVector(4, data.length, 4); for (int i = data.length - 1; i >= 0; i--) builder.addOffset(data[i]); return builder.endVector(); }
  public static void startTelemetryIdsVector(FlatBufferBuilder builder, int numElems) { builder.startVector(4, numElems, 4); }
  public static void addConstellationXpoints(FlatBufferBuilder builder, int constellationXpointsOffset) { builder.addOffset(95, constellationXpointsOffset, 0); }
  public static int createConstellationXpointsVector(FlatBufferBuilder builder, int[] data) { builder.startVector(4, data.length, 4); for (int i = data.length - 1; i >= 0; i--) builder.addOffset(data[i]); return builder.endVector(); }
  ...
  public static void addConstellationYpoints(FlatBufferBuilder builder, int constellationYpointsOffset) { builder.addOffset(96, constellationYpointsOffset, 0); }
  public static int createConstellationYpointsVector(FlatBufferBuilder builder, int[] data) { builder.startVector(4, data.length, 4); for (int i = data.length - 1; i >= 0; i--) builder.addOffset(data[i]); return builder.endVector(); }
  ...
  public static int endRFObservationDetails_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishRFObservationDetails_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "RFOB"); }
  public static void finishSizePrefixedRFObservationDetails_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "RFOB"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public RFObservationDetails_Ingest get(int j) { return get(new RFObservationDetails_Ingest(), j); }
    public RFObservationDetails_Ingest get(RFObservationDetails_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
