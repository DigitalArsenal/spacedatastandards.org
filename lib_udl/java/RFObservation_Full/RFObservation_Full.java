...
public final class RFObservation_Full extends Table {
  public static void ValidateVersion() { Constants.FLATBUFFERS_24_3_25(); }
  public static RFObservation_Full getRootAsRFObservation_Full(ByteBuffer _bb) { return getRootAsRFObservation_Full(_bb, new RFObservation_Full()); }
  public static RFObservation_Full getRootAsRFObservation_Full(ByteBuffer _bb, RFObservation_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean RFObservation_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "RFOB"); }
  public void __init(int _i, ByteBuffer _bb) { __reset(_i, _bb); }
  public RFObservation_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static int createRFObservation_Full(FlatBufferBuilder builder,
      int idOffset,
    ...
    RFObservation_Full.addBitErrorRate(builder, bitErrorRate);
    RFObservation_Full.addSymbolToNoiseRatio(builder, symbolToNoiseRatio);
    RFObservation_Full.addTransmitFilterRollOff(builder, transmitFilterRollOff);
    RFObservation_Full.addNoisePwrDensity(builder, noisePwrDensity);
    RFObservation_Full.addFrequencyShift(builder, frequencyShift);
    RFObservation_Full.addMaxPsd(builder, maxPsd);
    RFObservation_Full.addMinPsd(builder, minPsd);
    RFObservation_Full.addNominalEirp(builder, nominalEirp);
    RFObservation_Full.addEirp(builder, eirp);
    RFObservation_Full.addVideoBandwidth(builder, videoBandwidth);
    RFObservation_Full.addResolutionBandwidth(builder, resolutionBandwidth);
    RFObservation_Full.addNominalBandwidth(builder, nominalBandwidth);
    RFObservation_Full.addBandwidth(builder, bandwidth);
    RFObservation_Full.addNominalPowerOverNoise(builder, nominalPowerOverNoise);
    RFObservation_Full.addPowerOverNoise(builder, powerOverNoise);
    RFObservation_Full.addPolarity(builder, polarity);
    RFObservation_Full.addNominalSnr(builder, nominalSnr);
    RFObservation_Full.addSnr(builder, snr);
    RFObservation_Full.addBaudRate(builder, baudRate);
    RFObservation_Full.addConfidence(builder, confidence);
    RFObservation_Full.addPgri(builder, pgri);
    RFObservation_Full.addReferenceLevel(builder, referenceLevel);
    RFObservation_Full.addRelativeNoiseFloor(builder, relativeNoiseFloor);
    RFObservation_Full.addSpectrumAnalyzerPower(builder, spectrumAnalyzerPower);
    RFObservation_Full.addRelativeCarrierPower(builder, relativeCarrierPower);
    RFObservation_Full.addEndFrequency(builder, endFrequency);
    RFObservation_Full.addStartFrequency(builder, startFrequency);
    RFObservation_Full.addNominalFrequency(builder, nominalFrequency);
    RFObservation_Full.addFrequency(builder, frequency);
    RFObservation_Full.addSenalt(builder, senalt);
    RFObservation_Full.addSenlon(builder, senlon);
    RFObservation_Full.addSenlat(builder, senlat);
    RFObservation_Full.addTrackRange(builder, trackRange);
    RFObservation_Full.addRangeRateUnc(builder, rangeRateUnc);
    RFObservation_Full.addRangeRate(builder, rangeRate);
    RFObservation_Full.addRangeUnc(builder, rangeUnc);
    RFObservation_Full.addRange(builder, range);
    RFObservation_Full.addElevationRate(builder, elevationRate);
    RFObservation_Full.addElevationUnc(builder, elevationUnc);
    RFObservation_Full.addElevation(builder, elevation);
    RFObservation_Full.addAzimuthRate(builder, azimuthRate);
    RFObservation_Full.addAzimuthUnc(builder, azimuthUnc);
    RFObservation_Full.addAzimuth(builder, azimuth);
    RFObservation_Full.addUrl(builder, urlOffset);
    RFObservation_Full.addDescriptor(builder, descriptorOffset);
    RFObservation_Full.addOnOrbit(builder, onOrbitOffset);
    RFObservation_Full.addSourceDl(builder, sourceDlOffset);
    RFObservation_Full.addOrigNetwork(builder, origNetworkOffset);
    RFObservation_Full.addTransmitFilterType(builder, transmitFilterTypeOffset);
    RFObservation_Full.addOuterCodingRate(builder, outerCodingRate);
    RFObservation_Full.addInnerCodingRate(builder, innerCodingRate);
    RFObservation_Full.addModulation(builder, modulationOffset);
    RFObservation_Full.addCarrierStandard(builder, carrierStandardOffset);
    RFObservation_Full.addCreatedBy(builder, createdByOffset);
    RFObservation_Full.addCreatedAt(builder, createdAtOffset);
    RFObservation_Full.addTags(builder, tagsOffset);
    RFObservation_Full.addOrigin(builder, originOffset);
    RFObservation_Full.addSource(builder, sourceOffset);
    RFObservation_Full.addRawFileUri(builder, rawFileUriOffset);
    RFObservation_Full.addCollectionMode(builder, collectionModeOffset);
    RFObservation_Full.addDetectionStatus(builder, detectionStatusOffset);
    RFObservation_Full.addAntennaName(builder, antennaNameOffset);
    RFObservation_Full.addChannel(builder, channel);
    RFObservation_Full.addSwitchPoint(builder, switchPoint);
    RFObservation_Full.addElnot(builder, elnotOffset);
    RFObservation_Full.addTransponder(builder, transponderOffset);
    RFObservation_Full.addOrigSensorId(builder, origSensorIdOffset);
    RFObservation_Full.addOrigObjectId(builder, origObjectIdOffset);
    RFObservation_Full.addTrackId(builder, trackIdOffset);
    RFObservation_Full.addTransactionId(builder, transactionIdOffset);
    RFObservation_Full.addTaskId(builder, taskIdOffset);
    RFObservation_Full.addSatNo(builder, satNo);
    RFObservation_Full.addType(builder, typeOffset);
    RFObservation_Full.addIdSensor(builder, idSensorOffset);
    RFObservation_Full.addIdOnOrbit(builder, idOnOrbitOffset);
    RFObservation_Full.addObTime(builder, obTimeOffset);
    RFObservation_Full.addClassificationMarking(builder, classificationMarkingOffset);
    RFObservation_Full.addId(builder, idOffset);
    RFObservation_Full.addDataMode(builder, dataMode);
    RFObservation_Full.addPeak(builder, peak);
    RFObservation_Full.addPolarityType(builder, polarityType);
    RFObservation_Full.addIncoming(builder, incoming);
    RFObservation_Full.addUct(builder, uct);
    return RFObservation_Full.endRFObservation_Full(builder);
  }

  public static void startRFObservation_Full(FlatBufferBuilder builder) { builder.startTable(83); }
  ...
  public static int endRFObservation_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishRFObservation_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "RFOB"); }
  public static void finishSizePrefixedRFObservation_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "RFOB"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public RFObservation_Full get(int j) { return get(new RFObservation_Full(), j); }
    public RFObservation_Full get(RFObservation_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
