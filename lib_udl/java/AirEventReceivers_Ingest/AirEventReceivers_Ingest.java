...
public final class AirEventReceivers_Ingest extends Table {
  ...
  public static AirEventReceivers_Ingest getRootAsAirEventReceivers_Ingest(ByteBuffer _bb, AirEventReceivers_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean AirEventReceivers_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "AIRE"); }
  ...
  public static int createAirEventReceivers_Ingest(FlatBufferBuilder builder,
  ...
  public static int endAirEventReceivers_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAirEventReceivers_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "AIRE"); }
  public static void finishSizePrefixedAirEventReceivers_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "AIRE"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public AirEventReceivers_Ingest get(int j) { return get(new AirEventReceivers_Ingest(), j); }
    public AirEventReceivers_Ingest get(AirEventReceivers_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
