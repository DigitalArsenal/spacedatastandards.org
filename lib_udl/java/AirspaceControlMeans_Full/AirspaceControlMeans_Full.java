...
public final class AirspaceControlMeans_Full extends Table {
  ...
  public static AirspaceControlMeans_Full getRootAsAirspaceControlMeans_Full(ByteBuffer _bb, AirspaceControlMeans_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean AirspaceControlMeans_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "AIRS"); }
  ...
  public static int createAirspaceControlMeans_Full(FlatBufferBuilder builder,
      int cmTypeOffset,
      int cmIdOffset,
      byte cmShape,
      int usageOffset,
  ...
  public static int endAirspaceControlMeans_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAirspaceControlMeans_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "AIRS"); }
  public static void finishSizePrefixedAirspaceControlMeans_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "AIRS"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public AirspaceControlMeans_Full get(int j) { return get(new AirspaceControlMeans_Full(), j); }
    public AirspaceControlMeans_Full get(AirspaceControlMeans_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
