...
public final class IonoObservationDensityProfile_Ingest extends Table {
  ...
  public static IonoObservationDensityProfile_Ingest getRootAsIonoObservationDensityProfile_Ingest(ByteBuffer _bb, IonoObservationDensityProfile_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean IonoObservationDensityProfile_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "IONO"); }
  ...
  public static int createIonoObservationDensityProfile_Ingest(FlatBufferBuilder builder,
      int parabolicOffset,
  ...
  public static int endIonoObservationDensityProfile_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishIonoObservationDensityProfile_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "IONO"); }
  public static void finishSizePrefixedIonoObservationDensityProfile_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "IONO"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public IonoObservationDensityProfile_Ingest get(int j) { return get(new IonoObservationDensityProfile_Ingest(), j); }
    public IonoObservationDensityProfile_Ingest get(IonoObservationDensityProfile_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
