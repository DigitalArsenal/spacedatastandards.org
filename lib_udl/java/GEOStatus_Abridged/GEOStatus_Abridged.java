...
public final class GEOStatus_Abridged extends Table {
  ...
  public static GEOStatus_Abridged getRootAsGEOStatus_Abridged(ByteBuffer _bb, GEOStatus_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean GEOStatus_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "GEOS"); }
  ...
  public static int createGEOStatus_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endGEOStatus_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishGEOStatus_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "GEOS"); }
  public static void finishSizePrefixedGEOStatus_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "GEOS"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public GEOStatus_Abridged get(int j) { return get(new GEOStatus_Abridged(), j); }
    public GEOStatus_Abridged get(GEOStatus_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
