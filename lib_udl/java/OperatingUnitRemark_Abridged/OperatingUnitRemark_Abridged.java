...
public final class OperatingUnitRemark_Abridged extends Table {
  ...
  public static OperatingUnitRemark_Abridged getRootAsOperatingUnitRemark_Abridged(ByteBuffer _bb, OperatingUnitRemark_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean OperatingUnitRemark_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "OPER"); }
  ...
  public static int createOperatingUnitRemark_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endOperatingUnitRemark_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishOperatingUnitRemark_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "OPER"); }
  public static void finishSizePrefixedOperatingUnitRemark_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "OPER"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public OperatingUnitRemark_Abridged get(int j) { return get(new OperatingUnitRemark_Abridged(), j); }
    public OperatingUnitRemark_Abridged get(OperatingUnitRemark_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
