...
public final class TrackRoute_Ingest extends Table {
  ...
  public static TrackRoute_Ingest getRootAsTrackRoute_Ingest(ByteBuffer _bb, TrackRoute_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean TrackRoute_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "TRAC"); }
  ...
  public static int createTrackRoute_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endTrackRoute_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishTrackRoute_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "TRAC"); }
  public static void finishSizePrefixedTrackRoute_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "TRAC"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public TrackRoute_Ingest get(int j) { return get(new TrackRoute_Ingest(), j); }
    public TrackRoute_Ingest get(TrackRoute_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
