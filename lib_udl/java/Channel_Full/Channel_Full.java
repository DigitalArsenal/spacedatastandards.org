...
public final class Channel_Full extends Table {
  ...
  public static Channel_Full getRootAsChannel_Full(ByteBuffer _bb, Channel_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Channel_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "CHAN"); }
  ...
  public static int createChannel_Full(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endChannel_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishChannel_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "CHAN"); }
  public static void finishSizePrefixedChannel_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "CHAN"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Channel_Full get(int j) { return get(new Channel_Full(), j); }
    public Channel_Full get(Channel_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
