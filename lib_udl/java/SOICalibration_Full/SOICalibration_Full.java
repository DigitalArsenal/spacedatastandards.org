...
public final class SOICalibration_Full extends Table {
  ...
  public static SOICalibration_Full getRootAsSOICalibration_Full(ByteBuffer _bb, SOICalibration_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean SOICalibration_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "SOIC"); }
  ...
  public static int createSOICalibration_Full(FlatBufferBuilder builder,
  ...
  public static int endSOICalibration_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishSOICalibration_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "SOIC"); }
  public static void finishSizePrefixedSOICalibration_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "SOIC"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public SOICalibration_Full get(int j) { return get(new SOICalibration_Full(), j); }
    public SOICalibration_Full get(SOICalibration_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
