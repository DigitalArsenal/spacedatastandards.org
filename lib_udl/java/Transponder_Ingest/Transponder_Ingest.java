...
public final class Transponder_Ingest extends Table {
  ...
  public static Transponder_Ingest getRootAsTransponder_Ingest(ByteBuffer _bb, Transponder_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Transponder_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "TRAN"); }
  ...
  public static int createTransponder_Ingest(FlatBufferBuilder builder,
      int idOffset,
      int idCommOffset,
      int nameOffset,
  ...
  public static int endTransponder_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishTransponder_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "TRAN"); }
  public static void finishSizePrefixedTransponder_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "TRAN"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Transponder_Ingest get(int j) { return get(new Transponder_Ingest(), j); }
    public Transponder_Ingest get(Transponder_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
