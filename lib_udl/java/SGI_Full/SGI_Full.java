...
public final class SGI_Full extends Table {
  public static void ValidateVersion() { Constants.FLATBUFFERS_24_3_25(); }
  public static SGI_Full getRootAsSGI_Full(ByteBuffer _bb) { return getRootAsSGI_Full(_bb, new SGI_Full()); }
  public static SGI_Full getRootAsSGI_Full(ByteBuffer _bb, SGI_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean SGI_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "SGIF"); }
  public void __init(int _i, ByteBuffer _bb) { __reset(_i, _bb); }
  public SGI_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
   ...
   * Constraints: No constraints specified.
   */
  public String observedBaseline(int j) { int o = __offset(86); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int observedBaselineLength() { int o = __offset(86); return o != 0 ? __vector_len(o) : 0; }
  public StringVector observedBaselineVector() { return observedBaselineVector(new StringVector()); }
  public StringVector observedBaselineVector(StringVector obj) { int o = __offset(86); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public String frequencies(int j) { int o = __offset(88); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int frequenciesLength() { int o = __offset(88); return o != 0 ? __vector_len(o) : 0; }
  public StringVector frequenciesVector() { return frequenciesVector(new StringVector()); }
  public StringVector frequenciesVector(StringVector obj) { int o = __offset(88); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public String powers(int j) { int o = __offset(90); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int powersLength() { int o = __offset(90); return o != 0 ? __vector_len(o) : 0; }
  public StringVector powersVector() { return powersVector(new StringVector()); }
  public StringVector powersVector(StringVector obj) { int o = __offset(90); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   ...
   * Constraints: Minimum length = 0, Maximum length = 64
   */
  public String transactionId() { int o = __offset(94); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer transactionIdAsByteBuffer() { return __vector_as_bytebuffer(94, 1); }
  public ByteBuffer transactionIdInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 94, 1); }
  /**
   * Optional array of provider/source specific tags for this data, where each element is no longer than 32 characters, used for implementing data owner conditional access controls to restrict access to the data. Should be left null by data providers unless conditional access controls are coordinated with the UDL team.
   * Example: /// Example: ['PROVIDER_TAG1', 'PROVIDER_TAG2']
   * Constraints: No constraints specified.
   */
  public String tags(int j) { int o = __offset(96); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int tagsLength() { int o = __offset(96); return o != 0 ? __vector_len(o) : 0; }
  public StringVector tagsVector() { return tagsVector(new StringVector()); }
  public StringVector tagsVector(StringVector obj) { int o = __offset(96); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   * Source of the data.
   ...
   * Constraints: No constraints specified.
   */
  public String updatedAt() { int o = __offset(110); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer updatedAtAsByteBuffer() { return __vector_as_bytebuffer(110, 1); }
  public ByteBuffer updatedAtInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 110, 1); }
  /**
   * Application user who updated the row in the database, auto-populated by the system.
   * Example: /// Example: some.user
   * Constraints: Minimum length = 0, Maximum length = 64
   */
  public String updatedBy() { int o = __offset(112); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer updatedByAsByteBuffer() { return __vector_as_bytebuffer(112, 1); }
  public ByteBuffer updatedByInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 112, 1); }

  public static int createSGI_Full(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static void startSGI_Full(FlatBufferBuilder builder) { builder.startTable(55); }
  ...
  public static void addObservedBaseline(FlatBufferBuilder builder, int observedBaselineOffset) { builder.addOffset(41, observedBaselineOffset, 0); }
  public static int createObservedBaselineVector(FlatBufferBuilder builder, int[] data) { builder.startVector(4, data.length, 4); for (int i = data.length - 1; i >= 0; i--) builder.addOffset(data[i]); return builder.endVector(); }
  public static void startObservedBaselineVector(FlatBufferBuilder builder, int numElems) { builder.startVector(4, numElems, 4); }
  public static void addFrequencies(FlatBufferBuilder builder, int frequenciesOffset) { builder.addOffset(42, frequenciesOffset, 0); }
  ...
  public static void addPowers(FlatBufferBuilder builder, int powersOffset) { builder.addOffset(43, powersOffset, 0); }
  ...
  public static void addTransactionId(FlatBufferBuilder builder, int transactionIdOffset) { builder.addOffset(45, transactionIdOffset, 0); }
  public static void addTags(FlatBufferBuilder builder, int tagsOffset) { builder.addOffset(46, tagsOffset, 0); }
  ...
  public static void addUpdatedAt(FlatBufferBuilder builder, int updatedAtOffset) { builder.addOffset(53, updatedAtOffset, 0); }
  public static void addUpdatedBy(FlatBufferBuilder builder, int updatedByOffset) { builder.addOffset(54, updatedByOffset, 0); }
  public static int endSGI_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishSGI_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "SGIF"); }
  public static void finishSizePrefixedSGI_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "SGIF"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public SGI_Full get(int j) { return get(new SGI_Full(), j); }
    public SGI_Full get(SGI_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
