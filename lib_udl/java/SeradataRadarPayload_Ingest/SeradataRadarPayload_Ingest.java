...
public final class SeradataRadarPayload_Ingest extends Table {
  ...
  public static SeradataRadarPayload_Ingest getRootAsSeradataRadarPayload_Ingest(ByteBuffer _bb, SeradataRadarPayload_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean SeradataRadarPayload_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "SERA"); }
   ...
   * Constraints: Minimum length = 1, Maximum length = 64
   */
  public String source() { int o = __offset(60); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer sourceAsByteBuffer() { return __vector_as_bytebuffer(60, 1); }
  public ByteBuffer sourceInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 60, 1); }
  /**
   * Originating system or organization which produced the data, if different from the source. The origin may be different than the source if the source was a mediating system which forwarded the data on behalf of the origin system. If null, the source may be assumed to be the origin.
   * Example: /// Example: THIRD_PARTY_DATASOURCE
   * Constraints: Minimum length = 0, Maximum length = 64
   */
  public String origin() { int o = __offset(62); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer originAsByteBuffer() { return __vector_as_bytebuffer(62, 1); }
  public ByteBuffer originInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 62, 1); }
  /**
  ...
  public static int createSeradataRadarPayload_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static void addSource(FlatBufferBuilder builder, int sourceOffset) { builder.addOffset(28, sourceOffset, 0); }
  public static void addOrigin(FlatBufferBuilder builder, int originOffset) { builder.addOffset(29, originOffset, 0); }
  ...
  public static int endSeradataRadarPayload_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishSeradataRadarPayload_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "SERA"); }
  public static void finishSizePrefixedSeradataRadarPayload_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "SERA"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public SeradataRadarPayload_Ingest get(int j) { return get(new SeradataRadarPayload_Ingest(), j); }
    public SeradataRadarPayload_Ingest get(SeradataRadarPayload_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
