...
public final class ISRCollectionTaskings_Full extends Table {
  ...
  public static ISRCollectionTaskings_Full getRootAsISRCollectionTaskings_Full(ByteBuffer _bb, ISRCollectionTaskings_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean ISRCollectionTaskings_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "ISRC"); }
  ...
  public static int createISRCollectionTaskings_Full(FlatBufferBuilder builder,
      int idOffset,
      byte type,
      byte collectionType,
  ...
  public static int endISRCollectionTaskings_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishISRCollectionTaskings_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "ISRC"); }
  public static void finishSizePrefixedISRCollectionTaskings_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "ISRC"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public ISRCollectionTaskings_Full get(int j) { return get(new ISRCollectionTaskings_Full(), j); }
    public ISRCollectionTaskings_Full get(ISRCollectionTaskings_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
