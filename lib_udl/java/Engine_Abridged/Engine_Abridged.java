...
public final class Engine_Abridged extends Table {
  ...
  public static Engine_Abridged getRootAsEngine_Abridged(ByteBuffer _bb, Engine_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Engine_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "ENGI"); }
  ...
  public static int createEngine_Abridged(FlatBufferBuilder builder,
      int idOffset,
      int nameOffset,
  ...
  public static int endEngine_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishEngine_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "ENGI"); }
  public static void finishSizePrefixedEngine_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "ENGI"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Engine_Abridged get(int j) { return get(new Engine_Abridged(), j); }
    public Engine_Abridged get(Engine_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
