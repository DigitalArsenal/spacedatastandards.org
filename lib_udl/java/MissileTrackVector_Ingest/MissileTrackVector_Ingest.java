...
public final class MissileTrackVector_Ingest extends Table {
  ...
  public static MissileTrackVector_Ingest getRootAsMissileTrackVector_Ingest(ByteBuffer _bb, MissileTrackVector_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean MissileTrackVector_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "MISS"); }
  ...
  public static int createMissileTrackVector_Ingest(FlatBufferBuilder builder,
      int typeOffset,
      int objectOffset,
      int epochOffset,
      int idSensorOffset,
  ...
  public static int endMissileTrackVector_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishMissileTrackVector_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "MISS"); }
  public static void finishSizePrefixedMissileTrackVector_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "MISS"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public MissileTrackVector_Ingest get(int j) { return get(new MissileTrackVector_Ingest(), j); }
    public MissileTrackVector_Ingest get(MissileTrackVector_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
