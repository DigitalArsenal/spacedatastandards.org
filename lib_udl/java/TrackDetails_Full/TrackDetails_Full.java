...
public final class TrackDetails_Full extends Table {
  ...
  public static TrackDetails_Full getRootAsTrackDetails_Full(ByteBuffer _bb, TrackDetails_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean TrackDetails_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "TRAC"); }
  ...
  public static int endTrackDetails_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishTrackDetails_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "TRAC"); }
  public static void finishSizePrefixedTrackDetails_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "TRAC"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public TrackDetails_Full get(int j) { return get(new TrackDetails_Full(), j); }
    public TrackDetails_Full get(TrackDetails_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
