...
public final class RFEmitter_Full extends Table {
  ...
  public static RFEmitter_Full getRootAsRFEmitter_Full(ByteBuffer _bb, RFEmitter_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean RFEmitter_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "RFEM"); }
   ...
   * Constraints: No constraints specified.
   */
  public String rfEmitterDetails(int j) { int o = __offset(32); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int rfEmitterDetailsLength() { int o = __offset(32); return o != 0 ? __vector_len(o) : 0; }
  public StringVector rfEmitterDetailsVector() { return rfEmitterDetailsVector(new StringVector()); }
  public StringVector rfEmitterDetailsVector(StringVector obj) { int o = __offset(32); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }

  public static int createRFEmitter_Full(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static void addRfEmitterDetails(FlatBufferBuilder builder, int rfEmitterDetailsOffset) { builder.addOffset(14, rfEmitterDetailsOffset, 0); }
  ...
  public static int endRFEmitter_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishRFEmitter_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "RFEM"); }
  public static void finishSizePrefixedRFEmitter_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "RFEM"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public RFEmitter_Full get(int j) { return get(new RFEmitter_Full(), j); }
    public RFEmitter_Full get(RFEmitter_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
