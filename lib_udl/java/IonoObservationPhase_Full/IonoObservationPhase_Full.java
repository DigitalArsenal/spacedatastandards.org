...
public final class IonoObservationPhase_Full extends Table {
  ...
  public static IonoObservationPhase_Full getRootAsIonoObservationPhase_Full(ByteBuffer _bb, IonoObservationPhase_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean IonoObservationPhase_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "IONO"); }
  ...
  public static int createIonoObservationPhase_Full(FlatBufferBuilder builder,
      int notesOffset,
  ...
  public static int endIonoObservationPhase_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishIonoObservationPhase_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "IONO"); }
  public static void finishSizePrefixedIonoObservationPhase_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "IONO"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public IonoObservationPhase_Full get(int j) { return get(new IonoObservationPhase_Full(), j); }
    public IonoObservationPhase_Full get(IonoObservationPhase_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
