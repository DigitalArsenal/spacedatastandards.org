...
public final class OnorbitDetails_Ingest extends Table {
  ...
  public static OnorbitDetails_Ingest getRootAsOnorbitDetails_Ingest(ByteBuffer _bb, OnorbitDetails_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean OnorbitDetails_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "ONOR"); }
  ...
  public static int createOnorbitDetails_Ingest(FlatBufferBuilder builder,
      int idOffset,
      int idOnOrbitOffset,
  ...
  public static int endOnorbitDetails_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishOnorbitDetails_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "ONOR"); }
  public static void finishSizePrefixedOnorbitDetails_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "ONOR"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public OnorbitDetails_Ingest get(int j) { return get(new OnorbitDetails_Ingest(), j); }
    public OnorbitDetails_Ingest get(OnorbitDetails_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
