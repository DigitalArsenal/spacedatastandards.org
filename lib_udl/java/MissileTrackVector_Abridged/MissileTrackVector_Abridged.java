...
public final class MissileTrackVector_Abridged extends Table {
  ...
  public static MissileTrackVector_Abridged getRootAsMissileTrackVector_Abridged(ByteBuffer _bb, MissileTrackVector_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean MissileTrackVector_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "MISS"); }
  ...
  public static int createMissileTrackVector_Abridged(FlatBufferBuilder builder,
      int typeOffset,
      int objectOffset,
      int epochOffset,
      int idSensorOffset,
  ...
  public static int endMissileTrackVector_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishMissileTrackVector_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "MISS"); }
  public static void finishSizePrefixedMissileTrackVector_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "MISS"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public MissileTrackVector_Abridged get(int j) { return get(new MissileTrackVector_Abridged(), j); }
    public MissileTrackVector_Abridged get(MissileTrackVector_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
