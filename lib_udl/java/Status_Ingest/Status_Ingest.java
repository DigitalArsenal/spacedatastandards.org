...
public final class Status_Ingest extends Table {
  ...
  public static Status_Ingest getRootAsStatus_Ingest(ByteBuffer _bb, Status_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Status_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "STAT"); }
  ...
  public static int createStatus_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endStatus_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishStatus_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "STAT"); }
  public static void finishSizePrefixedStatus_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "STAT"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Status_Ingest get(int j) { return get(new Status_Ingest(), j); }
    public Status_Ingest get(Status_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
