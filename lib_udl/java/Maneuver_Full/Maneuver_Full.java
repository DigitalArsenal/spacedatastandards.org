...
public final class Maneuver_Full extends Table {
  ...
  public static Maneuver_Full getRootAsManeuver_Full(ByteBuffer _bb, Maneuver_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Maneuver_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "MANE"); }
   ...
   * Constraints: No constraints specified.
   */
  public String onOrbit() { int o = __offset(196); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer onOrbitAsByteBuffer() { return __vector_as_bytebuffer(196, 1); }
  public ByteBuffer onOrbitInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 196, 1); }
  /**
   * Optional identifier to track a commercial or marketplace transaction executed to produce this data.
   * Example: /// Example: TRANSACTION-ID
   * Constraints: Minimum length = 0, Maximum length = 64
   */
  public String transactionId() { int o = __offset(198); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer transactionIdAsByteBuffer() { return __vector_as_bytebuffer(198, 1); }
  public ByteBuffer transactionIdInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 198, 1); }
  /**
   * The originating source network on which this record was created, auto-populated by the system.
   * Example: /// Example: ORIG
   * Constraints: Minimum length = 1, Maximum length = 32
   */
  public String origNetwork() { int o = __offset(200); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer origNetworkAsByteBuffer() { return __vector_as_bytebuffer(200, 1); }
  public ByteBuffer origNetworkInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 200, 1); }

  public static int createManeuver_Full(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static void addOnOrbit(FlatBufferBuilder builder, int onOrbitOffset) { builder.addOffset(96, onOrbitOffset, 0); }
  public static void addTransactionId(FlatBufferBuilder builder, int transactionIdOffset) { builder.addOffset(97, transactionIdOffset, 0); }
  public static void addOrigNetwork(FlatBufferBuilder builder, int origNetworkOffset) { builder.addOffset(98, origNetworkOffset, 0); }
  public static int endManeuver_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishManeuver_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "MANE"); }
  public static void finishSizePrefixedManeuver_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "MANE"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Maneuver_Full get(int j) { return get(new Maneuver_Full(), j); }
    public Maneuver_Full get(Maneuver_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
