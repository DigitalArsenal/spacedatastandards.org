...
public final class AirEventTankers_Abridged extends Table {
  ...
  public static AirEventTankers_Abridged getRootAsAirEventTankers_Abridged(ByteBuffer _bb, AirEventTankers_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean AirEventTankers_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "AIRE"); }
  ...
  public static int createAirEventTankers_Abridged(FlatBufferBuilder builder,
  ...
  public static int endAirEventTankers_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAirEventTankers_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "AIRE"); }
  public static void finishSizePrefixedAirEventTankers_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "AIRE"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public AirEventTankers_Abridged get(int j) { return get(new AirEventTankers_Abridged(), j); }
    public AirEventTankers_Abridged get(AirEventTankers_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
