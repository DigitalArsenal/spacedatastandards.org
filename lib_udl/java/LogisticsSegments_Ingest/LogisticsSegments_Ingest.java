...
public final class LogisticsSegments_Ingest extends Table {
  ...
  public static LogisticsSegments_Ingest getRootAsLogisticsSegments_Ingest(ByteBuffer _bb, LogisticsSegments_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean LogisticsSegments_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "LOGI"); }
  ...
  public static int createLogisticsSegments_Ingest(FlatBufferBuilder builder,
      int segmentNumber,
      int modeCodeOffset,
  ...
  public static int endLogisticsSegments_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishLogisticsSegments_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "LOGI"); }
  public static void finishSizePrefixedLogisticsSegments_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "LOGI"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public LogisticsSegments_Ingest get(int j) { return get(new LogisticsSegments_Ingest(), j); }
    public LogisticsSegments_Ingest get(LogisticsSegments_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
