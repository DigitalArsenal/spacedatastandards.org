...
public final class EvacCondition_Ingest extends Table {
  ...
  public static EvacCondition_Ingest getRootAsEvacCondition_Ingest(ByteBuffer _bb, EvacCondition_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean EvacCondition_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "EVAC"); }
  ...
  public static int createEvacCondition_Ingest(FlatBufferBuilder builder,
      int typeOffset,
      int bodyPartOffset,
      int timeOffset,
      int commentsOffset) {
  ...
  public static int endEvacCondition_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishEvacCondition_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "EVAC"); }
  public static void finishSizePrefixedEvacCondition_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "EVAC"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public EvacCondition_Ingest get(int j) { return get(new EvacCondition_Ingest(), j); }
    public EvacCondition_Ingest get(EvacCondition_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
