...
public final class LaunchEvent_Ingest extends Table {
  ...
  public static LaunchEvent_Ingest getRootAsLaunchEvent_Ingest(ByteBuffer _bb, LaunchEvent_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean LaunchEvent_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "LAUN"); }
  ...
  public static int createLaunchEvent_Ingest(FlatBufferBuilder builder,
      int idOffset,
      int idOnOrbitOffset,
  ...
  public static int endLaunchEvent_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishLaunchEvent_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "LAUN"); }
  public static void finishSizePrefixedLaunchEvent_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "LAUN"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public LaunchEvent_Ingest get(int j) { return get(new LaunchEvent_Ingest(), j); }
    public LaunchEvent_Ingest get(LaunchEvent_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
