...
public final class AttitudeData_Ingest extends Table {
  ...
  public static AttitudeData_Ingest getRootAsAttitudeData_Ingest(ByteBuffer _bb, AttitudeData_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean AttitudeData_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "ATTI"); }
  ...
  public static int createAttitudeData_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endAttitudeData_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAttitudeData_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "ATTI"); }
  public static void finishSizePrefixedAttitudeData_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "ATTI"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public AttitudeData_Ingest get(int j) { return get(new AttitudeData_Ingest(), j); }
    public AttitudeData_Ingest get(AttitudeData_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
