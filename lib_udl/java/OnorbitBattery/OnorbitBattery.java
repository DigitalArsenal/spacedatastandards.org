...
public final class OnorbitBattery extends Table {
  ...
  public static OnorbitBattery getRootAsOnorbitBattery(ByteBuffer _bb, OnorbitBattery obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean OnorbitBatteryBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "ONOR"); }
  ...
  public static int createOnorbitBattery(FlatBufferBuilder builder,
      int idOffset,
      int idOnOrbitOffset,
      int idBatteryOffset,
  ...
  public static int endOnorbitBattery(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishOnorbitBatteryBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "ONOR"); }
  public static void finishSizePrefixedOnorbitBatteryBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "ONOR"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public OnorbitBattery get(int j) { return get(new OnorbitBattery(), j); }
    public OnorbitBattery get(OnorbitBattery obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
