...
public final class IonoObservationTraceGeneric_Full extends Table {
  ...
  public static IonoObservationTraceGeneric_Full getRootAsIonoObservationTraceGeneric_Full(ByteBuffer _bb, IonoObservationTraceGeneric_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean IonoObservationTraceGeneric_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "IONO"); }
  ...
  public static int createIonoObservationTraceGeneric_Full(FlatBufferBuilder builder,
      int dataOffset,
  ...
  public static int endIonoObservationTraceGeneric_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishIonoObservationTraceGeneric_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "IONO"); }
  public static void finishSizePrefixedIonoObservationTraceGeneric_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "IONO"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public IonoObservationTraceGeneric_Full get(int j) { return get(new IonoObservationTraceGeneric_Full(), j); }
    public IonoObservationTraceGeneric_Full get(IonoObservationTraceGeneric_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
