...
public final class MissionAssignment_Abridged extends Table {
  ...
  public static MissionAssignment_Abridged getRootAsMissionAssignment_Abridged(ByteBuffer _bb, MissionAssignment_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean MissionAssignment_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "MISS"); }
  ...
  public static int createMissionAssignment_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endMissionAssignment_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishMissionAssignment_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "MISS"); }
  public static void finishSizePrefixedMissionAssignment_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "MISS"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public MissionAssignment_Abridged get(int j) { return get(new MissionAssignment_Abridged(), j); }
    public MissionAssignment_Abridged get(MissionAssignment_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
