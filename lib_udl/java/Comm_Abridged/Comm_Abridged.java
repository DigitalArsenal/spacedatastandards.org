...
public final class Comm_Abridged extends Table {
  ...
  public static Comm_Abridged getRootAsComm_Abridged(ByteBuffer _bb, Comm_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Comm_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "COMM"); }
  ...
  public static int createComm_Abridged(FlatBufferBuilder builder,
      int idOffset,
      int idEntityOffset,
      int nameOffset,
  ...
  public static int endComm_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishComm_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "COMM"); }
  public static void finishSizePrefixedComm_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "COMM"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Comm_Abridged get(int j) { return get(new Comm_Abridged(), j); }
    public Comm_Abridged get(Comm_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
