...
public final class Sensorlimits_Ingest extends Table {
  ...
  public static Sensorlimits_Ingest getRootAsSensorlimits_Ingest(ByteBuffer _bb, Sensorlimits_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Sensorlimits_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "SENS"); }
   ...
   */
  public String idSensor() { int o = __offset(34); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer idSensorAsByteBuffer() { return __vector_as_bytebuffer(34, 1); }
  public ByteBuffer idSensorInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 34, 1); }

  public static int createSensorlimits_Ingest(FlatBufferBuilder builder,
  ...
  public static void addIdSensor(FlatBufferBuilder builder, int idSensorOffset) { builder.addOffset(15, idSensorOffset, 0); }
  public static int endSensorlimits_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishSensorlimits_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "SENS"); }
  public static void finishSizePrefixedSensorlimits_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "SENS"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Sensorlimits_Ingest get(int j) { return get(new Sensorlimits_Ingest(), j); }
    public Sensorlimits_Ingest get(Sensorlimits_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
