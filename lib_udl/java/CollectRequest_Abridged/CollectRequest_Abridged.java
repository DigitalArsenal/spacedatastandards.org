...
public final class CollectRequest_Abridged extends Table {
  ...
  public static CollectRequest_Abridged getRootAsCollectRequest_Abridged(ByteBuffer _bb, CollectRequest_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean CollectRequest_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "COLL"); }
  ...
  public static int createCollectRequest_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endCollectRequest_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishCollectRequest_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "COLL"); }
  public static void finishSizePrefixedCollectRequest_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "COLL"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public CollectRequest_Abridged get(int j) { return get(new CollectRequest_Abridged(), j); }
    public CollectRequest_Abridged get(CollectRequest_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
