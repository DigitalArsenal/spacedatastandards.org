...
public final class EventEvolution_Full extends Table {
  ...
  public static EventEvolution_Full getRootAsEventEvolution_Full(ByteBuffer _bb, EventEvolution_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean EventEvolution_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "EVEN"); }
  ...
  public static int createEventEvolution_Full(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endEventEvolution_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishEventEvolution_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "EVEN"); }
  public static void finishSizePrefixedEventEvolution_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "EVEN"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public EventEvolution_Full get(int j) { return get(new EventEvolution_Full(), j); }
    public EventEvolution_Full get(EventEvolution_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
