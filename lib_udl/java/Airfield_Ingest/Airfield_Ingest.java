...
public final class Airfield_Ingest extends Table {
  ...
  public static Airfield_Ingest getRootAsAirfield_Ingest(ByteBuffer _bb, Airfield_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Airfield_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "AIRF"); }
  ...
  public static int createAirfield_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endAirfield_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAirfield_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "AIRF"); }
  public static void finishSizePrefixedAirfield_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "AIRF"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Airfield_Ingest get(int j) { return get(new Airfield_Ingest(), j); }
    public Airfield_Ingest get(Airfield_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
