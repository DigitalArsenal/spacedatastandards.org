...
public final class AirspaceTimePeriod_Ingest extends Table {
  ...
  public static AirspaceTimePeriod_Ingest getRootAsAirspaceTimePeriod_Ingest(ByteBuffer _bb, AirspaceTimePeriod_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean AirspaceTimePeriod_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "AIRS"); }
  ...
  public static int createAirspaceTimePeriod_Ingest(FlatBufferBuilder builder,
      int timeModeOffset,
      int timeStartOffset,
      int timeEndOffset,
      int intFreqOffset,
  ...
  public static int endAirspaceTimePeriod_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAirspaceTimePeriod_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "AIRS"); }
  public static void finishSizePrefixedAirspaceTimePeriod_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "AIRS"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public AirspaceTimePeriod_Ingest get(int j) { return get(new AirspaceTimePeriod_Ingest(), j); }
    public AirspaceTimePeriod_Ingest get(AirspaceTimePeriod_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
