...
public final class SpaceEnvObservation_Ingest extends Table {
  ...
  public static SpaceEnvObservation_Ingest getRootAsSpaceEnvObservation_Ingest(ByteBuffer _bb, SpaceEnvObservation_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean SpaceEnvObservation_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "SPAC"); }
  ...
  public static int createSpaceEnvObservation_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endSpaceEnvObservation_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishSpaceEnvObservation_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "SPAC"); }
  public static void finishSizePrefixedSpaceEnvObservation_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "SPAC"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public SpaceEnvObservation_Ingest get(int j) { return get(new SpaceEnvObservation_Ingest(), j); }
    public SpaceEnvObservation_Ingest get(SpaceEnvObservation_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
