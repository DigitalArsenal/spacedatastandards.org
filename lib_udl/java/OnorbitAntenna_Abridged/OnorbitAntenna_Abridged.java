...
public final class OnorbitAntenna_Abridged extends Table {
  ...
  public static OnorbitAntenna_Abridged getRootAsOnorbitAntenna_Abridged(ByteBuffer _bb, OnorbitAntenna_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean OnorbitAntenna_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "ONOR"); }
  ...
  public static int createOnorbitAntenna_Abridged(FlatBufferBuilder builder,
      int idOffset,
      int idOnOrbitOffset,
      int idAntennaOffset,
  ...
  public static int endOnorbitAntenna_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishOnorbitAntenna_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "ONOR"); }
  public static void finishSizePrefixedOnorbitAntenna_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "ONOR"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public OnorbitAntenna_Abridged get(int j) { return get(new OnorbitAntenna_Abridged(), j); }
    public OnorbitAntenna_Abridged get(OnorbitAntenna_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
