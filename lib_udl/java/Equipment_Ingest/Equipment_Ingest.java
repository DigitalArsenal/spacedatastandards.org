...
public final class Equipment_Ingest extends Table {
  public static void ValidateVersion() { Constants.FLATBUFFERS_24_3_25(); }
  public static Equipment_Ingest getRootAsEquipment_Ingest(ByteBuffer _bb) { return getRootAsEquipment_Ingest(_bb, new Equipment_Ingest()); }
  public static Equipment_Ingest getRootAsEquipment_Ingest(ByteBuffer _bb, Equipment_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Equipment_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "EQUI"); }
  public void __init(int _i, ByteBuffer _bb) { __reset(_i, _bb); }
  public Equipment_Ingest __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static int createEquipment_Ingest(FlatBufferBuilder builder,
      int idOffset,
    ...
    Equipment_Ingest.addFunction(builder, functionOffset);
  ...
  public static void startEquipment_Ingest(FlatBufferBuilder builder) { builder.startTable(53); }
  ...
  public static int endEquipment_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishEquipment_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "EQUI"); }
  public static void finishSizePrefixedEquipment_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "EQUI"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Equipment_Ingest get(int j) { return get(new Equipment_Ingest(), j); }
    public Equipment_Ingest get(Equipment_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
