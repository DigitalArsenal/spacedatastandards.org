...
public final class AirEvent_Ingest extends Table {
  ...
  public static AirEvent_Ingest getRootAsAirEvent_Ingest(ByteBuffer _bb, AirEvent_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean AirEvent_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "AIRE"); }
  ...
  public static int createAirEvent_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endAirEvent_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAirEvent_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "AIRE"); }
  public static void finishSizePrefixedAirEvent_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "AIRE"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public AirEvent_Ingest get(int j) { return get(new AirEvent_Ingest(), j); }
    public AirEvent_Ingest get(AirEvent_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
