...
public final class Eop_Abridged extends Table {
  ...
  public static Eop_Abridged getRootAsEop_Abridged(ByteBuffer _bb, Eop_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Eop_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "EOPA"); }
  ...
  public static int createEop_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endEop_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishEop_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "EOPA"); }
  public static void finishSizePrefixedEop_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "EOPA"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Eop_Abridged get(int j) { return get(new Eop_Abridged(), j); }
    public Eop_Abridged get(Eop_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
