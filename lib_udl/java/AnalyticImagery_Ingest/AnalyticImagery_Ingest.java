...
public final class AnalyticImagery_Ingest extends Table {
  ...
  public static AnalyticImagery_Ingest getRootAsAnalyticImagery_Ingest(ByteBuffer _bb, AnalyticImagery_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean AnalyticImagery_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "ANAL"); }
  ...
  public static int createAnalyticImagery_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endAnalyticImagery_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAnalyticImagery_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "ANAL"); }
  public static void finishSizePrefixedAnalyticImagery_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "ANAL"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public AnalyticImagery_Ingest get(int j) { return get(new AnalyticImagery_Ingest(), j); }
    public AnalyticImagery_Ingest get(AnalyticImagery_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
