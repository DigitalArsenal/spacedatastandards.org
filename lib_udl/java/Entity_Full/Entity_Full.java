...
public final class Entity_Full extends Table {
  ...
  public static Entity_Full getRootAsEntity_Full(ByteBuffer _bb, Entity_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Entity_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "ENTI"); }
  ...
  public static int createEntity_Full(FlatBufferBuilder builder,
      int idEntityOffset,
      int nameOffset,
  ...
  public static int endEntity_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishEntity_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "ENTI"); }
  public static void finishSizePrefixedEntity_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "ENTI"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Entity_Full get(int j) { return get(new Entity_Full(), j); }
    public Entity_Full get(Entity_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
