...
public final class SOIObservationSet_Ingest extends Table {
  ...
  public static SOIObservationSet_Ingest getRootAsSOIObservationSet_Ingest(ByteBuffer _bb, SOIObservationSet_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean SOIObservationSet_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "SOIO"); }
  ...
  public static int createSOIObservationSet_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endSOIObservationSet_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishSOIObservationSet_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "SOIO"); }
  public static void finishSizePrefixedSOIObservationSet_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "SOIO"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public SOIObservationSet_Ingest get(int j) { return get(new SOIObservationSet_Ingest(), j); }
    public SOIObservationSet_Ingest get(SOIObservationSet_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
