...
public final class Country_Abridged extends Table {
  ...
  public static Country_Abridged getRootAsCountry_Abridged(ByteBuffer _bb, Country_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Country_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "COUN"); }
  ...
  public static int createCountry_Abridged(FlatBufferBuilder builder,
      int codeOffset,
      int nameOffset,
      int fipsCodeOffset,
      int iso3CodeOffset,
  ...
  public static int endCountry_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishCountry_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "COUN"); }
  public static void finishSizePrefixedCountry_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "COUN"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Country_Abridged get(int j) { return get(new Country_Abridged(), j); }
    public Country_Abridged get(Country_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
