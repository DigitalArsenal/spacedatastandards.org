...
public final class GEOStatus_Full extends Table {
  ...
  public static GEOStatus_Full getRootAsGEOStatus_Full(ByteBuffer _bb, GEOStatus_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean GEOStatus_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "GEOS"); }
   ...
   * Constraints: No constraints specified.
   */
  public String onOrbit() { int o = __offset(52); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer onOrbitAsByteBuffer() { return __vector_as_bytebuffer(52, 1); }
  public ByteBuffer onOrbitInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 52, 1); }
  /**
   * Satellite/catalog number of the target on-orbit object.
   * Example: /// Example: 21
   * Constraints: No constraints specified.
   */
  public int satNo() { int o = __offset(54); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  /**
  ...
  public static int createGEOStatus_Full(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static void addOnOrbit(FlatBufferBuilder builder, int onOrbitOffset) { builder.addOffset(24, onOrbitOffset, 0); }
  ...
  public static int endGEOStatus_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishGEOStatus_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "GEOS"); }
  public static void finishSizePrefixedGEOStatus_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "GEOS"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public GEOStatus_Full get(int j) { return get(new GEOStatus_Full(), j); }
    public GEOStatus_Full get(GEOStatus_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
