...
public final class IonoObservationFrequency_Ingest extends Table {
  ...
  public static IonoObservationFrequency_Ingest getRootAsIonoObservationFrequency_Ingest(ByteBuffer _bb, IonoObservationFrequency_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean IonoObservationFrequency_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "IONO"); }
  ...
  public static int createIonoObservationFrequency_Ingest(FlatBufferBuilder builder,
      int notesOffset,
  ...
  public static int endIonoObservationFrequency_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishIonoObservationFrequency_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "IONO"); }
  public static void finishSizePrefixedIonoObservationFrequency_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "IONO"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public IonoObservationFrequency_Ingest get(int j) { return get(new IonoObservationFrequency_Ingest(), j); }
    public IonoObservationFrequency_Ingest get(IonoObservationFrequency_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
