...
public final class Crew_Ingest extends Table {
  ...
  public static Crew_Ingest getRootAsCrew_Ingest(ByteBuffer _bb, Crew_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Crew_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "CREW"); }
  ...
  public static int createCrew_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endCrew_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishCrew_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "CREW"); }
  public static void finishSizePrefixedCrew_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "CREW"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Crew_Ingest get(int j) { return get(new Crew_Ingest(), j); }
    public Crew_Ingest get(Crew_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
