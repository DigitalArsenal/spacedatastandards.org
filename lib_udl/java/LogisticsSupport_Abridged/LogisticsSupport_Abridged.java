...
public final class LogisticsSupport_Abridged extends Table {
  ...
  public static LogisticsSupport_Abridged getRootAsLogisticsSupport_Abridged(ByteBuffer _bb, LogisticsSupport_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean LogisticsSupport_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "LOGI"); }
  ...
  public static int createLogisticsSupport_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endLogisticsSupport_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishLogisticsSupport_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "LOGI"); }
  public static void finishSizePrefixedLogisticsSupport_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "LOGI"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public LogisticsSupport_Abridged get(int j) { return get(new LogisticsSupport_Abridged(), j); }
    public LogisticsSupport_Abridged get(LogisticsSupport_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
