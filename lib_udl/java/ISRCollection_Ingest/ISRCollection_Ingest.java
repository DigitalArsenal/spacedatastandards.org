...
public final class ISRCollection_Ingest extends Table {
  ...
  public static ISRCollection_Ingest getRootAsISRCollection_Ingest(ByteBuffer _bb, ISRCollection_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean ISRCollection_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "ISRC"); }
  ...
  public static int createISRCollection_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endISRCollection_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishISRCollection_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "ISRC"); }
  public static void finishSizePrefixedISRCollection_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "ISRC"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public ISRCollection_Ingest get(int j) { return get(new ISRCollection_Ingest(), j); }
    public ISRCollection_Ingest get(ISRCollection_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
