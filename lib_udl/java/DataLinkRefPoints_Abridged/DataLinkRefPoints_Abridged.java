...
public final class DataLinkRefPoints_Abridged extends Table {
  ...
  public static DataLinkRefPoints_Abridged getRootAsDataLinkRefPoints_Abridged(ByteBuffer _bb, DataLinkRefPoints_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean DataLinkRefPoints_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "DATA"); }
  ...
  public static int createDataLinkRefPoints_Abridged(FlatBufferBuilder builder,
  ...
  public static int endDataLinkRefPoints_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishDataLinkRefPoints_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "DATA"); }
  public static void finishSizePrefixedDataLinkRefPoints_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "DATA"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public DataLinkRefPoints_Abridged get(int j) { return get(new DataLinkRefPoints_Abridged(), j); }
    public DataLinkRefPoints_Abridged get(DataLinkRefPoints_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
