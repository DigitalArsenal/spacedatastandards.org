...
public final class SiteRemark_Full extends Table {
  ...
  public static SiteRemark_Full getRootAsSiteRemark_Full(ByteBuffer _bb, SiteRemark_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean SiteRemark_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "SITE"); }
  ...
  public static int createSiteRemark_Full(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endSiteRemark_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishSiteRemark_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "SITE"); }
  public static void finishSizePrefixedSiteRemark_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "SITE"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public SiteRemark_Full get(int j) { return get(new SiteRemark_Full(), j); }
    public SiteRemark_Full get(SiteRemark_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
