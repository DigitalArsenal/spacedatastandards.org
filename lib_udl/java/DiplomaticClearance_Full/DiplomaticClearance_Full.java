...
public final class DiplomaticClearance_Full extends Table {
  ...
  public static DiplomaticClearance_Full getRootAsDiplomaticClearance_Full(ByteBuffer _bb, DiplomaticClearance_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean DiplomaticClearance_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "DIPL"); }
  ...
  public static int createDiplomaticClearance_Full(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endDiplomaticClearance_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishDiplomaticClearance_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "DIPL"); }
  public static void finishSizePrefixedDiplomaticClearance_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "DIPL"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public DiplomaticClearance_Full get(int j) { return get(new DiplomaticClearance_Full(), j); }
    public DiplomaticClearance_Full get(DiplomaticClearance_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
