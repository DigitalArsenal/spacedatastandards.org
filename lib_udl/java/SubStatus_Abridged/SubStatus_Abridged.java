...
public final class SubStatus_Abridged extends Table {
  ...
  public static SubStatus_Abridged getRootAsSubStatus_Abridged(ByteBuffer _bb, SubStatus_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean SubStatus_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "SUBS"); }
  ...
  public static int createSubStatus_Abridged(FlatBufferBuilder builder,
      int idOffset,
      byte type,
  ...
  public static int endSubStatus_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishSubStatus_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "SUBS"); }
  public static void finishSizePrefixedSubStatus_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "SUBS"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public SubStatus_Abridged get(int j) { return get(new SubStatus_Abridged(), j); }
    public SubStatus_Abridged get(SubStatus_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
