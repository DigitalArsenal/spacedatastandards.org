...
public final class PointOfContact_Abridged extends Table {
  ...
  public static PointOfContact_Abridged getRootAsPointOfContact_Abridged(ByteBuffer _bb, PointOfContact_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean PointOfContact_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "POIN"); }
  ...
  public static int createPointOfContact_Abridged(FlatBufferBuilder builder,
      int pocSequenceId,
  ...
  public static int endPointOfContact_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishPointOfContact_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "POIN"); }
  public static void finishSizePrefixedPointOfContact_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "POIN"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public PointOfContact_Abridged get(int j) { return get(new PointOfContact_Abridged(), j); }
    public PointOfContact_Abridged get(PointOfContact_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
