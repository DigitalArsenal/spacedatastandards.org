...
public final class MtiPlatformLocation_Full extends Table {
  ...
  public static MtiPlatformLocation_Full getRootAsMtiPlatformLocation_Full(ByteBuffer _bb, MtiPlatformLocation_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean MtiPlatformLocation_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "MTIP"); }
  ...
  public static int createMtiPlatformLocation_Full(FlatBufferBuilder builder,
      long l1,
      double l2,
      double l3,
      int l4,
  ...
  public static int endMtiPlatformLocation_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishMtiPlatformLocation_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "MTIP"); }
  public static void finishSizePrefixedMtiPlatformLocation_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "MTIP"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public MtiPlatformLocation_Full get(int j) { return get(new MtiPlatformLocation_Full(), j); }
    public MtiPlatformLocation_Full get(MtiPlatformLocation_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
