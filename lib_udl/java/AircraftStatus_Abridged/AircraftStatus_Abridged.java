...
public final class AircraftStatus_Abridged extends Table {
  ...
  public static AircraftStatus_Abridged getRootAsAircraftStatus_Abridged(ByteBuffer _bb, AircraftStatus_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean AircraftStatus_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "AIRC"); }
  ...
  public static int createAircraftStatus_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endAircraftStatus_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAircraftStatus_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "AIRC"); }
  public static void finishSizePrefixedAircraftStatus_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "AIRC"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public AircraftStatus_Abridged get(int j) { return get(new AircraftStatus_Abridged(), j); }
    public AircraftStatus_Abridged get(AircraftStatus_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
