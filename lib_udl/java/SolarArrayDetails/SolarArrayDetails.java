...
public final class SolarArrayDetails extends Table {
  ...
  public static SolarArrayDetails getRootAsSolarArrayDetails(ByteBuffer _bb, SolarArrayDetails obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean SolarArrayDetailsBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "SOLA"); }
  ...
  public static int createSolarArrayDetails(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endSolarArrayDetails(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishSolarArrayDetailsBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "SOLA"); }
  public static void finishSizePrefixedSolarArrayDetailsBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "SOLA"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public SolarArrayDetails get(int j) { return get(new SolarArrayDetails(), j); }
    public SolarArrayDetails get(SolarArrayDetails obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
