...
public final class EffectResponseActionsList_Full extends Table {
  ...
  public static EffectResponseActionsList_Full getRootAsEffectResponseActionsList_Full(ByteBuffer _bb, EffectResponseActionsList_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean EffectResponseActionsList_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "EFFE"); }
  ...
  public static int createEffectResponseActionsList_Full(FlatBufferBuilder builder,
      int summaryOffset,
      int actionIdOffset,
  ...
  public static int endEffectResponseActionsList_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishEffectResponseActionsList_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "EFFE"); }
  public static void finishSizePrefixedEffectResponseActionsList_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "EFFE"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public EffectResponseActionsList_Full get(int j) { return get(new EffectResponseActionsList_Full(), j); }
    public EffectResponseActionsList_Full get(EffectResponseActionsList_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
