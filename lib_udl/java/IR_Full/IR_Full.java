...
public final class IR_Full extends Table {
  public static void ValidateVersion() { Constants.FLATBUFFERS_24_3_25(); }
  public static IR_Full getRootAsIR_Full(ByteBuffer _bb) { return getRootAsIR_Full(_bb, new IR_Full()); }
  public static IR_Full getRootAsIR_Full(ByteBuffer _bb, IR_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean IR_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "IRFU"); }
  ...
  public static int createIR_Full(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endIR_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishIR_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "IRFU"); }
  public static void finishSizePrefixedIR_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "IRFU"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public IR_Full get(int j) { return get(new IR_Full(), j); }
    public IR_Full get(IR_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
