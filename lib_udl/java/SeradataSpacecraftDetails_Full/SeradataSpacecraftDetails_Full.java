...
public final class SeradataSpacecraftDetails_Full extends Table {
  ...
  public static SeradataSpacecraftDetails_Full getRootAsSeradataSpacecraftDetails_Full(ByteBuffer _bb, SeradataSpacecraftDetails_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean SeradataSpacecraftDetails_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "SERA"); }
   ...
   * Constraints: No constraints specified.
   */
  public String updatedAt() { int o = __offset(194); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer updatedAtAsByteBuffer() { return __vector_as_bytebuffer(194, 1); }
  public ByteBuffer updatedAtInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 194, 1); }
  /**
   * Application user who updated the row in the database, auto-populated by the system.
   * Example: /// Example: some.user
   * Constraints: Minimum length = 1, Maximum length = 64
   */
  public String updatedBy() { int o = __offset(196); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer updatedByAsByteBuffer() { return __vector_as_bytebuffer(196, 1); }
  public ByteBuffer updatedByInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 196, 1); }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public String seradataSigIntPayload(int j) { int o = __offset(198); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int seradataSigIntPayloadLength() { int o = __offset(198); return o != 0 ? __vector_len(o) : 0; }
  public StringVector seradataSigIntPayloadVector() { return seradataSigIntPayloadVector(new StringVector()); }
  public StringVector seradataSigIntPayloadVector(StringVector obj) { int o = __offset(198); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public String seradataRadarPayload(int j) { int o = __offset(200); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int seradataRadarPayloadLength() { int o = __offset(200); return o != 0 ? __vector_len(o) : 0; }
  public StringVector seradataRadarPayloadVector() { return seradataRadarPayloadVector(new StringVector()); }
  public StringVector seradataRadarPayloadVector(StringVector obj) { int o = __offset(200); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public String seradataNavigation(int j) { int o = __offset(202); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int seradataNavigationLength() { int o = __offset(202); return o != 0 ? __vector_len(o) : 0; }
  public StringVector seradataNavigationVector() { return seradataNavigationVector(new StringVector()); }
  public StringVector seradataNavigationVector(StringVector obj) { int o = __offset(202); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public String seradataOpticalPayload(int j) { int o = __offset(204); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int seradataOpticalPayloadLength() { int o = __offset(204); return o != 0 ? __vector_len(o) : 0; }
  public StringVector seradataOpticalPayloadVector() { return seradataOpticalPayloadVector(new StringVector()); }
  public StringVector seradataOpticalPayloadVector(StringVector obj) { int o = __offset(204); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public String seradataEarlyWarning(int j) { int o = __offset(206); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int seradataEarlyWarningLength() { int o = __offset(206); return o != 0 ? __vector_len(o) : 0; }
  public StringVector seradataEarlyWarningVector() { return seradataEarlyWarningVector(new StringVector()); }
  public StringVector seradataEarlyWarningVector(StringVector obj) { int o = __offset(206); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public String scientific(int j) { int o = __offset(208); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int scientificLength() { int o = __offset(208); return o != 0 ? __vector_len(o) : 0; }
  public StringVector scientificVector() { return scientificVector(new StringVector()); }
  public StringVector scientificVector(StringVector obj) { int o = __offset(208); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public String seradataCommDetails(int j) { int o = __offset(210); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int seradataCommDetailsLength() { int o = __offset(210); return o != 0 ? __vector_len(o) : 0; }
  public StringVector seradataCommDetailsVector() { return seradataCommDetailsVector(new StringVector()); }
  public StringVector seradataCommDetailsVector(StringVector obj) { int o = __offset(210); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   * No description provided.
   * Example: /// Example: No example provided.
   * Constraints: No constraints specified.
   */
  public String onOrbit() { int o = __offset(212); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer onOrbitAsByteBuffer() { return __vector_as_bytebuffer(212, 1); }
  public ByteBuffer onOrbitInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 212, 1); }

  public static int createSeradataSpacecraftDetails_Full(FlatBufferBuilder builder,
      int idOffset,
      int idOnOrbitOffset,
      ...
      int updatedAtOffset,
      int updatedByOffset,
      int seradataSigIntPayloadOffset,
      int seradataRadarPayloadOffset,
      int seradataNavigationOffset,
      int seradataOpticalPayloadOffset,
      int seradataEarlyWarningOffset,
      int scientificOffset,
      int seradataCommDetailsOffset,
      int onOrbitOffset) {
  ...
  public static void addUpdatedAt(FlatBufferBuilder builder, int updatedAtOffset) { builder.addOffset(95, updatedAtOffset, 0); }
  public static void addUpdatedBy(FlatBufferBuilder builder, int updatedByOffset) { builder.addOffset(96, updatedByOffset, 0); }
  public static void addSeradataSigIntPayload(FlatBufferBuilder builder, int seradataSigIntPayloadOffset) { builder.addOffset(97, seradataSigIntPayloadOffset, 0); }
  public static int createSeradataSigIntPayloadVector(FlatBufferBuilder builder, int[] data) { builder.startVector(4, data.length, 4); for (int i = data.length - 1; i >= 0; i--) builder.addOffset(data[i]); return builder.endVector(); }
  ...
  public static void addSeradataRadarPayload(FlatBufferBuilder builder, int seradataRadarPayloadOffset) { builder.addOffset(98, seradataRadarPayloadOffset, 0); }
  public static int createSeradataRadarPayloadVector(FlatBufferBuilder builder, int[] data) { builder.startVector(4, data.length, 4); for (int i = data.length - 1; i >= 0; i--) builder.addOffset(data[i]); return builder.endVector(); }
  ...
  public static void addSeradataNavigation(FlatBufferBuilder builder, int seradataNavigationOffset) { builder.addOffset(99, seradataNavigationOffset, 0); }
  public static int createSeradataNavigationVector(FlatBufferBuilder builder, int[] data) { builder.startVector(4, data.length, 4); for (int i = data.length - 1; i >= 0; i--) builder.addOffset(data[i]); return builder.endVector(); }
  public static void startSeradataNavigationVector(FlatBufferBuilder builder, int numElems) { builder.startVector(4, numElems, 4); }
  public static void addSeradataOpticalPayload(FlatBufferBuilder builder, int seradataOpticalPayloadOffset) { builder.addOffset(100, seradataOpticalPayloadOffset, 0); }
  public static int createSeradataOpticalPayloadVector(FlatBufferBuilder builder, int[] data) { builder.startVector(4, data.length, 4); for (int i = data.length - 1; i >= 0; i--) builder.addOffset(data[i]); return builder.endVector(); }
  ...
  public static void addSeradataEarlyWarning(FlatBufferBuilder builder, int seradataEarlyWarningOffset) { builder.addOffset(101, seradataEarlyWarningOffset, 0); }
  public static int createSeradataEarlyWarningVector(FlatBufferBuilder builder, int[] data) { builder.startVector(4, data.length, 4); for (int i = data.length - 1; i >= 0; i--) builder.addOffset(data[i]); return builder.endVector(); }
  ...
  public static void addScientific(FlatBufferBuilder builder, int scientificOffset) { builder.addOffset(102, scientificOffset, 0); }
  public static int createScientificVector(FlatBufferBuilder builder, int[] data) { builder.startVector(4, data.length, 4); for (int i = data.length - 1; i >= 0; i--) builder.addOffset(data[i]); return builder.endVector(); }
  public static void startScientificVector(FlatBufferBuilder builder, int numElems) { builder.startVector(4, numElems, 4); }
  public static void addSeradataCommDetails(FlatBufferBuilder builder, int seradataCommDetailsOffset) { builder.addOffset(103, seradataCommDetailsOffset, 0); }
  public static int createSeradataCommDetailsVector(FlatBufferBuilder builder, int[] data) { builder.startVector(4, data.length, 4); for (int i = data.length - 1; i >= 0; i--) builder.addOffset(data[i]); return builder.endVector(); }
  ...
  public static void addOnOrbit(FlatBufferBuilder builder, int onOrbitOffset) { builder.addOffset(104, onOrbitOffset, 0); }
  public static int endSeradataSpacecraftDetails_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishSeradataSpacecraftDetails_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "SERA"); }
  public static void finishSizePrefixedSeradataSpacecraftDetails_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "SERA"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public SeradataSpacecraftDetails_Full get(int j) { return get(new SeradataSpacecraftDetails_Full(), j); }
    public SeradataSpacecraftDetails_Full get(SeradataSpacecraftDetails_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
