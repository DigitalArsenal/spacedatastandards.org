...
public final class ObjectOfInterest_Full extends Table {
  ...
  public static ObjectOfInterest_Full getRootAsObjectOfInterest_Full(ByteBuffer _bb, ObjectOfInterest_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean ObjectOfInterest_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "OBJE"); }
   ...
   * Constraints: No constraints specified.
   */
  public String updatedAt() { int o = __offset(84); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer updatedAtAsByteBuffer() { return __vector_as_bytebuffer(84, 1); }
  public ByteBuffer updatedAtInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 84, 1); }
  /**
   * Application user who updated the row in the database, auto-populated by the system.
   * Example: /// Example: some.user
   * Constraints: Minimum length = 0, Maximum length = 64
   */
  public String updatedBy() { int o = __offset(86); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer updatedByAsByteBuffer() { return __vector_as_bytebuffer(86, 1); }
  public ByteBuffer updatedByInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 86, 1); }
  /**
   * Source of the data.
   ...
   * Constraints: Minimum length = 1, Maximum length = 32
   */
  public byte dataMode() { int o = __offset(94); return o != 0 ? bb.get(o + bb_pos) : 0; }
  /**
   * No description provided.
   * Example: /// Example: No example provided.
   * Constraints: No constraints specified.
   */
  public String onOrbit() { int o = __offset(96); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer onOrbitAsByteBuffer() { return __vector_as_bytebuffer(96, 1); }
  public ByteBuffer onOrbitInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 96, 1); }
  /**
   * Manifolds associated with this object of interest.
   * Example: /// Example: No example provided.
   * Constraints: No constraints specified.
   */
  public String manifolds(int j) { int o = __offset(98); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int manifoldsLength() { int o = __offset(98); return o != 0 ? __vector_len(o) : 0; }
  public StringVector manifoldsVector() { return manifoldsVector(new StringVector()); }
  public StringVector manifoldsVector(StringVector obj) { int o = __offset(98); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }

  public static int createObjectOfInterest_Full(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static void addUpdatedAt(FlatBufferBuilder builder, int updatedAtOffset) { builder.addOffset(40, updatedAtOffset, 0); }
  public static void addUpdatedBy(FlatBufferBuilder builder, int updatedByOffset) { builder.addOffset(41, updatedByOffset, 0); }
  ...
  public static void addDataMode(FlatBufferBuilder builder, byte dataMode) { builder.addByte(45, dataMode, 0); }
  public static void addOnOrbit(FlatBufferBuilder builder, int onOrbitOffset) { builder.addOffset(46, onOrbitOffset, 0); }
  public static void addManifolds(FlatBufferBuilder builder, int manifoldsOffset) { builder.addOffset(47, manifoldsOffset, 0); }
  ...
  public static int endObjectOfInterest_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishObjectOfInterest_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "OBJE"); }
  public static void finishSizePrefixedObjectOfInterest_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "OBJE"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public ObjectOfInterest_Full get(int j) { return get(new ObjectOfInterest_Full(), j); }
    public ObjectOfInterest_Full get(ObjectOfInterest_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
