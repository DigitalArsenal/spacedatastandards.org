...
public final class Transponder_Full extends Table {
  ...
  public static Transponder_Full getRootAsTransponder_Full(ByteBuffer _bb, Transponder_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Transponder_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "TRAN"); }
   ...
   * Constraints: No constraints specified.
   */
  public String channels(int j) { int o = __offset(44); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int channelsLength() { int o = __offset(44); return o != 0 ? __vector_len(o) : 0; }
  public StringVector channelsVector() { return channelsVector(new StringVector()); }
  public StringVector channelsVector(StringVector obj) { int o = __offset(44); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }

  public static int createTransponder_Full(FlatBufferBuilder builder,
      int idOffset,
      int idCommOffset,
      int nameOffset,
  ...
  public static void addChannels(FlatBufferBuilder builder, int channelsOffset) { builder.addOffset(20, channelsOffset, 0); }
  ...
  public static int endTransponder_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishTransponder_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "TRAN"); }
  public static void finishSizePrefixedTransponder_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "TRAN"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Transponder_Full get(int j) { return get(new Transponder_Full(), j); }
    public Transponder_Full get(Transponder_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
