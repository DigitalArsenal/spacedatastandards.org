...
public final class AirEventTankers_Ingest extends Table {
  ...
  public static AirEventTankers_Ingest getRootAsAirEventTankers_Ingest(ByteBuffer _bb, AirEventTankers_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean AirEventTankers_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "AIRE"); }
  ...
  public static int createAirEventTankers_Ingest(FlatBufferBuilder builder,
  ...
  public static int endAirEventTankers_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAirEventTankers_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "AIRE"); }
  public static void finishSizePrefixedAirEventTankers_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "AIRE"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public AirEventTankers_Ingest get(int j) { return get(new AirEventTankers_Ingest(), j); }
    public AirEventTankers_Ingest get(AirEventTankers_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
