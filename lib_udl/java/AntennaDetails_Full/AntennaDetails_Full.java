...
public final class AntennaDetails_Full extends Table {
  public static void ValidateVersion() { Constants.FLATBUFFERS_24_3_25(); }
  public static AntennaDetails_Full getRootAsAntennaDetails_Full(ByteBuffer _bb) { return getRootAsAntennaDetails_Full(_bb, new AntennaDetails_Full()); }
  public static AntennaDetails_Full getRootAsAntennaDetails_Full(ByteBuffer _bb, AntennaDetails_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean AntennaDetails_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "ANTE"); }
  public void __init(int _i, ByteBuffer _bb) { __reset(_i, _bb); }
  public AntennaDetails_Full __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
   ...
   * Constraints: No constraints specified.
   */
  public String updatedAt() { int o = __offset(44); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer updatedAtAsByteBuffer() { return __vector_as_bytebuffer(44, 1); }
  public ByteBuffer updatedAtInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 44, 1); }
  /**
   * Application user who updated the row in the database, auto-populated by the system.
   * Example: /// Example: some.user
   * Constraints: Minimum length = 0, Maximum length = 64
   */
  public String updatedBy() { int o = __offset(46); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer updatedByAsByteBuffer() { return __vector_as_bytebuffer(46, 1); }
  public ByteBuffer updatedByInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 46, 1); }
  /**
   * Source of the data.
   ...
   * Constraints: No constraints specified.
   */
  public String manufacturerOrg() { int o = __offset(58); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer manufacturerOrgAsByteBuffer() { return __vector_as_bytebuffer(58, 1); }
  public ByteBuffer manufacturerOrgInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 58, 1); }

  public static int createAntennaDetails_Full(FlatBufferBuilder builder,
      int idOffset,
      int idAntennaOffset,
  ...
  public static void startAntennaDetails_Full(FlatBufferBuilder builder) { builder.startTable(28); }
  ...
  public static void addUpdatedAt(FlatBufferBuilder builder, int updatedAtOffset) { builder.addOffset(20, updatedAtOffset, 0); }
  public static void addUpdatedBy(FlatBufferBuilder builder, int updatedByOffset) { builder.addOffset(21, updatedByOffset, 0); }
  ...
  public static void addManufacturerOrg(FlatBufferBuilder builder, int manufacturerOrgOffset) { builder.addOffset(27, manufacturerOrgOffset, 0); }
  public static int endAntennaDetails_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAntennaDetails_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "ANTE"); }
  public static void finishSizePrefixedAntennaDetails_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "ANTE"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public AntennaDetails_Full get(int j) { return get(new AntennaDetails_Full(), j); }
    public AntennaDetails_Full get(AntennaDetails_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
