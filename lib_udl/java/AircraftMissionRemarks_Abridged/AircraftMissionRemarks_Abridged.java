...
public final class AircraftMissionRemarks_Abridged extends Table {
  ...
  public static AircraftMissionRemarks_Abridged getRootAsAircraftMissionRemarks_Abridged(ByteBuffer _bb, AircraftMissionRemarks_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean AircraftMissionRemarks_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "AIRC"); }
  ...
  public static int createAircraftMissionRemarks_Abridged(FlatBufferBuilder builder,
  ...
  public static int endAircraftMissionRemarks_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAircraftMissionRemarks_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "AIRC"); }
  public static void finishSizePrefixedAircraftMissionRemarks_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "AIRC"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public AircraftMissionRemarks_Abridged get(int j) { return get(new AircraftMissionRemarks_Abridged(), j); }
    public AircraftMissionRemarks_Abridged get(AircraftMissionRemarks_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
