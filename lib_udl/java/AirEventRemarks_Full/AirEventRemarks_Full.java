...
public final class AirEventRemarks_Full extends Table {
  ...
  public static AirEventRemarks_Full getRootAsAirEventRemarks_Full(ByteBuffer _bb, AirEventRemarks_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean AirEventRemarks_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "AIRE"); }
  ...
  public static int createAirEventRemarks_Full(FlatBufferBuilder builder,
  ...
  public static int endAirEventRemarks_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAirEventRemarks_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "AIRE"); }
  public static void finishSizePrefixedAirEventRemarks_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "AIRE"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public AirEventRemarks_Full get(int j) { return get(new AirEventRemarks_Full(), j); }
    public AirEventRemarks_Full get(AirEventRemarks_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
