...
public final class OnorbitThrusterStatus_Abridged extends Table {
  ...
  public static OnorbitThrusterStatus_Abridged getRootAsOnorbitThrusterStatus_Abridged(ByteBuffer _bb, OnorbitThrusterStatus_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean OnorbitThrusterStatus_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "ONOR"); }
  ...
  public static int createOnorbitThrusterStatus_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endOnorbitThrusterStatus_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishOnorbitThrusterStatus_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "ONOR"); }
  public static void finishSizePrefixedOnorbitThrusterStatus_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "ONOR"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public OnorbitThrusterStatus_Abridged get(int j) { return get(new OnorbitThrusterStatus_Abridged(), j); }
    public OnorbitThrusterStatus_Abridged get(OnorbitThrusterStatus_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
