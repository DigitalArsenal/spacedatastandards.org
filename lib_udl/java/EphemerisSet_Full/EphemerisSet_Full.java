...
public final class EphemerisSet_Full extends Table {
  ...
  public static EphemerisSet_Full getRootAsEphemerisSet_Full(ByteBuffer _bb, EphemerisSet_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean EphemerisSet_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "EPHE"); }
   ...
   * Constraints: No constraints specified.
   */
  public String stateVector() { int o = __offset(82); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer stateVectorAsByteBuffer() { return __vector_as_bytebuffer(82, 1); }
  public ByteBuffer stateVectorInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 82, 1); }
  /**
   * Satellite/catalog number of the target on-orbit object.
   * Example: /// Example: 2
   * Constraints: No constraints specified.
   */
  public int satNo() { int o = __offset(84); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public String ephemerisList(int j) { int o = __offset(86); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int ephemerisListLength() { int o = __offset(86); return o != 0 ? __vector_len(o) : 0; }
  public StringVector ephemerisListVector() { return ephemerisListVector(new StringVector()); }
  public StringVector ephemerisListVector(StringVector obj) { int o = __offset(86); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   * No description provided.
   * Example: /// Example: No example provided.
   * Constraints: No constraints specified.
   */
  public String onOrbit() { int o = __offset(88); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer onOrbitAsByteBuffer() { return __vector_as_bytebuffer(88, 1); }
  public ByteBuffer onOrbitInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 88, 1); }
  /**
   * Optional array of provider/source specific tags for this data, where each element is no longer than 32 characters, used for implementing data owner conditional access controls to restrict access to the data. Should be left null by data providers unless conditional access controls are coordinated with the UDL team.
   * Example: /// Example: ['PROVIDER_TAG1', 'PROVIDER_TAG2']
   * Constraints: No constraints specified.
   */
  public String tags(int j) { int o = __offset(90); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int tagsLength() { int o = __offset(90); return o != 0 ? __vector_len(o) : 0; }
  public StringVector tagsVector() { return tagsVector(new StringVector()); }
  public StringVector tagsVector(StringVector obj) { int o = __offset(90); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   * Optional identifier to track a commercial or marketplace transaction executed to produce this data.
   * Example: /// Example: TRANSACTION-ID
   * Constraints: Minimum length = 0, Maximum length = 64
   */
  public String transactionId() { int o = __offset(92); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer transactionIdAsByteBuffer() { return __vector_as_bytebuffer(92, 1); }
  public ByteBuffer transactionIdInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 92, 1); }
  /**
  ...
  public static int createEphemerisSet_Full(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static void addStateVector(FlatBufferBuilder builder, int stateVectorOffset) { builder.addOffset(39, stateVectorOffset, 0); }
  public static void addSatNo(FlatBufferBuilder builder, int satNo) { builder.addInt(40, satNo, 0); }
  public static void addEphemerisList(FlatBufferBuilder builder, int ephemerisListOffset) { builder.addOffset(41, ephemerisListOffset, 0); }
  ...
  public static void addOnOrbit(FlatBufferBuilder builder, int onOrbitOffset) { builder.addOffset(42, onOrbitOffset, 0); }
  public static void addTags(FlatBufferBuilder builder, int tagsOffset) { builder.addOffset(43, tagsOffset, 0); }
  ...
  public static void addTransactionId(FlatBufferBuilder builder, int transactionIdOffset) { builder.addOffset(44, transactionIdOffset, 0); }
  ...
  public static int endEphemerisSet_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishEphemerisSet_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "EPHE"); }
  public static void finishSizePrefixedEphemerisSet_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "EPHE"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public EphemerisSet_Full get(int j) { return get(new EphemerisSet_Full(), j); }
    public EphemerisSet_Full get(EphemerisSet_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
