...
public final class DataLinkReferences_Abridged extends Table {
  ...
  public static DataLinkReferences_Abridged getRootAsDataLinkReferences_Abridged(ByteBuffer _bb, DataLinkReferences_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean DataLinkReferences_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "DATA"); }
  ...
  public static int createDataLinkReferences_Abridged(FlatBufferBuilder builder,
  ...
  public static int endDataLinkReferences_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishDataLinkReferences_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "DATA"); }
  public static void finishSizePrefixedDataLinkReferences_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "DATA"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public DataLinkReferences_Abridged get(int j) { return get(new DataLinkReferences_Abridged(), j); }
    public DataLinkReferences_Abridged get(DataLinkReferences_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
