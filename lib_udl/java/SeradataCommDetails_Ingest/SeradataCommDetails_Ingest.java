...
public final class SeradataCommDetails_Ingest extends Table {
  ...
  public static SeradataCommDetails_Ingest getRootAsSeradataCommDetails_Ingest(ByteBuffer _bb, SeradataCommDetails_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean SeradataCommDetails_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "SERA"); }
  ...
  public static int createSeradataCommDetails_Ingest(FlatBufferBuilder builder,
      int idOffset,
      int idCommOffset,
  ...
  public static int endSeradataCommDetails_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishSeradataCommDetails_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "SERA"); }
  public static void finishSizePrefixedSeradataCommDetails_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "SERA"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public SeradataCommDetails_Ingest get(int j) { return get(new SeradataCommDetails_Ingest(), j); }
    public SeradataCommDetails_Ingest get(SeradataCommDetails_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
