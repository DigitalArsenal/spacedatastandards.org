...
public final class FlightPlan_Abridged extends Table {
  ...
  public static FlightPlan_Abridged getRootAsFlightPlan_Abridged(ByteBuffer _bb, FlightPlan_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean FlightPlan_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "FLIG"); }
  ...
  public static int createFlightPlan_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endFlightPlan_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishFlightPlan_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "FLIG"); }
  public static void finishSizePrefixedFlightPlan_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "FLIG"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public FlightPlan_Abridged get(int j) { return get(new FlightPlan_Abridged(), j); }
    public FlightPlan_Abridged get(FlightPlan_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
