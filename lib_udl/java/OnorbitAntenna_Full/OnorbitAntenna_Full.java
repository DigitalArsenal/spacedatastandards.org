...
public final class OnorbitAntenna_Full extends Table {
  ...
  public static OnorbitAntenna_Full getRootAsOnorbitAntenna_Full(ByteBuffer _bb, OnorbitAntenna_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean OnorbitAntenna_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "ONOR"); }
  ...
  public static int createOnorbitAntenna_Full(FlatBufferBuilder builder,
      int idOffset,
      int idOnOrbitOffset,
      int idAntennaOffset,
  ...
  public static int endOnorbitAntenna_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishOnorbitAntenna_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "ONOR"); }
  public static void finishSizePrefixedOnorbitAntenna_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "ONOR"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public OnorbitAntenna_Full get(int j) { return get(new OnorbitAntenna_Full(), j); }
    public OnorbitAntenna_Full get(OnorbitAntenna_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
