...
public final class AirEventReceivers_Abridged extends Table {
  ...
  public static AirEventReceivers_Abridged getRootAsAirEventReceivers_Abridged(ByteBuffer _bb, AirEventReceivers_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean AirEventReceivers_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "AIRE"); }
  ...
  public static int createAirEventReceivers_Abridged(FlatBufferBuilder builder,
  ...
  public static int endAirEventReceivers_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAirEventReceivers_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "AIRE"); }
  public static void finishSizePrefixedAirEventReceivers_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "AIRE"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public AirEventReceivers_Abridged get(int j) { return get(new AirEventReceivers_Abridged(), j); }
    public AirEventReceivers_Abridged get(AirEventReceivers_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
