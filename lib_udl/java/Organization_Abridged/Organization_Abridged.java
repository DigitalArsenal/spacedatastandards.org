...
public final class Organization_Abridged extends Table {
  ...
  public static boolean Organization_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "ORGA"); }
  ...
  public static void finishOrganization_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "ORGA"); }
  public static void finishSizePrefixedOrganization_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "ORGA"); }
