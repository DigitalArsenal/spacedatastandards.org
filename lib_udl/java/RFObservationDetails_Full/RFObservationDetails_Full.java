...
public final class RFObservationDetails_Full extends Table {
  ...
  public static RFObservationDetails_Full getRootAsRFObservationDetails_Full(ByteBuffer _bb, RFObservationDetails_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean RFObservationDetails_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "RFOB"); }
   ...
   * Constraints: No constraints specified.
   */
  public String onOrbit() { int o = __offset(164); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer onOrbitAsByteBuffer() { return __vector_as_bytebuffer(164, 1); }
  public ByteBuffer onOrbitInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 164, 1); }
  /**
   * Optional source-provided and searchable metadata or descriptor of the data.
   * Example: /// Example: descriptor
   * Constraints: Minimum length = 0, Maximum length = 64
   */
  public String descriptor() { int o = __offset(166); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer descriptorAsByteBuffer() { return __vector_as_bytebuffer(166, 1); }
  public ByteBuffer descriptorInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 166, 1); }
  /**
   ...
   */
  public String url() { int o = __offset(168); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer urlAsByteBuffer() { return __vector_as_bytebuffer(168, 1); }
  public ByteBuffer urlInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 168, 1); }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public String frequencies(int j) { int o = __offset(170); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int frequenciesLength() { int o = __offset(170); return o != 0 ? __vector_len(o) : 0; }
  public StringVector frequenciesVector() { return frequenciesVector(new StringVector()); }
  public StringVector frequenciesVector(StringVector obj) { int o = __offset(170); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public String powers(int j) { int o = __offset(172); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int powersLength() { int o = __offset(172); return o != 0 ? __vector_len(o) : 0; }
  public StringVector powersVector() { return powersVector(new StringVector()); }
  public StringVector powersVector(StringVector obj) { int o = __offset(172); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   * Array of signal to noise ratios of the signals, in dB.
   * Example: /// Example: [1.1, 2.2]
   * Constraints: No constraints specified.
   */
  public String snrs(int j) { int o = __offset(174); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int snrsLength() { int o = __offset(174); return o != 0 ? __vector_len(o) : 0; }
  public StringVector snrsVector() { return snrsVector(new StringVector()); }
  public StringVector snrsVector(StringVector obj) { int o = __offset(174); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   * Array of measurement confidences.
   * Example: /// Example: [1.1, 2.2]
   * Constraints: No constraints specified.
   */
  public String confidences(int j) { int o = __offset(176); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int confidencesLength() { int o = __offset(176); return o != 0 ? __vector_len(o) : 0; }
  public StringVector confidencesVector() { return confidencesVector(new StringVector()); }
  public StringVector confidencesVector(StringVector obj) { int o = __offset(176); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   * Array of detection statuses (e.g. DETECTED, CARRIER_DETECTED, NOT_DETECTED) for each measured signal.
   * Example: /// Example: ['DETECTED']
   * Constraints: No constraints specified.
   */
  public String detectionStatuses(int j) { int o = __offset(178); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int detectionStatusesLength() { int o = __offset(178); return o != 0 ? __vector_len(o) : 0; }
  public StringVector detectionStatusesVector() { return detectionStatusesVector(new StringVector()); }
  public StringVector detectionStatusesVector(StringVector obj) { int o = __offset(178); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   * Array of chipRates.
   * Example: /// Example: [1.1, 2.2]
   * Constraints: No constraints specified.
   */
  public String chipRates(int j) { int o = __offset(180); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int chipRatesLength() { int o = __offset(180); return o != 0 ? __vector_len(o) : 0; }
  public StringVector chipRatesVector() { return chipRatesVector(new StringVector()); }
  public StringVector chipRatesVector(StringVector obj) { int o = __offset(180); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   * Array of code taps.
   * Example: /// Example: ['TAG1', 'TAG2']
   * Constraints: No constraints specified.
   */
  public String codeTaps(int j) { int o = __offset(182); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int codeTapsLength() { int o = __offset(182); return o != 0 ? __vector_len(o) : 0; }
  public StringVector codeTapsVector() { return codeTapsVector(new StringVector()); }
  public StringVector codeTapsVector(StringVector obj) { int o = __offset(182); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   * Array of code fills.
   * Example: /// Example: ['TAG1', 'TAG2']
   * Constraints: No constraints specified.
   */
  public String codeFills(int j) { int o = __offset(184); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int codeFillsLength() { int o = __offset(184); return o != 0 ? __vector_len(o) : 0; }
  public StringVector codeFillsVector() { return codeFillsVector(new StringVector()); }
  public StringVector codeFillsVector(StringVector obj) { int o = __offset(184); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   * Array of code lengths.
   * Example: /// Example: [1.1, 2.2]
   * Constraints: No constraints specified.
   */
  public String codeLengths(int j) { int o = __offset(186); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int codeLengthsLength() { int o = __offset(186); return o != 0 ? __vector_len(o) : 0; }
  public StringVector codeLengthsVector() { return codeLengthsVector(new StringVector()); }
  public StringVector codeLengthsVector(StringVector obj) { int o = __offset(186); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   * Array of pnOrder.
   * Example: /// Example: [1, 2]
   * Constraints: No constraints specified.
   */
  public String pnOrders(int j) { int o = __offset(188); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int pnOrdersLength() { int o = __offset(188); return o != 0 ? __vector_len(o) : 0; }
  public StringVector pnOrdersVector() { return pnOrdersVector(new StringVector()); }
  public StringVector pnOrdersVector(StringVector obj) { int o = __offset(188); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   * Array of optional source provided identifiers of the measurements/signals.
   * Example: /// Example: ['ID1', 'ID2']
   * Constraints: No constraints specified.
   */
  public String signalIds(int j) { int o = __offset(190); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int signalIdsLength() { int o = __offset(190); return o != 0 ? __vector_len(o) : 0; }
  public StringVector signalIdsVector() { return signalIdsVector(new StringVector()); }
  public StringVector signalIdsVector(StringVector obj) { int o = __offset(190); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   * Array of measured signal baud rates.
   * Example: /// Example: [1.1, 2.2]
   * Constraints: No constraints specified.
   */
  public String baudRates(int j) { int o = __offset(192); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int baudRatesLength() { int o = __offset(192); return o != 0 ? __vector_len(o) : 0; }
  public StringVector baudRatesVector() { return baudRatesVector(new StringVector()); }
  public StringVector baudRatesVector(StringVector obj) { int o = __offset(192); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   * Array of optional source provided telemetry identifiers of the measurements/signals.
   * Example: /// Example: ['ID1', 'ID2']
   * Constraints: No constraints specified.
   */
  public String telemetryIds(int j) { int o = __offset(194); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int telemetryIdsLength() { int o = __offset(194); return o != 0 ? __vector_len(o) : 0; }
  public StringVector telemetryIdsVector() { return telemetryIdsVector(new StringVector()); }
  public StringVector telemetryIdsVector(StringVector obj) { int o = __offset(194); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public String constellationXpoints(int j) { int o = __offset(196); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int constellationXpointsLength() { int o = __offset(196); return o != 0 ? __vector_len(o) : 0; }
  public StringVector constellationXpointsVector() { return constellationXpointsVector(new StringVector()); }
  public StringVector constellationXpointsVector(StringVector obj) { int o = __offset(196); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  /**
   ...
   * Constraints: No constraints specified.
   */
  public String constellationYpoints(int j) { int o = __offset(198); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int constellationYpointsLength() { int o = __offset(198); return o != 0 ? __vector_len(o) : 0; }
  public StringVector constellationYpointsVector() { return constellationYpointsVector(new StringVector()); }
  public StringVector constellationYpointsVector(StringVector obj) { int o = __offset(198); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }

  public static int createRFObservationDetails_Full(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static void addOnOrbit(FlatBufferBuilder builder, int onOrbitOffset) { builder.addOffset(80, onOrbitOffset, 0); }
  public static void addDescriptor(FlatBufferBuilder builder, int descriptorOffset) { builder.addOffset(81, descriptorOffset, 0); }
  public static void addUrl(FlatBufferBuilder builder, int urlOffset) { builder.addOffset(82, urlOffset, 0); }
  public static void addFrequencies(FlatBufferBuilder builder, int frequenciesOffset) { builder.addOffset(83, frequenciesOffset, 0); }
  ...
  public static void addPowers(FlatBufferBuilder builder, int powersOffset) { builder.addOffset(84, powersOffset, 0); }
  ...
  public static void addSnrs(FlatBufferBuilder builder, int snrsOffset) { builder.addOffset(85, snrsOffset, 0); }
  ...
  public static void addConfidences(FlatBufferBuilder builder, int confidencesOffset) { builder.addOffset(86, confidencesOffset, 0); }
  ...
  public static void addDetectionStatuses(FlatBufferBuilder builder, int detectionStatusesOffset) { builder.addOffset(87, detectionStatusesOffset, 0); }
  ...
  public static void addChipRates(FlatBufferBuilder builder, int chipRatesOffset) { builder.addOffset(88, chipRatesOffset, 0); }
  ...
  public static void addCodeTaps(FlatBufferBuilder builder, int codeTapsOffset) { builder.addOffset(89, codeTapsOffset, 0); }
  ...
  public static void addCodeFills(FlatBufferBuilder builder, int codeFillsOffset) { builder.addOffset(90, codeFillsOffset, 0); }
  ...
  public static void addCodeLengths(FlatBufferBuilder builder, int codeLengthsOffset) { builder.addOffset(91, codeLengthsOffset, 0); }
  ...
  public static void addPnOrders(FlatBufferBuilder builder, int pnOrdersOffset) { builder.addOffset(92, pnOrdersOffset, 0); }
  ...
  public static void addSignalIds(FlatBufferBuilder builder, int signalIdsOffset) { builder.addOffset(93, signalIdsOffset, 0); }
  ...
  public static void addBaudRates(FlatBufferBuilder builder, int baudRatesOffset) { builder.addOffset(94, baudRatesOffset, 0); }
  ...
  public static void addTelemetryIds(FlatBufferBuilder builder, int telemetryIdsOffset) { builder.addOffset(95, telemetryIdsOffset, 0); }
  ...
  public static void addConstellationXpoints(FlatBufferBuilder builder, int constellationXpointsOffset) { builder.addOffset(96, constellationXpointsOffset, 0); }
  ...
  public static void addConstellationYpoints(FlatBufferBuilder builder, int constellationYpointsOffset) { builder.addOffset(97, constellationYpointsOffset, 0); }
  ...
  public static int endRFObservationDetails_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishRFObservationDetails_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "RFOB"); }
  public static void finishSizePrefixedRFObservationDetails_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "RFOB"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public RFObservationDetails_Full get(int j) { return get(new RFObservationDetails_Full(), j); }
    public RFObservationDetails_Full get(RFObservationDetails_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
