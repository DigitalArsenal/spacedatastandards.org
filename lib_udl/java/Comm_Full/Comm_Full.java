...
public final class Comm_Full extends Table {
  public static void ValidateVersion() { Constants.FLATBUFFERS_24_3_25(); }
  public static Comm_Full getRootAsComm_Full(ByteBuffer _bb) { return getRootAsComm_Full(_bb, new Comm_Full()); }
  public static Comm_Full getRootAsComm_Full(ByteBuffer _bb, Comm_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Comm_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "COMM"); }
   ...
   * Constraints: No constraints specified.
   */
  public String transponders(int j) { int o = __offset(32); return o != 0 ? __string(__vector(o) + j * 4) : null; }
  public int transpondersLength() { int o = __offset(32); return o != 0 ? __vector_len(o) : 0; }
  public StringVector transpondersVector() { return transpondersVector(new StringVector()); }
  public StringVector transpondersVector(StringVector obj) { int o = __offset(32); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }

  public static int createComm_Full(FlatBufferBuilder builder,
      int idOffset,
      int idEntityOffset,
      int nameOffset,
  ...
  public static void addTransponders(FlatBufferBuilder builder, int transpondersOffset) { builder.addOffset(14, transpondersOffset, 0); }
  ...
  public static int endComm_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishComm_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "COMM"); }
  public static void finishSizePrefixedComm_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "COMM"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Comm_Full get(int j) { return get(new Comm_Full(), j); }
    public Comm_Full get(Comm_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
