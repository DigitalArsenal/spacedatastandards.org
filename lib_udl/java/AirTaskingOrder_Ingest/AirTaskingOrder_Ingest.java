...
public final class AirTaskingOrder_Ingest extends Table {
  ...
  public static AirTaskingOrder_Ingest getRootAsAirTaskingOrder_Ingest(ByteBuffer _bb, AirTaskingOrder_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean AirTaskingOrder_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "AIRT"); }
  ...
  public static int createAirTaskingOrder_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endAirTaskingOrder_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAirTaskingOrder_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "AIRT"); }
  public static void finishSizePrefixedAirTaskingOrder_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "AIRT"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public AirTaskingOrder_Ingest get(int j) { return get(new AirTaskingOrder_Ingest(), j); }
    public AirTaskingOrder_Ingest get(AirTaskingOrder_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
