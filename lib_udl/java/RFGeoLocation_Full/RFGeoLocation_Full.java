...
public final class RFGeoLocation_Full extends Table {
  ...
  public static RFGeoLocation_Full getRootAsRFGeoLocation_Full(ByteBuffer _bb, RFGeoLocation_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean RFGeoLocation_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "RFGE"); }
  ...
  public static int createRFGeoLocation_Full(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endRFGeoLocation_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishRFGeoLocation_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "RFGE"); }
  public static void finishSizePrefixedRFGeoLocation_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "RFGE"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public RFGeoLocation_Full get(int j) { return get(new RFGeoLocation_Full(), j); }
    public RFGeoLocation_Full get(RFGeoLocation_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
