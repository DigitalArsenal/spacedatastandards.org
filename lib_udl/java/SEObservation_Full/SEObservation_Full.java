...
public final class SEObservation_Full extends Table {
  ...
  public static SEObservation_Full getRootAsSEObservation_Full(ByteBuffer _bb, SEObservation_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean SEObservation_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "SEOB"); }
  ...
  public static int createSEObservation_Full(FlatBufferBuilder builder,
      int obTypeOffset,
      int obUoMOffset,
      double obValue,
      int obStringOffset,
  ...
  public static int endSEObservation_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishSEObservation_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "SEOB"); }
  public static void finishSizePrefixedSEObservation_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "SEOB"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public SEObservation_Full get(int j) { return get(new SEObservation_Full(), j); }
    public SEObservation_Full get(SEObservation_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
