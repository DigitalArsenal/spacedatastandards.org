...
public final class WeatherReport_Full extends Table {
  ...
  public static WeatherReport_Full getRootAsWeatherReport_Full(ByteBuffer _bb, WeatherReport_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean WeatherReport_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "WEAT"); }
  ...
  public static int createWeatherReport_Full(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endWeatherReport_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishWeatherReport_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "WEAT"); }
  public static void finishSizePrefixedWeatherReport_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "WEAT"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public WeatherReport_Full get(int j) { return get(new WeatherReport_Full(), j); }
    public WeatherReport_Full get(WeatherReport_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
