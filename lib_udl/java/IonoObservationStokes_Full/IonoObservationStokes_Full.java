...
public final class IonoObservationStokes_Full extends Table {
  ...
  public static IonoObservationStokes_Full getRootAsIonoObservationStokes_Full(ByteBuffer _bb, IonoObservationStokes_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean IonoObservationStokes_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "IONO"); }
  ...
  public static int createIonoObservationStokes_Full(FlatBufferBuilder builder,
      int notesOffset,
  ...
  public static int endIonoObservationStokes_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishIonoObservationStokes_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "IONO"); }
  public static void finishSizePrefixedIonoObservationStokes_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "IONO"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public IonoObservationStokes_Full get(int j) { return get(new IonoObservationStokes_Full(), j); }
    public IonoObservationStokes_Full get(IonoObservationStokes_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
