...
public final class Sensorlimits_Abridged extends Table {
  ...
  public static Sensorlimits_Abridged getRootAsSensorlimits_Abridged(ByteBuffer _bb, Sensorlimits_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Sensorlimits_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "SENS"); }
  ...
  public static int createSensorlimits_Abridged(FlatBufferBuilder builder,
  ...
  public static int endSensorlimits_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishSensorlimits_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "SENS"); }
  public static void finishSizePrefixedSensorlimits_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "SENS"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Sensorlimits_Abridged get(int j) { return get(new Sensorlimits_Abridged(), j); }
    public Sensorlimits_Abridged get(Sensorlimits_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
