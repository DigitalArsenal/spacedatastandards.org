...
public final class Hazard_Ingest extends Table {
  ...
  public static Hazard_Ingest getRootAsHazard_Ingest(ByteBuffer _bb, Hazard_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Hazard_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "HAZA"); }
  ...
  public static int createHazard_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endHazard_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishHazard_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "HAZA"); }
  public static void finishSizePrefixedHazard_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "HAZA"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Hazard_Ingest get(int j) { return get(new Hazard_Ingest(), j); }
    public Hazard_Ingest get(Hazard_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
