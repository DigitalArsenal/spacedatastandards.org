...
public final class OnorbitSolarArray extends Table {
  ...
  public static OnorbitSolarArray getRootAsOnorbitSolarArray(ByteBuffer _bb, OnorbitSolarArray obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean OnorbitSolarArrayBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "ONOR"); }
  ...
  public static int createOnorbitSolarArray(FlatBufferBuilder builder,
      int idOffset,
      int idOnOrbitOffset,
  ...
  public static int endOnorbitSolarArray(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishOnorbitSolarArrayBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "ONOR"); }
  public static void finishSizePrefixedOnorbitSolarArrayBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "ONOR"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public OnorbitSolarArray get(int j) { return get(new OnorbitSolarArray(), j); }
    public OnorbitSolarArray get(OnorbitSolarArray obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
