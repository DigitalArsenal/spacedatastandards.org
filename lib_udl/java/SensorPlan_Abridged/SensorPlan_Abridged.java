...
public final class SensorPlan_Abridged extends Table {
  ...
  public static SensorPlan_Abridged getRootAsSensorPlan_Abridged(ByteBuffer _bb, SensorPlan_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean SensorPlan_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "SENS"); }
  ...
  public static int createSensorPlan_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endSensorPlan_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishSensorPlan_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "SENS"); }
  public static void finishSizePrefixedSensorPlan_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "SENS"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public SensorPlan_Abridged get(int j) { return get(new SensorPlan_Abridged(), j); }
    public SensorPlan_Abridged get(SensorPlan_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
