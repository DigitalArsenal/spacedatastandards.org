...
public final class EvacTreatment_Abridged extends Table {
  ...
  public static EvacTreatment_Abridged getRootAsEvacTreatment_Abridged(ByteBuffer _bb, EvacTreatment_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean EvacTreatment_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "EVAC"); }
  ...
  public static int createEvacTreatment_Abridged(FlatBufferBuilder builder,
      int typeOffset,
      int bodyPartOffset,
      int timeOffset,
      int commentsOffset) {
  ...
  public static int endEvacTreatment_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishEvacTreatment_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "EVAC"); }
  public static void finishSizePrefixedEvacTreatment_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "EVAC"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public EvacTreatment_Abridged get(int j) { return get(new EvacTreatment_Abridged(), j); }
    public EvacTreatment_Abridged get(EvacTreatment_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
