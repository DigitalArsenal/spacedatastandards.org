...
public final class ISRCollectionRequirements_Abridged extends Table {
  ...
  public static ISRCollectionRequirements_Abridged getRootAsISRCollectionRequirements_Abridged(ByteBuffer _bb, ISRCollectionRequirements_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean ISRCollectionRequirements_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "ISRC"); }
  ...
  public static int createISRCollectionRequirements_Abridged(FlatBufferBuilder builder,
      int idOffset,
      int hashOffset,
      int typeOffset,
  ...
  public static int endISRCollectionRequirements_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishISRCollectionRequirements_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "ISRC"); }
  public static void finishSizePrefixedISRCollectionRequirements_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "ISRC"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public ISRCollectionRequirements_Abridged get(int j) { return get(new ISRCollectionRequirements_Abridged(), j); }
    public ISRCollectionRequirements_Abridged get(ISRCollectionRequirements_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
