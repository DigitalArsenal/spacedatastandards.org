...
public final class Bus_Abridged extends Table {
  ...
  public static boolean Bus_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "BUSA"); }
  ...
  public static void finishBus_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "BUSA"); }
  public static void finishSizePrefixedBus_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "BUSA"); }
