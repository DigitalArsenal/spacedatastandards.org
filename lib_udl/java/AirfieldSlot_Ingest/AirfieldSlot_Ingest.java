...
public final class AirfieldSlot_Ingest extends Table {
  ...
  public static AirfieldSlot_Ingest getRootAsAirfieldSlot_Ingest(ByteBuffer _bb, AirfieldSlot_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean AirfieldSlot_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "AIRF"); }
  ...
  public static int createAirfieldSlot_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endAirfieldSlot_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAirfieldSlot_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "AIRF"); }
  public static void finishSizePrefixedAirfieldSlot_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "AIRF"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public AirfieldSlot_Ingest get(int j) { return get(new AirfieldSlot_Ingest(), j); }
    public AirfieldSlot_Ingest get(AirfieldSlot_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
