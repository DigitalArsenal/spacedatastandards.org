...
public final class Track_Ingest extends Table {
  ...
  public static Track_Ingest getRootAsTrack_Ingest(ByteBuffer _bb, Track_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean Track_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "TRAC"); }
  ...
  public static int createTrack_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endTrack_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishTrack_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "TRAC"); }
  public static void finishSizePrefixedTrack_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "TRAC"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public Track_Ingest get(int j) { return get(new Track_Ingest(), j); }
    public Track_Ingest get(Track_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
