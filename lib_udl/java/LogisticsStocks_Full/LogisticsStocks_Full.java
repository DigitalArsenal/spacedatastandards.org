...
public final class LogisticsStocks_Full extends Table {
  ...
  public static LogisticsStocks_Full getRootAsLogisticsStocks_Full(ByteBuffer _bb, LogisticsStocks_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean LogisticsStocks_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "LOGI"); }
  ...
  public static int createLogisticsStocks_Full(FlatBufferBuilder builder,
  ...
  public static int endLogisticsStocks_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishLogisticsStocks_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "LOGI"); }
  public static void finishSizePrefixedLogisticsStocks_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "LOGI"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public LogisticsStocks_Full get(int j) { return get(new LogisticsStocks_Full(), j); }
    public LogisticsStocks_Full get(LogisticsStocks_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
