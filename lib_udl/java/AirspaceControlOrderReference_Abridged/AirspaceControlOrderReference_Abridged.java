...
public final class AirspaceControlOrderReference_Abridged extends Table {
  ...
  public static AirspaceControlOrderReference_Abridged getRootAsAirspaceControlOrderReference_Abridged(ByteBuffer _bb, AirspaceControlOrderReference_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean AirspaceControlOrderReference_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "AIRS"); }
  ...
  public static int createAirspaceControlOrderReference_Abridged(FlatBufferBuilder builder,
      int refSidOffset,
      int refTypeOffset,
  ...
  public static int endAirspaceControlOrderReference_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAirspaceControlOrderReference_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "AIRS"); }
  public static void finishSizePrefixedAirspaceControlOrderReference_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "AIRS"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public AirspaceControlOrderReference_Abridged get(int j) { return get(new AirspaceControlOrderReference_Abridged(), j); }
    public AirspaceControlOrderReference_Abridged get(AirspaceControlOrderReference_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
