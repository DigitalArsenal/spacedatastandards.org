...
public final class WeatherData_Ingest extends Table {
  ...
  public static WeatherData_Ingest getRootAsWeatherData_Ingest(ByteBuffer _bb, WeatherData_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean WeatherData_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "WEAT"); }
  ...
  public static int createWeatherData_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endWeatherData_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishWeatherData_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "WEAT"); }
  public static void finishSizePrefixedWeatherData_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "WEAT"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public WeatherData_Ingest get(int j) { return get(new WeatherData_Ingest(), j); }
    public WeatherData_Ingest get(WeatherData_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
