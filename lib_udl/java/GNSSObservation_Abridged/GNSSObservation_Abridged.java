...
public final class GNSSObservation_Abridged extends Table {
  ...
  public static GNSSObservation_Abridged getRootAsGNSSObservation_Abridged(ByteBuffer _bb, GNSSObservation_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean GNSSObservation_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "GNSS"); }
  ...
  public static int createGNSSObservation_Abridged(FlatBufferBuilder builder,
      int gnssSatIdOffset,
      int trackingStatus,
      int agcState,
  ...
  public static int endGNSSObservation_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishGNSSObservation_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "GNSS"); }
  public static void finishSizePrefixedGNSSObservation_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "GNSS"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public GNSSObservation_Abridged get(int j) { return get(new GNSSObservation_Abridged(), j); }
    public GNSSObservation_Abridged get(GNSSObservation_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
