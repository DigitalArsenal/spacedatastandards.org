...
public final class AircraftStatus_Full extends Table {
  ...
  public static AircraftStatus_Full getRootAsAircraftStatus_Full(ByteBuffer _bb, AircraftStatus_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean AircraftStatus_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "AIRC"); }
   ...
   * Constraints: Minimum length = 0, Maximum length = 64
   */
  public String sourceDl() { int o = __offset(102); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer sourceDlAsByteBuffer() { return __vector_as_bytebuffer(102, 1); }
  public ByteBuffer sourceDlInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 102, 1); }
  /**
   * Source of the data.
  ...
  public static int createAircraftStatus_Full(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static void addSourceDl(FlatBufferBuilder builder, int sourceDlOffset) { builder.addOffset(49, sourceDlOffset, 0); }
  ...
  public static int endAircraftStatus_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAircraftStatus_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "AIRC"); }
  public static void finishSizePrefixedAircraftStatus_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "AIRC"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public AircraftStatus_Full get(int j) { return get(new AircraftStatus_Full(), j); }
    public AircraftStatus_Full get(AircraftStatus_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
