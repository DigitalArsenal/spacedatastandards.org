...
public final class IonoObservationFrequency_Full extends Table {
  ...
  public static IonoObservationFrequency_Full getRootAsIonoObservationFrequency_Full(ByteBuffer _bb, IonoObservationFrequency_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean IonoObservationFrequency_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "IONO"); }
  ...
  public static int createIonoObservationFrequency_Full(FlatBufferBuilder builder,
      int notesOffset,
  ...
  public static int endIonoObservationFrequency_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishIonoObservationFrequency_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "IONO"); }
  public static void finishSizePrefixedIonoObservationFrequency_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "IONO"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public IonoObservationFrequency_Full get(int j) { return get(new IonoObservationFrequency_Full(), j); }
    public IonoObservationFrequency_Full get(IonoObservationFrequency_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
