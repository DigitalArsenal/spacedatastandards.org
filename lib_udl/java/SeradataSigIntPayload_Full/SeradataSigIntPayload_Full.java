...
public final class SeradataSigIntPayload_Full extends Table {
  ...
  public static SeradataSigIntPayload_Full getRootAsSeradataSigIntPayload_Full(ByteBuffer _bb, SeradataSigIntPayload_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean SeradataSigIntPayload_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "SERA"); }
  ...
  public static int createSeradataSigIntPayload_Full(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endSeradataSigIntPayload_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishSeradataSigIntPayload_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "SERA"); }
  public static void finishSizePrefixedSeradataSigIntPayload_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "SERA"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public SeradataSigIntPayload_Full get(int j) { return get(new SeradataSigIntPayload_Full(), j); }
    public SeradataSigIntPayload_Full get(SeradataSigIntPayload_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
