...
public final class LaunchSite_Abridged extends Table {
  ...
  public static LaunchSite_Abridged getRootAsLaunchSite_Abridged(ByteBuffer _bb, LaunchSite_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean LaunchSite_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "LAUN"); }
  ...
  public static int createLaunchSite_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endLaunchSite_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishLaunchSite_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "LAUN"); }
  public static void finishSizePrefixedLaunchSite_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "LAUN"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public LaunchSite_Abridged get(int j) { return get(new LaunchSite_Abridged(), j); }
    public LaunchSite_Abridged get(LaunchSite_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
