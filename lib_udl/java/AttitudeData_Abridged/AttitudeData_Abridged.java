...
public final class AttitudeData_Abridged extends Table {
  ...
  public static AttitudeData_Abridged getRootAsAttitudeData_Abridged(ByteBuffer _bb, AttitudeData_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean AttitudeData_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "ATTI"); }
  ...
  public static int createAttitudeData_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endAttitudeData_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishAttitudeData_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "ATTI"); }
  public static void finishSizePrefixedAttitudeData_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "ATTI"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public AttitudeData_Abridged get(int j) { return get(new AttitudeData_Abridged(), j); }
    public AttitudeData_Abridged get(AttitudeData_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
