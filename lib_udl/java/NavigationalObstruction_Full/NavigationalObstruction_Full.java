...
public final class NavigationalObstruction_Full extends Table {
  ...
  public static NavigationalObstruction_Full getRootAsNavigationalObstruction_Full(ByteBuffer _bb, NavigationalObstruction_Full obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean NavigationalObstruction_FullBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "NAVI"); }
   ...
   * Constraints: No constraints specified.
   */
  public String updatedAt() { int o = __offset(148); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer updatedAtAsByteBuffer() { return __vector_as_bytebuffer(148, 1); }
  public ByteBuffer updatedAtInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 148, 1); }
  /**
   * Application user who updated the row in the database, auto-populated by the system.
   * Example: /// Example: some.user
   * Constraints: Minimum length = 0, Maximum length = 64
   */
  public String updatedBy() { int o = __offset(150); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer updatedByAsByteBuffer() { return __vector_as_bytebuffer(150, 1); }
  public ByteBuffer updatedByInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 150, 1); }
  /**
   * The source data library from which this record was received. This could be a remote or tactical UDL or another data library. If null, the record should be assumed to have originated from the primary Enterprise UDL.
   * Example: /// Example: AXE
   * Constraints: Minimum length = 0, Maximum length = 64
   */
  public String sourceDl() { int o = __offset(152); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer sourceDlAsByteBuffer() { return __vector_as_bytebuffer(152, 1); }
  public ByteBuffer sourceDlInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 152, 1); }
  /**
   * Source of the data.
   ...
   * Constraints: Minimum length = 1, Maximum length = 32
   */
  public byte dataMode() { int o = __offset(160); return o != 0 ? bb.get(o + bb_pos) : 0; }

  public static int createNavigationalObstruction_Full(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static void addUpdatedAt(FlatBufferBuilder builder, int updatedAtOffset) { builder.addOffset(72, updatedAtOffset, 0); }
  public static void addUpdatedBy(FlatBufferBuilder builder, int updatedByOffset) { builder.addOffset(73, updatedByOffset, 0); }
  public static void addSourceDl(FlatBufferBuilder builder, int sourceDlOffset) { builder.addOffset(74, sourceDlOffset, 0); }
  ...
  public static void addDataMode(FlatBufferBuilder builder, byte dataMode) { builder.addByte(78, dataMode, 0); }
  public static int endNavigationalObstruction_Full(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishNavigationalObstruction_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "NAVI"); }
  public static void finishSizePrefixedNavigationalObstruction_FullBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "NAVI"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public NavigationalObstruction_Full get(int j) { return get(new NavigationalObstruction_Full(), j); }
    public NavigationalObstruction_Full get(NavigationalObstruction_Full obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
