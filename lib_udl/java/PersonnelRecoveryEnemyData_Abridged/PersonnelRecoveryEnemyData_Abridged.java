...
public final class PersonnelRecoveryEnemyData_Abridged extends Table {
  ...
  public static PersonnelRecoveryEnemyData_Abridged getRootAsPersonnelRecoveryEnemyData_Abridged(ByteBuffer _bb, PersonnelRecoveryEnemyData_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean PersonnelRecoveryEnemyData_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "PERS"); }
  ...
  public static int createPersonnelRecoveryEnemyData_Abridged(FlatBufferBuilder builder,
  ...
  public static int endPersonnelRecoveryEnemyData_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishPersonnelRecoveryEnemyData_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "PERS"); }
  public static void finishSizePrefixedPersonnelRecoveryEnemyData_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "PERS"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public PersonnelRecoveryEnemyData_Abridged get(int j) { return get(new PersonnelRecoveryEnemyData_Abridged(), j); }
    public PersonnelRecoveryEnemyData_Abridged get(PersonnelRecoveryEnemyData_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
