...
public final class IonoObservationTime_Abridged extends Table {
  ...
  public static IonoObservationTime_Abridged getRootAsIonoObservationTime_Abridged(ByteBuffer _bb, IonoObservationTime_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean IonoObservationTime_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "IONO"); }
  ...
  public static int createIonoObservationTime_Abridged(FlatBufferBuilder builder,
  ...
  public static int endIonoObservationTime_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishIonoObservationTime_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "IONO"); }
  public static void finishSizePrefixedIonoObservationTime_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "IONO"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public IonoObservationTime_Abridged get(int j) { return get(new IonoObservationTime_Abridged(), j); }
    public IonoObservationTime_Abridged get(IonoObservationTime_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
