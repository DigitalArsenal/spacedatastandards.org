...
public final class DataLink_Ingest extends Table {
  ...
  public static DataLink_Ingest getRootAsDataLink_Ingest(ByteBuffer _bb, DataLink_Ingest obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean DataLink_IngestBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "DATA"); }
  ...
  public static int createDataLink_Ingest(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static int endDataLink_Ingest(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishDataLink_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "DATA"); }
  public static void finishSizePrefixedDataLink_IngestBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "DATA"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public DataLink_Ingest get(int j) { return get(new DataLink_Ingest(), j); }
    public DataLink_Ingest get(DataLink_Ingest obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
