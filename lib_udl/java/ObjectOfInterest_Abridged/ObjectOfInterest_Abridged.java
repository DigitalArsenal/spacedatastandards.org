...
public final class ObjectOfInterest_Abridged extends Table {
  ...
  public static ObjectOfInterest_Abridged getRootAsObjectOfInterest_Abridged(ByteBuffer _bb, ObjectOfInterest_Abridged obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public static boolean ObjectOfInterest_AbridgedBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "OBJE"); }
   ...
   */
  public String origin() { int o = __offset(84); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer originAsByteBuffer() { return __vector_as_bytebuffer(84, 1); }
  public ByteBuffer originInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 84, 1); }
  /**
   ...
   * Constraints: Minimum length = 1, Maximum length = 32
   */
  public byte dataMode() { int o = __offset(88); return o != 0 ? bb.get(o + bb_pos) : 0; }

  public static int createObjectOfInterest_Abridged(FlatBufferBuilder builder,
      int idOffset,
  ...
  public static void addOrigin(FlatBufferBuilder builder, int originOffset) { builder.addOffset(40, originOffset, 0); }
  ...
  public static void addDataMode(FlatBufferBuilder builder, byte dataMode) { builder.addByte(42, dataMode, 0); }
  public static int endObjectOfInterest_Abridged(FlatBufferBuilder builder) {
    int o = builder.endTable();
    return o;
  }
  public static void finishObjectOfInterest_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "OBJE"); }
  public static void finishSizePrefixedObjectOfInterest_AbridgedBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "OBJE"); }

  public static final class Vector extends BaseVector {
    public Vector __assign(int _vector, int _element_size, ByteBuffer _bb) { __reset(_vector, _element_size, _bb); return this; }

    public ObjectOfInterest_Abridged get(int j) { return get(new ObjectOfInterest_Abridged(), j); }
    public ObjectOfInterest_Abridged get(ObjectOfInterest_Abridged obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
