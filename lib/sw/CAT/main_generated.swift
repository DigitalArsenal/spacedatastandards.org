...
public enum ownerCode: Int8, Enum, Verifiable {
  ...
  public static var max: ownerCode { return .zwe }
  public static var min: ownerCode { return .ab }
}
...
public struct CAT: FlatBufferObject, Verifiable {
  ...
  public var OWNER: ownerCode { let o = _accessor.offset(VTOFFSET.OWNER.v); return o == 0 ? .ab : ownerCode(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .ab }
  ...
  public static func add(OWNER: ownerCode, _ fbb: inout FlatBufferBuilder) { fbb.add(element: OWNER.rawValue, def: 0, at: VTOFFSET.OWNER.p) }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.OWNER.p, fieldName: "OWNER", required: false, type: ownerCode.self)
...
public struct CATCOLLECTION: FlatBufferObject, Verifiable {
  ...
  public static var id: String { "$CAT" } 
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: CATCOLLECTION.id, addPrefix: prefix) }
  private init(_ t: Table) { _accessor = t }
  public init(_ bb: ByteBuffer, o: Int32) { _accessor = Table(bb: bb, position: o) }
  ...
  public func RECORDS(at index: Int32) -> CAT? { let o = _accessor.offset(VTOFFSET.RECORDS.v); return o == 0 ? nil : CAT(_accessor.bb, o: _accessor.indirect(_accessor.vector(at: o) + index * 4)) }
  public static func startCATCOLLECTION(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 1) }
  public static func addVectorOf(RECORDS: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: RECORDS, at: VTOFFSET.RECORDS.p) }
  public static func endCATCOLLECTION(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createCATCOLLECTION(
    _ fbb: inout FlatBufferBuilder,
    RECORDSVectorOffset RECORDS: Offset = Offset()
  ) -> Offset {
    let __start = CATCOLLECTION.startCATCOLLECTION(&fbb)
    CATCOLLECTION.addVectorOf(RECORDS: RECORDS, &fbb)
    return CATCOLLECTION.endCATCOLLECTION(&fbb, start: __start)
  }

  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    var _v = try verifier.visitTable(at: position)
    try _v.visit(field: VTOFFSET.RECORDS.p, fieldName: "RECORDS", required: false, type: ForwardOffset<Vector<ForwardOffset<CAT>, CAT>>.self)
    _v.finish()
  }
}
