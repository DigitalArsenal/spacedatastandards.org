...
public struct CryptoKey: FlatBufferObject, Verifiable {
  ...
  public static var id: String { "$UPM" } 
  ...
  public var ADDRESS_TYPE: Int32 { let o = _accessor.offset(VTOFFSET.ADDRESS_TYPE.v); return o == 0 ? 0 : _accessor.readBuffer(of: Int32.self, at: o) }
  ...
  public static func add(ADDRESS_TYPE: Int32, _ fbb: inout FlatBufferBuilder) { fbb.add(element: ADDRESS_TYPE, def: 0, at: VTOFFSET.ADDRESS_TYPE.p) }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.ADDRESS_TYPE.p, fieldName: "ADDRESS_TYPE", required: false, type: Int32.self)
    _v.finish()
  }
}
...
public struct UPM: FlatBufferObject, Verifiable {
  ...
  public static var id: String { "$UPM" } 
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: UPM.id, addPrefix: prefix) }
  private init(_ t: Table) { _accessor = t }
  public init(_ bb: ByteBuffer, o: Int32) { _accessor = Table(bb: bb, position: o) }
  ...
  private enum VTOFFSET: VOffset {
    ...
    case JOB_TITLE = 26
    case AFFILIATION = 28
    case HAS_OCCUPATION = 30
    case FAMILY_NAME = 32
    case GIVEN_NAME = 34
    case ADDITIONAL_NAME = 36
    case HONORIFIC_PREFIX = 38
    case HONORIFIC_SUFFIX = 40
    var v: Int32 { Int32(self.rawValue) }
    var p: VOffset { self.rawValue }
  }
  ...
  public var AFFILIATION: Organization? { let o = _accessor.offset(VTOFFSET.AFFILIATION.v); return o == 0 ? nil : Organization(_accessor.bb, o: _accessor.indirect(o + _accessor.postion)) }
  ...
  public static func startUPM(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 19) }
  public static func add(NAME: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: NAME, at: VTOFFSET.NAME.p) }
  ...
  public static func add(AFFILIATION: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: AFFILIATION, at: VTOFFSET.AFFILIATION.p) }
  ...
  public static func endUPM(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createUPM(
    _ fbb: inout FlatBufferBuilder,
    NAMEOffset NAME: Offset = Offset(),
    ...
    AFFILIATIONOffset AFFILIATION: Offset = Offset(),
    ...
    let __start = UPM.startUPM(&fbb)
    UPM.add(NAME: NAME, &fbb)
    UPM.add(ALTERNATE_NAME: ALTERNATE_NAME, &fbb)
    UPM.add(DESCRIPTION: DESCRIPTION, &fbb)
    UPM.add(IMAGE: IMAGE, &fbb)
    UPM.add(SAME_AS: SAME_AS, &fbb)
    UPM.add(URL: URL, &fbb)
    UPM.add(TELEPHONE: TELEPHONE, &fbb)
    UPM.add(EMAIL: EMAIL, &fbb)
    UPM.addVectorOf(KEY: KEY, &fbb)
    UPM.addVectorOf(CONTACT_POINT: CONTACT_POINT, &fbb)
    UPM.add(ADDRESS: ADDRESS, &fbb)
    UPM.add(JOB_TITLE: JOB_TITLE, &fbb)
    UPM.add(AFFILIATION: AFFILIATION, &fbb)
    UPM.add(HAS_OCCUPATION: HAS_OCCUPATION, &fbb)
    UPM.add(FAMILY_NAME: FAMILY_NAME, &fbb)
    UPM.add(GIVEN_NAME: GIVEN_NAME, &fbb)
    UPM.add(ADDITIONAL_NAME: ADDITIONAL_NAME, &fbb)
    UPM.add(HONORIFIC_PREFIX: HONORIFIC_PREFIX, &fbb)
    UPM.add(HONORIFIC_SUFFIX: HONORIFIC_SUFFIX, &fbb)
    return UPM.endUPM(&fbb, start: __start)
  }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.AFFILIATION.p, fieldName: "AFFILIATION", required: false, type: ForwardOffset<Organization>.self)
...
public struct UPMCOLLECTION: FlatBufferObject, Verifiable {
  ...
  public static var id: String { "$UPM" } 
  public static func finish(_ fbb: inout FlatBufferBuilder, end: Offset, prefix: Bool = false) { fbb.finish(offset: end, fileId: UPMCOLLECTION.id, addPrefix: prefix) }
  private init(_ t: Table) { _accessor = t }
  public init(_ bb: ByteBuffer, o: Int32) { _accessor = Table(bb: bb, position: o) }
  ...
  public func RECORDS(at index: Int32) -> UPM? { let o = _accessor.offset(VTOFFSET.RECORDS.v); return o == 0 ? nil : UPM(_accessor.bb, o: _accessor.indirect(_accessor.vector(at: o) + index * 4)) }
  public static func startUPMCOLLECTION(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 1) }
  public static func addVectorOf(RECORDS: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: RECORDS, at: VTOFFSET.RECORDS.p) }
  public static func endUPMCOLLECTION(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createUPMCOLLECTION(
    _ fbb: inout FlatBufferBuilder,
    RECORDSVectorOffset RECORDS: Offset = Offset()
  ) -> Offset {
    let __start = UPMCOLLECTION.startUPMCOLLECTION(&fbb)
    UPMCOLLECTION.addVectorOf(RECORDS: RECORDS, &fbb)
    return UPMCOLLECTION.endUPMCOLLECTION(&fbb, start: __start)
  }

  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    var _v = try verifier.visitTable(at: position)
    try _v.visit(field: VTOFFSET.RECORDS.p, fieldName: "RECORDS", required: false, type: ForwardOffset<Vector<ForwardOffset<UPM>, UPM>>.self)
    _v.finish()
  }
}
