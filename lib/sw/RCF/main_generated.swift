...
public enum rcfPduType: Int8, FlatbuffersVectorInitializable, Enum, Verifiable {
...
public struct RCF: FlatBufferTable, FlatbuffersVectorInitializable, Verifiable {
  ...
  private struct VT {
    ...
    static let SPACECRAFT_ID: VOffset = 16
    static let VIRTUAL_CHANNEL_ID: VOffset = 18
    static let DATA: VOffset = 20
  }

  ///  PDU type
  public var PDU_TYPE: rcfPduType { let o = _accessor.offset(VT.PDU_TYPE); return o == 0 ? .bindInvocation : rcfPduType(rawValue: _accessor.readBuffer(of: Int8.self, at: o)) ?? .bindInvocation }
  ...
  public static func add(PDU_TYPE: rcfPduType, _ fbb: inout FlatBufferBuilder) { fbb.add(element: PDU_TYPE.rawValue, def: 0, at: VT.PDU_TYPE) }
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VT.PDU_TYPE, fieldName: "PDU_TYPE", required: false, type: rcfPduType.self)
