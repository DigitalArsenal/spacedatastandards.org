...
public struct opmStateVector: FlatBufferObject, Verifiable {
  ...
  public static func startopmStateVector(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 7) }
  public static func add(EPOCH: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: EPOCH, at: VTOFFSET.EPOCH.p) }
  ...
  public static func endopmStateVector(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createopmStateVector(
    _ fbb: inout FlatBufferBuilder,
    EPOCHOffset EPOCH: Offset = Offset(),
    X: Double = 0.0,
    Y: Double = 0.0,
    ...
    let __start = opmStateVector.startopmStateVector(&fbb)
    opmStateVector.add(EPOCH: EPOCH, &fbb)
    opmStateVector.add(X: X, &fbb)
    opmStateVector.add(Y: Y, &fbb)
    opmStateVector.add(Z: Z, &fbb)
    opmStateVector.add(X_DOT: X_DOT, &fbb)
    opmStateVector.add(Y_DOT: Y_DOT, &fbb)
    opmStateVector.add(Z_DOT: Z_DOT, &fbb)
    return opmStateVector.endopmStateVector(&fbb, start: __start)
  }
...
public struct opmCovarianceMatrixLine: FlatBufferObject, Verifiable {
  ...
  public static func startopmCovarianceMatrixLine(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 4) }
  ...
  public static func endopmCovarianceMatrixLine(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createopmCovarianceMatrixLine(
    _ fbb: inout FlatBufferBuilder,
    CX_X: Double = 0.0,
    CY_X: Double = 0.0,
    CZ_X: Double = 0.0,
    ...
    let __start = opmCovarianceMatrixLine.startopmCovarianceMatrixLine(&fbb)
    opmCovarianceMatrixLine.add(CX_X: CX_X, &fbb)
    opmCovarianceMatrixLine.add(CY_X: CY_X, &fbb)
    opmCovarianceMatrixLine.add(CZ_X: CZ_X, &fbb)
    opmCovarianceMatrixLine.add(CX_DOT_X: CX_DOT_X, &fbb)
    return opmCovarianceMatrixLine.endopmCovarianceMatrixLine(&fbb, start: __start)
  }
...
public struct opmAtmosphericModelData: FlatBufferObject, Verifiable {
  ...
  public static func startopmAtmosphericModelData(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 8) }
  ...
  public static func endopmAtmosphericModelData(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createopmAtmosphericModelData(
    _ fbb: inout FlatBufferBuilder,
    ...
    let __start = opmAtmosphericModelData.startopmAtmosphericModelData(&fbb)
    opmAtmosphericModelData.add(ATMOSPHERIC_MODEL: ATMOSPHERIC_MODEL, &fbb)
    opmAtmosphericModelData.add(GEOPOTENTIAL_MODEL: GEOPOTENTIAL_MODEL, &fbb)
    opmAtmosphericModelData.add(LUNAR_SOLAR_PERTURBATION: LUNAR_SOLAR_PERTURBATION, &fbb)
    opmAtmosphericModelData.add(LUNAR_PERTURBATION_MODEL: LUNAR_PERTURBATION_MODEL, &fbb)
    opmAtmosphericModelData.add(SOLAR_PERTURBATION_MODEL: SOLAR_PERTURBATION_MODEL, &fbb)
    opmAtmosphericModelData.add(SOLAR_RADIATION_PRESSURE: SOLAR_RADIATION_PRESSURE, &fbb)
    opmAtmosphericModelData.add(SRP_MODEL: SRP_MODEL, &fbb)
    opmAtmosphericModelData.add(RESONANCE_MODEL: RESONANCE_MODEL, &fbb)
    return opmAtmosphericModelData.endopmAtmosphericModelData(&fbb, start: __start)
  }
...
public struct OPM: FlatBufferObject, Verifiable {
  ...
  public var STATE_VECTOR: opmStateVector? { let o = _accessor.offset(VTOFFSET.STATE_VECTOR.v); return o == 0 ? nil : opmStateVector(_accessor.bb, o: _accessor.indirect(o + _accessor.postion)) }
  ...
  public var ATMOSPHERIC_MODEL_DATA: opmAtmosphericModelData? { let o = _accessor.offset(VTOFFSET.ATMOSPHERIC_MODEL_DATA.v); return o == 0 ? nil : opmAtmosphericModelData(_accessor.bb, o: _accessor.indirect(o + _accessor.postion)) }
  ...
  public func COVARIANCE_MATRIX(at index: Int32) -> opmCovarianceMatrixLine? { let o = _accessor.offset(VTOFFSET.COVARIANCE_MATRIX.v); return o == 0 ? nil : opmCovarianceMatrixLine(_accessor.bb, o: _accessor.indirect(_accessor.vector(at: o) + index * 4)) }
  ...
  public static func startOPM(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 39) }
  ...
  public static func createOPM(
    ...
    OPM.add(CCSDS_OMM_VERS: CCSDS_OMM_VERS, &fbb)
    ...
    OPM.add(STATE_VECTOR: STATE_VECTOR, &fbb)
    OPM.add(KEPLERIAN_ELEMENTS: KEPLERIAN_ELEMENTS, &fbb)
    OPM.add(EQUINOCTIAL_ELEMENTS: EQUINOCTIAL_ELEMENTS, &fbb)
    OPM.add(GM: GM, &fbb)
    OPM.add(ATMOSPHERIC_MODEL_DATA: ATMOSPHERIC_MODEL_DATA, &fbb)
    OPM.add(PROPAGATOR_SETTINGS: PROPAGATOR_SETTINGS, &fbb)
    OPM.addVectorOf(COVARIANCE_MATRIX: COVARIANCE_MATRIX, &fbb)
    OPM.add(UVW_SIGMAS: UVW_SIGMAS, &fbb)
    ...
    OPM.add(SRP: SRP, &fbb)
    OPM.add(CLASSIFICATION_TYPE: CLASSIFICATION_TYPE, &fbb)
    OPM.add(NORAD_CAT_ID: NORAD_CAT_ID, &fbb)
    OPM.add(ELEMENT_SET_NO: ELEMENT_SET_NO, &fbb)
    OPM.add(REV_AT_EPOCH: REV_AT_EPOCH, &fbb)
    OPM.add(BSTAR: BSTAR, &fbb)
    OPM.add(MEAN_MOTION_DOT: MEAN_MOTION_DOT, &fbb)
    OPM.add(MEAN_MOTION_DDOT: MEAN_MOTION_DDOT, &fbb)
    OPM.add(COV_REFERENCE_FRAME: COV_REFERENCE_FRAME, &fbb)
    OPM.add(CX_X: CX_X, &fbb)
    OPM.add(CY_X: CY_X, &fbb)
    OPM.add(CZ_X: CZ_X, &fbb)
    OPM.add(CX_DOT_X: CX_DOT_X, &fbb)
    OPM.add(USER_DEFINED_BIP_0044_TYPE: USER_DEFINED_BIP_0044_TYPE, &fbb)
    OPM.add(USER_DEFINED_OBJECT_DESIGNATOR: USER_DEFINED_OBJECT_DESIGNATOR, &fbb)
    OPM.add(USER_DEFINED_EARTH_MODEL: USER_DEFINED_EARTH_MODEL, &fbb)
    OPM.add(USER_DEFINED_EPOCH_TIMESTAMP: USER_DEFINED_EPOCH_TIMESTAMP, &fbb)
    OPM.add(USER_DEFINED_MICROSECONDS: USER_DEFINED_MICROSECONDS, &fbb)
  ...
  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    ...
    try _v.visit(field: VTOFFSET.STATE_VECTOR.p, fieldName: "STATE_VECTOR", required: false, type: ForwardOffset<opmStateVector>.self)
    ...
    try _v.visit(field: VTOFFSET.ATMOSPHERIC_MODEL_DATA.p, fieldName: "ATMOSPHERIC_MODEL_DATA", required: false, type: ForwardOffset<opmAtmosphericModelData>.self)
    ...
    try _v.visit(field: VTOFFSET.COVARIANCE_MATRIX.p, fieldName: "COVARIANCE_MATRIX", required: false, type: ForwardOffset<Vector<ForwardOffset<opmCovarianceMatrixLine>, opmCovarianceMatrixLine>>.self)
...
public struct OPM_COLLECTION: FlatBufferObject, Verifiable {
  ...
  public func RECORDS(at index: Int32) -> OPM? { let o = _accessor.offset(VTOFFSET.RECORDS.v); return o == 0 ? nil : OPM(_accessor.bb, o: _accessor.indirect(_accessor.vector(at: o) + index * 4)) }
  public static func startOPM_COLLECTION(_ fbb: inout FlatBufferBuilder) -> UOffset { fbb.startTable(with: 1) }
  public static func addVectorOf(RECORDS: Offset, _ fbb: inout FlatBufferBuilder) { fbb.add(offset: RECORDS, at: VTOFFSET.RECORDS.p) }
  public static func endOPM_COLLECTION(_ fbb: inout FlatBufferBuilder, start: UOffset) -> Offset { let end = Offset(offset: fbb.endTable(at: start)); return end }
  public static func createOPM_COLLECTION(
    _ fbb: inout FlatBufferBuilder,
    RECORDSVectorOffset RECORDS: Offset = Offset()
  ) -> Offset {
    let __start = OPM_COLLECTION.startOPM_COLLECTION(&fbb)
    OPM_COLLECTION.addVectorOf(RECORDS: RECORDS, &fbb)
    return OPM_COLLECTION.endOPM_COLLECTION(&fbb, start: __start)
  }

  public static func verify<T>(_ verifier: inout Verifier, at position: Int, of type: T.Type) throws where T: Verifiable {
    var _v = try verifier.visitTable(at: position)
    try _v.visit(field: VTOFFSET.RECORDS.p, fieldName: "RECORDS", required: false, type: ForwardOffset<Vector<ForwardOffset<OPM>, OPM>>.self)
    _v.finish()
  }
}
