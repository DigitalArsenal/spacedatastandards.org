...
enum seoDataType {
  ...
  final int value;
  const seoDataType(this.value);

  factory seoDataType.fromValue(int value) {
    switch (value) {
      case 0: return seoDataType.PARTICLE_COUNT;
      case 1: return seoDataType.MAGNETIC_FIELD;
      case 2: return seoDataType.RADIATION_DOSE;
      case 3: return seoDataType.PLASMA_DENSITY;
      case 4: return seoDataType.ENERGETIC_PARTICLE;
      case 5: return seoDataType.SOLAR_WIND;
      case 6: return seoDataType.CHARGING;
      case 7: return seoDataType.UNKNOWN;
...
enum seoParticleType {
  ...
  final int value;
  const seoParticleType(this.value);

  factory seoParticleType.fromValue(int value) {
    switch (value) {
      case 0: return seoParticleType.PROTON;
      case 1: return seoParticleType.ELECTRON;
      case 2: return seoParticleType.ALPHA;
      case 3: return seoParticleType.HEAVY_ION;
      case 4: return seoParticleType.NEUTRON;
      case 5: return seoParticleType.COSMIC_RAY;
      case 6: return seoParticleType.MIXED;
      default: throw StateError('Invalid value $value for bit flag enum');
    }
  }
...
enum seoObservatoryType {
  ...
  final int value;
  const seoObservatoryType(this.value);

  factory seoObservatoryType.fromValue(int value) {
    switch (value) {
      case 0: return seoObservatoryType.GROUND;
      case 1: return seoObservatoryType.LEO;
      case 2: return seoObservatoryType.GEO;
      case 3: return seoObservatoryType.L1;
      case 4: return seoObservatoryType.L2;
      case 5: return seoObservatoryType.INTERPLANETARY;
      case 6: return seoObservatoryType.SOLAR;
      default: throw StateError('Invalid value $value for bit flag enum');
    }
  }
...
class SEO {
  ...
  String? get genSystem => GEN_SYSTEM;
  ...
  List<double>? get senPos => SEN_POS;
  ...
  @override
  String toString() {
    return 'SEO{ID: ${ID}, msgType: ${msgType}, genSystem: ${genSystem}, externalId: ${externalId}, dataType: ${dataType}, genTime: ${genTime}, FORECAST: ${FORECAST}, DERIVED: ${DERIVED}, satNo: ${satNo}, origObjectId: ${origObjectId}, idSensor: ${idSensor}, origSensorId: ${origSensorId}, observatoryType: ${observatoryType}, observatoryName: ${observatoryName}, observatoryNotes: ${observatoryNotes}, instrumentType: ${instrumentType}, LAT: ${LAT}, LON: ${LON}, ALT: ${ALT}, senReferenceFrame: ${senReferenceFrame}, senPos: ${senPos}, senVel: ${senVel}, measType: ${measType}, particleType: ${particleType}, senEnergyLevel: ${senEnergyLevel}, obSetId: ${obSetId}, obTime: ${obTime}, VALUES: ${VALUES}, UNCERTAINTIES: ${UNCERTAINTIES}, UNITS: ${UNITS}, QUALITY: ${QUALITY}, DESCRIPTION: ${DESCRIPTION}, DESCRIPTOR: ${DESCRIPTOR}, srcTyps: ${srcTyps}, srcIds: ${srcIds}}';
  }
}
...
class SEOObjectBuilder extends fb.ObjectBuilder {
  ...
  SEOObjectBuilder({
    ...
    seoObservatoryType? observatoryType,
    ...
    List<String>? srcIds,
      ...
      : _ID = ID,
        ...
        _OBSERVATORY_TYPE = observatoryType ?? OBSERVATORY_TYPE,
        _OBSERVATORY_NAME = observatoryName ?? OBSERVATORY_NAME,
        _OBSERVATORY_NOTES = observatoryNotes ?? OBSERVATORY_NOTES,
        _INSTRUMENT_TYPE = instrumentType ?? INSTRUMENT_TYPE,
        _LAT = LAT,
        _LON = LON,
        _ALT = ALT,
        _SEN_REFERENCE_FRAME = senReferenceFrame ?? SEN_REFERENCE_FRAME,
        _SEN_POS = senPos ?? SEN_POS,
        _SEN_VEL = senVel ?? SEN_VEL,
        _MEAS_TYPE = measType ?? MEAS_TYPE,
        _PARTICLE_TYPE = particleType ?? PARTICLE_TYPE,
        _SEN_ENERGY_LEVEL = senEnergyLevel ?? SEN_ENERGY_LEVEL,
        _OB_SET_ID = obSetId ?? OB_SET_ID,
