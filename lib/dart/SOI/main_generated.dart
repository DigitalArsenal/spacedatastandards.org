...
enum soiCollectionMode {
  ...
  final int value;
  const soiCollectionMode(this.value);

  factory soiCollectionMode.fromValue(int value) {
    switch (value) {
      case 0: return soiCollectionMode.SIDEREAL;
      case 1: return soiCollectionMode.RATE_TRACK;
      case 2: return soiCollectionMode.STARE;
      case 3: return soiCollectionMode.SEARCH;
      case 4: return soiCollectionMode.SURVEY;
      case 5: return soiCollectionMode.TASKED;
...
enum soiObsType {
  ...
  final int value;
  const soiObsType(this.value);

  factory soiObsType.fromValue(int value) {
    switch (value) {
      case 0: return soiObsType.OPTICAL;
      case 1: return soiObsType.RADAR;
      case 2: return soiObsType.COMBINED;
      default: throw StateError('Invalid value $value for bit flag enum');
    }
  }
...
enum soiCalibrationType {
  ...
  final int value;
  const soiCalibrationType(this.value);

  factory soiCalibrationType.fromValue(int value) {
    switch (value) {
      case 0: return soiCalibrationType.PHOTOMETRIC;
      case 1: return soiCalibrationType.ASTROMETRIC;
      case 2: return soiCalibrationType.RADIOMETRIC;
      case 3: return soiCalibrationType.POLARIMETRIC;
      case 4: return soiCalibrationType.TEMPORAL;
      case 5: return soiCalibrationType.NONE;
      default: throw StateError('Invalid value $value for bit flag enum');
    }
  }
...
class SOI {
  ...
  String? get sensorAsId => SENSOR_AS_ID;
  ...
  double get losDeclinationStart => LOS_DECLINATION_START;
  ...
  double get losDeclinationEnd => LOS_DECLINATION_END;
  ...
  List<String>? get spectralFilters => SPECTRAL_FILTERS;
  ...
  bool get periodicityChangeDetected => PERIODICITY_CHANGE_DETECTED;
  ...
  bool get brightnessVarianceChangeDetected => BRIGHTNESS_VARIANCE_CHANGE_DETECTED;
  ...
  bool get solarPhaseAngleBrightnessChangeDetected => SOLAR_PHASE_ANGLE_BRIGHTNESS_CHANGE_DETECTED;
  ///  Change confidence assessment
  String? get CHANGE_CONF => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 110);
  String? get changeConf => CHANGE_CONF;
  ...
  String? get collectionDensityConf => COLLECTION_DENSITY_CONF;
  ...
  String? get periodicitySamplingConf => PERIODICITY_SAMPLING_CONF;
  ...
  String? get periodicityDetectionConf => PERIODICITY_DETECTION_CONF;
  ...
  List<String>? get opticalSoiobservationList => OPTICAL_SOIOBSERVATION_LIST;
  ...
  List<String>? get radarSoiobservationList => RADAR_SOIOBSERVATION_LIST;

  @override
  String toString() {
    return 'SOI{ID: ${ID}, msgCreateDate: ${msgCreateDate}, idSensor: ${idSensor}, origSensorId: ${origSensorId}, sensorAsId: ${sensorAsId}, satNo: ${satNo}, origObjectId: ${origObjectId}, satelliteName: ${satelliteName}, UCT: ${UCT}, SENLAT: ${SENLAT}, SENLON: ${SENLON}, SENALT: ${SENALT}, SENX: ${SENX}, SENY: ${SENY}, SENZ: ${SENZ}, SENVELX: ${SENVELX}, SENVELY: ${SENVELY}, SENVELZ: ${SENVELZ}, senReferenceFrame: ${senReferenceFrame}, obsType: ${obsType}, collectionMode: ${collectionMode}, startTime: ${startTime}, endTime: ${endTime}, numObs: ${numObs}, referenceFrame: ${referenceFrame}, polarAngleStart: ${polarAngleStart}, polarAngleEnd: ${polarAngleEnd}, losDeclinationStart: ${losDeclinationStart}, losDeclinationEnd: ${losDeclinationEnd}, pointingAngleAzStart: ${pointingAngleAzStart}, pointingAngleAzEnd: ${pointingAngleAzEnd}, pointingAngleElStart: ${pointingAngleElStart}, pointingAngleElEnd: ${pointingAngleElEnd}, pixelArrayWidth: ${pixelArrayWidth}, pixelArrayHeight: ${pixelArrayHeight}, numSpectralFilters: ${numSpectralFilters}, spectralFilters: ${spectralFilters}, GAIN: ${GAIN}, binningHoriz: ${binningHoriz}, binningVert: ${binningVert}, solarMag: ${solarMag}, pixelMin: ${pixelMin}, pixelMax: ${pixelMax}, softwareVersion: ${softwareVersion}, starCatName: ${starCatName}, corrQuality: ${corrQuality}, calibrationType: ${calibrationType}, validCalibrations: ${validCalibrations}, percentSatThreshold: ${percentSatThreshold}, changeDetected: ${changeDetected}, periodicityChangeDetected: ${periodicityChangeDetected}, brightnessVarianceChangeDetected: ${brightnessVarianceChangeDetected}, solarPhaseAngleBrightnessChangeDetected: ${solarPhaseAngleBrightnessChangeDetected}, changeConf: ${changeConf}, collectionDensityConf: ${collectionDensityConf}, periodicitySamplingConf: ${periodicitySamplingConf}, periodicityDetectionConf: ${periodicityDetectionConf}, collectionId: ${collectionId}, CALIBRATIONS: ${CALIBRATIONS}, TAGS: ${TAGS}, transactionId: ${transactionId}, opticalSoiobservationList: ${opticalSoiobservationList}, radarSoiobservationList: ${radarSoiobservationList}}';
  }
}
...
class SOIObjectBuilder extends fb.ObjectBuilder {
  ...
  SOIObjectBuilder({
    ...
    soiCollectionMode? collectionMode,
    String? START_TIME,
    String? startTime,
    String? END_TIME,
    String? endTime,
    ...
    soiCalibrationType? calibrationType,
    ...
    List<String>? radarSoiobservationList,
      ...
      : _ID = ID,
        ...
        _SENSOR_AS_ID = sensorAsId ?? SENSOR_AS_ID,
        ...
        _POLAR_ANGLE_START = polarAngleStart ?? POLAR_ANGLE_START,
        _POLAR_ANGLE_END = polarAngleEnd ?? POLAR_ANGLE_END,
        _LOS_DECLINATION_START = losDeclinationStart ?? LOS_DECLINATION_START,
        _LOS_DECLINATION_END = losDeclinationEnd ?? LOS_DECLINATION_END,
        _POINTING_ANGLE_AZ_START = pointingAngleAzStart ?? POINTING_ANGLE_AZ_START,
        _POINTING_ANGLE_AZ_END = pointingAngleAzEnd ?? POINTING_ANGLE_AZ_END,
        _POINTING_ANGLE_EL_START = pointingAngleElStart ?? POINTING_ANGLE_EL_START,
        _POINTING_ANGLE_EL_END = pointingAngleElEnd ?? POINTING_ANGLE_EL_END,
        _PIXEL_ARRAY_WIDTH = pixelArrayWidth ?? PIXEL_ARRAY_WIDTH,
        _PIXEL_ARRAY_HEIGHT = pixelArrayHeight ?? PIXEL_ARRAY_HEIGHT,
        _NUM_SPECTRAL_FILTERS = numSpectralFilters ?? NUM_SPECTRAL_FILTERS,
        _SPECTRAL_FILTERS = spectralFilters ?? SPECTRAL_FILTERS,
        _GAIN = GAIN,
        _BINNING_HORIZ = binningHoriz ?? BINNING_HORIZ,
        _BINNING_VERT = binningVert ?? BINNING_VERT,
        _SOLAR_MAG = solarMag ?? SOLAR_MAG,
        _PIXEL_MIN = pixelMin ?? PIXEL_MIN,
        _PIXEL_MAX = pixelMax ?? PIXEL_MAX,
        _SOFTWARE_VERSION = softwareVersion ?? SOFTWARE_VERSION,
        _STAR_CAT_NAME = starCatName ?? STAR_CAT_NAME,
        _CORR_QUALITY = corrQuality ?? CORR_QUALITY,
        _CALIBRATION_TYPE = calibrationType ?? CALIBRATION_TYPE,
        _VALID_CALIBRATIONS = validCalibrations ?? VALID_CALIBRATIONS,
        _PERCENT_SAT_THRESHOLD = percentSatThreshold ?? PERCENT_SAT_THRESHOLD,
        _CHANGE_DETECTED = changeDetected ?? CHANGE_DETECTED,
        _PERIODICITY_CHANGE_DETECTED = periodicityChangeDetected ?? PERIODICITY_CHANGE_DETECTED,
        _BRIGHTNESS_VARIANCE_CHANGE_DETECTED = brightnessVarianceChangeDetected ?? BRIGHTNESS_VARIANCE_CHANGE_DETECTED,
        _SOLAR_PHASE_ANGLE_BRIGHTNESS_CHANGE_DETECTED = solarPhaseAngleBrightnessChangeDetected ?? SOLAR_PHASE_ANGLE_BRIGHTNESS_CHANGE_DETECTED,
        _CHANGE_CONF = changeConf ?? CHANGE_CONF,
        _COLLECTION_DENSITY_CONF = collectionDensityConf ?? COLLECTION_DENSITY_CONF,
        _PERIODICITY_SAMPLING_CONF = periodicitySamplingConf ?? PERIODICITY_SAMPLING_CONF,
        _PERIODICITY_DETECTION_CONF = periodicityDetectionConf ?? PERIODICITY_DETECTION_CONF,
        _COLLECTION_ID = collectionId ?? COLLECTION_ID,
        _CALIBRATIONS = CALIBRATIONS,
        _TAGS = TAGS,
        _TRANSACTION_ID = transactionId ?? TRANSACTION_ID,
        _OPTICAL_SOIOBSERVATION_LIST = opticalSoiobservationList ?? OPTICAL_SOIOBSERVATION_LIST,
        _RADAR_SOIOBSERVATION_LIST = radarSoiobservationList ?? RADAR_SOIOBSERVATION_LIST;
