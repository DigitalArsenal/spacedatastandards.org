...
enum imageFormat {
  ...
  factory imageFormat.fromValue(int value) {
    switch (value) {
      case 0: return imageFormat.FITS;
      case 1: return imageFormat.JPEG;
      case 2: return imageFormat.PNG;
      case 3: return imageFormat.TIFF;
      case 4: return imageFormat.RAW;
      case 5: return imageFormat.NITF;
      case 6: return imageFormat.GEOTIFF;
      case 7: return imageFormat.OTHER;
...
class GDI {
  ...
  String? get imageTime => IMAGE_TIME;
  ///  Image filename
  ...
  @override
  String toString() {
    return 'GDI{ID: ${ID}, idSensor: ${idSensor}, origSensorId: ${origSensorId}, imageTime: ${imageTime}, FILENAME: ${FILENAME}, FORMAT: ${FORMAT}, FILESIZE: ${FILESIZE}, checksumValue: ${checksumValue}, regionGeoJson: ${regionGeoJson}, regionText: ${regionText}, REGION: ${REGION}, regionType: ${regionType}, regionNdims: ${regionNdims}, regionSrid: ${regionSrid}, subjectId: ${subjectId}, NAME: ${NAME}, transactionId: ${transactionId}, TAGS: ${TAGS}, KEYWORDS: ${KEYWORDS}, NOTES: ${NOTES}}';
  }
}
  ...
  GDIObjectBuilder({
    ...
    String? NOTES,
      ...
      : _ID = ID,
        ...
        _IMAGE_TIME = imageTime ?? IMAGE_TIME,
        _FILENAME = FILENAME,
        _FORMAT = FORMAT,
        _FILESIZE = FILESIZE,
        _CHECKSUM_VALUE = checksumValue ?? CHECKSUM_VALUE,
        _REGION_GEO_JSON = regionGeoJson ?? REGION_GEO_JSON,
        _REGION_TEXT = regionText ?? REGION_TEXT,
        _REGION = REGION,
        _REGION_TYPE = regionType ?? REGION_TYPE,
        _REGION_NDIMS = regionNdims ?? REGION_NDIMS,
        _REGION_SRID = regionSrid ?? REGION_SRID,
