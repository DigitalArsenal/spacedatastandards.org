...
class EME {
  ...
  List<int>? get encryptedBlob => ENCRYPTED_BLOB;
  ...
  String? get ephemeralPublicKey => EPHEMERAL_PUBLIC_KEY;
  ...
  String? get publicKeyIdentifier => PUBLIC_KEY_IDENTIFIER;
  ...
  String? get cipherSuite => CIPHER_SUITE;
  ...
  String? get kdfParameters => KDF_PARAMETERS;
  ...
  String? get encryptionAlgorithmParameters => ENCRYPTION_ALGORITHM_PARAMETERS;

  @override
  String toString() {
    return 'EME{encryptedBlob: ${encryptedBlob}, ephemeralPublicKey: ${ephemeralPublicKey}, MAC: ${MAC}, nonceStart: ${nonceStart}, TAG: ${TAG}, IV: ${IV}, SALT: ${SALT}, publicKeyIdentifier: ${publicKeyIdentifier}, cipherSuite: ${cipherSuite}, kdfParameters: ${kdfParameters}, encryptionAlgorithmParameters: ${encryptionAlgorithmParameters}}';
  }
}
...
class EMEObjectBuilder extends fb.ObjectBuilder {
  ...
  EMEObjectBuilder({
    ...
    String? encryptionAlgorithmParameters,
  })
      : _ENCRYPTED_BLOB = encryptedBlob ?? ENCRYPTED_BLOB,
        ...
        _IV = IV,
        _SALT = SALT,
        _PUBLIC_KEY_IDENTIFIER = publicKeyIdentifier ?? PUBLIC_KEY_IDENTIFIER,
        _CIPHER_SUITE = cipherSuite ?? CIPHER_SUITE,
        _KDF_PARAMETERS = kdfParameters ?? KDF_PARAMETERS,
        _ENCRYPTION_ALGORITHM_PARAMETERS = encryptionAlgorithmParameters ?? ENCRYPTION_ALGORITHM_PARAMETERS;
