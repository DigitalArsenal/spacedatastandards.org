...
enum mtiStandard {
  ...
  final int value;
  const mtiStandard(this.value);

  factory mtiStandard.fromValue(int value) {
    switch (value) {
      case 0: return mtiStandard.STANAG_4607;
      case 1: return mtiStandard.STANAG_4545;
      case 2: return mtiStandard.CUSTOM;
      case 3: return mtiStandard.UNKNOWN;
...
class MTI {
  ...
  List<String>? get platformLocs => PLATFORM_LOCS;
  ...
  List<String>? get jobRequests => JOB_REQUESTS;

  @override
  String toString() {
    return 'MTI{ID: ${ID}, STANDARD: ${STANDARD}, P3: ${P3}, P6: ${P6}, P7: ${P7}, P8: ${P8}, P9: ${P9}, P10: ${P10}, MISSIONS: ${MISSIONS}, DWELLS: ${DWELLS}, HRRS: ${HRRS}, jobDefs: ${jobDefs}, freeTexts: ${freeTexts}, platformLocs: ${platformLocs}, jobRequests: ${jobRequests}}';
  }
}
  ...
  MTIObjectBuilder({
    ...
    List<String>? jobRequests,
      ...
      : _ID = ID,
        ...
        _DWELLS = DWELLS,
        _HRRS = HRRS,
        _JOB_DEFS = jobDefs ?? JOB_DEFS,
        _FREE_TEXTS = freeTexts ?? FREE_TEXTS,
        _PLATFORM_LOCS = platformLocs ?? PLATFORM_LOCS,
        _JOB_REQUESTS = jobRequests ?? JOB_REQUESTS;
