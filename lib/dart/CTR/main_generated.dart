...
class CTRObjectBuilder extends fb.ObjectBuilder {
  ...
  CTRObjectBuilder({
    ...
    String? internetCctld,
    String? COMMENT,
  })
      : _ID = ID,
        _NAME = NAME,
        _GENC_CODE = gencCode ?? GENC_CODE,
        _ALPHA_2_CODE = alpha2Code ?? ALPHA_2_CODE,
        _ALPHA_3_CODE = alpha3Code ?? ALPHA_3_CODE,
        _STANAG_CODE = stanagCode ?? STANAG_CODE,
        _INTERNET_CCTLD = internetCctld ?? INTERNET_CCTLD,
        _COMMENT = COMMENT;
