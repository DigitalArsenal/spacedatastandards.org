...
class OSM {
  ...
  String? get passStart => PASS_START;
  ///  Duration of the observation pass in seconds
  int get PASS_DURATION => const fb.Int32Reader().vTableGet(_bc, _bcOffset, 14, 0);
  int get passDuration => PASS_DURATION;

  @override
  String toString() {
    return 'OSM{isStable: ${isStable}, numObs: ${numObs}, objectId: ${objectId}, idSensor: ${idSensor}, passStart: ${passStart}, passDuration: ${passDuration}}';
  }
}
...
class OSMObjectBuilder extends fb.ObjectBuilder {
  ...
  OSMObjectBuilder({
    ...
    int? passDuration,
      ...
      : _IS_STABLE = isStable ?? IS_STABLE,
        _NUM_OBS = numObs ?? NUM_OBS,
        _OBJECT_ID = objectId ?? OBJECT_ID,
        _ID_SENSOR = idSensor ?? ID_SENSOR,
        _PASS_START = passStart ?? PASS_START,
        _PASS_DURATION = passDuration ?? PASS_DURATION;
