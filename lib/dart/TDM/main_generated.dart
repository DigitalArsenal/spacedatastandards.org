...
class TDM {
  ...
  String? get MODE => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 46);
  ///  First path in TDM -  CCSDS 503.0-B-1, Page D-9
  int get PATH_1 => const fb.Uint16Reader().vTableGet(_bc, _bcOffset, 48, 0);
  ///  Second path in TDM (if applicable) -  CCSDS 503.0-B-1, Page D-9
  int get PATH_2 => const fb.Uint16Reader().vTableGet(_bc, _bcOffset, 50, 0);
  ///  Transmit band -  CCSDS 503.0-B-1, Page D-9
  String? get TRANSMIT_BAND => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 52);
  ///  Receive band -  CCSDS 503.0-B-1, Page D-9
  String? get RECEIVE_BAND => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 54);
  ///  Integration interval -  CCSDS 503.0-B-1, Page D-9
  double get INTEGRATION_INTERVAL => const fb.Float32Reader().vTableGet(_bc, _bcOffset, 56, 0.0);
  ///  Integration reference -  CCSDS 503.0-B-1, Page D-9
  String? get INTEGRATION_REF => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 58);
  ///  Receive delay for second participant -  CCSDS 503.0-B-1, Page D-9
  double get RECEIVE_DELAY_2 => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 60, 0.0);
  ///  Receive delay for third participant -  CCSDS 503.0-B-1, Page D-9
  double get RECEIVE_DELAY_3 => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 62, 0.0);
  ///  Data quality -  CCSDS 503.0-B-1, Page D-9
  String? get DATA_QUALITY => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 64);
  ///  End of metadata section -  CCSDS 503.0-B-1, Page D-9
  String? get META_STOP => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 66);
  ///  Start of data section -  CCSDS 503.0-B-1, Page D-9
  String? get DATA_START => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 68);
  ///  Transmit frequency for first participant -  CCSDS 503.0-B-1, Page D-9
  double get TRANSMIT_FREQ_1 => const fb.Float64Reader().vTableGet(_bc, _bcOffset, 70, 0.0);
  ///  Receive frequency -  CCSDS 503.0-B-1, Page D-9
  List<double>? get RECEIVE_FREQ => const fb.ListReader<double>(fb.Float64Reader()).vTableGetNullable(_bc, _bcOffset, 72);
  ///  End of data section -  CCSDS 503.0-B-1, Page D-9
  String? get DATA_STOP => const fb.StringReader().vTableGetNullable(_bc, _bcOffset, 74);
...
class TDMBuilder {
  ...
  int addPath1(int? PATH_1) {
    fbBuilder.addUint16(22, PATH_1);
    return fbBuilder.offset;
  }
  int addPath2(int? PATH_2) {
    fbBuilder.addUint16(23, PATH_2);
    return fbBuilder.offset;
  }
  ...
  int addIntegrationInterval(double? INTEGRATION_INTERVAL) {
    fbBuilder.addFloat32(26, INTEGRATION_INTERVAL);
    return fbBuilder.offset;
  }
  ...
  int addReceiveDelay2(double? RECEIVE_DELAY_2) {
    fbBuilder.addFloat64(28, RECEIVE_DELAY_2);
    return fbBuilder.offset;
  }
  int addReceiveDelay3(double? RECEIVE_DELAY_3) {
    fbBuilder.addFloat64(29, RECEIVE_DELAY_3);
    return fbBuilder.offset;
  }
  ...
  int addTransmitFreq1(double? TRANSMIT_FREQ_1) {
    fbBuilder.addFloat64(33, TRANSMIT_FREQ_1);
    return fbBuilder.offset;
  }
  ...
  int addAngleUncertainty1(double? ANGLE_UNCERTAINTY_1) {
    fbBuilder.addFloat32(40, ANGLE_UNCERTAINTY_1);
    return fbBuilder.offset;
  }
  int addAngleUncertainty2(double? ANGLE_UNCERTAINTY_2) {
    fbBuilder.addFloat32(41, ANGLE_UNCERTAINTY_2);
    return fbBuilder.offset;
  }
  int addRangeRate(double? RANGE_RATE) {
    fbBuilder.addFloat64(42, RANGE_RATE);
    return fbBuilder.offset;
  }
  int addRangeUncertainty(double? RANGE_UNCERTAINTY) {
    fbBuilder.addFloat64(43, RANGE_UNCERTAINTY);
    return fbBuilder.offset;
  }
  ...
  int addRangeModulus(double? RANGE_MODULUS) {
    fbBuilder.addFloat64(45, RANGE_MODULUS);
    return fbBuilder.offset;
  }
  int addCorrectionAngle1(double? CORRECTION_ANGLE_1) {
    fbBuilder.addFloat32(46, CORRECTION_ANGLE_1);
    return fbBuilder.offset;
  }
  int addCorrectionAngle2(double? CORRECTION_ANGLE_2) {
    fbBuilder.addFloat32(47, CORRECTION_ANGLE_2);
    return fbBuilder.offset;
  }
...
class TDMObjectBuilder extends fb.ObjectBuilder {
  ...
  int finish(fb.Builder fbBuilder) {
    ...
    fbBuilder.addOffset(21, MODEOffset);
    fbBuilder.addUint16(22, _PATH_1);
    fbBuilder.addUint16(23, _PATH_2);
    fbBuilder.addOffset(24, TRANSMIT_BANDOffset);
    fbBuilder.addOffset(25, RECEIVE_BANDOffset);
    fbBuilder.addFloat32(26, _INTEGRATION_INTERVAL);
    fbBuilder.addOffset(27, INTEGRATION_REFOffset);
    fbBuilder.addFloat64(28, _RECEIVE_DELAY_2);
    fbBuilder.addFloat64(29, _RECEIVE_DELAY_3);
    fbBuilder.addOffset(30, DATA_QUALITYOffset);
    fbBuilder.addOffset(31, META_STOPOffset);
    fbBuilder.addOffset(32, DATA_STARTOffset);
    fbBuilder.addFloat64(33, _TRANSMIT_FREQ_1);
    fbBuilder.addOffset(34, RECEIVE_FREQOffset);
    fbBuilder.addOffset(35, DATA_STOPOffset);
    fbBuilder.addOffset(36, TIMETAG_REFOffset);
    fbBuilder.addOffset(37, ANGLE_TYPEOffset);
    fbBuilder.addOffset(38, ANGLE_1Offset);
    fbBuilder.addOffset(39, ANGLE_2Offset);
    fbBuilder.addFloat32(40, _ANGLE_UNCERTAINTY_1);
    fbBuilder.addFloat32(41, _ANGLE_UNCERTAINTY_2);
    fbBuilder.addFloat64(42, _RANGE_RATE);
    fbBuilder.addFloat64(43, _RANGE_UNCERTAINTY);
    fbBuilder.addOffset(44, RANGE_MODEOffset);
    fbBuilder.addFloat64(45, _RANGE_MODULUS);
    fbBuilder.addFloat32(46, _CORRECTION_ANGLE_1);
    fbBuilder.addFloat32(47, _CORRECTION_ANGLE_2);
    fbBuilder.addOffset(48, CORRECTIONS_APPLIEDOffset);
    fbBuilder.addOffset(49, TROPO_DRYOffset);
    fbBuilder.addOffset(50, TROPO_WETOffset);
    fbBuilder.addOffset(51, STECOffset);
    fbBuilder.addOffset(52, PRESSUREOffset);
    fbBuilder.addOffset(53, RHUMIDITYOffset);
    fbBuilder.addOffset(54, TEMPERATUREOffset);
    fbBuilder.addOffset(55, CLOCK_BIASOffset);
    fbBuilder.addOffset(56, CLOCK_DRIFTOffset);
    return fbBuilder.endTable();
  }
