...
enum launchDetectionType {
  ...
  final int value;
  const launchDetectionType(this.value);

  factory launchDetectionType.fromValue(int value) {
    switch (value) {
      case 0: return launchDetectionType.IR_DETECT;
      case 1: return launchDetectionType.RADAR_DETECT;
      case 2: return launchDetectionType.OPTICAL_DETECT;
      case 3: return launchDetectionType.ELINT_DETECT;
      case 4: return launchDetectionType.COMBINED;
      case 5: return launchDetectionType.UNKNOWN;
...
class LND {
  ...
  launchDetectionType get detectionType => DETECTION_TYPE;
  ...
  String? get trajectoryType => TRAJECTORY_TYPE;
  ...
  @override
  String toString() {
    return 'LND{ID: ${ID}, eventId: ${eventId}, detectionType: ${detectionType}, messageType: ${messageType}, launchTime: ${launchTime}, launchLatitude: ${launchLatitude}, launchLongitude: ${launchLongitude}, launchAzimuth: ${launchAzimuth}, RAAN: ${RAAN}, INCLINATION: ${INCLINATION}, observationTime: ${observationTime}, observationLatitude: ${observationLatitude}, observationLongitude: ${observationLongitude}, observationAltitude: ${observationAltitude}, stereoFlag: ${stereoFlag}, highZenithAzimuth: ${highZenithAzimuth}, sequenceNumber: ${sequenceNumber}, launchSiteId: ${launchSiteId}, launchVehicle: ${launchVehicle}, trajectoryType: ${trajectoryType}, CONFIDENCE: ${CONFIDENCE}, DESCRIPTOR: ${DESCRIPTOR}, TAGS: ${TAGS}}';
  }
}
...
class LNDObjectBuilder extends fb.ObjectBuilder {
  ...
  LNDObjectBuilder({
    ...
    launchDetectionType? detectionType,
    String? MESSAGE_TYPE,
    String? messageType,
    String? LAUNCH_TIME,
    String? launchTime,
    ...
    List<String>? TAGS,
      ...
      : _ID = ID,
        ...
        _LAUNCH_LATITUDE = launchLatitude ?? LAUNCH_LATITUDE,
        _LAUNCH_LONGITUDE = launchLongitude ?? LAUNCH_LONGITUDE,
        _LAUNCH_AZIMUTH = launchAzimuth ?? LAUNCH_AZIMUTH,
        _RAAN = RAAN,
        _INCLINATION = INCLINATION,
        _OBSERVATION_TIME = observationTime ?? OBSERVATION_TIME,
        _OBSERVATION_LATITUDE = observationLatitude ?? OBSERVATION_LATITUDE,
        _OBSERVATION_LONGITUDE = observationLongitude ?? OBSERVATION_LONGITUDE,
        _OBSERVATION_ALTITUDE = observationAltitude ?? OBSERVATION_ALTITUDE,
        _STEREO_FLAG = stereoFlag ?? STEREO_FLAG,
        _HIGH_ZENITH_AZIMUTH = highZenithAzimuth ?? HIGH_ZENITH_AZIMUTH,
        _SEQUENCE_NUMBER = sequenceNumber ?? SEQUENCE_NUMBER,
        _LAUNCH_SITE_ID = launchSiteId ?? LAUNCH_SITE_ID,
        _LAUNCH_VEHICLE = launchVehicle ?? LAUNCH_VEHICLE,
        _TRAJECTORY_TYPE = trajectoryType ?? TRAJECTORY_TYPE,
