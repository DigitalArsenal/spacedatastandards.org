...
enum ScoreType {
  ...
  factory ScoreType.fromValue(int value) {
    switch (value) {
      case 0: return ScoreType.OUTLIER;
...
class Score {
  ...
  String? get noradCatId => NORAD_CAT_ID;
  ...
  @override
  String toString() {
    return 'Score{noradCatId: ${noradCatId}, TYPE: ${TYPE}, TAG: ${TAG}, SCORE: ${SCORE}}';
  }
}
...
class HYP {
  ...
  List<String>? get rowIndicators => ROW_INDICATORS;
  ...
  List<String>? get colIndicators => COL_INDICATORS;
  ...
  String? get analysisMethod => ANALYSIS_METHOD;
  ...
  @override
  String toString() {
    return 'HYP{catIds: ${catIds}, sitIds: ${sitIds}, NAME: ${NAME}, CATEGORY: ${CATEGORY}, rowIndicators: ${rowIndicators}, colIndicators: ${colIndicators}, MATRIX: ${MATRIX}, SCORE: ${SCORE}, analysisMethod: ${analysisMethod}, eventStartTime: ${eventStartTime}, eventEndTime: ${eventEndTime}}';
  }
}
...
class HYPObjectBuilder extends fb.ObjectBuilder {
  ...
  HYPObjectBuilder({
    ...
    List<String>? rowIndicators,
    List<String>? COL_INDICATORS,
    List<String>? colIndicators,
    List<bool>? MATRIX,
    ...
    String? eventEndTime,
      ...
      : _CAT_IDS = catIds ?? CAT_IDS,
        _SIT_IDS = sitIds ?? SIT_IDS,
        _NAME = NAME,
        _CATEGORY = CATEGORY,
        _ROW_INDICATORS = rowIndicators ?? ROW_INDICATORS,
        _COL_INDICATORS = colIndicators ?? COL_INDICATORS,
        _MATRIX = MATRIX,
        _SCORE = SCORE,
        _ANALYSIS_METHOD = analysisMethod ?? ANALYSIS_METHOD,
