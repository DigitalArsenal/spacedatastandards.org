...
class CRM {
  ...
  int get taskCategory => TASK_CATEGORY;
  ...
  bool get uctFollowUp => UCT_FOLLOW_UP;
  ...
  String? get taskGroup => TASK_GROUP;
  ...
  double get targetSize => TARGET_SIZE;
  ...
  double get visMagMin => VIS_MAG_MIN;
  ...
  double get visMagMax => VIS_MAG_MAX;
  ...
  String? get spectralModel => SPECTRAL_MODEL;
  ...
  double get frameRate => FRAME_RATE;
  ...
  String? get srchPattern => SRCH_PATTERN;
  ...
  String? get idManifold => ID_MANIFOLD;
  ...
  double get extentRange => EXTENT_RANGE;
  ...
  double get orientAngle => ORIENT_ANGLE;
  ...
  CRMObjectBuilder({
    ...
    String? dataMode,
      ...
      : _ID = ID,
        ...
        _TYPE = TYPE,
        _ID_PLAN = idPlan ?? ID_PLAN,
        _PLAN_INDEX = planIndex ?? PLAN_INDEX,
        _TASK_ID = taskId ?? TASK_ID,
        _DWELL_ID = dwellId ?? DWELL_ID,
        ...
        _PRIORITY = PRIORITY,
        _TASK_CATEGORY = taskCategory ?? TASK_CATEGORY,
        _SUFFIX = SUFFIX,
        _UCT_FOLLOW_UP = uctFollowUp ?? UCT_FOLLOW_UP,
        ...
        _TASK_GROUP = taskGroup ?? TASK_GROUP,
        _IRON = IRON,
        _ORBIT_REGIME = orbitRegime ?? ORBIT_REGIME,
        _TARGET_SIZE = targetSize ?? TARGET_SIZE,
        ...
        _VIS_MAG_MIN = visMagMin ?? VIS_MAG_MIN,
        _VIS_MAG = visMag ?? VIS_MAG,
        _VIS_MAG_MAX = visMagMax ?? VIS_MAG_MAX,
        _SPECTRAL_MODEL = spectralModel ?? SPECTRAL_MODEL,
        _REFLECTANCE = REFLECTANCE,
        _IRRADIANCE = IRRADIANCE,
        _NUM_FRAMES = numFrames ?? NUM_FRAMES,
        _FRAME_RATE = frameRate ?? FRAME_RATE,
        _INTEGRATION_TIME = integrationTime ?? INTEGRATION_TIME,
        _NUM_TRACKS = numTracks ?? NUM_TRACKS,
        _NUM_OBS = numObs ?? NUM_OBS,
        _DURATION = DURATION,
        _SRCH_PATTERN = srchPattern ?? SRCH_PATTERN,
        _SCENARIO = SCENARIO,
        _ID_ELSET = idElset ?? ID_ELSET,
        _ID_MANIFOLD = idManifold ?? ID_MANIFOLD,
        ...
        _EL = EL,
        _RANGE = RANGE,
        _EXTENT_AZ = extentAz ?? EXTENT_AZ,
        _EXTENT_EL = extentEl ?? EXTENT_EL,
        _EXTENT_RANGE = extentRange ?? EXTENT_RANGE,
        _LAT = LAT,
        _LON = LON,
        _ALT = ALT,
        _STOP_LAT = stopLat ?? STOP_LAT,
        _STOP_LON = stopLon ?? STOP_LON,
        _STOP_ALT = stopAlt ?? STOP_ALT,
        _SRCH_INC = srchInc ?? SRCH_INC,
        _X_ANGLE = xAngle ?? X_ANGLE,
        _Y_ANGLE = yAngle ?? Y_ANGLE,
        _ORIENT_ANGLE = orientAngle ?? ORIENT_ANGLE,
        _CUSTOMER = CUSTOMER,
        _NOTES = NOTES,
        _SOURCE = SOURCE,
        _ORIGIN = ORIGIN,
