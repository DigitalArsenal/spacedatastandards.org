...
func (rcv *keplerianElements) PERIAPSIS_RADIUS() float64 {
...
func (rcv *keplerianElements) PeriapsisRadius() float64 {
	return rcv.PERIAPSIS_RADIUS()
}

func (rcv *keplerianElements) MutatePERIAPSIS_RADIUS(n float64) bool {
	return rcv._tab.MutateFloat64Slot(18, n)
}

func (rcv *keplerianElements) MutatePeriapsisRadius(n float64) bool {
	return rcv.MutatePERIAPSIS_RADIUS(n)
}
...
func keplerianElementsAddPERIAPSIS_RADIUS(builder *flatbuffers.Builder, PERIAPSIS_RADIUS float64) {
	builder.PrependFloat64Slot(7, PERIAPSIS_RADIUS, 0.0)
}
func keplerianElementsAddPeriapsisRadius(builder *flatbuffers.Builder, PERIAPSIS_RADIUS float64) {
