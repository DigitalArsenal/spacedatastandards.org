...
func GetRootAsDetail(buf []byte, offset flatbuffers.UOffsetT) *Detail {
...
func GetSizePrefixedRootAsDetail(buf []byte, offset flatbuffers.UOffsetT) *Detail {
...
func (rcv *Detail) Init(buf []byte, i flatbuffers.UOffsetT) {
	rcv._tab.Bytes = buf
	rcv._tab.Pos = i
}

func (rcv *Detail) Table() flatbuffers.Table {
	return rcv._tab
}
...
func (rcv *Detail) MULTIFORMAT_ADDRESS() []byte {
