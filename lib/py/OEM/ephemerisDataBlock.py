...
def ephemerisDataBlockAddREF_FRAME(builder, REF_FRAME): builder.PrependInt8Slot(4, REF_FRAME, 0)
def AddREF_FRAME(builder, REF_FRAME):
    return ephemerisDataBlockAddREF_FRAME(builder, REF_FRAME)
def ephemerisDataBlockAddREF_FRAME_EPOCH(builder, REF_FRAME_EPOCH): builder.PrependUOffsetTRelativeSlot(5, flatbuffers.number_types.UOffsetTFlags.py_type(REF_FRAME_EPOCH), 0)
def AddREF_FRAME_EPOCH(builder, REF_FRAME_EPOCH):
    return ephemerisDataBlockAddREF_FRAME_EPOCH(builder, REF_FRAME_EPOCH)
...
class ephemerisDataBlockT(object):
    ...
    def _UnPack(self, ephemerisDataBlock):
        ...
        self.REF_FRAME = ephemerisDataBlock.REF_FRAME()
        self.REF_FRAME_EPOCH = ephemerisDataBlock.REF_FRAME_EPOCH()
    ...
    def Pack(self, builder):
        ...
        ephemerisDataBlockAddREF_FRAME(builder, self.REF_FRAME)
        if self.REF_FRAME_EPOCH is not None:
            ephemerisDataBlockAddREF_FRAME_EPOCH(builder, REF_FRAME_EPOCH)
