...
def RecordTypeCreator(unionType, table):
    ...
    if unionType == RecordType.FSB:
        import FSB
        return FSB.FSBT.InitFromBuf(table.Bytes, table.Pos)
    ...
    if unionType == RecordType.OPP:
        import OPP
        return OPP.OPPT.InitFromBuf(table.Bytes, table.Pos)
    if unionType == RecordType.IQC:
        import IQC
        return IQC.IQCT.InitFromBuf(table.Bytes, table.Pos)
    if unionType == RecordType.CNP:
        import CNP
        return CNP.CNPT.InitFromBuf(table.Bytes, table.Pos)
    if unionType == RecordType.CMR:
        import CMR
        return CMR.CMRT.InitFromBuf(table.Bytes, table.Pos)
    if unionType == RecordType.TBS:
        import TBS
        return TBS.TBST.InitFromBuf(table.Bytes, table.Pos)
    ...
    if unionType == RecordType.TRS:
        import TRS
        return TRS.TRST.InitFromBuf(table.Bytes, table.Pos)
    ...
    if unionType == RecordType.AVL:
        import AVL
        return AVL.AVLT.InitFromBuf(table.Bytes, table.Pos)
    if unionType == RecordType.TFN:
        import TFN
        return TFN.TFNT.InitFromBuf(table.Bytes, table.Pos)
    if unionType == RecordType.TMS:
        import TMS
        return TMS.TMST.InitFromBuf(table.Bytes, table.Pos)
    ...
    if unionType == RecordType.STX:
        import STX
        return STX.STXT.InitFromBuf(table.Bytes, table.Pos)
    ...
    if unionType == RecordType.ACT:
        import ACT
        return ACT.ACTT.InitFromBuf(table.Bytes, table.Pos)
    if unionType == RecordType.AGR:
        import AGR
        return AGR.AGRT.InitFromBuf(table.Bytes, table.Pos)
    if unionType == RecordType.NDS:
        import NDS
        return NDS.NDST.InitFromBuf(table.Bytes, table.Pos)
    if unionType == RecordType.NST:
        import NST
        return NST.NSTT.InitFromBuf(table.Bytes, table.Pos)
    if unionType == RecordType.QRP:
        import QRP
        return QRP.QRPT.InitFromBuf(table.Bytes, table.Pos)
    if unionType == RecordType.TCT:
        import TCT
        return TCT.TCTT.InitFromBuf(table.Bytes, table.Pos)
    ...
    if unionType == RecordType.GCT:
        import GCT
        return GCT.GCTT.InitFromBuf(table.Bytes, table.Pos)
    ...
    if unionType == RecordType.SKQ:
        import SKQ
        return SKQ.SKQT.InitFromBuf(table.Bytes, table.Pos)
