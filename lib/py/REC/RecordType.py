...
def RecordTypeCreator(unionType, table):
    ...
    if unionType == RecordType.AGF:
        import AGF
        return AGF.AGFT.InitFromBuf(table.Bytes, table.Pos)
    if unionType == RecordType.AGV:
        import AGV
        return AGV.AGVT.InitFromBuf(table.Bytes, table.Pos)
    return None
