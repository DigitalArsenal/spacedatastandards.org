...
def CTRCOLLECTIONStart(builder): builder.StartObject(1)
def Start(builder):
    return CTRCOLLECTIONStart(builder)
def CTRCOLLECTIONAddRECORDS(builder, RECORDS): builder.PrependUOffsetTRelativeSlot(0, flatbuffers.number_types.UOffsetTFlags.py_type(RECORDS), 0)
def AddRECORDS(builder, RECORDS):
    return CTRCOLLECTIONAddRECORDS(builder, RECORDS)
def CTRCOLLECTIONStartRECORDSVector(builder, numElems): return builder.StartVector(4, numElems, 4)
def StartRECORDSVector(builder, numElems):
    return CTRCOLLECTIONStartRECORDSVector(builder, numElems)
def CTRCOLLECTIONEnd(builder): return builder.EndObject()
def End(builder):
