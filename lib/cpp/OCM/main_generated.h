...
struct OCM FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    ...
    VT_METADATA = 6,
    VT_TRAJ_TYPE = 8,
    VT_TRAJ_TYPE_DESCRIPTION = 10,
    VT_STATE_STEP_SIZE = 12,
    VT_STATE_VECTOR_SIZE = 14,
    VT_STATE_DATA = 16,
    VT_COVARIANCE_DATA = 18,
    VT_POLYNOMIAL_POSITION_RECORDS = 20,
    VT_POLYNOMIAL_OE_RECORDS = 22,
    VT_PHYSICAL_PROPERTIES = 24,
    VT_MANEUVER_DATA = 26,
    VT_PERTURBATIONS = 28,
  ...
  trajectoryType TRAJ_TYPE() const {
    return static_cast<trajectoryType>(GetField<int8_t>(VT_TRAJ_TYPE, 0));
  }
  ...
  /// See PPE schema for record structure and evaluation procedure.
  const ::flatbuffers::Vector<::flatbuffers::Offset<PPEOrbitalElementRecord>> *POLYNOMIAL_OE_RECORDS() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<PPEOrbitalElementRecord>> *>(VT_POLYNOMIAL_OE_RECORDS);
  }
  ...
  bool Verify(::flatbuffers::VerifierTemplate<B> &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<int8_t>(verifier, VT_TRAJ_TYPE, 1) &&
           VerifyOffset(verifier, VT_TRAJ_TYPE_DESCRIPTION) &&
           verifier.VerifyString(TRAJ_TYPE_DESCRIPTION()) &&
           ...
           VerifyOffset(verifier, VT_POLYNOMIAL_OE_RECORDS) &&
           verifier.VerifyVector(POLYNOMIAL_OE_RECORDS()) &&
           verifier.VerifyVectorOfTables(POLYNOMIAL_OE_RECORDS()) &&
...
struct OCMBuilder {
  ...
  void add_TRAJ_TYPE(trajectoryType TRAJ_TYPE) {
    fbb_.AddElement<int8_t>(OCM::VT_TRAJ_TYPE, static_cast<int8_t>(TRAJ_TYPE), 0);
  }
  void add_TRAJ_TYPE_DESCRIPTION(::flatbuffers::Offset<::flatbuffers::String> TRAJ_TYPE_DESCRIPTION) {
    fbb_.AddOffset(OCM::VT_TRAJ_TYPE_DESCRIPTION, TRAJ_TYPE_DESCRIPTION);
  }
  ...
  void add_POLYNOMIAL_POSITION_RECORDS(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<PPEPositionRecord>>> POLYNOMIAL_POSITION_RECORDS) {
    fbb_.AddOffset(OCM::VT_POLYNOMIAL_POSITION_RECORDS, POLYNOMIAL_POSITION_RECORDS);
  }
  void add_POLYNOMIAL_OE_RECORDS(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<PPEOrbitalElementRecord>>> POLYNOMIAL_OE_RECORDS) {
    fbb_.AddOffset(OCM::VT_POLYNOMIAL_OE_RECORDS, POLYNOMIAL_OE_RECORDS);
  }
...
inline ::flatbuffers::Offset<OCM> CreateOCM(
    ...
    trajectoryType TRAJ_TYPE = trajectoryType_CARTESIAN_PV,
    ::flatbuffers::Offset<::flatbuffers::String> TRAJ_TYPE_DESCRIPTION = 0,
    ...
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<PPEOrbitalElementRecord>>> POLYNOMIAL_OE_RECORDS = 0,
  ...
  builder_.add_POLYNOMIAL_OE_RECORDS(POLYNOMIAL_OE_RECORDS);
...
inline ::flatbuffers::Offset<OCM> CreateOCMDirect(
    ...
    ::flatbuffers::Offset<Metadata> METADATA = 0,
    trajectoryType TRAJ_TYPE = trajectoryType_CARTESIAN_PV,
    const char *TRAJ_TYPE_DESCRIPTION = nullptr,
    double STATE_STEP_SIZE = 0.0,
    uint8_t STATE_VECTOR_SIZE = 6,
    ...
    const std::vector<::flatbuffers::Offset<PPEOrbitalElementRecord>> *POLYNOMIAL_OE_RECORDS = nullptr,
    ::flatbuffers::Offset<PhysicalProperties> PHYSICAL_PROPERTIES = 0,
  ...
  return CreateOCM(
      ...
      METADATA,
      TRAJ_TYPE,
      TRAJ_TYPE_DESCRIPTION__,
      STATE_STEP_SIZE,
      STATE_VECTOR_SIZE,
      STATE_DATA__,
      COVARIANCE_DATA__,
      POLYNOMIAL_POSITION_RECORDS__,
      POLYNOMIAL_OE_RECORDS__,
      PHYSICAL_PROPERTIES,
      MANEUVER_DATA__,
      PERTURBATIONS,
      ORBIT_DETERMINATION,
...
inline bool VerifyOCMBuffer(
  ...
  return verifier.template VerifyBuffer<OCM>(OCMIdentifier());
}

template <bool B = false>
inline bool VerifySizePrefixedOCMBuffer(
    ::flatbuffers::VerifierTemplate<B> &verifier) {
  return verifier.template VerifySizePrefixedBuffer<OCM>(OCMIdentifier());
}
