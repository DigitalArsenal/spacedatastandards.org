...
enum ephemerisFormat : int8_t {
  /// Simplified General Perturbation Model
  ephemerisFormat_SGP = 0,
  /// Simplified General Perturbation Model 4
  ephemerisFormat_SGP4 = 1,
  /// Simplified Deep Space Perturbation Model 4
  ephemerisFormat_SDP4 = 2,
  /// Simplified General Perturbation Model 8
  ephemerisFormat_SGP8 = 3,
  /// Simplified Deep Space Perturbation Model 8
  ephemerisFormat_SDP8 = 4,
  ephemerisFormat_MIN = ephemerisFormat_SGP,
  ephemerisFormat_MAX = ephemerisFormat_SDP8
};

inline const ephemerisFormat (&EnumValuesephemerisFormat())[5] {
  static const ephemerisFormat values[] = {
    ephemerisFormat_SGP,
    ephemerisFormat_SGP4,
    ephemerisFormat_SDP4,
    ephemerisFormat_SGP8,
    ephemerisFormat_SDP8
  };
  return values;
}
...
inline const char *EnumNameephemerisFormat(ephemerisFormat e) {
  if (::flatbuffers::IsOutRange(e, ephemerisFormat_SGP, ephemerisFormat_SDP8)) return "";
...
inline ::flatbuffers::Offset<OMM> CreateOMM(
    ...
    ephemerisFormat EPHEMERIS_TYPE = ephemerisFormat_SGP4,
...
inline bool VerifyOMMBuffer(
  ...
  return verifier.template VerifyBuffer<OMM>(OMMIdentifier());
}

template <bool B = false>
inline bool VerifySizePrefixedOMMBuffer(
    ::flatbuffers::VerifierTemplate<B> &verifier) {
  return verifier.template VerifySizePrefixedBuffer<OMM>(OMMIdentifier());
}
