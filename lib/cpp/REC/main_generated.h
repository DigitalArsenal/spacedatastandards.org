...
enum RecordType : uint8_t {
  ...
  RecordType_MAX = RecordType_CLM
};

inline const RecordType (&EnumValuesRecordType())[247] {
...
inline const char * const *EnumNamesRecordType() {
  static const char * const names[248] = {
    "NONE",
    "ACL",
    "ACM",
    "ACR",
...
inline const char *EnumNameRecordType(RecordType e) {
  if (::flatbuffers::IsOutRange(e, RecordType_NONE, RecordType_CLM)) return "";
...
template<> struct RecordTypeTraits<ANI> {
  static const RecordType enum_value = RecordType_ANI;
};
...
template<> struct RecordTypeTraits<BUS> {
  static const RecordType enum_value = RecordType_BUS;
};

template<> struct RecordTypeTraits<CAQ> {
  static const RecordType enum_value = RecordType_CAQ;
};
...
template<> struct RecordTypeTraits<DSS> {
  static const RecordType enum_value = RecordType_DSS;
};
...
template<> struct RecordTypeTraits<ENC> {
  static const RecordType enum_value = RecordType_ENC;
};
...
template<> struct RecordTypeTraits<ESL> {
  static const RecordType enum_value = RecordType_ESL;
};

template<> struct RecordTypeTraits<ETM> {
  static const RecordType enum_value = RecordType_ETM;
};
...
template<> struct RecordTypeTraits<HFC> {
  static const RecordType enum_value = RecordType_HFC;
};
...
template<> struct RecordTypeTraits<ION> {
  static const RecordType enum_value = RecordType_ION;
};
...
template<> struct RecordTypeTraits<KMF> {
  static const RecordType enum_value = RecordType_KMF;
};
...
template<> struct RecordTypeTraits<KRF> {
  static const RecordType enum_value = RecordType_KRF;
};

template<> struct RecordTypeTraits<LAM> {
  static const RecordType enum_value = RecordType_LAM;
};
...
template<> struct RecordTypeTraits<LCF> {
  static const RecordType enum_value = RecordType_LCF;
};

template<> struct RecordTypeTraits<LCH> {
  static const RecordType enum_value = RecordType_LCH;
};
...
template<> struct RecordTypeTraits<LGR> {
  static const RecordType enum_value = RecordType_LGR;
};
...
template<> struct RecordTypeTraits<LMO> {
  static const RecordType enum_value = RecordType_LMO;
};

template<> struct RecordTypeTraits<LMR> {
  static const RecordType enum_value = RecordType_LMR;
};

template<> struct RecordTypeTraits<LMS> {
  static const RecordType enum_value = RecordType_LMS;
};
...
template<> struct RecordTypeTraits<LPF> {
  static const RecordType enum_value = RecordType_LPF;
};

template<> struct RecordTypeTraits<LWK> {
  static const RecordType enum_value = RecordType_LWK;
};

template<> struct RecordTypeTraits<MBL> {
  static const RecordType enum_value = RecordType_MBL;
};
...
template<> struct RecordTypeTraits<OOA> {
  static const RecordType enum_value = RecordType_OOA;
};

template<> struct RecordTypeTraits<OOB> {
  static const RecordType enum_value = RecordType_OOB;
};
...
template<> struct RecordTypeTraits<OOS> {
  static const RecordType enum_value = RecordType_OOS;
};

template<> struct RecordTypeTraits<OOT> {
  static const RecordType enum_value = RecordType_OOT;
};
...
template<> struct RecordTypeTraits<PPE> {
  static const RecordType enum_value = RecordType_PPE;
};
...
template<> struct RecordTypeTraits<PRW> {
  static const RecordType enum_value = RecordType_PRW;
};
...
template<> struct RecordTypeTraits<REM> {
  static const RecordType enum_value = RecordType_REM;
};
...
template<> struct RecordTypeTraits<SDF> {
  static const RecordType enum_value = RecordType_SDF;
};
...
template<> struct RecordTypeTraits<SDR> {
  static const RecordType enum_value = RecordType_SDR;
};

template<> struct RecordTypeTraits<SEN> {
  static const RecordType enum_value = RecordType_SEN;
};
...
template<> struct RecordTypeTraits<SHW> {
  static const RecordType enum_value = RecordType_SHW;
};
...
template<> struct RecordTypeTraits<SNW> {
  static const RecordType enum_value = RecordType_SNW;
};
...
template<> struct RecordTypeTraits<SRI> {
  static const RecordType enum_value = RecordType_SRI;
};
...
template<> struct RecordTypeTraits<TAB> {
  static const RecordType enum_value = RecordType_TAB;
};
...
template<> struct RecordTypeTraits<FSM> {
  static const RecordType enum_value = RecordType_FSM;
};
...
template<> struct RecordTypeTraits<ENT> {
  static const RecordType enum_value = RecordType_ENT;
};

template<> struct RecordTypeTraits<VAM> {
  static const RecordType enum_value = RecordType_VAM;
};

template<> struct RecordTypeTraits<APP> {
  static const RecordType enum_value = RecordType_APP;
};

template<> struct RecordTypeTraits<CMT> {
  static const RecordType enum_value = RecordType_CMT;
};

template<> struct RecordTypeTraits<SCX> {
  static const RecordType enum_value = RecordType_SCX;
};

template<> struct RecordTypeTraits<CVG> {
  static const RecordType enum_value = RecordType_CVG;
};

template<> struct RecordTypeTraits<PKB> {
  static const RecordType enum_value = RecordType_PKB;
};

template<> struct RecordTypeTraits<RPT> {
  static const RecordType enum_value = RecordType_RPT;
};

template<> struct RecordTypeTraits<STO> {
  static const RecordType enum_value = RecordType_STO;
};

template<> struct RecordTypeTraits<SUB> {
  static const RecordType enum_value = RecordType_SUB;
};

template<> struct RecordTypeTraits<WKS> {
  static const RecordType enum_value = RecordType_WKS;
};

template<> struct RecordTypeTraits<CPS> {
  static const RecordType enum_value = RecordType_CPS;
};

template<> struct RecordTypeTraits<FSB> {
  static const RecordType enum_value = RecordType_FSB;
};

template<> struct RecordTypeTraits<FSO> {
  static const RecordType enum_value = RecordType_FSO;
};

template<> struct RecordTypeTraits<GST> {
  static const RecordType enum_value = RecordType_GST;
};

template<> struct RecordTypeTraits<MDP> {
  static const RecordType enum_value = RecordType_MDP;
};

template<> struct RecordTypeTraits<MDS> {
  static const RecordType enum_value = RecordType_MDS;
};

template<> struct RecordTypeTraits<PNL> {
  static const RecordType enum_value = RecordType_PNL;
};
...
template<> struct RecordTypeTraits<SBM> {
  static const RecordType enum_value = RecordType_SBM;
};

template<> struct RecordTypeTraits<PMM> {
  static const RecordType enum_value = RecordType_PMM;
};

template<> struct RecordTypeTraits<OPP> {
  static const RecordType enum_value = RecordType_OPP;
};

template<> struct RecordTypeTraits<IQC> {
  static const RecordType enum_value = RecordType_IQC;
};

template<> struct RecordTypeTraits<CNP> {
  static const RecordType enum_value = RecordType_CNP;
};

template<> struct RecordTypeTraits<CMR> {
  static const RecordType enum_value = RecordType_CMR;
};

template<> struct RecordTypeTraits<TBS> {
  static const RecordType enum_value = RecordType_TBS;
};
...
template<> struct RecordTypeTraits<GNP> {
  static const RecordType enum_value = RecordType_GNP;
};
...
template<> struct RecordTypeTraits<IRM> {
  static const RecordType enum_value = RecordType_IRM;
};

template<> struct RecordTypeTraits<VCF> {
  static const RecordType enum_value = RecordType_VCF;
};

template<> struct RecordTypeTraits<STX> {
  static const RecordType enum_value = RecordType_STX;
};

template<> struct RecordTypeTraits<TXS> {
  static const RecordType enum_value = RecordType_TXS;
};

template<> struct RecordTypeTraits<BPF> {
  static const RecordType enum_value = RecordType_BPF;
};

template<> struct RecordTypeTraits<EVL> {
  static const RecordType enum_value = RecordType_EVL;
};
...
template<> struct RecordTypeTraits<CLM> {
  static const RecordType enum_value = RecordType_CLM;
};
...
struct Record FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const ANI *value_as_ANI() const {
    return value_type() == RecordType_ANI ? static_cast<const ANI *>(value()) : nullptr;
  }
  ...
  const CAQ *value_as_CAQ() const {
    return value_type() == RecordType_CAQ ? static_cast<const CAQ *>(value()) : nullptr;
  }
  ...
  const DSS *value_as_DSS() const {
    return value_type() == RecordType_DSS ? static_cast<const DSS *>(value()) : nullptr;
  }
  const EME *value_as_EME() const {
    return value_type() == RecordType_EME ? static_cast<const EME *>(value()) : nullptr;
  }
  const ENC *value_as_ENC() const {
    return value_type() == RecordType_ENC ? static_cast<const ENC *>(value()) : nullptr;
  }
  ...
  const ESL *value_as_ESL() const {
    return value_type() == RecordType_ESL ? static_cast<const ESL *>(value()) : nullptr;
  }
  const ETM *value_as_ETM() const {
    return value_type() == RecordType_ETM ? static_cast<const ETM *>(value()) : nullptr;
  }
  ...
  const HFC *value_as_HFC() const {
    return value_type() == RecordType_HFC ? static_cast<const HFC *>(value()) : nullptr;
  }
  ...
  const ION *value_as_ION() const {
    return value_type() == RecordType_ION ? static_cast<const ION *>(value()) : nullptr;
  }
  const IRO *value_as_IRO() const {
    return value_type() == RecordType_IRO ? static_cast<const IRO *>(value()) : nullptr;
  }
  const KMF *value_as_KMF() const {
    return value_type() == RecordType_KMF ? static_cast<const KMF *>(value()) : nullptr;
  }
  ...
  const KRF *value_as_KRF() const {
    return value_type() == RecordType_KRF ? static_cast<const KRF *>(value()) : nullptr;
  }
  const LAM *value_as_LAM() const {
    return value_type() == RecordType_LAM ? static_cast<const LAM *>(value()) : nullptr;
  }
  const LCC *value_as_LCC() const {
    return value_type() == RecordType_LCC ? static_cast<const LCC *>(value()) : nullptr;
  }
  const LCF *value_as_LCF() const {
    return value_type() == RecordType_LCF ? static_cast<const LCF *>(value()) : nullptr;
  }
  const LCH *value_as_LCH() const {
    return value_type() == RecordType_LCH ? static_cast<const LCH *>(value()) : nullptr;
  }
  const LDM *value_as_LDM() const {
    return value_type() == RecordType_LDM ? static_cast<const LDM *>(value()) : nullptr;
  }
  const LGR *value_as_LGR() const {
    return value_type() == RecordType_LGR ? static_cast<const LGR *>(value()) : nullptr;
  }
  ...
  const LMO *value_as_LMO() const {
    return value_type() == RecordType_LMO ? static_cast<const LMO *>(value()) : nullptr;
  }
  const LMR *value_as_LMR() const {
    return value_type() == RecordType_LMR ? static_cast<const LMR *>(value()) : nullptr;
  }
  const LMS *value_as_LMS() const {
    return value_type() == RecordType_LMS ? static_cast<const LMS *>(value()) : nullptr;
  }
  ...
  const LPF *value_as_LPF() const {
    return value_type() == RecordType_LPF ? static_cast<const LPF *>(value()) : nullptr;
  }
  const LWK *value_as_LWK() const {
    return value_type() == RecordType_LWK ? static_cast<const LWK *>(value()) : nullptr;
  }
  const MBL *value_as_MBL() const {
    return value_type() == RecordType_MBL ? static_cast<const MBL *>(value()) : nullptr;
  }
  ...
  const OOA *value_as_OOA() const {
    return value_type() == RecordType_OOA ? static_cast<const OOA *>(value()) : nullptr;
  }
  const OOB *value_as_OOB() const {
    return value_type() == RecordType_OOB ? static_cast<const OOB *>(value()) : nullptr;
  }
  ...
  const OOS *value_as_OOS() const {
    return value_type() == RecordType_OOS ? static_cast<const OOS *>(value()) : nullptr;
  }
  const OOT *value_as_OOT() const {
    return value_type() == RecordType_OOT ? static_cast<const OOT *>(value()) : nullptr;
  }
  ...
  const PPE *value_as_PPE() const {
    return value_type() == RecordType_PPE ? static_cast<const PPE *>(value()) : nullptr;
  }
  ...
  const REM *value_as_REM() const {
    return value_type() == RecordType_REM ? static_cast<const REM *>(value()) : nullptr;
  }
  ...
  const SDF *value_as_SDF() const {
    return value_type() == RecordType_SDF ? static_cast<const SDF *>(value()) : nullptr;
  }
  ...
  const SDR *value_as_SDR() const {
    return value_type() == RecordType_SDR ? static_cast<const SDR *>(value()) : nullptr;
  }
  const SEN *value_as_SEN() const {
    return value_type() == RecordType_SEN ? static_cast<const SEN *>(value()) : nullptr;
  }
  ...
  const SHW *value_as_SHW() const {
    return value_type() == RecordType_SHW ? static_cast<const SHW *>(value()) : nullptr;
  }
  ...
  const SNW *value_as_SNW() const {
    return value_type() == RecordType_SNW ? static_cast<const SNW *>(value()) : nullptr;
  }
  ...
  const SRI *value_as_SRI() const {
    return value_type() == RecordType_SRI ? static_cast<const SRI *>(value()) : nullptr;
  }
  ...
  const TAB *value_as_TAB() const {
    return value_type() == RecordType_TAB ? static_cast<const TAB *>(value()) : nullptr;
  }
  ...
  const FSM *value_as_FSM() const {
    return value_type() == RecordType_FSM ? static_cast<const FSM *>(value()) : nullptr;
  }
  ...
  const ENT *value_as_ENT() const {
    return value_type() == RecordType_ENT ? static_cast<const ENT *>(value()) : nullptr;
  }
  const VAM *value_as_VAM() const {
    return value_type() == RecordType_VAM ? static_cast<const VAM *>(value()) : nullptr;
  }
  const APP *value_as_APP() const {
    return value_type() == RecordType_APP ? static_cast<const APP *>(value()) : nullptr;
  }
  const CMT *value_as_CMT() const {
    return value_type() == RecordType_CMT ? static_cast<const CMT *>(value()) : nullptr;
  }
  const SCX *value_as_SCX() const {
    return value_type() == RecordType_SCX ? static_cast<const SCX *>(value()) : nullptr;
  }
  const CVG *value_as_CVG() const {
    return value_type() == RecordType_CVG ? static_cast<const CVG *>(value()) : nullptr;
  }
  const PKB *value_as_PKB() const {
    return value_type() == RecordType_PKB ? static_cast<const PKB *>(value()) : nullptr;
  }
  const RPT *value_as_RPT() const {
    return value_type() == RecordType_RPT ? static_cast<const RPT *>(value()) : nullptr;
  }
  const STO *value_as_STO() const {
    return value_type() == RecordType_STO ? static_cast<const STO *>(value()) : nullptr;
  }
  const SUB *value_as_SUB() const {
    return value_type() == RecordType_SUB ? static_cast<const SUB *>(value()) : nullptr;
  }
  const WKS *value_as_WKS() const {
    return value_type() == RecordType_WKS ? static_cast<const WKS *>(value()) : nullptr;
  }
  const CPS *value_as_CPS() const {
    return value_type() == RecordType_CPS ? static_cast<const CPS *>(value()) : nullptr;
  }
  const FSB *value_as_FSB() const {
    return value_type() == RecordType_FSB ? static_cast<const FSB *>(value()) : nullptr;
  }
  const FSO *value_as_FSO() const {
    return value_type() == RecordType_FSO ? static_cast<const FSO *>(value()) : nullptr;
  }
  const GST *value_as_GST() const {
    return value_type() == RecordType_GST ? static_cast<const GST *>(value()) : nullptr;
  }
  const MDP *value_as_MDP() const {
    return value_type() == RecordType_MDP ? static_cast<const MDP *>(value()) : nullptr;
  }
  const MDS *value_as_MDS() const {
    return value_type() == RecordType_MDS ? static_cast<const MDS *>(value()) : nullptr;
  }
  const PNL *value_as_PNL() const {
    return value_type() == RecordType_PNL ? static_cast<const PNL *>(value()) : nullptr;
  }
  ...
  const SBM *value_as_SBM() const {
    return value_type() == RecordType_SBM ? static_cast<const SBM *>(value()) : nullptr;
  }
  const PMM *value_as_PMM() const {
    return value_type() == RecordType_PMM ? static_cast<const PMM *>(value()) : nullptr;
  }
  const OPP *value_as_OPP() const {
    return value_type() == RecordType_OPP ? static_cast<const OPP *>(value()) : nullptr;
  }
  const IQC *value_as_IQC() const {
    return value_type() == RecordType_IQC ? static_cast<const IQC *>(value()) : nullptr;
  }
  const CNP *value_as_CNP() const {
    return value_type() == RecordType_CNP ? static_cast<const CNP *>(value()) : nullptr;
  }
  const CMR *value_as_CMR() const {
    return value_type() == RecordType_CMR ? static_cast<const CMR *>(value()) : nullptr;
  }
  const TBS *value_as_TBS() const {
    return value_type() == RecordType_TBS ? static_cast<const TBS *>(value()) : nullptr;
  }
  ...
  const GNP *value_as_GNP() const {
    return value_type() == RecordType_GNP ? static_cast<const GNP *>(value()) : nullptr;
  }
  ...
  const IRM *value_as_IRM() const {
    return value_type() == RecordType_IRM ? static_cast<const IRM *>(value()) : nullptr;
  }
  const VCF *value_as_VCF() const {
    return value_type() == RecordType_VCF ? static_cast<const VCF *>(value()) : nullptr;
  }
  const STX *value_as_STX() const {
    return value_type() == RecordType_STX ? static_cast<const STX *>(value()) : nullptr;
  }
  const TXS *value_as_TXS() const {
    return value_type() == RecordType_TXS ? static_cast<const TXS *>(value()) : nullptr;
  }
  const BPF *value_as_BPF() const {
    return value_type() == RecordType_BPF ? static_cast<const BPF *>(value()) : nullptr;
  }
  const EVL *value_as_EVL() const {
    return value_type() == RecordType_EVL ? static_cast<const EVL *>(value()) : nullptr;
  }
  ...
  const CLM *value_as_CLM() const {
    return value_type() == RecordType_CLM ? static_cast<const CLM *>(value()) : nullptr;
  }
...
template<> inline const ANI *Record::value_as<ANI>() const {
  return value_as_ANI();
}
...
template<> inline const ENC *Record::value_as<ENC>() const {
  return value_as_ENC();
}
...
template<> inline const ION *Record::value_as<ION>() const {
  return value_as_ION();
}
...
template<> inline const KMF *Record::value_as<KMF>() const {
  return value_as_KMF();
}
...
template<> inline const LCF *Record::value_as<LCF>() const {
  return value_as_LCF();
}

template<> inline const LCH *Record::value_as<LCH>() const {
  return value_as_LCH();
}
...
template<> inline const LGR *Record::value_as<LGR>() const {
  return value_as_LGR();
}
...
template<> inline const LPF *Record::value_as<LPF>() const {
  return value_as_LPF();
}
...
template<> inline const OOA *Record::value_as<OOA>() const {
  return value_as_OOA();
}

template<> inline const OOB *Record::value_as<OOB>() const {
  return value_as_OOB();
}
...
template<> inline const OOS *Record::value_as<OOS>() const {
  return value_as_OOS();
}

template<> inline const OOT *Record::value_as<OOT>() const {
  return value_as_OOT();
}
...
template<> inline const PPE *Record::value_as<PPE>() const {
  return value_as_PPE();
}
...
template <bool B>
inline bool VerifyRecordType(::flatbuffers::VerifierTemplate<B> &verifier, const void *obj, RecordType type) {
  switch (type) {
    ...
    case RecordType_ANI: {
      auto ptr = reinterpret_cast<const ANI *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case RecordType_AOF: {
    ...
    case RecordType_ENC: {
      auto ptr = reinterpret_cast<const ENC *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case RecordType_ENV: {
    ...
    case RecordType_ION: {
      auto ptr = reinterpret_cast<const ION *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case RecordType_IRO: {
    ...
    case RecordType_KMF: {
      auto ptr = reinterpret_cast<const KMF *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case RecordType_KML: {
    ...
    case RecordType_LCF: {
      auto ptr = reinterpret_cast<const LCF *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case RecordType_LCH: {
      auto ptr = reinterpret_cast<const LCH *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case RecordType_LDM: {
    ...
    case RecordType_LGR: {
      auto ptr = reinterpret_cast<const LGR *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case RecordType_LKS: {
    ...
    case RecordType_LPF: {
      auto ptr = reinterpret_cast<const LPF *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case RecordType_LWK: {
    ...
    case RecordType_OOA: {
      auto ptr = reinterpret_cast<const OOA *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case RecordType_OOB: {
      auto ptr = reinterpret_cast<const OOB *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case RecordType_OOD: {
    ...
    case RecordType_OOS: {
      auto ptr = reinterpret_cast<const OOS *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case RecordType_OOT: {
      auto ptr = reinterpret_cast<const OOT *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case RecordType_OPM: {
    ...
    case RecordType_PPE: {
      auto ptr = reinterpret_cast<const PPE *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case RecordType_PRG: {
    ...
    case RecordType_SEN: {
      auto ptr = reinterpret_cast<const SEN *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case RecordType_SEO: {
...
template <bool B>
inline bool VerifyRecordTypeVector(::flatbuffers::VerifierTemplate<B> &verifier, const ::flatbuffers::Vector<::flatbuffers::Offset<void>> *values, const ::flatbuffers::Vector<uint8_t> *types) {
...
inline bool VerifyRECBuffer(
  ...
  return verifier.template VerifyBuffer<REC>(RECIdentifier());
}

template <bool B = false>
inline bool VerifySizePrefixedRECBuffer(
    ::flatbuffers::VerifierTemplate<B> &verifier) {
  return verifier.template VerifySizePrefixedBuffer<REC>(RECIdentifier());
}
