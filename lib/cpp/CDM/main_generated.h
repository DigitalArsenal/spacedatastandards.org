...
enum covarianceAlgorithm : int8_t {
  covarianceAlgorithm_CALCULATED = 0,
  covarianceAlgorithm_DEFAULT = 1,
  covarianceAlgorithm_MIN = covarianceAlgorithm_CALCULATED,
  covarianceAlgorithm_MAX = covarianceAlgorithm_DEFAULT
};

inline const covarianceAlgorithm (&EnumValuescovarianceAlgorithm())[2] {
  static const covarianceAlgorithm values[] = {
    covarianceAlgorithm_CALCULATED,
    covarianceAlgorithm_DEFAULT
  };
  return values;
}
...
inline const char *EnumNamecovarianceAlgorithm(covarianceAlgorithm e) {
  if (::flatbuffers::IsOutRange(e, covarianceAlgorithm_CALCULATED, covarianceAlgorithm_DEFAULT)) return "";
  const size_t index = static_cast<size_t>(e);
...
inline ::flatbuffers::Offset<CDMObject> CreateCDMObject(
    ...
    covarianceAlgorithm COVARIANCE_METHOD = covarianceAlgorithm_CALCULATED,
