...
pub fn root_as_stv(buf: &[u8]) -> Result<STV<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_stv(buf: &[u8]) -> Result<STV<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_stv_unchecked(buf: &[u8]) -> STV<'_> {
  unsafe { ::flatbuffers::root_unchecked::<STV>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_stv_unchecked(buf: &[u8]) -> STV<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<STV>(buf) }
}
