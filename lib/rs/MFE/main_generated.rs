...
pub fn root_as_mfe(buf: &[u8]) -> Result<MFE<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_mfe(buf: &[u8]) -> Result<MFE<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_mfe_unchecked(buf: &[u8]) -> MFE<'_> {
  unsafe { ::flatbuffers::root_unchecked::<MFE>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_mfe_unchecked(buf: &[u8]) -> MFE<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<MFE>(buf) }
}
