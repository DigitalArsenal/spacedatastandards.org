...
pub struct TKGT {
  ...
  pub FILTER_CONFIG: Option<alloc::string::String>,
  pub IMM_CONFIG: Option<alloc::string::String>,
  pub MHT_CONFIG: Option<alloc::string::String>,
  pub JPDA_CONFIG: Option<alloc::string::String>,
  pub FUSION_CONFIG: Option<alloc::string::String>,
  pub MEASUREMENTS: Option<alloc::string::String>,
  pub INITIAL_STATE: Option<alloc::string::String>,
  pub TRACK_TO_UPDATE: Option<alloc::string::String>,
  pub TRACKS_TO_CORRELATE: Option<alloc::vec::Vec<alloc::string::String>>,
}
...
pub fn root_as_tkg(buf: &[u8]) -> Result<TKG<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_tkg(buf: &[u8]) -> Result<TKG<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_tkg_unchecked(buf: &[u8]) -> TKG<'_> {
  unsafe { ::flatbuffers::root_unchecked::<TKG>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_tkg_unchecked(buf: &[u8]) -> TKG<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<TKG>(buf) }
}
