...
pub struct MNFT {
  ...
  pub STATUS: manifoldStatus,
  pub EVENT_EPOCH: Option<alloc::string::String>,
  ...
  pub DELTA_T_STEP: f64,
  pub NUM_ELEMENTS: u32,
  pub ELEMENTS: Option<alloc::vec::Vec<manifoldElsetT>>,
  pub CORRELATED_ID: Option<alloc::string::String>,
...
pub fn root_as_mnf(buf: &[u8]) -> Result<MNF<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_mnf(buf: &[u8]) -> Result<MNF<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_mnf_unchecked(buf: &[u8]) -> MNF<'_> {
  unsafe { ::flatbuffers::root_unchecked::<MNF>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_mnf_unchecked(buf: &[u8]) -> MNF<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<MNF>(buf) }
}
