...
pub struct EMET {
  pub ENCRYPTED_BLOB: Option<alloc::vec::Vec<u8>>,
  pub EPHEMERAL_PUBLIC_KEY: Option<alloc::string::String>,
  pub MAC: Option<alloc::string::String>,
  pub NONCE_START: Option<alloc::vec::Vec<u8>>,
  pub TAG: Option<alloc::string::String>,
  pub IV: Option<alloc::string::String>,
  pub SALT: Option<alloc::string::String>,
  pub PUBLIC_KEY_IDENTIFIER: Option<alloc::string::String>,
  pub CIPHER_SUITE: Option<alloc::string::String>,
  pub KDF_PARAMETERS: Option<alloc::string::String>,
  pub ENCRYPTION_ALGORITHM_PARAMETERS: Option<alloc::string::String>,
}
...
pub fn root_as_eme(buf: &[u8]) -> Result<EME<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_eme(buf: &[u8]) -> Result<EME<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_eme_unchecked(buf: &[u8]) -> EME<'_> {
  unsafe { ::flatbuffers::root_unchecked::<EME>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_eme_unchecked(buf: &[u8]) -> EME<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<EME>(buf) }
}
