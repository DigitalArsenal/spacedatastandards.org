...
pub struct HELT {
  ...
  pub OMEGA_BODY_Y: f64,
  pub OMEGA_BODY_Z: f64,
  pub MAIN_ROTOR: Option<alloc::string::String>,
  pub TAIL_ROTOR: Option<alloc::string::String>,
  pub ENGINE_N1: f64,
  pub ENGINE_TORQUE: f64,
  pub FLAGS: u32,
  pub FUEL_REMAINING: f32,
...
pub fn root_as_hel(buf: &[u8]) -> Result<HEL<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_hel(buf: &[u8]) -> Result<HEL<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_hel_unchecked(buf: &[u8]) -> HEL<'_> {
  unsafe { ::flatbuffers::root_unchecked::<HEL>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_hel_unchecked(buf: &[u8]) -> HEL<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<HEL>(buf) }
}
