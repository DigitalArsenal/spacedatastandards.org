...
pub struct DFHT {
  ...
  pub SLOT_HALF_WIDTH: f64,
  pub STATION_KEEPING: bool,
  pub RECORDS: Option<alloc::vec::Vec<driftRecordT>>,
  pub NUM_RECORDS: u32,
...
pub fn root_as_dfh(buf: &[u8]) -> Result<DFH<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_dfh(buf: &[u8]) -> Result<DFH<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_dfh_unchecked(buf: &[u8]) -> DFH<'_> {
  unsafe { ::flatbuffers::root_unchecked::<DFH>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_dfh_unchecked(buf: &[u8]) -> DFH<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<DFH>(buf) }
}
