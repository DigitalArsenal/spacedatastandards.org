...
pub fn root_as_wpn(buf: &[u8]) -> Result<WPN<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_wpn(buf: &[u8]) -> Result<WPN<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_wpn_unchecked(buf: &[u8]) -> WPN<'_> {
  unsafe { ::flatbuffers::root_unchecked::<WPN>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_wpn_unchecked(buf: &[u8]) -> WPN<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<WPN>(buf) }
}
