...
pub struct CHNT {
  ...
  pub ID_RFBAND: Option<alloc::string::String>,
  pub ENCRYPTION: Option<alloc::string::String>,
  pub PKG: Option<alloc::string::String>,
  pub RES: Option<alloc::string::String>,
  pub COMPRESSION: Option<alloc::string::String>,
  pub VPID: Option<alloc::string::String>,
  pub APID: Option<alloc::string::String>,
  pub SID: Option<alloc::string::String>,
...
pub fn root_as_chn(buf: &[u8]) -> Result<CHN<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_chn(buf: &[u8]) -> Result<CHN<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_chn_unchecked(buf: &[u8]) -> CHN<'_> {
  unsafe { ::flatbuffers::root_unchecked::<CHN>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_chn_unchecked(buf: &[u8]) -> CHN<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<CHN>(buf) }
}
