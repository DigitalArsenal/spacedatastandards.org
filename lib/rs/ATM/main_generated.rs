...
pub fn root_as_atm(buf: &[u8]) -> Result<ATM<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_atm(buf: &[u8]) -> Result<ATM<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_atm_unchecked(buf: &[u8]) -> ATM<'_> {
  unsafe { ::flatbuffers::root_unchecked::<ATM>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_atm_unchecked(buf: &[u8]) -> ATM<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<ATM>(buf) }
}
