...
pub struct CRMT {
  ...
  pub ID_PLAN: Option<alloc::string::String>,
  pub PLAN_INDEX: i32,
  pub TASK_ID: Option<alloc::string::String>,
  pub DWELL_ID: Option<alloc::string::String>,
  ...
  pub PRIORITY: Option<alloc::string::String>,
  pub TASK_CATEGORY: i32,
  ...
  pub TASK_GROUP: Option<alloc::string::String>,
  pub IRON: i32,
  ...
  pub VIS_MAG: f64,
  pub VIS_MAG_MAX: f64,
  pub SPECTRAL_MODEL: Option<alloc::string::String>,
  pub REFLECTANCE: f64,
  pub IRRADIANCE: f64,
  pub NUM_FRAMES: i32,
  pub FRAME_RATE: f64,
  ...
  pub NUM_OBS: i32,
  pub DURATION: i32,
  pub SRCH_PATTERN: Option<alloc::string::String>,
  pub SCENARIO: Option<alloc::string::String>,
  pub ID_ELSET: Option<alloc::string::String>,
  pub ID_MANIFOLD: Option<alloc::string::String>,
  pub ID_STATE_VECTOR: Option<alloc::string::String>,
  pub ES_ID: Option<alloc::string::String>,
...
pub fn root_as_crm(buf: &[u8]) -> Result<CRM<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_crm(buf: &[u8]) -> Result<CRM<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_crm_unchecked(buf: &[u8]) -> CRM<'_> {
  unsafe { ::flatbuffers::root_unchecked::<CRM>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_crm_unchecked(buf: &[u8]) -> CRM<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<CRM>(buf) }
}
