...
pub fn root_as_bus(buf: &[u8]) -> Result<BUS<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_bus(buf: &[u8]) -> Result<BUS<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_bus_unchecked(buf: &[u8]) -> BUS<'_> {
  unsafe { ::flatbuffers::root_unchecked::<BUS>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_bus_unchecked(buf: &[u8]) -> BUS<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<BUS>(buf) }
}
