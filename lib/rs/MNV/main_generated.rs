...
pub struct mnvOrbitalStateT {
  pub ID_ELSET: Option<alloc::string::String>,
  pub ELSET: Option<alloc::string::String>,
  pub ID_STATE_VECTOR: Option<alloc::string::String>,
  pub STATE_VECTOR: Option<alloc::string::String>,
  pub POS_X: f64,
  pub POS_Y: f64,
  pub POS_Z: f64,
  pub VEL_X: f64,
...
pub struct MNVT {
  ...
  pub CHARACTERIZATION: maneuverCharacterization,
  pub CHARACTERIZATION_UNC: f64,
  pub REPORT_TIME: Option<alloc::string::String>,
  pub EVENT_START_TIME: Option<alloc::string::String>,
  pub EVENT_END_TIME: Option<alloc::string::String>,
  pub TOTAL_BURN_TIME: f64,
  pub OD_FIT_END_TIME: Option<alloc::string::String>,
  ...
  pub DELTA_POS_W: f64,
  pub DELTA_MASS: f64,
  pub PRE_EVENT: Option<alloc::boxed::Box<mnvOrbitalStateT>>,
  pub POST_EVENT: Option<alloc::boxed::Box<mnvOrbitalStateT>>,
  pub POST_MASS: f64,
  pub POST_AREA: f64,
  pub COV: Option<alloc::vec::Vec<f64>>,
  pub NUM_OBS: u32,
  pub STATE_MODEL: Option<alloc::string::String>,
  pub STATE_MODEL_VERSION: f64,
  pub NUM_ACCEL_POINTS: u16,
  pub MNVR_ACCEL_TIMES: Option<alloc::vec::Vec<alloc::string::String>>,
  pub MNVR_ACCELS: Option<alloc::vec::Vec<f64>>,
  pub MNVR_ACCEL_UNCS: Option<alloc::vec::Vec<f64>>,
  ...
  pub SOURCED_DATA: Option<alloc::vec::Vec<alloc::string::String>>,
  pub SOURCED_DATA_TYPES: Option<alloc::string::String>,
...
pub fn root_as_mnv(buf: &[u8]) -> Result<MNV<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_mnv(buf: &[u8]) -> Result<MNV<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_mnv_unchecked(buf: &[u8]) -> MNV<'_> {
  unsafe { ::flatbuffers::root_unchecked::<MNV>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_mnv_unchecked(buf: &[u8]) -> MNV<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<MNV>(buf) }
}
