...
pub struct SDLT {
  ...
  pub MAC_LENGTH: u8,
  pub MAC: Option<alloc::vec::Vec<u8>>,
  pub PAD_LENGTH: u8,
...
pub fn root_as_sdl(buf: &[u8]) -> Result<SDL<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_sdl(buf: &[u8]) -> Result<SDL<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_sdl_unchecked(buf: &[u8]) -> SDL<'_> {
  unsafe { ::flatbuffers::root_unchecked::<SDL>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_sdl_unchecked(buf: &[u8]) -> SDL<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<SDL>(buf) }
}
