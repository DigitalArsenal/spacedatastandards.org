...
pub struct SOIT {
  ...
  pub SENSOR_AS_ID: Option<alloc::string::String>,
  pub SAT_NO: u32,
  ...
  pub SENVELY: f64,
  pub SENVELZ: f64,
  pub SEN_REFERENCE_FRAME: Option<alloc::string::String>,
  pub OBS_TYPE: soiObsType,
  pub COLLECTION_MODE: soiCollectionMode,
  ...
  pub PIXEL_ARRAY_HEIGHT: u16,
  pub NUM_SPECTRAL_FILTERS: u8,
  pub SPECTRAL_FILTERS: Option<alloc::vec::Vec<alloc::string::String>>,
  pub GAIN: f64,
  pub BINNING_HORIZ: u8,
  pub BINNING_VERT: u8,
  pub SOLAR_MAG: f64,
  pub PIXEL_MIN: i32,
  pub PIXEL_MAX: i32,
  pub SOFTWARE_VERSION: Option<alloc::string::String>,
  pub STAR_CAT_NAME: Option<alloc::string::String>,
  pub CORR_QUALITY: f64,
  pub CALIBRATION_TYPE: soiCalibrationType,
  pub VALID_CALIBRATIONS: Option<alloc::string::String>,
  pub PERCENT_SAT_THRESHOLD: f64,
  pub CHANGE_DETECTED: bool,
  pub PERIODICITY_CHANGE_DETECTED: bool,
  pub BRIGHTNESS_VARIANCE_CHANGE_DETECTED: bool,
  pub SOLAR_PHASE_ANGLE_BRIGHTNESS_CHANGE_DETECTED: bool,
  pub CHANGE_CONF: Option<alloc::string::String>,
  pub COLLECTION_DENSITY_CONF: Option<alloc::string::String>,
  pub PERIODICITY_SAMPLING_CONF: Option<alloc::string::String>,
  pub PERIODICITY_DETECTION_CONF: Option<alloc::string::String>,
  pub COLLECTION_ID: Option<alloc::string::String>,
  pub CALIBRATIONS: Option<alloc::vec::Vec<alloc::string::String>>,
  pub TAGS: Option<alloc::vec::Vec<alloc::string::String>>,
  pub TRANSACTION_ID: Option<alloc::string::String>,
  pub OPTICAL_SOIOBSERVATION_LIST: Option<alloc::vec::Vec<alloc::string::String>>,
  pub RADAR_SOIOBSERVATION_LIST: Option<alloc::vec::Vec<alloc::string::String>>,
}
...
pub fn root_as_soi(buf: &[u8]) -> Result<SOI<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_soi(buf: &[u8]) -> Result<SOI<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_soi_unchecked(buf: &[u8]) -> SOI<'_> {
  unsafe { ::flatbuffers::root_unchecked::<SOI>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_soi_unchecked(buf: &[u8]) -> SOI<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<SOI>(buf) }
}
