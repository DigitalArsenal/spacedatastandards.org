...
pub fn root_as_snr(buf: &[u8]) -> Result<SNR<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_snr(buf: &[u8]) -> Result<SNR<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_snr_unchecked(buf: &[u8]) -> SNR<'_> {
  unsafe { ::flatbuffers::root_unchecked::<SNR>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_snr_unchecked(buf: &[u8]) -> SNR<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<SNR>(buf) }
}
