...
pub fn root_as_clt(buf: &[u8]) -> Result<CLT<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_clt(buf: &[u8]) -> Result<CLT<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_clt_unchecked(buf: &[u8]) -> CLT<'_> {
  unsafe { ::flatbuffers::root_unchecked::<CLT>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_clt_unchecked(buf: &[u8]) -> CLT<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<CLT>(buf) }
}
