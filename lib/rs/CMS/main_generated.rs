...
pub struct commsTransponderT {
  pub TRANSPONDER_ID: Option<alloc::string::String>,
  pub NAME: Option<alloc::string::String>,
  ...
  pub BANDWIDTH: f64,
  pub NUM_CHANNELS: u32,
  pub CHANNELS: Option<alloc::vec::Vec<commsChannelT>>,
...
pub struct CMST {
  ...
  pub SAT_NO: u32,
  pub NUM_TRANSPONDERS: u32,
  pub TRANSPONDERS: Option<alloc::vec::Vec<commsTransponderT>>,
  pub TOTAL_POWER: f64,
  pub TOTAL_MASS: f64,
  pub TOTAL_BANDWIDTH: f64,
  pub MISSION: Option<alloc::string::String>,
  pub COVERAGE: Option<alloc::string::String>,
  pub DESIGN_LIFE: f64,
...
pub fn root_as_cms(buf: &[u8]) -> Result<CMS<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_cms(buf: &[u8]) -> Result<CMS<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_cms_unchecked(buf: &[u8]) -> CMS<'_> {
  unsafe { ::flatbuffers::root_unchecked::<CMS>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_cms_unchecked(buf: &[u8]) -> CMS<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<CMS>(buf) }
}
