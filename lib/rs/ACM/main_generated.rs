...
pub struct attitudeStateT {
  ...
  pub ATT_DIR: Option<alloc::string::String>,
...
pub struct attPhysicalPropertiesT {
  ...
  pub WET_MASS: f64,
  pub DRY_MASS: f64,
  pub CP_REF_FRAME: Option<alloc::string::String>,
  pub CP_X: f64,
  pub CP_Y: f64,
  pub CP_Z: f64,
  pub INERTIA_REF_FRAME: Option<alloc::string::String>,
  pub IXX: f64,
  pub IYY: f64,
  pub IZZ: f64,
  pub IXY: f64,
...
pub struct attCovarianceT {
  pub COV_TYPE: attCovType,
  pub COV_REF_FRAME: Option<alloc::string::String>,
  pub EPOCH: Option<alloc::string::String>,
...
#[derive(Debug, Clone, PartialEq)]
pub struct ACMT {
  pub CCSDS_ACM_VERS: Option<alloc::string::String>,
  ...
  pub ATT_STATES: Option<alloc::vec::Vec<attitudeStateT>>,
  pub PHYS_PROPERTIES: Option<alloc::boxed::Box<attPhysicalPropertiesT>>,
  pub COV_DATA: Option<alloc::vec::Vec<attCovarianceT>>,
  pub MANEUVERS: Option<alloc::vec::Vec<attManeuverT>>,
  pub MANEUVERABLE: maneuverableFlag,
...
pub fn root_as_acm(buf: &[u8]) -> Result<ACM<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_acm(buf: &[u8]) -> Result<ACM<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_acm_unchecked(buf: &[u8]) -> ACM<'_> {
  unsafe { ::flatbuffers::root_unchecked::<ACM>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_acm_unchecked(buf: &[u8]) -> ACM<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<ACM>(buf) }
}
