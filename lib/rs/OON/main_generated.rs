...
pub struct OONT {
  pub SAT_NO: i32,
  pub COMMON_NAME: Option<alloc::string::String>,
  pub CONSTELLATION: Option<alloc::string::String>,
  pub INTL_DES: Option<alloc::string::String>,
  ...
  pub MISSION_NUMBER: Option<alloc::string::String>,
  pub CATEGORY: Option<alloc::string::String>,
  pub LIFETIME_YEARS: i32,
  pub ALT_NAME: Option<alloc::string::String>,
  pub LAUNCH_SITE_ID: Option<alloc::string::String>,
  pub ANTENNAS: Option<alloc::vec::Vec<alloc::string::String>>,
  pub BATTERIES: Option<alloc::vec::Vec<alloc::string::String>>,
  pub SOLAR_ARRAYS: Option<alloc::vec::Vec<alloc::string::String>>,
  pub THRUSTERS: Option<alloc::vec::Vec<alloc::string::String>>,
  pub ONORBIT_DETAILS: Option<alloc::vec::Vec<alloc::string::String>>,
  pub COUNTRY_CODE: Option<alloc::string::String>,
  pub ENTITY_COLLECTION: Option<alloc::vec::Vec<alloc::string::String>>,
}
...
pub fn root_as_oon(buf: &[u8]) -> Result<OON<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_oon(buf: &[u8]) -> Result<OON<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_oon_unchecked(buf: &[u8]) -> OON<'_> {
  unsafe { ::flatbuffers::root_unchecked::<OON>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_oon_unchecked(buf: &[u8]) -> OON<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<OON>(buf) }
}
