...
pub struct GDIT {
  ...
  pub IMAGE_TIME: Option<alloc::string::String>,
  pub FILENAME: Option<alloc::string::String>,
  pub FORMAT: imageFormat,
  pub FILESIZE: i64,
  pub CHECKSUM_VALUE: Option<alloc::string::String>,
  pub REGION_GEO_JSON: Option<alloc::string::String>,
  pub REGION_TEXT: Option<alloc::string::String>,
  pub REGION: Option<alloc::string::String>,
  pub REGION_TYPE: Option<alloc::string::String>,
  pub REGION_NDIMS: u8,
  pub REGION_SRID: u16,
...
pub fn root_as_gdi(buf: &[u8]) -> Result<GDI<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_gdi(buf: &[u8]) -> Result<GDI<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_gdi_unchecked(buf: &[u8]) -> GDI<'_> {
  unsafe { ::flatbuffers::root_unchecked::<GDI>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_gdi_unchecked(buf: &[u8]) -> GDI<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<GDI>(buf) }
}
