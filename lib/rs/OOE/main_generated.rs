...
pub struct OOET {
  ...
  pub DERIVED_FROM: Option<alloc::string::String>,
  pub DECLASSIFICATION_DATE: Option<alloc::string::String>,
  pub DECLASSIFICATION_STRING: Option<alloc::string::String>,
  pub EVENT_TIME: Option<alloc::string::String>,
  pub EVENT_TIME_NOTES: Option<alloc::string::String>,
  pub CATEGORY: eventCategory,
  pub RESULT: eventResult,
  pub EVENT_TYPE: Option<alloc::string::String>,
  pub OPERATOR_ORG_ID: Option<alloc::string::String>,
  pub OWNER_ORG_ID: Option<alloc::string::String>,
  pub LESSEE_ORG_ID: Option<alloc::string::String>,
  pub OPERATED_ON_BEHALF_OF_ORG_ID: Option<alloc::string::String>,
  pub GEO_POSITION: f64,
  pub PLANE_SLOT: Option<alloc::string::String>,
  pub PLANE_NUMBER: Option<alloc::string::String>,
  pub POSITION_STATUS: Option<alloc::string::String>,
  pub UNTIL_TIME: Option<alloc::string::String>,
  pub OFFICIAL_LOSS_DATE: Option<alloc::string::String>,
  pub NET_AMOUNT: f64,
  pub UNDERLYING_CAUSE: Option<alloc::string::String>,
  pub CAPABILITY_LOSS: f64,
  pub CAPACITY_LOSS: f64,
  pub INSURANCE_LOSS: f64,
  pub THIRD_PARTY_INSURANCE_LOSS: f64,
  ...
  pub AGE_AT_EVENT: f64,
  pub LIFE_LOST: f64,
  pub ACHIEVED_FLIGHT_PHASE: Option<alloc::string::String>,
  pub OCCURRENCE_FLIGHT_PHASE: Option<alloc::string::String>,
  pub STAGE_AT_FAULT: Option<alloc::string::String>,
  pub EQUIPMENT_AT_FAULT: Option<alloc::string::String>,
  pub EQUIPMENT_TYPE_AT_FAULT: Option<alloc::string::String>,
  pub EQUIPMENT_PART_AT_FAULT: Option<alloc::string::String>,
  pub CONSEQUENTIAL_EQUIPMENT_FAILURE: Option<alloc::string::String>,
  pub INCLINED: bool,
  pub DESCRIPTION: Option<alloc::string::String>,
  pub REMARKS: Option<alloc::string::String>,
  pub OBJECT_STATUS: Option<alloc::string::String>,
  pub SATELLITE_POSITION: Option<alloc::string::String>,
  pub ON_ORBIT: Option<alloc::string::String>,
}
...
pub fn root_as_ooe(buf: &[u8]) -> Result<OOE<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_ooe(buf: &[u8]) -> Result<OOE<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_ooe_unchecked(buf: &[u8]) -> OOE<'_> {
  unsafe { ::flatbuffers::root_unchecked::<OOE>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_ooe_unchecked(buf: &[u8]) -> OOE<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<OOE>(buf) }
}
