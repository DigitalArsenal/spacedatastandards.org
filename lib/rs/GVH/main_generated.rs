...
pub struct GVHT {
  ...
  pub LATERAL_G: f32,
  pub LONGITUDINAL_G: f32,
  pub TURRET: Option<alloc::string::String>,
  pub DRIVETRAIN: Option<alloc::string::String>,
  pub SUSPENSION_LF: Option<alloc::string::String>,
  pub SUSPENSION_RF: Option<alloc::string::String>,
  pub SUSPENSION_LR: Option<alloc::string::String>,
  pub SUSPENSION_RR: Option<alloc::string::String>,
  pub VEHICLE_TYPE: u8,
  pub DRIVE_TYPE: u8,
  pub ENGINE_RUNNING: u8,
  pub LIGHTS: u8,
...
pub fn root_as_gvh(buf: &[u8]) -> Result<GVH<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_gvh(buf: &[u8]) -> Result<GVH<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_gvh_unchecked(buf: &[u8]) -> GVH<'_> {
  unsafe { ::flatbuffers::root_unchecked::<GVH>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_gvh_unchecked(buf: &[u8]) -> GVH<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<GVH>(buf) }
}
