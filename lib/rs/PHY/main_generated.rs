...
pub struct PHYT {
  ...
  pub SIMULATION_STEP: Option<alloc::string::String>,
  pub RIGID_BODY: Option<alloc::string::String>,
  pub INTEGRATION_CONFIG: Option<alloc::string::String>,
  pub COLLISION_QUERY_A: Option<alloc::string::String>,
  pub COLLISION_QUERY_B: Option<alloc::string::String>,
  pub TRANSFORM_A: Option<alloc::string::String>,
  pub TRANSFORM_B: Option<alloc::string::String>,
  pub POSITION_A: Option<alloc::string::String>,
  pub POSITION_B: Option<alloc::string::String>,
  pub FLUID: Option<alloc::string::String>,
  pub AERO_QUERY: Option<alloc::string::String>,
  pub DRAG_MODEL: Option<alloc::string::String>,
  pub THERMAL_STATE: Option<alloc::string::String>,
}
...
pub fn root_as_phy(buf: &[u8]) -> Result<PHY<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_phy(buf: &[u8]) -> Result<PHY<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_phy_unchecked(buf: &[u8]) -> PHY<'_> {
  unsafe { ::flatbuffers::root_unchecked::<PHY>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_phy_unchecked(buf: &[u8]) -> PHY<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<PHY>(buf) }
}
