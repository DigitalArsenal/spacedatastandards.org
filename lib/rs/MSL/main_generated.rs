...
pub struct MSLT {
  ...
  pub TARGET_VELOCITY_Z: f64,
  pub MISS_DISTANCE: f64,
  pub SEEKER: Option<alloc::string::String>,
  pub MOTOR: Option<alloc::string::String>,
  pub GUIDANCE_CMD: Option<alloc::string::String>,
  pub PHASE: u8,
  pub GUIDANCE_LAW: u8,
  pub TYPE: u8,
  pub ARMED: u8,
...
pub fn root_as_msl(buf: &[u8]) -> Result<MSL<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_msl(buf: &[u8]) -> Result<MSL<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_msl_unchecked(buf: &[u8]) -> MSL<'_> {
  unsafe { ::flatbuffers::root_unchecked::<MSL>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_msl_unchecked(buf: &[u8]) -> MSL<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<MSL>(buf) }
}
