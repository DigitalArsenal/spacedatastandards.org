...
pub struct COMT {
  ...
  pub BYTES_SENT: u64,
  pub BYTES_RECEIVED: u64,
  pub CONNECTED_NODES: Option<alloc::vec::Vec<u32>>,
  pub ACTIVE_LINKS: Option<alloc::vec::Vec<DataLinkType>>,
  pub LAST_UPDATE_MS: i64,
}
...
pub fn root_as_com(buf: &[u8]) -> Result<COM<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_com(buf: &[u8]) -> Result<COM<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_com_unchecked(buf: &[u8]) -> COM<'_> {
  unsafe { ::flatbuffers::root_unchecked::<COM>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_com_unchecked(buf: &[u8]) -> COM<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<COM>(buf) }
}
