...
pub struct CTRT {
  ...
  pub GENC_CODE: Option<alloc::string::String>,
  pub ALPHA_2_CODE: Option<alloc::string::String>,
  pub ALPHA_3_CODE: Option<alloc::string::String>,
  pub STANAG_CODE: Option<alloc::string::String>,
  pub INTERNET_CCTLD: Option<alloc::string::String>,
...
pub fn root_as_ctr(buf: &[u8]) -> Result<CTR<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_ctr(buf: &[u8]) -> Result<CTR<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_ctr_unchecked(buf: &[u8]) -> CTR<'_> {
  unsafe { ::flatbuffers::root_unchecked::<CTR>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_ctr_unchecked(buf: &[u8]) -> CTR<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<CTR>(buf) }
}
