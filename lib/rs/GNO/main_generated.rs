...
pub struct gnssSatObsT {
  pub GNSS_SAT_ID: Option<alloc::string::String>,
  pub CONSTELLATION: gnssConstellation,
  pub ELEVATION: f64,
  pub AZIMUTH: f64,
  pub TRACKING_STATUS: i32,
  pub AGC_STATE: i32,
  pub OBSERVATIONS: Option<alloc::vec::Vec<gnssObsDataT>>,
}
...
pub struct GNOT {
  ...
  pub RECEIVER_TYPE: Option<alloc::string::String>,
  ...
  pub HDOP: f64,
  pub VDOP: f64,
  pub SAT_OBS: Option<alloc::vec::Vec<gnssSatObsT>>,
  pub OBS_CODE_SET: Option<alloc::vec::Vec<alloc::string::String>>,
...
pub fn root_as_gno(buf: &[u8]) -> Result<GNO<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_gno(buf: &[u8]) -> Result<GNO<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_gno_unchecked(buf: &[u8]) -> GNO<'_> {
  unsafe { ::flatbuffers::root_unchecked::<GNO>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_gno_unchecked(buf: &[u8]) -> GNO<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<GNO>(buf) }
}
