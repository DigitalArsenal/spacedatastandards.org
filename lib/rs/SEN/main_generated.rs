...
pub struct sensorMaintenanceEventT {
  ...
  pub COMPONENTS: Option<alloc::vec::Vec<alloc::string::String>>,
}
...
pub struct sensorStatsT {
  pub PERIOD_START: Option<alloc::string::String>,
  pub PERIOD_END: Option<alloc::string::String>,
  pub OBS_ATTEMPTED: u32,
  pub OBS_SUCCESSFUL: u32,
  pub OBS_FAILED: u32,
  pub UPTIME: f64,
...
pub struct SENT {
  ...
  pub LONGITUDE: f64,
  pub ALTITUDE: f64,
  pub STATUS_TIME: Option<alloc::string::String>,
  pub MAINTENANCE: Option<alloc::vec::Vec<sensorMaintenanceEventT>>,
  pub PLANS: Option<alloc::vec::Vec<sensorPlanT>>,
  pub STATISTICS: Option<alloc::vec::Vec<sensorStatsT>>,
...
pub fn root_as_sen(buf: &[u8]) -> Result<SEN<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_sen(buf: &[u8]) -> Result<SEN<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_sen_unchecked(buf: &[u8]) -> SEN<'_> {
  unsafe { ::flatbuffers::root_unchecked::<SEN>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_sen_unchecked(buf: &[u8]) -> SEN<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<SEN>(buf) }
}
