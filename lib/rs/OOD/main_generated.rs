...
pub struct OODT {
  ...
  pub EST_DELTA_VDURATION: f64,
  pub NUM_MISSION: i32,
  pub MISSION_TYPES: Option<alloc::vec::Vec<alloc::string::String>>,
  pub BUS_TYPE: Option<alloc::string::String>,
  pub GEO_SLOT: f64,
  pub DRIFT_RATE: f64,
  pub DRY_MASS: f64,
  pub ADDITIONAL_MASS: f64,
  ...
  pub ADEPT_RADIUS: f64,
  pub NUM_DEPLOYABLE: i32,
  pub DEP_NAMES: Option<alloc::vec::Vec<alloc::string::String>>,
  pub DEP_EST_MASSES: Option<alloc::vec::Vec<alloc::string::String>>,
  pub DEP_MASS_UNCS: Option<alloc::vec::Vec<alloc::string::String>>,
  pub LAST_OB_SOURCE: Option<alloc::string::String>,
}
...
pub fn root_as_ood(buf: &[u8]) -> Result<OOD<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_ood(buf: &[u8]) -> Result<OOD<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_ood_unchecked(buf: &[u8]) -> OOD<'_> {
  unsafe { ::flatbuffers::root_unchecked::<OOD>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_ood_unchecked(buf: &[u8]) -> OOD<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<OOD>(buf) }
}
