...
pub struct IntegerDataEncodingT {
  ...
  pub BYTE_ORDER: ByteOrderType,
  pub ENCODING: IntegerEncodingType,
  pub DEFAULT_CALIBRATOR: Option<alloc::string::String>,
  pub CONTEXT_CALIBRATOR_LIST: Option<alloc::vec::Vec<ContextCalibratorT>>,
}
...
pub struct PolynomialCalibratorT {
  pub COEFFICIENTS: Option<alloc::vec::Vec<f64>>,
}
...
pub struct SplineCalibratorT {
  pub POINTS: Option<alloc::vec::Vec<SplinePointT>>,
  pub EXTRAPOLATE_LOW: bool,
  pub EXTRAPOLATE_HIGH: bool,
}
...
pub struct MathOperationT {
  pub RPN_EXPRESSION: Option<alloc::string::String>,
}
...
pub struct ContextCalibratorT {
  pub MATCH_CRITERIA: Option<alloc::boxed::Box<MatchCriteriaT>>,
  pub POLYNOMIAL: Option<alloc::boxed::Box<PolynomialCalibratorT>>,
  pub SPLINE: Option<alloc::boxed::Box<SplineCalibratorT>>,
  pub MATH_OPERATION: Option<alloc::boxed::Box<MathOperationT>>,
}
...
pub struct StaticAlarmRangesT {
  pub WATCH_RANGE: Option<alloc::boxed::Box<AlarmRangeT>>,
  pub WARNING_RANGE: Option<alloc::boxed::Box<AlarmRangeT>>,
  pub DISTRESS_RANGE: Option<alloc::boxed::Box<AlarmRangeT>>,
  pub CRITICAL_RANGE: Option<alloc::boxed::Box<AlarmRangeT>>,
  pub SEVERE_RANGE: Option<alloc::boxed::Box<AlarmRangeT>>,
}
...
pub struct DefaultAlarmT {
  pub MIN_VIOLATIONS: u16,
  pub STATIC_ALARM_RANGES: Option<alloc::boxed::Box<StaticAlarmRangesT>>,
  pub ENUMERATION_ALARMS: Option<alloc::vec::Vec<EnumerationAlarmT>>,
}
...
pub struct ContextAlarmT {
  pub MATCH_CRITERIA: Option<alloc::boxed::Box<MatchCriteriaT>>,
  pub ALARM: Option<alloc::boxed::Box<DefaultAlarmT>>,
}
...
pub struct ParameterComparisonT {
  pub PARAMETER_REF: Option<alloc::string::String>,
  pub OPERATOR: ComparisonOperator,
...
pub struct BooleanExpressionT {
  pub OPERATOR: BooleanOperatorType,
  pub CONDITIONS: Option<alloc::vec::Vec<ParameterComparisonT>>,
  pub EXPRESSIONS: Option<alloc::vec::Vec<BooleanExpressionT>>,
}
...
pub struct MatchCriteriaT {
  pub COMPARISON: Option<alloc::boxed::Box<ParameterComparisonT>>,
  pub COMPARISON_LIST: Option<alloc::vec::Vec<ParameterComparisonT>>,
  pub BOOLEAN_EXPRESSION: Option<alloc::boxed::Box<BooleanExpressionT>>,
  pub CUSTOM_ALGORITHM: Option<alloc::string::String>,
}
...
pub struct IntegerParameterTypeT {
  ...
  pub SHORT_DESCRIPTION: Option<alloc::string::String>,
  pub LONG_DESCRIPTION: Option<alloc::string::String>,
  pub UNITS: Option<alloc::vec::Vec<UnitT>>,
  pub DATA_ENCODING: Option<alloc::boxed::Box<IntegerDataEncodingT>>,
  pub DEFAULT_ALARM: Option<alloc::boxed::Box<DefaultAlarmT>>,
  pub CONTEXT_ALARMS: Option<alloc::vec::Vec<ContextAlarmT>>,
  pub VALID_MIN: i64,
  pub VALID_MAX: i64,
  pub SIGNED: bool,
  pub SIZE_IN_BITS: u16,
...
pub struct FloatParameterTypeT {
  ...
  pub LONG_DESCRIPTION: Option<alloc::string::String>,
  pub UNITS: Option<alloc::vec::Vec<UnitT>>,
  pub DATA_ENCODING: Option<alloc::boxed::Box<FloatDataEncodingT>>,
  pub DEFAULT_ALARM: Option<alloc::boxed::Box<DefaultAlarmT>>,
  pub CONTEXT_ALARMS: Option<alloc::vec::Vec<ContextAlarmT>>,
  pub VALID_MIN: f64,
  pub VALID_MAX: f64,
...
pub struct StringParameterTypeT {
  ...
  pub SHORT_DESCRIPTION: Option<alloc::string::String>,
  pub LONG_DESCRIPTION: Option<alloc::string::String>,
  pub DATA_ENCODING: Option<alloc::boxed::Box<StringDataEncodingT>>,
  pub DEFAULT_ALARM: Option<alloc::boxed::Box<DefaultAlarmT>>,
  pub CONTEXT_ALARMS: Option<alloc::vec::Vec<ContextAlarmT>>,
  pub INITIAL_VALUE: Option<alloc::string::String>,
  pub RESTRICTION_PATTERN: Option<alloc::string::String>,
}
...
pub struct BooleanParameterTypeT {
  ...
  pub LONG_DESCRIPTION: Option<alloc::string::String>,
  pub DATA_ENCODING: Option<alloc::boxed::Box<IntegerDataEncodingT>>,
  pub ONE_STRING_VALUE: Option<alloc::string::String>,
  pub ZERO_STRING_VALUE: Option<alloc::string::String>,
  pub INITIAL_VALUE: bool,
}
...
pub struct EnumeratedParameterTypeT {
  ...
  pub DEFAULT_ALARM: Option<alloc::boxed::Box<DefaultAlarmT>>,
  pub CONTEXT_ALARMS: Option<alloc::vec::Vec<ContextAlarmT>>,
  pub ENUMERATION_LIST: Option<alloc::vec::Vec<EnumerationValueT>>,
  pub INITIAL_VALUE: Option<alloc::string::String>,
}
...
pub struct BinaryParameterTypeT {
  ...
  pub SHORT_DESCRIPTION: Option<alloc::string::String>,
  pub LONG_DESCRIPTION: Option<alloc::string::String>,
  pub DATA_ENCODING: Option<alloc::boxed::Box<BinaryDataEncodingT>>,
  pub INITIAL_VALUE: Option<alloc::string::String>,
}
...
pub struct AbsoluteTimeParameterTypeT {
  ...
  pub LONG_DESCRIPTION: Option<alloc::string::String>,
  pub EPOCH: EpochType,
  pub EPOCH_DATE: Option<alloc::string::String>,
  pub DATA_ENCODING: Option<alloc::boxed::Box<IntegerDataEncodingT>>,
  pub SCALE: f64,
  pub OFFSET: f64,
  pub DEFAULT_ALARM: Option<alloc::boxed::Box<DefaultAlarmT>>,
...
pub struct ArrayDimensionT {
  pub SIZE: u32,
  pub SIZE_PARAMETER_REF: Option<alloc::string::String>,
}
...
pub struct ArrayParameterTypeT {
  ...
  pub SHORT_DESCRIPTION: Option<alloc::string::String>,
  pub LONG_DESCRIPTION: Option<alloc::string::String>,
  pub ARRAY_TYPE_REF: Option<alloc::string::String>,
  pub DIMENSIONS: Option<alloc::vec::Vec<ArrayDimensionT>>,
}
...
pub struct AggregateParameterTypeT {
  ...
  pub SHORT_DESCRIPTION: Option<alloc::string::String>,
  pub LONG_DESCRIPTION: Option<alloc::string::String>,
  pub MEMBERS: Option<alloc::vec::Vec<AggregateMemberT>>,
}
...
pub struct ParameterTypeSetT {
  pub INTEGER_TYPES: Option<alloc::vec::Vec<IntegerParameterTypeT>>,
  pub FLOAT_TYPES: Option<alloc::vec::Vec<FloatParameterTypeT>>,
  pub STRING_TYPES: Option<alloc::vec::Vec<StringParameterTypeT>>,
  pub BOOLEAN_TYPES: Option<alloc::vec::Vec<BooleanParameterTypeT>>,
  pub ENUMERATED_TYPES: Option<alloc::vec::Vec<EnumeratedParameterTypeT>>,
  pub BINARY_TYPES: Option<alloc::vec::Vec<BinaryParameterTypeT>>,
  pub ABSOLUTE_TIME_TYPES: Option<alloc::vec::Vec<AbsoluteTimeParameterTypeT>>,
  pub RELATIVE_TIME_TYPES: Option<alloc::vec::Vec<RelativeTimeParameterTypeT>>,
  pub ARRAY_TYPES: Option<alloc::vec::Vec<ArrayParameterTypeT>>,
  pub AGGREGATE_TYPES: Option<alloc::vec::Vec<AggregateParameterTypeT>>,
}
...
pub struct ParameterPropertiesT {
  ...
  pub VALIDITY_CONDITION: Option<alloc::boxed::Box<MatchCriteriaT>>,
}
...
pub struct ParameterT {
  pub NAME: Option<alloc::string::String>,
  pub PARAMETER_TYPE_REF: Option<alloc::string::String>,
  pub SHORT_DESCRIPTION: Option<alloc::string::String>,
  pub LONG_DESCRIPTION: Option<alloc::string::String>,
  pub PROPERTIES: Option<alloc::boxed::Box<ParameterPropertiesT>>,
  pub PHYSICAL_ADDRESS: Option<alloc::string::String>,
  pub INITIAL_VALUE: Option<alloc::string::String>,
}
...
pub struct ParameterSetT {
  pub PARAMETERS: Option<alloc::vec::Vec<ParameterT>>,
}
...
pub struct RepeatEntryT {
  pub COUNT: u32,
  pub COUNT_PARAMETER_REF: Option<alloc::string::String>,
  pub OFFSET_IN_BITS: i32,
}
...
pub struct ParameterRefEntryT {
  pub PARAMETER_REF: Option<alloc::string::String>,
  pub LOCATION: Option<alloc::boxed::Box<LocationInContainerT>>,
  pub REPEAT: Option<alloc::boxed::Box<RepeatEntryT>>,
  pub INCLUDE_CONDITION: Option<alloc::boxed::Box<MatchCriteriaT>>,
  pub SHORT_DESCRIPTION: Option<alloc::string::String>,
}
...
pub struct ContainerRefEntryT {
  pub CONTAINER_REF: Option<alloc::string::String>,
  pub LOCATION: Option<alloc::boxed::Box<LocationInContainerT>>,
  pub REPEAT: Option<alloc::boxed::Box<RepeatEntryT>>,
  pub INCLUDE_CONDITION: Option<alloc::boxed::Box<MatchCriteriaT>>,
}
...
pub struct FixedValueEntryT {
  pub BINARY_VALUE: Option<alloc::string::String>,
  pub SIZE_IN_BITS: u16,
  pub NAME: Option<alloc::string::String>,
  pub LOCATION: Option<alloc::boxed::Box<LocationInContainerT>>,
}
...
pub struct ContainerEntryT {
  pub PARAMETER_REF_ENTRY: Option<alloc::boxed::Box<ParameterRefEntryT>>,
  pub CONTAINER_REF_ENTRY: Option<alloc::boxed::Box<ContainerRefEntryT>>,
  pub FIXED_VALUE_ENTRY: Option<alloc::boxed::Box<FixedValueEntryT>>,
  pub ARRAY_PARAMETER_REF_ENTRY: Option<alloc::boxed::Box<ArrayParameterRefEntryT>>,
}
...
pub struct BaseContainerT {
  pub CONTAINER_REF: Option<alloc::string::String>,
  pub RESTRICTION_CRITERIA: Option<alloc::boxed::Box<MatchCriteriaT>>,
}
...
pub struct RateInStreamT {
  pub STREAM_REF: Option<alloc::string::String>,
  pub RATE: f64,
  pub BASIS: RateBasisType,
}
...
pub struct ContainerBinaryEncodingT {
  pub ERROR_DETECTION: ErrorDetectionType,
  pub CRC_POLYNOMIAL: Option<alloc::string::String>,
  pub SIZE_IN_BITS: u32,
}
...
pub struct SequenceContainerT {
  ...
  pub LONG_DESCRIPTION: Option<alloc::string::String>,
  pub ABSTRACT: bool,
  pub ENTRY_LIST: Option<alloc::vec::Vec<ContainerEntryT>>,
  pub BASE_CONTAINER: Option<alloc::boxed::Box<BaseContainerT>>,
  pub BINARY_ENCODING: Option<alloc::boxed::Box<ContainerBinaryEncodingT>>,
  pub RATE_IN_STREAM: Option<alloc::boxed::Box<RateInStreamT>>,
  pub IDLE_PATTERN: Option<alloc::string::String>,
}
...
pub struct ContainerSetT {
  pub CONTAINERS: Option<alloc::vec::Vec<SequenceContainerT>>,
}
...
pub struct AlgorithmInputT {
  pub PARAMETER_REF: Option<alloc::string::String>,
  pub INPUT_NAME: Option<alloc::string::String>,
}
...
pub struct AlgorithmOutputT {
  pub PARAMETER_REF: Option<alloc::string::String>,
  pub OUTPUT_NAME: Option<alloc::string::String>,
}
...
pub struct CustomAlgorithmT {
  ...
  pub ALGORITHM_TEXT: Option<alloc::string::String>,
  pub EXTERNAL_ALGORITHM_REF: Option<alloc::string::String>,
  pub INPUTS: Option<alloc::vec::Vec<AlgorithmInputT>>,
  pub OUTPUTS: Option<alloc::vec::Vec<AlgorithmOutputT>>,
  pub TRIGGERS: Option<alloc::vec::Vec<AlgorithmTriggerT>>,
}
...
pub struct MathAlgorithmT {
  pub NAME: Option<alloc::string::String>,
  pub SHORT_DESCRIPTION: Option<alloc::string::String>,
  pub MATH_OPERATION: Option<alloc::string::String>,
  pub OUTPUT_PARAMETER_REF: Option<alloc::string::String>,
  pub TRIGGERS: Option<alloc::vec::Vec<AlgorithmTriggerT>>,
}
...
pub struct AlgorithmSetT {
  pub CUSTOM_ALGORITHMS: Option<alloc::vec::Vec<CustomAlgorithmT>>,
  pub MATH_ALGORITHMS: Option<alloc::vec::Vec<MathAlgorithmT>>,
}
...
pub struct ArgumentTypeSetT {
  pub INTEGER_TYPES: Option<alloc::vec::Vec<IntegerArgumentTypeT>>,
  pub FLOAT_TYPES: Option<alloc::vec::Vec<FloatArgumentTypeT>>,
  pub STRING_TYPES: Option<alloc::vec::Vec<StringArgumentTypeT>>,
  pub BOOLEAN_TYPES: Option<alloc::vec::Vec<BooleanArgumentTypeT>>,
  pub ENUMERATED_TYPES: Option<alloc::vec::Vec<EnumeratedArgumentTypeT>>,
  pub BINARY_TYPES: Option<alloc::vec::Vec<BinaryArgumentTypeT>>,
  pub AGGREGATE_TYPES: Option<alloc::vec::Vec<AggregateArgumentTypeT>>,
}
...
pub struct ArgumentT {
  pub NAME: Option<alloc::string::String>,
  pub ARGUMENT_TYPE_REF: Option<alloc::string::String>,
  pub SHORT_DESCRIPTION: Option<alloc::string::String>,
  pub LONG_DESCRIPTION: Option<alloc::string::String>,
  pub INITIAL_VALUE: Option<alloc::string::String>,
}
...
pub struct ArgumentRefEntryT {
  pub ARGUMENT_REF: Option<alloc::string::String>,
  pub LOCATION: Option<alloc::boxed::Box<LocationInContainerT>>,
  pub SHORT_DESCRIPTION: Option<alloc::string::String>,
}
...
pub struct CommandContainerEntryT {
  pub ARGUMENT_REF_ENTRY: Option<alloc::boxed::Box<ArgumentRefEntryT>>,
  pub PARAMETER_REF_ENTRY: Option<alloc::boxed::Box<ParameterRefEntryT>>,
  pub FIXED_VALUE_ENTRY: Option<alloc::boxed::Box<FixedValueEntryT>>,
}
...
pub struct CommandContainerT {
  pub NAME: Option<alloc::string::String>,
  pub ENTRY_LIST: Option<alloc::vec::Vec<CommandContainerEntryT>>,
  pub BASE_CONTAINER: Option<alloc::boxed::Box<BaseContainerT>>,
}
...
pub struct CommandVerifierT {
  pub NAME: Option<alloc::string::String>,
  pub VERIFIER_TYPE: VerifierType,
  pub CONDITION: Option<alloc::boxed::Box<MatchCriteriaT>>,
  pub CONTAINER_REF: Option<alloc::string::String>,
  pub TIME_WINDOW_START: f64,
  pub TIME_WINDOW_STOP: f64,
  pub TIME_WINDOW_REF: TimeWindowRefType,
...
pub struct CommandSignificanceT {
  pub CONSEQUENCE_LEVEL: u8,
  pub REASON_FOR_WARNING: Option<alloc::string::String>,
}
...
pub struct BaseMetaCommandT {
  pub META_COMMAND_REF: Option<alloc::string::String>,
  pub ARGUMENT_ASSIGNMENTS: Option<alloc::vec::Vec<ArgumentAssignmentT>>,
}
...
pub struct ArgumentAssignmentT {
  pub ARGUMENT_NAME: Option<alloc::string::String>,
  pub VALUE: Option<alloc::string::String>,
}
...
pub struct MetaCommandT {
  ...
  pub LONG_DESCRIPTION: Option<alloc::string::String>,
  pub ABSTRACT: bool,
  pub ARGUMENTS: Option<alloc::vec::Vec<ArgumentT>>,
  pub COMMAND_CONTAINER: Option<alloc::boxed::Box<CommandContainerT>>,
  pub BASE_META_COMMAND: Option<alloc::boxed::Box<BaseMetaCommandT>>,
  pub VERIFIERS: Option<alloc::vec::Vec<CommandVerifierT>>,
  pub SIGNIFICANCE: Option<alloc::boxed::Box<CommandSignificanceT>>,
  pub INTERLOCKS: Option<alloc::vec::Vec<InterlockT>>,
  pub DEFAULT_SIGNIFICANCE: Option<alloc::boxed::Box<CommandSignificanceT>>,
}
...
pub struct MetaCommandSetT {
  pub META_COMMANDS: Option<alloc::vec::Vec<MetaCommandT>>,
}
...
pub struct FixedFrameStreamT {
  ...
  pub SHORT_DESCRIPTION: Option<alloc::string::String>,
  pub FRAME_SIZE_IN_BITS: u32,
  pub SYNC_PATTERN: Option<alloc::string::String>,
}
...
pub struct CustomStreamT {
  pub NAME: Option<alloc::string::String>,
  pub SHORT_DESCRIPTION: Option<alloc::string::String>,
  pub ALGORITHM_REF: Option<alloc::string::String>,
}
...
pub struct StreamSetT {
  pub FIXED_FRAME_STREAMS: Option<alloc::vec::Vec<FixedFrameStreamT>>,
  pub VARIABLE_FRAME_STREAMS: Option<alloc::vec::Vec<VariableFrameStreamT>>,
  pub CUSTOM_STREAMS: Option<alloc::vec::Vec<CustomStreamT>>,
}
...
pub struct ServiceT {
  ...
  pub SHORT_DESCRIPTION: Option<alloc::string::String>,
  pub LONG_DESCRIPTION: Option<alloc::string::String>,
  pub CONTAINER_REFS: Option<alloc::vec::Vec<alloc::string::String>>,
  pub COMMAND_REFS: Option<alloc::vec::Vec<alloc::string::String>>,
}
...
pub struct ServiceSetT {
  pub SERVICES: Option<alloc::vec::Vec<ServiceT>>,
}
...
pub struct XTCHeaderT {
  ...
  pub VALIDATION_STATUS: Option<alloc::string::String>,
  pub AUTHOR: Option<alloc::string::String>,
  pub NOTES: Option<alloc::vec::Vec<alloc::string::String>>,
}
...
pub struct TelemetryMetaDataT {
  pub PARAMETER_TYPE_SET: Option<alloc::boxed::Box<ParameterTypeSetT>>,
  pub PARAMETER_SET: Option<alloc::boxed::Box<ParameterSetT>>,
  pub CONTAINER_SET: Option<alloc::boxed::Box<ContainerSetT>>,
  pub ALGORITHM_SET: Option<alloc::boxed::Box<AlgorithmSetT>>,
  pub STREAM_SET: Option<alloc::boxed::Box<StreamSetT>>,
}
...
pub struct CommandMetaDataT {
  pub ARGUMENT_TYPE_SET: Option<alloc::boxed::Box<ArgumentTypeSetT>>,
  pub PARAMETER_TYPE_SET: Option<alloc::boxed::Box<ParameterTypeSetT>>,
  pub PARAMETER_SET: Option<alloc::boxed::Box<ParameterSetT>>,
  pub META_COMMAND_SET: Option<alloc::boxed::Box<MetaCommandSetT>>,
  pub COMMAND_CONTAINER_SET: Option<alloc::boxed::Box<ContainerSetT>>,
  pub ALGORITHM_SET: Option<alloc::boxed::Box<AlgorithmSetT>>,
  pub STREAM_SET: Option<alloc::boxed::Box<StreamSetT>>,
}
...
pub struct XTCT {
  ...
  pub HEADER: Option<alloc::boxed::Box<XTCHeaderT>>,
  pub TELEMETRY_META_DATA: Option<alloc::boxed::Box<TelemetryMetaDataT>>,
  pub COMMAND_META_DATA: Option<alloc::boxed::Box<CommandMetaDataT>>,
  pub SERVICE_SET: Option<alloc::boxed::Box<ServiceSetT>>,
  pub CHILD_SYSTEMS: Option<alloc::vec::Vec<XTCT>>,
}
...
pub fn root_as_xtc(buf: &[u8]) -> Result<XTC<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_xtc(buf: &[u8]) -> Result<XTC<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_xtc_unchecked(buf: &[u8]) -> XTC<'_> {
  unsafe { ::flatbuffers::root_unchecked::<XTC>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_xtc_unchecked(buf: &[u8]) -> XTC<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<XTC>(buf) }
}
