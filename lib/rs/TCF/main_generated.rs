...
pub fn root_as_tcf(buf: &[u8]) -> Result<TCF<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_tcf(buf: &[u8]) -> Result<TCF<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_tcf_unchecked(buf: &[u8]) -> TCF<'_> {
  unsafe { ::flatbuffers::root_unchecked::<TCF>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_tcf_unchecked(buf: &[u8]) -> TCF<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<TCF>(buf) }
}
