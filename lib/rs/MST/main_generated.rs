...
pub struct MSTT {
  ...
  pub MSG_TYPE: Option<alloc::string::String>,
  pub MSG_SUB_TYPE: Option<alloc::string::String>,
  pub MSG_CREATE_DATE: Option<alloc::string::String>,
  pub ENVIRONMENT: missileEnvironment,
  pub OBJ_TYPE: Option<alloc::string::String>,
  pub OBJ_TYPE_CONF: u8,
  pub OBJ_PLAT: Option<alloc::string::String>,
  pub OBJ_IDENT: Option<alloc::string::String>,
  pub SPACE_AMP: Option<alloc::string::String>,
  pub SPACE_AMP_CONF: u8,
  pub OBJ_ACT: Option<alloc::string::String>,
  pub SPACE_SPEC_TYPE: Option<alloc::string::String>,
  pub ACFT_SUB_TYPE: Option<alloc::string::String>,
  pub NAME: Option<alloc::string::String>,
  pub CALL_SIGN: Option<alloc::string::String>,
  pub LOST_TRK_IND: bool,
  pub TRACK_ID: Option<alloc::string::String>,
  pub PARENT_TRACK_ID: Option<alloc::string::String>,
  pub MUID_SRC_TRK: Option<alloc::string::String>,
  pub MUID_SRC: Option<alloc::string::String>,
  pub ALERT: Option<alloc::string::String>,
  pub MSL_STATUS: missileStatus,
  ...
  pub TRK_QUAL: u8,
  pub ANG_ELEV: f64,
  pub SEN_MODE: Option<alloc::string::String>,
  pub INFO_SOURCE: Option<alloc::string::String>,
  pub BOOSTING: bool,
  pub POLAR_SING_LOC_LAT: f64,
  pub POLAR_SING_LOC_LON: f64,
  pub EMG_IND: bool,
  pub DROP_PT_IND: bool,
  pub LAUNCH_TIME: Option<alloc::string::String>,
  pub LAUNCH_LAT: f64,
  pub LAUNCH_LON: f64,
  pub AZ_CORR: f64,
  pub BURNOUT_ALT: f64,
  pub LAUNCH_AOU_TYPE: aouReportType,
  pub IMPACT_TIME: Option<alloc::string::String>,
  pub IMPACT_LAT: f64,
  pub IMPACT_LON: f64,
  pub IMPACT_AOU_TYPE: aouReportType,
  pub VECTOR_START_TIME: Option<alloc::string::String>,
  pub VECTOR_STEP_SIZE: f64,
  pub VECTOR_COMPONENTS: u8,
  pub VECTORS: Option<alloc::vec::Vec<f64>>,
  pub AOU_RPT: Option<alloc::vec::Vec<f64>>,
  pub LAUNCH_AOU: Option<alloc::vec::Vec<f64>>,
  pub IMPACT_AOU: Option<alloc::vec::Vec<f64>>,
}
...
pub fn root_as_mst(buf: &[u8]) -> Result<MST<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_mst(buf: &[u8]) -> Result<MST<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_mst_unchecked(buf: &[u8]) -> MST<'_> {
  unsafe { ::flatbuffers::root_unchecked::<MST>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_mst_unchecked(buf: &[u8]) -> MST<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<MST>(buf) }
}
