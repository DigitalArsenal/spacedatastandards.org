...
pub struct EWRT {
  ...
  pub ECM_ACTIVE: bool,
  pub RWR_ACTIVE: bool,
  pub ESM_CONTACTS: Option<alloc::vec::Vec<alloc::string::String>>,
  pub ACTIVE_JAMMING: Option<alloc::vec::Vec<alloc::string::String>>,
  pub COUNTERMEASURES: Option<alloc::string::String>,
  pub THREAT_WARNINGS: Option<alloc::vec::Vec<alloc::string::String>>,
  pub EMCON_LEVEL: u8,
  pub LAST_UPDATE_MS: i64,
}
...
pub fn root_as_ewr(buf: &[u8]) -> Result<EWR<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_ewr(buf: &[u8]) -> Result<EWR<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_ewr_unchecked(buf: &[u8]) -> EWR<'_> {
  unsafe { ::flatbuffers::root_unchecked::<EWR>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_ewr_unchecked(buf: &[u8]) -> EWR<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<EWR>(buf) }
}
