...
pub struct OOST {
  ...
  pub ID_SOLAR_ARRAY: Option<alloc::string::String>,
  pub NAME: Option<alloc::string::String>,
  pub CELL_TYPE: Option<alloc::string::String>,
  pub QUANTITY: u32,
  pub AREA: f64,
  pub POWER_BOL: f64,
  pub POWER_EOL: f64,
...
pub fn root_as_oos(buf: &[u8]) -> Result<OOS<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_oos(buf: &[u8]) -> Result<OOS<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_oos_unchecked(buf: &[u8]) -> OOS<'_> {
  unsafe { ::flatbuffers::root_unchecked::<OOS>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_oos_unchecked(buf: &[u8]) -> OOS<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<OOS>(buf) }
}
