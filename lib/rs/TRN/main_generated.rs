...
pub struct TRNT {
  pub SOURCES: Option<alloc::vec::Vec<TerrainDataSource>>,
  pub INTERPOLATION: TerrainInterpolation,
  pub CACHE_ENABLED: bool,
  pub MAX_CACHE_TILES: u16,
  pub VERTICAL_EXAGGERATION: f64,
...
pub fn root_as_trn(buf: &[u8]) -> Result<TRN<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_trn(buf: &[u8]) -> Result<TRN<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_trn_unchecked(buf: &[u8]) -> TRN<'_> {
  unsafe { ::flatbuffers::root_unchecked::<TRN>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_trn_unchecked(buf: &[u8]) -> TRN<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<TRN>(buf) }
}
