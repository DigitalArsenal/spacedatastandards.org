...
pub struct ASTT {
  ...
  pub PROPAGATION_REQUEST: Option<alloc::string::String>,
  pub TLE: Option<alloc::string::String>,
  pub INITIAL_ELEMENTS: Option<alloc::string::String>,
  pub INITIAL_STATE: Option<alloc::string::String>,
  pub EPOCH_MS: i64,
  pub MANEUVER_PLAN: Option<alloc::string::String>,
  pub CONJUNCTION_PRIMARY: Option<alloc::string::String>,
  pub CONJUNCTION_SECONDARY: Option<alloc::string::String>,
  pub OBSERVATIONS: Option<alloc::vec::Vec<alloc::string::String>>,
  pub OD_CONFIG: Option<alloc::string::String>,
  pub GROUND_STATION: Option<alloc::string::String>,
  pub FORMATION_CONFIG: Option<alloc::string::String>,
  pub TARGET_ELEMENTS: Option<alloc::string::String>,
}
...
pub fn root_as_ast(buf: &[u8]) -> Result<AST<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_ast(buf: &[u8]) -> Result<AST<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_ast_unchecked(buf: &[u8]) -> AST<'_> {
  unsafe { ::flatbuffers::root_unchecked::<AST>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_ast_unchecked(buf: &[u8]) -> AST<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<AST>(buf) }
}
