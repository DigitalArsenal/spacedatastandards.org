...
pub struct PLKT {
  pub LICENSE_ID: alloc::string::String,
  pub PLUGIN_ID: alloc::string::String,
  pub PLUGIN_VERSION: Option<alloc::string::String>,
  pub LICENSEE_ORG: alloc::string::String,
  pub LICENSEE_EMAIL: Option<alloc::string::String>,
  pub LICENSEE_PEER_ID: Option<alloc::string::String>,
  pub LICENSEE_PUBKEY: Option<alloc::vec::Vec<u8>>,
  ...
  pub VALID_FROM: u64,
  pub EXPIRES_AT: u64,
  pub ISSUER_PEER_ID: Option<alloc::string::String>,
  pub SIGNATURE: Option<alloc::vec::Vec<u8>>,
}
impl Default for PLKT {
  fn default() -> Self {
    Self {
      LICENSE_ID: alloc::string::ToString::to_string(""),
      PLUGIN_ID: alloc::string::ToString::to_string(""),
      PLUGIN_VERSION: None,
      LICENSEE_ORG: alloc::string::ToString::to_string(""),
      LICENSEE_EMAIL: None,
      LICENSEE_PEER_ID: None,
      LICENSEE_PUBKEY: None,
      ISSUER_PUBKEY: None,
...
pub fn root_as_plk(buf: &[u8]) -> Result<PLK<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_plk(buf: &[u8]) -> Result<PLK<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_plk_unchecked(buf: &[u8]) -> PLK<'_> {
  unsafe { ::flatbuffers::root_unchecked::<PLK>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_plk_unchecked(buf: &[u8]) -> PLK<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<PLK>(buf) }
}
