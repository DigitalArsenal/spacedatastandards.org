...
pub struct ScoreT {
  pub NORAD_CAT_ID: Option<alloc::string::String>,
  pub TYPE: ScoreType,
...
#[derive(Debug, Clone, PartialEq)]
pub struct HYPT {
  pub CAT_IDS: Option<alloc::vec::Vec<alloc::string::String>>,
  pub SIT_IDS: Option<alloc::vec::Vec<alloc::string::String>>,
  pub NAME: Option<alloc::string::String>,
  pub CATEGORY: Option<alloc::string::String>,
  pub ROW_INDICATORS: Option<alloc::vec::Vec<alloc::string::String>>,
  pub COL_INDICATORS: Option<alloc::vec::Vec<alloc::string::String>>,
  pub MATRIX: Option<alloc::vec::Vec<bool>>,
  pub SCORE: Option<alloc::vec::Vec<ScoreT>>,
  pub ANALYSIS_METHOD: Option<alloc::string::String>,
...
pub fn root_as_hyp(buf: &[u8]) -> Result<HYP<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_hyp(buf: &[u8]) -> Result<HYP<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_hyp_unchecked(buf: &[u8]) -> HYP<'_> {
  unsafe { ::flatbuffers::root_unchecked::<HYP>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_hyp_unchecked(buf: &[u8]) -> HYP<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<HYP>(buf) }
}
