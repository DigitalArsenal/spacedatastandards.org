...
pub struct SWRT {
  ...
  pub LAT: f64,
  pub LON: f64,
  pub LOCATION_NAME: Option<alloc::string::String>,
  pub BAD_WAVE: Option<alloc::string::String>,
  pub WAVELENGTHS: Option<alloc::vec::Vec<f64>>,
  pub ABS_FLUXES: Option<alloc::vec::Vec<f64>>,
  pub RATIO_WAVELENGTHS: Option<alloc::vec::Vec<f64>>,
  pub FLUX_RATIOS: Option<alloc::vec::Vec<f64>>,
  pub TEMPERATURE: f64,
  pub SIGNAL_NOISE_RATIO: f64,
  pub INTEGRATION_TIME: f64,
  pub QUALITY: u8,
...
pub fn root_as_swr(buf: &[u8]) -> Result<SWR<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_swr(buf: &[u8]) -> Result<SWR<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_swr_unchecked(buf: &[u8]) -> SWR<'_> {
  unsafe { ::flatbuffers::root_unchecked::<SWR>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_swr_unchecked(buf: &[u8]) -> SWR<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<SWR>(buf) }
}
