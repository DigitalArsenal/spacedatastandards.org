...
pub struct ENVT {
  pub ATMOSPHERE: Option<alloc::string::String>,
  pub WEATHER: Option<alloc::string::String>,
  pub TIME_UTC: f64,
  pub LATITUDE: f64,
  pub LONGITUDE: f64,
  pub SUN_AZIMUTH: f32,
...
pub fn root_as_env(buf: &[u8]) -> Result<ENV<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_env(buf: &[u8]) -> Result<ENV<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_env_unchecked(buf: &[u8]) -> ENV<'_> {
  unsafe { ::flatbuffers::root_unchecked::<ENV>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_env_unchecked(buf: &[u8]) -> ENV<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<ENV>(buf) }
}
