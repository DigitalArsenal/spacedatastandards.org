...
pub struct DOAT {
  ...
  pub COLLECTION_MODE: doaCollectionMode,
  pub ID_SENSOR1: Option<alloc::string::String>,
  pub ORIG_SENSOR_ID1: Option<alloc::string::String>,
  pub SENLAT: f64,
  pub SENLON: f64,
  pub SENALT: f64,
  pub SENSOR1_DELAY: f64,
  pub ID_SENSOR2: Option<alloc::string::String>,
  pub ORIG_SENSOR_ID2: Option<alloc::string::String>,
  pub SEN2LAT: f64,
  pub SEN2LON: f64,
  pub SEN2ALT: f64,
  pub SENSOR2_DELAY: f64,
...
pub fn root_as_doa(buf: &[u8]) -> Result<DOA<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_doa(buf: &[u8]) -> Result<DOA<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_doa_unchecked(buf: &[u8]) -> DOA<'_> {
  unsafe { ::flatbuffers::root_unchecked::<DOA>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_doa_unchecked(buf: &[u8]) -> DOA<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<DOA>(buf) }
}
