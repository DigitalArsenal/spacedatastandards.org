...
pub struct OOBT {
  ...
  pub ID_BATTERY: Option<alloc::string::String>,
  pub NAME: Option<alloc::string::String>,
  pub CHEMISTRY: Option<alloc::string::String>,
  pub QUANTITY: u32,
  pub VOLTAGE: f64,
  pub CAPACITY_AH: f64,
  pub ENERGY_WH: f64,
...
pub fn root_as_oob(buf: &[u8]) -> Result<OOB<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_oob(buf: &[u8]) -> Result<OOB<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_oob_unchecked(buf: &[u8]) -> OOB<'_> {
  unsafe { ::flatbuffers::root_unchecked::<OOB>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_oob_unchecked(buf: &[u8]) -> OOB<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<OOB>(buf) }
}
