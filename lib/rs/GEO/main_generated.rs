...
pub struct GEOT {
  ...
  pub CONFIDENCE: geoConfidence,
  pub TROUGH: troughType,
  pub PLANE_CHANGE_STATUS: Option<alloc::string::String>,
  pub LOST_FLAG: bool,
  pub SEMI_ANNUAL_CORR_FLAG: bool,
...
pub fn root_as_geo(buf: &[u8]) -> Result<GEO<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_geo(buf: &[u8]) -> Result<GEO<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_geo_unchecked(buf: &[u8]) -> GEO<'_> {
  unsafe { ::flatbuffers::root_unchecked::<GEO>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_geo_unchecked(buf: &[u8]) -> GEO<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<GEO>(buf) }
}
