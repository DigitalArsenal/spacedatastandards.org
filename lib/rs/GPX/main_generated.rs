...
pub struct GPXWaypointT {
  ...
  pub LINKS: Option<alloc::vec::Vec<GPXLinkT>>,
...
pub struct GPXTrackSegmentT {
  pub POINTS: Option<alloc::vec::Vec<GPXWaypointT>>,
}
...
pub struct GPXTrackT {
  ...
  pub NUMBER: u32,
  pub TYPE: Option<alloc::string::String>,
  pub SEGMENTS: Option<alloc::vec::Vec<GPXTrackSegmentT>>,
}
...
pub struct GPXT {
  ...
  pub CREATOR: Option<alloc::string::String>,
  pub NAME: Option<alloc::string::String>,
  pub DESCRIPTION: Option<alloc::string::String>,
  pub AUTHOR_NAME: Option<alloc::string::String>,
  pub AUTHOR_EMAIL: Option<alloc::string::String>,
  pub AUTHOR_LINK: Option<alloc::boxed::Box<GPXLinkT>>,
  pub COPYRIGHT_AUTHOR: Option<alloc::string::String>,
  pub COPYRIGHT_YEAR: Option<alloc::string::String>,
  pub COPYRIGHT_LICENSE: Option<alloc::string::String>,
  pub LINKS: Option<alloc::vec::Vec<GPXLinkT>>,
  pub TIME: Option<alloc::string::String>,
  pub KEYWORDS: Option<alloc::string::String>,
  pub BOUNDS_MIN_LAT: f64,
  pub BOUNDS_MIN_LON: f64,
  pub BOUNDS_MAX_LAT: f64,
  pub BOUNDS_MAX_LON: f64,
  pub WAYPOINTS: Option<alloc::vec::Vec<GPXWaypointT>>,
  pub ROUTES: Option<alloc::vec::Vec<GPXRouteT>>,
  pub TRACKS: Option<alloc::vec::Vec<GPXTrackT>>,
}
...
pub fn root_as_gpx(buf: &[u8]) -> Result<GPX<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_gpx(buf: &[u8]) -> Result<GPX<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_gpx_unchecked(buf: &[u8]) -> GPX<'_> {
  unsafe { ::flatbuffers::root_unchecked::<GPX>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_gpx_unchecked(buf: &[u8]) -> GPX<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<GPX>(buf) }
}
