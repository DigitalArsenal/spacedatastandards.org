...
pub fn root_as_arm(buf: &[u8]) -> Result<ARM<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_arm(buf: &[u8]) -> Result<ARM<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_arm_unchecked(buf: &[u8]) -> ARM<'_> {
  unsafe { ::flatbuffers::root_unchecked::<ARM>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_arm_unchecked(buf: &[u8]) -> ARM<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<ARM>(buf) }
}
