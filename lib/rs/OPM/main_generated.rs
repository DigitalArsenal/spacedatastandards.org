...
pub struct OPMT {
  pub CCSDS_OPM_VERS: Option<alloc::string::String>,
...
pub fn root_as_opm(buf: &[u8]) -> Result<OPM<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_opm(buf: &[u8]) -> Result<OPM<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_opm_unchecked(buf: &[u8]) -> OPM<'_> {
  unsafe { ::flatbuffers::root_unchecked::<OPM>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_opm_unchecked(buf: &[u8]) -> OPM<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<OPM>(buf) }
}
