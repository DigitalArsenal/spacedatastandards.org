...
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
pub const ENUM_MAX_ANOMALY_TYPE: i8 = 2;
#[deprecated(since = "2.0.0", note = "Use associated constants instead. This will no longer be generated in 2021.")]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_ANOMALY_TYPE: [anomalyType; 3] = [
  anomalyType::TRUE_ANOMALY,
  anomalyType::MEAN_ANOMALY,
  anomalyType::ECCENTRIC_ANOMALY,
];
...
pub struct PPEPositionRecordT {
  pub EPOCH_MID: String,
  pub EPOCH_HALF_SPAN: f64,
  pub NUM_COEFFICIENTS: u16,
  pub BASIS_TYPE: polynomialBasisType,
  pub POS_COEFF_X: Vec<f64>,
  pub POS_COEFF_Y: Vec<f64>,
  pub POS_COEFF_Z: Vec<f64>,
  pub HAS_VELOCITY_COEFFICIENTS: bool,
  pub VEL_COEFF_X: Option<Vec<f64>>,
  pub VEL_COEFF_Y: Option<Vec<f64>>,
  pub VEL_COEFF_Z: Option<Vec<f64>>,
  pub MAX_POSITION_RESIDUAL: f64,
  pub RMS_POSITION_RESIDUAL: f64,
}
...
impl<'a> PPEOrbitalElementRecord<'a> {
  ...
  pub fn ANOMALY_TYPE(&self) -> anomalyType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<anomalyType>(PPEOrbitalElementRecord::VT_ANOMALY_TYPE, Some(anomalyType::TRUE_ANOMALY)).unwrap()}
  }
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> PPEOrbitalElementRecordBuilder<'a, 'b, A> {
  ...
  pub fn add_ANOMALY_TYPE(&mut self, ANOMALY_TYPE: anomalyType) {
    self.fbb_.push_slot::<anomalyType>(PPEOrbitalElementRecord::VT_ANOMALY_TYPE, ANOMALY_TYPE, anomalyType::TRUE_ANOMALY);
  }
  #[inline]
...
pub struct PPEOrbitalElementRecordT {
  ...
  pub SIZE_SHAPE_TYPE: sizeShapeType,
  pub ANOMALY_TYPE: anomalyType,
  pub COEFF_SIZE_SHAPE: Vec<f64>,
  pub COEFF_ECCENTRICITY: Vec<f64>,
  pub COEFF_INCLINATION: Vec<f64>,
  pub COEFF_RAAN: Vec<f64>,
  pub COEFF_ARG_PERIAPSIS: Vec<f64>,
  pub COEFF_ANOMALY: Vec<f64>,
  pub MAX_ELEMENT_RESIDUAL: f64,
  pub RMS_ELEMENT_RESIDUAL: f64,
}
...
pub struct PPET {
  ...
  pub DEFAULT_BASIS_TYPE: polynomialBasisType,
  pub POSITION_RECORDS: Option<Vec<PPEPositionRecordT>>,
  pub ORBITAL_ELEMENT_RECORDS: Option<Vec<PPEOrbitalElementRecordT>>,
...
pub fn root_as_PPE(buf: &[u8]) -> Result<PPE, flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_PPE(buf: &[u8]) -> Result<PPE, flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_PPE_unchecked(buf: &[u8]) -> PPE {
  flatbuffers::root_unchecked::<PPE>(buf)
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_PPE_unchecked(buf: &[u8]) -> PPE {
  flatbuffers::size_prefixed_root_unchecked::<PPE>(buf)
}
