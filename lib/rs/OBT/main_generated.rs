...
pub struct OBTT {
  ...
  pub CH_XREF: Option<alloc::string::String>,
  pub AMPLIFICATION: Option<alloc::string::String>,
  pub IFF: Option<alloc::string::String>,
  pub VEH_TYPE: Option<alloc::string::String>,
  pub REINFORCED: bool,
  pub REDUCED: bool,
  pub HQ: bool,
  pub DUMMY: bool,
  ...
  pub FEINT: bool,
  pub INSTALLATION: bool,
  pub TRACK_SENSORS: Option<alloc::vec::Vec<alloc::string::String>>,
}
...
pub fn root_as_obt(buf: &[u8]) -> Result<OBT<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_obt(buf: &[u8]) -> Result<OBT<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_obt_unchecked(buf: &[u8]) -> OBT<'_> {
  unsafe { ::flatbuffers::root_unchecked::<OBT>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_obt_unchecked(buf: &[u8]) -> OBT<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<OBT>(buf) }
}
