...
pub struct OSMT {
  ...
  pub PASS_START: Option<alloc::string::String>,
  pub PASS_DURATION: i32,
}
...
pub fn root_as_osm(buf: &[u8]) -> Result<OSM<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_osm(buf: &[u8]) -> Result<OSM<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_osm_unchecked(buf: &[u8]) -> OSM<'_> {
  unsafe { ::flatbuffers::root_unchecked::<OSM>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_osm_unchecked(buf: &[u8]) -> OSM<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<OSM>(buf) }
}
