...
pub struct SPWCOLLECTIONT {
  pub RECORDS: Option<alloc::vec::Vec<SPWT>>,
}
...
pub fn root_as_spw(buf: &[u8]) -> Result<SPW<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_spw(buf: &[u8]) -> Result<SPW<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_spw_unchecked(buf: &[u8]) -> SPW<'_> {
  unsafe { ::flatbuffers::root_unchecked::<SPW>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_spw_unchecked(buf: &[u8]) -> SPW<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<SPW>(buf) }
}
