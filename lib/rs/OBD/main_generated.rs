...
pub struct odSensorContributionT {
  ...
  pub NUM_REJECTED: u32,
  pub WRMS: f64,
  pub OB_TYPES: Option<alloc::vec::Vec<alloc::string::String>>,
}
...
pub struct OBDT {
  ...
  pub METHOD: odMethod,
  pub METHOD_SOURCE: Option<alloc::string::String>,
  pub INITIAL_OD: bool,
  pub APRIORI_ID_ELSET: Option<alloc::string::String>,
  pub APRIORI_ELSET: Option<alloc::string::String>,
  pub APRIORI_ID_STATE_VECTOR: Option<alloc::string::String>,
  pub APRIORI_STATE_VECTOR: Option<alloc::string::String>,
  pub LAST_OB_START: Option<alloc::string::String>,
  pub LAST_OB_END: Option<alloc::string::String>,
  pub TIME_SPAN: f64,
  pub FIT_SPAN: f64,
  pub EFFECTIVE_FROM: Option<alloc::string::String>,
  pub EFFECTIVE_UNTIL: Option<alloc::string::String>,
  pub WRMS: f64,
  pub PREVIOUS_WRMS: f64,
  pub FIRST_PASS_WRMS: f64,
  pub BEST_PASS_WRMS: f64,
  ...
  pub EDR: f64,
  pub BALLISTIC_COEFF_EST: bool,
  pub BALLISTIC_COEFF_MODEL: Option<alloc::string::String>,
  pub AGOM_EST: bool,
  pub AGOM_MODEL: Option<alloc::string::String>,
  pub RMS_CONVERGENCE_CRITERIA: f64,
  pub NUM_ITERATIONS: u16,
  pub NUM_ACCEPTED_OBS: u32,
  pub NUM_REJECTED_OBS: u32,
  pub SENSORS: Option<alloc::vec::Vec<odSensorContributionT>>,
  pub ACCEPTED_OB_TYPS: Option<alloc::vec::Vec<alloc::string::String>>,
  pub ACCEPTED_OB_IDS: Option<alloc::vec::Vec<alloc::string::String>>,
  pub REJECTED_OB_TYPS: Option<alloc::vec::Vec<alloc::string::String>>,
  pub REJECTED_OB_IDS: Option<alloc::vec::Vec<alloc::string::String>>,
}
...
pub fn root_as_obd(buf: &[u8]) -> Result<OBD<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_obd(buf: &[u8]) -> Result<OBD<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_obd_unchecked(buf: &[u8]) -> OBD<'_> {
  unsafe { ::flatbuffers::root_unchecked::<OBD>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_obd_unchecked(buf: &[u8]) -> OBD<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<OBD>(buf) }
}
