...
pub struct GJNLinearRingT {
  pub POSITIONS: Option<alloc::vec::Vec<GJNPositionT>>,
}
...
pub struct GJNPolygonRingsT {
  pub RINGS: Option<alloc::vec::Vec<GJNLinearRingT>>,
}
...
pub struct GJNGeometryT {
  pub TYPE: GJNGeometryType,
  pub POINT: Option<alloc::boxed::Box<GJNPositionT>>,
  pub POSITIONS: Option<alloc::vec::Vec<GJNPositionT>>,
  pub RINGS: Option<alloc::vec::Vec<GJNLinearRingT>>,
  pub POLYGON_RINGS: Option<alloc::vec::Vec<GJNPolygonRingsT>>,
  pub GEOMETRIES: Option<alloc::vec::Vec<GJNGeometryT>>,
  pub BBOX: Option<alloc::boxed::Box<GJNBoundingBoxT>>,
}
...
pub struct GJNPropertyT {
  ...
  pub BOOL_VALUE: bool,
  pub IS_NULL: bool,
  pub JSON_VALUE: Option<alloc::string::String>,
}
...
pub struct GJNFeatureT {
  ...
  pub GEOMETRY: Option<alloc::boxed::Box<GJNGeometryT>>,
  pub PROPERTIES: Option<alloc::vec::Vec<GJNPropertyT>>,
  pub NUM_ID: f64,
  pub ID_IS_NUMERIC: bool,
  pub HAS_GEOMETRY: bool,
  pub PROPERTIES_IS_NULL: bool,
...
#[derive(Debug, Clone, PartialEq)]
pub struct GJNT {
  pub FEATURES: Option<alloc::vec::Vec<GJNFeatureT>>,
  pub BBOX: Option<alloc::boxed::Box<GJNBoundingBoxT>>,
}
...
pub fn root_as_gjn(buf: &[u8]) -> Result<GJN<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_gjn(buf: &[u8]) -> Result<GJN<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_gjn_unchecked(buf: &[u8]) -> GJN<'_> {
  unsafe { ::flatbuffers::root_unchecked::<GJN>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_gjn_unchecked(buf: &[u8]) -> GJN<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<GJN>(buf) }
}
