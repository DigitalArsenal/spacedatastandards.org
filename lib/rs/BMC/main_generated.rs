...
pub struct BMCT {
  ...
  pub CONTOUR_IDX: i32,
  pub GAIN: f64,
  pub REGION_NAME: Option<alloc::string::String>,
  pub GEOGRAPHY: Option<alloc::string::String>,
  pub GEOGRAPHY_TEXT: Option<alloc::string::String>,
  pub GEOGRAPHY_JSON: Option<alloc::string::String>,
  pub GEOGRAPHY_TYPE: Option<alloc::string::String>,
  pub GEOGRAPHY_NDIMS: i32,
  pub GEOGRAPHY_SRID: i32,
}
...
pub fn root_as_bmc(buf: &[u8]) -> Result<BMC<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_bmc(buf: &[u8]) -> Result<BMC<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_bmc_unchecked(buf: &[u8]) -> BMC<'_> {
  unsafe { ::flatbuffers::root_unchecked::<BMC>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_bmc_unchecked(buf: &[u8]) -> BMC<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<BMC>(buf) }
}
