...
pub struct ACRT {
  ...
  pub CG_X: f32,
  pub CG_Z: f32,
  pub AERO: Option<alloc::string::String>,
  pub CONTROLS: Option<alloc::string::String>,
  pub ENGINE: Option<alloc::string::String>,
  pub GEAR_STATE: u8,
  pub GEAR_POSITION: u8,
  pub FLAP_POSITION: u8,
  pub SPEEDBRAKE_POS: u8,
...
pub fn root_as_acr(buf: &[u8]) -> Result<ACR<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_acr(buf: &[u8]) -> Result<ACR<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_acr_unchecked(buf: &[u8]) -> ACR<'_> {
  unsafe { ::flatbuffers::root_unchecked::<ACR>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_acr_unchecked(buf: &[u8]) -> ACR<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<ACR>(buf) }
}
