...
pub struct BALT {
  ...
  pub TRAJECTORY_REQUEST: Option<alloc::string::String>,
  pub TABLE_REQUEST: Option<alloc::string::String>,
  pub FIRE_CONTROL: Option<alloc::string::String>,
  pub PENETRATION_PROJECTILE: Option<alloc::string::String>,
  pub PENETRATION_ARMOR: Option<alloc::string::String>,
  pub IMPACT_VELOCITY_MPS: f64,
  pub IMPACT_ANGLE_DEG: f64,
}
...
pub fn root_as_bal(buf: &[u8]) -> Result<BAL<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_bal(buf: &[u8]) -> Result<BAL<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_bal_unchecked(buf: &[u8]) -> BAL<'_> {
  unsafe { ::flatbuffers::root_unchecked::<BAL>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_bal_unchecked(buf: &[u8]) -> BAL<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<BAL>(buf) }
}
