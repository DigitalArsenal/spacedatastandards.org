...
pub struct COTDetailT {
  pub CALLSIGN: Option<alloc::string::String>,
  pub ENDPOINT: Option<alloc::string::String>,
  pub PHONE: Option<alloc::string::String>,
  pub COURSE: f64,
  pub SPEED: f64,
  pub GROUP_NAME: Option<alloc::string::String>,
  pub GROUP_ROLE: Option<alloc::string::String>,
  pub STATUS_BATTERY: f64,
  pub STATUS_READINESS: bool,
  pub PREC_LOCATION_SOURCE: Option<alloc::string::String>,
  pub PREC_ALTSRC: Option<alloc::string::String>,
  pub UID_DROID: Option<alloc::string::String>,
  pub REMARKS: Option<alloc::string::String>,
  pub REMARKS_SOURCE: Option<alloc::string::String>,
  pub REMARKS_TIME: Option<alloc::string::String>,
  pub LINK_UID: Option<alloc::string::String>,
  pub LINK_TYPE: Option<alloc::string::String>,
  pub LINK_RELATION: Option<alloc::string::String>,
  pub COLOR: i32,
  pub STROKE_WEIGHT: f64,
  pub FILL_COLOR: i32,
  pub LABELLED: bool,
  pub ARCHIVE: bool,
  pub RAW_XML: Option<alloc::string::String>,
}
...
pub struct COTT {
  ...
  pub UID: Option<alloc::string::String>,
  pub TYPE: Option<alloc::string::String>,
  pub HOW: COTHowType,
  pub TIME: Option<alloc::string::String>,
  pub START: Option<alloc::string::String>,
  pub STALE: Option<alloc::string::String>,
  pub ACCESS: Option<alloc::string::String>,
  pub QOS: Option<alloc::string::String>,
  pub OPEX: Option<alloc::string::String>,
  pub POINT: Option<alloc::boxed::Box<COTPointT>>,
  pub DETAIL: Option<alloc::boxed::Box<COTDetailT>>,
}
...
pub fn root_as_cot(buf: &[u8]) -> Result<COT<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_cot(buf: &[u8]) -> Result<COT<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_cot_unchecked(buf: &[u8]) -> COT<'_> {
  unsafe { ::flatbuffers::root_unchecked::<COT>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_cot_unchecked(buf: &[u8]) -> COT<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<COT>(buf) }
}
