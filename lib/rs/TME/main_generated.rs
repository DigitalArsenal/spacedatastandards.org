...
pub struct TMET {
  pub COMMAND: Option<alloc::string::String>,
  pub CONVERSION_REQUEST: Option<alloc::string::String>,
  pub LEAP_SECOND_QUERY: Option<alloc::string::String>,
  pub EOP_QUERY: Option<alloc::string::String>,
  pub SIDEREAL_QUERY: Option<alloc::string::String>,
  pub INTERVAL_REQUEST: Option<alloc::string::String>,
  pub SOLAR_POSITION_QUERY: Option<alloc::string::String>,
  pub LUNAR_POSITION_QUERY: Option<alloc::string::String>,
  pub SUNRISE_SUNSET_QUERY: Option<alloc::vec::Vec<f64>>,
  pub CLOCK_PROPAGATION: Option<alloc::string::String>,
}
...
pub fn root_as_tme(buf: &[u8]) -> Result<TME<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_tme(buf: &[u8]) -> Result<TME<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_tme_unchecked(buf: &[u8]) -> TME<'_> {
  unsafe { ::flatbuffers::root_unchecked::<TME>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_tme_unchecked(buf: &[u8]) -> TME<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<TME>(buf) }
}
