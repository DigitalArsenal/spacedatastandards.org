...
pub struct RDOT {
  ...
  pub OB_POSITION: Option<alloc::string::String>,
...
pub fn root_as_rdo(buf: &[u8]) -> Result<RDO<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_rdo(buf: &[u8]) -> Result<RDO<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_rdo_unchecked(buf: &[u8]) -> RDO<'_> {
  unsafe { ::flatbuffers::root_unchecked::<RDO>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_rdo_unchecked(buf: &[u8]) -> RDO<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<RDO>(buf) }
}
