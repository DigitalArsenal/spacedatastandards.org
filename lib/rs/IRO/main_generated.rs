...
pub struct IROT {
  ...
  pub SPECTRAL_VALUES: Option<alloc::vec::Vec<f64>>,
  pub QUALITY: u8,
...
pub fn root_as_iro(buf: &[u8]) -> Result<IRO<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_iro(buf: &[u8]) -> Result<IRO<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_iro_unchecked(buf: &[u8]) -> IRO<'_> {
  unsafe { ::flatbuffers::root_unchecked::<IRO>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_iro_unchecked(buf: &[u8]) -> IRO<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<IRO>(buf) }
}
