...
pub struct KMLIconStyleT {
  ...
  pub SCALE: f64,
  pub HEADING: f64,
  pub ICON_HREF: Option<alloc::string::String>,
  pub HOTSPOT_X: f64,
  pub HOTSPOT_Y: f64,
  pub HOTSPOT_X_UNITS: KMLUnits,
  pub HOTSPOT_Y_UNITS: KMLUnits,
...
pub struct KMLLineStyleT {
  ...
  pub COLOR_MODE: KMLColorMode,
  pub WIDTH: f64,
  pub GX_OUTER_COLOR: Option<alloc::string::String>,
  pub GX_OUTER_WIDTH: f64,
  pub GX_PHYSICAL_WIDTH: f64,
  pub GX_LABEL_VISIBILITY: bool,
}
...
pub struct KMLBalloonStyleT {
  pub BG_COLOR: Option<alloc::string::String>,
...
pub struct KMLItemIconT {
  pub STATE: Option<alloc::string::String>,
  pub HREF: Option<alloc::string::String>,
}
...
pub struct KMLListStyleT {
  pub LIST_ITEM_TYPE: KMLListItemType,
  pub BG_COLOR: Option<alloc::string::String>,
  pub ITEM_ICONS: Option<alloc::vec::Vec<KMLItemIconT>>,
  pub MAX_SNIPPET_LINES: i32,
}
...
pub struct KMLStyleT {
  ...
  pub ICON_STYLE: Option<alloc::boxed::Box<KMLIconStyleT>>,
  pub LABEL_STYLE: Option<alloc::boxed::Box<KMLLabelStyleT>>,
  pub LINE_STYLE: Option<alloc::boxed::Box<KMLLineStyleT>>,
  pub POLY_STYLE: Option<alloc::boxed::Box<KMLPolyStyleT>>,
  pub BALLOON_STYLE: Option<alloc::boxed::Box<KMLBalloonStyleT>>,
  pub LIST_STYLE: Option<alloc::boxed::Box<KMLListStyleT>>,
}
...
pub struct KMLStyleMapPairT {
  pub STATE: KMLStyleState,
  pub STYLE_URL: Option<alloc::string::String>,
}
...
pub struct KMLStyleMapT {
  pub ID: Option<alloc::string::String>,
  pub PAIRS: Option<alloc::vec::Vec<KMLStyleMapPairT>>,
}
...
pub struct KMLPointT {
  pub COORDINATES: Option<alloc::boxed::Box<KMLCoordinateT>>,
  pub ALTITUDE_MODE: KMLAltitudeMode,
  pub EXTRUDE: bool,
}
...
pub struct KMLLineStringT {
  pub COORDINATES: Option<alloc::vec::Vec<KMLCoordinateT>>,
  pub ALTITUDE_MODE: KMLAltitudeMode,
  pub EXTRUDE: bool,
  pub TESSELLATE: bool,
  pub GX_DRAW_ORDER: i32,
...
pub struct KMLPolygonT {
  pub OUTER_BOUNDARY: Option<alloc::boxed::Box<KMLLinearRingT>>,
  pub INNER_BOUNDARIES: Option<alloc::vec::Vec<KMLLinearRingT>>,
  pub ALTITUDE_MODE: KMLAltitudeMode,
  pub EXTRUDE: bool,
  pub TESSELLATE: bool,
}
...
pub struct KMLResourceMapAliasT {
  pub TARGET_HREF: Option<alloc::string::String>,
  pub SOURCE_HREF: Option<alloc::string::String>,
}
...
pub struct KMLModelT {
  ...
  pub SCALE_Y: f64,
  pub SCALE_Z: f64,
  pub LINK_HREF: Option<alloc::string::String>,
  pub RESOURCE_MAP: Option<alloc::vec::Vec<KMLResourceMapAliasT>>,
}
...
pub struct KMLTrackT {
  ...
  pub TESSELLATE: bool,
  pub ALTITUDE_MODE: KMLAltitudeMode,
  pub WHEN: Option<alloc::vec::Vec<alloc::string::String>>,
  pub COORDS: Option<alloc::vec::Vec<KMLCoordinateT>>,
  pub ANGLES: Option<alloc::vec::Vec<KMLCoordinateT>>,
  pub MODEL: Option<alloc::boxed::Box<KMLModelT>>,
}
...
pub struct KMLMultiTrackT {
  pub ALTITUDE_MODE: KMLAltitudeMode,
  pub INTERPOLATE: bool,
  pub TRACKS: Option<alloc::vec::Vec<KMLTrackT>>,
}
...
pub struct KMLMultiGeometryT {
  pub POINTS: Option<alloc::vec::Vec<KMLPointT>>,
  pub LINE_STRINGS: Option<alloc::vec::Vec<KMLLineStringT>>,
  pub POLYGONS: Option<alloc::vec::Vec<KMLPolygonT>>,
  pub MULTI_GEOMETRIES: Option<alloc::vec::Vec<KMLMultiGeometryT>>,
  pub LINEAR_RINGS: Option<alloc::vec::Vec<KMLLinearRingT>>,
  pub MODELS: Option<alloc::vec::Vec<KMLModelT>>,
  pub TRACKS: Option<alloc::vec::Vec<KMLTrackT>>,
  pub MULTI_TRACKS: Option<alloc::vec::Vec<KMLMultiTrackT>>,
}
...
pub struct KMLTimeSpanT {
  pub BEGIN: Option<alloc::string::String>,
  pub END: Option<alloc::string::String>,
}
...
pub struct KMLTimeStampT {
  pub WHEN: Option<alloc::string::String>,
}
...
pub struct KMLSimpleFieldT {
  pub NAME: Option<alloc::string::String>,
  pub FIELD_TYPE: Option<alloc::string::String>,
  pub DISPLAY_NAME: Option<alloc::string::String>,
}
...
pub struct KMLSchemaT {
  pub NAME: Option<alloc::string::String>,
  pub ID: Option<alloc::string::String>,
  pub SIMPLE_FIELDS: Option<alloc::vec::Vec<KMLSimpleFieldT>>,
}
...
pub struct KMLSchemaDataT {
  pub SCHEMA_URL: Option<alloc::string::String>,
  pub SIMPLE_DATA: Option<alloc::vec::Vec<KMLSimpleDataT>>,
}
...
pub struct KMLRegionT {
  pub LAT_LON_ALT_BOX: Option<alloc::boxed::Box<KMLLatLonAltBoxT>>,
  pub LOD: Option<alloc::boxed::Box<KMLLodT>>,
}
...
pub struct KMLLinkT {
  ...
  pub VIEW_REFRESH_TIME: f64,
  pub VIEW_BOUND_SCALE: f64,
  pub VIEW_FORMAT: Option<alloc::string::String>,
  pub HTTP_QUERY: Option<alloc::string::String>,
}
...
pub struct KMLNetworkLinkT {
  ...
  pub REFRESH_VISIBILITY: bool,
  pub FLY_TO_VIEW: bool,
  pub LINK: Option<alloc::boxed::Box<KMLLinkT>>,
}
...
pub struct KMLPhotoOverlayT {
  ...
  pub DRAW_ORDER: i32,
  pub ROTATION: f64,
  pub VIEW_VOLUME: Option<alloc::boxed::Box<KMLViewVolumeT>>,
  pub IMAGE_PYRAMID: Option<alloc::boxed::Box<KMLImagePyramidT>>,
  pub POINT: Option<alloc::boxed::Box<KMLPointT>>,
  pub SHAPE: KMLShape,
}
...
pub struct KMLGroundOverlayT {
  ...
  pub ALTITUDE_MODE: KMLAltitudeMode,
  pub DRAW_ORDER: i32,
  pub LAT_LON_QUAD: Option<alloc::boxed::Box<KMLLatLonQuadT>>,
  pub STYLE_URL: Option<alloc::string::String>,
  pub REGION: Option<alloc::boxed::Box<KMLRegionT>>,
}
...
pub struct KMLUpdateT {
  pub TARGET_HREF: Option<alloc::string::String>,
  pub CHANGE_KML: Option<alloc::string::String>,
  pub CREATE_KML: Option<alloc::string::String>,
  pub DELETE_KML: Option<alloc::string::String>,
}
...
pub struct KMLNetworkLinkControlT {
  ...
  pub LINK_DESCRIPTION: Option<alloc::string::String>,
  pub LINK_SNIPPET: Option<alloc::string::String>,
  pub EXPIRES: Option<alloc::string::String>,
  pub UPDATE: Option<alloc::boxed::Box<KMLUpdateT>>,
  pub LOOK_AT: Option<alloc::boxed::Box<KMLLookAtT>>,
  pub CAMERA: Option<alloc::boxed::Box<KMLCameraT>>,
}
...
pub struct KMLTourControlT {
  pub PLAY_MODE: Option<alloc::string::String>,
}
...
pub struct KMLTourPrimitiveT {
  pub FLY_TO: Option<alloc::boxed::Box<KMLFlyToT>>,
  pub WAIT: Option<alloc::boxed::Box<KMLWaitT>>,
  pub ANIMATED_UPDATE: Option<alloc::boxed::Box<KMLAnimatedUpdateT>>,
  pub TOUR_CONTROL: Option<alloc::boxed::Box<KMLTourControlT>>,
  pub SOUND_CUE: Option<alloc::boxed::Box<KMLSoundCueT>>,
}
...
pub struct KMLPlaylistT {
  pub PRIMITIVES: Option<alloc::vec::Vec<KMLTourPrimitiveT>>,
}
...
pub struct KMLTourT {
  ...
  pub DESCRIPTION: Option<alloc::string::String>,
  pub VISIBILITY: bool,
  pub PLAYLIST: Option<alloc::boxed::Box<KMLPlaylistT>>,
}
...
pub struct KMLPlacemarkT {
  ...
  pub VISIBILITY: bool,
  pub STYLE_URL: Option<alloc::string::String>,
  pub STYLE: Option<alloc::boxed::Box<KMLStyleT>>,
  pub SNIPPET: Option<alloc::string::String>,
  pub OPEN: bool,
  pub ADDRESS: Option<alloc::string::String>,
  pub POINT: Option<alloc::boxed::Box<KMLPointT>>,
  pub LINE_STRING: Option<alloc::boxed::Box<KMLLineStringT>>,
  pub POLYGON: Option<alloc::boxed::Box<KMLPolygonT>>,
  pub LINEAR_RING: Option<alloc::boxed::Box<KMLLinearRingT>>,
  pub MULTI_GEOMETRY: Option<alloc::boxed::Box<KMLMultiGeometryT>>,
  pub MODEL: Option<alloc::boxed::Box<KMLModelT>>,
  pub TRACK: Option<alloc::boxed::Box<KMLTrackT>>,
  pub MULTI_TRACK: Option<alloc::boxed::Box<KMLMultiTrackT>>,
  pub LOOK_AT: Option<alloc::boxed::Box<KMLLookAtT>>,
  pub CAMERA: Option<alloc::boxed::Box<KMLCameraT>>,
  pub TIME_SPAN: Option<alloc::boxed::Box<KMLTimeSpanT>>,
  pub TIME_STAMP: Option<alloc::boxed::Box<KMLTimeStampT>>,
  pub EXTENDED_DATA: Option<alloc::vec::Vec<KMLDataT>>,
  pub SCHEMA_DATA: Option<alloc::boxed::Box<KMLSchemaDataT>>,
  pub REGION: Option<alloc::boxed::Box<KMLRegionT>>,
  pub STYLE_MAP: Option<alloc::boxed::Box<KMLStyleMapT>>,
}
...
pub struct KMLFolderT {
  ...
  pub VISIBILITY: bool,
  pub OPEN: bool,
  pub PLACEMARKS: Option<alloc::vec::Vec<KMLPlacemarkT>>,
  pub FOLDERS: Option<alloc::vec::Vec<KMLFolderT>>,
  pub NETWORK_LINKS: Option<alloc::vec::Vec<KMLNetworkLinkT>>,
  pub GROUND_OVERLAYS: Option<alloc::vec::Vec<KMLGroundOverlayT>>,
  pub STYLES: Option<alloc::vec::Vec<KMLStyleT>>,
  pub STYLE_MAPS: Option<alloc::vec::Vec<KMLStyleMapT>>,
  pub SCREEN_OVERLAYS: Option<alloc::vec::Vec<KMLScreenOverlayT>>,
  pub PHOTO_OVERLAYS: Option<alloc::vec::Vec<KMLPhotoOverlayT>>,
  pub TOURS: Option<alloc::vec::Vec<KMLTourT>>,
  pub STYLE_URL: Option<alloc::string::String>,
  pub REGION: Option<alloc::boxed::Box<KMLRegionT>>,
  pub EXTENDED_DATA: Option<alloc::vec::Vec<KMLDataT>>,
  pub LOOK_AT: Option<alloc::boxed::Box<KMLLookAtT>>,
...
pub struct KMLT {
  ...
  pub NETWORK_LINKS: Option<alloc::vec::Vec<KMLNetworkLinkT>>,
  pub GROUND_OVERLAYS: Option<alloc::vec::Vec<KMLGroundOverlayT>>,
  pub SCHEMAS: Option<alloc::vec::Vec<KMLSchemaT>>,
  pub SCREEN_OVERLAYS: Option<alloc::vec::Vec<KMLScreenOverlayT>>,
  pub PHOTO_OVERLAYS: Option<alloc::vec::Vec<KMLPhotoOverlayT>>,
  pub TOURS: Option<alloc::vec::Vec<KMLTourT>>,
  pub NETWORK_LINK_CONTROL: Option<alloc::boxed::Box<KMLNetworkLinkControlT>>,
}
...
pub fn root_as_kml(buf: &[u8]) -> Result<KML<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_kml(buf: &[u8]) -> Result<KML<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_kml_unchecked(buf: &[u8]) -> KML<'_> {
  unsafe { ::flatbuffers::root_unchecked::<KML>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_kml_unchecked(buf: &[u8]) -> KML<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<KML>(buf) }
}
