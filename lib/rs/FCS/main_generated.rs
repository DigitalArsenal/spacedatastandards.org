...
pub struct FCST {
  ...
  pub SOLUTION: Option<alloc::string::String>,
  pub LAST_RANGE: f64,
  pub RANGE_RATE: f64,
  pub ROUNDS_REMAINING: u16,
  pub TEMPERATURE: f32,
...
pub fn root_as_fcs(buf: &[u8]) -> Result<FCS<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_fcs(buf: &[u8]) -> Result<FCS<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_fcs_unchecked(buf: &[u8]) -> FCS<'_> {
  unsafe { ::flatbuffers::root_unchecked::<FCS>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_fcs_unchecked(buf: &[u8]) -> FCS<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<FCS>(buf) }
}
