...
pub struct ATDT {
  ...
  pub AS_ID: Option<alloc::string::String>,
  pub SAT_NO: u32,
...
pub fn root_as_atd(buf: &[u8]) -> Result<ATD<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_atd(buf: &[u8]) -> Result<ATD<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_atd_unchecked(buf: &[u8]) -> ATD<'_> {
  unsafe { ::flatbuffers::root_unchecked::<ATD>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_atd_unchecked(buf: &[u8]) -> ATD<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<ATD>(buf) }
}
