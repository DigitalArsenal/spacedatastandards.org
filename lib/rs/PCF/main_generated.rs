...
pub fn root_as_pcf(buf: &[u8]) -> Result<PCF<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_pcf(buf: &[u8]) -> Result<PCF<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_pcf_unchecked(buf: &[u8]) -> PCF<'_> {
  unsafe { ::flatbuffers::root_unchecked::<PCF>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_pcf_unchecked(buf: &[u8]) -> PCF<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<PCF>(buf) }
}
