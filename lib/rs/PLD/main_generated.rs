...
pub struct PLDT {
  pub PAYLOAD_DURATION: Option<alloc::string::String>,
  pub MASS_AT_LAUNCH: f32,
  pub DIMENSIONS: Option<alloc::string::String>,
  pub SOLAR_ARRAY_AREA: f32,
  pub SOLAR_ARRAY_DIMENSIONS: Option<alloc::string::String>,
  pub NOMINAL_OPERATIONAL_LIFETIME: Option<alloc::string::String>,
  pub INSTRUMENTS: Option<alloc::vec::Vec<IDMT>>,
}
...
pub fn root_as_pld(buf: &[u8]) -> Result<PLD<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_pld(buf: &[u8]) -> Result<PLD<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_pld_unchecked(buf: &[u8]) -> PLD<'_> {
  unsafe { ::flatbuffers::root_unchecked::<PLD>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_pld_unchecked(buf: &[u8]) -> PLD<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<PLD>(buf) }
}
