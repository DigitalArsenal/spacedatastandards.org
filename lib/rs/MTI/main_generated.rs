...
pub struct MTIT {
  ...
  pub STANDARD: mtiStandard,
  pub P3: Option<alloc::string::String>,
  pub P6: Option<alloc::string::String>,
  pub P7: Option<alloc::string::String>,
  pub P8: Option<alloc::string::String>,
  pub P9: u32,
  pub P10: u16,
  pub MISSIONS: Option<alloc::vec::Vec<alloc::string::String>>,
  pub DWELLS: Option<alloc::vec::Vec<alloc::string::String>>,
  pub HRRS: Option<alloc::vec::Vec<alloc::string::String>>,
  pub JOB_DEFS: Option<alloc::vec::Vec<alloc::string::String>>,
  pub FREE_TEXTS: Option<alloc::vec::Vec<alloc::string::String>>,
  pub PLATFORM_LOCS: Option<alloc::vec::Vec<alloc::string::String>>,
  pub JOB_REQUESTS: Option<alloc::vec::Vec<alloc::string::String>>,
}
...
pub fn root_as_mti(buf: &[u8]) -> Result<MTI<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_mti(buf: &[u8]) -> Result<MTI<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_mti_unchecked(buf: &[u8]) -> MTI<'_> {
  unsafe { ::flatbuffers::root_unchecked::<MTI>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_mti_unchecked(buf: &[u8]) -> MTI<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<MTI>(buf) }
}
