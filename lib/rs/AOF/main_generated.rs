...
pub struct AOFT {
  ...
  pub VC_FRAME_COUNT_USAGE: bool,
  pub VC_FRAME_COUNT_CYCLE: u8,
  pub INSERT_ZONE: Option<alloc::vec::Vec<u8>>,
  pub DATA: Option<alloc::vec::Vec<u8>>,
  pub OCF: Option<alloc::vec::Vec<u8>>,
  pub FECF: u16,
}
...
pub fn root_as_aof(buf: &[u8]) -> Result<AOF<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_aof(buf: &[u8]) -> Result<AOF<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_aof_unchecked(buf: &[u8]) -> AOF<'_> {
  unsafe { ::flatbuffers::root_unchecked::<AOF>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_aof_unchecked(buf: &[u8]) -> AOF<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<AOF>(buf) }
}
