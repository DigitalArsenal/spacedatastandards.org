...
pub struct ionoDensityProfileT {
  pub EPOCH: Option<alloc::string::String>,
  pub ALTITUDES: Option<alloc::vec::Vec<f64>>,
  pub DENSITIES: Option<alloc::vec::Vec<f64>>,
}
...
pub struct IONT {
  ...
  pub STEC: f64,
  pub S4: f64,
  pub DATA_POINTS: Option<alloc::vec::Vec<ionoDataPointT>>,
  pub DENSITY_PROFILES: Option<alloc::vec::Vec<ionoDensityProfileT>>,
  pub QUALITY: u8,
...
pub fn root_as_ion(buf: &[u8]) -> Result<ION<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_ion(buf: &[u8]) -> Result<ION<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_ion_unchecked(buf: &[u8]) -> ION<'_> {
  unsafe { ::flatbuffers::root_unchecked::<ION>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_ion_unchecked(buf: &[u8]) -> ION<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<ION>(buf) }
}
