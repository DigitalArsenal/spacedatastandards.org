...
#[derive(Debug, Clone, PartialEq)]
pub struct RDMT {
  pub CCSDS_RDM_VERS: Option<alloc::string::String>,
  ...
  pub DISPOSITION: reentryDisposition,
  pub REASON: reentryReason,
  pub REENTRY_EPOCH: Option<alloc::string::String>,
  pub REENTRY_EPOCH_UNC: f64,
  pub REENTRY_LATITUDE: f64,
  pub REENTRY_LONGITUDE: f64,
  pub REENTRY_ALTITUDE: f64,
  pub TIME_SYSTEM: Option<alloc::string::String>,
  pub PREV_PREDICTION_EPOCH: Option<alloc::string::String>,
  pub BALLISTIC_COEFF: f64,
  pub MASS: f64,
  pub SOLAR_RAD_AREA: f64,
  pub DRAG_AREA: f64,
  pub INITIAL_STATE: Option<alloc::boxed::Box<reentryStateVectorT>>,
  pub IMPACT_PREDICTIONS: Option<alloc::vec::Vec<reentryImpactT>>,
  pub SURVIVING_DEBRIS: Option<alloc::vec::Vec<survivingDebrisT>>,
  pub CASUALTY_EXPECTATION: f64,
  pub NUM_FRAGMENTS: u32,
  pub SURVIVING_MASS: f64,
...
pub fn root_as_rdm(buf: &[u8]) -> Result<RDM<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_rdm(buf: &[u8]) -> Result<RDM<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_rdm_unchecked(buf: &[u8]) -> RDM<'_> {
  unsafe { ::flatbuffers::root_unchecked::<RDM>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_rdm_unchecked(buf: &[u8]) -> RDM<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<RDM>(buf) }
}
