...
pub struct LDMT {
  ...
  pub AZIMUTH: f32,
  pub REFERENCES: Option<alloc::string::String>,
  pub AGENCY_NAME: Option<alloc::string::String>,
  pub POINTS_OF_CONTACT: Option<alloc::vec::Vec<EPMT>>,
  pub OPERATIONS_POINTS_OF_CONTACT: Option<alloc::vec::Vec<EPMT>>,
  pub NET: Option<alloc::string::String>,
  pub ROCKET_CONFIGURATION: Option<alloc::boxed::Box<ROCT>>,
  pub MISSION_NAME: Option<alloc::string::String>,
  pub MISSION_DESCRIPTION: Option<alloc::string::String>,
  pub MISSION_TYPE: Option<alloc::string::String>,
  pub ORBIT_TYPE: Option<alloc::string::String>,
  pub WEATHER_CONDITIONS: Option<alloc::string::String>,
  pub LAUNCH_STATUS: Option<alloc::string::String>,
  pub WEBCAST_URL: Option<alloc::string::String>,
  pub MEDIA_LINKS: Option<alloc::vec::Vec<alloc::string::String>>,
  pub EARLIEST_LAUNCH_TIMES: Option<alloc::vec::Vec<alloc::string::String>>,
  pub LATEST_LAUNCH_TIMES: Option<alloc::vec::Vec<alloc::string::String>>,
  pub LCOLA_WINDOW_CLOSURES: Option<alloc::vec::Vec<alloc::string::String>>,
  pub OBJECTS: Option<alloc::vec::Vec<CATT>>,
  pub TRACKING_REQUIREMENTS: Option<alloc::vec::Vec<alloc::string::String>>,
  pub COLA_SCREEN_DURATION: Option<alloc::string::String>,
  pub PROBABILITY_OF_COLLISION_THRESHOLD: Option<alloc::string::String>,
  pub COLA_RUNS_REQUIRED: Option<alloc::string::String>,
...
pub fn root_as_ldm(buf: &[u8]) -> Result<LDM<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_ldm(buf: &[u8]) -> Result<LDM<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_ldm_unchecked(buf: &[u8]) -> LDM<'_> {
  unsafe { ::flatbuffers::root_unchecked::<LDM>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_ldm_unchecked(buf: &[u8]) -> LDM<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<LDM>(buf) }
}
