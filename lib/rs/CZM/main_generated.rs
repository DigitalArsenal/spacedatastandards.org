...
pub struct CZMIntervalT {
  pub INTERVAL: Option<alloc::string::String>,
}
...
pub struct CZMDynIntervalT {
  ...
  pub COLOR_VALUE: Option<alloc::boxed::Box<CZMColorT>>,
  pub ARRAY_VALUE: Option<alloc::vec::Vec<f64>>,
}
...
pub struct CZMDynSampledT {
  ...
  pub VALUE_TYPE: CZMDynValueType,
  pub DATA: Option<alloc::vec::Vec<f64>>,
  pub INTERPOLATION: Option<alloc::boxed::Box<CZMInterpolationT>>,
}
...
pub struct CZMDynamicPropertyT {
  ...
  pub SAMPLED: Option<alloc::boxed::Box<CZMDynSampledT>>,
  pub INTERVALS: Option<alloc::vec::Vec<CZMDynIntervalT>>,
  pub REFERENCE: Option<alloc::string::String>,
}
...
pub struct CZMSolidColorMaterialT {
  pub COLOR: Option<alloc::boxed::Box<CZMColorT>>,
}
...
pub struct CZMStripeMaterialT {
  pub ORIENTATION: Option<alloc::string::String>,
  pub EVEN_COLOR: Option<alloc::boxed::Box<CZMColorT>>,
  pub ODD_COLOR: Option<alloc::boxed::Box<CZMColorT>>,
  pub OFFSET: f64,
  pub REPEAT_COUNT: f64,
}
...
pub struct CZMMaterialT {
  pub SOLID_COLOR: Option<alloc::boxed::Box<CZMSolidColorMaterialT>>,
  pub IMAGE: Option<alloc::boxed::Box<CZMImageMaterialT>>,
  pub GRID: Option<alloc::boxed::Box<CZMGridMaterialT>>,
  pub STRIPE: Option<alloc::boxed::Box<CZMStripeMaterialT>>,
  pub CHECKERBOARD: Option<alloc::boxed::Box<CZMCheckerboardMaterialT>>,
}
...
pub struct CZMPolylineOutlineMaterialT {
  pub COLOR: Option<alloc::boxed::Box<CZMColorT>>,
  pub OUTLINE_COLOR: Option<alloc::boxed::Box<CZMColorT>>,
  pub OUTLINE_WIDTH: f64,
}
...
pub struct CZMPolylineDashMaterialT {
  pub COLOR: Option<alloc::boxed::Box<CZMColorT>>,
  pub GAP_COLOR: Option<alloc::boxed::Box<CZMColorT>>,
  pub DASH_LENGTH: f64,
  pub DASH_PATTERN: i32,
}
...
pub struct CZMPolylineMaterialT {
  pub SOLID_COLOR: Option<alloc::boxed::Box<CZMSolidColorMaterialT>>,
  pub POLYLINE_OUTLINE: Option<alloc::boxed::Box<CZMPolylineOutlineMaterialT>>,
  pub POLYLINE_ARROW: Option<alloc::boxed::Box<CZMPolylineArrowMaterialT>>,
  pub POLYLINE_DASH: Option<alloc::boxed::Box<CZMPolylineDashMaterialT>>,
  pub POLYLINE_GLOW: Option<alloc::boxed::Box<CZMPolylineGlowMaterialT>>,
}
...
pub struct CZMBillboardT {
  ...
  pub HORIZONTAL_ORIGIN: CZMHorizontalOrigin,
  pub VERTICAL_ORIGIN: CZMVerticalOrigin,
  pub TRANSLUCENCY_BY_DISTANCE: Option<alloc::boxed::Box<CZMNearFarScalarT>>,
  pub ROTATION: f64,
  pub SIZE_IN_METERS: bool,
  pub WIDTH: f64,
  pub HEIGHT: f64,
  ...
  pub EYE_OFFSET_Y: f64,
  pub EYE_OFFSET_Z: f64,
  pub SCALE_BY_DISTANCE: Option<alloc::boxed::Box<CZMNearFarScalarT>>,
  pub PIXEL_OFFSET_SCALE_BY_DISTANCE: Option<alloc::boxed::Box<CZMNearFarScalarT>>,
  pub DISTANCE_DISPLAY_CONDITION_NEAR: f64,
  pub DISTANCE_DISPLAY_CONDITION_FAR: f64,
  pub DISABLE_DEPTH_TEST_DISTANCE: f64,
}
...
pub struct CZMLabelT {
  ...
  pub FONT: Option<alloc::string::String>,
  pub STYLE: CZMLabelStyle,
  pub FILL_COLOR: Option<alloc::boxed::Box<CZMColorT>>,
  pub OUTLINE_COLOR: Option<alloc::boxed::Box<CZMColorT>>,
  pub OUTLINE_WIDTH: f64,
  pub PIXEL_OFFSET_X: f64,
  pub PIXEL_OFFSET_Y: f64,
  ...
  pub HEIGHT_REFERENCE: CZMHeightReference,
  pub SHOW_BACKGROUND: bool,
  pub BACKGROUND_COLOR: Option<alloc::boxed::Box<CZMColorT>>,
  pub BACKGROUND_PADDING_X: f64,
  pub BACKGROUND_PADDING_Y: f64,
  pub EYE_OFFSET_X: f64,
  pub EYE_OFFSET_Y: f64,
...
pub struct CZMPolylineT {
  pub SHOW: bool,
  pub POSITIONS_CARTOGRAPHIC_DEGREES: Option<alloc::vec::Vec<f64>>,
  pub POSITIONS_CARTESIAN: Option<alloc::vec::Vec<f64>>,
  pub WIDTH: f64,
  pub COLOR: Option<alloc::boxed::Box<CZMColorT>>,
  pub CLAMP_TO_GROUND: bool,
  pub ARC_TYPE: Option<alloc::string::String>,
  pub GRANULARITY: f64,
  pub MATERIAL: Option<alloc::boxed::Box<CZMPolylineMaterialT>>,
  pub SHADOWS: Option<alloc::string::String>,
  pub DEPTH_FAIL_MATERIAL: Option<alloc::boxed::Box<CZMPolylineMaterialT>>,
...
pub struct CZMPolygonT {
  ...
  pub HEIGHT_REFERENCE: CZMHeightReference,
  pub CLASSIFICATION_TYPE: CZMClassificationType,
  pub HOLES: Option<alloc::vec::Vec<CZMPolygonHoleT>>,
  pub ARC_TYPE: Option<alloc::string::String>,
  pub HEIGHT: f64,
  pub EXTRUDED_HEIGHT_REFERENCE: Option<alloc::string::String>,
  pub ST_ROTATION: f64,
  pub GRANULARITY: f64,
  pub MATERIAL: Option<alloc::boxed::Box<CZMMaterialT>>,
  pub OUTLINE_WIDTH: f64,
  pub PER_POSITION_HEIGHT: bool,
  pub CLOSE_TOP: bool,
  pub CLOSE_BOTTOM: bool,
...
pub struct CZMModelT {
  pub SHOW: bool,
  pub GLTF: Option<alloc::string::String>,
  pub SCALE: f64,
  pub MINIMUM_PIXEL_SIZE: f64,
  pub MAXIMUM_SCALE: f64,
  pub HEIGHT_REFERENCE: CZMHeightReference,
  ...
  pub RUN_ANIMATIONS: bool,
  pub SHADOWS: Option<alloc::string::String>,
  pub SILHOUETTE_COLOR: Option<alloc::boxed::Box<CZMColorT>>,
  pub SILHOUETTE_SIZE: f64,
  pub COLOR_BLEND_MODE: Option<alloc::string::String>,
  pub COLOR_BLEND_AMOUNT: f64,
}
...
pub struct CZMBoxT {
  ...
  pub DIMENSIONS_Y: f64,
  pub DIMENSIONS_Z: f64,
  pub HEIGHT_REFERENCE: Option<alloc::string::String>,
  pub FILL: bool,
  pub MATERIAL: Option<alloc::boxed::Box<CZMMaterialT>>,
  pub OUTLINE: bool,
  pub OUTLINE_COLOR: Option<alloc::boxed::Box<CZMColorT>>,
...
pub struct CZMCorridorT {
  ...
  pub EXTRUDED_HEIGHT: f64,
  pub EXTRUDED_HEIGHT_REFERENCE: Option<alloc::string::String>,
  pub CORNER_TYPE: Option<alloc::string::String>,
  pub GRANULARITY: f64,
  pub FILL: bool,
  pub MATERIAL: Option<alloc::boxed::Box<CZMMaterialT>>,
  pub OUTLINE: bool,
...
pub struct CZMPolylineVolumeT {
  ...
  pub POSITIONS_CARTOGRAPHIC_DEGREES: Option<alloc::vec::Vec<f64>>,
  pub POSITIONS_CARTESIAN: Option<alloc::vec::Vec<f64>>,
  pub SHAPE: Option<alloc::vec::Vec<f64>>,
  pub CORNER_TYPE: Option<alloc::string::String>,
  pub GRANULARITY: f64,
  pub FILL: bool,
  pub MATERIAL: Option<alloc::boxed::Box<CZMMaterialT>>,
...
pub struct CZMRectangleT {
  pub SHOW: bool,
  pub COORDINATES_WSEN_DEGREES: Option<alloc::vec::Vec<f64>>,
  pub HEIGHT: f64,
  pub HEIGHT_REFERENCE: Option<alloc::string::String>,
  pub EXTRUDED_HEIGHT: f64,
  pub EXTRUDED_HEIGHT_REFERENCE: Option<alloc::string::String>,
...
pub struct CZMWallT {
  ...
  pub POSITIONS_CARTOGRAPHIC_DEGREES: Option<alloc::vec::Vec<f64>>,
  pub POSITIONS_CARTESIAN: Option<alloc::vec::Vec<f64>>,
  pub MINIMUM_HEIGHTS: Option<alloc::vec::Vec<f64>>,
  pub MAXIMUM_HEIGHTS: Option<alloc::vec::Vec<f64>>,
  pub GRANULARITY: f64,
  pub FILL: bool,
  pub MATERIAL: Option<alloc::boxed::Box<CZMMaterialT>>,
  pub OUTLINE: bool,
...
pub struct CZMPacketT {
  ...
  pub AVAILABILITY: Option<alloc::string::String>,
  pub POSITION_CARTOGRAPHIC_DEGREES: Option<alloc::boxed::Box<CZMCartographicDegreesT>>,
  pub POSITION_CARTESIAN: Option<alloc::boxed::Box<CZMCartesianT>>,
  pub POSITION_EPOCH: Option<alloc::string::String>,
  pub POSITION_CARTOGRAPHIC_DEGREES_ARRAY: Option<alloc::vec::Vec<f64>>,
  pub POSITION_CARTESIAN_ARRAY: Option<alloc::vec::Vec<f64>>,
  pub BILLBOARD: Option<alloc::boxed::Box<CZMBillboardT>>,
  pub LABEL: Option<alloc::boxed::Box<CZMLabelT>>,
  pub POINT: Option<alloc::boxed::Box<CZMPointT>>,
  pub POLYLINE: Option<alloc::boxed::Box<CZMPolylineT>>,
  pub POLYGON: Option<alloc::boxed::Box<CZMPolygonT>>,
  pub MODEL: Option<alloc::boxed::Box<CZMModelT>>,
  pub PATH: Option<alloc::boxed::Box<CZMPathT>>,
  pub ELLIPSE: Option<alloc::boxed::Box<CZMEllipseT>>,
  pub ORIENTATION: Option<alloc::boxed::Box<CZMOrientationT>>,
  pub VIEW_FROM: Option<alloc::boxed::Box<CZMViewFromT>>,
  pub DELETE: bool,
  pub BOX: Option<alloc::boxed::Box<CZMBoxT>>,
  pub CORRIDOR: Option<alloc::boxed::Box<CZMCorridorT>>,
  pub CYLINDER: Option<alloc::boxed::Box<CZMCylinderT>>,
  pub ELLIPSOID: Option<alloc::boxed::Box<CZMEllipsoidT>>,
  pub POLYLINE_VOLUME: Option<alloc::boxed::Box<CZMPolylineVolumeT>>,
  pub RECTANGLE: Option<alloc::boxed::Box<CZMRectangleT>>,
  pub TILESET: Option<alloc::boxed::Box<CZMTilesetT>>,
  pub WALL: Option<alloc::boxed::Box<CZMWallT>>,
  pub POSITION_INTERPOLATION: Option<alloc::boxed::Box<CZMInterpolationT>>,
  pub POSITION_REFERENCE_FRAME: Option<alloc::string::String>,
  pub POSITION_REFERENCE: Option<alloc::string::String>,
  pub ORIENTATION_EPOCH: Option<alloc::string::String>,
  pub ORIENTATION_ARRAY: Option<alloc::vec::Vec<f64>>,
  pub ORIENTATION_INTERPOLATION: Option<alloc::boxed::Box<CZMInterpolationT>>,
  pub ORIENTATION_REFERENCE: Option<alloc::string::String>,
  pub DYNAMIC_PROPERTIES: Option<alloc::vec::Vec<CZMDynamicPropertyT>>,
}
...
pub struct CZMT {
  ...
  pub CLOCK_CURRENT_TIME: Option<alloc::string::String>,
  pub CLOCK_INTERVAL: Option<alloc::string::String>,
  pub CLOCK_MULTIPLIER: f64,
  pub CLOCK_RANGE: Option<alloc::string::String>,
  pub CLOCK_STEP: Option<alloc::string::String>,
  pub PACKETS: Option<alloc::vec::Vec<CZMPacketT>>,
}
...
pub fn root_as_czm(buf: &[u8]) -> Result<CZM<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_czm(buf: &[u8]) -> Result<CZM<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_czm_unchecked(buf: &[u8]) -> CZM<'_> {
  unsafe { ::flatbuffers::root_unchecked::<CZM>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_czm_unchecked(buf: &[u8]) -> CZM<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<CZM>(buf) }
}
