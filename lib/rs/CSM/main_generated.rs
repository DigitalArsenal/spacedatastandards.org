...
pub struct CSMT {
  pub OBJECT_1: Option<alloc::boxed::Box<CATT>>,
  pub DSE_1: f64,
  pub OBJECT_2: Option<alloc::boxed::Box<CATT>>,
  pub DSE_2: f64,
  pub TCA: f64,
  pub TCA_RANGE: f64,
  pub TCA_RELATIVE_SPEED: f64,
...
pub fn root_as_csm(buf: &[u8]) -> Result<CSM<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_csm(buf: &[u8]) -> Result<CSM<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_csm_unchecked(buf: &[u8]) -> CSM<'_> {
  unsafe { ::flatbuffers::root_unchecked::<CSM>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_csm_unchecked(buf: &[u8]) -> CSM<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<CSM>(buf) }
}
