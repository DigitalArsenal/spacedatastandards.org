...
pub struct RFOT {
  ...
  pub TRANSPONDER: Option<alloc::string::String>,
  pub DETECTION_STATUS: rfDetectionStatus,
  pub AZIMUTH: f64,
  pub AZIMUTH_UNC: f64,
  pub AZIMUTH_RATE: f64,
  ...
  pub ANTENNA_NAME: Option<alloc::string::String>,
  pub COLLECTION_MODE: Option<alloc::string::String>,
  pub FREQUENCY: f64,
  pub NOMINAL_FREQUENCY: f64,
  pub START_FREQUENCY: f64,
  pub END_FREQUENCY: f64,
  ...
  pub NOMINAL_POWER_OVER_NOISE: f64,
  pub POLARITY: f64,
  pub POLARITY_TYPE: Option<alloc::string::String>,
  pub CHANNEL: u16,
  pub BAUD_RATE: f64,
  pub SYMBOL_TO_NOISE_RATIO: f64,
  pub BIT_ERROR_RATE: f64,
  ...
  pub SWITCH_POINT: u16,
  pub CONFIDENCE: f64,
  pub CARRIER_STANDARD: Option<alloc::string::String>,
  pub MODULATION: Option<alloc::string::String>,
  pub INNER_CODING_RATE: u8,
  pub OUTER_CODING_RATE: u8,
  pub TRANSMIT_FILTER_TYPE: Option<alloc::string::String>,
  pub TRANSMIT_FILTER_ROLL_OFF: f64,
...
pub fn root_as_rfo(buf: &[u8]) -> Result<RFO<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_rfo(buf: &[u8]) -> Result<RFO<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_rfo_unchecked(buf: &[u8]) -> RFO<'_> {
  unsafe { ::flatbuffers::root_unchecked::<RFO>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_rfo_unchecked(buf: &[u8]) -> RFO<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<RFO>(buf) }
}
