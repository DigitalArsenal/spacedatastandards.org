...
pub struct LKST {
  ...
  pub ID_ON_ORBIT1: Option<alloc::string::String>,
  pub SAT_NO1: u32,
  pub ID_ON_ORBIT2: Option<alloc::string::String>,
  pub SAT_NO2: u32,
  ...
  pub ID_BEAM1: Option<alloc::string::String>,
  pub END_POINT1_NAME: Option<alloc::string::String>,
  pub END_POINT1_LAT: f64,
  pub END_POINT1_LON: f64,
  pub ID_BEAM2: Option<alloc::string::String>,
  pub END_POINT2_NAME: Option<alloc::string::String>,
  pub END_POINT2_LAT: f64,
  pub END_POINT2_LON: f64,
  pub DATA_RATE1_TO2: f64,
  pub DATA_RATE2_TO1: f64,
  pub SYS_CAP: Option<alloc::string::String>,
  pub OPS_CAP: Option<alloc::string::String>,
}
...
pub fn root_as_lks(buf: &[u8]) -> Result<LKS<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_lks(buf: &[u8]) -> Result<LKS<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_lks_unchecked(buf: &[u8]) -> LKS<'_> {
  unsafe { ::flatbuffers::root_unchecked::<LKS>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_lks_unchecked(buf: &[u8]) -> LKS<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<LKS>(buf) }
}
