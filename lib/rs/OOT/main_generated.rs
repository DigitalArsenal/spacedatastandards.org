...
pub struct OOTT {
  ...
  pub ID_THRUSTER: Option<alloc::string::String>,
  pub NAME: Option<alloc::string::String>,
  pub TYPE: thrusterType,
  pub QUANTITY: u32,
  pub THRUST: f64,
  pub ISP: f64,
  pub PROPELLANT: Option<alloc::string::String>,
  pub PROPELLANT_MASS: f64,
  pub PROPELLANT_REMAINING: f64,
  pub DELTA_V_TOTAL: f64,
  pub DELTA_V_REMAINING: f64,
...
pub fn root_as_oot(buf: &[u8]) -> Result<OOT<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_oot(buf: &[u8]) -> Result<OOT<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_oot_unchecked(buf: &[u8]) -> OOT<'_> {
  unsafe { ::flatbuffers::root_unchecked::<OOT>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_oot_unchecked(buf: &[u8]) -> OOT<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<OOT>(buf) }
}
