...
pub struct WTHT {
  ...
  pub ID_SENSOR: Option<alloc::string::String>,
  pub ORIG_SENSOR_ID: Option<alloc::string::String>,
  pub OB_TIME: Option<alloc::string::String>,
  pub FILE_CREATION: Option<alloc::string::String>,
  pub QC_VALUE: u8,
  pub TERM_ALT: f64,
  pub AVG_TX_PWR: f64,
  pub AVG_REF_PWR: f64,
  ...
  pub NUM_ELEMENTS: u16,
  pub CHECKSUM: u32,
  pub SIG_PWRS: Option<alloc::vec::Vec<f64>>,
  pub NOISE_LVLS: Option<alloc::vec::Vec<f64>>,
  pub SPEC_WIDTHS: Option<alloc::vec::Vec<f64>>,
  pub FIRST_GUESS_AVGS: Option<alloc::vec::Vec<f64>>,
  pub TD_AVG_SAMPLE_NUMS: Option<alloc::vec::Vec<f64>>,
  pub CO_INTEGS: Option<alloc::vec::Vec<f64>>,
  pub SPEC_AVGS: Option<alloc::vec::Vec<f64>>,
  pub INTERPULSE_PERIODS: Option<alloc::vec::Vec<f64>>,
  pub DOPP_VELS: Option<alloc::vec::Vec<f64>>,
  pub CONS_RECS: Option<alloc::vec::Vec<f64>>,
  pub SNRS: Option<alloc::vec::Vec<f64>>,
  pub SIG_STRENGTH: f64,
  pub SEMI_MAJOR_AXIS: f64,
  pub SEMI_MINOR_AXIS: f64,
  pub ANGLE_ORIENTATION: f64,
  pub LIGHT_EVENT_NUM: u32,
  pub LIGHT_DET_SENSORS: Option<alloc::vec::Vec<alloc::string::String>>,
  pub POS_CONFIDENCE: f64,
...
pub fn root_as_wth(buf: &[u8]) -> Result<WTH<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_wth(buf: &[u8]) -> Result<WTH<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_wth_unchecked(buf: &[u8]) -> WTH<'_> {
  unsafe { ::flatbuffers::root_unchecked::<WTH>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_wth_unchecked(buf: &[u8]) -> WTH<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<WTH>(buf) }
}
