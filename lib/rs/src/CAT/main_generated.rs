...
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_MASS_TYPE: [massType; 2] = [massType::DRY, massType::WET];
...
impl massType {
    ...
    pub const ENUM_VALUES: &'static [Self] = &[Self::DRY, Self::WET];
    /// Returns the variant's name or "" if unknown.
    pub fn variant_name(self) -> Option<&'static str> {
        match self {
            Self::DRY => Some("DRY"),
...
impl<'a> CAT<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        ...
        if let Some(x) = args.PAYLOADS {
            builder.add_PAYLOADS(x);
        }
        if let Some(x) = args.DEPLOYMENT_DATE {
            builder.add_DEPLOYMENT_DATE(x);
        }
        if let Some(x) = args.ORBIT_CENTER {
            builder.add_ORBIT_CENTER(x);
        }
        if let Some(x) = args.DECAY_DATE {
            builder.add_DECAY_DATE(x);
        }
        if let Some(x) = args.LAUNCH_SITE {
            builder.add_LAUNCH_SITE(x);
        }
        if let Some(x) = args.LAUNCH_DATE {
            builder.add_LAUNCH_DATE(x);
        }
        builder.add_NORAD_CAT_ID(args.NORAD_CAT_ID);
        if let Some(x) = args.OBJECT_ID {
            builder.add_OBJECT_ID(x);
        }
        if let Some(x) = args.OBJECT_NAME {
            builder.add_OBJECT_NAME(x);
        }
    ...
    pub fn unpack(&self) -> CATT {
        let OBJECT_NAME = self.OBJECT_NAME().map(|x| x.to_string());
        let OBJECT_ID = self.OBJECT_ID().map(|x| x.to_string());
        let NORAD_CAT_ID = self.NORAD_CAT_ID();
        let OBJECT_TYPE = self.OBJECT_TYPE();
        let OPS_STATUS_CODE = self.OPS_STATUS_CODE();
        let OWNER = self.OWNER();
        let LAUNCH_DATE = self.LAUNCH_DATE().map(|x| x.to_string());
        let LAUNCH_SITE = self.LAUNCH_SITE().map(|x| x.to_string());
        let DECAY_DATE = self.DECAY_DATE().map(|x| x.to_string());
        ...
        let ORBIT_CENTER = self.ORBIT_CENTER().map(|x| x.to_string());
        let ORBIT_TYPE = self.ORBIT_TYPE();
        let DEPLOYMENT_DATE = self.DEPLOYMENT_DATE().map(|x| x.to_string());
    ...
    pub fn OBJECT_NAME(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(CAT::VT_OBJECT_NAME, None)
        }
    }
    ...
    pub fn OBJECT_ID(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(CAT::VT_OBJECT_ID, None)
        }
    }
    ...
    pub fn OBJECT_TYPE(&self) -> objectType {
        ...
        unsafe {
            self._tab
                .get::<objectType>(CAT::VT_OBJECT_TYPE, Some(objectType::UNKNOWN))
                .unwrap()
        }
    }
    ...
    pub fn OPS_STATUS_CODE(&self) -> opsStatusCode {
        ...
        unsafe {
            self._tab
                .get::<opsStatusCode>(CAT::VT_OPS_STATUS_CODE, Some(opsStatusCode::UNKNOWN))
                .unwrap()
        }
    }
    ...
    pub fn OWNER(&self) -> legacyCountryCode {
        ...
        unsafe {
            self._tab
                .get::<legacyCountryCode>(CAT::VT_OWNER, Some(legacyCountryCode::AB))
                .unwrap()
        }
    }
    ...
    pub fn LAUNCH_DATE(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(CAT::VT_LAUNCH_DATE, None)
        }
    }
    /// Launch Site
    #[inline]
    pub fn LAUNCH_SITE(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(CAT::VT_LAUNCH_SITE, None)
        }
    }
    ...
    pub fn DECAY_DATE(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(CAT::VT_DECAY_DATE, None)
        }
    }
    ...
    pub fn INCLINATION(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CAT::VT_INCLINATION, Some(0.0))
                .unwrap()
        }
    }
    ...
    pub fn DATA_STATUS_CODE(&self) -> dataStatusCode {
        ...
        unsafe {
            self._tab
                .get::<dataStatusCode>(
                    CAT::VT_DATA_STATUS_CODE,
                    Some(dataStatusCode::NO_CURRENT_ELEMENTS),
                )
                .unwrap()
        }
    }
    ...
    pub fn ORBIT_CENTER(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(CAT::VT_ORBIT_CENTER, None)
        }
    }
    ...
    pub fn ORBIT_TYPE(&self) -> orbitType {
        ...
        unsafe {
            self._tab
                .get::<orbitType>(CAT::VT_ORBIT_TYPE, Some(orbitType::ORBIT))
                .unwrap()
        }
    }
    ...
    pub fn DEPLOYMENT_DATE(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(CAT::VT_DEPLOYMENT_DATE, None)
        }
    }
    ...
    pub fn MANEUVERABLE(&self) -> bool {
        ...
        unsafe {
            self._tab
                .get::<bool>(CAT::VT_MANEUVERABLE, Some(false))
                .unwrap()
        }
    }
    ...
    pub fn MASS_TYPE(&self) -> massType {
        ...
        unsafe {
            self._tab
                .get::<massType>(CAT::VT_MASS_TYPE, Some(massType::DRY))
                .unwrap()
        }
    }
    /// Vector of PAYLOADS
    ...
    pub fn PAYLOADS(
        &self,
    ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<PLD<'a>>>> {
        // Safety:
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe {
            self._tab.get::<flatbuffers::ForwardsUOffset<
                flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<PLD>>,
            >>(CAT::VT_PAYLOADS, None)
        }
    }
}
    ...
    fn run_verifier(
        ...
        v.visit_table(pos)?
            ...
            .visit_field::<flatbuffers::ForwardsUOffset<
                flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<PLD>>,
            >>("PAYLOADS", Self::VT_PAYLOADS, false)?
            .finish();
        Ok(())
    }
}
pub struct CATArgs<'a> {
    ...
    pub PAYLOADS: Option<
        flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<PLD<'a>>>>,
    >,
}
...
impl<'a: 'b, 'b> CATBuilder<'a, 'b> {
    ...
    pub fn add_OBJECT_NAME(&mut self, OBJECT_NAME: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(CAT::VT_OBJECT_NAME, OBJECT_NAME);
    }
    #[inline]
    pub fn add_OBJECT_ID(&mut self, OBJECT_ID: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(CAT::VT_OBJECT_ID, OBJECT_ID);
    }
    #[inline]
    pub fn add_NORAD_CAT_ID(&mut self, NORAD_CAT_ID: u32) {
        self.fbb_
            .push_slot::<u32>(CAT::VT_NORAD_CAT_ID, NORAD_CAT_ID, 0);
    }
    #[inline]
    pub fn add_OBJECT_TYPE(&mut self, OBJECT_TYPE: objectType) {
        self.fbb_
            .push_slot::<objectType>(CAT::VT_OBJECT_TYPE, OBJECT_TYPE, objectType::UNKNOWN);
    }
    #[inline]
    pub fn add_OPS_STATUS_CODE(&mut self, OPS_STATUS_CODE: opsStatusCode) {
        self.fbb_.push_slot::<opsStatusCode>(
            CAT::VT_OPS_STATUS_CODE,
            OPS_STATUS_CODE,
            opsStatusCode::UNKNOWN,
        );
    }
    ...
    pub fn add_OWNER(&mut self, OWNER: legacyCountryCode) {
        self.fbb_
            .push_slot::<legacyCountryCode>(CAT::VT_OWNER, OWNER, legacyCountryCode::AB);
    }
    #[inline]
    pub fn add_LAUNCH_DATE(&mut self, LAUNCH_DATE: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(CAT::VT_LAUNCH_DATE, LAUNCH_DATE);
    }
    #[inline]
    pub fn add_LAUNCH_SITE(&mut self, LAUNCH_SITE: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(CAT::VT_LAUNCH_SITE, LAUNCH_SITE);
    }
    #[inline]
    pub fn add_DECAY_DATE(&mut self, DECAY_DATE: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(CAT::VT_DECAY_DATE, DECAY_DATE);
    }
    #[inline]
    ...
    pub fn add_INCLINATION(&mut self, INCLINATION: f64) {
        self.fbb_
            .push_slot::<f64>(CAT::VT_INCLINATION, INCLINATION, 0.0);
    }
    #[inline]
    ...
    pub fn add_DATA_STATUS_CODE(&mut self, DATA_STATUS_CODE: dataStatusCode) {
        self.fbb_.push_slot::<dataStatusCode>(
            CAT::VT_DATA_STATUS_CODE,
            DATA_STATUS_CODE,
            dataStatusCode::NO_CURRENT_ELEMENTS,
        );
    ...
    pub fn add_ORBIT_CENTER(&mut self, ORBIT_CENTER: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(CAT::VT_ORBIT_CENTER, ORBIT_CENTER);
    }
    #[inline]
    pub fn add_ORBIT_TYPE(&mut self, ORBIT_TYPE: orbitType) {
        self.fbb_
            .push_slot::<orbitType>(CAT::VT_ORBIT_TYPE, ORBIT_TYPE, orbitType::ORBIT);
    }
    #[inline]
    pub fn add_DEPLOYMENT_DATE(&mut self, DEPLOYMENT_DATE: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
            CAT::VT_DEPLOYMENT_DATE,
            DEPLOYMENT_DATE,
        );
    }
    #[inline]
    pub fn add_MANEUVERABLE(&mut self, MANEUVERABLE: bool) {
        self.fbb_
            .push_slot::<bool>(CAT::VT_MANEUVERABLE, MANEUVERABLE, false);
    }
    #[inline]
    ...
    pub fn add_MASS_TYPE(&mut self, MASS_TYPE: massType) {
        self.fbb_
            .push_slot::<massType>(CAT::VT_MASS_TYPE, MASS_TYPE, massType::DRY);
    }
    #[inline]
    pub fn add_PAYLOADS(
        &mut self,
        PAYLOADS: flatbuffers::WIPOffset<
            flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<PLD<'b>>>,
        >,
    ) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(CAT::VT_PAYLOADS, PAYLOADS);
    }
    #[inline]
...
impl CATT {
    pub fn pack<'b>(
        ...
        let OBJECT_NAME = self.OBJECT_NAME.as_ref().map(|x| _fbb.create_string(x));
        let OBJECT_ID = self.OBJECT_ID.as_ref().map(|x| _fbb.create_string(x));
        let NORAD_CAT_ID = self.NORAD_CAT_ID;
        let OBJECT_TYPE = self.OBJECT_TYPE;
        let OPS_STATUS_CODE = self.OPS_STATUS_CODE;
        let OWNER = self.OWNER;
        let LAUNCH_DATE = self.LAUNCH_DATE.as_ref().map(|x| _fbb.create_string(x));
        let LAUNCH_SITE = self.LAUNCH_SITE.as_ref().map(|x| _fbb.create_string(x));
        let DECAY_DATE = self.DECAY_DATE.as_ref().map(|x| _fbb.create_string(x));
        let PERIOD = self.PERIOD;
        let INCLINATION = self.INCLINATION;
        let APOGEE = self.APOGEE;
        let PERIGEE = self.PERIGEE;
        let RCS = self.RCS;
        let DATA_STATUS_CODE = self.DATA_STATUS_CODE;
        let ORBIT_CENTER = self.ORBIT_CENTER.as_ref().map(|x| _fbb.create_string(x));
        let ORBIT_TYPE = self.ORBIT_TYPE;
        let DEPLOYMENT_DATE = self.DEPLOYMENT_DATE.as_ref().map(|x| _fbb.create_string(x));
        let MANEUVERABLE = self.MANEUVERABLE;
        let SIZE = self.SIZE;
        let MASS = self.MASS;
        let MASS_TYPE = self.MASS_TYPE;
...
impl<'a> CATCOLLECTION<'a> {
    ...
    pub fn unpack(&self) -> CATCOLLECTIONT {
        let RECORDS = self
            .RECORDS()
            .map(|x| x.iter().map(|t| t.unpack()).collect());
        CATCOLLECTIONT { RECORDS }
    }

    #[inline]
    pub fn RECORDS(
        &self,
    ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<CAT<'a>>>> {
        // Safety:
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe {
            self._tab.get::<flatbuffers::ForwardsUOffset<
                flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<CAT>>,
            >>(CATCOLLECTION::VT_RECORDS, None)
        }
    }
}
...
impl flatbuffers::Verifiable for CATCOLLECTION<'_> {
    ...
    fn run_verifier(
        ...
        v.visit_table(pos)?
            .visit_field::<flatbuffers::ForwardsUOffset<
                flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<CAT>>,
...
pub struct CATCOLLECTIONArgs<'a> {
    pub RECORDS: Option<
        flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<CAT<'a>>>>,
    >,
}
impl<'a> Default for CATCOLLECTIONArgs<'a> {
    #[inline]
    fn default() -> Self {
        CATCOLLECTIONArgs { RECORDS: None }
    }
}
...
impl<'a: 'b, 'b> CATCOLLECTIONBuilder<'a, 'b> {
    ...
    pub fn add_RECORDS(
        ...
        RECORDS: flatbuffers::WIPOffset<
            flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<CAT<'b>>>,
        >,
    ) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(CATCOLLECTION::VT_RECORDS, RECORDS);
    }
    #[inline]
...
impl CATCOLLECTIONT {
    pub fn pack<'b>(
        ...
        CATCOLLECTION::create(_fbb, &CATCOLLECTIONArgs { RECORDS })
    }
}
#[inline]
...
#[inline]
pub fn finish_size_prefixed_CAT_buffer<'a, 'b>(
    fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
    root: flatbuffers::WIPOffset<CAT<'a>>,
) {
