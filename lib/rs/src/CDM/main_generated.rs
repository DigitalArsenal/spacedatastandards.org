...
pub const ENUM_VALUES_SCREENING_VOLUME_SHAPE: [screeningVolumeShape; 2] =
    [screeningVolumeShape::ELLIPSOID, screeningVolumeShape::BOX];
...
impl screeningVolumeShape {
    ...
    pub const ENUM_VALUES: &'static [Self] = &[Self::ELLIPSOID, Self::BOX];
...
pub const ENUM_VALUES_COVARIANCE_METHOD: [covarianceMethod; 2] =
    [covarianceMethod::CALCULATED, covarianceMethod::DEFAULT];
...
impl covarianceMethod {
    ...
    pub const ENUM_MIN: i8 = 0;
    pub const ENUM_MAX: i8 = 1;
    pub const ENUM_VALUES: &'static [Self] = &[Self::CALCULATED, Self::DEFAULT];
    /// Returns the variant's name or "" if unknown.
    pub fn variant_name(self) -> Option<&'static str> {
        match self {
...
impl<'a> CDMObject<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        ...
        if let Some(x) = args.TIME_LASTOB_END {
            builder.add_TIME_LASTOB_END(x);
        }
        if let Some(x) = args.TIME_LASTOB_START {
            builder.add_TIME_LASTOB_START(x);
        }
        if let Some(x) = args.N_BODY_PERTURBATIONS {
            builder.add_N_BODY_PERTURBATIONS(x);
        }
        if let Some(x) = args.ATMOSPHERIC_MODEL {
            builder.add_ATMOSPHERIC_MODEL(x);
        }
        if let Some(x) = args.GRAVITY_MODEL {
            builder.add_GRAVITY_MODEL(x);
        }
        if let Some(x) = args.EPHEMERIS_NAME {
            builder.add_EPHEMERIS_NAME(x);
        }
        if let Some(x) = args.OPERATOR_ORGANIZATION {
            builder.add_OPERATOR_ORGANIZATION(x);
        }
        if let Some(x) = args.OPERATOR_CONTACT_POSITION {
            builder.add_OPERATOR_CONTACT_POSITION(x);
        }
        if let Some(x) = args.POC {
            builder.add_POC(x);
        }
    ...
    pub fn unpack(&self) -> CDMObjectT {
        let COMMENT = self.COMMENT().map(|x| x.to_string());
        let OBJECT = self.OBJECT().map(|x| Box::new(x.unpack()));
        let POC = self.POC().map(|x| Box::new(x.unpack()));
        let OPERATOR_CONTACT_POSITION = self.OPERATOR_CONTACT_POSITION().map(|x| x.to_string());
        let OPERATOR_ORGANIZATION = self.OPERATOR_ORGANIZATION().map(|x| x.to_string());
        let EPHEMERIS_NAME = self.EPHEMERIS_NAME().map(|x| x.to_string());
        let COVARIANCE_METHOD = self.COVARIANCE_METHOD();
        let REFERENCE_FRAME = self.REFERENCE_FRAME();
        let GRAVITY_MODEL = self.GRAVITY_MODEL().map(|x| x.to_string());
        let ATMOSPHERIC_MODEL = self.ATMOSPHERIC_MODEL().map(|x| x.to_string());
        let N_BODY_PERTURBATIONS = self.N_BODY_PERTURBATIONS().map(|x| x.to_string());
        let SOLAR_RAD_PRESSURE = self.SOLAR_RAD_PRESSURE();
        let EARTH_TIDES = self.EARTH_TIDES();
        let INTRACK_THRUST = self.INTRACK_THRUST();
        let TIME_LASTOB_START = self.TIME_LASTOB_START().map(|x| x.to_string());
        let TIME_LASTOB_END = self.TIME_LASTOB_END().map(|x| x.to_string());
    ...
    pub fn COMMENT(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(CDMObject::VT_COMMENT, None)
        }
    }
    #[inline]
    pub fn OBJECT(&self) -> Option<CAT<'a>> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<CAT>>(CDMObject::VT_OBJECT, None)
        }
    }
    /// Point of Contact
    #[inline]
    pub fn POC(&self) -> Option<EPM<'a>> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<EPM>>(CDMObject::VT_POC, None)
        }
    }
    ...
    pub fn OPERATOR_CONTACT_POSITION(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(
                CDMObject::VT_OPERATOR_CONTACT_POSITION,
                None,
            )
        }
    }
    ...
    pub fn OPERATOR_ORGANIZATION(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(
                CDMObject::VT_OPERATOR_ORGANIZATION,
                None,
            )
        }
    }
    ...
    pub fn EPHEMERIS_NAME(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(CDMObject::VT_EPHEMERIS_NAME, None)
        }
    }
    /// Covariance method
    #[inline]
    pub fn COVARIANCE_METHOD(&self) -> covarianceMethod {
        ...
        unsafe {
            self._tab
                .get::<covarianceMethod>(
                    CDMObject::VT_COVARIANCE_METHOD,
                    Some(covarianceMethod::CALCULATED),
                )
                .unwrap()
        }
    }
    ...
    pub fn REFERENCE_FRAME(&self) -> refFrame {
        ...
        unsafe {
            self._tab
                .get::<refFrame>(CDMObject::VT_REFERENCE_FRAME, Some(refFrame::ECEF))
                .unwrap()
        }
    }
    /// Gravity model
    ...
    pub fn GRAVITY_MODEL(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(CDMObject::VT_GRAVITY_MODEL, None)
        }
    }
    /// Atmospheric model
    #[inline]
    pub fn ATMOSPHERIC_MODEL(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(CDMObject::VT_ATMOSPHERIC_MODEL, None)
        }
    }
    ...
    pub fn N_BODY_PERTURBATIONS(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(CDMObject::VT_N_BODY_PERTURBATIONS, None)
        }
    }
    ...
    pub fn SOLAR_RAD_PRESSURE(&self) -> bool {
        ...
        unsafe {
            self._tab
                .get::<bool>(CDMObject::VT_SOLAR_RAD_PRESSURE, Some(false))
                .unwrap()
        }
    }
    /// Earth tides
    ...
    pub fn EARTH_TIDES(&self) -> bool {
        ...
        unsafe {
            self._tab
                .get::<bool>(CDMObject::VT_EARTH_TIDES, Some(false))
                .unwrap()
        }
    }
    /// Intrack thrust
    ...
    pub fn INTRACK_THRUST(&self) -> bool {
        ...
        unsafe {
            self._tab
                .get::<bool>(CDMObject::VT_INTRACK_THRUST, Some(false))
                .unwrap()
        }
    }
    ...
    pub fn TIME_LASTOB_START(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(CDMObject::VT_TIME_LASTOB_START, None)
        }
    }
    ...
    pub fn TIME_LASTOB_END(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(CDMObject::VT_TIME_LASTOB_END, None)
        }
    }
    ...
    pub fn RECOMMENDED_OD_SPAN(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDMObject::VT_RECOMMENDED_OD_SPAN, Some(0.0))
                .unwrap()
        }
    }
    ...
    pub fn ACTUAL_OD_SPAN(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDMObject::VT_ACTUAL_OD_SPAN, Some(0.0))
                .unwrap()
        }
    }
    ...
    pub fn OBS_AVAILABLE(&self) -> u32 {
        ...
        unsafe {
            self._tab
                .get::<u32>(CDMObject::VT_OBS_AVAILABLE, Some(0))
                .unwrap()
        }
    }
    ...
    pub fn OBS_USED(&self) -> u32 {
        ...
        unsafe {
            self._tab
                .get::<u32>(CDMObject::VT_OBS_USED, Some(0))
                .unwrap()
        }
    }
    ...
    pub fn TRACKS_AVAILABLE(&self) -> u32 {
        ...
        unsafe {
            self._tab
                .get::<u32>(CDMObject::VT_TRACKS_AVAILABLE, Some(0))
                .unwrap()
        }
    }
    ...
    pub fn TRACKS_USED(&self) -> u32 {
        ...
        unsafe {
            self._tab
                .get::<u32>(CDMObject::VT_TRACKS_USED, Some(0))
                .unwrap()
        }
    }
    /// Residuals accepted
    ...
    pub fn RESIDUALS_ACCEPTED(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDMObject::VT_RESIDUALS_ACCEPTED, Some(0.0))
                .unwrap()
        }
    }
    ...
    pub fn WEIGHTED_RMS(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDMObject::VT_WEIGHTED_RMS, Some(0.0))
                .unwrap()
        }
    }
    /// Area of the object
    ...
    pub fn AREA_PC(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDMObject::VT_AREA_PC, Some(0.0))
                .unwrap()
        }
    }
    ...
    pub fn AREA_DRG(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDMObject::VT_AREA_DRG, Some(0.0))
                .unwrap()
        }
    }
    ...
    pub fn AREA_SRP(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDMObject::VT_AREA_SRP, Some(0.0))
                .unwrap()
        }
    }
    ...
    pub fn CR_AREA_OVER_MASS(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDMObject::VT_CR_AREA_OVER_MASS, Some(0.0))
                .unwrap()
        }
    }
    ...
    pub fn THRUST_ACCELERATION(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDMObject::VT_THRUST_ACCELERATION, Some(0.0))
                .unwrap()
        }
    }
    /// Object's solar flux
    ...
    pub fn X_DOT(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDMObject::VT_X_DOT, Some(0.0))
                .unwrap()
        }
    }
    /// Y-coordinate of the object's position in RTN
    ...
    pub fn Y_DOT(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDMObject::VT_Y_DOT, Some(0.0))
                .unwrap()
        }
    }
    /// Z-coordinate of the object's position in RTN
    ...
    pub fn Z_DOT(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDMObject::VT_Z_DOT, Some(0.0))
                .unwrap()
        }
    }
    ...
    pub fn CRDOT_R(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDMObject::VT_CRDOT_R, Some(0.0))
                .unwrap()
        }
    }
    /// Covariance Matrix component
    ...
    pub fn CRDOT_T(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDMObject::VT_CRDOT_T, Some(0.0))
                .unwrap()
        }
    }
    /// Covariance Matrix component
    ...
    pub fn CRDOT_N(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDMObject::VT_CRDOT_N, Some(0.0))
                .unwrap()
        }
    }
    /// Covariance Matrix component
    ...
    pub fn CRDOT_RDOT(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDMObject::VT_CRDOT_RDOT, Some(0.0))
                .unwrap()
        }
    }
    /// Covariance Matrix component
    ...
    pub fn CTDOT_R(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDMObject::VT_CTDOT_R, Some(0.0))
                .unwrap()
        }
    }
    /// Covariance Matrix component
    ...
    pub fn CTDOT_T(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDMObject::VT_CTDOT_T, Some(0.0))
                .unwrap()
        }
    }
    /// Covariance Matrix component
    ...
    pub fn CTDOT_N(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDMObject::VT_CTDOT_N, Some(0.0))
                .unwrap()
        }
    }
    /// Covariance Matrix component
    ...
    pub fn CTDOT_RDOT(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDMObject::VT_CTDOT_RDOT, Some(0.0))
                .unwrap()
        }
    }
    /// Covariance Matrix component
    ...
    pub fn CTDOT_TDOT(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDMObject::VT_CTDOT_TDOT, Some(0.0))
                .unwrap()
        }
    }
    /// Covariance Matrix component
    ...
    pub fn CNDOT_R(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDMObject::VT_CNDOT_R, Some(0.0))
                .unwrap()
        }
    }
    /// Covariance Matrix component
    ...
    pub fn CNDOT_T(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDMObject::VT_CNDOT_T, Some(0.0))
                .unwrap()
        }
    }
    /// Covariance Matrix component
    ...
    pub fn CNDOT_N(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDMObject::VT_CNDOT_N, Some(0.0))
                .unwrap()
        }
    }
    /// Covariance Matrix component
    ...
    pub fn CNDOT_RDOT(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDMObject::VT_CNDOT_RDOT, Some(0.0))
                .unwrap()
        }
    }
    /// Covariance Matrix component
    ...
    pub fn CNDOT_TDOT(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDMObject::VT_CNDOT_TDOT, Some(0.0))
                .unwrap()
        }
    }
    /// Covariance Matrix component
    ...
    pub fn CNDOT_NDOT(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDMObject::VT_CNDOT_NDOT, Some(0.0))
                .unwrap()
        }
    }
    /// Covariance Matrix component
    ...
    pub fn CDRG_R(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDMObject::VT_CDRG_R, Some(0.0))
                .unwrap()
        }
    }
    /// Covariance Matrix component
    ...
    pub fn CDRG_T(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDMObject::VT_CDRG_T, Some(0.0))
                .unwrap()
        }
    }
    /// Covariance Matrix component
    ...
    pub fn CDRG_N(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDMObject::VT_CDRG_N, Some(0.0))
                .unwrap()
        }
    }
    /// Covariance Matrix component
    ...
    pub fn CDRG_RDOT(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDMObject::VT_CDRG_RDOT, Some(0.0))
                .unwrap()
        }
    }
    /// Covariance Matrix component
    ...
    pub fn CDRG_TDOT(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDMObject::VT_CDRG_TDOT, Some(0.0))
                .unwrap()
        }
    }
    /// Covariance Matrix component
    ...
    pub fn CDRG_NDOT(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDMObject::VT_CDRG_NDOT, Some(0.0))
                .unwrap()
        }
    }
    /// Covariance Matrix component
    ...
    pub fn CDRG_DRG(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDMObject::VT_CDRG_DRG, Some(0.0))
                .unwrap()
        }
    }
    /// Covariance Matrix component
    ...
    pub fn CSRP_R(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDMObject::VT_CSRP_R, Some(0.0))
                .unwrap()
        }
    }
    /// Covariance Matrix component
    ...
    pub fn CSRP_T(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDMObject::VT_CSRP_T, Some(0.0))
                .unwrap()
        }
    }
    /// Covariance Matrix component
    ...
    pub fn CSRP_N(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDMObject::VT_CSRP_N, Some(0.0))
                .unwrap()
        }
    }
    /// Covariance Matrix component
    ...
    pub fn CSRP_RDOT(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDMObject::VT_CSRP_RDOT, Some(0.0))
                .unwrap()
        }
    }
    /// Covariance Matrix component
    ...
    pub fn CSRP_TDOT(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDMObject::VT_CSRP_TDOT, Some(0.0))
                .unwrap()
        }
    }
    /// Covariance Matrix component
    ...
    pub fn CSRP_NDOT(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDMObject::VT_CSRP_NDOT, Some(0.0))
                .unwrap()
        }
    }
    /// Covariance Matrix component
    ...
    pub fn CSRP_DRG(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDMObject::VT_CSRP_DRG, Some(0.0))
                .unwrap()
        }
    }
    /// Covariance Matrix component
    ...
    pub fn CSRP_SRP(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDMObject::VT_CSRP_SRP, Some(0.0))
                .unwrap()
        }
    }
    /// Covariance Matrix component
    ...
    pub fn CTHR_R(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDMObject::VT_CTHR_R, Some(0.0))
                .unwrap()
        }
    }
    /// Covariance Matrix component
    ...
    pub fn CTHR_T(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDMObject::VT_CTHR_T, Some(0.0))
                .unwrap()
        }
    }
    /// Covariance Matrix component
    ...
    pub fn CTHR_N(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDMObject::VT_CTHR_N, Some(0.0))
                .unwrap()
        }
    }
    /// Covariance Matrix component
    ...
    pub fn CTHR_RDOT(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDMObject::VT_CTHR_RDOT, Some(0.0))
                .unwrap()
        }
    }
    /// Covariance Matrix component
    ...
    pub fn CTHR_TDOT(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDMObject::VT_CTHR_TDOT, Some(0.0))
                .unwrap()
        }
    }
    /// Covariance Matrix component
    ...
    pub fn CTHR_NDOT(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDMObject::VT_CTHR_NDOT, Some(0.0))
                .unwrap()
        }
    }
    /// Covariance Matrix component
    ...
    pub fn CTHR_DRG(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDMObject::VT_CTHR_DRG, Some(0.0))
                .unwrap()
        }
    }
    /// Covariance Matrix component
    ...
    pub fn CTHR_SRP(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDMObject::VT_CTHR_SRP, Some(0.0))
                .unwrap()
        }
    }
    /// Covariance Matrix component
    ...
    pub fn CTHR_THR(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDMObject::VT_CTHR_THR, Some(0.0))
                .unwrap()
        }
    }
}
    ...
    fn run_verifier(
        ...
        v.visit_table(pos)?
            ...
            .visit_field::<flatbuffers::ForwardsUOffset<&str>>(
                "OPERATOR_CONTACT_POSITION",
                Self::VT_OPERATOR_CONTACT_POSITION,
                false,
            )?
            .visit_field::<flatbuffers::ForwardsUOffset<&str>>(
                "OPERATOR_ORGANIZATION",
                Self::VT_OPERATOR_ORGANIZATION,
                false,
            )?
            .visit_field::<flatbuffers::ForwardsUOffset<&str>>(
                "EPHEMERIS_NAME",
                Self::VT_EPHEMERIS_NAME,
                false,
            )?
            .visit_field::<covarianceMethod>(
                "COVARIANCE_METHOD",
                Self::VT_COVARIANCE_METHOD,
                false,
            )?
            .visit_field::<refFrame>("REFERENCE_FRAME", Self::VT_REFERENCE_FRAME, false)?
            .visit_field::<flatbuffers::ForwardsUOffset<&str>>(
                "GRAVITY_MODEL",
                Self::VT_GRAVITY_MODEL,
                false,
            )?
            .visit_field::<flatbuffers::ForwardsUOffset<&str>>(
                "ATMOSPHERIC_MODEL",
                Self::VT_ATMOSPHERIC_MODEL,
                false,
            )?
            .visit_field::<flatbuffers::ForwardsUOffset<&str>>(
                "N_BODY_PERTURBATIONS",
                Self::VT_N_BODY_PERTURBATIONS,
                false,
            )?
            ...
            .visit_field::<flatbuffers::ForwardsUOffset<&str>>(
                "TIME_LASTOB_START",
                Self::VT_TIME_LASTOB_START,
                false,
            )?
            .visit_field::<flatbuffers::ForwardsUOffset<&str>>(
                "TIME_LASTOB_END",
                Self::VT_TIME_LASTOB_END,
                false,
            )?
...
impl<'a: 'b, 'b> CDMObjectBuilder<'a, 'b> {
    ...
    pub fn add_COMMENT(&mut self, COMMENT: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(CDMObject::VT_COMMENT, COMMENT);
    }
    #[inline]
    pub fn add_OBJECT(&mut self, OBJECT: flatbuffers::WIPOffset<CAT<'b>>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<CAT>>(CDMObject::VT_OBJECT, OBJECT);
    }
    #[inline]
    pub fn add_POC(&mut self, POC: flatbuffers::WIPOffset<EPM<'b>>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<EPM>>(CDMObject::VT_POC, POC);
    }
    #[inline]
    pub fn add_OPERATOR_CONTACT_POSITION(
        &mut self,
        OPERATOR_CONTACT_POSITION: flatbuffers::WIPOffset<&'b str>,
    ) {
    ...
    #[inline]
    pub fn add_OPERATOR_ORGANIZATION(
        &mut self,
        OPERATOR_ORGANIZATION: flatbuffers::WIPOffset<&'b str>,
    ) {
        self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
            CDMObject::VT_OPERATOR_ORGANIZATION,
            OPERATOR_ORGANIZATION,
    ...
    pub fn add_REFERENCE_FRAME(&mut self, REFERENCE_FRAME: refFrame) {
        self.fbb_.push_slot::<refFrame>(
            CDMObject::VT_REFERENCE_FRAME,
            REFERENCE_FRAME,
            refFrame::ECEF,
        );
    }
    ...
    pub fn add_ATMOSPHERIC_MODEL(&mut self, ATMOSPHERIC_MODEL: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
            CDMObject::VT_ATMOSPHERIC_MODEL,
            ATMOSPHERIC_MODEL,
        );
    }
    #[inline]
    pub fn add_N_BODY_PERTURBATIONS(
        &mut self,
        N_BODY_PERTURBATIONS: flatbuffers::WIPOffset<&'b str>,
    ) {
        self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
            CDMObject::VT_N_BODY_PERTURBATIONS,
            N_BODY_PERTURBATIONS,
        );
    }
    #[inline]
    pub fn add_SOLAR_RAD_PRESSURE(&mut self, SOLAR_RAD_PRESSURE: bool) {
        self.fbb_
            .push_slot::<bool>(CDMObject::VT_SOLAR_RAD_PRESSURE, SOLAR_RAD_PRESSURE, false);
    }
    #[inline]
    pub fn add_EARTH_TIDES(&mut self, EARTH_TIDES: bool) {
        self.fbb_
            .push_slot::<bool>(CDMObject::VT_EARTH_TIDES, EARTH_TIDES, false);
    }
    #[inline]
    pub fn add_INTRACK_THRUST(&mut self, INTRACK_THRUST: bool) {
        self.fbb_
            .push_slot::<bool>(CDMObject::VT_INTRACK_THRUST, INTRACK_THRUST, false);
    }
    #[inline]
    pub fn add_TIME_LASTOB_START(&mut self, TIME_LASTOB_START: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
            CDMObject::VT_TIME_LASTOB_START,
            TIME_LASTOB_START,
        );
    }
    #[inline]
    ...
    pub fn add_RECOMMENDED_OD_SPAN(&mut self, RECOMMENDED_OD_SPAN: f64) {
        self.fbb_
            .push_slot::<f64>(CDMObject::VT_RECOMMENDED_OD_SPAN, RECOMMENDED_OD_SPAN, 0.0);
    }
    #[inline]
    pub fn add_ACTUAL_OD_SPAN(&mut self, ACTUAL_OD_SPAN: f64) {
        self.fbb_
            .push_slot::<f64>(CDMObject::VT_ACTUAL_OD_SPAN, ACTUAL_OD_SPAN, 0.0);
    }
    #[inline]
    pub fn add_OBS_AVAILABLE(&mut self, OBS_AVAILABLE: u32) {
        self.fbb_
            .push_slot::<u32>(CDMObject::VT_OBS_AVAILABLE, OBS_AVAILABLE, 0);
    }
    #[inline]
    pub fn add_OBS_USED(&mut self, OBS_USED: u32) {
        self.fbb_
            .push_slot::<u32>(CDMObject::VT_OBS_USED, OBS_USED, 0);
    }
    #[inline]
    pub fn add_TRACKS_AVAILABLE(&mut self, TRACKS_AVAILABLE: u32) {
        self.fbb_
            .push_slot::<u32>(CDMObject::VT_TRACKS_AVAILABLE, TRACKS_AVAILABLE, 0);
    }
    #[inline]
    pub fn add_TRACKS_USED(&mut self, TRACKS_USED: u32) {
        self.fbb_
            .push_slot::<u32>(CDMObject::VT_TRACKS_USED, TRACKS_USED, 0);
    }
    #[inline]
    pub fn add_RESIDUALS_ACCEPTED(&mut self, RESIDUALS_ACCEPTED: f64) {
        self.fbb_
            .push_slot::<f64>(CDMObject::VT_RESIDUALS_ACCEPTED, RESIDUALS_ACCEPTED, 0.0);
    }
    #[inline]
    pub fn add_WEIGHTED_RMS(&mut self, WEIGHTED_RMS: f64) {
        self.fbb_
            .push_slot::<f64>(CDMObject::VT_WEIGHTED_RMS, WEIGHTED_RMS, 0.0);
    }
    #[inline]
    pub fn add_AREA_PC(&mut self, AREA_PC: f64) {
        self.fbb_
            .push_slot::<f64>(CDMObject::VT_AREA_PC, AREA_PC, 0.0);
    }
    #[inline]
    pub fn add_AREA_DRG(&mut self, AREA_DRG: f64) {
        self.fbb_
            .push_slot::<f64>(CDMObject::VT_AREA_DRG, AREA_DRG, 0.0);
    }
    #[inline]
    pub fn add_AREA_SRP(&mut self, AREA_SRP: f64) {
        self.fbb_
            .push_slot::<f64>(CDMObject::VT_AREA_SRP, AREA_SRP, 0.0);
    }
    #[inline]
    pub fn add_CR_AREA_OVER_MASS(&mut self, CR_AREA_OVER_MASS: f64) {
        self.fbb_
            .push_slot::<f64>(CDMObject::VT_CR_AREA_OVER_MASS, CR_AREA_OVER_MASS, 0.0);
    }
    #[inline]
    pub fn add_THRUST_ACCELERATION(&mut self, THRUST_ACCELERATION: f64) {
        self.fbb_
            .push_slot::<f64>(CDMObject::VT_THRUST_ACCELERATION, THRUST_ACCELERATION, 0.0);
    }
    #[inline]
    ...
    pub fn add_CRDOT_R(&mut self, CRDOT_R: f64) {
        self.fbb_
            .push_slot::<f64>(CDMObject::VT_CRDOT_R, CRDOT_R, 0.0);
    }
    #[inline]
    pub fn add_CRDOT_T(&mut self, CRDOT_T: f64) {
        self.fbb_
            .push_slot::<f64>(CDMObject::VT_CRDOT_T, CRDOT_T, 0.0);
    }
    #[inline]
    pub fn add_CRDOT_N(&mut self, CRDOT_N: f64) {
        self.fbb_
            .push_slot::<f64>(CDMObject::VT_CRDOT_N, CRDOT_N, 0.0);
    }
    #[inline]
    pub fn add_CRDOT_RDOT(&mut self, CRDOT_RDOT: f64) {
        self.fbb_
            .push_slot::<f64>(CDMObject::VT_CRDOT_RDOT, CRDOT_RDOT, 0.0);
    }
    #[inline]
    pub fn add_CTDOT_R(&mut self, CTDOT_R: f64) {
        self.fbb_
            .push_slot::<f64>(CDMObject::VT_CTDOT_R, CTDOT_R, 0.0);
    }
    #[inline]
    pub fn add_CTDOT_T(&mut self, CTDOT_T: f64) {
        self.fbb_
            .push_slot::<f64>(CDMObject::VT_CTDOT_T, CTDOT_T, 0.0);
    }
    #[inline]
    pub fn add_CTDOT_N(&mut self, CTDOT_N: f64) {
        self.fbb_
            .push_slot::<f64>(CDMObject::VT_CTDOT_N, CTDOT_N, 0.0);
    }
    #[inline]
    pub fn add_CTDOT_RDOT(&mut self, CTDOT_RDOT: f64) {
        self.fbb_
            .push_slot::<f64>(CDMObject::VT_CTDOT_RDOT, CTDOT_RDOT, 0.0);
    }
    #[inline]
    pub fn add_CTDOT_TDOT(&mut self, CTDOT_TDOT: f64) {
        self.fbb_
            .push_slot::<f64>(CDMObject::VT_CTDOT_TDOT, CTDOT_TDOT, 0.0);
    }
    #[inline]
    pub fn add_CNDOT_R(&mut self, CNDOT_R: f64) {
        self.fbb_
            .push_slot::<f64>(CDMObject::VT_CNDOT_R, CNDOT_R, 0.0);
    }
    #[inline]
    pub fn add_CNDOT_T(&mut self, CNDOT_T: f64) {
        self.fbb_
            .push_slot::<f64>(CDMObject::VT_CNDOT_T, CNDOT_T, 0.0);
    }
    #[inline]
    pub fn add_CNDOT_N(&mut self, CNDOT_N: f64) {
        self.fbb_
            .push_slot::<f64>(CDMObject::VT_CNDOT_N, CNDOT_N, 0.0);
    }
    #[inline]
    pub fn add_CNDOT_RDOT(&mut self, CNDOT_RDOT: f64) {
        self.fbb_
            .push_slot::<f64>(CDMObject::VT_CNDOT_RDOT, CNDOT_RDOT, 0.0);
    }
    #[inline]
    pub fn add_CNDOT_TDOT(&mut self, CNDOT_TDOT: f64) {
        self.fbb_
            .push_slot::<f64>(CDMObject::VT_CNDOT_TDOT, CNDOT_TDOT, 0.0);
    }
    #[inline]
    pub fn add_CNDOT_NDOT(&mut self, CNDOT_NDOT: f64) {
        self.fbb_
            .push_slot::<f64>(CDMObject::VT_CNDOT_NDOT, CNDOT_NDOT, 0.0);
    }
    #[inline]
    pub fn add_CDRG_R(&mut self, CDRG_R: f64) {
        self.fbb_
            .push_slot::<f64>(CDMObject::VT_CDRG_R, CDRG_R, 0.0);
    }
    #[inline]
    pub fn add_CDRG_T(&mut self, CDRG_T: f64) {
        self.fbb_
            .push_slot::<f64>(CDMObject::VT_CDRG_T, CDRG_T, 0.0);
    }
    #[inline]
    pub fn add_CDRG_N(&mut self, CDRG_N: f64) {
        self.fbb_
            .push_slot::<f64>(CDMObject::VT_CDRG_N, CDRG_N, 0.0);
    }
    #[inline]
    pub fn add_CDRG_RDOT(&mut self, CDRG_RDOT: f64) {
        self.fbb_
            .push_slot::<f64>(CDMObject::VT_CDRG_RDOT, CDRG_RDOT, 0.0);
    }
    #[inline]
    pub fn add_CDRG_TDOT(&mut self, CDRG_TDOT: f64) {
        self.fbb_
            .push_slot::<f64>(CDMObject::VT_CDRG_TDOT, CDRG_TDOT, 0.0);
    }
    #[inline]
    pub fn add_CDRG_NDOT(&mut self, CDRG_NDOT: f64) {
        self.fbb_
            .push_slot::<f64>(CDMObject::VT_CDRG_NDOT, CDRG_NDOT, 0.0);
    }
    #[inline]
    pub fn add_CDRG_DRG(&mut self, CDRG_DRG: f64) {
        self.fbb_
            .push_slot::<f64>(CDMObject::VT_CDRG_DRG, CDRG_DRG, 0.0);
    }
    #[inline]
    pub fn add_CSRP_R(&mut self, CSRP_R: f64) {
        self.fbb_
            .push_slot::<f64>(CDMObject::VT_CSRP_R, CSRP_R, 0.0);
    }
    #[inline]
    pub fn add_CSRP_T(&mut self, CSRP_T: f64) {
        self.fbb_
            .push_slot::<f64>(CDMObject::VT_CSRP_T, CSRP_T, 0.0);
    }
    #[inline]
    pub fn add_CSRP_N(&mut self, CSRP_N: f64) {
        self.fbb_
            .push_slot::<f64>(CDMObject::VT_CSRP_N, CSRP_N, 0.0);
    }
    #[inline]
    pub fn add_CSRP_RDOT(&mut self, CSRP_RDOT: f64) {
        self.fbb_
            .push_slot::<f64>(CDMObject::VT_CSRP_RDOT, CSRP_RDOT, 0.0);
    }
    #[inline]
    pub fn add_CSRP_TDOT(&mut self, CSRP_TDOT: f64) {
        self.fbb_
            .push_slot::<f64>(CDMObject::VT_CSRP_TDOT, CSRP_TDOT, 0.0);
    }
    #[inline]
    pub fn add_CSRP_NDOT(&mut self, CSRP_NDOT: f64) {
        self.fbb_
            .push_slot::<f64>(CDMObject::VT_CSRP_NDOT, CSRP_NDOT, 0.0);
    }
    #[inline]
    pub fn add_CSRP_DRG(&mut self, CSRP_DRG: f64) {
        self.fbb_
            .push_slot::<f64>(CDMObject::VT_CSRP_DRG, CSRP_DRG, 0.0);
    }
    #[inline]
    pub fn add_CSRP_SRP(&mut self, CSRP_SRP: f64) {
        self.fbb_
            .push_slot::<f64>(CDMObject::VT_CSRP_SRP, CSRP_SRP, 0.0);
    }
    #[inline]
    pub fn add_CTHR_R(&mut self, CTHR_R: f64) {
        self.fbb_
            .push_slot::<f64>(CDMObject::VT_CTHR_R, CTHR_R, 0.0);
    }
    #[inline]
    pub fn add_CTHR_T(&mut self, CTHR_T: f64) {
        self.fbb_
            .push_slot::<f64>(CDMObject::VT_CTHR_T, CTHR_T, 0.0);
    }
    #[inline]
    pub fn add_CTHR_N(&mut self, CTHR_N: f64) {
        self.fbb_
            .push_slot::<f64>(CDMObject::VT_CTHR_N, CTHR_N, 0.0);
    }
    #[inline]
    pub fn add_CTHR_RDOT(&mut self, CTHR_RDOT: f64) {
        self.fbb_
            .push_slot::<f64>(CDMObject::VT_CTHR_RDOT, CTHR_RDOT, 0.0);
    }
    #[inline]
    pub fn add_CTHR_TDOT(&mut self, CTHR_TDOT: f64) {
        self.fbb_
            .push_slot::<f64>(CDMObject::VT_CTHR_TDOT, CTHR_TDOT, 0.0);
    }
    #[inline]
    pub fn add_CTHR_NDOT(&mut self, CTHR_NDOT: f64) {
        self.fbb_
            .push_slot::<f64>(CDMObject::VT_CTHR_NDOT, CTHR_NDOT, 0.0);
    }
    #[inline]
    pub fn add_CTHR_DRG(&mut self, CTHR_DRG: f64) {
        self.fbb_
            .push_slot::<f64>(CDMObject::VT_CTHR_DRG, CTHR_DRG, 0.0);
    }
    #[inline]
    pub fn add_CTHR_SRP(&mut self, CTHR_SRP: f64) {
        self.fbb_
            .push_slot::<f64>(CDMObject::VT_CTHR_SRP, CTHR_SRP, 0.0);
    }
    #[inline]
    pub fn add_CTHR_THR(&mut self, CTHR_THR: f64) {
        self.fbb_
            .push_slot::<f64>(CDMObject::VT_CTHR_THR, CTHR_THR, 0.0);
    }
    #[inline]
...
impl core::fmt::Debug for CDMObject<'_> {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        ...
        ds.field(
            "OPERATOR_CONTACT_POSITION",
            &self.OPERATOR_CONTACT_POSITION(),
        );
...
impl CDMObjectT {
    pub fn pack<'b>(
        ...
        let COMMENT = self.COMMENT.as_ref().map(|x| _fbb.create_string(x));
        let OBJECT = self.OBJECT.as_ref().map(|x| x.pack(_fbb));
        let POC = self.POC.as_ref().map(|x| x.pack(_fbb));
        let OPERATOR_CONTACT_POSITION = self
            .OPERATOR_CONTACT_POSITION
            .as_ref()
            .map(|x| _fbb.create_string(x));
        let OPERATOR_ORGANIZATION = self
            .OPERATOR_ORGANIZATION
            .as_ref()
            .map(|x| _fbb.create_string(x));
        let EPHEMERIS_NAME = self.EPHEMERIS_NAME.as_ref().map(|x| _fbb.create_string(x));
        let COVARIANCE_METHOD = self.COVARIANCE_METHOD;
        let REFERENCE_FRAME = self.REFERENCE_FRAME;
        let GRAVITY_MODEL = self.GRAVITY_MODEL.as_ref().map(|x| _fbb.create_string(x));
        let ATMOSPHERIC_MODEL = self
            .ATMOSPHERIC_MODEL
            .as_ref()
            .map(|x| _fbb.create_string(x));
        let N_BODY_PERTURBATIONS = self
            .N_BODY_PERTURBATIONS
            .as_ref()
            .map(|x| _fbb.create_string(x));
        let SOLAR_RAD_PRESSURE = self.SOLAR_RAD_PRESSURE;
        let EARTH_TIDES = self.EARTH_TIDES;
        let INTRACK_THRUST = self.INTRACK_THRUST;
        let TIME_LASTOB_START = self
            .TIME_LASTOB_START
            .as_ref()
            .map(|x| _fbb.create_string(x));
        let TIME_LASTOB_END = self.TIME_LASTOB_END.as_ref().map(|x| _fbb.create_string(x));
        let RECOMMENDED_OD_SPAN = self.RECOMMENDED_OD_SPAN;
        let ACTUAL_OD_SPAN = self.ACTUAL_OD_SPAN;
        let OBS_AVAILABLE = self.OBS_AVAILABLE;
        let OBS_USED = self.OBS_USED;
...
impl<'a> CDM<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        ...
        if let Some(x) = args.OBJECT2_DATASOURCE {
            builder.add_OBJECT2_DATASOURCE(x);
        }
        if let Some(x) = args.OBJECT1_DATASOURCE {
            builder.add_OBJECT1_DATASOURCE(x);
        }
        if let Some(x) = args.OBJECT2 {
            builder.add_OBJECT2(x);
        }
        if let Some(x) = args.OBJECT1 {
            builder.add_OBJECT1(x);
        }
        if let Some(x) = args.COLLISION_PROBABILITY_METHOD {
            builder.add_COLLISION_PROBABILITY_METHOD(x);
        }
        if let Some(x) = args.SCREEN_EXIT_TIME {
            builder.add_SCREEN_EXIT_TIME(x);
        }
        if let Some(x) = args.SCREEN_ENTRY_TIME {
            builder.add_SCREEN_ENTRY_TIME(x);
        }
        if let Some(x) = args.STOP_SCREEN_PERIOD {
            builder.add_STOP_SCREEN_PERIOD(x);
        }
        if let Some(x) = args.START_SCREEN_PERIOD {
            builder.add_START_SCREEN_PERIOD(x);
        }
        if let Some(x) = args.TCA {
            builder.add_TCA(x);
        }
        if let Some(x) = args.MESSAGE_ID {
            builder.add_MESSAGE_ID(x);
        }
        if let Some(x) = args.MESSAGE_FOR {
            builder.add_MESSAGE_FOR(x);
        }
        if let Some(x) = args.ORIGINATOR {
            builder.add_ORIGINATOR(x);
        }
        if let Some(x) = args.CREATION_DATE {
            builder.add_CREATION_DATE(x);
        }
    ...
    pub fn unpack(&self) -> CDMT {
        ...
        let CREATION_DATE = self.CREATION_DATE().map(|x| x.to_string());
        let ORIGINATOR = self.ORIGINATOR().map(|x| x.to_string());
        let MESSAGE_FOR = self.MESSAGE_FOR().map(|x| x.to_string());
        let MESSAGE_ID = self.MESSAGE_ID().map(|x| x.to_string());
        let TCA = self.TCA().map(|x| x.to_string());
        ...
        let START_SCREEN_PERIOD = self.START_SCREEN_PERIOD().map(|x| x.to_string());
        let STOP_SCREEN_PERIOD = self.STOP_SCREEN_PERIOD().map(|x| x.to_string());
        ...
        let SCREEN_ENTRY_TIME = self.SCREEN_ENTRY_TIME().map(|x| x.to_string());
        let SCREEN_EXIT_TIME = self.SCREEN_EXIT_TIME().map(|x| x.to_string());
        let COLLISION_PROBABILITY = self.COLLISION_PROBABILITY();
        let COLLISION_PROBABILITY_METHOD =
            self.COLLISION_PROBABILITY_METHOD().map(|x| x.to_string());
        let OBJECT1 = self.OBJECT1().map(|x| Box::new(x.unpack()));
        let OBJECT2 = self.OBJECT2().map(|x| Box::new(x.unpack()));
        let OBJECT1_DATASOURCE = self.OBJECT1_DATASOURCE().map(|x| Box::new(x.unpack()));
        let OBJECT2_DATASOURCE = self.OBJECT2_DATASOURCE().map(|x| Box::new(x.unpack()));
        CDMT {
            CCSDS_CDM_VERS,
            CREATION_DATE,
            ORIGINATOR,
    ...
    pub fn CCSDS_CDM_VERS(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDM::VT_CCSDS_CDM_VERS, Some(0.0))
                .unwrap()
        }
    }
    ...
    pub fn CREATION_DATE(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(CDM::VT_CREATION_DATE, None)
        }
    }
    ...
    pub fn ORIGINATOR(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(CDM::VT_ORIGINATOR, None)
        }
    }
    ...
    pub fn MESSAGE_FOR(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(CDM::VT_MESSAGE_FOR, None)
        }
    }
    ...
    pub fn MESSAGE_ID(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(CDM::VT_MESSAGE_ID, None)
        }
    }
    ...
    pub fn TCA(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(CDM::VT_TCA, None)
        }
    }
    ...
    pub fn MISS_DISTANCE(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDM::VT_MISS_DISTANCE, Some(0.0))
                .unwrap()
        }
    }
    ...
    pub fn RELATIVE_SPEED(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDM::VT_RELATIVE_SPEED, Some(0.0))
                .unwrap()
        }
    }
    ...
    pub fn RELATIVE_POSITION_R(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDM::VT_RELATIVE_POSITION_R, Some(0.0))
                .unwrap()
        }
    }
    ...
    pub fn RELATIVE_POSITION_T(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDM::VT_RELATIVE_POSITION_T, Some(0.0))
                .unwrap()
        }
    }
    ...
    pub fn RELATIVE_POSITION_N(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDM::VT_RELATIVE_POSITION_N, Some(0.0))
                .unwrap()
        }
    }
    ...
    pub fn RELATIVE_VELOCITY_R(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDM::VT_RELATIVE_VELOCITY_R, Some(0.0))
                .unwrap()
        }
    }
    ...
    pub fn RELATIVE_VELOCITY_T(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDM::VT_RELATIVE_VELOCITY_T, Some(0.0))
                .unwrap()
        }
    }
    ...
    pub fn RELATIVE_VELOCITY_N(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDM::VT_RELATIVE_VELOCITY_N, Some(0.0))
                .unwrap()
        }
    }
    ...
    pub fn START_SCREEN_PERIOD(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(CDM::VT_START_SCREEN_PERIOD, None)
        }
    }
    ...
    pub fn STOP_SCREEN_PERIOD(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(CDM::VT_STOP_SCREEN_PERIOD, None)
        }
    }
    ...
    pub fn SCREEN_VOLUME_FRAME(&self) -> refFrame {
        ...
        unsafe {
            self._tab
                .get::<refFrame>(CDM::VT_SCREEN_VOLUME_FRAME, Some(refFrame::ECEF))
                .unwrap()
        }
    }
    ...
    pub fn SCREEN_VOLUME_SHAPE(&self) -> screeningVolumeShape {
        ...
        unsafe {
            self._tab
                .get::<screeningVolumeShape>(
                    CDM::VT_SCREEN_VOLUME_SHAPE,
                    Some(screeningVolumeShape::ELLIPSOID),
                )
                .unwrap()
        }
    }
    ...
    pub fn SCREEN_VOLUME_X(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDM::VT_SCREEN_VOLUME_X, Some(0.0))
                .unwrap()
        }
    }
    ...
    pub fn SCREEN_VOLUME_Y(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDM::VT_SCREEN_VOLUME_Y, Some(0.0))
                .unwrap()
        }
    }
    ...
    pub fn SCREEN_VOLUME_Z(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDM::VT_SCREEN_VOLUME_Z, Some(0.0))
                .unwrap()
        }
    }
    ...
    pub fn SCREEN_ENTRY_TIME(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(CDM::VT_SCREEN_ENTRY_TIME, None)
        }
    }
    ...
    pub fn SCREEN_EXIT_TIME(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(CDM::VT_SCREEN_EXIT_TIME, None)
        }
    }
    ...
    pub fn COLLISION_PROBABILITY(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(CDM::VT_COLLISION_PROBABILITY, Some(0.0))
                .unwrap()
        }
    }
    ...
    pub fn COLLISION_PROBABILITY_METHOD(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(
                CDM::VT_COLLISION_PROBABILITY_METHOD,
                None,
            )
        }
    }
    ...
    pub fn OBJECT1(&self) -> Option<CDMObject<'a>> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<CDMObject>>(CDM::VT_OBJECT1, None)
        }
    }
    ...
    pub fn OBJECT2(&self) -> Option<CDMObject<'a>> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<CDMObject>>(CDM::VT_OBJECT2, None)
        }
    }
    ...
    pub fn OBJECT1_DATASOURCE(&self) -> Option<PNM<'a>> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<PNM>>(CDM::VT_OBJECT1_DATASOURCE, None)
        }
    }
    ...
    pub fn OBJECT2_DATASOURCE(&self) -> Option<PNM<'a>> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<PNM>>(CDM::VT_OBJECT2_DATASOURCE, None)
        }
    }
}
...
impl flatbuffers::Verifiable for CDM<'_> {
    ...
    fn run_verifier(
        ...
        v.visit_table(pos)?
            ...
            .visit_field::<flatbuffers::ForwardsUOffset<&str>>(
                "START_SCREEN_PERIOD",
                Self::VT_START_SCREEN_PERIOD,
                false,
            )?
            .visit_field::<flatbuffers::ForwardsUOffset<&str>>(
                "STOP_SCREEN_PERIOD",
                Self::VT_STOP_SCREEN_PERIOD,
                false,
            )?
            .visit_field::<refFrame>("SCREEN_VOLUME_FRAME", Self::VT_SCREEN_VOLUME_FRAME, false)?
            .visit_field::<screeningVolumeShape>(
                "SCREEN_VOLUME_SHAPE",
                Self::VT_SCREEN_VOLUME_SHAPE,
                false,
            )?
            ...
            .visit_field::<flatbuffers::ForwardsUOffset<&str>>(
                "SCREEN_ENTRY_TIME",
                Self::VT_SCREEN_ENTRY_TIME,
                false,
            )?
            .visit_field::<flatbuffers::ForwardsUOffset<&str>>(
                "SCREEN_EXIT_TIME",
                Self::VT_SCREEN_EXIT_TIME,
                false,
            )?
            .visit_field::<f64>(
                "COLLISION_PROBABILITY",
                Self::VT_COLLISION_PROBABILITY,
                false,
            )?
            .visit_field::<flatbuffers::ForwardsUOffset<&str>>(
                "COLLISION_PROBABILITY_METHOD",
                Self::VT_COLLISION_PROBABILITY_METHOD,
                false,
            )?
            .visit_field::<flatbuffers::ForwardsUOffset<CDMObject>>(
                "OBJECT1",
                Self::VT_OBJECT1,
                false,
            )?
            ...
            .visit_field::<flatbuffers::ForwardsUOffset<PNM>>(
                "OBJECT1_DATASOURCE",
                Self::VT_OBJECT1_DATASOURCE,
                false,
            )?
            .visit_field::<flatbuffers::ForwardsUOffset<PNM>>(
                "OBJECT2_DATASOURCE",
                Self::VT_OBJECT2_DATASOURCE,
                false,
            )?
            .finish();
        Ok(())
...
impl<'a: 'b, 'b> CDMBuilder<'a, 'b> {
    ...
    pub fn add_CCSDS_CDM_VERS(&mut self, CCSDS_CDM_VERS: f64) {
        self.fbb_
            .push_slot::<f64>(CDM::VT_CCSDS_CDM_VERS, CCSDS_CDM_VERS, 0.0);
    }
    #[inline]
    pub fn add_CREATION_DATE(&mut self, CREATION_DATE: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(CDM::VT_CREATION_DATE, CREATION_DATE);
    }
    #[inline]
    pub fn add_ORIGINATOR(&mut self, ORIGINATOR: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(CDM::VT_ORIGINATOR, ORIGINATOR);
    }
    #[inline]
    pub fn add_MESSAGE_FOR(&mut self, MESSAGE_FOR: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(CDM::VT_MESSAGE_FOR, MESSAGE_FOR);
    }
    #[inline]
    pub fn add_MESSAGE_ID(&mut self, MESSAGE_ID: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(CDM::VT_MESSAGE_ID, MESSAGE_ID);
    }
    #[inline]
    pub fn add_TCA(&mut self, TCA: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(CDM::VT_TCA, TCA);
    }
    #[inline]
    pub fn add_MISS_DISTANCE(&mut self, MISS_DISTANCE: f64) {
        self.fbb_
            .push_slot::<f64>(CDM::VT_MISS_DISTANCE, MISS_DISTANCE, 0.0);
    }
    #[inline]
    pub fn add_RELATIVE_SPEED(&mut self, RELATIVE_SPEED: f64) {
        self.fbb_
            .push_slot::<f64>(CDM::VT_RELATIVE_SPEED, RELATIVE_SPEED, 0.0);
    }
    #[inline]
    pub fn add_RELATIVE_POSITION_R(&mut self, RELATIVE_POSITION_R: f64) {
        self.fbb_
            .push_slot::<f64>(CDM::VT_RELATIVE_POSITION_R, RELATIVE_POSITION_R, 0.0);
    }
    #[inline]
    pub fn add_RELATIVE_POSITION_T(&mut self, RELATIVE_POSITION_T: f64) {
        self.fbb_
            .push_slot::<f64>(CDM::VT_RELATIVE_POSITION_T, RELATIVE_POSITION_T, 0.0);
    }
    #[inline]
    pub fn add_RELATIVE_POSITION_N(&mut self, RELATIVE_POSITION_N: f64) {
        self.fbb_
            .push_slot::<f64>(CDM::VT_RELATIVE_POSITION_N, RELATIVE_POSITION_N, 0.0);
    }
    #[inline]
    pub fn add_RELATIVE_VELOCITY_R(&mut self, RELATIVE_VELOCITY_R: f64) {
        self.fbb_
            .push_slot::<f64>(CDM::VT_RELATIVE_VELOCITY_R, RELATIVE_VELOCITY_R, 0.0);
    }
    #[inline]
    pub fn add_RELATIVE_VELOCITY_T(&mut self, RELATIVE_VELOCITY_T: f64) {
        self.fbb_
            .push_slot::<f64>(CDM::VT_RELATIVE_VELOCITY_T, RELATIVE_VELOCITY_T, 0.0);
    }
    #[inline]
    pub fn add_RELATIVE_VELOCITY_N(&mut self, RELATIVE_VELOCITY_N: f64) {
        self.fbb_
            .push_slot::<f64>(CDM::VT_RELATIVE_VELOCITY_N, RELATIVE_VELOCITY_N, 0.0);
    }
    #[inline]
    pub fn add_START_SCREEN_PERIOD(
        &mut self,
        START_SCREEN_PERIOD: flatbuffers::WIPOffset<&'b str>,
    ) {
        self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
            CDM::VT_START_SCREEN_PERIOD,
            START_SCREEN_PERIOD,
        );
    }
    #[inline]
    ...
    pub fn add_SCREEN_VOLUME_SHAPE(&mut self, SCREEN_VOLUME_SHAPE: screeningVolumeShape) {
        self.fbb_.push_slot::<screeningVolumeShape>(
            CDM::VT_SCREEN_VOLUME_SHAPE,
            SCREEN_VOLUME_SHAPE,
    ...
    pub fn add_COLLISION_PROBABILITY(&mut self, COLLISION_PROBABILITY: f64) {
        self.fbb_
            .push_slot::<f64>(CDM::VT_COLLISION_PROBABILITY, COLLISION_PROBABILITY, 0.0);
    }
    #[inline]
    pub fn add_COLLISION_PROBABILITY_METHOD(
        &mut self,
        COLLISION_PROBABILITY_METHOD: flatbuffers::WIPOffset<&'b str>,
    ) {
        self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(
            CDM::VT_COLLISION_PROBABILITY_METHOD,
            COLLISION_PROBABILITY_METHOD,
    ...
    pub fn add_OBJECT1(&mut self, OBJECT1: flatbuffers::WIPOffset<CDMObject<'b>>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<CDMObject>>(CDM::VT_OBJECT1, OBJECT1);
    }
    #[inline]
    pub fn add_OBJECT2(&mut self, OBJECT2: flatbuffers::WIPOffset<CDMObject<'b>>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<CDMObject>>(CDM::VT_OBJECT2, OBJECT2);
    }
    #[inline]
    pub fn add_OBJECT1_DATASOURCE(&mut self, OBJECT1_DATASOURCE: flatbuffers::WIPOffset<PNM<'b>>) {
        self.fbb_.push_slot_always::<flatbuffers::WIPOffset<PNM>>(
            CDM::VT_OBJECT1_DATASOURCE,
            OBJECT1_DATASOURCE,
        );
    }
    #[inline]
...
impl CDMT {
    pub fn pack<'b>(
        ...
        let CCSDS_CDM_VERS = self.CCSDS_CDM_VERS;
        let CREATION_DATE = self.CREATION_DATE.as_ref().map(|x| _fbb.create_string(x));
        let ORIGINATOR = self.ORIGINATOR.as_ref().map(|x| _fbb.create_string(x));
        let MESSAGE_FOR = self.MESSAGE_FOR.as_ref().map(|x| _fbb.create_string(x));
        let MESSAGE_ID = self.MESSAGE_ID.as_ref().map(|x| _fbb.create_string(x));
        let TCA = self.TCA.as_ref().map(|x| _fbb.create_string(x));
        let MISS_DISTANCE = self.MISS_DISTANCE;
        let RELATIVE_SPEED = self.RELATIVE_SPEED;
        let RELATIVE_POSITION_R = self.RELATIVE_POSITION_R;
        let RELATIVE_POSITION_T = self.RELATIVE_POSITION_T;
        ...
        let RELATIVE_VELOCITY_T = self.RELATIVE_VELOCITY_T;
        let RELATIVE_VELOCITY_N = self.RELATIVE_VELOCITY_N;
        let START_SCREEN_PERIOD = self
            .START_SCREEN_PERIOD
            .as_ref()
            .map(|x| _fbb.create_string(x));
        let STOP_SCREEN_PERIOD = self
            .STOP_SCREEN_PERIOD
            .as_ref()
            .map(|x| _fbb.create_string(x));
        let SCREEN_VOLUME_FRAME = self.SCREEN_VOLUME_FRAME;
        ...
        let SCREEN_VOLUME_Y = self.SCREEN_VOLUME_Y;
        let SCREEN_VOLUME_Z = self.SCREEN_VOLUME_Z;
        let SCREEN_ENTRY_TIME = self
            .SCREEN_ENTRY_TIME
            .as_ref()
            .map(|x| _fbb.create_string(x));
        let SCREEN_EXIT_TIME = self
            .SCREEN_EXIT_TIME
            .as_ref()
            .map(|x| _fbb.create_string(x));
        let COLLISION_PROBABILITY = self.COLLISION_PROBABILITY;
        let COLLISION_PROBABILITY_METHOD = self
            .COLLISION_PROBABILITY_METHOD
            .as_ref()
            .map(|x| _fbb.create_string(x));
        let OBJECT1 = self.OBJECT1.as_ref().map(|x| x.pack(_fbb));
        let OBJECT2 = self.OBJECT2.as_ref().map(|x| x.pack(_fbb));
        let OBJECT1_DATASOURCE = self.OBJECT1_DATASOURCE.as_ref().map(|x| x.pack(_fbb));
        let OBJECT2_DATASOURCE = self.OBJECT2_DATASOURCE.as_ref().map(|x| x.pack(_fbb));
        CDM::create(
            _fbb,
            &CDMArgs {
                CCSDS_CDM_VERS,
...
impl<'a> CDMCOLLECTION<'a> {
    ...
    pub fn unpack(&self) -> CDMCOLLECTIONT {
        ...
        CDMCOLLECTIONT { RECORDS }
    }

    #[inline]
    pub fn RECORDS(
        &self,
    ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<CDM<'a>>>> {
        // Safety:
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe {
            self._tab.get::<flatbuffers::ForwardsUOffset<
                flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<CDM>>,
            >>(CDMCOLLECTION::VT_RECORDS, None)
        }
    }
}
    ...
    fn run_verifier(
        ...
        v.visit_table(pos)?
            .visit_field::<flatbuffers::ForwardsUOffset<
                flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<CDM>>,
...
pub struct CDMCOLLECTIONArgs<'a> {
    pub RECORDS: Option<
        flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<CDM<'a>>>>,
    >,
}
impl<'a> Default for CDMCOLLECTIONArgs<'a> {
    #[inline]
    fn default() -> Self {
        CDMCOLLECTIONArgs { RECORDS: None }
    }
}
...
impl<'a: 'b, 'b> CDMCOLLECTIONBuilder<'a, 'b> {
    ...
    pub fn add_RECORDS(
        ...
        RECORDS: flatbuffers::WIPOffset<
            flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<CDM<'b>>>,
        >,
    ) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(CDMCOLLECTION::VT_RECORDS, RECORDS);
    }
    #[inline]
...
impl CDMCOLLECTIONT {
    pub fn pack<'b>(
        ...
        CDMCOLLECTION::create(_fbb, &CDMCOLLECTIONArgs { RECORDS })
    }
}
#[inline]
...
#[inline]
pub fn finish_size_prefixed_CDM_buffer<'a, 'b>(
    fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
    root: flatbuffers::WIPOffset<CDM<'a>>,
) {
