...
impl<'a> PRG<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr>(
        ...
        if let Some(x) = args.MESSAGE_TYPES {
            builder.add_MESSAGE_TYPES(x);
        }
        if let Some(x) = args.HD_KEY_PATH {
            builder.add_HD_KEY_PATH(x);
        }
    ...
    pub fn unpack(&self) -> PRGT {
        ...
        let HD_KEY_PATH = self.HD_KEY_PATH().map(|x| x.to_string());
        let MESSAGE_TYPES = self
            .MESSAGE_TYPES()
            .map(|x| x.iter().map(|s| s.to_string()).collect());
        let USERS = self.USERS().map(|x| x.iter().map(|t| t.unpack()).collect());
        PRGT {
            NAME,
            HD_KEY_PATH,
            MESSAGE_TYPES,
    ...
    pub fn NAME(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(PRG::VT_NAME, None)
        }
    }
    ...
    pub fn HD_KEY_PATH(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(PRG::VT_HD_KEY_PATH, None)
        }
    }
    ...
    pub fn USERS(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<USR<'a>>>> {
        ...
        unsafe {
            self._tab.get::<flatbuffers::ForwardsUOffset<
                flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<USR>>,
            >>(PRG::VT_USERS, None)
        }
    }
}
...
impl flatbuffers::Verifiable for PRG<'_> {
    ...
    fn run_verifier(
        ...
        v.visit_table(pos)?
            ...
            >>("MESSAGE_TYPES", Self::VT_MESSAGE_TYPES, false)?
            .visit_field::<flatbuffers::ForwardsUOffset<
                flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<USR>>,
...
pub struct PRGArgs<'a> {
    ...
    pub MESSAGE_TYPES: Option<
        flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>,
    >,
    pub USERS: Option<
        flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<USR<'a>>>>,
    >,
}
...
impl<'a: 'b, 'b> PRGBuilder<'a, 'b> {
    ...
    pub fn add_NAME(&mut self, NAME: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(PRG::VT_NAME, NAME);
    }
    #[inline]
    pub fn add_HD_KEY_PATH(&mut self, HD_KEY_PATH: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(PRG::VT_HD_KEY_PATH, HD_KEY_PATH);
    }
    #[inline]
    pub fn add_MESSAGE_TYPES(
        &mut self,
        MESSAGE_TYPES: flatbuffers::WIPOffset<
            flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<&'b str>>,
        >,
    ) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(PRG::VT_MESSAGE_TYPES, MESSAGE_TYPES);
    }
    #[inline]
    pub fn add_USERS(
        &mut self,
        USERS: flatbuffers::WIPOffset<
            flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<USR<'b>>>,
        >,
    ) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(PRG::VT_USERS, USERS);
    }
    #[inline]
...
impl PRGT {
    pub fn pack<'b>(
        ...
        let HD_KEY_PATH = self.HD_KEY_PATH.as_ref().map(|x| _fbb.create_string(x));
...
impl<'a> USR<'a> {
    ...
    pub fn ID(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(USR::VT_ID, None)
        }
    }
    #[inline]
    pub fn MESSAGE_TYPES(
...
impl<'a: 'b, 'b> USRBuilder<'a, 'b> {
    ...
    pub fn add_ID(&mut self, ID: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(USR::VT_ID, ID);
    }
    #[inline]
    pub fn add_MESSAGE_TYPES(
        &mut self,
        ...
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(USR::VT_MESSAGE_TYPES, MESSAGE_TYPES);
    }
    #[inline]
...
impl USRT {
    pub fn pack<'b>(
        ...
        USR::create(_fbb, &USRArgs { ID, MESSAGE_TYPES })
    }
}
...
impl<'a> PRGCOLLECTION<'a> {
    ...
    pub fn unpack(&self) -> PRGCOLLECTIONT {
        ...
        PRGCOLLECTIONT { RECORDS }
    }

    #[inline]
    pub fn RECORDS(
        &self,
    ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<PRG<'a>>>> {
        // Safety:
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe {
            self._tab.get::<flatbuffers::ForwardsUOffset<
                flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<PRG>>,
            >>(PRGCOLLECTION::VT_RECORDS, None)
        }
    }
}
...
impl flatbuffers::Verifiable for PRGCOLLECTION<'_> {
    ...
    fn run_verifier(
        ...
        v.visit_table(pos)?
            .visit_field::<flatbuffers::ForwardsUOffset<
                flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<PRG>>,
...
pub struct PRGCOLLECTIONArgs<'a> {
    pub RECORDS: Option<
        flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<PRG<'a>>>>,
    >,
}
impl<'a> Default for PRGCOLLECTIONArgs<'a> {
    #[inline]
    fn default() -> Self {
        PRGCOLLECTIONArgs { RECORDS: None }
    }
}
...
impl<'a: 'b, 'b> PRGCOLLECTIONBuilder<'a, 'b> {
    ...
    pub fn add_RECORDS(
        ...
        RECORDS: flatbuffers::WIPOffset<
            flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<PRG<'b>>>,
        >,
    ) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(PRGCOLLECTION::VT_RECORDS, RECORDS);
    }
    #[inline]
...
impl PRGCOLLECTIONT {
    pub fn pack<'b>(
        ...
        PRGCOLLECTION::create(_fbb, &PRGCOLLECTIONArgs { RECORDS })
    }
}
#[inline]
...
#[inline]
pub fn finish_size_prefixed_PRG_buffer<'a, 'b>(
    fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
    root: flatbuffers::WIPOffset<PRG<'a>>,
) {
