...
impl<'a> BOV<'a> {
    ...
    pub fn unpack(&self) -> BOVT {
        ...
        let EPOCH = self.EPOCH().map(|x| x.to_string());
    ...
    pub fn E_COORDINATE(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(BOV::VT_E_COORDINATE, Some(0.0))
                .unwrap()
        }
    }
    #[inline]
    pub fn F_COORDINATE(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(BOV::VT_F_COORDINATE, Some(0.0))
                .unwrap()
        }
    }
    #[inline]
    pub fn G_COORDINATE(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(BOV::VT_G_COORDINATE, Some(0.0))
                .unwrap()
        }
    }
    #[inline]
    ...
    pub fn EPOCH(&self) -> Option<&'a str> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<&str>>(BOV::VT_EPOCH, None)
        }
    }
    #[inline]
    pub fn TIME_FROM_LAUNCH(&self) -> f64 {
        ...
        unsafe {
            self._tab
                .get::<f64>(BOV::VT_TIME_FROM_LAUNCH, Some(0.0))
                .unwrap()
        }
    }
}
...
impl<'a: 'b, 'b> BOVBuilder<'a, 'b> {
    ...
    pub fn add_E_COORDINATE(&mut self, E_COORDINATE: f64) {
        self.fbb_
            .push_slot::<f64>(BOV::VT_E_COORDINATE, E_COORDINATE, 0.0);
    }
    #[inline]
    pub fn add_F_COORDINATE(&mut self, F_COORDINATE: f64) {
        self.fbb_
            .push_slot::<f64>(BOV::VT_F_COORDINATE, F_COORDINATE, 0.0);
    }
    #[inline]
    pub fn add_G_COORDINATE(&mut self, G_COORDINATE: f64) {
        self.fbb_
            .push_slot::<f64>(BOV::VT_G_COORDINATE, G_COORDINATE, 0.0);
    }
    #[inline]
    ...
    pub fn add_EPOCH(&mut self, EPOCH: flatbuffers::WIPOffset<&'b str>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(BOV::VT_EPOCH, EPOCH);
    }
    #[inline]
    pub fn add_TIME_FROM_LAUNCH(&mut self, TIME_FROM_LAUNCH: f64) {
        self.fbb_
            .push_slot::<f64>(BOV::VT_TIME_FROM_LAUNCH, TIME_FROM_LAUNCH, 0.0);
    }
    #[inline]
...
impl BOVT {
    pub fn pack<'b>(
        ...
        let F_DOT = self.F_DOT;
        let G_DOT = self.G_DOT;
        let EPOCH = self.EPOCH.as_ref().map(|x| _fbb.create_string(x));
        let TIME_FROM_LAUNCH = self.TIME_FROM_LAUNCH;
        BOV::create(
            _fbb,
            &BOVArgs {
...
impl<'a> BOVCOLLECTION<'a> {
    ...
    pub fn unpack(&self) -> BOVCOLLECTIONT {
        ...
        BOVCOLLECTIONT { RECORDS }
    }

    #[inline]
    pub fn RECORDS(
        &self,
    ) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<BOV<'a>>>> {
        // Safety:
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe {
            self._tab.get::<flatbuffers::ForwardsUOffset<
                flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<BOV>>,
            >>(BOVCOLLECTION::VT_RECORDS, None)
        }
    }
}
    ...
    fn run_verifier(
        ...
        v.visit_table(pos)?
            .visit_field::<flatbuffers::ForwardsUOffset<
                flatbuffers::Vector<'_, flatbuffers::ForwardsUOffset<BOV>>,
...
pub struct BOVCOLLECTIONArgs<'a> {
    pub RECORDS: Option<
        flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<BOV<'a>>>>,
    >,
}
impl<'a> Default for BOVCOLLECTIONArgs<'a> {
    #[inline]
    fn default() -> Self {
        BOVCOLLECTIONArgs { RECORDS: None }
    }
}
...
impl<'a: 'b, 'b> BOVCOLLECTIONBuilder<'a, 'b> {
    ...
    pub fn add_RECORDS(
        ...
        RECORDS: flatbuffers::WIPOffset<
            flatbuffers::Vector<'b, flatbuffers::ForwardsUOffset<BOV<'b>>>,
        >,
    ) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(BOVCOLLECTION::VT_RECORDS, RECORDS);
    }
    #[inline]
...
impl BOVCOLLECTIONT {
    pub fn pack<'b>(
        ...
        BOVCOLLECTION::create(_fbb, &BOVCOLLECTIONArgs { RECORDS })
    }
}
#[inline]
...
#[inline]
pub fn finish_size_prefixed_BOV_buffer<'a, 'b>(
    fbb: &'b mut flatbuffers::FlatBufferBuilder<'a>,
    root: flatbuffers::WIPOffset<BOV<'a>>,
) {
