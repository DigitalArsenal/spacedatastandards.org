...
pub struct SEOT {
  ...
  pub GEN_SYSTEM: Option<alloc::string::String>,
  pub EXTERNAL_ID: Option<alloc::string::String>,
  pub DATA_TYPE: seoDataType,
  pub GEN_TIME: Option<alloc::string::String>,
  pub FORECAST: bool,
  pub DERIVED: bool,
  pub SAT_NO: u32,
  ...
  pub OBSERVATORY_TYPE: seoObservatoryType,
  pub OBSERVATORY_NAME: Option<alloc::string::String>,
  pub OBSERVATORY_NOTES: Option<alloc::string::String>,
  pub INSTRUMENT_TYPE: Option<alloc::string::String>,
  pub LAT: f64,
  pub LON: f64,
  pub ALT: f64,
  pub SEN_REFERENCE_FRAME: Option<alloc::string::String>,
  pub SEN_POS: Option<alloc::vec::Vec<f64>>,
  pub SEN_VEL: Option<alloc::vec::Vec<f64>>,
  pub MEAS_TYPE: Option<alloc::string::String>,
  pub PARTICLE_TYPE: seoParticleType,
  pub SEN_ENERGY_LEVEL: Option<alloc::string::String>,
  pub OB_SET_ID: Option<alloc::string::String>,
  pub OB_TIME: Option<alloc::string::String>,
  pub VALUES: Option<alloc::vec::Vec<f64>>,
  pub UNCERTAINTIES: Option<alloc::vec::Vec<f64>>,
  pub UNITS: Option<alloc::string::String>,
  pub QUALITY: Option<alloc::string::String>,
...
pub fn root_as_seo(buf: &[u8]) -> Result<SEO<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_seo(buf: &[u8]) -> Result<SEO<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_seo_unchecked(buf: &[u8]) -> SEO<'_> {
  unsafe { ::flatbuffers::root_unchecked::<SEO>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_seo_unchecked(buf: &[u8]) -> SEO<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<SEO>(buf) }
}
