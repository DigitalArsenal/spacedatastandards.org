...
pub fn root_as_dmg(buf: &[u8]) -> Result<DMG<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_dmg(buf: &[u8]) -> Result<DMG<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_dmg_unchecked(buf: &[u8]) -> DMG<'_> {
  unsafe { ::flatbuffers::root_unchecked::<DMG>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_dmg_unchecked(buf: &[u8]) -> DMG<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<DMG>(buf) }
}
