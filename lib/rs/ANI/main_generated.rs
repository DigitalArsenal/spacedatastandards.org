...
pub struct ANIT {
  ...
  pub OBS_TIME: Option<alloc::string::String>,
  pub SAT_NO: u32,
  ...
  pub CONFIDENCE: Option<alloc::vec::Vec<f64>>,
  pub FEATURES: Option<alloc::vec::Vec<f64>>,
  pub QUALITY: f64,
...
pub fn root_as_ani(buf: &[u8]) -> Result<ANI<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_ani(buf: &[u8]) -> Result<ANI<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_ani_unchecked(buf: &[u8]) -> ANI<'_> {
  unsafe { ::flatbuffers::root_unchecked::<ANI>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_ani_unchecked(buf: &[u8]) -> ANI<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<ANI>(buf) }
}
