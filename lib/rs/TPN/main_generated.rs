...
pub struct TPNT {
  ...
  pub NID: Option<alloc::string::String>,
  pub TID: Option<alloc::string::String>,
  pub TTF: f64,
  pub SYMBOL_RATE: f64,
  pub FEC: i32,
  pub MODULATION: Option<alloc::string::String>,
  pub FORMAT: Option<alloc::string::String>,
  pub SYSTEM: Option<alloc::string::String>,
  pub CHANNELS: Option<alloc::vec::Vec<alloc::string::String>>,
}
...
pub fn root_as_tpn(buf: &[u8]) -> Result<TPN<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_tpn(buf: &[u8]) -> Result<TPN<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_tpn_unchecked(buf: &[u8]) -> TPN<'_> {
  unsafe { ::flatbuffers::root_unchecked::<TPN>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_tpn_unchecked(buf: &[u8]) -> TPN<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<TPN>(buf) }
}
