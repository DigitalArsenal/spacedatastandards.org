...
pub struct LNDT {
  ...
  pub DETECTION_TYPE: launchDetectionType,
  pub MESSAGE_TYPE: Option<alloc::string::String>,
  ...
  pub RAAN: f64,
  pub INCLINATION: f64,
  pub OBSERVATION_TIME: Option<alloc::string::String>,
  pub OBSERVATION_LATITUDE: f64,
  pub OBSERVATION_LONGITUDE: f64,
  pub OBSERVATION_ALTITUDE: f64,
  pub STEREO_FLAG: bool,
  ...
  pub TRAJECTORY_TYPE: Option<alloc::string::String>,
  pub CONFIDENCE: f64,
...
pub fn root_as_lnd(buf: &[u8]) -> Result<LND<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_lnd(buf: &[u8]) -> Result<LND<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_lnd_unchecked(buf: &[u8]) -> LND<'_> {
  unsafe { ::flatbuffers::root_unchecked::<LND>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_lnd_unchecked(buf: &[u8]) -> LND<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<LND>(buf) }
}
