...
pub struct LNET {
  ...
  pub OUTCOME: launchOutcome,
  pub LAUNCH_FAILURE_CODE: Option<alloc::string::String>,
  pub BE_NUMBER: Option<alloc::string::String>,
  pub O_SUFFIX: Option<alloc::string::String>,
  pub LAUNCH_FACILITY_NAME: Option<alloc::string::String>,
  pub LAUNCH_FACILITY_CODE: Option<alloc::string::String>,
  pub LAUNCH_VEHICLE: Option<alloc::string::String>,
  pub LAUNCH_VEHICLE_CONFIG: Option<alloc::string::String>,
  pub TARGET_ORBIT: Option<alloc::string::String>,
  pub OBJECTS_ON_ORBIT: u16,
  pub ON_ORBIT: Option<alloc::string::String>,
  pub LAUNCH_COUNTRY: Option<alloc::string::String>,
...
pub fn root_as_lne(buf: &[u8]) -> Result<LNE<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_lne(buf: &[u8]) -> Result<LNE<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_lne_unchecked(buf: &[u8]) -> LNE<'_> {
  unsafe { ::flatbuffers::root_unchecked::<LNE>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_lne_unchecked(buf: &[u8]) -> LNE<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<LNE>(buf) }
}
