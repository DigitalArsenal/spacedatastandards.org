...
pub struct SONT {
  ...
  pub ACTIVE_CONFIG: Option<alloc::string::String>,
  pub PASSIVE_CONFIG: Option<alloc::string::String>,
  pub TL_REQUEST: Option<alloc::string::String>,
  pub ENVIRONMENT: Option<alloc::string::String>,
  pub TARGET_SIGNATURE: Option<alloc::string::String>,
  pub TMA_INPUT: Option<alloc::string::String>,
  pub TORPEDO_SEEKER: Option<alloc::string::String>,
}
...
pub fn root_as_son(buf: &[u8]) -> Result<SON<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_son(buf: &[u8]) -> Result<SON<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_son_unchecked(buf: &[u8]) -> SON<'_> {
  unsafe { ::flatbuffers::root_unchecked::<SON>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_son_unchecked(buf: &[u8]) -> SON<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<SON>(buf) }
}
