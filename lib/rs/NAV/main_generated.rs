...
pub struct NAVT {
  ...
  pub COURSE: f32,
  pub RUDDER_ANGLE: f32,
  pub HULL: Option<alloc::string::String>,
  pub PROPULSION: Option<alloc::string::String>,
  pub DC_STATE: u8,
  pub FIRES_ACTIVE: u8,
  pub FLOODING_ACTIVE: u8,
  pub CREW_CASUALTIES: u8,
...
pub fn root_as_nav(buf: &[u8]) -> Result<NAV<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_nav(buf: &[u8]) -> Result<NAV<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_nav_unchecked(buf: &[u8]) -> NAV<'_> {
  unsafe { ::flatbuffers::root_unchecked::<NAV>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_nav_unchecked(buf: &[u8]) -> NAV<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<NAV>(buf) }
}
