...
pub fn root_as_bov(buf: &[u8]) -> Result<BOV<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_bov(buf: &[u8]) -> Result<BOV<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_bov_unchecked(buf: &[u8]) -> BOV<'_> {
  unsafe { ::flatbuffers::root_unchecked::<BOV>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_bov_unchecked(buf: &[u8]) -> BOV<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<BOV>(buf) }
}
