...
pub struct SART {
  ...
  pub DETECTION_ID: Option<alloc::string::String>,
  pub COLLECTION_START: Option<alloc::string::String>,
  pub COLLECTION_END: Option<alloc::string::String>,
  pub CENTER_TIME: Option<alloc::string::String>,
  pub DETECTION_START: Option<alloc::string::String>,
  ...
  pub FAR_RANGE: f64,
  pub SWATH_LENGTH: f64,
  pub AGJSON: Option<alloc::string::String>,
  pub ATEXT: Option<alloc::string::String>,
  pub ATYPE: Option<alloc::string::String>,
  pub COORD_SYS: Option<alloc::string::String>,
  pub SPACING_RANGE: f64,
  pub SPACING_AZIMUTH: f64,
  pub LOOKS_AZIMUTH: u8,
  pub LOOKS_RANGE: u8,
  pub RESOLUTION_RANGE: f64,
  pub RESOLUTION_AZIMUTH: f64,
  pub OB_DIRECTION: Option<alloc::string::String>,
  pub TARGETPOSX: f64,
  pub TARGETPOSY: f64,
  pub TARGETPOSZ: f64,
  pub SENALT: f64,
...
pub fn root_as_sar(buf: &[u8]) -> Result<SAR<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_sar(buf: &[u8]) -> Result<SAR<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_sar_unchecked(buf: &[u8]) -> SAR<'_> {
  unsafe { ::flatbuffers::root_unchecked::<SAR>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_sar_unchecked(buf: &[u8]) -> SAR<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<SAR>(buf) }
}
