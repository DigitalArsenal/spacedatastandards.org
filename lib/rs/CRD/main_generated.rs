...
pub fn root_as_crd(buf: &[u8]) -> Result<CRD<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_crd(buf: &[u8]) -> Result<CRD<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_crd_unchecked(buf: &[u8]) -> CRD<'_> {
  unsafe { ::flatbuffers::root_unchecked::<CRD>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_crd_unchecked(buf: &[u8]) -> CRD<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<CRD>(buf) }
}
