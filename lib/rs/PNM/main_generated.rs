...
pub struct PNMT {
  ...
  pub PUBLISH_TIMESTAMP: Option<alloc::string::String>,
  ...
  pub TIMESTAMP_SIGNATURE: Option<alloc::string::String>,
  pub SIGNATURE_TYPE: Option<alloc::string::String>,
  pub TIMESTAMP_SIGNATURE_TYPE: Option<alloc::string::String>,
}
...
pub fn root_as_pnm(buf: &[u8]) -> Result<PNM<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_pnm(buf: &[u8]) -> Result<PNM<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_pnm_unchecked(buf: &[u8]) -> PNM<'_> {
  unsafe { ::flatbuffers::root_unchecked::<PNM>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_pnm_unchecked(buf: &[u8]) -> PNM<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<PNM>(buf) }
}
