...
pub struct OOIT {
  ...
  pub STATUS: ooiStatus,
  pub STATUS_DATE: Option<alloc::string::String>,
  pub PRIORITY: ooiPriority,
  pub DESCRIPTION: Option<alloc::string::String>,
  pub SENSOR_TASKING_START_TIME: Option<alloc::string::String>,
  pub SENSOR_TASKING_STOP_TIME: Option<alloc::string::String>,
  pub LAST_OB_TIME: Option<alloc::string::String>,
  pub MISSED_OB_TIME: Option<alloc::string::String>,
  pub SV_EPOCH: Option<alloc::string::String>,
  pub X: f64,
  pub Y: f64,
  pub Z: f64,
  pub XVEL: f64,
  pub YVEL: f64,
  pub ZVEL: f64,
  pub ELSET_EPOCH: Option<alloc::string::String>,
  pub MEAN_MOTION: f64,
  pub ECCENTRICITY: f64,
  pub INCLINATION: f64,
  pub RAAN: f64,
  ...
  pub APOGEE: f64,
  pub PERIGEE: f64,
  pub DELTA_VS: Option<alloc::vec::Vec<f64>>,
  pub DELTA_TS: Option<alloc::vec::Vec<f64>>,
  pub AFFECTED_OBJECTS: Option<alloc::vec::Vec<alloc::string::String>>,
  pub MANIFOLDS: Option<alloc::vec::Vec<alloc::string::String>>,
}
...
pub fn root_as_ooi(buf: &[u8]) -> Result<OOI<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_ooi(buf: &[u8]) -> Result<OOI<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_ooi_unchecked(buf: &[u8]) -> OOI<'_> {
  unsafe { ::flatbuffers::root_unchecked::<OOI>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_ooi_unchecked(buf: &[u8]) -> OOI<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<OOI>(buf) }
}
