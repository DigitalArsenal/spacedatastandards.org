...
pub struct SKIT {
  ...
  pub FRAME_HEIGHT_PIXELS: u16,
  pub PIXEL_BIT_DEPTH: u8,
  pub ANNOTATION_KEY: Option<alloc::string::String>,
  pub CALIBRATION_KEY: Option<alloc::string::String>,
  ...
  pub EO_OBSERVATIONS: Option<alloc::vec::Vec<alloc::string::String>>,
}
...
pub fn root_as_ski(buf: &[u8]) -> Result<SKI<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_ski(buf: &[u8]) -> Result<SKI<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_ski_unchecked(buf: &[u8]) -> SKI<'_> {
  unsafe { ::flatbuffers::root_unchecked::<SKI>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_ski_unchecked(buf: &[u8]) -> SKI<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<SKI>(buf) }
}
