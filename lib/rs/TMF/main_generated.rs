...
pub fn root_as_tmf(buf: &[u8]) -> Result<TMF<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_tmf(buf: &[u8]) -> Result<TMF<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_tmf_unchecked(buf: &[u8]) -> TMF<'_> {
  unsafe { ::flatbuffers::root_unchecked::<TMF>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_tmf_unchecked(buf: &[u8]) -> TMF<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<TMF>(buf) }
}
