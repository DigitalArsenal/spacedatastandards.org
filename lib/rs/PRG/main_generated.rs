...
pub struct PRGT {
  ...
  pub HD_KEY_PATH: Option<alloc::string::String>,
  pub MESSAGE_TYPES: Option<alloc::vec::Vec<alloc::string::String>>,
  pub USERS: Option<alloc::vec::Vec<USRT>>,
}
...
pub fn root_as_prg(buf: &[u8]) -> Result<PRG<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_prg(buf: &[u8]) -> Result<PRG<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_prg_unchecked(buf: &[u8]) -> PRG<'_> {
  unsafe { ::flatbuffers::root_unchecked::<PRG>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_prg_unchecked(buf: &[u8]) -> PRG<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<PRG>(buf) }
}
