...
pub struct ROCT {
  ...
  pub STAGES: Option<alloc::vec::Vec<STAGET>>,
  pub SUSTAINERS: Option<alloc::vec::Vec<SUSTAINERT>>,
}
...
pub struct STAGET {
  pub STAGE_NUMBER: i32,
  pub ENGINES: Option<alloc::vec::Vec<ENGINET>>,
  pub FUEL_TYPE: Option<alloc::string::String>,
  pub THRUST: f64,
  pub BURN_DURATION: f64,
}
...
pub struct SUSTAINERT {
  pub SUSTAINER_NAME: Option<alloc::string::String>,
  pub THRUST: f64,
  pub BURN_DURATION: f64,
}
...
#[derive(Debug, Clone, PartialEq)]
pub struct ENGINET {
  pub ENGINE_NAME: Option<alloc::string::String>,
  pub TYPE: ENGINE_TYPE,
  pub THRUST: f64,
}
...
pub fn root_as_roc(buf: &[u8]) -> Result<ROC<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_roc(buf: &[u8]) -> Result<ROC<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_roc_unchecked(buf: &[u8]) -> ROC<'_> {
  unsafe { ::flatbuffers::root_unchecked::<ROC>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_roc_unchecked(buf: &[u8]) -> ROC<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<ROC>(buf) }
}
