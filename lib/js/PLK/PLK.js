...
export class PLKT {
    constructor(LICENSE_ID = null, PLUGIN_ID = null, PLUGIN_VERSION = null, LICENSEE_ORG = null, LICENSEE_EMAIL = null, LICENSEE_PEER_ID = null, LICENSEE_PUBKEY = [], ISSUER_PUBKEY = [], ALLOWED_DOMAINS = [], ALLOWED_TLDS = [], LICENSE_TYPE = licenseCategory.Trial, MAX_ACTIVATIONS = 0, ISSUED_AT = BigInt('0'), VALID_FROM = BigInt('0'), EXPIRES_AT = BigInt('0'), ISSUER_PEER_ID = null, SIGNATURE = []) {
