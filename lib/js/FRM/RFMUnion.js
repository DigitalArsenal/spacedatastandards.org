...
export function unionToRfmunion(type, accessor) {
    switch (RFMUnion[type]) {
        ...
        case 'RFMCoordinateSystemWrapper': return accessor(new RFMCoordinateSystemWrapper());
        default: return null;
    }
}
export function unionListToRfmunion(type, accessor, index) {
    switch (RFMUnion[type]) {
        ...
        case 'RFMCoordinateSystemWrapper': return accessor(index, new RFMCoordinateSystemWrapper());
        default: return null;
    }
}
