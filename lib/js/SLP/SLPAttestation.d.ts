...
export declare class SLPAttestation implements flatbuffers.IUnpackableObject<SLPAttestationT> {
    bb: flatbuffers.ByteBuffer | null;
    bb_pos: number;
    __init(i: number, bb: flatbuffers.ByteBuffer): SLPAttestation;
    static getRootAsSLPAttestation(bb: flatbuffers.ByteBuffer, obj?: SLPAttestation): SLPAttestation;
    static getSizePrefixedRootAsSLPAttestation(bb: flatbuffers.ByteBuffer, obj?: SLPAttestation): SLPAttestation;
    /**
    ...
    static startSLPAttestation(builder: flatbuffers.Builder): void;
    ...
    static endSLPAttestation(builder: flatbuffers.Builder): flatbuffers.Offset;
    static createSLPAttestation(builder: flatbuffers.Builder, SIGNING_PUBLIC_KEYOffset: flatbuffers.Offset, SIGNED_ATOffset: flatbuffers.Offset, SIGNATUREOffset: flatbuffers.Offset, CANONICAL_JSON_SIGNATUREOffset: flatbuffers.Offset): flatbuffers.Offset;
    unpack(): SLPAttestationT;
    unpackTo(_o: SLPAttestationT): void;
}
export declare class SLPAttestationT implements flatbuffers.IGeneratedObject {
...
//# sourceMappingURL=SLPAttestation.d.ts.map