 ...
 */
export var agvArrayLayout;
(function (agvArrayLayout) {
    agvArrayLayout[agvArrayLayout["UNSPECIFIED"] = 0] = "UNSPECIFIED";
    /**
     * NZ contiguous z-slabs, each a complete row-major NX * NY field. Index of
     * (i, j, k) is k * NX * NY + j * NX + i. The ONLY legal layout.
     */
    agvArrayLayout[agvArrayLayout["LEVEL_MAJOR"] = 1] = "LEVEL_MAJOR";
})(agvArrayLayout || (agvArrayLayout = {}));
