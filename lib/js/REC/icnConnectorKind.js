 ...
 */
export var icnConnectorKind;
(function (icnConnectorKind) {
    /**
     * Files are supplied through a bounded upload session.
     */
    icnConnectorKind[icnConnectorKind["UploadSession"] = 0] = "UploadSession";
    /**
     * Records are pulled from an HTTPS endpoint.
     */
    icnConnectorKind[icnConnectorKind["HttpsPull"] = 1] = "HttpsPull";
    /**
     * A directory is scanned for settled files.
     */
    icnConnectorKind[icnConnectorKind["FilesystemWatch"] = 2] = "FilesystemWatch";
})(icnConnectorKind || (icnConnectorKind = {}));
