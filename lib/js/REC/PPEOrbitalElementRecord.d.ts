...
export declare class PPEOrbitalElementRecord implements flatbuffers.IUnpackableObject<PPEOrbitalElementRecordT> {
    ...
    static addSizeShapeType(builder: flatbuffers.Builder, SIZE_SHAPE_TYPE: sizeShapeProfile): void;
...
export declare class PPEOrbitalElementRecordT implements flatbuffers.IGeneratedObject {
    ...
    MAX_ELEMENT_RESIDUAL: number;
    RMS_ELEMENT_RESIDUAL: number;
    constructor(EPOCH_MID?: string | Uint8Array | null, EPOCH_HALF_SPAN?: number, NUM_COEFFICIENTS?: number, BASIS_TYPE?: polynomialBasisType, SIZE_SHAPE_TYPE?: sizeShapeProfile, ANOMALY_TYPE?: ppeAnomalyType, COEFF_SIZE_SHAPE?: (number)[], COEFF_ECCENTRICITY?: (number)[], COEFF_INCLINATION?: (number)[], COEFF_RAAN?: (number)[], COEFF_ARG_PERIAPSIS?: (number)[], COEFF_ANOMALY?: (number)[], MAX_ELEMENT_RESIDUAL?: number, RMS_ELEMENT_RESIDUAL?: number);
