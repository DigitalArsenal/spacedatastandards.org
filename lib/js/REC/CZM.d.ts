...
export declare class CZMT implements flatbuffers.IGeneratedObject {
    ...
    CLOCK_MULTIPLIER: number;
    PACKETS: (CZMPacketT)[];
    constructor(NAME?: string | Uint8Array | null, VERSION?: string | Uint8Array | null, CLOCK_CURRENT_TIME?: string | Uint8Array | null, CLOCK_INTERVAL?: string | Uint8Array | null, CLOCK_MULTIPLIER?: number, PACKETS?: (CZMPacketT)[]);
