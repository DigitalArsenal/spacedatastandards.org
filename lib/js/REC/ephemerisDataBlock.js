...
export class ephemerisDataBlock {
    ...
    static createephemerisDataBlock(builder, COMMENTOffset, OBJECT_NAMEOffset, OBJECT_IDOffset, CENTER_NAMEOffset, REFERENCE_FRAME, REFERENCE_FRAME_EPOCHOffset, TIME_SYSTEM, START_TIMEOffset, USEABLE_START_TIMEOffset, USEABLE_STOP_TIMEOffset, STOP_TIMEOffset, STEP_SIZE, INTERPOLATIONOffset, INTERPOLATION_DEGREE, EPHEMERIS_DATA_LINESOffset, COVARIANCE_MATRIX_LINESOffset) {
...
export class ephemerisDataBlockT {
    constructor(COMMENT = null, OBJECT_NAME = null, OBJECT_ID = null, CENTER_NAME = null, REFERENCE_FRAME = refFrame.ECEF, REFERENCE_FRAME_EPOCH = null, TIME_SYSTEM = timeSystem.GMST, START_TIME = null, USEABLE_START_TIME = null, USEABLE_STOP_TIME = null, STOP_TIME = null, STEP_SIZE = 0.0, INTERPOLATION = null, INTERPOLATION_DEGREE = 0, EPHEMERIS_DATA_LINES = [], COVARIANCE_MATRIX_LINES = []) {
    ...
    pack(builder) {
        ...
        return ephemerisDataBlock.createephemerisDataBlock(builder, COMMENT, OBJECT_NAME, OBJECT_ID, CENTER_NAME, this.REFERENCE_FRAME, REFERENCE_FRAME_EPOCH, this.TIME_SYSTEM, START_TIME, USEABLE_START_TIME, USEABLE_STOP_TIME, STOP_TIME, this.STEP_SIZE, INTERPOLATION, this.INTERPOLATION_DEGREE, EPHEMERIS_DATA_LINES, COVARIANCE_MATRIX_LINES);
    }
}
