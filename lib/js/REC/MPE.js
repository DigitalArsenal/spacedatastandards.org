...
export class MPET {
    constructor(ENTITY_ID = null, EPOCH = 0.0, MEAN_MOTION = 0.0, ECCENTRICITY = 0.0, INCLINATION = 0.0, RA_OF_ASC_NODE = 0.0, ARG_OF_PERICENTER = 0.0, MEAN_ANOMALY = 0.0, BSTAR = 0.0, MEAN_ELEMENT_THEORY = meanElementSource.SGP4) {
