...
export declare class VAMReview implements flatbuffers.IUnpackableObject<VAMReviewT> {
    ...
    static addApprovedAlternates(builder: flatbuffers.Builder, APPROVED_ALTERNATESOffset: flatbuffers.Offset): void;
    static createApprovedAlternatesVector(builder: flatbuffers.Builder, data: flatbuffers.Offset[]): flatbuffers.Offset;
    static startApprovedAlternatesVector(builder: flatbuffers.Builder, numElems: number): void;
