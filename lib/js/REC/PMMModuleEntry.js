...
export class PMMModuleEntry {
    ...
    static addPrimaryCategory(builder, PRIMARY_CATEGORY) {
...
export class PMMModuleEntryT {
    constructor(MODULE_ID = null, PLUGIN_ID = null, PLG_CID = null, NAME = null, DESCRIPTION = null, VERSION = null, EPOCH = BigInt('0'), CONTENT_HASH = null, ARTIFACT_SIZE_BYTES = BigInt('0'), ARTIFACT_PATH = null, ARTIFACT_CID = null, ARTIFACT_SIGNATURE = [], TRUST_TIER = pmmTrustTier.UNSPECIFIED, DEFAULT_ENABLED = false, ACCESS_POLICY = pmmAccessPolicy.AUTHENTICATED, ENTRY_STATE = pmmEntryState.ACTIVE, RUNTIME_TARGETS = [], REQUIRED_SCHEMAS = [], MIN_PERMISSIONS = [], LICENSE = null, DOCUMENTATION_URL = null, ICON_URL = null, SUPERSEDES_CONTENT_HASH = null, UPDATED_AT = null, PLUGIN_TYPE = pluginCategory.Unspecified, PRIMARY_CATEGORY = capabilityClass.UNSPECIFIED, CATEGORIES = []) {
