...
export declare class commsChannel implements flatbuffers.IUnpackableObject<commsChannelT> {
    ...
    static addModulation(builder: flatbuffers.Builder, MODULATION: ModulationType): void;
...
export declare class commsChannelT implements flatbuffers.IGeneratedObject {
    ...
    FEC_RATE: number;
    POWER: number;
    constructor(CHANNEL_ID?: string | Uint8Array | null, NAME?: string | Uint8Array | null, UPLINK_FREQ?: number, DOWNLINK_FREQ?: number, BANDWIDTH?: number, MODULATION?: ModulationType, DATA_RATE?: number, ENCRYPTION?: encryptionType, FEC_RATE?: number, POWER?: number);
