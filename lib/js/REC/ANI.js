...
export class ANIT {
    constructor(ID = null, SOURCE_ID = null, SOURCE_TYPE = null, ANALYTIC_TYPE = analyticProfile.SPECTRAL, ALGORITHM = null, ALGORITHM_VERSION = null, PROCESSING_TIME = null, OBS_TIME = null, SAT_NO = 0, OBJECT_DESIGNATOR = null, RA = 0.0, DEC = 0.0, FOV = 0.0, VISUAL_MAG = 0.0, MAG_UNCERTAINTY = 0.0, OBJECT_COUNT = 0, LABELS = [], CONFIDENCE = [], FEATURES = [], QUALITY = 0.0, NOTES = null) {
        this.ID = ID;
