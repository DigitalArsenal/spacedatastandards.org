...
export class DPM {
    ...
    unpack() {
        return new DPMT(this.VERSION(), this.DATASET_ID(), this.UPDATE_ID(), this.PROVIDER_PEER_ID(), this.PROVIDER_EPM_CID(), this.PUBLISH_TIMESTAMP(), this.bb.createObjList(this.ASSETS.bind(this), this.assetsLength()), this.bb.createObjList(this.SOURCES.bind(this), this.sourcesLength()), (this.QUERY() !== null ? this.QUERY().unpack() : null), (this.ENCRYPTION() !== null ? this.ENCRYPTION().unpack() : null), this.bb.createScalarList(this.PROVIDER_SIGNATURE.bind(this), this.providerSignatureLength()), this.SIGNATURE_TYPE());
    }
    unpackTo(_o) {
...
export class DPMT {
    constructor(VERSION = null, DATASET_ID = null, UPDATE_ID = null, PROVIDER_PEER_ID = null, PROVIDER_EPM_CID = null, PUBLISH_TIMESTAMP = null, ASSETS = [], SOURCES = [], QUERY = null, ENCRYPTION = null, PROVIDER_SIGNATURE = [], SIGNATURE_TYPE = null) {
