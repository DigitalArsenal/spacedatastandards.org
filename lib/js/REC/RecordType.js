...
(function (RecordType) {
    ...
    RecordType[RecordType["OPM"] = 9] = "OPM";
    RecordType[RecordType["CRM"] = 10] = "CRM";
    RecordType[RecordType["SCM"] = 11] = "SCM";
    RecordType[RecordType["TDM"] = 12] = "TDM";
    RecordType[RecordType["IDM"] = 13] = "IDM";
    RecordType[RecordType["MET"] = 14] = "MET";
    RecordType[RecordType["ROC"] = 15] = "ROC";
    RecordType[RecordType["BOV"] = 16] = "BOV";
    RecordType[RecordType["EOP"] = 17] = "EOP";
    RecordType[RecordType["EOO"] = 18] = "EOO";
    RecordType[RecordType["EME"] = 19] = "EME";
    RecordType[RecordType["LDM"] = 20] = "LDM";
    RecordType[RecordType["PNM"] = 21] = "PNM";
    RecordType[RecordType["HYP"] = 22] = "HYP";
    RecordType[RecordType["CTR"] = 23] = "CTR";
    RecordType[RecordType["CDM"] = 24] = "CDM";
    RecordType[RecordType["SIT"] = 25] = "SIT";
    RecordType[RecordType["OEM"] = 26] = "OEM";
    RecordType[RecordType["TIM"] = 27] = "TIM";
    RecordType[RecordType["EPM"] = 28] = "EPM";
    RecordType[RecordType["PRG"] = 29] = "PRG";
