...
export class Record {
    ...
    static createRecord(builder, valueType, valueOffset, typeOffset) {
...
export class RecordT {
    constructor(valueType = RecordType.NONE, value = null, type = null) {
    ...
    pack(builder) {
        ...
        return Record.createRecord(builder, this.valueType, value, type);
    }
}
