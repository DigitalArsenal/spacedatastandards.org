...
export class Record {
    ...
    static createRecord(builder, value_type, valueOffset, standardOffset) {
    ...
    unpack() {
        return new RecordT(this.value_type(), (() => {
...
export class RecordT {
    constructor(value_type = RecordType.NONE, value = null, standard = null) {
    ...
    pack(builder) {
        ...
        return Record.createRecord(builder, this.value_type, value, standard);
    }
}
