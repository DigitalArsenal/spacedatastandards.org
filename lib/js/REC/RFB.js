...
export class RFB {
    ...
    static createRFB(builder, IDOffset, ID_ENTITYOffset, NAMEOffset, BAND, MODEOffset, PURPOSEOffset, FREQ_MIN, FREQ_MAX, CENTER_FREQ, BANDWIDTH, PEAK_GAIN, EDGE_GAIN, BEAMWIDTH, POLARIZATION, ERP, EIRP) {
    ...
    unpack() {
        return new RFBT(this.ID(), this.ID_ENTITY(), this.NAME(), this.BAND(), this.MODE(), this.PURPOSE(), this.FREQ_MIN(), this.FREQ_MAX(), this.CENTER_FREQ(), this.BANDWIDTH(), this.PEAK_GAIN(), this.EDGE_GAIN(), this.BEAMWIDTH(), this.POLARIZATION(), this.ERP(), this.EIRP());
    }
    unpackTo(_o) {
        _o.ID = this.ID();
...
export class RFBT {
    constructor(ID = null, ID_ENTITY = null, NAME = null, BAND = rfBandDesignation.UHF, MODE = null, PURPOSE = null, FREQ_MIN = 0.0, FREQ_MAX = 0.0, CENTER_FREQ = 0.0, BANDWIDTH = 0.0, PEAK_GAIN = 0.0, EDGE_GAIN = 0.0, BEAMWIDTH = 0.0, POLARIZATION = rfPolarization.LHCP, ERP = 0.0, EIRP = 0.0) {
        this.ID = ID;
    ...
    pack(builder) {
        ...
        return RFB.createRFB(builder, ID, ID_ENTITY, NAME, this.BAND, MODE, PURPOSE, this.FREQ_MIN, this.FREQ_MAX, this.CENTER_FREQ, this.BANDWIDTH, this.PEAK_GAIN, this.EDGE_GAIN, this.BEAMWIDTH, this.POLARIZATION, this.ERP, this.EIRP);
    }
}
