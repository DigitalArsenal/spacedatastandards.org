...
export declare class MTIT implements flatbuffers.IGeneratedObject {
    ...
    JOB_REQUESTS: (string)[];
    constructor(ID?: string | Uint8Array | null, P3?: string | Uint8Array | null, P6?: string | Uint8Array | null, P7?: string | Uint8Array | null, P8?: string | Uint8Array | null, P9?: number, P10?: number, MISSIONS?: (string)[], DWELLS?: (string)[], HRRS?: (string)[], JOB_DEFS?: (string)[], FREE_TEXTS?: (string)[], PLATFORM_LOCS?: (string)[], JOB_REQUESTS?: (string)[]);
