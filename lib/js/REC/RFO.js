...
export class RFO {
    ...
    DETECTION_STATUS(optionalEncoding) {
    ...
    static addDetectionStatus(builder, DETECTION_STATUSOffset) {
    ...
    static createRFO(builder, IDOffset, OB_TIMEOffset, ID_SENSOROffset, TYPEOffset, SAT_NO, TASK_IDOffset, TRANSACTION_IDOffset, TRACK_IDOffset, ORIG_OBJECT_IDOffset, ORIG_SENSOR_IDOffset, UCT, TRANSPONDEROffset, AZIMUTH, AZIMUTH_UNC, AZIMUTH_RATE, ELEVATION, ELEVATION_UNC, ELEVATION_RATE, RANGE, RANGE_UNC, RANGE_RATE, RANGE_RATE_UNC, TRACK_RANGE, SENLAT, SENLON, SENALT, ELNOTOffset, FREQUENCY, NOMINAL_FREQUENCY, START_FREQUENCY, END_FREQUENCY, RELATIVE_CARRIER_POWER, SPECTRUM_ANALYZER_POWER, RELATIVE_NOISE_FLOOR, REFERENCE_LEVEL, PGRI, CONFIDENCE, INCOMING, SWITCH_POINT, BAUD_RATE, SNR, NOMINAL_SNR, POLARITY, POLARITY_TYPEOffset, CHANNEL, POWER_OVER_NOISE, NOMINAL_POWER_OVER_NOISE, BANDWIDTH, NOMINAL_BANDWIDTH, RESOLUTION_BANDWIDTH, VIDEO_BANDWIDTH, EIRP, NOMINAL_EIRP, MIN_PSD, MAX_PSD, FREQUENCY_SHIFT, PEAK, ANTENNA_NAMEOffset, DETECTION_STATUSOffset, COLLECTION_MODEOffset, RAW_FILE_URIOffset, TAGSOffset, NOISE_PWR_DENSITY, CARRIER_STANDARDOffset, MODULATIONOffset, INNER_CODING_RATE, OUTER_CODING_RATE, TRANSMIT_FILTER_TYPEOffset, TRANSMIT_FILTER_ROLL_OFF, SYMBOL_TO_NOISE_RATIO, BIT_ERROR_RATE, ON_ORBITOffset, DESCRIPTOROffset, URLOffset) {
    ...
    unpack() {
        return new RFOT(this.ID(), this.OB_TIME(), this.ID_SENSOR(), this.TYPE(), this.SAT_NO(), this.TASK_ID(), this.TRANSACTION_ID(), this.TRACK_ID(), this.ORIG_OBJECT_ID(), this.ORIG_SENSOR_ID(), this.UCT(), this.TRANSPONDER(), this.AZIMUTH(), this.AZIMUTH_UNC(), this.AZIMUTH_RATE(), this.ELEVATION(), this.ELEVATION_UNC(), this.ELEVATION_RATE(), this.RANGE(), this.RANGE_UNC(), this.RANGE_RATE(), this.RANGE_RATE_UNC(), this.TRACK_RANGE(), this.SENLAT(), this.SENLON(), this.SENALT(), this.ELNOT(), this.FREQUENCY(), this.NOMINAL_FREQUENCY(), this.START_FREQUENCY(), this.END_FREQUENCY(), this.RELATIVE_CARRIER_POWER(), this.SPECTRUM_ANALYZER_POWER(), this.RELATIVE_NOISE_FLOOR(), this.REFERENCE_LEVEL(), this.PGRI(), this.CONFIDENCE(), this.INCOMING(), this.SWITCH_POINT(), this.BAUD_RATE(), this.SNR(), this.NOMINAL_SNR(), this.POLARITY(), this.POLARITY_TYPE(), this.CHANNEL(), this.POWER_OVER_NOISE(), this.NOMINAL_POWER_OVER_NOISE(), this.BANDWIDTH(), this.NOMINAL_BANDWIDTH(), this.RESOLUTION_BANDWIDTH(), this.VIDEO_BANDWIDTH(), this.EIRP(), this.NOMINAL_EIRP(), this.MIN_PSD(), this.MAX_PSD(), this.FREQUENCY_SHIFT(), this.PEAK(), this.ANTENNA_NAME(), this.DETECTION_STATUS(), this.COLLECTION_MODE(), this.RAW_FILE_URI(), this.bb.createScalarList(this.TAGS.bind(this), this.tagsLength()), this.NOISE_PWR_DENSITY(), this.CARRIER_STANDARD(), this.MODULATION(), this.INNER_CODING_RATE(), this.OUTER_CODING_RATE(), this.TRANSMIT_FILTER_TYPE(), this.TRANSMIT_FILTER_ROLL_OFF(), this.SYMBOL_TO_NOISE_RATIO(), this.BIT_ERROR_RATE(), this.ON_ORBIT(), this.DESCRIPTOR(), this.URL());
    }
    unpackTo(_o) {
        _o.ID = this.ID();
...
export class RFOT {
    constructor(ID = null, OB_TIME = null, ID_SENSOR = null, TYPE = null, SAT_NO = 0, TASK_ID = null, TRANSACTION_ID = null, TRACK_ID = null, ORIG_OBJECT_ID = null, ORIG_SENSOR_ID = null, UCT = false, TRANSPONDER = null, AZIMUTH = 0.0, AZIMUTH_UNC = 0.0, AZIMUTH_RATE = 0.0, ELEVATION = 0.0, ELEVATION_UNC = 0.0, ELEVATION_RATE = 0.0, RANGE = 0.0, RANGE_UNC = 0.0, RANGE_RATE = 0.0, RANGE_RATE_UNC = 0.0, TRACK_RANGE = 0.0, SENLAT = 0.0, SENLON = 0.0, SENALT = 0.0, ELNOT = null, FREQUENCY = 0.0, NOMINAL_FREQUENCY = 0.0, START_FREQUENCY = 0.0, END_FREQUENCY = 0.0, RELATIVE_CARRIER_POWER = 0.0, SPECTRUM_ANALYZER_POWER = 0.0, RELATIVE_NOISE_FLOOR = 0.0, REFERENCE_LEVEL = 0.0, PGRI = 0.0, CONFIDENCE = 0.0, INCOMING = false, SWITCH_POINT = 0, BAUD_RATE = 0.0, SNR = 0.0, NOMINAL_SNR = 0.0, POLARITY = 0.0, POLARITY_TYPE = null, CHANNEL = 0, POWER_OVER_NOISE = 0.0, NOMINAL_POWER_OVER_NOISE = 0.0, BANDWIDTH = 0.0, NOMINAL_BANDWIDTH = 0.0, RESOLUTION_BANDWIDTH = 0.0, VIDEO_BANDWIDTH = 0.0, EIRP = 0.0, NOMINAL_EIRP = 0.0, MIN_PSD = 0.0, MAX_PSD = 0.0, FREQUENCY_SHIFT = 0.0, PEAK = false, ANTENNA_NAME = null, DETECTION_STATUS = null, COLLECTION_MODE = null, RAW_FILE_URI = null, TAGS = [], NOISE_PWR_DENSITY = 0.0, CARRIER_STANDARD = null, MODULATION = null, INNER_CODING_RATE = 0, OUTER_CODING_RATE = 0, TRANSMIT_FILTER_TYPE = null, TRANSMIT_FILTER_ROLL_OFF = 0.0, SYMBOL_TO_NOISE_RATIO = 0.0, BIT_ERROR_RATE = 0.0, ON_ORBIT = null, DESCRIPTOR = null, URL = null) {
        this.ID = ID;
    ...
    pack(builder) {
        ...
        return RFO.createRFO(builder, ID, OB_TIME, ID_SENSOR, TYPE, this.SAT_NO, TASK_ID, TRANSACTION_ID, TRACK_ID, ORIG_OBJECT_ID, ORIG_SENSOR_ID, this.UCT, TRANSPONDER, this.AZIMUTH, this.AZIMUTH_UNC, this.AZIMUTH_RATE, this.ELEVATION, this.ELEVATION_UNC, this.ELEVATION_RATE, this.RANGE, this.RANGE_UNC, this.RANGE_RATE, this.RANGE_RATE_UNC, this.TRACK_RANGE, this.SENLAT, this.SENLON, this.SENALT, ELNOT, this.FREQUENCY, this.NOMINAL_FREQUENCY, this.START_FREQUENCY, this.END_FREQUENCY, this.RELATIVE_CARRIER_POWER, this.SPECTRUM_ANALYZER_POWER, this.RELATIVE_NOISE_FLOOR, this.REFERENCE_LEVEL, this.PGRI, this.CONFIDENCE, this.INCOMING, this.SWITCH_POINT, this.BAUD_RATE, this.SNR, this.NOMINAL_SNR, this.POLARITY, POLARITY_TYPE, this.CHANNEL, this.POWER_OVER_NOISE, this.NOMINAL_POWER_OVER_NOISE, this.BANDWIDTH, this.NOMINAL_BANDWIDTH, this.RESOLUTION_BANDWIDTH, this.VIDEO_BANDWIDTH, this.EIRP, this.NOMINAL_EIRP, this.MIN_PSD, this.MAX_PSD, this.FREQUENCY_SHIFT, this.PEAK, ANTENNA_NAME, DETECTION_STATUS, COLLECTION_MODE, RAW_FILE_URI, TAGS, this.NOISE_PWR_DENSITY, CARRIER_STANDARD, MODULATION, this.INNER_CODING_RATE, this.OUTER_CODING_RATE, TRANSMIT_FILTER_TYPE, this.TRANSMIT_FILTER_ROLL_OFF, this.SYMBOL_TO_NOISE_RATIO, this.BIT_ERROR_RATE, ON_ORBIT, DESCRIPTOR, URL);
    }
}
