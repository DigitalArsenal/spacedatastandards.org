...
export class TAB {
    ...
    unpack() {
        return new TABT(this.OFFSET(), this.SIZE(), this.ALIGNMENT(), this.WIRE_FORMAT(), (this.TYPE_REF() !== null ? this.TYPE_REF().unpack() : null), this.MUTABILITY(), this.OWNERSHIP(), this.FRAME_ID());
    }
    unpackTo(_o) {
...
export class TABT {
    constructor(OFFSET = 0, SIZE = 0, ALIGNMENT = 0, WIRE_FORMAT = payloadWireFormat.FLATBUFFER, TYPE_REF = null, MUTABILITY = bufferMutability.IMMUTABLE, OWNERSHIP = bufferOwnership.HOST_OWNED, FRAME_ID = BigInt('0')) {
        this.OFFSET = OFFSET;
        this.SIZE = SIZE;
