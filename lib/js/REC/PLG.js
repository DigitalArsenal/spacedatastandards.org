...
export class PLGT {
    ...
    pack(builder) {
        ...
        return PLG.createPLG(builder, PLUGIN_ID, NAME, VERSION, DESCRIPTION, this.PLUGIN_TYPE, this.ABI_VERSION, WASM_HASH, this.WASM_SIZE, WASM_CID, ENCRYPTED_WASM_HASH, this.ENCRYPTED_WASM_SIZE, ENTRY_FUNCTIONS, REQUIRED_SCHEMAS, DEPENDENCIES, CAPABILITIES, PROVIDER_PEER_ID, PROVIDER_EPM_CID, this.ENCRYPTED, REQUIRED_SCOPE, KEY_ID, ALLOWED_DOMAINS, this.MAX_GRANT_TIMEOUT_MS, MIN_PERMISSIONS, this.CREATED_AT, this.UPDATED_AT, DOCUMENTATION_URL, ICON_URL, LICENSE, SIGNATURE);
    }
}
