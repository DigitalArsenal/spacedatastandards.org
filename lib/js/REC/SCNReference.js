...
import { SCNTleLines } from './SCNTleLines.js';
...
export class SCNReference {
    ...
    static addTles(builder, TLESOffset) {
        builder.addFieldOffset(9, TLESOffset, 0);
    }
    static createTlesVector(builder, data) {
        builder.startVector(4, data.length, 4);
        for (let i = data.length - 1; i >= 0; i--) {
            builder.addOffset(data[i]);
        }
    ...
    static startTlesVector(builder, numElems) {
        builder.startVector(4, numElems, 4);
    }
    ...
    static addSiteLatitudeDeg(builder, SITE_LATITUDE_DEG) {
        builder.addFieldFloat64(17, SITE_LATITUDE_DEG, 0.0);
    }
    static addSiteLongitudeDeg(builder, SITE_LONGITUDE_DEG) {
    ...
    unpackTo(_o) {
        ...
        _o.TLES = this.bb.createObjList(this.TLES.bind(this), this.tlesLength());
...
export class SCNReferenceT {
    constructor(REFERENCE_ID = null, DISPLAY_NAME = null, REFERENCE_KIND = scenarioReferenceKind.UNKNOWN, REMOVE = false, NORAD_CAT_ID = 0, OBJECT_ID = null, COUNTRY = null, SOURCES = [], DATA_MODES = [], TLES = [], MEAN_ELEMENTS = [], STATES = [], MANEUVERS = [], SITE = null, SENSOR = null, SENSOR_SYSTEM_ID = null, SENSOR_ID = null, SITE_LATITUDE_DEG = 0.0, SITE_LONGITUDE_DEG = 0.0, VARIABLE_SATELLITE_ID = null, VARIABLE_SITE_ID = null, POINTS = [], VIEW_CONE = null, SUN_ADVANTAGE_TARGET = null, EXCLUSION_ZONE = null, OBSERVATION_EO = null, OBSERVATION_RADAR = null) {
        ...
        this.SITE_LATITUDE_DEG = SITE_LATITUDE_DEG;
        this.SITE_LONGITUDE_DEG = SITE_LONGITUDE_DEG;
