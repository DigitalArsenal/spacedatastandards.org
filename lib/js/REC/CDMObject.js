...
export class CDMObjectT {
    constructor(COMMENT = null, OBJECT = null, POC = null, OPERATOR_CONTACT_POSITION = null, OPERATOR_ORGANIZATION = null, EPHEMERIS_NAME = null, COVARIANCE_METHOD = covarianceAlgorithm.CALCULATED, REFERENCE_FRAME = null, GRAVITY_MODEL = null, ATMOSPHERIC_MODEL = null, N_BODY_PERTURBATIONS = null, SOLAR_RAD_PRESSURE = false, EARTH_TIDES = false, INTRACK_THRUST = false, TIME_LASTOB_START = null, TIME_LASTOB_END = null, RECOMMENDED_OD_SPAN = 0.0, ACTUAL_OD_SPAN = 0.0, OBS_AVAILABLE = 0, OBS_USED = 0, TRACKS_AVAILABLE = 0, TRACKS_USED = 0, RESIDUALS_ACCEPTED = 0.0, WEIGHTED_RMS = 0.0, AREA_PC = 0.0, AREA_DRG = 0.0, AREA_SRP = 0.0, CR_AREA_OVER_MASS = 0.0, THRUST_ACCELERATION = 0.0, SEDR = 0.0, X = 0.0, Y = 0.0, Z = 0.0, X_DOT = 0.0, Y_DOT = 0.0, Z_DOT = 0.0, COVARIANCE = []) {
