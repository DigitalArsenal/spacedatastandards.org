 ...
 */
export declare class BooleanParameterType implements flatbuffers.IUnpackableObject<BooleanParameterTypeT> {
    ...
    static startBooleanParameterType(builder: flatbuffers.Builder): void;
...
export declare class BooleanParameterTypeT implements flatbuffers.IGeneratedObject {
...
//# sourceMappingURL=BooleanParameterType.d.ts.map