...
export class SCN {
    ...
    unpack() {
        return new SCNT(this.SCENARIO_ID(), this.bb.createObjList(this.REFERENCES.bind(this), this.referencesLength()), (this.EVENT() !== null ? this.EVENT().unpack() : null), this.FOCUSED_REFERENCE_INDEX(), this.FOCUSED_REFERENCE_ID(), this.SIM_TIME(), this.SIM_SPEED(), this.USE_ECEF_FRAME(), (this.REFERENCE_FRAME() !== null ? this.REFERENCE_FRAME().unpack() : null), this.ACTION(), (this.VIEW_STATE() !== null ? this.VIEW_STATE().unpack() : null), (this.ASSETS_CHANGED() !== null ? this.ASSETS_CHANGED().unpack() : null));
    }
    unpackTo(_o) {
...
export class SCNT {
    constructor(SCENARIO_ID = null, REFERENCES = [], EVENT = null, FOCUSED_REFERENCE_INDEX = -1, FOCUSED_REFERENCE_ID = null, SIM_TIME = null, SIM_SPEED = 0.0, USE_ECEF_FRAME = false, REFERENCE_FRAME = null, ACTION = scenarioActionCode.NONE, VIEW_STATE = null, ASSETS_CHANGED = null) {
        ...
        this.USE_ECEF_FRAME = USE_ECEF_FRAME;
