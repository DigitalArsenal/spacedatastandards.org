...
export class OBTT {
    constructor(ID = null, SAT_NO = 0, ORIG_OBJECT_ID = null, ON_ORBIT = null, TS = null, LAT = 0.0, LON = 0.0, ALT = 0.0, SPD = 0.0, ANG_ELEV = 0.0, RDF_RF = 0.0, CALL_SIGN = null, RPT_NUM = null, TRK_ID = null, OBJ_IDENT = null, IDENT_AMP = null, SAT_STATUS = null, OBJ_TYPE = orbitObjectType.PAYLOAD, COUNTRY_CODE = null, DECAY = 0.0, CHARLIE_LINE = null, AOU_TYPE = aouCategory.CIRCULAR, AOU_DATA = [], CNTNMNT = 0.0, XREF = null, CH_XREF = null, AMPLIFICATION = null, IFF = null, VEH_TYPE = null, REINFORCED = false, REDUCED = false, HQ = false, DUMMY = false, TASK_FORCE = false, FEINT = false, INSTALLATION = false, TRACK_SENSORS = []) {
        this.ID = ID;
        this.SAT_NO = SAT_NO;
