...
export class Perturbations {
    ...
    static createPerturbations(builder, COMMENTOffset, ATMOSPHERIC_MODELOffset, GRAVITY_MODELOffset, GRAVITY_DEGREE, GRAVITY_ORDER, GM, N_BODY_PERTURBATIONSOffset, OCEAN_TIDES_MODELOffset, SOLID_TIDES_MODELOffset, ATMOSPHERIC_TIDES_MODELOffset, GEOPOTENTIAL_MODELOffset, SOLAR_RAD_PRESSUREOffset, ALBEDOOffset, THERMALOffset, RELATIVITYOffset, ATMOSPHERIC_DRAGOffset, FIXED_GEOMAG_KP, FIXED_F10P7, FIXED_F10P7_MEAN) {
...
export class PerturbationsT {
    ...
    pack(builder) {
        ...
        return Perturbations.createPerturbations(builder, COMMENT, ATMOSPHERIC_MODEL, GRAVITY_MODEL, this.GRAVITY_DEGREE, this.GRAVITY_ORDER, this.GM, N_BODY_PERTURBATIONS, OCEAN_TIDES_MODEL, SOLID_TIDES_MODEL, ATMOSPHERIC_TIDES_MODEL, GEOPOTENTIAL_MODEL, SOLAR_RAD_PRESSURE, ALBEDO, THERMAL, RELATIVITY, ATMOSPHERIC_DRAG, this.FIXED_GEOMAG_KP, this.FIXED_F10P7, this.FIXED_F10P7_MEAN);
    }
}
