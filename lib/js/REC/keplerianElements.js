...
export class keplerianElementsT {
    constructor(SEMI_MAJOR_AXIS = 0.0, ECCENTRICITY = 0.0, INCLINATION = 0.0, RA_OF_ASC_NODE = 0.0, ARG_OF_PERICENTER = 0.0, ANOMALY_TYPE = anomalyConvention.TRUE_ANOMALY, ANOMALY = 0.0) {
