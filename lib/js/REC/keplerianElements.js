...
export class keplerianElements {
    ...
    static addPeriapsisRadius(builder, PERIAPSIS_RADIUS) {
    ...
    static createkeplerianElements(builder, SEMI_MAJOR_AXIS, ECCENTRICITY, INCLINATION, RA_OF_ASC_NODE, ARG_OF_PERICENTER, ANOMALY_TYPE, ANOMALY, PERIAPSIS_RADIUS) {
    ...
    unpack() {
        return new keplerianElementsT(this.SEMI_MAJOR_AXIS(), this.ECCENTRICITY(), this.INCLINATION(), this.RA_OF_ASC_NODE(), this.ARG_OF_PERICENTER(), this.ANOMALY_TYPE(), this.ANOMALY(), this.PERIAPSIS_RADIUS());
    }
    unpackTo(_o) {
...
export class keplerianElementsT {
    constructor(SEMI_MAJOR_AXIS = 0.0, ECCENTRICITY = 0.0, INCLINATION = 0.0, RA_OF_ASC_NODE = 0.0, ARG_OF_PERICENTER = 0.0, ANOMALY_TYPE = anomalyConvention.TRUE_ANOMALY, ANOMALY = 0.0, PERIAPSIS_RADIUS = 0.0) {
        ...
        this.PERIAPSIS_RADIUS = PERIAPSIS_RADIUS;
    }
    pack(builder) {
        return keplerianElements.createkeplerianElements(builder, this.SEMI_MAJOR_AXIS, this.ECCENTRICITY, this.INCLINATION, this.RA_OF_ASC_NODE, this.ARG_OF_PERICENTER, this.ANOMALY_TYPE, this.ANOMALY, this.PERIAPSIS_RADIUS);
    }
}
