...
export declare class OOE implements flatbuffers.IUnpackableObject<OOET> {
    ...
    static addInsuranceLossNotes(builder: flatbuffers.Builder, INSURANCE_LOSS_NOTESOffset: flatbuffers.Offset): void;
    static addCapabilityLossNotes(builder: flatbuffers.Builder, CAPABILITY_LOSS_NOTESOffset: flatbuffers.Offset): void;
    static addInsuranceCarriedNotes(builder: flatbuffers.Builder, INSURANCE_CARRIED_NOTESOffset: flatbuffers.Offset): void;
    static addEquipmentCausingLossNotes(builder: flatbuffers.Builder, EQUIPMENT_CAUSING_LOSS_NOTESOffset: flatbuffers.Offset): void;
...
export declare class OOET implements flatbuffers.IGeneratedObject {
    ...
    INSURANCE_LOSS_NOTES: string | Uint8Array | null;
    CAPABILITY_LOSS_NOTES: string | Uint8Array | null;
    INSURANCE_CARRIED_NOTES: string | Uint8Array | null;
    EQUIPMENT_CAUSING_LOSS_NOTES: string | Uint8Array | null;
    EVENT_TYPE: string | Uint8Array | null;
    EVENT_RESULT: string | Uint8Array | null;
    OBJECT_STATUS: string | Uint8Array | null;
    SATELLITE_POSITION: string | Uint8Array | null;
    ON_ORBIT: string | Uint8Array | null;
    constructor(ID?: string | Uint8Array | null, DERIVED_FROM?: string | Uint8Array | null, DECLASSIFICATION_DATE?: string | Uint8Array | null, DECLASSIFICATION_STRING?: string | Uint8Array | null, SAT_NO?: number, ORIG_OBJECT_ID?: string | Uint8Array | null, EVENT_TIME?: string | Uint8Array | null, EVENT_TIME_NOTES?: string | Uint8Array | null, OPERATOR_ORG_ID?: string | Uint8Array | null, OWNER_ORG_ID?: string | Uint8Array | null, LESSEE_ORG_ID?: string | Uint8Array | null, OPERATED_ON_BEHALF_OF_ORG_ID?: string | Uint8Array | null, GEO_POSITION?: number, PLANE_SLOT?: string | Uint8Array | null, PLANE_NUMBER?: string | Uint8Array | null, POSITION_STATUS?: string | Uint8Array | null, UNTIL_TIME?: string | Uint8Array | null, OFFICIAL_LOSS_DATE?: string | Uint8Array | null, NET_AMOUNT?: number, UNDERLYING_CAUSE?: string | Uint8Array | null, CAPABILITY_LOSS?: number, CAPACITY_LOSS?: number, INSURANCE_LOSS?: number, THIRD_PARTY_INSURANCE_LOSS?: number, INJURED?: number, KILLED?: number, LIFE_LOST?: number, AGE_AT_EVENT?: number, ACHIEVED_FLIGHT_PHASE?: string | Uint8Array | null, OCCURRENCE_FLIGHT_PHASE?: string | Uint8Array | null, STAGE_AT_FAULT?: string | Uint8Array | null, EQUIPMENT_AT_FAULT?: string | Uint8Array | null, EQUIPMENT_TYPE_AT_FAULT?: string | Uint8Array | null, EQUIPMENT_PART_AT_FAULT?: string | Uint8Array | null, CONSEQUENTIAL_EQUIPMENT_FAILURE?: string | Uint8Array | null, INCLINED?: boolean, DESCRIPTION?: string | Uint8Array | null, REMARKS?: string | Uint8Array | null, INSURANCE_LOSS_NOTES?: string | Uint8Array | null, CAPABILITY_LOSS_NOTES?: string | Uint8Array | null, INSURANCE_CARRIED_NOTES?: string | Uint8Array | null, EQUIPMENT_CAUSING_LOSS_NOTES?: string | Uint8Array | null, EVENT_TYPE?: string | Uint8Array | null, EVENT_RESULT?: string | Uint8Array | null, OBJECT_STATUS?: string | Uint8Array | null, SATELLITE_POSITION?: string | Uint8Array | null, ON_ORBIT?: string | Uint8Array | null);
