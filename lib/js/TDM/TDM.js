...
import { TDMSegment } from './TDMSegment.js';
...
export class TDM {
     ...
     */
    DOPPLER_NOISE_HZ(index) {
        const offset = this.bb.__offset(this.bb_pos, 130);
        return offset ? this.bb.readFloat64(this.bb.__vector(this.bb_pos + offset) + index * 8) : 0;
    }
    dopplerNoiseHzLength() {
        const offset = this.bb.__offset(this.bb_pos, 130);
        return offset ? this.bb.__vector_len(this.bb_pos + offset) : 0;
    }
    dopplerNoiseHzArray() {
    ...
    static addSignalToNoise(builder, SIGNAL_TO_NOISEOffset) {
        builder.addFieldOffset(61, SIGNAL_TO_NOISEOffset, 0);
    }
    static createSignalToNoiseVector(builder, data) {
        builder.startVector(8, data.length, 8);
        for (let i = data.length - 1; i >= 0; i--) {
            builder.addFloat64(data[i]);
        }
    ...
    static startSignalToNoiseVector(builder, numElems) {
        builder.startVector(8, numElems, 8);
    }
    static addSpectralMax(builder, SPECTRAL_MAXOffset) {
        builder.addFieldOffset(62, SPECTRAL_MAXOffset, 0);
    }
    static createSpectralMaxVector(builder, data) {
        builder.startVector(8, data.length, 8);
        for (let i = data.length - 1; i >= 0; i--) {
            builder.addFloat64(data[i]);
        }
    ...
    static startSpectralMaxVector(builder, numElems) {
        builder.startVector(8, numElems, 8);
    }
    static addDopplerNoiseHz(builder, DOPPLER_NOISE_HZOffset) {
        builder.addFieldOffset(63, DOPPLER_NOISE_HZOffset, 0);
    }
    static createDopplerNoiseHzVector(builder, data) {
        builder.startVector(8, data.length, 8);
        for (let i = data.length - 1; i >= 0; i--) {
            builder.addFloat64(data[i]);
        }
    ...
    static startDopplerNoiseHzVector(builder, numElems) {
        builder.startVector(8, numElems, 8);
    }
    ...
    unpackTo(_o) {
        ...
        _o.SIGNAL_TO_NOISE = this.bb.createScalarList(this.SIGNAL_TO_NOISE.bind(this), this.signalToNoiseLength());
        _o.SPECTRAL_MAX = this.bb.createScalarList(this.SPECTRAL_MAX.bind(this), this.spectralMaxLength());
        _o.DOPPLER_NOISE_HZ = this.bb.createScalarList(this.DOPPLER_NOISE_HZ.bind(this), this.dopplerNoiseHzLength());
...
export class TDMT {
    constructor(OBSERVER_ID = null, OBSERVER_X = 0.0, OBSERVER_Y = 0.0, OBSERVER_Z = 0.0, OBSERVER_VX = 0.0, OBSERVER_VY = 0.0, OBSERVER_VZ = 0.0, OBSERVER_POSITION_REFERENCE_FRAME = null, OBS_REFERENCE_FRAME = null, EPOCH = null, OBSERVATION_STEP_SIZE = 0.0, OBSERVATION_START_TIME = null, CCSDS_TDM_VERS = null, COMMENT = [], CREATION_DATE = null, ORIGINATOR = null, META_START = null, TIME_SYSTEM = null, START_TIME = null, STOP_TIME = null, PARTICIPANT_1 = null, PARTICIPANT_2 = null, PARTICIPANT_3 = null, PARTICIPANT_4 = null, PARTICIPANT_5 = null, MODE = null, PATH_1 = 0, PATH_2 = 0, TRANSMIT_BAND = null, RECEIVE_BAND = null, INTEGRATION_INTERVAL = 0.0, INTEGRATION_REF = null, RECEIVE_DELAY_2 = 0.0, RECEIVE_DELAY_3 = 0.0, DATA_QUALITY = null, META_STOP = null, DATA_START = null, TRANSMIT_FREQ_1 = 0.0, RECEIVE_FREQ = [], DATA_STOP = null, TIMETAG_REF = null, ANGLE_TYPE = null, ANGLE_1 = [], ANGLE_2 = [], ANGLE_UNCERTAINTY_1 = 0.0, ANGLE_UNCERTAINTY_2 = 0.0, RANGE_RATE = 0.0, RANGE_UNCERTAINTY = 0.0, RANGE_MODE = null, RANGE_MODULUS = 0.0, CORRECTION_ANGLE_1 = 0.0, CORRECTION_ANGLE_2 = 0.0, CORRECTIONS_APPLIED = null, TROPO_DRY = [], TROPO_WET = [], STEC = [], PRESSURE = [], RHUMIDITY = [], TEMPERATURE = [], CLOCK_BIAS = [], CLOCK_DRIFT = [], SIGNAL_TO_NOISE = [], SPECTRAL_MAX = [], DOPPLER_NOISE_HZ = [], TRANSMIT_RAMPS = [], OBSERVATIONS = [], SEGMENTS = [], TRANSMIT_FREQ_2 = 0.0, TRANSMIT_FREQ_3 = 0.0, TRANSMIT_FREQ_4 = 0.0, TRANSMIT_FREQ_5 = 0.0, TRANSMIT_FREQ_RATE_1 = 0.0, TRANSMIT_FREQ_RATE_2 = 0.0, TRANSMIT_FREQ_RATE_3 = 0.0, TRANSMIT_FREQ_RATE_4 = 0.0, TRANSMIT_FREQ_RATE_5 = 0.0, MESSAGE_ID = null, TRACK_ID = null, DATA_TYPES = null, PATH = null, EPHEMERIS_NAME_1 = null, EPHEMERIS_NAME_2 = null, EPHEMERIS_NAME_3 = null, EPHEMERIS_NAME_4 = null, EPHEMERIS_NAME_5 = null, RANGE_UNITS = null, REFERENCE_FRAME = null, INTERPOLATION = null, INTERPOLATION_DEGREE = 0, FREQ_OFFSET = 0.0, TURNAROUND_NUMERATOR = 0, TURNAROUND_DENOMINATOR = 0, TRANSMIT_DELAY_1 = 0.0, TRANSMIT_DELAY_2 = 0.0, TRANSMIT_DELAY_3 = 0.0, TRANSMIT_DELAY_4 = 0.0, TRANSMIT_DELAY_5 = 0.0, RECEIVE_DELAY_1 = 0.0, RECEIVE_DELAY_4 = 0.0, RECEIVE_DELAY_5 = 0.0, DOPPLER_COUNT_BIAS = 0.0, DOPPLER_COUNT_SCALE = 0, DOPPLER_COUNT_ROLLOVER = false, CORRECTION_RANGE = 0.0, CORRECTION_DOPPLER = 0.0, CORRECTION_MAG = 0.0, CORRECTION_RCS = 0.0, CORRECTION_RECEIVE = 0.0, CORRECTION_TRANSMIT = 0.0, CORRECTION_ABERRATION_YEARLY = 0.0, CORRECTION_ABERRATION_DIURNAL = 0.0) {
        ...
        this.SPECTRAL_MAX = SPECTRAL_MAX;
        this.DOPPLER_NOISE_HZ = DOPPLER_NOISE_HZ;
