...
export class EME {
    ...
    static createEME(builder, ENCRYPTED_BLOBOffset, EPHEMERAL_PUBLIC_KEYOffset, MACOffset, NONCEOffset, TAGOffset, IVOffset, SALTOffset, PUBLIC_KEY_IDENTIFIEROffset, CIPHER_SUITEOffset, KDF_PARAMETERSOffset, ENCRYPTION_ALGORITHM_PARAMETERSOffset) {
    ...
    unpack() {
        return new EMET(this.bb.createScalarList(this.ENCRYPTED_BLOB.bind(this), this.encryptedBlobLength()), this.EPHEMERAL_PUBLIC_KEY(), this.MAC(), this.NONCE(), this.TAG(), this.IV(), this.SALT(), this.PUBLIC_KEY_IDENTIFIER(), this.CIPHER_SUITE(), this.KDF_PARAMETERS(), this.ENCRYPTION_ALGORITHM_PARAMETERS());
    }
    unpackTo(_o) {
...
export class EMET {
    constructor(ENCRYPTED_BLOB = [], EPHEMERAL_PUBLIC_KEY = null, MAC = null, NONCE = null, TAG = null, IV = null, SALT = null, PUBLIC_KEY_IDENTIFIER = null, CIPHER_SUITE = null, KDF_PARAMETERS = null, ENCRYPTION_ALGORITHM_PARAMETERS = null) {
    ...
    pack(builder) {
        ...
        return EME.createEME(builder, ENCRYPTED_BLOB, EPHEMERAL_PUBLIC_KEY, MAC, NONCE, TAG, IV, SALT, PUBLIC_KEY_IDENTIFIER, CIPHER_SUITE, KDF_PARAMETERS, ENCRYPTION_ALGORITHM_PARAMETERS);
    }
}
