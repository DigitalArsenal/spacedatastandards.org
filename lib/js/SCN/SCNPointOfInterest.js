...
export class SCNPointOfInterest {
    ...
    static addHighlightBeforeSec(builder, HIGHLIGHT_BEFORE_SEC) {
        builder.addFieldFloat64(3, HIGHLIGHT_BEFORE_SEC, 0.0);
    }
    static addHighlightAfterSec(builder, HIGHLIGHT_AFTER_SEC) {
    ...
    unpack() {
        return new SCNPointOfInterestT(this.NAME(), this.DESCRIPTION(), this.EPOCH(), this.HIGHLIGHT_BEFORE_SEC(), this.HIGHLIGHT_AFTER_SEC(), this.COLOR(), (this.POSITION() !== null ? this.POSITION().unpack() : null));
    }
    unpackTo(_o) {
        _o.NAME = this.NAME();
...
export class SCNPointOfInterestT {
    constructor(NAME = null, DESCRIPTION = null, EPOCH = null, HIGHLIGHT_BEFORE_SEC = 0.0, HIGHLIGHT_AFTER_SEC = 0.0, COLOR = null, POSITION = null) {
        this.NAME = NAME;
        this.DESCRIPTION = DESCRIPTION;
        this.EPOCH = EPOCH;
        this.HIGHLIGHT_BEFORE_SEC = HIGHLIGHT_BEFORE_SEC;
        this.HIGHLIGHT_AFTER_SEC = HIGHLIGHT_AFTER_SEC;
        this.COLOR = COLOR;
