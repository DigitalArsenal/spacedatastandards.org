...
export class PLGT {
    constructor(PLUGIN_ID = null, NAME = null, VERSION = null, DESCRIPTION = null, TAGLINE = null, PLUGIN_TYPE = pluginType.Sensor, PUBLISHER_NAME = null, PUBLISHER_HANDLE = null, PUBLISHER_URL = null, SUPPORT_URL = null, TAGS = [], FEATURES = [], SCREENSHOT_URLS = [], BANNER_URL = null, ABI_VERSION = 1, WASM_HASH = [], WASM_SIZE = BigInt('0'), WASM_CID = null, ENCRYPTED_WASM_HASH = [], ENCRYPTED_WASM_SIZE = BigInt('0'), ENTRY_FUNCTIONS = [], REQUIRED_SCHEMAS = [], DEPENDENCIES = [], CAPABILITIES = [], PROVIDER_PEER_ID = null, PROVIDER_EPM_CID = null, ENCRYPTED = true, REQUIRED_SCOPE = null, KEY_ID = null, ALLOWED_DOMAINS = [], MAX_GRANT_TIMEOUT_MS = BigInt('0'), MIN_PERMISSIONS = [], CREATED_AT = BigInt('0'), UPDATED_AT = BigInt('0'), DOCUMENTATION_URL = null, CHANGELOG_URL = null, ICON_URL = null, LICENSE = null, PAYMENT_MODEL = paymentModel.Free, PRICE_USD_CENTS = 0, SUBSCRIPTION_PERIOD_DAYS = 0, ACCEPTED_PAYMENT_METHODS = [], LISTING_STATUS = listingStatus.Public, SIGNATURE = []) {
