...
export declare class SHWCompileRequest implements flatbuffers.IUnpackableObject<SHWCompileRequestT> {
    ...
    static addShaderStage(builder: flatbuffers.Builder, SHADER_STAGE: shaderStage): void;
    static addShaderInjectionPoint(builder: flatbuffers.Builder, SHADER_INJECTION_POINT: shaderInjectionPoint): void;
...
export declare class SHWCompileRequestT implements flatbuffers.IGeneratedObject {
    ...
    constructor(SHADER_NAME?: string | Uint8Array | null, SHADER_STAGE?: shaderStage, SHADER_INJECTION_POINT?: shaderInjectionPoint, SHADER_SOURCE?: string | Uint8Array | null, GLSL_VERSION?: string | Uint8Array | null, SHADER_UNIFORMS?: (SHWUniformT)[]);
