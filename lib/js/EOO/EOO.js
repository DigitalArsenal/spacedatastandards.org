...
export class EOO {
    ...
    static addReferenceFrame(builder, REFERENCE_FRAME) {
        builder.addFieldInt8(78, REFERENCE_FRAME, referenceFrame.ECEF);
    }
