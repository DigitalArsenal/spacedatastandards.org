...
import { BEMHopSchedule } from './BEMHopSchedule.js';
...
export class BEM {
    ...
    static addHopSchedule(builder, HOP_SCHEDULEOffset) {
    ...
    unpack() {
        return new BEMT(this.ID(), this.BEAM_NAME(), this.ID_ENTITY(), this.ID_ANTENNA(), this.TYPE(), this.POLARIZATION(), this.PEAK_GAIN(), this.EOC_GAIN(), this.CENTER_LATITUDE(), this.CENTER_LONGITUDE(), this.BEAMWIDTH(), this.FREQUENCY(), this.EIRP(), this.G_OVER_T(), this.FOOTPRINT_AREA(), this.bb.createObjList(this.BEAM_CONTOURS.bind(this), this.beamContoursLength()), this.NOTES(), (this.HOP_SCHEDULE() !== null ? this.HOP_SCHEDULE().unpack() : null), (this.PROVENANCE() !== null ? this.PROVENANCE().unpack() : null), this.COMPUTED_AT(), this.PRODUCER_ID(), this.bb.createScalarList(this.SIGNATURE.bind(this), this.signatureLength()), this.bb.createScalarList(this.CANONICAL_JSON_SIGNATURE.bind(this), this.canonicalJsonSignatureLength()));
    }
    unpackTo(_o) {
        _o.ID = this.ID();
...
export class BEMT {
    constructor(ID = null, BEAM_NAME = null, ID_ENTITY = null, ID_ANTENNA = null, TYPE = beamType.SPOT, POLARIZATION = beamPolarization.RHCP, PEAK_GAIN = 0.0, EOC_GAIN = 0.0, CENTER_LATITUDE = 0.0, CENTER_LONGITUDE = 0.0, BEAMWIDTH = 0.0, FREQUENCY = 0.0, EIRP = 0.0, G_OVER_T = 0.0, FOOTPRINT_AREA = 0.0, BEAM_CONTOURS = [], NOTES = null, HOP_SCHEDULE = null, PROVENANCE = null, COMPUTED_AT = BigInt('0'), PRODUCER_ID = null, SIGNATURE = [], CANONICAL_JSON_SIGNATURE = []) {
        this.ID = ID;
        ...
        this.NOTES = NOTES;
        this.HOP_SCHEDULE = HOP_SCHEDULE;
