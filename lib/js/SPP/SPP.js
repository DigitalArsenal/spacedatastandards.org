...
export class SPP {
    ...
    unpack() {
        return new SPPT(this.VERSION(), this.PACKET_TYPE(), this.SEC_HDR_FLAG(), this.APID(), this.SEQUENCE_FLAGS(), this.SEQUENCE_COUNT(), this.DATA_LENGTH(), this.bb.createScalarList(this.DATA.bind(this), this.DATA_LENGTH()));
    }
    unpackTo(_o) {
        ...
        _o.DATA = this.bb.createScalarList(this.DATA.bind(this), this.DATA_LENGTH());
    }
}
export class SPPT {
    constructor(VERSION = 0, PACKET_TYPE = packetKind.TM, SEC_HDR_FLAG = false, APID = 0, SEQUENCE_FLAGS = 0, SEQUENCE_COUNT = 0, DATA_LENGTH = 0, DATA = []) {
