...
export class STFT {
    constructor(LISTING_ID = null, PROVIDER_PEER_ID = null, PROVIDER_EPM_CID = null, TITLE = null, DESCRIPTION = null, DATA_TYPES = [], COVERAGE = null, SAMPLE_CID = null, ACCESS_TYPE = accessCategory.OneTime, ENCRYPTION_REQUIRED = false, PRICING = [], ACCEPTED_PAYMENTS = [], CREATED_AT = BigInt('0'), UPDATED_AT = BigInt('0'), ACTIVE = false, SIGNATURE = [], LISTING_KIND = listingCategory.DataStream, TAGS = [], SAMPLE_RECORD_COUNT = 0, DELIVERY_METHODS = [], PROTECTED_DELIVERY = null, REPUTATION = null, VERSION = 0, EXPIRES_AT = BigInt('0'), TERMS_CID = null, LICENSE = null, SOURCE_PEER_ID = null, PRIMARY_CATEGORY = capabilityClass.UNSPECIFIED, CATEGORIES = []) {
