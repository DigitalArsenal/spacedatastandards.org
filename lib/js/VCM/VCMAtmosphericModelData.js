...
export class VCMAtmosphericModelDataT {
    constructor(ATMOSPHERIC_MODEL = atmosphericSource.NONE, GEOPOTENTIAL_MODEL = geopotentialSource.NONE, LUNAR_SOLAR_PERTURBATION = perturbationStatus.OFF, LUNAR_PERTURBATION_MODEL = lunarPerturbationSource.NONE, SOLAR_PERTURBATION_MODEL = solarPerturbationSource.NONE, SOLAR_RADIATION_PRESSURE = perturbationStatus.OFF, SRP_MODEL = solarRadiationPressureModel.NONE, RESONANCE_MODEL = resonanceSource.NONE) {
