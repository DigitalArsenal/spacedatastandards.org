...
export declare class propagatorConfig implements flatbuffers.IUnpackableObject<propagatorConfigT> {
    ...
    static addPropagatorType(builder: flatbuffers.Builder, PROPAGATOR_TYPE: propagatorFamily): void;
...
export declare class propagatorConfigT implements flatbuffers.IGeneratedObject {
    ...
    constructor(PROPAGATOR_NAME?: string | Uint8Array | null, PROPAGATOR_TYPE?: propagatorFamily, FORCE_MODELS?: (string)[], EPOCH?: string | Uint8Array | null, TIME_STEP?: number, ZONAL_HARMONIC_TERMS?: (zonalHarmonic)[]);
