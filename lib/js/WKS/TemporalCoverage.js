...
export class TemporalCoverage {
    ...
    static addLatencySeconds(builder, LATENCY_SECONDS) {
    ...
    static createTemporalCoverage(builder, START_EPOCHOffset, END_EPOCHOffset, UPDATE_FREQUENCYOffset, HISTORICAL_DEPTH, LATENCY_SECONDS) {
    ...
    unpack() {
        return new TemporalCoverageT(this.START_EPOCH(), this.END_EPOCH(), this.UPDATE_FREQUENCY(), this.HISTORICAL_DEPTH(), this.LATENCY_SECONDS());
    }
    unpackTo(_o) {
...
export class TemporalCoverageT {
    constructor(START_EPOCH = null, END_EPOCH = null, UPDATE_FREQUENCY = null, HISTORICAL_DEPTH = 0, LATENCY_SECONDS = 0) {
    ...
    pack(builder) {
        ...
        return TemporalCoverage.createTemporalCoverage(builder, START_EPOCH, END_EPOCH, UPDATE_FREQUENCY, this.HISTORICAL_DEPTH, this.LATENCY_SECONDS);
    }
}
