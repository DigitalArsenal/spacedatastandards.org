...
export class SDL {
    ...
    unpack() {
        return new SDLT(this.SPI(), this.IV_LENGTH(), this.bb.createScalarList(this.IV.bind(this), this.IV_LENGTH()), this.MAC_LENGTH(), this.bb.createScalarList(this.MAC.bind(this), this.MAC_LENGTH()), this.PAD_LENGTH(), this.bb.createScalarList(this.PAYLOAD.bind(this), this.payloadLength()));
    }
    unpackTo(_o) {
        _o.SPI = this.SPI();
        _o.IV_LENGTH = this.IV_LENGTH();
        _o.IV = this.bb.createScalarList(this.IV.bind(this), this.IV_LENGTH());
        _o.MAC_LENGTH = this.MAC_LENGTH();
        _o.MAC = this.bb.createScalarList(this.MAC.bind(this), this.MAC_LENGTH());
