 ...
 * provider, or site.
 */
export declare class VEPProvenance implements flatbuffers.IUnpackableObject<VEPProvenanceT> {
    ...
    static startVEPProvenance(builder: flatbuffers.Builder): void;
...
export declare class VEPProvenanceT implements flatbuffers.IGeneratedObject {
...
//# sourceMappingURL=VEPProvenance.d.ts.map