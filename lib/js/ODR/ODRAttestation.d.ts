...
export declare class ODRAttestation implements flatbuffers.IUnpackableObject<ODRAttestationT> {
    bb: flatbuffers.ByteBuffer | null;
    bb_pos: number;
    __init(i: number, bb: flatbuffers.ByteBuffer): ODRAttestation;
    static getRootAsODRAttestation(bb: flatbuffers.ByteBuffer, obj?: ODRAttestation): ODRAttestation;
    static getSizePrefixedRootAsODRAttestation(bb: flatbuffers.ByteBuffer, obj?: ODRAttestation): ODRAttestation;
    ...
    static startODRAttestation(builder: flatbuffers.Builder): void;
    ...
    static endODRAttestation(builder: flatbuffers.Builder): flatbuffers.Offset;
    static createODRAttestation(builder: flatbuffers.Builder, SIGNING_PUBLIC_KEYOffset: flatbuffers.Offset, SIGNED_ATOffset: flatbuffers.Offset, SIGNATUREOffset: flatbuffers.Offset, CANONICAL_JSON_SIGNATUREOffset: flatbuffers.Offset): flatbuffers.Offset;
    unpack(): ODRAttestationT;
    unpackTo(_o: ODRAttestationT): void;
}
export declare class ODRAttestationT implements flatbuffers.IGeneratedObject {
...
//# sourceMappingURL=ODRAttestation.d.ts.map