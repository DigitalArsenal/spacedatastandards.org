...
export class PNM {
    ...
    static addCidFid(builder, CID_FIDOffset) {
        builder.addFieldOffset(1, CID_FIDOffset, 0);
    }
...
export class PNMT {
    ...
    pack(builder) {
        ...
        const CID_FID = (this.CID_FID !== null ? builder.createString(this.CID_FID) : 0);
