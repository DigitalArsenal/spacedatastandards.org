...
export class PNM {
    ...
    static addFileEncrypted(builder, FILE_ENCRYPTEDOffset) {
    ...
    unpack() {
        return new PNMT((this.FILE() !== null ? this.FILE().unpack() : null), (this.FILE_ENCRYPTED() !== null ? this.FILE_ENCRYPTED().unpack() : null));
    }
    unpackTo(_o) {
...
export class PNMT {
    constructor(FILE = null, FILE_ENCRYPTED = null) {
        this.FILE = FILE;
        this.FILE_ENCRYPTED = FILE_ENCRYPTED;
    }
    pack(builder) {
