...
export declare class PNM implements flatbuffers.IUnpackableObject<PNMT> {
    ...
    static addIpfsCidAccount(builder: flatbuffers.Builder, IPFS_CID_ACCOUNTOffset: flatbuffers.Offset): void;
...
export declare class PNMT implements flatbuffers.IGeneratedObject {
    IPFS_CID_ACCOUNT: IPFS_CID_ADDRESST | null;
