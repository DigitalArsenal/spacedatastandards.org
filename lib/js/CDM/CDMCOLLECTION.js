...
export class CDMCOLLECTION {
    ...
    static finishCDMCOLLECTIONBuffer(builder, offset) {
        builder.finish(offset, '$CDM');
    }
    static finishSizePrefixedCDMCOLLECTIONBuffer(builder, offset) {
    ...
    unpack() {
        return new CDMCOLLECTIONT(this.bb.createObjList(this.RECORDS.bind(this), this.recordsLength()));
    }
    unpackTo(_o) {
        _o.RECORDS = this.bb.createObjList(this.RECORDS.bind(this), this.recordsLength());
    }
}
export class CDMCOLLECTIONT {
    constructor(RECORDS = []) {
