...
export class RFM {
    ...
    static createRFM(builder, referenceFrameType, REFERENCE_FRAMEOffset, INDEX, NAMEOffset) {
...
export class RFMT {
    constructor(referenceFrameType = RFMUnion.NONE, REFERENCE_FRAME = null, INDEX = 0, NAME = null) {
    ...
    pack(builder) {
        ...
        return RFM.createRFM(builder, this.referenceFrameType, REFERENCE_FRAME, this.INDEX, NAME);
    }
}
