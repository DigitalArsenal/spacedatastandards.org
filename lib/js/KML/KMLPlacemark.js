...
import { KMLSchemaData } from './KMLSchemaData.js';
...
export class KMLPlacemark {
    ...
    static addLinearRing(builder, LINEAR_RINGOffset) {
    ...
    static addTrack(builder, TRACKOffset) {
        builder.addFieldOffset(14, TRACKOffset, 0);
    }
    static addMultiTrack(builder, MULTI_TRACKOffset) {
    ...
    static addSchemaData(builder, SCHEMA_DATAOffset) {
    ...
    static addStyleMap(builder, STYLE_MAPOffset) {
    ...
    unpack() {
        return new KMLPlacemarkT(this.NAME(), this.DESCRIPTION(), this.VISIBILITY(), this.STYLE_URL(), (this.STYLE() !== null ? this.STYLE().unpack() : null), this.SNIPPET(), this.OPEN(), this.ADDRESS(), (this.POINT() !== null ? this.POINT().unpack() : null), (this.LINE_STRING() !== null ? this.LINE_STRING().unpack() : null), (this.POLYGON() !== null ? this.POLYGON().unpack() : null), (this.LINEAR_RING() !== null ? this.LINEAR_RING().unpack() : null), (this.MULTI_GEOMETRY() !== null ? this.MULTI_GEOMETRY().unpack() : null), (this.MODEL() !== null ? this.MODEL().unpack() : null), (this.TRACK() !== null ? this.TRACK().unpack() : null), (this.MULTI_TRACK() !== null ? this.MULTI_TRACK().unpack() : null), (this.LOOK_AT() !== null ? this.LOOK_AT().unpack() : null), (this.CAMERA() !== null ? this.CAMERA().unpack() : null), (this.TIME_SPAN() !== null ? this.TIME_SPAN().unpack() : null), (this.TIME_STAMP() !== null ? this.TIME_STAMP().unpack() : null), this.bb.createObjList(this.EXTENDED_DATA.bind(this), this.extendedDataLength()), (this.SCHEMA_DATA() !== null ? this.SCHEMA_DATA().unpack() : null), (this.REGION() !== null ? this.REGION().unpack() : null), (this.STYLE_MAP() !== null ? this.STYLE_MAP().unpack() : null));
    }
    unpackTo(_o) {
        _o.NAME = this.NAME();
...
export class KMLPlacemarkT {
    constructor(NAME = null, DESCRIPTION = null, VISIBILITY = false, STYLE_URL = null, STYLE = null, SNIPPET = null, OPEN = false, ADDRESS = null, POINT = null, LINE_STRING = null, POLYGON = null, LINEAR_RING = null, MULTI_GEOMETRY = null, MODEL = null, TRACK = null, MULTI_TRACK = null, LOOK_AT = null, CAMERA = null, TIME_SPAN = null, TIME_STAMP = null, EXTENDED_DATA = [], SCHEMA_DATA = null, REGION = null, STYLE_MAP = null) {
        this.NAME = NAME;
        ...
        this.LINEAR_RING = LINEAR_RING;
        this.MULTI_GEOMETRY = MULTI_GEOMETRY;
        this.MODEL = MODEL;
        this.TRACK = TRACK;
        this.MULTI_TRACK = MULTI_TRACK;
