...
export class CryptoKey {
    ...
    static createCryptoKey(builder, PUBLIC_KEYOffset, XPUBOffset, PRIVATE_KEYOffset, XPRIVOffset, KEY_ADDRESSOffset, ADDRESS_TYPEOffset, KEY_TYPE) {
    ...
    unpack() {
        return new CryptoKeyT(this.PUBLIC_KEY(), this.XPUB(), this.PRIVATE_KEY(), this.XPRIV(), this.KEY_ADDRESS(), this.ADDRESS_TYPE(), this.KEY_TYPE());
    }
    unpackTo(_o) {
...
export class CryptoKeyT {
    constructor(PUBLIC_KEY = null, XPUB = null, PRIVATE_KEY = null, XPRIV = null, KEY_ADDRESS = null, ADDRESS_TYPE = null, KEY_TYPE = KeyType.Signing) {
    ...
    pack(builder) {
        ...
        return CryptoKey.createCryptoKey(builder, PUBLIC_KEY, XPUB, PRIVATE_KEY, XPRIV, KEY_ADDRESS, ADDRESS_TYPE, this.KEY_TYPE);
    }
}
