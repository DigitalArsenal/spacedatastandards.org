...
export class APPModuleRef {
    ...
    static addRuntimeTarget(builder, RUNTIME_TARGET) {
    ...
    static createAPPModuleRef(builder, IDOffset, PLUGIN_IDOffset, CONTENT_HASHOffset, VERSIONOffset, ROLEOffset, DESCRIPTIONOffset, MAX_WALL_CLOCK_MS, MAX_COST_UNITS, MAX_MEMORY_PAGES, RUNTIME_TARGET) {
    ...
    unpack() {
        return new APPModuleRefT(this.ID(), this.PLUGIN_ID(), this.CONTENT_HASH(), this.VERSION(), this.ROLE(), this.DESCRIPTION(), this.MAX_WALL_CLOCK_MS(), this.MAX_COST_UNITS(), this.MAX_MEMORY_PAGES(), this.RUNTIME_TARGET());
    }
    unpackTo(_o) {
        _o.ID = this.ID();
...
export class APPModuleRefT {
    constructor(ID = null, PLUGIN_ID = null, CONTENT_HASH = null, VERSION = null, ROLE = null, DESCRIPTION = null, MAX_WALL_CLOCK_MS = BigInt('0'), MAX_COST_UNITS = BigInt('0'), MAX_MEMORY_PAGES = 0, RUNTIME_TARGET = appRuntimeTarget.NODE) {
        this.ID = ID;
        ...
        this.RUNTIME_TARGET = RUNTIME_TARGET;
    }
    pack(builder) {
        ...
        return APPModuleRef.createAPPModuleRef(builder, ID, PLUGIN_ID, CONTENT_HASH, VERSION, ROLE, DESCRIPTION, this.MAX_WALL_CLOCK_MS, this.MAX_COST_UNITS, this.MAX_MEMORY_PAGES, this.RUNTIME_TARGET);
    }
}
