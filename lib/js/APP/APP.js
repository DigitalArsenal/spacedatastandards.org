...
export class APP {
    ...
    static addRuntimeClass(builder, RUNTIME_CLASS) {
    ...
    static createAPP(builder, IDOffset, NAMEOffset, VERSIONOffset, DESCRIPTIONOffset, MODULESOffset, DATAOffset, SOURCESOffset, UIOffset, CREATED_ATOffset, UPDATED_ATOffset, DATAFLOWOffset, RUNTIME_CLASS, PRIMARY_CATEGORY, CATEGORIESOffset) {
...
export class APPT {
    constructor(ID = null, NAME = null, VERSION = null, DESCRIPTION = null, MODULES = [], DATA = [], SOURCES = [], UI = [], CREATED_AT = null, UPDATED_AT = null, DATAFLOW = [], RUNTIME_CLASS = appRuntimeTarget.NODE, PRIMARY_CATEGORY = capabilityClass.UNSPECIFIED, CATEGORIES = []) {
        this.ID = ID;
        this.NAME = NAME;
        ...
        this.RUNTIME_CLASS = RUNTIME_CLASS;
    ...
    pack(builder) {
        ...
        return APP.createAPP(builder, ID, NAME, VERSION, DESCRIPTION, MODULES, DATA, SOURCES, UI, CREATED_AT, UPDATED_AT, DATAFLOW, this.RUNTIME_CLASS, this.PRIMARY_CATEGORY, CATEGORIES);
    }
}
