...
export class APP {
    ...
    static createAPP(builder, IDOffset, NAMEOffset, VERSIONOffset, DESCRIPTIONOffset, MODULESOffset, DATAOffset, SOURCESOffset, UIOffset, CREATED_ATOffset, UPDATED_ATOffset, DATAFLOWOffset, RUNTIME_CLASS) {
...
export class APPT {
    constructor(ID = null, NAME = null, VERSION = null, DESCRIPTION = null, MODULES = [], DATA = [], SOURCES = [], UI = [], CREATED_AT = null, UPDATED_AT = null, DATAFLOW = [], RUNTIME_CLASS = appRuntimeTarget.NODE) {
        this.ID = ID;
        this.NAME = NAME;
    ...
    pack(builder) {
        ...
        return APP.createAPP(builder, ID, NAME, VERSION, DESCRIPTION, MODULES, DATA, SOURCES, UI, CREATED_AT, UPDATED_AT, DATAFLOW, this.RUNTIME_CLASS);
    }
}
