...
export class OrbitDetermination {
     ...
     */
    OD_RESIDUALS_SERIES(index) {
        const offset = this.bb.__offset(this.bb_pos, 42);
        return offset ? this.bb.readFloat64(this.bb.__vector(this.bb_pos + offset) + index * 8) : 0;
    }
    odResidualsSeriesLength() {
        const offset = this.bb.__offset(this.bb_pos, 42);
        return offset ? this.bb.__vector_len(this.bb_pos + offset) : 0;
    }
    odResidualsSeriesArray() {
        const offset = this.bb.__offset(this.bb_pos, 42);
     ...
     */
    OD_RESIDUAL_EPOCHS(index) {
        const offset = this.bb.__offset(this.bb_pos, 44);
        return offset ? this.bb.readFloat64(this.bb.__vector(this.bb_pos + offset) + index * 8) : 0;
    }
    odResidualEpochsLength() {
        const offset = this.bb.__offset(this.bb_pos, 44);
        return offset ? this.bb.__vector_len(this.bb_pos + offset) : 0;
    }
    odResidualEpochsArray() {
        const offset = this.bb.__offset(this.bb_pos, 44);
        return offset ? new Float64Array(this.bb.bytes().buffer, this.bb.bytes().byteOffset + this.bb.__vector(this.bb_pos + offset), this.bb.__vector_len(this.bb_pos + offset)) : null;
    }
    OD_BATCH_BASELINE_ID(optionalEncoding) {
    ...
    static addOdEstimator(builder, OD_ESTIMATOR) {
        builder.addFieldInt8(17, OD_ESTIMATOR, estimatorCategory.Unknown);
    }
    static addOdResidualRms(builder, OD_RESIDUAL_RMS) {
        builder.addFieldFloat64(18, OD_RESIDUAL_RMS, 0.0);
    }
    static addOdResidualsSeries(builder, OD_RESIDUALS_SERIESOffset) {
        builder.addFieldOffset(19, OD_RESIDUALS_SERIESOffset, 0);
    }
    static createOdResidualsSeriesVector(builder, data) {
    ...
    static startOdResidualsSeriesVector(builder, numElems) {
        builder.startVector(8, numElems, 8);
    }
    static addOdResidualEpochs(builder, OD_RESIDUAL_EPOCHSOffset) {
        builder.addFieldOffset(20, OD_RESIDUAL_EPOCHSOffset, 0);
    }
    static createOdResidualEpochsVector(builder, data) {
        builder.startVector(8, data.length, 8);
        for (let i = data.length - 1; i >= 0; i--) {
            builder.addFloat64(data[i]);
        }
    ...
    static startOdResidualEpochsVector(builder, numElems) {
        builder.startVector(8, numElems, 8);
    }
    static addOdBatchBaselineId(builder, OD_BATCH_BASELINE_IDOffset) {
        builder.addFieldOffset(21, OD_BATCH_BASELINE_IDOffset, 0);
    }
    static addOdBatchBaselineRms(builder, OD_BATCH_BASELINE_RMS) {
    ...
    unpackTo(_o) {
        ...
        _o.OD_RESIDUALS_SERIES = this.bb.createScalarList(this.OD_RESIDUALS_SERIES.bind(this), this.odResidualsSeriesLength());
        _o.OD_RESIDUAL_EPOCHS = this.bb.createScalarList(this.OD_RESIDUAL_EPOCHS.bind(this), this.odResidualEpochsLength());
...
export class OrbitDeterminationT {
    constructor(OD_ID = null, OD_PREV_ID = null, OD_ALGORITHM = null, OD_METHOD = null, OD_EPOCH = null, OD_TIME_TAG = null, OD_PROCESS_NOISE = null, OD_COV_REDUCTION = null, OD_NOISE_MODELS = null, OD_OBSERVATIONS_TYPE = [], OD_OBSERVATIONS_USED = 0, OD_TRACKS_USED = 0, OD_DATA_WEIGHTING = null, OD_CONVERGENCE_CRITERIA = null, OD_EST_PARAMETERS = [], OD_APRIORI_DATA = null, OD_RESIDUALS = null, OD_ESTIMATOR = estimatorCategory.Unknown, OD_RESIDUAL_RMS = 0.0, OD_RESIDUALS_SERIES = [], OD_RESIDUAL_EPOCHS = [], OD_BATCH_BASELINE_ID = null, OD_BATCH_BASELINE_RMS = 0.0, SEDR = 0.0, WEIGHTED_RMS = 0.0) {
        ...
        this.OD_ESTIMATOR = OD_ESTIMATOR;
        this.OD_RESIDUAL_RMS = OD_RESIDUAL_RMS;
        this.OD_RESIDUALS_SERIES = OD_RESIDUALS_SERIES;
        this.OD_RESIDUAL_EPOCHS = OD_RESIDUAL_EPOCHS;
        this.OD_BATCH_BASELINE_ID = OD_BATCH_BASELINE_ID;
        this.OD_BATCH_BASELINE_RMS = OD_BATCH_BASELINE_RMS;
        this.SEDR = SEDR;
