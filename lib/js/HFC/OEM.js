...
export class OEM {
    ...
    static addCcsdsOemVers(builder, CCSDS_OEM_VERS) {
        builder.addFieldFloat64(1, CCSDS_OEM_VERS, 0.0);
    }
    static addCreationDate(builder, CREATION_DATEOffset) {
        builder.addFieldOffset(2, CREATION_DATEOffset, 0);
    }
    ...
    static addEphemerisDataBlock(builder, EPHEMERIS_DATA_BLOCKOffset) {
        builder.addFieldOffset(4, EPHEMERIS_DATA_BLOCKOffset, 0);
    }
    ...
    static createOEM(builder, CLASSIFICATIONOffset, CCSDS_OEM_VERS, CREATION_DATEOffset, ORIGINATOROffset, EPHEMERIS_DATA_BLOCKOffset) {
    ...
    unpack() {
        return new OEMT(this.CLASSIFICATION(), this.CCSDS_OEM_VERS(), this.CREATION_DATE(), this.ORIGINATOR(), this.bb.createObjList(this.EPHEMERIS_DATA_BLOCK.bind(this), this.ephemerisDataBlockLength()));
    }
    unpackTo(_o) {
...
export class OEMT {
    constructor(CLASSIFICATION = null, CCSDS_OEM_VERS = 0.0, CREATION_DATE = null, ORIGINATOR = null, EPHEMERIS_DATA_BLOCK = []) {
    ...
    pack(builder) {
        ...
        return OEM.createOEM(builder, CLASSIFICATION, this.CCSDS_OEM_VERS, CREATION_DATE, ORIGINATOR, EPHEMERIS_DATA_BLOCK);
    }
}
