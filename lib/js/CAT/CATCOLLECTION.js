...
export class CATCOLLECTION {
    ...
    static finishCATCOLLECTIONBuffer(builder, offset) {
        builder.finish(offset, '$CAT');
    }
    static finishSizePrefixedCATCOLLECTIONBuffer(builder, offset) {
    ...
    unpack() {
        return new CATCOLLECTIONT(this.bb.createObjList(this.RECORDS.bind(this), this.recordsLength()));
    }
    unpackTo(_o) {
