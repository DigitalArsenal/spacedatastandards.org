...
export class VSTCameraOptions {
    ...
    static addDistanceFromTarget(builder, DISTANCE_FROM_TARGET) {
    ...
    unpack() {
        return new VSTCameraOptionsT(this.CAMERA_FRAME_MODE(), this.SATELLITE_ALIGNMENT(), this.DISTANCE_FROM_TARGET(), (this.ROTATION() !== null ? this.ROTATION().unpack() : null));
    }
    unpackTo(_o) {
...
export class VSTCameraOptionsT {
    constructor(CAMERA_FRAME_MODE = viewerCameraFrameMode.DEFAULT, SATELLITE_ALIGNMENT = viewerSatelliteAlignmentMode.UNKNOWN, DISTANCE_FROM_TARGET = 0.0, ROTATION = null) {
