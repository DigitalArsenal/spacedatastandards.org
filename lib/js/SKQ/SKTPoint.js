...
export class SKTPoint {
    ...
    static createSKTPoint(builder, RA_FIXED, DEC_FIXED, PMRA, PMDEC, PARALLAX, MAG, COLOR, FLAGS, ROW) {
        builder.prep(4, 24);
    ...
    unpack() {
        return new SKTPointT(this.RA_FIXED(), this.DEC_FIXED(), this.PMRA(), this.PMDEC(), this.PARALLAX(), this.MAG(), this.COLOR(), this.FLAGS(), this.ROW());
    }
    unpackTo(_o) {
...
export class SKTPointT {
    constructor(RA_FIXED = 0, DEC_FIXED = 0, PMRA = 0, PMDEC = 0, PARALLAX = 0, MAG = 0, COLOR = 0, FLAGS = 0, ROW = 0) {
        this.RA_FIXED = RA_FIXED;
        this.DEC_FIXED = DEC_FIXED;
        this.PMRA = PMRA;
        this.PMDEC = PMDEC;
    ...
    pack(builder) {
        return SKTPoint.createSKTPoint(builder, this.RA_FIXED, this.DEC_FIXED, this.PMRA, this.PMDEC, this.PARALLAX, this.MAG, this.COLOR, this.FLAGS, this.ROW);
    }
}
