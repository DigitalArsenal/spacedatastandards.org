 ...
 */
export declare class Detail implements flatbuffers.IUnpackableObject<DetailT> {
    bb: flatbuffers.ByteBuffer | null;
    bb_pos: number;
    __init(i: number, bb: flatbuffers.ByteBuffer): Detail;
    static getRootAsDetail(bb: flatbuffers.ByteBuffer, obj?: Detail): Detail;
    static getSizePrefixedRootAsDetail(bb: flatbuffers.ByteBuffer, obj?: Detail): Detail;
    /**
     * Multiformat Address
