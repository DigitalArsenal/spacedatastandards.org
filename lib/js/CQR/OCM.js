...
export class OCMT {
    constructor(HEADER = null, METADATA = null, TRAJ_TYPE = trajectoryType.CARTESIAN_PV, TRAJ_TYPE_DESCRIPTION = null, STATE_STEP_SIZE = 0.0, STATE_VECTOR_SIZE = 6, STATE_DATA = [], COVARIANCE_DATA = [], POLYNOMIAL_POSITION_RECORDS = [], POLYNOMIAL_OE_RECORDS = [], PHYSICAL_PROPERTIES = null, MANEUVER_DATA = [], PERTURBATIONS = null, ORBIT_DETERMINATION = null, USER_DEFINED_PARAMETERS = []) {
        this.HEADER = HEADER;
