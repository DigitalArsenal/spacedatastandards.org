...
export class ephemerisDataBlock {
    ...
    static addObjectNaifId(builder, OBJECT_NAIF_ID) {
...
export class ephemerisDataBlockT {
    constructor(COMMENT = null, OBJECT = null, CENTER_NAME = null, REFERENCE_FRAME = null, REFERENCE_FRAME_EPOCH = null, COV_REFERENCE_FRAME = null, TIME_SYSTEM = timingStandard.GMST, START_TIME = null, USEABLE_START_TIME = null, USEABLE_STOP_TIME = null, STOP_TIME = null, INTERPOLATION = null, INTERPOLATION_DEGREE = 0, STEP_SIZE = 0.0, STATE_VECTOR_SIZE = 6, EPHEMERIS_DATA = [], EPHEMERIS_DATA_LINES = [], COVARIANCE_MATRIX_LINES = [], POLYNOMIAL_POSITION_RECORDS = [], OBJECT_NAIF_ID = 0, CENTER_NAIF_ID = 0) {
        ...
        this.OBJECT_NAIF_ID = OBJECT_NAIF_ID;
