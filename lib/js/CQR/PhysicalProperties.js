...
export class PhysicalProperties {
    ...
    static addMassUnits(builder, MASS_UNITSOffset) {
        builder.addFieldOffset(3, MASS_UNITSOffset, 0);
    }
    static addOebQ1(builder, OEB_Q1) {
        builder.addFieldFloat64(4, OEB_Q1, 0.0);
    }
    static addOebQ2(builder, OEB_Q2) {
        builder.addFieldFloat64(5, OEB_Q2, 0.0);
    }
    static addOebQ3(builder, OEB_Q3) {
        builder.addFieldFloat64(6, OEB_Q3, 0.0);
    }
    static addOebQc(builder, OEB_QC) {
        builder.addFieldFloat64(7, OEB_QC, 0.0);
    }
    static addOebMax(builder, OEB_MAX) {
        builder.addFieldFloat64(8, OEB_MAX, 0.0);
    }
    static addOebInt(builder, OEB_INT) {
        builder.addFieldFloat64(9, OEB_INT, 0.0);
    }
    static addOebMin(builder, OEB_MIN) {
        builder.addFieldFloat64(10, OEB_MIN, 0.0);
    }
    static addAreaAlongOebMax(builder, AREA_ALONG_OEB_MAX) {
        builder.addFieldFloat64(11, AREA_ALONG_OEB_MAX, 0.0);
    }
    static addAreaAlongOebInt(builder, AREA_ALONG_OEB_INT) {
        builder.addFieldFloat64(12, AREA_ALONG_OEB_INT, 0.0);
    }
    static addAreaAlongOebMin(builder, AREA_ALONG_OEB_MIN) {
        builder.addFieldFloat64(13, AREA_ALONG_OEB_MIN, 0.0);
    }
    static addAreaUnits(builder, AREA_UNITSOffset) {
        builder.addFieldOffset(14, AREA_UNITSOffset, 0);
    }
    static addDragConstArea(builder, DRAG_CONST_AREA) {
        builder.addFieldFloat64(15, DRAG_CONST_AREA, 0.0);
    }
    static addDragCoeffNom(builder, DRAG_COEFF_NOM) {
        builder.addFieldFloat64(16, DRAG_COEFF_NOM, 0.0);
    }
    static addDragUncertainty(builder, DRAG_UNCERTAINTY) {
        builder.addFieldFloat64(17, DRAG_UNCERTAINTY, 0.0);
    }
    static addSrpConstArea(builder, SRP_CONST_AREA) {
    ...
    static addSrpUncertainty(builder, SRP_UNCERTAINTY) {
    ...
    static createPhysicalProperties(builder, COMMENTOffset, WET_MASS, DRY_MASS, MASS_UNITSOffset, OEB_Q1, OEB_Q2, OEB_Q3, OEB_QC, OEB_MAX, OEB_INT, OEB_MIN, AREA_ALONG_OEB_MAX, AREA_ALONG_OEB_INT, AREA_ALONG_OEB_MIN, AREA_UNITSOffset, DRAG_CONST_AREA, DRAG_COEFF_NOM, DRAG_UNCERTAINTY, SRP_CONST_AREA, SOLAR_RAD_COEFF, SRP_UNCERTAINTY) {
    ...
    unpack() {
        return new PhysicalPropertiesT(this.bb.createScalarList(this.COMMENT.bind(this), this.commentLength()), this.WET_MASS(), this.DRY_MASS(), this.MASS_UNITS(), this.OEB_Q1(), this.OEB_Q2(), this.OEB_Q3(), this.OEB_QC(), this.OEB_MAX(), this.OEB_INT(), this.OEB_MIN(), this.AREA_ALONG_OEB_MAX(), this.AREA_ALONG_OEB_INT(), this.AREA_ALONG_OEB_MIN(), this.AREA_UNITS(), this.DRAG_CONST_AREA(), this.DRAG_COEFF_NOM(), this.DRAG_UNCERTAINTY(), this.SRP_CONST_AREA(), this.SOLAR_RAD_COEFF(), this.SRP_UNCERTAINTY());
    }
    unpackTo(_o) {
...
export class PhysicalPropertiesT {
    constructor(COMMENT = [], WET_MASS = 0.0, DRY_MASS = 0.0, MASS_UNITS = null, OEB_Q1 = 0.0, OEB_Q2 = 0.0, OEB_Q3 = 0.0, OEB_QC = 0.0, OEB_MAX = 0.0, OEB_INT = 0.0, OEB_MIN = 0.0, AREA_ALONG_OEB_MAX = 0.0, AREA_ALONG_OEB_INT = 0.0, AREA_ALONG_OEB_MIN = 0.0, AREA_UNITS = null, DRAG_CONST_AREA = 0.0, DRAG_COEFF_NOM = 0.0, DRAG_UNCERTAINTY = 0.0, SRP_CONST_AREA = 0.0, SOLAR_RAD_COEFF = 0.0, SRP_UNCERTAINTY = 0.0) {
        ...
        this.OEB_Q3 = OEB_Q3;
        this.OEB_QC = OEB_QC;
        this.OEB_MAX = OEB_MAX;
        this.OEB_INT = OEB_INT;
        this.OEB_MIN = OEB_MIN;
        this.AREA_ALONG_OEB_MAX = AREA_ALONG_OEB_MAX;
        this.AREA_ALONG_OEB_INT = AREA_ALONG_OEB_INT;
        this.AREA_ALONG_OEB_MIN = AREA_ALONG_OEB_MIN;
        this.AREA_UNITS = AREA_UNITS;
        this.DRAG_CONST_AREA = DRAG_CONST_AREA;
        this.DRAG_COEFF_NOM = DRAG_COEFF_NOM;
        this.DRAG_UNCERTAINTY = DRAG_UNCERTAINTY;
        this.SRP_CONST_AREA = SRP_CONST_AREA;
        this.SOLAR_RAD_COEFF = SOLAR_RAD_COEFF;
        this.SRP_UNCERTAINTY = SRP_UNCERTAINTY;
    }
    pack(builder) {
        ...
        return PhysicalProperties.createPhysicalProperties(builder, COMMENT, this.WET_MASS, this.DRY_MASS, MASS_UNITS, this.OEB_Q1, this.OEB_Q2, this.OEB_Q3, this.OEB_QC, this.OEB_MAX, this.OEB_INT, this.OEB_MIN, this.AREA_ALONG_OEB_MAX, this.AREA_ALONG_OEB_INT, this.AREA_ALONG_OEB_MIN, AREA_UNITS, this.DRAG_CONST_AREA, this.DRAG_COEFF_NOM, this.DRAG_UNCERTAINTY, this.SRP_CONST_AREA, this.SOLAR_RAD_COEFF, this.SRP_UNCERTAINTY);
    }
}
