...
export class CDM {
    ...
    static addScreenVolumeFrame(builder, SCREEN_VOLUME_FRAMEOffset) {
    ...
    static addObject1Datasource(builder, OBJECT1_DATASOURCEOffset) {
        builder.addFieldOffset(27, OBJECT1_DATASOURCEOffset, 0);
    }
    static addObject2Datasource(builder, OBJECT2_DATASOURCEOffset) {
    ...
    unpack() {
        return new CDMT(this.CCSDS_CDM_VERS(), this.CREATION_DATE(), this.ORIGINATOR(), this.MESSAGE_FOR(), this.MESSAGE_ID(), this.TCA(), this.MISS_DISTANCE(), this.RELATIVE_SPEED(), this.RELATIVE_POSITION_R(), this.RELATIVE_POSITION_T(), this.RELATIVE_POSITION_N(), this.RELATIVE_VELOCITY_R(), this.RELATIVE_VELOCITY_T(), this.RELATIVE_VELOCITY_N(), this.START_SCREEN_PERIOD(), this.STOP_SCREEN_PERIOD(), (this.SCREEN_VOLUME_FRAME() !== null ? this.SCREEN_VOLUME_FRAME().unpack() : null), this.SCREEN_VOLUME_SHAPE(), this.SCREEN_VOLUME_X(), this.SCREEN_VOLUME_Y(), this.SCREEN_VOLUME_Z(), this.SCREEN_ENTRY_TIME(), this.SCREEN_EXIT_TIME(), this.COLLISION_PROBABILITY(), this.COLLISION_PROBABILITY_METHOD(), (this.OBJECT1() !== null ? this.OBJECT1().unpack() : null), (this.OBJECT2() !== null ? this.OBJECT2().unpack() : null), (this.OBJECT1_DATASOURCE() !== null ? this.OBJECT1_DATASOURCE().unpack() : null), (this.OBJECT2_DATASOURCE() !== null ? this.OBJECT2_DATASOURCE().unpack() : null));
    }
    unpackTo(_o) {
...
export class CDMT {
    constructor(CCSDS_CDM_VERS = 0.0, CREATION_DATE = null, ORIGINATOR = null, MESSAGE_FOR = null, MESSAGE_ID = null, TCA = null, MISS_DISTANCE = 0.0, RELATIVE_SPEED = 0.0, RELATIVE_POSITION_R = 0.0, RELATIVE_POSITION_T = 0.0, RELATIVE_POSITION_N = 0.0, RELATIVE_VELOCITY_R = 0.0, RELATIVE_VELOCITY_T = 0.0, RELATIVE_VELOCITY_N = 0.0, START_SCREEN_PERIOD = null, STOP_SCREEN_PERIOD = null, SCREEN_VOLUME_FRAME = null, SCREEN_VOLUME_SHAPE = screeningVolumeShape.ELLIPSOID, SCREEN_VOLUME_X = 0.0, SCREEN_VOLUME_Y = 0.0, SCREEN_VOLUME_Z = 0.0, SCREEN_ENTRY_TIME = null, SCREEN_EXIT_TIME = null, COLLISION_PROBABILITY = 0.0, COLLISION_PROBABILITY_METHOD = null, OBJECT1 = null, OBJECT2 = null, OBJECT1_DATASOURCE = null, OBJECT2_DATASOURCE = null) {
        ...
        this.OBJECT1_DATASOURCE = OBJECT1_DATASOURCE;
        this.OBJECT2_DATASOURCE = OBJECT2_DATASOURCE;
    }
    pack(builder) {
