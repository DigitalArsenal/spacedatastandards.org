...
export class PLGT {
    ...
    pack(builder) {
        ...
        return PLG.createPLG(builder, PLUGIN_ID, NAME, VERSION, DESCRIPTION, TAGLINE, this.PLUGIN_TYPE, PUBLISHER_NAME, PUBLISHER_HANDLE, PUBLISHER_URL, SUPPORT_URL, TAGS, FEATURES, SCREENSHOT_URLS, BANNER_URL, this.ABI_VERSION, WASM_HASH, this.WASM_SIZE, WASM_CID, ENCRYPTED_WASM_HASH, this.ENCRYPTED_WASM_SIZE, ENTRY_FUNCTIONS, REQUIRED_SCHEMAS, DEPENDENCIES, CAPABILITIES, PROVIDER_PEER_ID, PROVIDER_EPM_CID, this.ENCRYPTED, REQUIRED_SCOPE, KEY_ID, this.MAX_GRANT_TIMEOUT_MS, MIN_PERMISSIONS, this.CREATED_AT, this.UPDATED_AT, DOCUMENTATION_URL, CHANGELOG_URL, ICON_URL, LICENSE, this.PAYMENT_MODEL, this.PRICE_USD_CENTS, this.SUBSCRIPTION_PERIOD_DAYS, ACCEPTED_PAYMENT_METHODS, this.LISTING_STATUS, SIGNATURE, INVOKE_SURFACES, METHODS, HOST_CAPABILITIES, TIMERS, PROTOCOLS, SCHEMAS_USED, BUILD_ARTIFACTS, RUNTIME_TARGETS, ALLOWED_XPUBS, FLOW_NODES, FLOW_EDGES, FLOW_TRIGGERS, FLOW_TRIGGER_BINDINGS, this.PRIMARY_CATEGORY, CATEGORIES);
    }
}
