...
export class covarianceMatrixLine {
    ...
    static createcovarianceMatrixLine(builder, EPOCHOffset, CX_X, CY_X, CY_Y, CZ_X, CZ_Y, CZ_Z, CX_DOT_X, CX_DOT_Y, CX_DOT_Z, CX_DOT_X_DOT, CY_DOT_X, CY_DOT_Y, CY_DOT_Z, CY_DOT_X_DOT, CY_DOT_Y_DOT, CZ_DOT_X, CZ_DOT_Y, CZ_DOT_Z, CZ_DOT_X_DOT, CZ_DOT_Y_DOT, CZ_DOT_Z_DOT) {
...
export class covarianceMatrixLineT {
    constructor(EPOCH = null, CX_X = 0.0, CY_X = 0.0, CY_Y = 0.0, CZ_X = 0.0, CZ_Y = 0.0, CZ_Z = 0.0, CX_DOT_X = 0.0, CX_DOT_Y = 0.0, CX_DOT_Z = 0.0, CX_DOT_X_DOT = 0.0, CY_DOT_X = 0.0, CY_DOT_Y = 0.0, CY_DOT_Z = 0.0, CY_DOT_X_DOT = 0.0, CY_DOT_Y_DOT = 0.0, CZ_DOT_X = 0.0, CZ_DOT_Y = 0.0, CZ_DOT_Z = 0.0, CZ_DOT_X_DOT = 0.0, CZ_DOT_Y_DOT = 0.0, CZ_DOT_Z_DOT = 0.0) {
        this.EPOCH = EPOCH;
        this.CX_X = CX_X;
        this.CY_X = CY_X;
        this.CY_Y = CY_Y;
    ...
    pack(builder) {
        ...
        return covarianceMatrixLine.createcovarianceMatrixLine(builder, EPOCH, this.CX_X, this.CY_X, this.CY_Y, this.CZ_X, this.CZ_Y, this.CZ_Z, this.CX_DOT_X, this.CX_DOT_Y, this.CX_DOT_Z, this.CX_DOT_X_DOT, this.CY_DOT_X, this.CY_DOT_Y, this.CY_DOT_Z, this.CY_DOT_X_DOT, this.CY_DOT_Y_DOT, this.CZ_DOT_X, this.CZ_DOT_Y, this.CZ_DOT_Z, this.CZ_DOT_X_DOT, this.CZ_DOT_Y_DOT, this.CZ_DOT_Z_DOT);
    }
}
