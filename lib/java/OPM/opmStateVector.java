...
public final class opmStateVector extends Table {
  ...
  public static opmStateVector getRootAsopmStateVector(ByteBuffer _bb, opmStateVector obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  ...
  public static int createopmStateVector(FlatBufferBuilder builder,
      int EPOCHOffset,
      double X,
      double Y,
      double Z,
  ...
  public static int endopmStateVector(FlatBufferBuilder builder) {
  ...
  public static final class Vector extends BaseVector {
    ...
    public opmStateVector get(int j) { return get(new opmStateVector(), j); }
    public opmStateVector get(opmStateVector obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
