...
public final class UPMCOLLECTION extends Table {
  ...
  public static UPMCOLLECTION getRootAsUPMCOLLECTION(ByteBuffer _bb, UPMCOLLECTION obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __reset(_i, _bb); }
  public UPMCOLLECTION __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }

  public UPM RECORDS(int j) { return RECORDS(new UPM(), j); }
  public UPM RECORDS(UPM obj, int j) { int o = __offset(4); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int RECORDSLength() { int o = __offset(4); return o != 0 ? __vector_len(o) : 0; }
  public UPM.Vector recordsVector() { return recordsVector(new UPM.Vector()); }
  public UPM.Vector recordsVector(UPM.Vector obj) { int o = __offset(4); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }

  public static int createUPMCOLLECTION(FlatBufferBuilder builder,
      int RECORDSOffset) {
  ...
  public static int endUPMCOLLECTION(FlatBufferBuilder builder) {
  ...
  public static final class Vector extends BaseVector {
    ...
    public UPMCOLLECTION get(int j) { return get(new UPMCOLLECTION(), j); }
    public UPMCOLLECTION get(UPMCOLLECTION obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
