...
public final class CRMCOLLECTION extends Table {
  ...
  public CRM RECORDS(int j) { return RECORDS(new CRM(), j); }
  public CRM RECORDS(CRM obj, int j) { int o = __offset(4); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int RECORDSLength() { int o = __offset(4); return o != 0 ? __vector_len(o) : 0; }
  public CRM.Vector recordsVector() { return recordsVector(new CRM.Vector()); }
  public CRM.Vector recordsVector(CRM.Vector obj) { int o = __offset(4); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }

  public static int createCRMCOLLECTION(FlatBufferBuilder builder,
      int RECORDSOffset) {
  ...
  public static int endCRMCOLLECTION(FlatBufferBuilder builder) {
  ...
  public static final class Vector extends BaseVector {
    ...
    public CRMCOLLECTION get(int j) { return get(new CRMCOLLECTION(), j); }
    public CRMCOLLECTION get(CRMCOLLECTION obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
