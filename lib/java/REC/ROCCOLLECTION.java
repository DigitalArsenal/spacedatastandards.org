...
public final class ROCCOLLECTION extends Table {
  ...
  public ROC RECORDS(int j) { return RECORDS(new ROC(), j); }
  public ROC RECORDS(ROC obj, int j) { int o = __offset(4); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int RECORDSLength() { int o = __offset(4); return o != 0 ? __vector_len(o) : 0; }
  public ROC.Vector recordsVector() { return recordsVector(new ROC.Vector()); }
  public ROC.Vector recordsVector(ROC.Vector obj) { int o = __offset(4); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }

  public static int createROCCOLLECTION(FlatBufferBuilder builder,
      int RECORDSOffset) {
  ...
  public static int endROCCOLLECTION(FlatBufferBuilder builder) {
  ...
  public static final class Vector extends BaseVector {
    ...
    public ROCCOLLECTION get(int j) { return get(new ROCCOLLECTION(), j); }
    public ROCCOLLECTION get(ROCCOLLECTION obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
