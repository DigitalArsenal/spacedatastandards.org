...
public final class opmAtmosphericModelData extends Table {
  ...
  public static opmAtmosphericModelData getRootAsopmAtmosphericModelData(ByteBuffer _bb, opmAtmosphericModelData obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  ...
  public static int createopmAtmosphericModelData(FlatBufferBuilder builder,
  ...
  public static int endopmAtmosphericModelData(FlatBufferBuilder builder) {
  ...
  public static final class Vector extends BaseVector {
    ...
    public opmAtmosphericModelData get(int j) { return get(new opmAtmosphericModelData(), j); }
    public opmAtmosphericModelData get(opmAtmosphericModelData obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
