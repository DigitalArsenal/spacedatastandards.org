...
public final class OPM extends Table {
  ...
  public opmStateVector STATE_VECTOR() { return STATE_VECTOR(new opmStateVector()); }
  public opmStateVector STATE_VECTOR(opmStateVector obj) { int o = __offset(20); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  ...
  public opmAtmosphericModelData ATMOSPHERIC_MODEL_DATA() { return ATMOSPHERIC_MODEL_DATA(new opmAtmosphericModelData()); }
  public opmAtmosphericModelData ATMOSPHERIC_MODEL_DATA(opmAtmosphericModelData obj) { int o = __offset(28); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  ...
  public opmCovarianceMatrixLine COVARIANCE_MATRIX(int j) { return COVARIANCE_MATRIX(new opmCovarianceMatrixLine(), j); }
  public opmCovarianceMatrixLine COVARIANCE_MATRIX(opmCovarianceMatrixLine obj, int j) { int o = __offset(32); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int COVARIANCE_MATRIXLength() { int o = __offset(32); return o != 0 ? __vector_len(o) : 0; }
  public opmCovarianceMatrixLine.Vector covarianceMatrixVector() { return covarianceMatrixVector(new opmCovarianceMatrixLine.Vector()); }
  public opmCovarianceMatrixLine.Vector covarianceMatrixVector(opmCovarianceMatrixLine.Vector obj) { int o = __offset(32); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  ...
  public static int createOPM(FlatBufferBuilder builder,
    ...
    OPM.addUserDefinedMicroseconds(builder, USER_DEFINED_MICROSECONDS);
    ...
    OPM.addMeanMotionDdot(builder, MEAN_MOTION_DDOT);
    OPM.addMeanMotionDot(builder, MEAN_MOTION_DOT);
    OPM.addBstar(builder, BSTAR);
    OPM.addRevAtEpoch(builder, REV_AT_EPOCH);
    ...
    OPM.addCcsdsOmmVers(builder, CCSDS_OMM_VERS);
    ...
    OPM.addCovReferenceFrame(builder, COV_REFERENCE_FRAMEOffset);
    OPM.addElementSetNo(builder, ELEMENT_SET_NO);
    OPM.addNoradCatId(builder, NORAD_CAT_ID);
    OPM.addClassificationType(builder, CLASSIFICATION_TYPEOffset);
    OPM.addUvwSigmas(builder, UVW_SIGMASOffset);
    OPM.addCovarianceMatrix(builder, COVARIANCE_MATRIXOffset);
    OPM.addPropagatorSettings(builder, PROPAGATOR_SETTINGSOffset);
    OPM.addAtmosphericModelData(builder, ATMOSPHERIC_MODEL_DATAOffset);
    OPM.addEquinoctialElements(builder, EQUINOCTIAL_ELEMENTSOffset);
    OPM.addKeplerianElements(builder, KEPLERIAN_ELEMENTSOffset);
    OPM.addStateVector(builder, STATE_VECTOROffset);
  ...
  public static void finishOPMBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset); }
  public static void finishSizePrefixedOPMBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset); }
