...
public final class ndsPublisherRung {
  private ndsPublisherRung() { }
  /**
   * Only a source tag string is known; nothing has been verified.
   */
  public static final byte SourceTag = 0;
  /**
   * The producer's signed identity record verifies in this node's directory.
   */
  public static final byte Signed = 1;
  /**
   * The producer additionally carries a verified domain proof.
   */
  public static final byte Bonded = 2;

  public static final String[] names = { "SourceTag", "Signed", "Bonded", };
