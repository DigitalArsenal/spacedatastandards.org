...
public final class VCMCovarianceMatrixLine extends Table {
  ...
  public static VCMCovarianceMatrixLine getRootAsVCMCovarianceMatrixLine(ByteBuffer _bb, VCMCovarianceMatrixLine obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  ...
  public static int createVCMCovarianceMatrixLine(FlatBufferBuilder builder,
      double CX_X,
      double CY_X,
      double CZ_X,
      double CX_DOT_X) {
  ...
  public static int endVCMCovarianceMatrixLine(FlatBufferBuilder builder) {
  ...
  public static final class Vector extends BaseVector {
    ...
    public VCMCovarianceMatrixLine get(int j) { return get(new VCMCovarianceMatrixLine(), j); }
    public VCMCovarianceMatrixLine get(VCMCovarianceMatrixLine obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
