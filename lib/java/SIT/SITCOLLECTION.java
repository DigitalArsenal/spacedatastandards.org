...
public final class SITCOLLECTION extends Table {
  ...
  public SIT RECORDS(int j) { return RECORDS(new SIT(), j); }
  public SIT RECORDS(SIT obj, int j) { int o = __offset(4); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int RECORDSLength() { int o = __offset(4); return o != 0 ? __vector_len(o) : 0; }
  public SIT.Vector recordsVector() { return recordsVector(new SIT.Vector()); }
  public SIT.Vector recordsVector(SIT.Vector obj) { int o = __offset(4); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }

  public static int createSITCOLLECTION(FlatBufferBuilder builder,
      int RECORDSOffset) {
  ...
  public static int endSITCOLLECTION(FlatBufferBuilder builder) {
  ...
  public static final class Vector extends BaseVector {
    ...
    public SITCOLLECTION get(int j) { return get(new SITCOLLECTION(), j); }
    public SITCOLLECTION get(SITCOLLECTION obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
