...
public final class bpfPartKind {
  private bpfPartKind() { }
  /**
   ...
   */
  public static final byte ENGINE_BINARY = 1;
  /**
   * Embedded imagery data.
   */
  public static final byte IMAGERY_DATA = 2;
  /**
   * Embedded endpoint/locator data.
   */
  public static final byte URL_DATA = 3;
  /**
   * Embedded end-user documentation.
   */
  public static final byte DOCUMENTATION = 4;
  /**
   * The cross-origin-isolation loader pair required for shared-memory
   * execution in a browsing context.
   */
  public static final byte ISOLATION_LOADER = 5;
  /**
   * Debug source maps.
   */
  public static final byte SOURCE_MAPS = 6;
  /**
   * A module payload embedded in the artifact.
   */
  public static final byte MODULE = 7;
  /**
   * A part outside every class above.
   */
  public static final byte OTHER = 8;

  public static final String[] names = { "UNSPECIFIED", "ENGINE_BINARY", "IMAGERY_DATA", "URL_DATA", "DOCUMENTATION", "ISOLATION_LOADER", "SOURCE_MAPS", "MODULE", "OTHER", };
