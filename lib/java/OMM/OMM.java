...
public final class OMM extends Table {
   ...
   * REF_FRAME_EPOCH
   */
  public String REF_FRAME_EPOCH() { int o = __offset(18); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer REF_FRAME_EPOCHAsByteBuffer() { return __vector_as_bytebuffer(18, 1); }
  public ByteBuffer REF_FRAME_EPOCHInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 18, 1); }
  /**
   ...
   */
  public byte COV_REF_FRAME() { int o = __offset(70); return o != 0 ? bb.get(o + bb_pos) : 0; }
  /**
  ...
  public static void addCovRefFrame(FlatBufferBuilder builder, byte COV_REF_FRAME) { builder.addByte(33, COV_REF_FRAME, 0); }
