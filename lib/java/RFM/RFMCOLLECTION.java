...
public final class RFMCOLLECTION extends Table {
  ...
  public static RFMCOLLECTION getRootAsRFMCOLLECTION(ByteBuffer _bb, RFMCOLLECTION obj) { _bb.order(ByteOrder.LITTLE_ENDIAN); return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __reset(_i, _bb); }
  public RFMCOLLECTION __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }

  public RFM RECORDS(int j) { return RECORDS(new RFM(), j); }
  public RFM RECORDS(RFM obj, int j) { int o = __offset(4); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int RECORDSLength() { int o = __offset(4); return o != 0 ? __vector_len(o) : 0; }
  public RFM.Vector recordsVector() { return recordsVector(new RFM.Vector()); }
  public RFM.Vector recordsVector(RFM.Vector obj) { int o = __offset(4); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }

  public static int createRFMCOLLECTION(FlatBufferBuilder builder,
      int RECORDSOffset) {
  ...
  public static int endRFMCOLLECTION(FlatBufferBuilder builder) {
  ...
  public static final class Vector extends BaseVector {
    ...
    public RFMCOLLECTION get(int j) { return get(new RFMCOLLECTION(), j); }
    public RFMCOLLECTION get(RFMCOLLECTION obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
