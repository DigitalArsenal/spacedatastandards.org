...
public final class MPECOLLECTION extends Table {
  ...
  public static boolean MPECOLLECTIONBufferHasIdentifier(ByteBuffer _bb) { return __has_identifier(_bb, "$MPE"); }
  ...
  public static void finishMPECOLLECTIONBuffer(FlatBufferBuilder builder, int offset) { builder.finish(offset, "$MPE"); }
  public static void finishSizePrefixedMPECOLLECTIONBuffer(FlatBufferBuilder builder, int offset) { builder.finishSizePrefixed(offset, "$MPE"); }
