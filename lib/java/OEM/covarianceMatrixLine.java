...
public final class covarianceMatrixLine extends Table {
   ...
   */
  public byte COV_REF_FRAME() { int o = __offset(6); return o != 0 ? bb.get(o + bb_pos) : 0; }
  /**
  ...
  public static void addCovRefFrame(FlatBufferBuilder builder, byte COV_REF_FRAME) { builder.addByte(1, COV_REF_FRAME, 0); }
