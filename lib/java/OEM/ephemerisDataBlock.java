...
public final class ephemerisDataBlock extends Table {
   ...
   */
  public byte REF_FRAME() { int o = __offset(12); return o != 0 ? bb.get(o + bb_pos) : 0; }
  /**
   * Epoch of reference frame, if not intrinsic to the definition of the reference frame
   */
  public String REF_FRAME_EPOCH() { int o = __offset(14); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer REF_FRAME_EPOCHAsByteBuffer() { return __vector_as_bytebuffer(14, 1); }
  public ByteBuffer REF_FRAME_EPOCHInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 14, 1); }
  /**
  ...
  public static void addRefFrame(FlatBufferBuilder builder, byte REF_FRAME) { builder.addByte(4, REF_FRAME, 0); }
  public static void addRefFrameEpoch(FlatBufferBuilder builder, int REF_FRAME_EPOCHOffset) { builder.addOffset(5, REF_FRAME_EPOCHOffset, 0); }
