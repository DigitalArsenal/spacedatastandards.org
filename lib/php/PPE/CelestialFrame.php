...
class CelestialFrame
{
    ...
    private static $names = array(
        CelestialFrame::GCRF=>"GCRF",
        CelestialFrame::ICRF=>"ICRF",
        CelestialFrame::J2000=>"J2000",
        CelestialFrame::J2000A=>"J2000A",
        CelestialFrame::EME2000=>"EME2000",
        CelestialFrame::TEMEOFDATE=>"TEMEOFDATE",
        CelestialFrame::GTOD=>"GTOD",
        CelestialFrame::CIRS=>"CIRS",
        CelestialFrame::MOD_EARTH=>"MOD_EARTH",
        CelestialFrame::MOD_CB=>"MOD_CB",
        CelestialFrame::MOD_MOON=>"MOD_MOON",
        CelestialFrame::TOD_EARTH=>"TOD_EARTH",
        CelestialFrame::TOD_CB=>"TOD_CB",
        CelestialFrame::TOD_MOON=>"TOD_MOON",
        CelestialFrame::TOE_EARTH=>"TOE_EARTH",
        CelestialFrame::TOE_CB=>"TOE_CB",
        CelestialFrame::TOE_MOON=>"TOE_MOON",
        CelestialFrame::ITRF2000=>"ITRF2000",
        CelestialFrame::ITRF93=>"ITRF93",
        CelestialFrame::ITRF97=>"ITRF97",
        CelestialFrame::EFG=>"EFG",
        CelestialFrame::FIXED_CB=>"FIXED_CB",
        CelestialFrame::FIXED_EARTH=>"FIXED_EARTH",
        CelestialFrame::WGS84=>"WGS84",
        CelestialFrame::DTRFYYYY=>"DTRFYYYY",
        CelestialFrame::ALIGN_EARTH=>"ALIGN_EARTH",
        CelestialFrame::ALIGN_CB=>"ALIGN_CB",
        CelestialFrame::B1950=>"B1950",
    );
