...
class tbsMergeMethod
{
    ...
    private static $names = array(
        tbsMergeMethod::SINGLE_SOURCE=>"SINGLE_SOURCE",
        tbsMergeMethod::HIGHEST_SAMPLE_COUNT=>"HIGHEST_SAMPLE_COUNT",
        tbsMergeMethod::MOST_RECENT=>"MOST_RECENT",
        tbsMergeMethod::AUTHORITY_PRECEDENCE=>"AUTHORITY_PRECEDENCE",
        tbsMergeMethod::CENTROID=>"CENTROID",
        tbsMergeMethod::UNSPECIFIED=>"UNSPECIFIED",
    );
