...
/// Schema Manifest
class SCHEMA_MANIFEST extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return SCHEMA_MANIFEST
     */
    public static function getRootAsSCHEMA_MANIFEST(ByteBuffer $bb)
    {
        $obj = new SCHEMA_MANIFEST();
    ...
    {
        return self::__has_identifier($buf, self::SCHEMA_MANIFESTIdentifier());
    }
     ...
     * @return void
     */
    public static function startSCHEMA_MANIFEST(FlatBufferBuilder $builder)
    {
     ...
     * @return SCHEMA_MANIFEST
     */
    public static function createSCHEMA_MANIFEST(FlatBufferBuilder $builder, $version, $RECORDS)
    {
        $builder->startObject(2);
     ...
     */
    public static function endSCHEMA_MANIFEST(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }
