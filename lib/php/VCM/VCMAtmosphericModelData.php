...
class VCMAtmosphericModelData extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return VCMAtmosphericModelData
     */
    public static function getRootAsVCMAtmosphericModelData(ByteBuffer $bb)
    {
     ...
     * @return void
     */
    public static function startVCMAtmosphericModelData(FlatBufferBuilder $builder)
    {
     ...
     * @return VCMAtmosphericModelData
     */
    public static function createVCMAtmosphericModelData(FlatBufferBuilder $builder, $ATMOSPHERIC_MODEL, $GEOPOTENTIAL_MODEL, $LUNAR_SOLAR_PERTURBATION, $LUNAR_PERTURBATION_MODEL, $SOLAR_PERTURBATION_MODEL, $SOLAR_RADIATION_PRESSURE, $SRP_MODEL, $RESONANCE_MODEL)
    {
        $builder->startObject(8);
     ...
     */
    public static function endVCMAtmosphericModelData(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }
