...
class VCMCovarianceMatrixLine extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return VCMCovarianceMatrixLine
     */
    public static function getRootAsVCMCovarianceMatrixLine(ByteBuffer $bb)
    {
     ...
     * @return void
     */
    public static function startVCMCovarianceMatrixLine(FlatBufferBuilder $builder)
    {
     ...
     * @return VCMCovarianceMatrixLine
     */
    public static function createVCMCovarianceMatrixLine(FlatBufferBuilder $builder, $CX_X, $CY_X, $CZ_X, $CX_DOT_X)
    {
        $builder->startObject(4);
     ...
     */
    public static function endVCMCovarianceMatrixLine(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }
