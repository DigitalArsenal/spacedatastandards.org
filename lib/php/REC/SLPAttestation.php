...
class SLPAttestation extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return SLPAttestation
     */
    public static function getRootAsSLPAttestation(ByteBuffer $bb)
    {
        $obj = new SLPAttestation();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function SLPAttestationIdentifier()
    {
        return "$SLP";
    }

    public static function SLPAttestationBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::SLPAttestationIdentifier());
    }
     ...
     * @return void
     */
    public static function startSLPAttestation(FlatBufferBuilder $builder)
    {
     ...
     * @return SLPAttestation
     */
    public static function createSLPAttestation(FlatBufferBuilder $builder, $SIGNING_PUBLIC_KEY, $SIGNED_AT, $SIGNATURE, $CANONICAL_JSON_SIGNATURE)
    {
        $builder->startObject(4);
     ...
     */
    public static function endSLPAttestation(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        $builder->required($o, 4);  // SIGNING_PUBLIC_KEY
        $builder->required($o, 8);  // SIGNATURE
