...
/// Schema Manifest
class SCM extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return SCM
     */
    public static function getRootAsSCM(ByteBuffer $bb)
    {
        $obj = new SCM();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function SCMIdentifier()
    {
        return "$SCM";
    }

    public static function SCMBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::SCMIdentifier());
    }
     ...
     */
    public static function endSCM(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishSCMBuffer(FlatBufferBuilder $builder, $offset)
    {
