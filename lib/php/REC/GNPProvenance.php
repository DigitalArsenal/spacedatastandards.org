...
class GNPProvenance extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return GNPProvenance
     */
    public static function getRootAsGNPProvenance(ByteBuffer $bb)
    {
        $obj = new GNPProvenance();
        return ($obj->init($bb->getInt($bb->getPosition()) + $bb->getPosition(), $bb));
    }

    public static function GNPProvenanceIdentifier()
    {
        return "$GNP";
    }

    public static function GNPProvenanceBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::GNPProvenanceIdentifier());
    }
     ...
     * @return void
     */
    public static function startGNPProvenance(FlatBufferBuilder $builder)
    {
     ...
     * @return GNPProvenance
     */
    public static function createGNPProvenance(FlatBufferBuilder $builder, $DATASET_ID, $DATASET_NAME, $DATASET_URL, $DATASET_EPOCH, $DATASET_CID, $SOURCE_URL, $SOURCE_QUERY, $RETRIEVED_AT, $LICENSE, $LICENSE_URL, $ATTRIBUTION, $NON_COMMERCIAL_ONLY, $SHARE_ALIKE, $NATIVE_ID, $NATIVE_MODIFIED)
    {
        $builder->startObject(15);
     ...
     */
    public static function endGNPProvenance(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        $builder->required($o, 4);  // DATASET_ID
        $builder->required($o, 10);  // DATASET_EPOCH
