...
class REC extends Table
{
    /**
     * @param ByteBuffer $bb
     * @return REC
     */
    public static function getRootAsREC(ByteBuffer $bb)
    {
        $obj = new REC();
    ...
    public static function RECBufferHasIdentifier(ByteBuffer $buf)
    {
        return self::__has_identifier($buf, self::RECIdentifier());
    }
     ...
     */
    public static function endREC(FlatBufferBuilder $builder)
    {
        $o = $builder->endObject();
        return $o;
    }

    public static function finishRECBuffer(FlatBufferBuilder $builder, $offset)
    {
