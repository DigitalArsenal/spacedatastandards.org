...
class ephemerisDataBlock extends Table
{
     ...
     * @return ephemerisDataBlock
     */
    public static function createephemerisDataBlock(FlatBufferBuilder $builder, $COMMENT, $OBJECT_NAME, $OBJECT_ID, $CENTER_NAME, $REF_FRAME, $REF_FRAME_EPOCH, $TIME_SYSTEM, $START_TIME, $USEABLE_START_TIME, $USEABLE_STOP_TIME, $STOP_TIME, $INTERPOLATION, $INTERPOLATION_DEGREE, $EPHEMERIS_DATA_LINES, $COVARIANCE_MATRIX_LINES)
    {
        $builder->startObject(15);
    ...
    {
        $builder->addSbyteX(4, $REF_FRAME, 0);
    }
    ...
    {
        $builder->addOffsetX(5, $REF_FRAME_EPOCH, 0);
    }
