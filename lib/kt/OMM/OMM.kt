...
class OMM : Table() {
    ...
    val REF_FRAME_EPOCHAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(18, 1)
    fun REF_FRAME_EPOCHInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 18, 1)
    /**
    ...
    companion object {
        ...
        fun addCOV_REF_FRAME(builder: FlatBufferBuilder, COV_REF_FRAME: Byte) = builder.addByte(33, COV_REF_FRAME, 0)
