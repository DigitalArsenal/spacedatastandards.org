...
class HYPCOLLECTION : Table() {
    ...
    fun __assign(_i: Int, _bb: ByteBuffer) : HYPCOLLECTION {
        __init(_i, _bb)
        return this
    }
    fun RECORDS(j: Int) : HYP? = RECORDS(HYP(), j)
    fun RECORDS(obj: HYP, j: Int) : HYP? {
        val o = __offset(4)
        return if (o != 0) {
    ...
    companion object {
        ...
        fun createHYPCOLLECTION(builder: FlatBufferBuilder, RECORDSOffset: Int) : Int {
            ...
            return endHYPCOLLECTION(builder)
        }
        fun startHYPCOLLECTION(builder: FlatBufferBuilder) = builder.startTable(1)
        ...
        fun endHYPCOLLECTION(builder: FlatBufferBuilder) : Int {
