...
class RFMCOLLECTION : Table() {
    ...
    fun __assign(_i: Int, _bb: ByteBuffer) : RFMCOLLECTION {
        __init(_i, _bb)
        return this
    }
    fun RECORDS(j: Int) : RFM? = RECORDS(RFM(), j)
    fun RECORDS(obj: RFM, j: Int) : RFM? {
        val o = __offset(4)
        return if (o != 0) {
    ...
    companion object {
        ...
        fun createRFMCOLLECTION(builder: FlatBufferBuilder, RECORDSOffset: Int) : Int {
            builder.startTable(1)
            addRECORDS(builder, RECORDSOffset)
            return endRFMCOLLECTION(builder)
        }
        fun startRFMCOLLECTION(builder: FlatBufferBuilder) = builder.startTable(1)
        ...
        fun endRFMCOLLECTION(builder: FlatBufferBuilder) : Int {
