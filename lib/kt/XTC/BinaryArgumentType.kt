...
class BinaryArgumentType : Table() {
    ...
    companion object {
        ...
        fun createBinaryArgumentType(builder: FlatBufferBuilder, nameOffset: Int, shortDescriptionOffset: Int, longDescriptionOffset: Int, dataEncodingOffset: Int, initialValueOffset: Int) : Int {
