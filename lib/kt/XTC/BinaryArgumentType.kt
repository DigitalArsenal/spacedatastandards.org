 ...
 */
@Suppress("unused")
class BinaryArgumentType : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : BinaryArgumentType {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsBinaryArgumentType(_bb: ByteBuffer): BinaryArgumentType = getRootAsBinaryArgumentType(_bb, BinaryArgumentType())
        fun getRootAsBinaryArgumentType(_bb: ByteBuffer, obj: BinaryArgumentType): BinaryArgumentType {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun createBinaryArgumentType(builder: FlatBufferBuilder, NAMEOffset: Int, SHORT_DESCRIPTIONOffset: Int, LONG_DESCRIPTIONOffset: Int, DATA_ENCODINGOffset: Int, INITIAL_VALUEOffset: Int) : Int {
            ...
            return endBinaryArgumentType(builder)
        }
        fun startBinaryArgumentType(builder: FlatBufferBuilder) = builder.startTable(5)
        ...
        fun endBinaryArgumentType(builder: FlatBufferBuilder) : Int {
