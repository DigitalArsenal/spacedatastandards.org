...
class FloatParameterType : Table() {
    ...
    companion object {
        ...
        fun createFloatParameterType(builder: FlatBufferBuilder, nameOffset: Int, shortDescriptionOffset: Int, longDescriptionOffset: Int, unitsOffset: Int, dataEncodingOffset: Int, defaultAlarmOffset: Int, contextAlarmsOffset: Int, validMin: Double, validMax: Double, sizeInBits: UShort, initialValue: Double) : Int {
        ...
        fun addVALIDMIN(builder: FlatBufferBuilder, validMin: Double) = builder.addDouble(7, validMin, 0.0)
        fun addVALIDMAX(builder: FlatBufferBuilder, validMax: Double) = builder.addDouble(8, validMax, 0.0)
        fun addSIZEINBITS(builder: FlatBufferBuilder, sizeInBits: UShort) = builder.addShort(9, sizeInBits.toShort(), 0)
        fun addINITIALVALUE(builder: FlatBufferBuilder, initialValue: Double) = builder.addDouble(10, initialValue, 0.0)
