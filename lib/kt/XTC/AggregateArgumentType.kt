 ...
 */
@Suppress("unused")
class AggregateArgumentType : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : AggregateArgumentType {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun getRootAsAggregateArgumentType(_bb: ByteBuffer): AggregateArgumentType = getRootAsAggregateArgumentType(_bb, AggregateArgumentType())
        fun getRootAsAggregateArgumentType(_bb: ByteBuffer, obj: AggregateArgumentType): AggregateArgumentType {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun createAggregateArgumentType(builder: FlatBufferBuilder, NAMEOffset: Int, SHORT_DESCRIPTIONOffset: Int, LONG_DESCRIPTIONOffset: Int, MEMBERSOffset: Int) : Int {
            ...
            return endAggregateArgumentType(builder)
        }
        fun startAggregateArgumentType(builder: FlatBufferBuilder) = builder.startTable(4)
        ...
        fun endAggregateArgumentType(builder: FlatBufferBuilder) : Int {
