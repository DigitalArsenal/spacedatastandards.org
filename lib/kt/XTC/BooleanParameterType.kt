...
class BooleanParameterType : Table() {
    ...
    companion object {
        ...
        fun createBooleanParameterType(builder: FlatBufferBuilder, nameOffset: Int, shortDescriptionOffset: Int, longDescriptionOffset: Int, dataEncodingOffset: Int, oneStringValueOffset: Int, zeroStringValueOffset: Int, initialValue: Boolean) : Int {
