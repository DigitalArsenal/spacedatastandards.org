...
class KMLLookAt : Table() {
    ...
    companion object {
        ...
        fun createKMLLookAt(builder: FlatBufferBuilder, longitude: Double, latitude: Double, altitude: Double, heading: Double, tilt: Double, range: Double, altitudeMode: Byte) : Int {
