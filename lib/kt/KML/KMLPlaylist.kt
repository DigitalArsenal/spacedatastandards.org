 ...
 */
@Suppress("unused")
class KMLPlaylist : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : KMLPlaylist {
        __init(_i, _bb)
        return this
    }
    /**
    ...
    companion object {
        ...
        fun startPrimitivesVector(builder: FlatBufferBuilder, numElems: Int) = builder.startVector(4, numElems, 4)
        fun endKMLPlaylist(builder: FlatBufferBuilder) : Int {
