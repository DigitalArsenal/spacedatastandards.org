...
class RECCOLLECTION : Table() {
    ...
    fun __assign(_i: Int, _bb: ByteBuffer) : RECCOLLECTION {
        __init(_i, _bb)
        return this
    }
    fun RECORDS(j: Int) : REC? = RECORDS(REC(), j)
    fun RECORDS(obj: REC, j: Int) : REC? {
        val o = __offset(4)
        return if (o != 0) {
    ...
    companion object {
        ...
        fun createRECCOLLECTION(builder: FlatBufferBuilder, RECORDSOffset: Int) : Int {
            builder.startTable(1)
            addRECORDS(builder, RECORDSOffset)
            return endRECCOLLECTION(builder)
        }
        fun startRECCOLLECTION(builder: FlatBufferBuilder) = builder.startTable(1)
        ...
        fun endRECCOLLECTION(builder: FlatBufferBuilder) : Int {
