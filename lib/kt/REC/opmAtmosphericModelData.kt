 ...
 */
@Suppress("unused")
class opmAtmosphericModelData : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : opmAtmosphericModelData {
        __init(_i, _bb)
        return this
    }
    ...
    companion object {
        ...
        fun getRootAsopmAtmosphericModelData(_bb: ByteBuffer): opmAtmosphericModelData = getRootAsopmAtmosphericModelData(_bb, opmAtmosphericModelData())
        fun getRootAsopmAtmosphericModelData(_bb: ByteBuffer, obj: opmAtmosphericModelData): opmAtmosphericModelData {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun createopmAtmosphericModelData(builder: FlatBufferBuilder, ATMOSPHERIC_MODEL: Byte, GEOPOTENTIAL_MODEL: Byte, LUNAR_SOLAR_PERTURBATION: Byte, LUNAR_PERTURBATION_MODEL: Byte, SOLAR_PERTURBATION_MODEL: Byte, SOLAR_RADIATION_PRESSURE: Byte, SRP_MODEL: Byte, RESONANCE_MODEL: Byte) : Int {
            ...
            return endopmAtmosphericModelData(builder)
        }
        fun startopmAtmosphericModelData(builder: FlatBufferBuilder) = builder.startTable(8)
        ...
        fun endopmAtmosphericModelData(builder: FlatBufferBuilder) : Int {
