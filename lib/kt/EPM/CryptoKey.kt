...
class CryptoKey : Table() {
    ...
    companion object {
        ...
        fun createCryptoKey(builder: FlatBufferBuilder, PUBLIC_KEYOffset: Int, XPUBOffset: Int, PRIVATE_KEYOffset: Int, XPRIVOffset: Int) : Int {
        ...
        fun startCryptoKey(builder: FlatBufferBuilder) = builder.startTable(4)
