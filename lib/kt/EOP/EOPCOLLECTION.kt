...
class EOPCOLLECTION : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : EOPCOLLECTION {
        __init(_i, _bb)
        return this
    }
    fun RECORDS(j: Int) : EOP? = RECORDS(EOP(), j)
    fun RECORDS(obj: EOP, j: Int) : EOP? {
        val o = __offset(4)
        return if (o != 0) {
    ...
    companion object {
        ...
        fun getRootAsEOPCOLLECTION(_bb: ByteBuffer): EOPCOLLECTION = getRootAsEOPCOLLECTION(_bb, EOPCOLLECTION())
        fun getRootAsEOPCOLLECTION(_bb: ByteBuffer, obj: EOPCOLLECTION): EOPCOLLECTION {
        ...
        fun createEOPCOLLECTION(builder: FlatBufferBuilder, RECORDSOffset: Int) : Int {
            ...
            return endEOPCOLLECTION(builder)
        }
        fun startEOPCOLLECTION(builder: FlatBufferBuilder) = builder.startTable(1)
        ...
        fun endEOPCOLLECTION(builder: FlatBufferBuilder) : Int {
