...
class ephemerisDataBlock : Table() {
    ...
    val REF_FRAME_EPOCHAsByteBuffer : ByteBuffer get() = __vector_as_bytebuffer(14, 1)
    fun REF_FRAME_EPOCHInByteBuffer(_bb: ByteBuffer) : ByteBuffer = __vector_in_bytebuffer(_bb, 14, 1)
    /**
    ...
    companion object {
        ...
        fun createephemerisDataBlock(builder: FlatBufferBuilder, COMMENTOffset: Int, OBJECT_NAMEOffset: Int, OBJECT_IDOffset: Int, CENTER_NAMEOffset: Int, REF_FRAME: Byte, REF_FRAME_EPOCHOffset: Int, TIME_SYSTEM: Byte, START_TIMEOffset: Int, USEABLE_START_TIMEOffset: Int, USEABLE_STOP_TIMEOffset: Int, STOP_TIMEOffset: Int, INTERPOLATIONOffset: Int, INTERPOLATION_DEGREE: UInt, EPHEMERIS_DATA_LINESOffset: Int, COVARIANCE_MATRIX_LINESOffset: Int) : Int {
            ...
            addREF_FRAME_EPOCH(builder, REF_FRAME_EPOCHOffset)
        ...
        fun addREF_FRAME(builder: FlatBufferBuilder, REF_FRAME: Byte) = builder.addByte(4, REF_FRAME, 0)
        fun addREF_FRAME_EPOCH(builder: FlatBufferBuilder, REF_FRAME_EPOCH: Int) = builder.addOffset(5, REF_FRAME_EPOCH, 0)
