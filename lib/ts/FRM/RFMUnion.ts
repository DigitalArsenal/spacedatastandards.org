...
export function unionToRfmunion(
  type: RFMUnion,
  accessor: (obj:CelestialFrameWrapper|CustomFrameWrapper|OrbitFrameWrapper|RFMCoordinateSystemWrapper|SpacecraftFrameWrapper) => CelestialFrameWrapper|CustomFrameWrapper|OrbitFrameWrapper|RFMCoordinateSystemWrapper|SpacecraftFrameWrapper|null
): CelestialFrameWrapper|CustomFrameWrapper|OrbitFrameWrapper|RFMCoordinateSystemWrapper|SpacecraftFrameWrapper|null {
  switch(RFMUnion[type]) {
    ...
    case 'RFMCoordinateSystemWrapper': return accessor(new RFMCoordinateSystemWrapper())! as RFMCoordinateSystemWrapper;
    default: return null;
  }
}
...
export function unionListToRfmunion(
  type: RFMUnion,
  accessor: (index: number, obj:CelestialFrameWrapper|CustomFrameWrapper|OrbitFrameWrapper|RFMCoordinateSystemWrapper|SpacecraftFrameWrapper) => CelestialFrameWrapper|CustomFrameWrapper|OrbitFrameWrapper|RFMCoordinateSystemWrapper|SpacecraftFrameWrapper|null,
  index: number
): CelestialFrameWrapper|CustomFrameWrapper|OrbitFrameWrapper|RFMCoordinateSystemWrapper|SpacecraftFrameWrapper|null {
  switch(RFMUnion[type]) {
    case 'NONE': return null;
    ...
    case 'RFMCoordinateSystemWrapper': return accessor(index, new RFMCoordinateSystemWrapper())! as RFMCoordinateSystemWrapper;
    default: return null;
  }
}
