 ...
 * provider, or site.
 */
export class TMSProvenance implements flatbuffers.IUnpackableObject<TMSProvenanceT> {
...
static startTMSProvenance(builder:flatbuffers.Builder) {
...
export class TMSProvenanceT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return TMSProvenance.createTMSProvenance(builder,
    DATASET_ID,
    DATASET_NAME,
    DATASET_URL,
    DATASET_EPOCH,
