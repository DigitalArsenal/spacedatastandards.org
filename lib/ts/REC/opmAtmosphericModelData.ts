 ...
 */
export class opmAtmosphericModelData implements flatbuffers.IUnpackableObject<opmAtmosphericModelDataT> {
...
static startopmAtmosphericModelData(builder:flatbuffers.Builder) {
...
unpack(): opmAtmosphericModelDataT {
  return new opmAtmosphericModelDataT(
...
export class opmAtmosphericModelDataT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  return opmAtmosphericModelData.createopmAtmosphericModelData(builder,
    this.ATMOSPHERIC_MODEL,
    this.GEOPOTENTIAL_MODEL,
    this.LUNAR_SOLAR_PERTURBATION,
    this.LUNAR_PERTURBATION_MODEL,
