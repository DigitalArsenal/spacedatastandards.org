 ...
 */
export class PGMMetadataEntry implements flatbuffers.IUnpackableObject<PGMMetadataEntryT> {
...
static startPGMMetadataEntry(builder:flatbuffers.Builder) {
...
export class PGMMetadataEntryT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return PGMMetadataEntry.createPGMMetadataEntry(builder,
    KEY,
    VALUE
  );
}
