 ...
 */
export class Detail implements flatbuffers.IUnpackableObject<DetailT> {
...
static startDetail(builder:flatbuffers.Builder) {
...
export class DetailT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return Detail.createDetail(builder,
    MULTIFORMAT_ADDRESS,
    CID,
    FID,
