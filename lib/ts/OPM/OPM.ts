...
STATE_VECTOR(obj?:opmStateVector):opmStateVector|null {
  ...
  return offset ? (obj || new opmStateVector()).__init(this.bb!.__indirect(this.bb_pos + offset), this.bb!) : null;
}
...
ATMOSPHERIC_MODEL_DATA(obj?:opmAtmosphericModelData):opmAtmosphericModelData|null {
  ...
  return offset ? (obj || new opmAtmosphericModelData()).__init(this.bb!.__indirect(this.bb_pos + offset), this.bb!) : null;
}
...
COVARIANCE_MATRIX(index: number, obj?:opmCovarianceMatrixLine):opmCovarianceMatrixLine|null {
  ...
  return offset ? (obj || new opmCovarianceMatrixLine()).__init(this.bb!.__indirect(this.bb!.__vector(this.bb_pos + offset) + index * 4), this.bb!) : null;
}
...
unpack(): OPMT {
  return new OPMT(
    ...
    this.bb!.createObjList<opmCovarianceMatrixLine, opmCovarianceMatrixLineT>(this.COVARIANCE_MATRIX.bind(this), this.covarianceMatrixLength()),
...
unpackTo(_o: OPMT): void {
  ...
  _o.COVARIANCE_MATRIX = this.bb!.createObjList<opmCovarianceMatrixLine, opmCovarianceMatrixLineT>(this.COVARIANCE_MATRIX.bind(this), this.covarianceMatrixLength());
...
constructor(
  ...
  public STATE_VECTOR: opmStateVectorT|null = null,
  ...
  public ATMOSPHERIC_MODEL_DATA: opmAtmosphericModelDataT|null = null,
  public PROPAGATOR_SETTINGS: propagatorConfigT|null = null,
  public COVARIANCE_MATRIX: (opmCovarianceMatrixLineT)[] = [],
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  const COVARIANCE_MATRIX = OPM.createCovarianceMatrixVector(builder, builder.createObjectOffsetList(this.COVARIANCE_MATRIX));
  ...
  OPM.addCcsdsOmmVers(builder, this.CCSDS_OMM_VERS);
  OPM.addCreationDate(builder, CREATION_DATE);
  OPM.addOriginator(builder, ORIGINATOR);
  OPM.addObjectName(builder, OBJECT_NAME);
  OPM.addObjectId(builder, OBJECT_ID);
  OPM.addCenterName(builder, CENTER_NAME);
  OPM.addRefFrame(builder, REF_FRAME);
  OPM.addTimeSystem(builder, TIME_SYSTEM);
  OPM.addStateVector(builder, STATE_VECTOR);
  OPM.addKeplerianElements(builder, KEPLERIAN_ELEMENTS);
  OPM.addEquinoctialElements(builder, EQUINOCTIAL_ELEMENTS);
  OPM.addGm(builder, this.GM);
  OPM.addAtmosphericModelData(builder, ATMOSPHERIC_MODEL_DATA);
  OPM.addPropagatorSettings(builder, PROPAGATOR_SETTINGS);
  OPM.addCovarianceMatrix(builder, COVARIANCE_MATRIX);
  OPM.addUvwSigmas(builder, UVW_SIGMAS);
  OPM.addMass(builder, this.MASS);
  OPM.addSolarRadArea(builder, this.SOLAR_RAD_AREA);
  OPM.addSolarRadCoeff(builder, this.SOLAR_RAD_COEFF);
  OPM.addDragArea(builder, this.DRAG_AREA);
  OPM.addDragCoeff(builder, this.DRAG_COEFF);
  OPM.addSrp(builder, this.SRP);
  OPM.addClassificationType(builder, CLASSIFICATION_TYPE);
  OPM.addNoradCatId(builder, this.NORAD_CAT_ID);
  OPM.addElementSetNo(builder, this.ELEMENT_SET_NO);
  OPM.addRevAtEpoch(builder, this.REV_AT_EPOCH);
  OPM.addBstar(builder, this.BSTAR);
  OPM.addMeanMotionDot(builder, this.MEAN_MOTION_DOT);
  OPM.addMeanMotionDdot(builder, this.MEAN_MOTION_DDOT);
  OPM.addCovReferenceFrame(builder, COV_REFERENCE_FRAME);
  OPM.addCxX(builder, this.CX_X);
  OPM.addCyX(builder, this.CY_X);
  OPM.addCzX(builder, this.CZ_X);
  OPM.addCxDotX(builder, this.CX_DOT_X);
  OPM.addUserDefinedBip0044Type(builder, this.USER_DEFINED_BIP_0044_TYPE);
  OPM.addUserDefinedObjectDesignator(builder, USER_DEFINED_OBJECT_DESIGNATOR);
  OPM.addUserDefinedEarthModel(builder, USER_DEFINED_EARTH_MODEL);
  OPM.addUserDefinedEpochTimestamp(builder, this.USER_DEFINED_EPOCH_TIMESTAMP);
  OPM.addUserDefinedMicroseconds(builder, this.USER_DEFINED_MICROSECONDS);
