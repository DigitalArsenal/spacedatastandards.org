 ...
 */
export class BEMProvenance implements flatbuffers.IUnpackableObject<BEMProvenanceT> {
...
static startBEMProvenance(builder:flatbuffers.Builder) {
...
export class BEMProvenanceT implements flatbuffers.IGeneratedObject {
constructor(
...
pack(builder:flatbuffers.Builder): flatbuffers.Offset {
  ...
  return BEMProvenance.createBEMProvenance(builder,
    SOURCE,
    SOURCE_QUERY,
    MODEL_NAME,
    MODEL_VERSION,
