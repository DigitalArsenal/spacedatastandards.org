...
public struct Record : IFlatbufferObject
{
  ...
  public DSS valueAsDSS() { return value<DSS>().Value; }
  ...
  public GST valueAsGST() { return value<GST>().Value; }
  public MDP valueAsMDP() { return value<MDP>().Value; }
  public MDS valueAsMDS() { return value<MDS>().Value; }
  public PNL valueAsPNL() { return value<PNL>().Value; }
  public SHC valueAsSHC() { return value<SHC>().Value; }
  ...
  public OPP valueAsOPP() { return value<OPP>().Value; }
  public IQC valueAsIQC() { return value<IQC>().Value; }
  public CNP valueAsCNP() { return value<CNP>().Value; }
  ...
  public BPF valueAsBPF() { return value<BPF>().Value; }
  ...
  public RPC valueAsRPC() { return value<RPC>().Value; }
  public CSO valueAsCSO() { return value<CSO>().Value; }
  public PHB valueAsPHB() { return value<PHB>().Value; }
  public SKT valueAsSKT() { return value<SKT>().Value; }
  public SKQ valueAsSKQ() { return value<SKQ>().Value; }
  public SKR valueAsSKR() { return value<SKR>().Value; }
  ...
  public void UnPackTo(RecordT _o) {
    ...
    switch (this.valueType) {
      ...
      case RecordType.DPM:
        ...
        break;
      case RecordType.DSS:
        _o.value.Value = this.value<DSS>().HasValue ? this.value<DSS>().Value.UnPack() : null;
        break;
      case RecordType.EME:
      ...
      case RecordType.FSP:
        ...
        break;
      case RecordType.SCC:
        _o.value.Value = this.value<SCC>().HasValue ? this.value<SCC>().Value.UnPack() : null;
        break;
      case RecordType.SCN:
        _o.value.Value = this.value<SCN>().HasValue ? this.value<SCN>().Value.UnPack() : null;
        break;
      case RecordType.VST:
      ...
      case RecordType.ENT:
        ...
        break;
      case RecordType.VAM:
        _o.value.Value = this.value<VAM>().HasValue ? this.value<VAM>().Value.UnPack() : null;
        break;
      case RecordType.APP:
      ...
      case RecordType.FSO:
        ...
        break;
      case RecordType.GST:
        _o.value.Value = this.value<GST>().HasValue ? this.value<GST>().Value.UnPack() : null;
        break;
      case RecordType.MDP:
        _o.value.Value = this.value<MDP>().HasValue ? this.value<MDP>().Value.UnPack() : null;
        break;
      case RecordType.MDS:
        _o.value.Value = this.value<MDS>().HasValue ? this.value<MDS>().Value.UnPack() : null;
        break;
      case RecordType.PNL:
        _o.value.Value = this.value<PNL>().HasValue ? this.value<PNL>().Value.UnPack() : null;
        break;
      case RecordType.SHC:
        _o.value.Value = this.value<SHC>().HasValue ? this.value<SHC>().Value.UnPack() : null;
        break;
      case RecordType.CES:
        _o.value.Value = this.value<CES>().HasValue ? this.value<CES>().Value.UnPack() : null;
        break;
      case RecordType.QEM:
        _o.value.Value = this.value<QEM>().HasValue ? this.value<QEM>().Value.UnPack() : null;
        break;
      case RecordType.SBM:
      ...
      case RecordType.PMM:
        ...
        break;
      case RecordType.OPP:
        _o.value.Value = this.value<OPP>().HasValue ? this.value<OPP>().Value.UnPack() : null;
        break;
      case RecordType.IQC:
        _o.value.Value = this.value<IQC>().HasValue ? this.value<IQC>().Value.UnPack() : null;
        break;
      case RecordType.CNP:
        _o.value.Value = this.value<CNP>().HasValue ? this.value<CNP>().Value.UnPack() : null;
        break;
      case RecordType.CMR:
        _o.value.Value = this.value<CMR>().HasValue ? this.value<CMR>().Value.UnPack() : null;
        break;
      case RecordType.TBS:
        _o.value.Value = this.value<TBS>().HasValue ? this.value<TBS>().Value.UnPack() : null;
        break;
      case RecordType.CCT:
      ...
      case RecordType.TRS:
        ...
        break;
      case RecordType.GNP:
        _o.value.Value = this.value<GNP>().HasValue ? this.value<GNP>().Value.UnPack() : null;
        break;
      case RecordType.DTT:
      ...
      case RecordType.TXS:
        ...
        break;
      case RecordType.BPF:
        _o.value.Value = this.value<BPF>().HasValue ? this.value<BPF>().Value.UnPack() : null;
        break;
      case RecordType.EVL:
        _o.value.Value = this.value<EVL>().HasValue ? this.value<EVL>().Value.UnPack() : null;
        break;
      case RecordType.PCE:
        _o.value.Value = this.value<PCE>().HasValue ? this.value<PCE>().Value.UnPack() : null;
        break;
      case RecordType.NCD:
      ...
      case RecordType.WXF:
        ...
        break;
      case RecordType.CLM:
        _o.value.Value = this.value<CLM>().HasValue ? this.value<CLM>().Value.UnPack() : null;
        break;
      case RecordType.GCT:
      ...
      case RecordType.CQR:
        ...
        break;
      case RecordType.RPC:
        _o.value.Value = this.value<RPC>().HasValue ? this.value<RPC>().Value.UnPack() : null;
        break;
      case RecordType.CSO:
        _o.value.Value = this.value<CSO>().HasValue ? this.value<CSO>().Value.UnPack() : null;
        break;
      case RecordType.PHB:
        _o.value.Value = this.value<PHB>().HasValue ? this.value<PHB>().Value.UnPack() : null;
        break;
      case RecordType.SKT:
        _o.value.Value = this.value<SKT>().HasValue ? this.value<SKT>().Value.UnPack() : null;
        break;
      case RecordType.SKQ:
        _o.value.Value = this.value<SKQ>().HasValue ? this.value<SKQ>().Value.UnPack() : null;
        break;
      case RecordType.SKR:
        _o.value.Value = this.value<SKR>().HasValue ? this.value<SKR>().Value.UnPack() : null;
        break;
    }
