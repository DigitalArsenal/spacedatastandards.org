...
static public class ENGINEVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      && verifier.VerifyString(tablePos, 4 /*ENGINE_NAME*/, false)
      && verifier.VerifyField(tablePos, 6 /*TYPE*/, 1 /*ENGINE_TYPE*/, 1, false)
      && verifier.VerifyField(tablePos, 8 /*THRUST*/, 8 /*double*/, 8, false)
