...
public struct covarianceMatrixLine : IFlatbufferObject
{
  ...
  public manCovRefFrame COV_REF_FRAME { get { int o = __p.__offset(6); return o != 0 ? (manCovRefFrame)__p.bb.GetSbyte(o + __p.bb_pos) : manCovRefFrame.RSW; } }
  ...
  public static void AddCOV_REF_FRAME(FlatBufferBuilder builder, manCovRefFrame COV_REF_FRAME) { builder.AddSbyte(1, (sbyte)COV_REF_FRAME, 0); }
