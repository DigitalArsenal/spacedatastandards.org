...
public struct PLD : IFlatbufferObject
{
  ...
  public static bool VerifyPLD(ByteBuffer _bb) {Google.FlatBuffers.Verifier verifier = new Google.FlatBuffers.Verifier(_bb); return verifier.VerifyBuffer("$PLD", false, PLDVerify.Verify); }
...
static public class PLDVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      && verifier.VerifyString(tablePos, 4 /*PAYLOAD_DURATION*/, false)
      && verifier.VerifyField(tablePos, 6 /*MASS_AT_LAUNCH*/, 4 /*float*/, 4, false)
      && verifier.VerifyString(tablePos, 8 /*DIMENSIONS*/, false)
      && verifier.VerifyField(tablePos, 10 /*SOLAR_ARRAY_AREA*/, 4 /*float*/, 4, false)
      && verifier.VerifyString(tablePos, 12 /*SOLAR_ARRAY_DIMENSIONS*/, false)
      && verifier.VerifyString(tablePos, 14 /*NOMINAL_OPERATIONAL_LIFETIME*/, false)
      && verifier.VerifyVectorOfTables(tablePos, 16 /*INSTRUMENTS*/, IDMVerify.Verify, false)
