...
public struct OMM : IFlatbufferObject
{
  ...
  public referenceFrame REF_FRAME { get { int o = __p.__offset(16); return o != 0 ? (referenceFrame)__p.bb.GetSbyte(o + __p.bb_pos) : referenceFrame.TEME; } }
  /// REF_FRAME_EPOCH
  public string REF_FRAME_EPOCH { get { int o = __p.__offset(18); return o != 0 ? __p.__string(o + __p.bb_pos) : null; } }
#if ENABLE_SPAN_T
  public Span<byte> GetREF_FRAME_EPOCHBytes() { return __p.__vector_as_span<byte>(18, 1); }
#else
  public ArraySegment<byte>? GetREF_FRAME_EPOCHBytes() { return __p.__vector_as_arraysegment(18); }
#endif
  public byte[] GetREF_FRAME_EPOCHArray() { return __p.__vector_as_array<byte>(18); }
  ...
  public manCovRefFrame COV_REF_FRAME { get { int o = __p.__offset(70); return o != 0 ? (manCovRefFrame)__p.bb.GetSbyte(o + __p.bb_pos) : manCovRefFrame.RSW; } }
  ...
  public static Offset<OMM> CreateOMM(FlatBufferBuilder builder,
      ...
      manCovRefFrame COV_REF_FRAME = manCovRefFrame.RSW,
      double CX_X = 0.0,
      double CY_X = 0.0,
      double CY_Y = 0.0,
      double CZ_X = 0.0,
  ...
  public static void AddCOV_REF_FRAME(FlatBufferBuilder builder, manCovRefFrame COV_REF_FRAME) { builder.AddSbyte(33, (sbyte)COV_REF_FRAME, 0); }
...
public class OMMT
{
  ...
  public manCovRefFrame COV_REF_FRAME { get; set; }
  ...
  public OMMT() {
    ...
    this.COV_REF_FRAME = manCovRefFrame.RSW;
    this.CX_X = 0.0;
    this.CY_X = 0.0;
    this.CY_Y = 0.0;
    this.CZ_X = 0.0;
