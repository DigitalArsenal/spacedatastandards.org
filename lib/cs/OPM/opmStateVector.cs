...
public struct opmStateVector : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static opmStateVector GetRootAsopmStateVector(ByteBuffer _bb) { return GetRootAsopmStateVector(_bb, new opmStateVector()); }
  public static opmStateVector GetRootAsopmStateVector(ByteBuffer _bb, opmStateVector obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public opmStateVector __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<opmStateVector> CreateopmStateVector(FlatBufferBuilder builder,
    ...
    opmStateVector.AddZ_DOT(builder, Z_DOT);
    opmStateVector.AddY_DOT(builder, Y_DOT);
    opmStateVector.AddX_DOT(builder, X_DOT);
  ...
  public static void StartopmStateVector(FlatBufferBuilder builder) { builder.StartTable(7); }
  ...
  public static Offset<opmStateVector> EndopmStateVector(FlatBufferBuilder builder) {
    int o = builder.EndTable();
    return new Offset<opmStateVector>(o);
  }
  public opmStateVectorT UnPack() {
    var _o = new opmStateVectorT();
    this.UnPackTo(_o);
    return _o;
  }
  public void UnPackTo(opmStateVectorT _o) {
    _o.EPOCH = this.EPOCH;
    _o.X = this.X;
    _o.Y = this.Y;
    _o.Z = this.Z;
  ...
  public static Offset<opmStateVector> Pack(FlatBufferBuilder builder, opmStateVectorT _o) {
    if (_o == null) return default(Offset<opmStateVector>);
...
static public class opmStateVectorVerify
{
